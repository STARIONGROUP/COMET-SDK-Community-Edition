// --------------------------------------------------------------------------------------------------------------------
// <copyright file="RelationalExpressionVerifier.cs" company="Starion Group S.A.">
...
namespace CDP4RequirementsVerification.Verifiers
{
    ...
    public class RelationalExpressionVerifier : BooleanExpressionVerifier<RelationalExpression>
    {
        ...
        public RelationalExpressionVerifier(RelationalExpression relationalExpression, IRequirementVerificationConfiguration configuration, ICDPMessageBus messageBus) : base(configuration, messageBus)
        {
