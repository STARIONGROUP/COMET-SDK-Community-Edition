// --------------------------------------------------------------------------------------------------------------------
// <copyright file="AndExpressionVerifier.cs" company="RHEA System S.A.">
...
namespace CDP4RequirementsVerification.Verifiers
{
    ...
    public class AndExpressionVerifier : BooleanExpressionVerifier<AndExpression>
    {
        ...
        public AndExpressionVerifier(AndExpression andExpression, IRequirementVerificationConfiguration configuration) : base(configuration)
        {
