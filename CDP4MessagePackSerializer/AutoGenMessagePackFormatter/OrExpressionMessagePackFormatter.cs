// --------------------------------------------------------------------------------------------------------------------
// <copyright file="OrExpressionMessagePackFormatter.cs" company="Starion Group S.A.">
...
namespace CDP4MessagePackSerializer
{
    ...
    public class OrExpressionMessagePackFormatter : IMessagePackFormatter<OrExpression>
    {
        ...
        public void Serialize(ref MessagePackWriter writer, OrExpression orExpression, MessagePackSerializerOptions options)
        {
            ...
            {
                writer.Write(orExpression.Actor.Value.ToByteArray());
            }
            else
            {
                writer.WriteNil();
            ...
            for (var i = 0; i < propertyCounter; i++)
            {
                ...
                switch (i)
                {
                    ...
                    case 7:
                        if (reader.TryReadNil())
                        {
                            orExpression.Actor = null;
                        }
                        else
                        {
                            orExpression.Actor = reader.ReadBytes().ToGuid();
                        }
                        break;
                    default:
                        reader.Skip();
