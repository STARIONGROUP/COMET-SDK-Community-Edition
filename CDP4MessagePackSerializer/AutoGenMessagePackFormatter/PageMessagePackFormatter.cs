// --------------------------------------------------------------------------------------------------------------------
// <copyright file="PageMessagePackFormatter.cs" company="Starion Group S.A.">
...
namespace CDP4MessagePackSerializer
{
    ...
    /// <summary>
    /// The purpose of the <see cref="PageMessagePackFormatter"/> is to provide
    /// the contract for MessagePack (de)serialization of the <see cref="Page"/> type
    /// </summary>
    [CDPVersion("1.1.0")]
    public class PageMessagePackFormatter : IMessagePackFormatter<Page>
    {
        ...
        /// </param>
        /// <param name="page">
        /// The <see cref="Page"/> that is to be serialized.
        /// </param>
        /// <param name="options">
        /// The serialization settings to use.
        /// </param>
        public void Serialize(ref MessagePackWriter writer, Page page, MessagePackSerializerOptions options)
        {
            if (page == null)
            {
        ...
        /// <summary>
        /// Deserializes an <see cref="Page"/>.
        /// </summary>
        /// <param name="reader">
        /// The <see cref="MessagePackWriter"/> to deserialize the <see cref="Page"/> from.
        /// </param>
        /// <param name="options">
        /// The serialization settings to use.
        /// </param>
        /// <returns>
        /// The deserialized <see cref="Page"/>.
        /// </returns>
        public Page Deserialize(ref MessagePackReader reader, MessagePackSerializerOptions options)
        {
            ...
            for (var i = 0; i < propertyCounter; i++)
            {
                ...
                {
                    case 0:
                        page.Iid = reader.ReadBytes().ToGuid();
                        break;
                    case 1:
                        page.RevisionNumber = reader.ReadInt32();
                        break;
                    case 2:
                        valueLength = reader.ReadArrayHeader();
                        for (valueCounter = 0; valueCounter < valueLength; valueCounter++)
                        {
                            page.Category.Add(reader.ReadBytes().ToGuid());
                        }
                        break;
                    case 3:
                        page.CreatedOn = reader.ReadDateTime();
                        break;
                    case 4:
                        valueLength = reader.ReadArrayHeader();
                        for (valueCounter = 0; valueCounter < valueLength; valueCounter++)
                        {
                            page.ExcludedDomain.Add(reader.ReadBytes().ToGuid());
                        }
                        break;
                    case 5:
                        valueLength = reader.ReadArrayHeader();
                        for (valueCounter = 0; valueCounter < valueLength; valueCounter++)
                        {
                            page.ExcludedPerson.Add(reader.ReadBytes().ToGuid());
                        }
                        break;
                    case 6:
                        page.ModifiedOn = reader.ReadDateTime();
                        break;
                    case 7:
                    ...
                    case 8:
                        ...
                        break;
                    case 9:
                        page.Owner = reader.ReadBytes().ToGuid();
                        break;
                    case 10:
                        page.ShortName = reader.ReadString();
                        break;
                    case 11:
