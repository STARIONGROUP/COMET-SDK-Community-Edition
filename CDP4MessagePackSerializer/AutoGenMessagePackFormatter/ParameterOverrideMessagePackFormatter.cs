// --------------------------------------------------------------------------------------------------------------------
// <copyright file="ParameterOverrideMessagePackFormatter.cs" company="Starion Group S.A.">
...
namespace CDP4MessagePackSerializer
{
    ...
    public class ParameterOverrideMessagePackFormatter : IMessagePackFormatter<ParameterOverride>
    {
        ...
        public void Serialize(ref MessagePackWriter writer, ParameterOverride parameterOverride, MessagePackSerializerOptions options)
        {
            ...
            {
                writer.Write(parameterOverride.Actor.Value.ToByteArray());
            }
            else
            {
                writer.WriteNil();
            ...
            for (var i = 0; i < propertyCounter; i++)
            {
                ...
                switch (i)
                {
                    ...
                    case 10:
                        if (reader.TryReadNil())
                        {
                            parameterOverride.Actor = null;
                        }
                        else
                        {
                            parameterOverride.Actor = reader.ReadBytes().ToGuid();
                        }
                        break;
                    default:
                        reader.Skip();
