// --------------------------------------------------------------------------------------------------------------------
// <copyright file="EngineeringModelDataDiscussionItemMessagePackFormatter.cs" company="Starion Group S.A.">
...
namespace CDP4MessagePackSerializer
{
    ...
    public class EngineeringModelDataDiscussionItemMessagePackFormatter : IMessagePackFormatter<EngineeringModelDataDiscussionItem>
    {
        ...
        public void Serialize(ref MessagePackWriter writer, EngineeringModelDataDiscussionItem engineeringModelDataDiscussionItem, MessagePackSerializerOptions options)
        {
            ...
            {
                writer.Write(engineeringModelDataDiscussionItem.Actor.Value.ToByteArray());
            }
            else
            {
                writer.WriteNil();
            ...
            for (var i = 0; i < propertyCounter; i++)
            {
                ...
                switch (i)
                {
                    ...
                    case 11:
                        if (reader.TryReadNil())
                        {
                            engineeringModelDataDiscussionItem.Actor = null;
                        }
                        else
                        {
                            engineeringModelDataDiscussionItem.Actor = reader.ReadBytes().ToGuid();
                        }
                        break;
                    default:
                        reader.Skip();
