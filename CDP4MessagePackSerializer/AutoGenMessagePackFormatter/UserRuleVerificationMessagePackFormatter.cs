// --------------------------------------------------------------------------------------------------------------------
// <copyright file="UserRuleVerificationMessagePackFormatter.cs" company="Starion Group S.A.">
...
namespace CDP4MessagePackSerializer
{
    ...
    public class UserRuleVerificationMessagePackFormatter : IMessagePackFormatter<UserRuleVerification>
    {
        ...
        public void Serialize(ref MessagePackWriter writer, UserRuleVerification userRuleVerification, MessagePackSerializerOptions options)
        {
            ...
            {
                writer.Write(userRuleVerification.Actor.Value.ToByteArray());
            }
            else
            {
                writer.WriteNil();
            ...
            for (var i = 0; i < propertyCounter; i++)
            {
                ...
                switch (i)
                {
                    ...
                    case 11:
                        if (reader.TryReadNil())
                        {
                            userRuleVerification.Actor = null;
                        }
                        else
                        {
                            userRuleVerification.Actor = reader.ReadBytes().ToGuid();
                        }
                        break;
                    default:
                        reader.Skip();
