// --------------------------------------------------------------------------------------------------------------------
// <copyright file="QuantityKindFactorMessagePackFormatter.cs" company="Starion Group S.A.">
...
namespace CDP4MessagePackSerializer
{
    ...
    public class QuantityKindFactorMessagePackFormatter : IMessagePackFormatter<QuantityKindFactor>
    {
        ...
        public void Serialize(ref MessagePackWriter writer, QuantityKindFactor quantityKindFactor, MessagePackSerializerOptions options)
        {
            ...
            {
                writer.Write(quantityKindFactor.Actor.Value.ToByteArray());
            }
            else
            {
                writer.WriteNil();
            ...
            for (var i = 0; i < propertyCounter; i++)
            {
                ...
                switch (i)
                {
                    ...
                    case 8:
                        if (reader.TryReadNil())
                        {
                            quantityKindFactor.Actor = null;
                        }
                        else
                        {
                            quantityKindFactor.Actor = reader.ReadBytes().ToGuid();
                        }
                        break;
                    default:
                        reader.Skip();
