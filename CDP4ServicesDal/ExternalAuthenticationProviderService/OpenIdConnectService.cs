...
namespace CDP4ServicesDal.ExternalAuthenticationProviderService
{
    ...
    /// <summary>
    /// The <see cref="IOpenIdConnectService" /> provides open Id Connect interaction features
    /// </summary>
    public class OpenIdConnectService : IOpenIdConnectService
    {
        ...
        /// <summary>
        /// Requests <see cref="OpenIdAuthenticationDto" /> generated by an external provider, supporting the OpenID Connect standard
        /// </summary>
        /// <param name="code">The code that should be used to get <see cref="OpenIdAuthenticationDto" /></param>
        ...
        /// <returns>An <see cref="Task{TResult}" /> that have the retrieved <see cref="OpenIdAuthenticationDto" /></returns>
        ...
        public async Task<OpenIdAuthenticationDto> RequestAuthenticationToken(string code, AuthenticationSchemeResponse authenticationSchemeResponse, string redirectUri = null, string clientSecret = null)
        {
            ...
            {
                parameters.Add(new KeyValuePair<string, string>("redirect_uri", redirectUri.TrimEnd('/')));
            ...
            if (statusCodeValue is >= 200 and < 300)
            {
                ...
                return JsonSerializer.Deserialize<OpenIdAuthenticationDto>(content, JsonSerializerOptions);
            }
