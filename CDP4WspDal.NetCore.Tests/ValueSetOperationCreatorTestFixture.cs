// --------------------------------------------------------------------------------------------------------------------
// <copyright file="ValueSetOperationCreatorTestFixture.cs" company="Starion Group S.A.">
...
namespace CDP4WspDal.Tests
{
    ...
    internal class ValueSetOperationCreatorTestFixture
    {
        ...
        public void VerifyThatCreateValueSetsUpdateOperationsWorks()
        {
            ...
            Assert.That(modifiedPvs.Manual, Is.Not.EqualTo(originalPvs.Manual));
        }
        ...
        public void VerifyThatCreateValueSetsUpdateOperationsWorksOptionDependent()
        {
            ...
            Assert.That(modified.Manual, Is.Not.EqualTo(original.Manual));
        }
