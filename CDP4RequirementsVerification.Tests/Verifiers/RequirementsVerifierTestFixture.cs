// --------------------------------------------------------------------------------------------------------------------
// <copyright file="RequirementsVerifierTestFixture.cs" company="Starion Group S.A.">
...
namespace CDP4RequirementsVerification.Tests.Verifiers
{
    ...
    public class RequirementsVerifierTestFixture
    {
        ...
        public void SetUp()
        {
            ...
            this.requirementVerifier = new RequirementVerifier(this.requirement, null, this.messageBus);
