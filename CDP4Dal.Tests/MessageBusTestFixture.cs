...
namespace CDP4Dal.Tests
{
    ...
    public class MessageBusTestFixture
    {
        ...
        public void VerifyMemoryUsage()
        {
            ...
            Assert.That(count + currentCount, Is.EqualTo(this.messageBus.ActiveObservableCount));
            Assert.That((count * 2 * repeat) + currentCalls, Is.EqualTo(this.messageBus.ListenerCallCount));
            ...
            dotMemory.Check(x =>
            {
                ...
                Assert.That(result2 - result1 < 253000000, Is.True, "ICDPMessageBus uses more memory that expected on creation of Observables and Subscriptions");
            });
            ...
            dotMemory.Check(x =>
            {
                ...
                Assert.That(result2 - result3 > 94000000, Is.True, "ICDPMessageBus frees up LESS memory than expected on disposing subscriptions");
                Assert.That(result2 - result3 < 98000000, Is.True, "ICDPMessageBus frees up MORE memory than expected on disposing subscriptions");
            });
        ...
        public async Task VerifyThatSubscribeToTypeGetsEvent()
        {
            ...
            Assert.That(2, Is.EqualTo(this.cache.Count));
        ...
        public async Task VerifyThatSubscribeToTypeSuperclassGetsEvent()
        {
            ...
            // Check that the viewModel catches the event
            Assert.That(4, Is.EqualTo(this.cache.Count));
        ...
        public void VerifyThatSubscribeToObjectWorks()
        {
            ...
            Assert.That(1, Is.EqualTo(this.cache.Count));
            ...
            Assert.That(3, Is.EqualTo(this.cache.Count));
        }
