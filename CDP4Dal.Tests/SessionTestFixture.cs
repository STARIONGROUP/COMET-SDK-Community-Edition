...
namespace CDP4Dal.Tests
{
    ...
    public class SessionTestFixture
    {
        ...
        public async Task VerifyQueryAuthenticatedUserName()
        {
            ...
            temporaryCredentials.ProvideUserToken(new AuthenticationToken("token", "refreshToken"), AuthenticationSchemeKind.ExternalJwtBearer);
        ...
        public async Task VerifyRequestAuthenticationTokenBasedOnRefreshToken()
        {
            ...
            var token = new AuthenticationToken("access", "refreshToken");
            this.session.Credentials.ProvideUserToken(token, AuthenticationSchemeKind.LocalJwtBearer);
