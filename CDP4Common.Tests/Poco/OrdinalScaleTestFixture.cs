...
namespace CDP4Common.Tests.Poco
{
    ...
    /// <summary>
    /// Suite of tests for the <see cref="MeasurementScale"/> class
    /// </summary>
    [TestFixture]
    public class OrdinalScaleTestFixture
    {
        private Uri uri;
        ...
        public void VerifyThatGetRequiredRdlsReturnsExpectedResults()
        {
            ...
            var ordinalScale = new OrdinalScale(Guid.NewGuid(), this.cache, this.uri);

            srdl1_1.RequiredRdl = srdl1;
            mrdl.RequiredRdl = srdl1_1;
            srdl2.RequiredRdl = srdl1;

            mrdl.Scale.Add(ordinalScale);

            var requiredRdls = ordinalScale.RequiredRdls.ToList();
