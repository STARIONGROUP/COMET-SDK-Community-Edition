...
namespace CDP4Common.Tests.Poco
{
    ...
    /// <summary>
    /// suite of tests for the <see cref="FileType"/>
    /// </summary>
    [TestFixture]
    public class FileTypeTestFixture
    {
        private Uri uri;
        ...
        public void VerifyThatGetRequiredRdlsReturnsExpectedResults()
        {
            ...
            var fileType = new FileType(Guid.NewGuid(), this.cache, this.uri);

            srdl1_1.RequiredRdl = srdl1;
            mrdl.RequiredRdl = srdl1_1;
            srdl2.RequiredRdl = srdl1;

            mrdl.FileType.Add(fileType);

            var requiredRdls = fileType.RequiredRdls.ToList();
