...
namespace CDP4JsonSerializer
{
    ...
    public class RelationshipParameterValueSerializer : BaseThingSerializer, IThingSerializer
    {
        ...
        private JObject Serialize(RelationshipParameterValue relationshipParameterValue)
        {
            ...
            jsonObject.Add("excludedDomain", this.PropertySerializerMap["excludedDomain"](relationshipParameterValue.ExcludedDomain.OrderBy(x => x, this.guidComparer)));
            jsonObject.Add("excludedPerson", this.PropertySerializerMap["excludedPerson"](relationshipParameterValue.ExcludedPerson.OrderBy(x => x, this.guidComparer)));
            ...
            jsonObject.Add("thingPreference", this.PropertySerializerMap["thingPreference"](relationshipParameterValue.ThingPreference));
