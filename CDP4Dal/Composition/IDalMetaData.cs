// --------------------------------------------------------------------------------------------------------------------
// <copyright file="IDalMetaData.cs" company="Starion Group S.A.">
...
namespace CDP4Dal.Composition
{
    ...
    /// used in conjunction with a custom <see cref="System.ComponentModel.Composition.ExportAttribute"/>. This interface also carries the type of Dal it is used with.
    /// </summary>
