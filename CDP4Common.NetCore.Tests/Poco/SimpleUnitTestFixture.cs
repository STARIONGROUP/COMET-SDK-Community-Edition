...
namespace CDP4Common.Tests.Poco
{
    ...
    /// <summary>
    /// Suite of tests for the <see cref="SimpleUnit"/> class
    /// </summary>
    [TestFixture]
    public  class SimpleUnitTestFixture
    {
        private Uri uri;
        ...
        public void VerifyThatGetRequiredRdlsReturnsExpectedResults()
        {
            ...
            var simpleUnit = new SimpleUnit(Guid.NewGuid(), this.cache, this.uri);

            srdl1_1.RequiredRdl = srdl1;
            mrdl.RequiredRdl = srdl1_1;
            srdl2.RequiredRdl = srdl1;

            mrdl.Unit.Add(simpleUnit);
