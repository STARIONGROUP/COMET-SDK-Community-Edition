...
namespace CDP4Common.Tests.Extensions
{
    ...
    public class BooleanExpressionExtensionsTestFixture
    {
        ...
        /// <summary>
        /// Helper enum so a static testcase source can be used
        /// </summary>
        ...
        public void VerifyThatAllCategoriesAreReturnedWhenRelationalExpressionsAreAddedToAndExpression(ExpressionNumber expressionNumber, bool shouldContain)
        {
        ...
        [TestCase(ExpressionNumber.Relational3, true)]
        [TestCase(ExpressionNumber.Relational4, true)]
        public void VerifyThatAllCategoriesAreReturnedWhenRelationalExpressionsAreAddedToOrExpression(ExpressionNumber expressionNumber, bool shouldContain)
        {
        ...
        [TestCase(ExpressionNumber.Relational3, true)]
        [TestCase(ExpressionNumber.Relational4, true)]
        public void VerifyThatAllCategoriesAreReturnedWhenRelationalExpressionsAreAddedToExclusiveOrExpression(ExpressionNumber expressionNumber, bool shouldContain)
        {
        ...
        [TestCase(ExpressionNumber.Relational3, true)]
        [TestCase(ExpressionNumber.Relational4, true)]
        public void VerifyThatAllCategoriesAreReturnedWhenRelationalExpressionIsAddedToNotExpression(ExpressionNumber expressionNumber, bool shouldContain)
        {
        ...
        public void VerifyThatAllCategoriesAreReturnedWhenRelationalExpressionsAreNested(ExpressionNumber expressionNumber, bool shouldContain)
        {
            this.andExpression.Term.Add(this.relationalExpression1);
            this.andExpression.Term.Add(this.relationalExpression2);
