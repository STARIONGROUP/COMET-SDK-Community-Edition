// --------------------------------------------------------------------------------------------------------------------
// <copyright file="DataCollectorNode.cs" company="Starion Group S.A.">
...
namespace CDP4Reporting.DataCollection
{
    ...
    /// </typeparam>
    public class DataCollectorNode<T> where T : DataCollectorRow, new()
    {
        /// <summary>
        ...
        /// </summary>
        public List<DataCollectorNode<T>> Children { get; } = new List<DataCollectorNode<T>>();

        /// <summary>
        /// Gets the <see cref="CDP4Common.EngineeringModelData.NestedElement"/> associated with this node.
        /// </summary>
        public NestedElement NestedElement { get; }

        /// <summary>
        /// The <see cref="ICategorizableThing"/> associated with this node.
        /// </summary>
        public ICategorizableThing CategorizableThing => this.ElementBase;

        /// <summary>
        /// The <see cref="CDP4Common.EngineeringModelData.ElementBase"/> associated with this node.
        /// </summary>
        public ElementBase ElementBase => this.NestedElement.GetElementBase();

        /// <summary>
        /// The <see cref="CDP4Common.EngineeringModelData.ElementDefinition"/> representing this node.
        /// </summary>
        public ElementDefinition ElementDefinition => this.NestedElement.GetElementDefinition();

        /// <summary>
        /// The <see cref="ElementUsage"/> representing this node, if it exists.
        /// </summary>
        public ElementUsage ElementUsage =>  this.NestedElement.GetElementUsage();
        ...
        /// </returns>
        public int CountCategoryRecursionLevel(Category category)
        {
        ...
        /// In case you only want the rows that indeed contain the wanted <see cref="ParameterValueSet"/>s then set this parameter to true.
        /// </param>
        public void AddDataRows(DataTable table, bool excludeMissingParameters)
        {
