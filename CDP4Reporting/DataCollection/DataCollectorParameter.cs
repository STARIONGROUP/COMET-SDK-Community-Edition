// --------------------------------------------------------------------------------------------------------------------
// <copyright file="DataCollectorParameterColumn.cs" company="Starion Group S.A.">
...
namespace CDP4Reporting.DataCollection
{
    ...
    public abstract class DataCollectorParameter<TRow, TValue> : DataCollectorColumn<TRow>, IDataCollectorParameter where TRow : DataCollectorRow, new()
    {
        ...
        /// </summary>
        public ParameterValueContext ParameterValueContext { get; set; } = ParameterValueContext.PublishedValue;

        /// <summary>
        /// The <see cref="ParameterValueContext"/> for which the value needs to be retrieved
        /// in case <see cref="DataCollectorParameter{TRow, TValue}.ParameterBase"/> is of type <see cref="ParameterSubscription"/>
        /// </summary>
        public ParameterValueContext ParameterSubscriptionValueContext { get; set; } = ParameterValueContext.PublishedValue;
        ...
        /// </param>
        public override void Initialize(DataCollectorNode<TRow> node, PropertyInfo propertyInfo)
        {
