// <copyright file="UserRuleVerificationRuleChecker.cs" company="Starion Group S.A.">
...
namespace CDP4Rules.RuleCheckers
{
    ...
    public class UserRuleVerificationRuleChecker : RuleChecker
    {
        ...
        private UserRuleVerification VerifyThingArgument(Thing thing)
        {
            ...
            {
                throw new ArgumentException($"{nameof(thing)} with Iid:{thing.Iid} is not a UserRuleVerification", nameof(thing));
            }
