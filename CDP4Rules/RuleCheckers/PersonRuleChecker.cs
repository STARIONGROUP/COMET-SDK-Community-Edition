// <copyright file="PersonRuleChecker.cs" company="Starion Group S.A.">
...
namespace CDP4Rules.RuleCheckers
{
    ...
    public class PersonRuleChecker : RuleChecker
    {
        ...
        {
            var person = VerifyThingArgument(thing);
        ...
        /// thrown when <paramref name="thing"/> is not an <see cref="Person"/>
        /// </exception>
        private static Person VerifyThingArgument(Thing thing)
        {
            if (thing == null)
            {
