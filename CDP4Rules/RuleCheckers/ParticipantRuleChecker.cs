// <copyright file="ParticipantRuleChecker.cs" company="Starion Group S.A.">
...
namespace CDP4Rules.RuleCheckers
{
    ...
    /// <summary>
    /// The purpose of the <see cref="ParticipantRuleChecker"/> is to execute the rules for instances of type <see cref="Participant"/>
    /// </summary>
    [RuleChecker(typeof(Participant))]
    public class ParticipantRuleChecker : RuleChecker
    {
        /// <summary>
        /// Checks whether a referenced <see cref="IDeprecatableThing"/> is deprecated
        /// </summary>
        /// <param name="thing">
        /// The subject <see cref="Participant"/>
        /// </param>
        /// <returns>
        ...
        /// thrown when <paramref name="thing"/> is not an <see cref="Participant"/>
        /// </exception>
        [Rule("MA-0500")]
        public IEnumerable<RuleCheckResult> ChecksWhetherAReferencedDeprecatableThingIsDeprecated(Thing thing)
        {
            var participant = VerifyThingArgument(thing);
        ...
        /// </param>
        /// <returns>
        /// an instance of <see cref="Participant"/>
        /// </returns>
        /// <exception cref="ArgumentNullException">
        /// thrown when <paramref name="thing"/> is null
        /// </exception>
        ...
        /// thrown when <paramref name="thing"/> is not an <see cref="Participant"/>
        /// </exception>
        private static Participant VerifyThingArgument(Thing thing)
        {
            if (thing == null)
            {
            ...
            if (participant == null)
            {
                throw new ArgumentException($"{nameof(thing)} with Iid:{thing.Iid} is not an Participant", nameof(thing));
            }
