// <copyright file="ReferenceDataLibraryRuleChecker.cs" company="Starion Group S.A.">
...
namespace CDP4Rules.RuleCheckers
{
    ...
    /// <summary>
    /// The purpose of the <see cref="ReferenceDataLibraryRuleChecker"/> is to execute the rules for instances of type <see cref="ReferenceDataLibrary"/>
    /// </summary>
    [RuleChecker(typeof(ReferenceDataLibrary))]
    public class ReferenceDataLibraryRuleChecker : RuleChecker
    {
        /// <summary>
        /// Checks whether a referenced <see cref="IDeprecatableThing"/> is deprecated
        /// </summary>
        /// <param name="thing">
        /// The subject <see cref="ReferenceDataLibrary"/>
        /// </param>
        /// <returns>
        ...
        /// thrown when <paramref name="thing"/> is not an <see cref="ReferenceDataLibrary"/>
        /// </exception>
        [Rule("MA-0500")]
        public IEnumerable<RuleCheckResult> ChecksWhetherAReferencedDeprecatableThingIsDeprecated(Thing thing)
        {
            var referenceDataLibrary = VerifyThingArgument(thing);
        ...
        /// </param>
        /// <returns>
        /// an instance of <see cref="ReferenceDataLibrary"/>
        /// </returns>
        /// <exception cref="ArgumentNullException">
        /// thrown when <paramref name="thing"/> is null
        /// </exception>
        ...
        /// thrown when <paramref name="thing"/> is not an <see cref="ReferenceDataLibrary"/>
        /// </exception>
        private static ReferenceDataLibrary VerifyThingArgument(Thing thing)
        {
            if (thing == null)
            {
            ...
            {
                throw new ArgumentException($"{nameof(thing)} with Iid:{thing.Iid} is not a ReferenceDataLibrary", nameof(thing));
            }
