// <copyright file="ParameterizedCategoryRuleRuleChecker.cs" company="RHEA System S.A.">
...
namespace CDP4Rules.RuleCheckers
{
    ...
    public class ParameterizedCategoryRuleRuleChecker : RuleChecker
    {
        ...
        private ParameterizedCategoryRule VerifyThingArgument(Thing thing)
        {
            ...
            {
                throw new ArgumentException($"{nameof(thing)} with Iid:{thing.Iid} is not an ParameterizedCategoryRule");
            }
