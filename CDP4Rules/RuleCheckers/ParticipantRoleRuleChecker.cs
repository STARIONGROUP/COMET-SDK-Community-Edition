// <copyright file="ParticipantRoleRuleChecker.cs" company="Starion Group S.A.">
...
namespace CDP4Rules.RuleCheckers
{
    ...
    public class ParticipantRoleRuleChecker : RuleChecker
    {
        ...
        private ParticipantRole VerifyThingArgument(Thing thing)
        {
            ...
            {
                throw new ArgumentException($"{nameof(thing)} with Iid:{thing.Iid} is not a ParticipantRole", nameof(thing));
            }
