// <copyright file="PrefixedUnitRuleChecker.cs" company="Starion Group S.A.">
...
namespace CDP4Rules.RuleCheckers
{
    ...
    /// <summary>
    /// The purpose of the <see cref="PrefixedUnitRuleChecker"/> is to execute the rules for instances of type <see cref="PrefixedUnit"/>
    /// </summary>
    [RuleChecker(typeof(PrefixedUnit))]
    public class PrefixedUnitRuleChecker : RuleChecker
    {
        /// <summary>
        /// Checks whether a referenced <see cref="UnitPrefix"/> is the in chain of Reference Data Libraries
        /// </summary>
        /// <param name="thing">
        ...
        public IEnumerable<RuleCheckResult> CheckWhetherReferencedUnitPrefixIsInChainOfRdls(Thing thing)
        {
            ...
            if (!referenceDataLibrary.IsUnitPrefixInChainOfRdls(prefixedUnit.Prefix))
            {
                var result = new RuleCheckResult(thing, rule.Id, $"The referenced UnitPrefix {prefixedUnit.Prefix.Iid}:{prefixedUnit.Prefix.ShortName} of PrefixedUnit.Prefix is not in the chain of Reference Data Libraries", SeverityKind.Error);
                results.Add(result);
            }
        ...
        /// </param>
        /// <returns>
        /// an instance of <see cref="PrefixedUnit"/>
        /// </returns>
        /// <exception cref="ArgumentNullException">
        /// thrown when <paramref name="thing"/> is null
        /// </exception>
        ...
        private PrefixedUnit VerifyThingArgument(Thing thing)
        {
            ...
            {
                throw new ArgumentException($"{nameof(thing)} with Iid:{thing.Iid} is not a PrefixedUnit", nameof(thing));
            }
