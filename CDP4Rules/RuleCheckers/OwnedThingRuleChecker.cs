// <copyright file="OwnedThingRuleChecker.cs" company="Starion Group S.A.">
...
namespace CDP4Rules.RuleCheckers
{
    ...
    public class OwnedThingRuleChecker : RuleChecker
    {
        ...
        private IOwnedThing VerifyThingArgument(Thing thing)
        {
            ...
            if (ownedThing == null)
            {
                throw new ArgumentException($"{nameof(thing)} with Iid:{thing.Iid} is not an IOwnedThing", nameof(thing));
            }
