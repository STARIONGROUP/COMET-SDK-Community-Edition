// <copyright file="DefinedThingRuleChecker.cs" company="Starion Group S.A.">
...
namespace CDP4Rules.RuleCheckers
{
    ...
    public class DefinedThingRuleChecker : RuleChecker
    {
        ...
        private DefinedThing VerifyThingArgument(Thing thing)
        {
            ...
            {
                throw new ArgumentException($"{nameof(thing)} with Iid:{thing.Iid} is not a DefinedThing", nameof(thing));
            }
