// <copyright file="ConversionBasedUnitRuleChecker.cs" company="Starion Group S.A.">
...
namespace CDP4Rules.RuleCheckers
{
    ...
    public class ConversionBasedUnitRuleChecker : RuleChecker
    {
        ...
        private ConversionBasedUnit VerifyThingArgument(Thing thing)
        {
            ...
            {
                throw new ArgumentException($"{nameof(thing)} with Iid:{thing.Iid} is not an ConversionBasedUnit", nameof(thing));
            }
