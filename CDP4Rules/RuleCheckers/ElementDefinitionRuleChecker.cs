// <copyright file="ElementDefinitionRuleChecker.cs" company="RHEA System S.A.">
...
namespace CDP4Rules.RuleCheckers
{
    ...
    public class ElementDefinitionRuleChecker : RuleChecker
    {
        ...
        private ElementDefinition VerifyThingArgument(Thing thing)
        {
            ...
            {
                throw new ArgumentException($"{nameof(thing)} with Iid:{thing.Iid} is not an ElementDefinition");
            }
