// <copyright file="CitationRuleChecker.cs" company="Starion Group S.A.">
...
namespace CDP4Rules.RuleCheckers
{
    ...
    public class CitationRuleChecker : RuleChecker
    {
        ...
        private Citation VerifyThingArgument(Thing thing)
        {
            ...
            if (citation == null)
            {
                throw new ArgumentException($"{nameof(thing)} with Iid:{thing.Iid} is not a Citation", nameof(thing));
            }
