// <copyright file="BinaryRelationshipRuleChecker.cs" company="Starion Group S.A.">
...
namespace CDP4Rules.RuleCheckers
{
    ...
    public class BinaryRelationshipRuleChecker : RuleChecker
    {
        ...
        private BinaryRelationship VerifyThingArgument(Thing thing)
        {
            ...
            {
                throw new ArgumentException($"{nameof(thing)} with Iid:{thing.Iid} is not a BinaryRelationship", nameof(thing));
            }
