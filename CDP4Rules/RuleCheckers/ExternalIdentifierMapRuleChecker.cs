// <copyright file="ExternalIdentifierMapRuleChecker.cs" company="Starion Group S.A.">
...
namespace CDP4Rules.RuleCheckers
{
    ...
    public class ExternalIdentifierMapRuleChecker : RuleChecker
    {
        ...
        private ExternalIdentifierMap VerifyThingArgument(Thing thing)
        {
            ...
            {
                throw new ArgumentException($"{nameof(thing)} with Iid:{thing.Iid} is not an ExternalIdentifierMap", nameof(thing));
            }
