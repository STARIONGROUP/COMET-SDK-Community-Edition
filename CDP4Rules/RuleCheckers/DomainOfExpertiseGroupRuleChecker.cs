// <copyright file="DomainOfExpertiseGroupRuleChecker.cs" company="RHEA System S.A.">
...
namespace CDP4Rules.RuleCheckers
{
    ...
    public class DomainOfExpertiseGroupRuleChecker : RuleChecker
    {
        ...
        private DomainOfExpertiseGroup VerifyThingArgument(Thing thing)
        {
            ...
            {
                throw new ArgumentException($"{nameof(thing)} with Iid:{thing.Iid} is not an DomainOfExpertiseGroup");
            }
