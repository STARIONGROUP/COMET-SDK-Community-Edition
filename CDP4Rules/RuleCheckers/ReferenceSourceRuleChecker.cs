// <copyright file="ReferenceSourceRuleChecker.cs" company="Starion Group S.A.">
...
namespace CDP4Rules.RuleCheckers
{
    ...
    public class ReferenceSourceRuleChecker : RuleChecker
    {
        ...
        {
            var referenceSource = VerifyThingArgument(thing);
        ...
        /// thrown when <paramref name="thing"/> is not an <see cref="ReferenceSource"/>
        /// </exception>
        private static ReferenceSource VerifyThingArgument(Thing thing)
        {
            if (thing == null)
            {
