...
namespace CDP4Common.DTO
{
    ...
    /// <summary>
    /// A Data Transfer Object representation of the <see cref="NotExpression"/> class.
    /// </summary>
    [DataContract]
    ...
    public partial class NotExpression : BooleanExpression
    {
        ...
        /// The revision number.
        /// </param>
        public NotExpression(Guid iid, int rev) : base(iid: iid, rev: rev)
        {
        }

        /// <summary>
        /// Gets or sets the unique identifier of the referenced Term.
        /// </summary>
        ...
        /// <summary>
        /// Gets the route for the current <see ref="NotExpression"/>.
        /// </summary>
            ...
            foreach (var referencedProperty in this.GetReferenceProperties())
            {
                switch (referencedProperty.Key)
                {
                    ...
                    case "Term":
                        ...
                        {
                            errors.Add($"Removed reference '{referencedProperty.Key}' from Term property results in inconsistent NotExpression.");
                            result = false;
                        }
                        break;
                }
        ...
        /// <summary>
        /// Instantiate a <see cref="CDP4Common.EngineeringModelData.NotExpression"/> from a <see cref="NotExpression"/>
        /// </summary>
        /// <param name="cache">The cache that stores all the <see cref="CommonData.Thing"/>s</param>.
        /// <param name="uri">The <see cref="Uri"/> of the <see cref="CDP4Common.EngineeringModelData.NotExpression"/></param>.
        /// <returns>A new <see cref="CommonData.Thing"/></returns>
        public override CommonData.Thing InstantiatePoco(ConcurrentDictionary<CacheKey, Lazy<CommonData.Thing>> cache, Uri uri)
        {
            return new CDP4Common.EngineeringModelData.NotExpression(this.Iid, cache, uri);
        }
        ...
        {
            var original = originalThing as NotExpression;
            if (original == null)
            {
            ...
            var copyTerm = originalCopyMap.SingleOrDefault(kvp => kvp.Key.Iid == original.Term);
            this.Term = copyTerm.Value == null ? original.Term : copyTerm.Value.Iid;
