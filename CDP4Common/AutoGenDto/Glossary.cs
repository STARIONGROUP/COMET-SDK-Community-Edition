// --------------------------------------------------------------------------------------------------------------------
// <copyright file="Glossary.cs" company="Starion Group S.A.">
...
namespace CDP4Common.DTO
{
    ...
    /// <summary>
    /// A Data Transfer Object representation of the <see cref="Glossary"/> class.
    /// </summary>
    [DataContract]
    [Container(typeof(ReferenceDataLibrary), "Glossary")]
    public partial class Glossary : DefinedThing, ICategorizableThing, IDeprecatableThing
    {
        /// <summary>
        ...
        /// The revision number.
        /// </param>
        public Glossary(Guid iid, int rev) : base(iid: iid, rev: rev)
        {
            this.Category = new List<Guid>();
            this.Term = new List<Guid>();
        }
        ...
        /// <summary>
        /// Gets or sets the unique identifiers of the contained Term instances.
        /// </summary>
        ...
        /// <summary>
        /// Instantiate a <see cref="CDP4Common.SiteDirectoryData.Glossary"/> from a <see cref="Glossary"/>
        /// </summary>
        /// <param name="cache">The cache that stores all the <see cref="CommonData.Thing"/>s</param>.
        /// <param name="uri">The <see cref="Uri"/> of the <see cref="CDP4Common.SiteDirectoryData.Glossary"/></param>.
        /// <returns>A new <see cref="CommonData.Thing"/></returns>
        public override CommonData.Thing InstantiatePoco(ConcurrentDictionary<CacheKey, Lazy<CommonData.Thing>> cache, Uri uri)
        {
            return new CDP4Common.SiteDirectoryData.Glossary(this.Iid, cache, uri);
        }
        ...
        {
            var original = originalThing as Glossary;
            if (original == null)
            {
