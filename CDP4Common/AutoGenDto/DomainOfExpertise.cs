...
namespace CDP4Common.DTO
{
    ...
    /// <summary>
    /// A Data Transfer Object representation of the <see cref="DomainOfExpertise"/> class.
    /// </summary>
    [DataContract]
    ...
    public partial class DomainOfExpertise : DefinedThing, ICategorizableThing, IDeprecatableThing
    {
        ...
        /// The revision number.
        /// </param>
        public DomainOfExpertise(Guid iid, int rev) : base(iid: iid, rev: rev)
        {
            this.Category = new List<Guid>();
        }
        ...
        /// <summary>
        /// Instantiate a <see cref="CDP4Common.SiteDirectoryData.DomainOfExpertise"/> from a <see cref="DomainOfExpertise"/>
        /// </summary>
        /// <param name="cache">The cache that stores all the <see cref="CommonData.Thing"/>s</param>.
        /// <param name="uri">The <see cref="Uri"/> of the <see cref="CDP4Common.SiteDirectoryData.DomainOfExpertise"/></param>.
        /// <returns>A new <see cref="CommonData.Thing"/></returns>
        public override CommonData.Thing InstantiatePoco(ConcurrentDictionary<CacheKey, Lazy<CommonData.Thing>> cache, Uri uri)
        {
            return new CDP4Common.SiteDirectoryData.DomainOfExpertise(this.Iid, cache, uri);
        }
        ...
        {
            var original = originalThing as DomainOfExpertise;
            if (original == null)
            {
