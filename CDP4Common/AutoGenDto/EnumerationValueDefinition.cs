...
namespace CDP4Common.DTO
{
    ...
    /// <summary>
    /// A Data Transfer Object representation of the <see cref="EnumerationValueDefinition"/> class.
    /// </summary>
    [DataContract]
    ...
    public partial class EnumerationValueDefinition : DefinedThing
    {
        ...
        /// The revision number.
        /// </param>
        public EnumerationValueDefinition(Guid iid, int rev) : base(iid: iid, rev: rev)
        {
        }
        ...
        /// <summary>
        /// Instantiate a <see cref="CDP4Common.SiteDirectoryData.EnumerationValueDefinition"/> from a <see cref="EnumerationValueDefinition"/>
        /// </summary>
        /// <param name="cache">The cache that stores all the <see cref="CommonData.Thing"/>s</param>.
        /// <param name="uri">The <see cref="Uri"/> of the <see cref="CDP4Common.SiteDirectoryData.EnumerationValueDefinition"/></param>.
        /// <returns>A new <see cref="CommonData.Thing"/></returns>
        public override CommonData.Thing InstantiatePoco(ConcurrentDictionary<CacheKey, Lazy<CommonData.Thing>> cache, Uri uri)
        {
            return new CDP4Common.SiteDirectoryData.EnumerationValueDefinition(this.Iid, cache, uri);
        }
        ...
        {
            var original = originalThing as EnumerationValueDefinition;
            if (original == null)
            {
