...
namespace CDP4Common.DTO
{
    ...
    /// <summary>
    /// A Data Transfer Object representation of the <see cref="ParticipantPermission"/> class.
    /// </summary>
    [DataContract]
    ...
    public partial class ParticipantPermission : Thing, IDeprecatableThing
    {
        ...
        /// The revision number.
        /// </param>
        public ParticipantPermission(Guid iid, int rev) : base(iid: iid, rev: rev)
        {
        }
        ...
        /// <summary>
        /// Instantiate a <see cref="CDP4Common.SiteDirectoryData.ParticipantPermission"/> from a <see cref="ParticipantPermission"/>
        /// </summary>
        /// <param name="cache">The cache that stores all the <see cref="CommonData.Thing"/>s</param>.
        /// <param name="uri">The <see cref="Uri"/> of the <see cref="CDP4Common.SiteDirectoryData.ParticipantPermission"/></param>.
        /// <returns>A new <see cref="CommonData.Thing"/></returns>
        public override CommonData.Thing InstantiatePoco(ConcurrentDictionary<CacheKey, Lazy<CommonData.Thing>> cache, Uri uri)
        {
            return new CDP4Common.SiteDirectoryData.ParticipantPermission(this.Iid, cache, uri);
        }
        ...
        {
            var original = originalThing as ParticipantPermission;
            if (original == null)
            {
                throw new InvalidOperationException("The originalThing cannot be null or is of the incorrect type");
            }

            this.AccessRight = original.AccessRight;
