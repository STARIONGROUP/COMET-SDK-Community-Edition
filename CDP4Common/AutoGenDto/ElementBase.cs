...
namespace CDP4Common.DTO
{
    ...
    /// <summary>
    /// A Data Transfer Object representation of the <see cref="ElementBase"/> class.
    /// </summary>
    [DataContract]
    public abstract partial class ElementBase : DefinedThing, ICategorizableThing, IOwnedThing
    {
        ...
        /// The revision number.
        /// </param>
        protected ElementBase(Guid iid, int rev) : base(iid: iid, rev: rev)
        {
            this.Category = new List<Guid>();
        }
            ...
            foreach (var referencedProperty in this.GetReferenceProperties())
            {
                switch (referencedProperty.Key)
                {
                    ...
                    case "Owner":
                        ...
                        {
                            errors.Add($"Removed reference '{referencedProperty.Key}' from Owner property results in inconsistent ElementBase.");
                            result = false;
                        }
                        break;
                }
