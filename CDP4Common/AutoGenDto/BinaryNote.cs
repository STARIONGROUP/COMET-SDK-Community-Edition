...
namespace CDP4Common.DTO
{
    ...
    /// <summary>
    /// A Data Transfer Object representation of the <see cref="BinaryNote"/> class.
    /// </summary>
    [DataContract]
    [CDPVersion("1.1.0")]
    ...
    public partial class BinaryNote : Note
    {
        ...
        /// The revision number.
        /// </param>
        public BinaryNote(Guid iid, int rev) : base(iid: iid, rev: rev)
        {
        }
        ...
        /// <summary>
        /// Gets or sets the unique identifier of the referenced FileType.
        /// </summary>
        [UmlInformation(aggregation: AggregationKind.None, isDerived: false, isOrdered: false, isNullable: false, isPersistent: true)]
        [DataMember]
        ...
        /// <summary>
        /// Gets the route for the current <see ref="BinaryNote"/>.
        /// </summary>
            ...
            foreach (var referencedProperty in this.GetReferenceProperties())
            {
                switch (referencedProperty.Key)
                {
                    ...
                    case "FileType":
                        ...
                        {
                            errors.Add($"Removed reference '{referencedProperty.Key}' from FileType property results in inconsistent BinaryNote.");
                            result = false;
                        }
                        break;
                    ...
                    case "Owner":
                        if (referencedProperty.Value.Except(ids).Any())
                        {
                            errors.Add($"Removed reference '{referencedProperty.Key}' from Owner property results in inconsistent BinaryNote.");
                            result = false;
                        }
                        break;
                }
        ...
        /// <summary>
        /// Instantiate a <see cref="CDP4Common.ReportingData.BinaryNote"/> from a <see cref="BinaryNote"/>
        /// </summary>
        /// <param name="cache">The cache that stores all the <see cref="CommonData.Thing"/>s</param>.
        /// <param name="uri">The <see cref="Uri"/> of the <see cref="CDP4Common.ReportingData.BinaryNote"/></param>.
        /// <returns>A new <see cref="CommonData.Thing"/></returns>
        public override CommonData.Thing InstantiatePoco(ConcurrentDictionary<CacheKey, Lazy<CommonData.Thing>> cache, Uri uri)
        {
            return new CDP4Common.ReportingData.BinaryNote(this.Iid, cache, uri);
        }
        ...
        {
            var original = originalThing as BinaryNote;
            if (original == null)
            {
            ...
            var copyFileType = originalCopyMap.SingleOrDefault(kvp => kvp.Key.Iid == original.FileType);
            this.FileType = copyFileType.Value == null ? original.FileType : copyFileType.Value.Iid;
        ...
        public override bool ResolveCopyReference(IReadOnlyDictionary<Thing, Thing> originalCopyMap)
        {
            ...
            var copyFileType = originalCopyMap.SingleOrDefault(kvp => kvp.Key.Iid == this.FileType);
            if (copyFileType.Key != null)
            {
                this.FileType = copyFileType.Value.Iid;
                hasChanges = true;
            }
