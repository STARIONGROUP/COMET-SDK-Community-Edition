// --------------------------------------------------------------------------------------------------------------------
// <copyright file="IntervalScale.cs" company="Starion Group S.A.">
...
namespace CDP4Common.DTO
{
    ...
    /// <summary>
    /// A Data Transfer Object representation of the <see cref="IntervalScale"/> class.
    /// </summary>
    [DataContract]
    ...
    public partial class IntervalScale : MeasurementScale
    {
        ...
        /// The revision number.
        /// </param>
        public IntervalScale(Guid iid, int rev) : base(iid: iid, rev: rev)
        {
        }

        /// <summary>
        /// Gets the route for the current <see ref="IntervalScale"/>.
        /// </summary>
            ...
            foreach (var referencedProperty in this.GetReferenceProperties())
            {
                switch (referencedProperty.Key)
                {
                    ...
                    case "Unit":
                        ...
                        {
                            errors.Add($"Removed reference '{referencedProperty.Key}' from Unit property results in inconsistent IntervalScale.");
                            result = false;
                        }
                        break;
        ...
        /// <summary>
        /// Instantiate a <see cref="CDP4Common.SiteDirectoryData.IntervalScale"/> from a <see cref="IntervalScale"/>
        /// </summary>
        /// <param name="cache">The cache that stores all the <see cref="CommonData.Thing"/>s</param>.
        /// <param name="uri">The <see cref="Uri"/> of the <see cref="CDP4Common.SiteDirectoryData.IntervalScale"/></param>.
        /// <returns>A new <see cref="CommonData.Thing"/></returns>
        public override CommonData.Thing InstantiatePoco(ConcurrentDictionary<CacheKey, Lazy<CommonData.Thing>> cache, Uri uri)
        {
            return new CDP4Common.SiteDirectoryData.IntervalScale(this.Iid, cache, uri);
        }
        ...
        {
            var original = originalThing as IntervalScale;
            if (original == null)
            {
