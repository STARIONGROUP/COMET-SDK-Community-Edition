...
namespace CDP4Common.DTO
{
    ...
    /// <summary>
    /// A Data Transfer Object representation of the <see cref="Behavior"/> class.
    /// </summary>
    [DataContract]
    [CDPVersion("1.4.0")]
    ...
    public partial class Behavior : DefinedThing
    {
        ...
        public Behavior()
        {
            this.BehavioralParameter = new List<Guid>();
        }
        ...
        /// <summary>
        /// Gets the route for the current <see ref="Behavior"/>.
        /// </summary>
        ...
        public override IDictionary<string, IEnumerable<Guid>> GetReferenceProperties()
        {
            ...
            dictionary.Add("BehavioralParameter", this.BehavioralParameter);
                    ...
                    foreach (var kvp in foundProperty)
                    {
                        switch (kvp.Key)
                        {
                            ...
                            case "BehavioralParameter":
                                this.BehavioralParameter.Remove(id);
                                break;
            ...
            foreach (var referencedProperty in this.GetReferenceProperties())
            {
                switch (referencedProperty.Key)
                {
                    ...
                    case "BehavioralParameter":
                        foreach (var toBeRemoved in referencedProperty.Value.Except(ids).ToList())
                        {
                            this.BehavioralParameter.Remove(toBeRemoved);
                        } 
                        break;
        ...
        /// <summary>
        /// Instantiate a <see cref="CDP4Common.EngineeringModelData.Behavior"/> from a <see cref="Behavior"/>
        /// </summary>
        /// <param name="cache">The cache that stores all the <see cref="CommonData.Thing"/>s</param>.
        /// <param name="uri">The <see cref="Uri"/> of the <see cref="CDP4Common.EngineeringModelData.Behavior"/></param>.
