// --------------------------------------------------------------------------------------------------------------------
// <copyright file="UserRuleVerification.cs" company="Starion Group S.A.">
            ...
            foreach (var referencedProperty in this.GetReferenceProperties())
            {
                switch (referencedProperty.Key)
                {
                    ...
                    case "Rule":
                        ...
                        {
                            errors.Add($"Removed reference '{referencedProperty.Key}' from Rule property results in inconsistent UserRuleVerification.");
                            result = false;
                        }
                        break;
                }
