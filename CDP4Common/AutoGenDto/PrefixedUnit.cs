// --------------------------------------------------------------------------------------------------------------------
// <copyright file="PrefixedUnit.cs" company="Starion Group S.A.">
...
namespace CDP4Common.DTO
{
    ...
    public partial class PrefixedUnit : ConversionBasedUnit
    {
        /// <summary>
            ...
            foreach (var referencedProperty in this.GetReferenceProperties())
            {
                switch (referencedProperty.Key)
                {
                    ...
                    case "Prefix":
                        ...
                        {
                            errors.Add($"Removed reference '{referencedProperty.Key}' from Prefix property results in inconsistent PrefixedUnit.");
                            result = false;
                        }
                        break;
                    ...
                    case "ReferenceUnit":
                        if (referencedProperty.Value.Except(ids).Any())
                        {
                            errors.Add($"Removed reference '{referencedProperty.Key}' from ReferenceUnit property results in inconsistent PrefixedUnit.");
                            result = false;
                        }
                        break;
                }
