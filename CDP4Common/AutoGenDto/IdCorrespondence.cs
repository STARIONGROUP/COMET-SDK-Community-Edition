...
namespace CDP4Common.DTO
{
    ...
    /// <summary>
    /// A Data Transfer Object representation of the <see cref="IdCorrespondence"/> class.
    /// </summary>
    [DataContract]
    ...
    public sealed partial class IdCorrespondence : Thing, IOwnedThing
    {
        ...
        /// The revision number.
        /// </param>
        public IdCorrespondence(Guid iid, int rev) : base(iid: iid, rev: rev)
        {
        }
        ...
        /// <summary>
        /// Gets or sets the unique identifier of the referenced InternalThing.
        /// </summary>
        [UmlInformation(aggregation: AggregationKind.None, isDerived: false, isOrdered: false, isNullable: false, isPersistent: true)]
        [DataMember]
        ...
        public Guid Owner
        {
            get { throw new InvalidOperationException("Forbidden Get value for the derived property IdCorrespondence.Owner"); }
        ...
        /// <summary>
        /// Instantiate a <see cref="CDP4Common.EngineeringModelData.IdCorrespondence"/> from a <see cref="IdCorrespondence"/>
        /// </summary>
        /// <param name="cache">The cache that stores all the <see cref="CommonData.Thing"/>s</param>.
        /// <param name="uri">The <see cref="Uri"/> of the <see cref="CDP4Common.EngineeringModelData.IdCorrespondence"/></param>.
        ...
        {
            return new CDP4Common.EngineeringModelData.IdCorrespondence(this.Iid, cache, uri);
        }
        ...
        {
            var original = originalThing as IdCorrespondence;
            if (original == null)
            {
            ...
            this.ExternalId = original.ExternalId;

            this.InternalThing = original.InternalThing;
