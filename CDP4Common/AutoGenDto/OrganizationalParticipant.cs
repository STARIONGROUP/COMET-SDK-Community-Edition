...
namespace CDP4Common.DTO
{
    ...
    /// <summary>
    /// A Data Transfer Object representation of the <see cref="OrganizationalParticipant"/> class.
    /// </summary>
    [DataContract]
    [CDPVersion("1.2.0")]
    ...
    public partial class OrganizationalParticipant : Thing
    {
        ...
        /// The revision number.
        /// </param>
        public OrganizationalParticipant(Guid iid, int rev) : base(iid: iid, rev: rev)
        {
        }
        ...
        /// <summary>
        /// Gets the route for the current <see ref="OrganizationalParticipant"/>.
        /// </summary>
            ...
            foreach (var referencedProperty in this.GetReferenceProperties())
            {
                switch (referencedProperty.Key)
                {
                    ...
                    case "Organization":
                        ...
                        {
                            errors.Add($"Removed reference '{referencedProperty.Key}' from Organization property results in inconsistent OrganizationalParticipant.");
                            result = false;
                        }
                        break;
                }
        ...
        /// <summary>
        /// Instantiate a <see cref="CDP4Common.SiteDirectoryData.OrganizationalParticipant"/> from a <see cref="OrganizationalParticipant"/>
        /// </summary>
        /// <param name="cache">The cache that stores all the <see cref="CommonData.Thing"/>s</param>.
        /// <param name="uri">The <see cref="Uri"/> of the <see cref="CDP4Common.SiteDirectoryData.OrganizationalParticipant"/></param>.
        /// <returns>A new <see cref="CommonData.Thing"/></returns>
        public override CommonData.Thing InstantiatePoco(ConcurrentDictionary<CacheKey, Lazy<CommonData.Thing>> cache, Uri uri)
        {
            return new CDP4Common.SiteDirectoryData.OrganizationalParticipant(this.Iid, cache, uri);
        }
        ...
        {
            var original = originalThing as OrganizationalParticipant;
            if (original == null)
            {
