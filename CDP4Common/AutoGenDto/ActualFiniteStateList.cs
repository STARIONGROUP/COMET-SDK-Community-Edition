            ...
            foreach (var referencedProperty in this.GetReferenceProperties())
            {
                switch (referencedProperty.Key)
                {
                    case "ActualState":
                        ...
                        {
                            this.ActualState.Remove(toBeRemoved);
                        } 
                        break;
                    ...
                    case "Owner":
                        ...
                        {
                            errors.Add($"Removed reference '{referencedProperty.Key}' from Owner property results in inconsistent ActualFiniteStateList.");
                            result = false;
                        }
                        break;
                }
