// --------------------------------------------------------------------------------------------------------------------
// <copyright file="MappingToReferenceScale.cs" company="Starion Group S.A.">
            ...
            foreach (var referencedProperty in this.GetReferenceProperties())
            {
                switch (referencedProperty.Key)
                {
                    case "DependentScaleValue":
                        ...
                        {
                            errors.Add($"Removed reference '{referencedProperty.Key}' from DependentScaleValue property results in inconsistent MappingToReferenceScale.");
                            result = false;
                        }
                        break;
                    ...
                    case "ReferenceScaleValue":
                        if (referencedProperty.Value.Except(ids).Any())
                        {
                            errors.Add($"Removed reference '{referencedProperty.Key}' from ReferenceScaleValue property results in inconsistent MappingToReferenceScale.");
                            result = false;
                        }
                        break;
                }
