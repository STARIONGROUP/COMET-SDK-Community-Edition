...
namespace CDP4Common.DTO
{
    ...
    public partial class BehavioralParameter : Thing
    {
        /// <summary>
                    ...
                    foreach (var kvp in foundProperty)
                    {
                        switch (kvp.Key)
                        {
                            ...
                            case "Parameter":
                                if (addModelErrors)
                                {
                                    errors.Add($"Removed reference '{id}' from Parameter property results in inconsistent BehavioralParameter.");
                                    result = false;
                                }
                                break;
                        }
            ...
            foreach (var referencedProperty in this.GetReferenceProperties())
            {
                switch (referencedProperty.Key)
                {
                    ...
                    case "Parameter":
                        ...
                        {
                            errors.Add($"Removed reference '{referencedProperty.Key}' from Parameter property results in inconsistent BehavioralParameter.");
                            result = false;
                        }
                        break;
                }
