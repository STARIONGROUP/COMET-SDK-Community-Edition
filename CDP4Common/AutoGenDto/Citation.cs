// --------------------------------------------------------------------------------------------------------------------
// <copyright file="Citation.cs" company="Starion Group S.A.">
...
namespace CDP4Common.DTO
{
    ...
    /// <summary>
    /// A Data Transfer Object representation of the <see cref="Citation"/> class.
    /// </summary>
    [DataContract]
    ...
    public partial class Citation : Thing, IShortNamedThing
    {
        ...
        /// The revision number.
        /// </param>
        public Citation(Guid iid, int rev) : base(iid: iid, rev: rev)
        {
        }
            ...
            foreach (var referencedProperty in this.GetReferenceProperties())
            {
                switch (referencedProperty.Key)
                {
                    ...
                    case "Source":
                        ...
                        {
                            errors.Add($"Removed reference '{referencedProperty.Key}' from Source property results in inconsistent Citation.");
                            result = false;
                        }
                        break;
                }
        ...
        /// <summary>
        /// Instantiate a <see cref="CDP4Common.CommonData.Citation"/> from a <see cref="Citation"/>
        /// </summary>
        /// <param name="cache">The cache that stores all the <see cref="CommonData.Thing"/>s</param>.
        /// <param name="uri">The <see cref="Uri"/> of the <see cref="CDP4Common.CommonData.Citation"/></param>.
        /// <returns>A new <see cref="CommonData.Thing"/></returns>
        public override CommonData.Thing InstantiatePoco(ConcurrentDictionary<CacheKey, Lazy<CommonData.Thing>> cache, Uri uri)
        {
            return new CDP4Common.CommonData.Citation(this.Iid, cache, uri);
        }
        ...
        {
            var original = originalThing as Citation;
            if (original == null)
            {
            ...
            this.IsAdaptation = original.IsAdaptation;
        ...
        public override bool ResolveCopyReference(IReadOnlyDictionary<Thing, Thing> originalCopyMap)
        {
            ...
            var copySource = originalCopyMap.SingleOrDefault(kvp => kvp.Key.Iid == this.Source);
            if (copySource.Key != null)
            {
                this.Source = copySource.Value.Iid;
                hasChanges = true;
            }
