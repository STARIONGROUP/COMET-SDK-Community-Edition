...
namespace CDP4Common.DTO
{
    ...
    /// <summary>
    /// A Data Transfer Object representation of the <see cref="Option"/> class.
    /// </summary>
    [DataContract]
    ...
    public partial class Option : DefinedThing, ICategorizableThing
    {
        ...
        public Option()
        {
            ...
            this.NestedElement = new List<Guid>();
        }
        ...
        /// The revision number.
        /// </param>
        public Option(Guid iid, int rev) : base(iid: iid, rev: rev)
        {
            this.Category = new List<Guid>();
            this.NestedElement = new List<Guid>();
        }
        ...
        /// <summary>
        /// Gets or sets the unique identifiers of the contained NestedElement instances.
        /// </summary>
        [UmlInformation(aggregation: AggregationKind.Composite, isDerived: false, isOrdered: false, isNullable: false, isPersistent: true)]
        [DataMember]
        public List<Guid> NestedElement { get; set; }
        ...
        public override IDictionary<string, IEnumerable<Guid>> GetReferenceProperties()
        {
            ...
            dictionary.Add("NestedElement", this.NestedElement);
            ...
            foreach (var referencedProperty in this.GetReferenceProperties())
            {
                switch (referencedProperty.Key)
                {
                    ...
                    case "NestedElement":
                        foreach (var toBeRemoved in referencedProperty.Value.Except(ids).ToList())
                        {
                            this.NestedElement.Remove(toBeRemoved);
                        } 
                        break;
                }
            }
        ...
        /// <summary>
        /// Instantiate a <see cref="CDP4Common.EngineeringModelData.Option"/> from a <see cref="Option"/>
        /// </summary>
        /// <param name="cache">The cache that stores all the <see cref="CommonData.Thing"/>s</param>.
        /// <param name="uri">The <see cref="Uri"/> of the <see cref="CDP4Common.EngineeringModelData.Option"/></param>.
        /// <returns>A new <see cref="CommonData.Thing"/></returns>
        public override CommonData.Thing InstantiatePoco(ConcurrentDictionary<CacheKey, Lazy<CommonData.Thing>> cache, Uri uri)
        {
            return new CDP4Common.EngineeringModelData.Option(this.Iid, cache, uri);
        }
        ...
        {
            var original = originalThing as Option;
            if (original == null)
            {
            ...
            foreach (var guid in original.NestedElement)
            {
                var copy = originalCopyMap.SingleOrDefault(kvp => kvp.Key.Iid == guid);
                if (Equals(copy, default(KeyValuePair<Thing, Thing>)))
                {
                ...
                this.NestedElement.Add(copy.Value.Iid);
            }
