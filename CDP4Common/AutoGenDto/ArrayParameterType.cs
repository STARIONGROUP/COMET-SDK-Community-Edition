// --------------------------------------------------------------------------------------------------------------------
// <copyright file="ArrayParameterType.cs" company="Starion Group S.A.">
...
namespace CDP4Common.DTO
{
    ...
    /// <summary>
    /// A Data Transfer Object representation of the <see cref="ArrayParameterType"/> class.
    /// </summary>
    [DataContract]
    ...
    public partial class ArrayParameterType : CompoundParameterType
    {
        ...
        {
            this.Dimension = new List<OrderedItem>();
        }
        ...
        /// The revision number.
        /// </param>
        public ArrayParameterType(Guid iid, int rev) : base(iid: iid, rev: rev)
        {
            this.Dimension = new List<OrderedItem>();
        }
        ...
        [DataMember]
        public List<OrderedItem> Dimension { get; set; }
        ...
        /// <summary>
        /// Gets the route for the current <see ref="ArrayParameterType"/>.
        /// </summary>
        ...
        /// <summary>
        /// Instantiate a <see cref="CDP4Common.SiteDirectoryData.ArrayParameterType"/> from a <see cref="ArrayParameterType"/>
        /// </summary>
        /// <param name="cache">The cache that stores all the <see cref="CommonData.Thing"/>s</param>.
        /// <param name="uri">The <see cref="Uri"/> of the <see cref="CDP4Common.SiteDirectoryData.ArrayParameterType"/></param>.
        /// <returns>A new <see cref="CommonData.Thing"/></returns>
        public override CommonData.Thing InstantiatePoco(ConcurrentDictionary<CacheKey, Lazy<CommonData.Thing>> cache, Uri uri)
        {
            return new CDP4Common.SiteDirectoryData.ArrayParameterType(this.Iid, cache, uri);
        }
        ...
        {
            var original = originalThing as ArrayParameterType;
            if (original == null)
            {
            ...
            this.IsTensor = original.IsTensor;
