// --------------------------------------------------------------------------------------------------------------------
// <copyright file="CommonFileStore.cs" company="Starion Group S.A.">
...
namespace CDP4Common.DTO
{
    ...
    /// <summary>
    /// A Data Transfer Object representation of the <see cref="CommonFileStore"/> class.
    /// </summary>
    [DataContract]
    ...
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CommonFileStore"/> class.
        /// </summary>
        ...
        /// The revision number.
        /// </param>
        public CommonFileStore(Guid iid, int rev) : base(iid: iid, rev: rev)
        {
        }
            ...
            foreach (var referencedProperty in this.GetReferenceProperties())
            {
                switch (referencedProperty.Key)
                {
                    ...
                    case "Owner":
                        ...
                        {
                            errors.Add($"Removed reference '{referencedProperty.Key}' from Owner property results in inconsistent CommonFileStore.");
                            result = false;
                        }
                        break;
                }
        ...
        /// <summary>
        /// Instantiate a <see cref="CDP4Common.EngineeringModelData.CommonFileStore"/> from a <see cref="CommonFileStore"/>
        /// </summary>
        /// <param name="cache">The cache that stores all the <see cref="CommonData.Thing"/>s</param>.
        /// <param name="uri">The <see cref="Uri"/> of the <see cref="CDP4Common.EngineeringModelData.CommonFileStore"/></param>.
        /// <returns>A new <see cref="CommonData.Thing"/></returns>
        public override CommonData.Thing InstantiatePoco(ConcurrentDictionary<CacheKey, Lazy<CommonData.Thing>> cache, Uri uri)
        {
            return new CDP4Common.EngineeringModelData.CommonFileStore(this.Iid, cache, uri);
        }
        ...
        {
            var original = originalThing as CommonFileStore;
            if (original == null)
            {
