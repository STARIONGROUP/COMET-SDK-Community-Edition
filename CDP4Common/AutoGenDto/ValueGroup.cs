// --------------------------------------------------------------------------------------------------------------------
// <copyright file="ValueGroup.cs" company="Starion Group S.A.">
...
namespace CDP4Common.DTO
{
    ...
    /// <summary>
    /// A Data Transfer Object representation of the <see cref="ValueGroup"/> class.
    /// </summary>
    [DataContract]
    [CDPVersion("1.1.0")]
    ...
    public partial class ValueGroup : DefinedThing, ICategorizableThing
    {
        ...
        /// The revision number.
        /// </param>
        public ValueGroup(Guid iid, int rev) : base(iid: iid, rev: rev)
        {
            this.Category = new List<Guid>();
        }
        ...
        /// <summary>
        /// Instantiate a <see cref="CDP4Common.EngineeringModelData.ValueGroup"/> from a <see cref="ValueGroup"/>
        /// </summary>
        /// <param name="cache">The cache that stores all the <see cref="CommonData.Thing"/>s</param>.
        /// <param name="uri">The <see cref="Uri"/> of the <see cref="CDP4Common.EngineeringModelData.ValueGroup"/></param>.
        /// <returns>A new <see cref="CommonData.Thing"/></returns>
        public override CommonData.Thing InstantiatePoco(ConcurrentDictionary<CacheKey, Lazy<CommonData.Thing>> cache, Uri uri)
        {
            return new CDP4Common.EngineeringModelData.ValueGroup(this.Iid, cache, uri);
        }
        ...
        {
            var original = originalThing as ValueGroup;
            if (original == null)
            {
