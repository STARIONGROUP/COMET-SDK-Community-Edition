...
namespace CDP4Common.DTO
{
    ...
    /// <summary>
    /// A Data Transfer Object representation of the <see cref="MultiRelationship"/> class.
    /// </summary>
    [DataContract]
    ...
    public partial class MultiRelationship : Relationship
    {
        ...
        /// The revision number.
        /// </param>
        public MultiRelationship(Guid iid, int rev) : base(iid: iid, rev: rev)
        {
            this.RelatedThing = new List<Guid>();
        }

        /// <summary>
        /// Gets or sets the list of unique identifiers of the referenced RelatedThing instances.
        /// </summary>
        ...
        /// <summary>
        /// Gets the route for the current <see ref="MultiRelationship"/>.
        /// </summary>
            ...
            foreach (var referencedProperty in this.GetReferenceProperties())
            {
                switch (referencedProperty.Key)
                {
                    ...
                    case "Owner":
                        ...
                        {
                            errors.Add($"Removed reference '{referencedProperty.Key}' from Owner property results in inconsistent MultiRelationship.");
                            result = false;
                        }
                        break;
        ...
        /// <summary>
        /// Instantiate a <see cref="CDP4Common.EngineeringModelData.MultiRelationship"/> from a <see cref="MultiRelationship"/>
        /// </summary>
        /// <param name="cache">The cache that stores all the <see cref="CommonData.Thing"/>s</param>.
        /// <param name="uri">The <see cref="Uri"/> of the <see cref="CDP4Common.EngineeringModelData.MultiRelationship"/></param>.
        /// <returns>A new <see cref="CommonData.Thing"/></returns>
        public override CommonData.Thing InstantiatePoco(ConcurrentDictionary<CacheKey, Lazy<CommonData.Thing>> cache, Uri uri)
        {
            return new CDP4Common.EngineeringModelData.MultiRelationship(this.Iid, cache, uri);
        }
        ...
        {
            var original = originalThing as MultiRelationship;
            if (original == null)
            {
            ...
            {
                var copy = originalCopyMap.SingleOrDefault(kvp => kvp.Key.Iid == guid);
                this.RelatedThing.Add(copy.Value == null ? guid : copy.Value.Iid);
            }
