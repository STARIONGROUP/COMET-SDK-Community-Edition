// --------------------------------------------------------------------------------------------------------------------
// <copyright file="SimpleParameterValue.cs" company="Starion Group S.A.">
...
namespace CDP4Common.DTO
{
    ...
    /// <summary>
    /// A Data Transfer Object representation of the <see cref="SimpleParameterValue"/> class.
    /// </summary>
    [DataContract]
    ...
    public partial class SimpleParameterValue : Thing, IOwnedThing
    {
        ...
        /// The revision number.
        /// </param>
        public SimpleParameterValue(Guid iid, int rev) : base(iid: iid, rev: rev)
        {
            this.Value = new ValueArray<string>();
        }
        ...
        public Guid Owner
        {
            get { throw new InvalidOperationException("Forbidden Get value for the derived property SimpleParameterValue.Owner"); }
                    ...
                    foreach (var kvp in foundProperty)
                    {
                        switch (kvp.Key)
                        {
                            ...
                            case "ParameterType":
                                if (addModelErrors)
                                {
                                    errors.Add($"Removed reference '{id}' from ParameterType property results in inconsistent SimpleParameterValue.");
                                    result = false;
                                }
                                break;
            ...
            foreach (var referencedProperty in this.GetReferenceProperties())
            {
                switch (referencedProperty.Key)
                {
                    ...
                    case "ParameterType":
                        ...
                        {
                            errors.Add($"Removed reference '{referencedProperty.Key}' from ParameterType property results in inconsistent SimpleParameterValue.");
                            result = false;
                        }
                        break;
        ...
        /// <summary>
        /// Instantiate a <see cref="CDP4Common.EngineeringModelData.SimpleParameterValue"/> from a <see cref="SimpleParameterValue"/>
        /// </summary>
        /// <param name="cache">The cache that stores all the <see cref="CommonData.Thing"/>s</param>.
        /// <param name="uri">The <see cref="Uri"/> of the <see cref="CDP4Common.EngineeringModelData.SimpleParameterValue"/></param>.
        /// <returns>A new <see cref="CommonData.Thing"/></returns>
        public override CommonData.Thing InstantiatePoco(ConcurrentDictionary<CacheKey, Lazy<CommonData.Thing>> cache, Uri uri)
        {
            return new CDP4Common.EngineeringModelData.SimpleParameterValue(this.Iid, cache, uri);
        }
        ...
        {
            var original = originalThing as SimpleParameterValue;
            if (original == null)
            {
