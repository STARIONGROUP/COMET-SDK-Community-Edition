// --------------------------------------------------------------------------------------------------------------------
// <copyright file="EnumerationParameterType.cs" company="Starion Group S.A.">
...
namespace CDP4Common.DTO
{
    ...
    /// <summary>
    /// A Data Transfer Object representation of the <see cref="EnumerationParameterType"/> class.
    /// </summary>
    [DataContract]
    ...
    public partial class EnumerationParameterType : ScalarParameterType
    {
        ...
        {
            this.ValueDefinition = new List<OrderedItem>();
        }
        ...
        /// The revision number.
        /// </param>
        public EnumerationParameterType(Guid iid, int rev) : base(iid: iid, rev: rev)
        {
            this.ValueDefinition = new List<OrderedItem>();
        }
        ...
        [DataMember]
        public List<OrderedItem> ValueDefinition { get; set; }

        /// <summary>
        /// Gets the route for the current <see ref="EnumerationParameterType"/>.
        /// </summary>
        ...
        /// <summary>
        /// Instantiate a <see cref="CDP4Common.SiteDirectoryData.EnumerationParameterType"/> from a <see cref="EnumerationParameterType"/>
        /// </summary>
        /// <param name="cache">The cache that stores all the <see cref="CommonData.Thing"/>s</param>.
        /// <param name="uri">The <see cref="Uri"/> of the <see cref="CDP4Common.SiteDirectoryData.EnumerationParameterType"/></param>.
        /// <returns>A new <see cref="CommonData.Thing"/></returns>
        public override CommonData.Thing InstantiatePoco(ConcurrentDictionary<CacheKey, Lazy<CommonData.Thing>> cache, Uri uri)
        {
            return new CDP4Common.SiteDirectoryData.EnumerationParameterType(this.Iid, cache, uri);
        }
        ...
        {
            var original = originalThing as EnumerationParameterType;
            if (original == null)
            {
            ...
            this.AllowMultiSelect = original.AllowMultiSelect;
            ...
            foreach (var orderedItem in original.ValueDefinition)
            {
