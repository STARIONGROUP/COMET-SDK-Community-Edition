...
namespace CDP4Common.DTO
{
    ...
    /// <summary>
    /// A Data Transfer Object representation of the <see cref="DomainOfExpertiseGroup"/> class.
    /// </summary>
    [DataContract]
    ...
    public partial class DomainOfExpertiseGroup : DefinedThing, IDeprecatableThing
    {
        ...
        /// The revision number.
        /// </param>
        public DomainOfExpertiseGroup(Guid iid, int rev) : base(iid: iid, rev: rev)
        {
            this.Domain = new List<Guid>();
        }
        ...
        /// <summary>
        /// Instantiate a <see cref="CDP4Common.SiteDirectoryData.DomainOfExpertiseGroup"/> from a <see cref="DomainOfExpertiseGroup"/>
        /// </summary>
        /// <param name="cache">The cache that stores all the <see cref="CommonData.Thing"/>s</param>.
        /// <param name="uri">The <see cref="Uri"/> of the <see cref="CDP4Common.SiteDirectoryData.DomainOfExpertiseGroup"/></param>.
        /// <returns>A new <see cref="CommonData.Thing"/></returns>
        public override CommonData.Thing InstantiatePoco(ConcurrentDictionary<CacheKey, Lazy<CommonData.Thing>> cache, Uri uri)
        {
            return new CDP4Common.SiteDirectoryData.DomainOfExpertiseGroup(this.Iid, cache, uri);
        }
        ...
        {
            var original = originalThing as DomainOfExpertiseGroup;
            if (original == null)
            {
