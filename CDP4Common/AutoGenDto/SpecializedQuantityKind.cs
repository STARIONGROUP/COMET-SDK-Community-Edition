// --------------------------------------------------------------------------------------------------------------------
// <copyright file="SpecializedQuantityKind.cs" company="Starion Group S.A.">
...
namespace CDP4Common.DTO
{
    ...
    public partial class SpecializedQuantityKind : QuantityKind
    {
        /// <summary>
        ...
        public override IDictionary<string, IEnumerable<Guid>> GetReferenceProperties()
        {
            ...
            {
                dictionary.Add("General", new [] { this.General });
            }
            ...
            foreach (var referencedProperty in this.GetReferenceProperties())
            {
                switch (referencedProperty.Key)
                {
                    ...
                    case "DefaultScale":
                        ...
                        {
                            errors.Add($"Removed reference '{referencedProperty.Key}' from DefaultScale property results in inconsistent SpecializedQuantityKind.");
                            result = false;
                        }
                        break;
                    ...
                    case "General":
                        if (referencedProperty.Value.Except(ids).Any())
                        {
                            errors.Add($"Removed reference '{referencedProperty.Key}' from General property results in inconsistent SpecializedQuantityKind.");
                            result = false;
                        }
                        break;
