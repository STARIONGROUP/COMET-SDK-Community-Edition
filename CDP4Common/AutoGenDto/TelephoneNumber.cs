// --------------------------------------------------------------------------------------------------------------------
// <copyright file="TelephoneNumber.cs" company="Starion Group S.A.">
...
namespace CDP4Common.DTO
{
    ...
    /// <summary>
    /// A Data Transfer Object representation of the <see cref="TelephoneNumber"/> class.
    /// </summary>
    [DataContract]
    ...
    public partial class TelephoneNumber : Thing
    {
        ...
        /// The revision number.
        /// </param>
        public TelephoneNumber(Guid iid, int rev) : base(iid: iid, rev: rev)
        {
            this.VcardType = new List<VcardTelephoneNumberKind>();
        }
        ...
        /// <summary>
        /// Instantiate a <see cref="CDP4Common.SiteDirectoryData.TelephoneNumber"/> from a <see cref="TelephoneNumber"/>
        /// </summary>
        /// <param name="cache">The cache that stores all the <see cref="CommonData.Thing"/>s</param>.
        /// <param name="uri">The <see cref="Uri"/> of the <see cref="CDP4Common.SiteDirectoryData.TelephoneNumber"/></param>.
        /// <returns>A new <see cref="CommonData.Thing"/></returns>
        public override CommonData.Thing InstantiatePoco(ConcurrentDictionary<CacheKey, Lazy<CommonData.Thing>> cache, Uri uri)
        {
            return new CDP4Common.SiteDirectoryData.TelephoneNumber(this.Iid, cache, uri);
        }
        ...
        {
            var original = originalThing as TelephoneNumber;
            if (original == null)
            {
