// --------------------------------------------------------------------------------------------------------------------
// <copyright file="ScaleReferenceQuantityValue.cs" company="Starion Group S.A.">
...
namespace CDP4Common.DTO
{
    ...
    /// <summary>
    /// A Data Transfer Object representation of the <see cref="ScaleReferenceQuantityValue"/> class.
    /// </summary>
    [DataContract]
    ...
    public partial class ScaleReferenceQuantityValue : Thing
    {
        ...
        /// The revision number.
        /// </param>
        public ScaleReferenceQuantityValue(Guid iid, int rev) : base(iid: iid, rev: rev)
        {
        }
            ...
            foreach (var referencedProperty in this.GetReferenceProperties())
            {
                switch (referencedProperty.Key)
                {
                    ...
                    case "Scale":
                        ...
                        {
                            errors.Add($"Removed reference '{referencedProperty.Key}' from Scale property results in inconsistent ScaleReferenceQuantityValue.");
                            result = false;
                        }
                        break;
                }
        ...
        /// <summary>
        /// Instantiate a <see cref="CDP4Common.SiteDirectoryData.ScaleReferenceQuantityValue"/> from a <see cref="ScaleReferenceQuantityValue"/>
        /// </summary>
        /// <param name="cache">The cache that stores all the <see cref="CommonData.Thing"/>s</param>.
        /// <param name="uri">The <see cref="Uri"/> of the <see cref="CDP4Common.SiteDirectoryData.ScaleReferenceQuantityValue"/></param>.
        /// <returns>A new <see cref="CommonData.Thing"/></returns>
        public override CommonData.Thing InstantiatePoco(ConcurrentDictionary<CacheKey, Lazy<CommonData.Thing>> cache, Uri uri)
        {
            return new CDP4Common.SiteDirectoryData.ScaleReferenceQuantityValue(this.Iid, cache, uri);
        }
        ...
        {
            var original = originalThing as ScaleReferenceQuantityValue;
            if (original == null)
            {
