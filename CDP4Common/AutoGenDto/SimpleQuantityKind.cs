// --------------------------------------------------------------------------------------------------------------------
// <copyright file="SimpleQuantityKind.cs" company="Starion Group S.A.">
...
namespace CDP4Common.DTO
{
    ...
    /// <summary>
    /// A Data Transfer Object representation of the <see cref="SimpleQuantityKind"/> class.
    /// </summary>
    [DataContract]
    ...
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SimpleQuantityKind"/> class.
        /// </summary>
        ...
        /// The revision number.
        /// </param>
        public SimpleQuantityKind(Guid iid, int rev) : base(iid: iid, rev: rev)
        {
        }

        /// <summary>
        /// Gets the route for the current <see ref="SimpleQuantityKind"/>.
        /// </summary>
        ...
        public override IDictionary<string, IEnumerable<Guid>> GetReferenceProperties()
        {
            ...
            dictionary.Add("PossibleScale", this.PossibleScale);
            ...
            foreach (var referencedProperty in this.GetReferenceProperties())
            {
                switch (referencedProperty.Key)
                {
                    ...
                    case "DefaultScale":
                        ...
                        {
                            errors.Add($"Removed reference '{referencedProperty.Key}' from DefaultScale property results in inconsistent SimpleQuantityKind.");
                            result = false;
                        }
                        break;
                    ...
                    case "PossibleScale":
                        foreach (var toBeRemoved in referencedProperty.Value.Except(ids).ToList())
                        {
                            this.PossibleScale.Remove(toBeRemoved);
                        } 
                        break;
                }
            }
        ...
        /// <summary>
        /// Instantiate a <see cref="CDP4Common.SiteDirectoryData.SimpleQuantityKind"/> from a <see cref="SimpleQuantityKind"/>
        /// </summary>
        /// <param name="cache">The cache that stores all the <see cref="CommonData.Thing"/>s</param>.
        /// <param name="uri">The <see cref="Uri"/> of the <see cref="CDP4Common.SiteDirectoryData.SimpleQuantityKind"/></param>.
        /// <returns>A new <see cref="CommonData.Thing"/></returns>
        public override CommonData.Thing InstantiatePoco(ConcurrentDictionary<CacheKey, Lazy<CommonData.Thing>> cache, Uri uri)
        {
            return new CDP4Common.SiteDirectoryData.SimpleQuantityKind(this.Iid, cache, uri);
        }
        ...
        {
            var original = originalThing as SimpleQuantityKind;
            if (original == null)
            {
