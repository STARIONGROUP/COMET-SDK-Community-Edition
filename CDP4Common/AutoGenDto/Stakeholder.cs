...
namespace CDP4Common.DTO
{
    ...
    /// <summary>
    /// A Data Transfer Object representation of the <see cref="Stakeholder"/> class.
    /// </summary>
    [DataContract]
    [CDPVersion("1.1.0")]
    ...
    public partial class Stakeholder : DefinedThing, ICategorizableThing
    {
        ...
        /// The revision number.
        /// </param>
        public Stakeholder(Guid iid, int rev) : base(iid: iid, rev: rev)
        {
            this.Category = new List<Guid>();
            this.StakeholderValue = new List<Guid>();
        }
        ...
        /// <summary>
        /// Instantiate a <see cref="CDP4Common.EngineeringModelData.Stakeholder"/> from a <see cref="Stakeholder"/>
        /// </summary>
        /// <param name="cache">The cache that stores all the <see cref="CommonData.Thing"/>s</param>.
        /// <param name="uri">The <see cref="Uri"/> of the <see cref="CDP4Common.EngineeringModelData.Stakeholder"/></param>.
        /// <returns>A new <see cref="CommonData.Thing"/></returns>
        public override CommonData.Thing InstantiatePoco(ConcurrentDictionary<CacheKey, Lazy<CommonData.Thing>> cache, Uri uri)
        {
            return new CDP4Common.EngineeringModelData.Stakeholder(this.Iid, cache, uri);
        }
        ...
        {
            var original = originalThing as Stakeholder;
            if (original == null)
            {
