// --------------------------------------------------------------------------------------------------------------------
// <copyright file="ParameterOverride.cs" company="Starion Group S.A.">
...
namespace CDP4Common.DTO
{
    ...
    /// <summary>
    /// A Data Transfer Object representation of the <see cref="ParameterOverride"/> class.
    /// </summary>
    [DataContract]
    ...
    public partial class ParameterOverride : ParameterOrOverrideBase
    {
        ...
        /// The revision number.
        /// </param>
        public ParameterOverride(Guid iid, int rev) : base(iid: iid, rev: rev)
        {
            this.ValueSet = new List<Guid>();
        }
        ...
        {
            get { throw new InvalidOperationException("Forbidden Get value for the derived property ParameterOverride.Group"); }
        ...
        {
            get { throw new InvalidOperationException("Forbidden Get value for the derived property ParameterOverride.IsOptionDependent"); }
        ...
        {
            get { throw new InvalidOperationException("Forbidden Get value for the derived property ParameterOverride.ParameterType"); }
        ...
        {
            get { throw new InvalidOperationException("Forbidden Get value for the derived property ParameterOverride.Scale"); }
        ...
        {
            get { throw new InvalidOperationException("Forbidden Get value for the derived property ParameterOverride.StateDependence"); }
                    ...
                    foreach (var kvp in foundProperty)
                    {
                        switch (kvp.Key)
                        {
                            ...
                            case "ParameterSubscription":
                                this.ParameterSubscription.Remove(id);
                                break;
            ...
            foreach (var referencedProperty in this.GetReferenceProperties())
            {
                switch (referencedProperty.Key)
                {
                    ...
                    case "Owner":
                        ...
                        {
                            errors.Add($"Removed reference '{referencedProperty.Key}' from Owner property results in inconsistent ParameterOverride.");
                            result = false;
                        }
                        break;
                    ...
                    case "Parameter":
                        if (referencedProperty.Value.Except(ids).Any())
                        {
                            errors.Add($"Removed reference '{referencedProperty.Key}' from Parameter property results in inconsistent ParameterOverride.");
                            result = false;
                        }
                        break;
                    ...
                    case "ParameterSubscription":
                        foreach (var toBeRemoved in referencedProperty.Value.Except(ids).ToList())
                        {
                            this.ParameterSubscription.Remove(toBeRemoved);
                        } 
                        break;
                    ...
                    case "ValueSet":
                        ...
                        {
                            errors.Add($"Removed reference '{referencedProperty.Key}' from ValueSet property results in inconsistent ParameterOverride.");
                            result = false;
                        }
                        break;
                }
        ...
        /// <summary>
        /// Instantiate a <see cref="CDP4Common.EngineeringModelData.ParameterOverride"/> from a <see cref="ParameterOverride"/>
        /// </summary>
        /// <param name="cache">The cache that stores all the <see cref="CommonData.Thing"/>s</param>.
        /// <param name="uri">The <see cref="Uri"/> of the <see cref="CDP4Common.EngineeringModelData.ParameterOverride"/></param>.
        /// <returns>A new <see cref="CommonData.Thing"/></returns>
        public override CommonData.Thing InstantiatePoco(ConcurrentDictionary<CacheKey, Lazy<CommonData.Thing>> cache, Uri uri)
        {
            return new CDP4Common.EngineeringModelData.ParameterOverride(this.Iid, cache, uri);
        }
        ...
        {
            var original = originalThing as ParameterOverride;
            if (original == null)
            {
