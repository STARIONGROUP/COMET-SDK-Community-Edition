// --------------------------------------------------------------------------------------------------------------------
// <copyright file="OrExpression.cs" company="Starion Group S.A.">
...
namespace CDP4Common.DTO
{
    ...
    /// <summary>
    /// A Data Transfer Object representation of the <see cref="OrExpression"/> class.
    /// </summary>
    [DataContract]
    [Container(typeof(ParametricConstraint), "Expression")]
    public partial class OrExpression : BooleanExpression
    {
        /// <summary>
        ...
        /// The revision number.
        /// </param>
        public OrExpression(Guid iid, int rev) : base(iid: iid, rev: rev)
        {
            this.Term = new List<Guid>();
        }
        ...
        /// <summary>
        /// Gets the route for the current <see ref="OrExpression"/>.
        /// </summary>
            ...
            foreach (var referencedProperty in this.GetReferenceProperties())
            {
                switch (referencedProperty.Key)
                {
                    ...
                    case "Term":
                        ...
                        if (!this.Term.Any())
                        {
                            errors.Add($"Removed reference '{referencedProperty.Key}' from Term property results in inconsistent OrExpression.");
                            result = false;
                        }
                        break;
                }
        ...
        /// <summary>
        /// Instantiate a <see cref="CDP4Common.EngineeringModelData.OrExpression"/> from a <see cref="OrExpression"/>
        /// </summary>
        /// <param name="cache">The cache that stores all the <see cref="CommonData.Thing"/>s</param>.
        /// <param name="uri">The <see cref="Uri"/> of the <see cref="CDP4Common.EngineeringModelData.OrExpression"/></param>.
        /// <returns>A new <see cref="CommonData.Thing"/></returns>
        public override CommonData.Thing InstantiatePoco(ConcurrentDictionary<CacheKey, Lazy<CommonData.Thing>> cache, Uri uri)
        {
            return new CDP4Common.EngineeringModelData.OrExpression(this.Iid, cache, uri);
        }
        ...
        {
            var original = originalThing as OrExpression;
            if (original == null)
            {
