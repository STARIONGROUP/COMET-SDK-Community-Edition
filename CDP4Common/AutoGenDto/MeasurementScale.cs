// --------------------------------------------------------------------------------------------------------------------
// <copyright file="MeasurementScale.cs" company="Starion Group S.A.">
            ...
            foreach (var referencedProperty in this.GetReferenceProperties())
            {
                switch (referencedProperty.Key)
                {
                    ...
                    case "Unit":
                        ...
                        {
                            errors.Add($"Removed reference '{referencedProperty.Key}' from Unit property results in inconsistent MeasurementScale.");
                            result = false;
                        }
                        break;
