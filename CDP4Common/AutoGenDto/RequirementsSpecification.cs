// --------------------------------------------------------------------------------------------------------------------
// <copyright file="RequirementsSpecification.cs" company="Starion Group S.A.">
...
namespace CDP4Common.DTO
{
    ...
    /// <summary>
    /// A Data Transfer Object representation of the <see cref="RequirementsSpecification"/> class.
    /// </summary>
    [DataContract]
    [Container(typeof(Iteration), "RequirementsSpecification")]
    public partial class RequirementsSpecification : RequirementsContainer, IDeprecatableThing
    {
        /// <summary>
        ...
        /// The revision number.
        /// </param>
        public RequirementsSpecification(Guid iid, int rev) : base(iid: iid, rev: rev)
        {
            this.Requirement = new List<Guid>();
        }
        ...
        /// <summary>
        /// Gets or sets the unique identifiers of the contained Requirement instances.
        /// </summary>
        ...
        public override IDictionary<string, IEnumerable<Guid>> GetReferenceProperties()
        {
            ...
            dictionary.Add("Requirement", this.Requirement);
            ...
            foreach (var referencedProperty in this.GetReferenceProperties())
            {
                switch (referencedProperty.Key)
                {
                    ...
                    case "Owner":
                        ...
                        {
                            errors.Add($"Removed reference '{referencedProperty.Key}' from Owner property results in inconsistent RequirementsSpecification.");
                            result = false;
                        }
                        break;
                    ...
                    case "Requirement":
                        foreach (var toBeRemoved in referencedProperty.Value.Except(ids).ToList())
                        {
                            this.Requirement.Remove(toBeRemoved);
                        } 
                        break;
                }
            }
        ...
        /// <summary>
        /// Instantiate a <see cref="CDP4Common.EngineeringModelData.RequirementsSpecification"/> from a <see cref="RequirementsSpecification"/>
        /// </summary>
        /// <param name="cache">The cache that stores all the <see cref="CommonData.Thing"/>s</param>.
        /// <param name="uri">The <see cref="Uri"/> of the <see cref="CDP4Common.EngineeringModelData.RequirementsSpecification"/></param>.
        /// <returns>A new <see cref="CommonData.Thing"/></returns>
        public override CommonData.Thing InstantiatePoco(ConcurrentDictionary<CacheKey, Lazy<CommonData.Thing>> cache, Uri uri)
        {
            return new CDP4Common.EngineeringModelData.RequirementsSpecification(this.Iid, cache, uri);
        }
        ...
        {
            var original = originalThing as RequirementsSpecification;
            if (original == null)
            {
            ...
            foreach (var guid in original.Group)
            {
                var copy = originalCopyMap.SingleOrDefault(kvp => kvp.Key.Iid == guid);
                if (Equals(copy, default(KeyValuePair<Thing, Thing>)))
                {
            ...
            foreach (var guid in original.Requirement)
            {
                ...
                this.Requirement.Add(copy.Value.Iid);
            }
