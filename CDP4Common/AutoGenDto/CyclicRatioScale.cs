// --------------------------------------------------------------------------------------------------------------------
// <copyright file="CyclicRatioScale.cs" company="Starion Group S.A.">
...
namespace CDP4Common.DTO
{
    ...
    /// <summary>
    /// A Data Transfer Object representation of the <see cref="CyclicRatioScale"/> class.
    /// </summary>
    [DataContract]
    ...
    public partial class CyclicRatioScale : RatioScale
    {
        ...
        /// The revision number.
        /// </param>
        public CyclicRatioScale(Guid iid, int rev) : base(iid: iid, rev: rev)
        {
        }
        ...
        /// <summary>
        /// Gets the route for the current <see ref="CyclicRatioScale"/>.
        /// </summary>
                    ...
                    foreach (var kvp in foundProperty)
                    {
                        switch (kvp.Key)
                        {
                            ...
                            case "Unit":
                                if (addModelErrors)
                                {
                                    errors.Add($"Removed reference '{id}' from Unit property results in inconsistent CyclicRatioScale.");
                                    result = false;
                                }
                                break;
            ...
            foreach (var referencedProperty in this.GetReferenceProperties())
            {
                switch (referencedProperty.Key)
                {
                    ...
                    case "Unit":
                        ...
                        {
                            errors.Add($"Removed reference '{referencedProperty.Key}' from Unit property results in inconsistent CyclicRatioScale.");
                            result = false;
                        }
                        break;
        ...
        /// <summary>
        /// Instantiate a <see cref="CDP4Common.SiteDirectoryData.CyclicRatioScale"/> from a <see cref="CyclicRatioScale"/>
        /// </summary>
        /// <param name="cache">The cache that stores all the <see cref="CommonData.Thing"/>s</param>.
        /// <param name="uri">The <see cref="Uri"/> of the <see cref="CDP4Common.SiteDirectoryData.CyclicRatioScale"/></param>.
        /// <returns>A new <see cref="CommonData.Thing"/></returns>
        public override CommonData.Thing InstantiatePoco(ConcurrentDictionary<CacheKey, Lazy<CommonData.Thing>> cache, Uri uri)
        {
            return new CDP4Common.SiteDirectoryData.CyclicRatioScale(this.Iid, cache, uri);
        }
        ...
        {
            var original = originalThing as CyclicRatioScale;
            if (original == null)
            {
