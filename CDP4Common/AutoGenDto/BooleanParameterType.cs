...
namespace CDP4Common.DTO
{
    ...
    /// <summary>
    /// A Data Transfer Object representation of the <see cref="BooleanParameterType"/> class.
    /// </summary>
    [DataContract]
    ...
    public partial class BooleanParameterType : ScalarParameterType
    {
        ...
        /// The revision number.
        /// </param>
        public BooleanParameterType(Guid iid, int rev) : base(iid: iid, rev: rev)
        {
        }

        /// <summary>
        /// Gets the route for the current <see ref="BooleanParameterType"/>.
        /// </summary>
        ...
        /// <summary>
        /// Instantiate a <see cref="CDP4Common.SiteDirectoryData.BooleanParameterType"/> from a <see cref="BooleanParameterType"/>
        /// </summary>
        /// <param name="cache">The cache that stores all the <see cref="CommonData.Thing"/>s</param>.
        /// <param name="uri">The <see cref="Uri"/> of the <see cref="CDP4Common.SiteDirectoryData.BooleanParameterType"/></param>.
        /// <returns>A new <see cref="CommonData.Thing"/></returns>
        public override CommonData.Thing InstantiatePoco(ConcurrentDictionary<CacheKey, Lazy<CommonData.Thing>> cache, Uri uri)
        {
            return new CDP4Common.SiteDirectoryData.BooleanParameterType(this.Iid, cache, uri);
        }
        ...
        {
            var original = originalThing as BooleanParameterType;
            if (original == null)
            {
