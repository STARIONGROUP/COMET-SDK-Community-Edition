// --------------------------------------------------------------------------------------------------------------------
// <copyright file="NestedParameter.cs" company="Starion Group S.A.">
...
namespace CDP4Common.DTO
{
    ...
    /// <summary>
    /// A Data Transfer Object representation of the <see cref="NestedParameter"/> class.
    /// </summary>
    [DataContract]
    ...
    public partial class NestedParameter : Thing, IOwnedThing, IVolatileThing
    {
        ...
        /// The revision number.
        /// </param>
        public NestedParameter(Guid iid, int rev) : base(iid: iid, rev: rev)
        {
        }
        ...
        [DataMember]
        public Guid? ActualState { get; set; }
        ...
        /// <summary>
        /// Gets or sets the unique identifier of the referenced AssociatedParameter.
        /// </summary>
        [UmlInformation(aggregation: AggregationKind.None, isDerived: false, isOrdered: false, isNullable: false, isPersistent: true)]
        [DataMember]
        public Guid AssociatedParameter { get; set; }
        ...
        public string Path
        {
            get { throw new InvalidOperationException("Forbidden Get value for the derived property NestedParameter.Path"); }
            ...
            foreach (var referencedProperty in this.GetReferenceProperties())
            {
                switch (referencedProperty.Key)
                {
                    ...
                    case "AssociatedParameter":
                        if (referencedProperty.Value.Except(ids).Any())
                        {
                            errors.Add($"Removed reference '{referencedProperty.Key}' from AssociatedParameter property results in inconsistent NestedParameter.");
                            result = false;
                        }
                        break;
                    ...
                    case "Owner":
                        if (referencedProperty.Value.Except(ids).Any())
                        {
                            errors.Add($"Removed reference '{referencedProperty.Key}' from Owner property results in inconsistent NestedParameter.");
                            result = false;
                        }
                        break;
                }
        ...
        /// <summary>
        /// Instantiate a <see cref="CDP4Common.EngineeringModelData.NestedParameter"/> from a <see cref="NestedParameter"/>
        /// </summary>
        /// <param name="cache">The cache that stores all the <see cref="CommonData.Thing"/>s</param>.
        /// <param name="uri">The <see cref="Uri"/> of the <see cref="CDP4Common.EngineeringModelData.NestedParameter"/></param>.
        /// <returns>A new <see cref="CommonData.Thing"/></returns>
        public override CommonData.Thing InstantiatePoco(ConcurrentDictionary<CacheKey, Lazy<CommonData.Thing>> cache, Uri uri)
        {
            return new CDP4Common.EngineeringModelData.NestedParameter(this.Iid, cache, uri);
        }
        ...
        {
            var original = originalThing as NestedParameter;
            if (original == null)
            {
            ...
            this.ActualValue = original.ActualValue;

            var copyAssociatedParameter = originalCopyMap.SingleOrDefault(kvp => kvp.Key.Iid == original.AssociatedParameter);
            this.AssociatedParameter = copyAssociatedParameter.Value == null ? original.AssociatedParameter : copyAssociatedParameter.Value.Iid;
