// --------------------------------------------------------------------------------------------------------------------
// <copyright file="HyperLink.cs" company="Starion Group S.A.">
...
namespace CDP4Common.DTO
{
    ...
    /// <summary>
    /// A Data Transfer Object representation of the <see cref="HyperLink"/> class.
    /// </summary>
    [DataContract]
    ...
    public partial class HyperLink : Thing, IAnnotation
    {
        ...
        /// The revision number.
        /// </param>
        public HyperLink(Guid iid, int rev) : base(iid: iid, rev: rev)
        {
        }
        ...
        /// <summary>
        /// Instantiate a <see cref="CDP4Common.CommonData.HyperLink"/> from a <see cref="HyperLink"/>
        /// </summary>
        /// <param name="cache">The cache that stores all the <see cref="CommonData.Thing"/>s</param>.
        /// <param name="uri">The <see cref="Uri"/> of the <see cref="CDP4Common.CommonData.HyperLink"/></param>.
        /// <returns>A new <see cref="CommonData.Thing"/></returns>
        public override CommonData.Thing InstantiatePoco(ConcurrentDictionary<CacheKey, Lazy<CommonData.Thing>> cache, Uri uri)
        {
            return new CDP4Common.CommonData.HyperLink(this.Iid, cache, uri);
        }
        ...
        {
            var original = originalThing as HyperLink;
            if (original == null)
            {
