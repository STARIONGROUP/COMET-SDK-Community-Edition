// --------------------------------------------------------------------------------------------------------------------
// <copyright file="ParameterOverrideValueSet.cs" company="Starion Group S.A.">
            ...
            foreach (var referencedProperty in this.GetReferenceProperties())
            {
                switch (referencedProperty.Key)
                {
                    ...
                    case "ParameterValueSet":
                        ...
                        {
                            errors.Add($"Removed reference '{referencedProperty.Key}' from ParameterValueSet property results in inconsistent ParameterOverrideValueSet.");
                            result = false;
                        }
                        break;
                }
