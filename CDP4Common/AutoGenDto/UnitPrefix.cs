// --------------------------------------------------------------------------------------------------------------------
// <copyright file="UnitPrefix.cs" company="Starion Group S.A.">
...
namespace CDP4Common.DTO
{
    ...
    /// <summary>
    /// A Data Transfer Object representation of the <see cref="UnitPrefix"/> class.
    /// </summary>
    [DataContract]
    ...
    public partial class UnitPrefix : DefinedThing, IDeprecatableThing
    {
        ...
        /// The revision number.
        /// </param>
        public UnitPrefix(Guid iid, int rev) : base(iid: iid, rev: rev)
        {
        }
        ...
        /// <summary>
        /// Instantiate a <see cref="CDP4Common.SiteDirectoryData.UnitPrefix"/> from a <see cref="UnitPrefix"/>
        /// </summary>
        /// <param name="cache">The cache that stores all the <see cref="CommonData.Thing"/>s</param>.
        /// <param name="uri">The <see cref="Uri"/> of the <see cref="CDP4Common.SiteDirectoryData.UnitPrefix"/></param>.
        /// <returns>A new <see cref="CommonData.Thing"/></returns>
        public override CommonData.Thing InstantiatePoco(ConcurrentDictionary<CacheKey, Lazy<CommonData.Thing>> cache, Uri uri)
        {
            return new CDP4Common.SiteDirectoryData.UnitPrefix(this.Iid, cache, uri);
        }
        ...
        {
            var original = originalThing as UnitPrefix;
            if (original == null)
            {
