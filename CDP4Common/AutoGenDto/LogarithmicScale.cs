// --------------------------------------------------------------------------------------------------------------------
// <copyright file="LogarithmicScale.cs" company="Starion Group S.A.">
...
namespace CDP4Common.DTO
{
    ...
    /// <summary>
    /// A Data Transfer Object representation of the <see cref="LogarithmicScale"/> class.
    /// </summary>
    [DataContract]
    ...
    public partial class LogarithmicScale : MeasurementScale
    {
        ...
        {
            this.ReferenceQuantityValue = new List<Guid>();
        }
        ...
        /// The revision number.
        /// </param>
        public LogarithmicScale(Guid iid, int rev) : base(iid: iid, rev: rev)
        {
            this.ReferenceQuantityValue = new List<Guid>();
        }
        ...
        /// <summary>
        /// Gets or sets the unique identifier of the referenced ReferenceQuantityKind.
        /// </summary>
        [UmlInformation(aggregation: AggregationKind.None, isDerived: false, isOrdered: false, isNullable: false, isPersistent: true)]
        [DataMember]
        public Guid ReferenceQuantityKind { get; set; }

        /// <summary>
        /// Gets or sets the unique identifiers of the contained ReferenceQuantityValue instances.
        /// </summary>
        [UmlInformation(aggregation: AggregationKind.Composite, isDerived: false, isOrdered: false, isNullable: false, isPersistent: true)]
        [DataMember]
        public List<Guid> ReferenceQuantityValue { get; set; }

        /// <summary>
        /// Gets the route for the current <see ref="LogarithmicScale"/>.
        /// </summary>
                    ...
                    foreach (var kvp in foundProperty)
                    {
                        switch (kvp.Key)
                        {
                            ...
                            case "ReferenceQuantityValue":
                                this.ReferenceQuantityValue.Remove(id);
                                break;
        ...
        /// <param name="uri">The <see cref="Uri"/> of the <see cref="CDP4Common.SiteDirectoryData.LogarithmicScale"/></param>.
        /// <returns>A new <see cref="CommonData.Thing"/></returns>
        public override CommonData.Thing InstantiatePoco(ConcurrentDictionary<CacheKey, Lazy<CommonData.Thing>> cache, Uri uri)
        {
            return new CDP4Common.SiteDirectoryData.LogarithmicScale(this.Iid, cache, uri);
        }
        ...
        {
            var original = originalThing as LogarithmicScale;
            if (original == null)
            {
            ...
            this.LogarithmBase = original.LogarithmBase;
            ...
            var copyReferenceQuantityKind = originalCopyMap.SingleOrDefault(kvp => kvp.Key.Iid == original.ReferenceQuantityKind);
            this.ReferenceQuantityKind = copyReferenceQuantityKind.Value == null ? original.ReferenceQuantityKind : copyReferenceQuantityKind.Value.Iid;

            foreach (var guid in original.ReferenceQuantityValue)
            {
                var copy = originalCopyMap.SingleOrDefault(kvp => kvp.Key.Iid == guid);
                if (Equals(copy, default(KeyValuePair<Thing, Thing>)))
                {
                ...
                this.ReferenceQuantityValue.Add(copy.Value.Iid);
            }
        ...
        public override bool ResolveCopyReference(IReadOnlyDictionary<Thing, Thing> originalCopyMap)
        {
            ...
            var copyReferenceQuantityKind = originalCopyMap.SingleOrDefault(kvp => kvp.Key.Iid == this.ReferenceQuantityKind);
            if (copyReferenceQuantityKind.Key != null)
            {
                this.ReferenceQuantityKind = copyReferenceQuantityKind.Value.Iid;
                hasChanges = true;
            }
