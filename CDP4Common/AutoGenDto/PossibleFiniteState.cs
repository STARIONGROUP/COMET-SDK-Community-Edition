...
namespace CDP4Common.DTO
{
    ...
    /// <summary>
    /// A Data Transfer Object representation of the <see cref="PossibleFiniteState"/> class.
    /// </summary>
    [DataContract]
    ...
    public partial class PossibleFiniteState : DefinedThing, IOwnedThing
    {
        ...
        /// The revision number.
        /// </param>
        public PossibleFiniteState(Guid iid, int rev) : base(iid: iid, rev: rev)
        {
        }
        ...
        public Guid Owner
        {
            get { throw new InvalidOperationException("Forbidden Get value for the derived property PossibleFiniteState.Owner"); }
        ...
        /// <summary>
        /// Instantiate a <see cref="CDP4Common.EngineeringModelData.PossibleFiniteState"/> from a <see cref="PossibleFiniteState"/>
        /// </summary>
        /// <param name="cache">The cache that stores all the <see cref="CommonData.Thing"/>s</param>.
        /// <param name="uri">The <see cref="Uri"/> of the <see cref="CDP4Common.EngineeringModelData.PossibleFiniteState"/></param>.
        /// <returns>A new <see cref="CommonData.Thing"/></returns>
        public override CommonData.Thing InstantiatePoco(ConcurrentDictionary<CacheKey, Lazy<CommonData.Thing>> cache, Uri uri)
        {
            return new CDP4Common.EngineeringModelData.PossibleFiniteState(this.Iid, cache, uri);
        }
        ...
        {
            var original = originalThing as PossibleFiniteState;
            if (original == null)
            {
