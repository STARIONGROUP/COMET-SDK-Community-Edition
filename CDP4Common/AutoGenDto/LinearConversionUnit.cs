// --------------------------------------------------------------------------------------------------------------------
// <copyright file="LinearConversionUnit.cs" company="Starion Group S.A.">
...
namespace CDP4Common.DTO
{
    ...
    /// <summary>
    /// A Data Transfer Object representation of the <see cref="LinearConversionUnit"/> class.
    /// </summary>
    [DataContract]
    ...
    public partial class LinearConversionUnit : ConversionBasedUnit
    {
        ...
        /// The revision number.
        /// </param>
        public LinearConversionUnit(Guid iid, int rev) : base(iid: iid, rev: rev)
        {
        }

        /// <summary>
        /// Gets the route for the current <see ref="LinearConversionUnit"/>.
        /// </summary>
            ...
            foreach (var referencedProperty in this.GetReferenceProperties())
            {
                switch (referencedProperty.Key)
                {
                    ...
                    case "ReferenceUnit":
                        ...
                        {
                            errors.Add($"Removed reference '{referencedProperty.Key}' from ReferenceUnit property results in inconsistent LinearConversionUnit.");
                            result = false;
                        }
                        break;
                }
        ...
        /// <summary>
        /// Instantiate a <see cref="CDP4Common.SiteDirectoryData.LinearConversionUnit"/> from a <see cref="LinearConversionUnit"/>
        /// </summary>
        /// <param name="cache">The cache that stores all the <see cref="CommonData.Thing"/>s</param>.
        /// <param name="uri">The <see cref="Uri"/> of the <see cref="CDP4Common.SiteDirectoryData.LinearConversionUnit"/></param>.
        /// <returns>A new <see cref="CommonData.Thing"/></returns>
        public override CommonData.Thing InstantiatePoco(ConcurrentDictionary<CacheKey, Lazy<CommonData.Thing>> cache, Uri uri)
        {
            return new CDP4Common.SiteDirectoryData.LinearConversionUnit(this.Iid, cache, uri);
        }
        ...
        {
            var original = originalThing as LinearConversionUnit;
            if (original == null)
            {
