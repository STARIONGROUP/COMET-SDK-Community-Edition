// --------------------------------------------------------------------------------------------------------------------
// <copyright file="RuleViolation.cs" company="Starion Group S.A.">
...
namespace CDP4Common.DTO
{
    ...
    /// <summary>
    /// A Data Transfer Object representation of the <see cref="RuleViolation"/> class.
    /// </summary>
    [DataContract]
    ...
    public partial class RuleViolation : Thing
    {
        ...
        /// The revision number.
        /// </param>
        public RuleViolation(Guid iid, int rev) : base(iid: iid, rev: rev)
        {
            this.ViolatingThing = new List<Guid>();
        }
        ...
        /// <summary>
        /// Gets or sets the list of unique identifiers of the referenced ViolatingThing instances.
        /// </summary>
        [UmlInformation(aggregation: AggregationKind.None, isDerived: false, isOrdered: false, isNullable: false, isPersistent: true)]
        [DataMember]
        ...
        /// <summary>
        /// Instantiate a <see cref="CDP4Common.EngineeringModelData.RuleViolation"/> from a <see cref="RuleViolation"/>
        /// </summary>
        /// <param name="cache">The cache that stores all the <see cref="CommonData.Thing"/>s</param>.
        /// <param name="uri">The <see cref="Uri"/> of the <see cref="CDP4Common.EngineeringModelData.RuleViolation"/></param>.
        /// <returns>A new <see cref="CommonData.Thing"/></returns>
        public override CommonData.Thing InstantiatePoco(ConcurrentDictionary<CacheKey, Lazy<CommonData.Thing>> cache, Uri uri)
        {
            return new CDP4Common.EngineeringModelData.RuleViolation(this.Iid, cache, uri);
        }
        ...
        {
            var original = originalThing as RuleViolation;
            if (original == null)
            {
            ...
            foreach (var guid in original.ViolatingThing)
            {
                var copy = originalCopyMap.SingleOrDefault(kvp => kvp.Key.Iid == guid);
                this.ViolatingThing.Add(copy.Value == null ? guid : copy.Value.Iid);
            }
        }
