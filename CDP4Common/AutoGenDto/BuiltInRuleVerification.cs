...
namespace CDP4Common.DTO
{
    ...
    /// <summary>
    /// A Data Transfer Object representation of the <see cref="BuiltInRuleVerification"/> class.
    /// </summary>
    [DataContract]
    ...
    public partial class BuiltInRuleVerification : RuleVerification
    {
        ...
        /// The revision number.
        /// </param>
        public BuiltInRuleVerification(Guid iid, int rev) : base(iid: iid, rev: rev)
        {
        }

        /// <summary>
        /// Gets the route for the current <see ref="BuiltInRuleVerification"/>.
        /// </summary>
        ...
        /// <summary>
        /// Instantiate a <see cref="CDP4Common.EngineeringModelData.BuiltInRuleVerification"/> from a <see cref="BuiltInRuleVerification"/>
        /// </summary>
        /// <param name="cache">The cache that stores all the <see cref="CommonData.Thing"/>s</param>.
        /// <param name="uri">The <see cref="Uri"/> of the <see cref="CDP4Common.EngineeringModelData.BuiltInRuleVerification"/></param>.
        /// <returns>A new <see cref="CommonData.Thing"/></returns>
        public override CommonData.Thing InstantiatePoco(ConcurrentDictionary<CacheKey, Lazy<CommonData.Thing>> cache, Uri uri)
        {
            return new CDP4Common.EngineeringModelData.BuiltInRuleVerification(this.Iid, cache, uri);
        }
        ...
        {
            var original = originalThing as BuiltInRuleVerification;
            if (original == null)
            {
