            ...
            foreach (var referencedProperty in this.GetReferenceProperties())
            {
                switch (referencedProperty.Key)
                {
                    case "Annotation":
                        ...
                        {
                            this.Annotation.Remove(toBeRemoved);
                        } 
                        break;
                    ...
                    case "DomainGroup":
                        foreach (var toBeRemoved in referencedProperty.Value.Except(ids).ToList())
                        {
                            this.DomainGroup.Remove(toBeRemoved);
                        } 
                        break;
                    ...
                    case "NaturalLanguage":
                        foreach (var toBeRemoved in referencedProperty.Value.Except(ids).ToList())
                        {
                            this.NaturalLanguage.Remove(toBeRemoved);
                        } 
                        break;
                    ...
                    case "Organization":
                        foreach (var toBeRemoved in referencedProperty.Value.Except(ids).ToList())
                        {
                            this.Organization.Remove(toBeRemoved);
                        } 
                        break;
                    ...
                    case "ParticipantRole":
                        foreach (var toBeRemoved in referencedProperty.Value.Except(ids).ToList())
                        {
                            this.ParticipantRole.Remove(toBeRemoved);
                        } 
                        break;
                    ...
                    case "Person":
                        foreach (var toBeRemoved in referencedProperty.Value.Except(ids).ToList())
                        {
                            this.Person.Remove(toBeRemoved);
                        } 
                        break;
                    ...
                    case "PersonRole":
                        foreach (var toBeRemoved in referencedProperty.Value.Except(ids).ToList())
                        {
                            this.PersonRole.Remove(toBeRemoved);
                        } 
                        break;
                    ...
                    case "SiteReferenceDataLibrary":
                        foreach (var toBeRemoved in referencedProperty.Value.Except(ids).ToList())
                        {
                            this.SiteReferenceDataLibrary.Remove(toBeRemoved);
                        } 
                        break;
                }
            }
