// --------------------------------------------------------------------------------------------------------------------
// <copyright file="SimpleUnit.cs" company="Starion Group S.A.">
...
namespace CDP4Common.DTO
{
    ...
    /// <summary>
    /// A Data Transfer Object representation of the <see cref="SimpleUnit"/> class.
    /// </summary>
    [DataContract]
    [Container(typeof(ReferenceDataLibrary), "Unit")]
    public partial class SimpleUnit : MeasurementUnit
    {
        /// <summary>
        ...
        /// The revision number.
        /// </param>
        public SimpleUnit(Guid iid, int rev) : base(iid: iid, rev: rev)
        {
        }

        /// <summary>
        /// Gets the route for the current <see ref="SimpleUnit"/>.
        /// </summary>
        ...
        /// <summary>
        /// Instantiate a <see cref="CDP4Common.SiteDirectoryData.SimpleUnit"/> from a <see cref="SimpleUnit"/>
        /// </summary>
        /// <param name="cache">The cache that stores all the <see cref="CommonData.Thing"/>s</param>.
        /// <param name="uri">The <see cref="Uri"/> of the <see cref="CDP4Common.SiteDirectoryData.SimpleUnit"/></param>.
        /// <returns>A new <see cref="CommonData.Thing"/></returns>
        public override CommonData.Thing InstantiatePoco(ConcurrentDictionary<CacheKey, Lazy<CommonData.Thing>> cache, Uri uri)
        {
            return new CDP4Common.SiteDirectoryData.SimpleUnit(this.Iid, cache, uri);
        }
        ...
        {
            var original = originalThing as SimpleUnit;
            if (original == null)
            {
