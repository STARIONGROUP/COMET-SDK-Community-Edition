// --------------------------------------------------------------------------------------------------------------------
// <copyright file="RequirementsContainerParameterValue.cs" company="Starion Group S.A.">
                    ...
                    foreach (var kvp in foundProperty)
                    {
                        switch (kvp.Key)
                        {
                            ...
                            case "ParameterType":
                                if (addModelErrors)
                                {
                                    errors.Add($"Removed reference '{id}' from ParameterType property results in inconsistent RequirementsContainerParameterValue.");
                                    result = false;
                                }
                                break;
            ...
            foreach (var referencedProperty in this.GetReferenceProperties())
            {
                switch (referencedProperty.Key)
                {
                    ...
                    case "ParameterType":
                        ...
                        {
                            errors.Add($"Removed reference '{referencedProperty.Key}' from ParameterType property results in inconsistent RequirementsContainerParameterValue.");
                            result = false;
                        }
                        break;
