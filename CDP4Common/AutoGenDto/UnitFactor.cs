// --------------------------------------------------------------------------------------------------------------------
// <copyright file="UnitFactor.cs" company="Starion Group S.A.">
...
namespace CDP4Common.DTO
{
    ...
    /// <summary>
    /// A Data Transfer Object representation of the <see cref="UnitFactor"/> class.
    /// </summary>
    [DataContract]
    ...
    public partial class UnitFactor : Thing
    {
        ...
        /// The revision number.
        /// </param>
        public UnitFactor(Guid iid, int rev) : base(iid: iid, rev: rev)
        {
        }
            ...
            foreach (var referencedProperty in this.GetReferenceProperties())
            {
                switch (referencedProperty.Key)
                {
                    ...
                    case "Unit":
                        ...
                        {
                            errors.Add($"Removed reference '{referencedProperty.Key}' from Unit property results in inconsistent UnitFactor.");
                            result = false;
                        }
                        break;
                }
        ...
        /// <summary>
        /// Instantiate a <see cref="CDP4Common.SiteDirectoryData.UnitFactor"/> from a <see cref="UnitFactor"/>
        /// </summary>
        /// <param name="cache">The cache that stores all the <see cref="CommonData.Thing"/>s</param>.
        /// <param name="uri">The <see cref="Uri"/> of the <see cref="CDP4Common.SiteDirectoryData.UnitFactor"/></param>.
        /// <returns>A new <see cref="CommonData.Thing"/></returns>
        public override CommonData.Thing InstantiatePoco(ConcurrentDictionary<CacheKey, Lazy<CommonData.Thing>> cache, Uri uri)
        {
            return new CDP4Common.SiteDirectoryData.UnitFactor(this.Iid, cache, uri);
        }
        ...
        {
            var original = originalThing as UnitFactor;
            if (original == null)
            {
