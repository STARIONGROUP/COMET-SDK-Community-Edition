...
namespace CDP4Common.DTO
{
    ...
    /// <summary>
    /// A Data Transfer Object representation of the <see cref="PersonPermission"/> class.
    /// </summary>
    [DataContract]
    ...
    public partial class PersonPermission : Thing, IDeprecatableThing
    {
        ...
        /// The revision number.
        /// </param>
        public PersonPermission(Guid iid, int rev) : base(iid: iid, rev: rev)
        {
        }
        ...
        /// <summary>
        /// Instantiate a <see cref="CDP4Common.SiteDirectoryData.PersonPermission"/> from a <see cref="PersonPermission"/>
        /// </summary>
        /// <param name="cache">The cache that stores all the <see cref="CommonData.Thing"/>s</param>.
        /// <param name="uri">The <see cref="Uri"/> of the <see cref="CDP4Common.SiteDirectoryData.PersonPermission"/></param>.
        /// <returns>A new <see cref="CommonData.Thing"/></returns>
        public override CommonData.Thing InstantiatePoco(ConcurrentDictionary<CacheKey, Lazy<CommonData.Thing>> cache, Uri uri)
        {
            return new CDP4Common.SiteDirectoryData.PersonPermission(this.Iid, cache, uri);
        }
        ...
        {
            var original = originalThing as PersonPermission;
            if (original == null)
            {
