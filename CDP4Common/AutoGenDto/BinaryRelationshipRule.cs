// --------------------------------------------------------------------------------------------------------------------
// <copyright file="BinaryRelationshipRule.cs" company="Starion Group S.A.">
            ...
            foreach (var referencedProperty in this.GetReferenceProperties())
            {
                switch (referencedProperty.Key)
                {
                    ...
                    case "RelationshipCategory":
                        ...
                        {
                            errors.Add($"Removed reference '{referencedProperty.Key}' from RelationshipCategory property results in inconsistent BinaryRelationshipRule.");
                            result = false;
                        }
                        break;
                    ...
                    case "SourceCategory":
                        if (referencedProperty.Value.Except(ids).Any())
                        {
                            errors.Add($"Removed reference '{referencedProperty.Key}' from SourceCategory property results in inconsistent BinaryRelationshipRule.");
                            result = false;
                        }
                        break;
                    ...
                    case "TargetCategory":
                        if (referencedProperty.Value.Except(ids).Any())
                        {
                            errors.Add($"Removed reference '{referencedProperty.Key}' from TargetCategory property results in inconsistent BinaryRelationshipRule.");
                            result = false;
                        }
                        break;
                }
