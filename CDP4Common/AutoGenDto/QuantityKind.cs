                    ...
                    foreach (var kvp in foundProperty)
                    {
                        switch (kvp.Key)
                        {
                            ...
                            case "DefaultScale":
                                if (addModelErrors)
                                {
                                    errors.Add($"Removed reference '{id}' from DefaultScale property results in inconsistent QuantityKind.");
                                    result = false;
                                }
                                break;
            ...
            foreach (var referencedProperty in this.GetReferenceProperties())
            {
                switch (referencedProperty.Key)
                {
                    ...
                    case "DefaultScale":
                        ...
                        {
                            errors.Add($"Removed reference '{referencedProperty.Key}' from DefaultScale property results in inconsistent QuantityKind.");
                            result = false;
                        }
                        break;
