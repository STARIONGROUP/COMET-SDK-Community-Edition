// --------------------------------------------------------------------------------------------------------------------
// <copyright file="DerivedQuantityKind.cs" company="Starion Group S.A.">
            ...
            foreach (var referencedProperty in this.GetReferenceProperties())
            {
                switch (referencedProperty.Key)
                {
                    ...
                    case "DefaultScale":
                        ...
                        {
                            errors.Add($"Removed reference '{referencedProperty.Key}' from DefaultScale property results in inconsistent DerivedQuantityKind.");
                            result = false;
                        }
                        break;
