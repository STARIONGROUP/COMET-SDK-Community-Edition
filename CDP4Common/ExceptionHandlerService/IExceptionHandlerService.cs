// --------------------------------------------------------------------------------------------------------------------
// <copyright file="IExceptionHandlerService.cs" company="Starion Group S.A.">
...
namespace CDP4Common.ExceptionHandlerService
{
    ...
    /// <summary>
    /// The purpose of the <see cref="IExceptionHandlerService" /> is to check server exceptions and start Application processes accordingly
    /// </summary>
