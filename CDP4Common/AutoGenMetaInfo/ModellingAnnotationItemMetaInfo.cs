// --------------------------------------------------------------------------------------------------------------------
// <copyright file="ModellingAnnotationItemMetaInfo.cs" company="Starion Group S.A.">
...
namespace CDP4Common.MetaInfo
{
    ...
    public partial class ModellingAnnotationItemMetaInfo : IModellingAnnotationItemMetaInfo
    {
        ...
        public IEnumerable<Guid> GetContainmentIds(CDP4Common.DTO.Thing modellingAnnotationItem, string propertyName)
        {
            ...
            {
                throw new ArgumentException($"'{propertyName}' is not a valid containment property of 'ModellingAnnotationItem'");
            }
        ...
        public object DeserializeCollectionValue(string propertyName, object value)
        {
            ...
            {
                throw new ArgumentException($"'{propertyName}' is not a valid collection property of 'ModellingAnnotationItem'");
            }
