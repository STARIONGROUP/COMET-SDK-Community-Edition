// --------------------------------------------------------------------------------------------------------------------
// <copyright file="ModellingAnnotationItemMetaInfo.cs" company="RHEA System S.A.">
...
namespace CDP4Common.MetaInfo
{
    ...
    /// <summary>
    /// This a class that holds meta info for <see cref="ModellingAnnotationItem"/>.
    /// </summary>
    public partial class ModellingAnnotationItemMetaInfo : IModellingAnnotationItemMetaInfo
    {
        /// <summary>
        /// The containment property value map.
        /// </summary>
        private readonly Dictionary<string, Func<CDP4Common.DTO.ModellingAnnotationItem, IEnumerable<Guid>>> containmentPropertyValueMap = new Dictionary<string, Func<CDP4Common.DTO.ModellingAnnotationItem, IEnumerable<Guid>>>
        {
            { "ApprovedBy", modellingAnnotationItem => modellingAnnotationItem.ApprovedBy },
            { "Discussion", modellingAnnotationItem => modellingAnnotationItem.Discussion },
            { "RelatedThing", modellingAnnotationItem => modellingAnnotationItem.RelatedThing },
        };

        /// <summary>
        /// The ordered containment property value map.
        /// </summary>
        private readonly Dictionary<string, Func<CDP4Common.DTO.ModellingAnnotationItem, IEnumerable<OrderedItem>>> orderedContainmentPropertyValueMap = new Dictionary<string, Func<CDP4Common.DTO.ModellingAnnotationItem, IEnumerable<OrderedItem>>>();

        /// <summary>
        /// The validation rules that should pass for an instance of <see cref="CDP4Common.DTO.ModellingAnnotationItem"/>.
        /// </summary>
        private readonly Dictionary<string, DtoValidationHelper<CDP4Common.DTO.ModellingAnnotationItem>> validationRules = new Dictionary<string, DtoValidationHelper<CDP4Common.DTO.ModellingAnnotationItem>>
        {
            { "ApprovedBy", new DtoValidationHelper<CDP4Common.DTO.ModellingAnnotationItem>(item => item.ApprovedBy != null, "The 'ApprovedBy' property of a 'ModellingAnnotationItem' is mandatory and cannot be null.") },
            { "Category", new DtoValidationHelper<CDP4Common.DTO.ModellingAnnotationItem>(item => item.Category != null, "The 'Category' property of a 'ModellingAnnotationItem' is mandatory and cannot be null.") },
            { "Content", new DtoValidationHelper<CDP4Common.DTO.ModellingAnnotationItem>(item => !string.IsNullOrWhiteSpace(item.Content), "The 'Content' property of a 'ModellingAnnotationItem' is mandatory and cannot be empty or null.") },
            { "Discussion", new DtoValidationHelper<CDP4Common.DTO.ModellingAnnotationItem>(item => item.Discussion != null, "The 'Discussion' property of a 'ModellingAnnotationItem' is mandatory and cannot be null.") },
            { "ExcludedDomain", new DtoValidationHelper<CDP4Common.DTO.ModellingAnnotationItem>(item => item.ExcludedDomain != null, "The 'ExcludedDomain' property of a 'ModellingAnnotationItem' is mandatory and cannot be null.") },
            { "ExcludedPerson", new DtoValidationHelper<CDP4Common.DTO.ModellingAnnotationItem>(item => item.ExcludedPerson != null, "The 'ExcludedPerson' property of a 'ModellingAnnotationItem' is mandatory and cannot be null.") },
            { "LanguageCode", new DtoValidationHelper<CDP4Common.DTO.ModellingAnnotationItem>(item => !string.IsNullOrWhiteSpace(item.LanguageCode), "The 'LanguageCode' property of a 'ModellingAnnotationItem' is mandatory and cannot be empty or null.") },
            { "RelatedThing", new DtoValidationHelper<CDP4Common.DTO.ModellingAnnotationItem>(item => item.RelatedThing != null, "The 'RelatedThing' property of a 'ModellingAnnotationItem' is mandatory and cannot be null.") },
            { "ShortName", new DtoValidationHelper<CDP4Common.DTO.ModellingAnnotationItem>(item => !string.IsNullOrWhiteSpace(item.ShortName), "The 'ShortName' property of a 'ModellingAnnotationItem' is mandatory and cannot be empty or null.") },
            { "SourceAnnotation", new DtoValidationHelper<CDP4Common.DTO.ModellingAnnotationItem>(item => item.SourceAnnotation != null, "The 'SourceAnnotation' property of a 'ModellingAnnotationItem' is mandatory and cannot be null.") },
            { "Title", new DtoValidationHelper<CDP4Common.DTO.ModellingAnnotationItem>(item => !string.IsNullOrWhiteSpace(item.Title), "The 'Title' property of a 'ModellingAnnotationItem' is mandatory and cannot be empty or null.") },
        };
        ...
        /// If any validation rule failed.
        /// </exception>
        public void Validate(CDP4Common.DTO.Thing modellingAnnotationItem, Func<string, bool> validateProperty)
        {
            foreach (var applicableRule in this.validationRules.Where(x => validateProperty(x.Key)))
            {
                applicableRule.Value.Validate((CDP4Common.DTO.ModellingAnnotationItem)modellingAnnotationItem);
            }
        }
        ...
        /// True if all validation rules have passed or if none are defined.
        /// </returns>
        public bool TryValidate(CDP4Common.DTO.Thing modellingAnnotationItem, Func<string, bool> validateProperty)
        {
            var applicableValidationRules = this.validationRules.Where(x => validateProperty(x.Key)).Select(x => x.Value);

            return applicableValidationRules.All(applicableRule => applicableRule.TryValidate((CDP4Common.DTO.ModellingAnnotationItem)modellingAnnotationItem));
        }

        /// <summary>
        /// Returns the containment property value for the supplied <see cref="CDP4Common.DTO.ModellingAnnotationItem"/>.
        /// </summary>
        /// <param name="modellingAnnotationItem">
        /// The <see cref="CDP4Common.DTO.ModellingAnnotationItem"/> for which to return the containment property value.
        /// </param>
        ...
        /// If the property name is not supported for the <see cref="CDP4Common.DTO.ModellingAnnotationItem"/>.
        /// </exception>
        public IEnumerable<Guid> GetContainmentIds(CDP4Common.DTO.Thing modellingAnnotationItem, string propertyName)
        {
            if (!this.containmentPropertyValueMap.ContainsKey(propertyName))
            {
                throw new ArgumentException(string.Format("'{0}' is not a valid containment property of 'ModellingAnnotationItem'", propertyName));
            }

            return this.containmentPropertyValueMap[propertyName]((CDP4Common.DTO.ModellingAnnotationItem)modellingAnnotationItem);
        }

        /// <summary>
        /// Returns the ordered containment property value for the supplied <see cref="CDP4Common.DTO.ModellingAnnotationItem"/>.
        /// </summary>
        /// <param name="modellingAnnotationItem">
        /// The <see cref="CDP4Common.DTO.ModellingAnnotationItem"/> for which to return the containment property value.
        /// </param>
        ...
        /// If the property name is not supported for the <see cref="CDP4Common.DTO.ModellingAnnotationItem"/>.
        /// </exception>
        public IEnumerable<OrderedItem> GetOrderedContainmentIds(CDP4Common.DTO.Thing modellingAnnotationItem, string propertyName)
        {
            ...
            return this.orderedContainmentPropertyValueMap[propertyName]((CDP4Common.DTO.ModellingAnnotationItem)modellingAnnotationItem);
        }
        ...
        /// <summary>
        /// Gets the <see cref="PropertyMetaInfo"/> for the <see cref="ModellingAnnotationItem"/> class
        /// </summary>
        ...
        private readonly Dictionary<string, Action<CDP4Common.DTO.ModellingAnnotationItem, object>> propertyValueAssignmentMap = new Dictionary<string, Action<CDP4Common.DTO.ModellingAnnotationItem, object>>
        {
            ...
            { "CreatedOn", (modellingAnnotationItem, value) => modellingAnnotationItem.CreatedOn = (DateTime)value },
            { "Iid", (modellingAnnotationItem, value) => modellingAnnotationItem.Iid = (Guid)value },
            { "LanguageCode", (modellingAnnotationItem, value) => modellingAnnotationItem.LanguageCode = value.ToString() },
            { "ModifiedOn", (modellingAnnotationItem, value) => modellingAnnotationItem.ModifiedOn = (DateTime)value },
            { "Owner", (modellingAnnotationItem, value) => modellingAnnotationItem.Owner = (Guid)value },
            { "PrimaryAnnotatedThing", (modellingAnnotationItem, value) => modellingAnnotationItem.PrimaryAnnotatedThing = value == null ? (Guid?)null : (Guid)value },
            { "ShortName", (modellingAnnotationItem, value) => modellingAnnotationItem.ShortName = value.ToString() },
            { "Status", (modellingAnnotationItem, value) => modellingAnnotationItem.Status = (AnnotationStatusKind)value },
            { "ThingPreference", (modellingAnnotationItem, value) => modellingAnnotationItem.ThingPreference = value == null ? (string)null : value.ToString() },
            { "Title", (modellingAnnotationItem, value) => modellingAnnotationItem.Title = value.ToString() },
        };
        ...
        {
            get { return "EngineeringModelDataAnnotation"; }
        }
        ...
        /// <summary>
        /// Returns the <see cref="CDP4Common.DTO.ModellingAnnotationItem"/> containment property type from the supplied property name.
        /// </summary>
        /// <param name="propertyName">
        ...
        /// <summary>
        /// Returns the <see cref="CDP4Common.DTO.ModellingAnnotationItem"/> property type from the supplied property name.
        /// </summary>
        /// <param name="propertyName">
        /// The property name.
        /// </param>
        ...
        /// <summary>
        /// Returns the container property for the supplied type name is a possible container for <see cref="CDP4Common.DTO.ModellingAnnotationItem"/>.
        /// </summary>
        /// <param name="typeName">
        /// Name of the type for which to check if it is a container of <see cref="CDP4Common.DTO.ModellingAnnotationItem"/>.
        /// </param>
        /// <param name="containerProperty">
        /// Supplied container property info instance that will be set if the supplied type name is a container of <see cref="CDP4Common.DTO.ModellingAnnotationItem"/>.
        /// </param>
        /// <returns>
        /// True if the supplied typeName is a container for <see cref="CDP4Common.DTO.ModellingAnnotationItem"/> and sets the container property name.
        /// </returns>
        ...
        /// <summary>
        /// Check if the supplied property name for <see cref="CDP4Common.DTO.ModellingAnnotationItem"/> is scalar.
        /// </summary>
        /// <param name="propertyName">
        /// Name of the property for which to check if it is scalar.
        /// </param>
        ...
        public bool ApplyPropertyUpdate(CDP4Common.DTO.Thing updatableThing, string propertyName, object value)
        {
            ...
            this.propertyValueAssignmentMap[propertyName]((CDP4Common.DTO.ModellingAnnotationItem)updatableThing, value);
        ...
        public object DeserializeCollectionValue(string propertyName, object value)
        {
            ...
            {
                throw new ArgumentException(string.Format("'{0}' is not a valid collection property of 'ModellingAnnotationItem'", propertyName));
            }
        ...
        public object GetValue(string propertyName, CDP4Common.DTO.Thing thing)
        {
            ...
            return this.propertyValueMap[propertyName]((CDP4Common.DTO.ModellingAnnotationItem)thing);
        }
        ...
        /// <summary>
        /// Instantiates a <see cref="CDP4Common.DTO.ModellingAnnotationItem"/>
        /// </summary>
        /// <returns>
