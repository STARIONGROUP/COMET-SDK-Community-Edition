...
namespace CDP4Common.MetaInfo
{
    ...
    public partial class ColorMetaInfo : IColorMetaInfo
    {
        ...
        {
            { "OwnedStyle", new PropertyMetaInfo("UsedColor", "Guid", PropertyKind.List, AggregationKind.Composite, false, false, true, 0, "*", true) },
            { "SharedStyle", new PropertyMetaInfo("UsedColor", "Guid", PropertyKind.List, AggregationKind.Composite, false, false, true, 0, "*", true) },
        };
