// --------------------------------------------------------------------------------------------------------------------
// <copyright file="IndependentParameterTypeAssignmentMetaInfo.cs" company="Starion Group S.A.">
...
namespace CDP4Common.MetaInfo
{
    ...
    /// <summary>
    /// This a class that holds meta info for <see cref="IndependentParameterTypeAssignment"/>.
    /// </summary>
    public partial class IndependentParameterTypeAssignmentMetaInfo : IIndependentParameterTypeAssignmentMetaInfo
    {
        /// <summary>
        /// The containment property value map.
        /// </summary>
        private readonly Dictionary<string, Func<CDP4Common.DTO.IndependentParameterTypeAssignment, IEnumerable<Guid>>> containmentPropertyValueMap = new Dictionary<string, Func<CDP4Common.DTO.IndependentParameterTypeAssignment, IEnumerable<Guid>>>();

        /// <summary>
        /// The ordered containment property value map.
        /// </summary>
        private readonly Dictionary<string, Func<CDP4Common.DTO.IndependentParameterTypeAssignment, IEnumerable<OrderedItem>>> orderedContainmentPropertyValueMap = new Dictionary<string, Func<CDP4Common.DTO.IndependentParameterTypeAssignment, IEnumerable<OrderedItem>>>();

        /// <summary>
        /// The validation rules that should pass for an instance of <see cref="CDP4Common.DTO.IndependentParameterTypeAssignment"/>.
        /// </summary>
        private readonly Dictionary<string, DtoValidationHelper<CDP4Common.DTO.IndependentParameterTypeAssignment>> validationRules = new Dictionary<string, DtoValidationHelper<CDP4Common.DTO.IndependentParameterTypeAssignment>>
        {
            { "ExcludedDomain", new DtoValidationHelper<CDP4Common.DTO.IndependentParameterTypeAssignment>(item => item.ExcludedDomain != null, "The 'ExcludedDomain' property of a 'IndependentParameterTypeAssignment' is mandatory and cannot be null.") },
            { "ExcludedPerson", new DtoValidationHelper<CDP4Common.DTO.IndependentParameterTypeAssignment>(item => item.ExcludedPerson != null, "The 'ExcludedPerson' property of a 'IndependentParameterTypeAssignment' is mandatory and cannot be null.") },
        };
        ...
        /// </exception>
        public void Validate(CDP4Common.DTO.Thing independentParameterTypeAssignment)
        {
            this.Validate(independentParameterTypeAssignment, x => true);
        }
        ...
        /// If any validation rule failed.
        /// </exception>
        public void Validate(CDP4Common.DTO.Thing independentParameterTypeAssignment, Func<string, bool> validateProperty)
        {
            foreach (var applicableRule in this.validationRules.Where(x => validateProperty(x.Key)))
            {
                applicableRule.Value.Validate((CDP4Common.DTO.IndependentParameterTypeAssignment)independentParameterTypeAssignment);
            }
        }
        ...
        /// </returns>
        public bool TryValidate(CDP4Common.DTO.Thing independentParameterTypeAssignment)
        {
            return this.TryValidate(independentParameterTypeAssignment, x => true);
        }
        ...
        /// True if all validation rules have passed or if none are defined.
        /// </returns>
        public bool TryValidate(CDP4Common.DTO.Thing independentParameterTypeAssignment, Func<string, bool> validateProperty)
        {
            var applicableValidationRules = this.validationRules.Where(x => validateProperty(x.Key)).Select(x => x.Value);

            return applicableValidationRules.All(applicableRule => applicableRule.TryValidate((CDP4Common.DTO.IndependentParameterTypeAssignment)independentParameterTypeAssignment));
        }

        /// <summary>
        /// Returns the containment property value for the supplied <see cref="CDP4Common.DTO.IndependentParameterTypeAssignment"/>.
        /// </summary>
        /// <param name="independentParameterTypeAssignment">
        /// The <see cref="CDP4Common.DTO.IndependentParameterTypeAssignment"/> for which to return the containment property value.
        /// </param>
        ...
        /// If the property name is not supported for the <see cref="CDP4Common.DTO.IndependentParameterTypeAssignment"/>.
        /// </exception>
        public IEnumerable<Guid> GetContainmentIds(CDP4Common.DTO.Thing independentParameterTypeAssignment, string propertyName)
        {
        ...
        /// <summary>
        /// Returns the ordered containment property value for the supplied <see cref="CDP4Common.DTO.IndependentParameterTypeAssignment"/>.
        /// </summary>
        /// <param name="independentParameterTypeAssignment">
        /// The <see cref="CDP4Common.DTO.IndependentParameterTypeAssignment"/> for which to return the containment property value.
        /// </param>
        ...
        /// If the property name is not supported for the <see cref="CDP4Common.DTO.IndependentParameterTypeAssignment"/>.
        /// </exception>
        public IEnumerable<OrderedItem> GetOrderedContainmentIds(CDP4Common.DTO.Thing independentParameterTypeAssignment, string propertyName)
        {
        ...
        /// <summary>
        /// Gets the <see cref="PropertyMetaInfo"/> for the <see cref="IndependentParameterTypeAssignment"/> class
        /// </summary>
        ...
        /// </summary>
        private readonly Dictionary<string, Func<CDP4Common.DTO.IndependentParameterTypeAssignment, object>> propertyValueMap = new Dictionary<string, Func<CDP4Common.DTO.IndependentParameterTypeAssignment, object>>
        {
            ...
            { "Iid", thing => thing.Iid },
            { "MeasurementScale", thing => thing.MeasurementScale },
        ...
        private readonly Dictionary<string, PropertyMetaInfo> propertyTypeMap = new Dictionary<string, PropertyMetaInfo>
        {
            ...
            { "MeasurementScale", new PropertyMetaInfo("MeasurementScale", "MeasurementScale", PropertyKind.Scalar, AggregationKind.None, false, false, true, 0, "1", true) },
        ...
        /// </summary>
        private readonly Dictionary<string, Action<CDP4Common.DTO.IndependentParameterTypeAssignment, object>> propertyValueAssignmentMap = new Dictionary<string, Action<CDP4Common.DTO.IndependentParameterTypeAssignment, object>>
        {
            { "Actor", (independentParameterTypeAssignment, value) => independentParameterTypeAssignment.Actor = value == null ? (Guid?)null : (Guid)value },
            { "Iid", (independentParameterTypeAssignment, value) => independentParameterTypeAssignment.Iid = (Guid)value },
            { "MeasurementScale", (independentParameterTypeAssignment, value) => independentParameterTypeAssignment.MeasurementScale = value == null ? (Guid?)null : (Guid)value },
            { "ModifiedOn", (independentParameterTypeAssignment, value) => independentParameterTypeAssignment.ModifiedOn = (DateTime)value },
            { "ParameterType", (independentParameterTypeAssignment, value) => independentParameterTypeAssignment.ParameterType = (Guid)value },
            { "ThingPreference", (independentParameterTypeAssignment, value) => independentParameterTypeAssignment.ThingPreference = value == null ? (string)null : value.ToString() },
        };
        ...
        {
            { "SampledFunctionParameterType", new PropertyMetaInfo("IndependentParameterType", "IndependentParameterTypeAssignment", PropertyKind.OrderedList, AggregationKind.Composite, false, true, true, 1, "*", true) },
        };
        ...
        /// <summary>
        /// Returns the <see cref="CDP4Common.DTO.IndependentParameterTypeAssignment"/> containment property type from the supplied property name.
        /// </summary>
        /// <param name="propertyName">
        ...
        /// <summary>
        /// Returns the <see cref="CDP4Common.DTO.IndependentParameterTypeAssignment"/> property type from the supplied property name.
        /// </summary>
        /// <param name="propertyName">
        /// The property name.
        /// </param>
        ...
        /// <summary>
        /// Returns the container property for the supplied type name is a possible container for <see cref="CDP4Common.DTO.IndependentParameterTypeAssignment"/>.
        /// </summary>
        /// <param name="typeName">
        /// Name of the type for which to check if it is a container of <see cref="CDP4Common.DTO.IndependentParameterTypeAssignment"/>.
        /// </param>
        /// <param name="containerProperty">
        /// Supplied container property info instance that will be set if the supplied type name is a container of <see cref="CDP4Common.DTO.IndependentParameterTypeAssignment"/>.
        /// </param>
        /// <returns>
        /// True if the supplied typeName is a container for <see cref="CDP4Common.DTO.IndependentParameterTypeAssignment"/> and sets the container property name.
        /// </returns>
        ...
        /// <summary>
        /// Check if the supplied property name for <see cref="CDP4Common.DTO.IndependentParameterTypeAssignment"/> is scalar.
        /// </summary>
        /// <param name="propertyName">
        /// Name of the property for which to check if it is scalar.
        /// </param>
        ...
        public bool ApplyPropertyUpdate(CDP4Common.DTO.Thing updatableThing, string propertyName, object value)
        {
            ...
            this.propertyValueAssignmentMap[propertyName]((CDP4Common.DTO.IndependentParameterTypeAssignment)updatableThing, value);
        ...
        /// <summary>
        /// Instantiates a <see cref="CDP4Common.DTO.IndependentParameterTypeAssignment"/>
        /// </summary>
        /// <returns>
        ...
        {
            return new CDP4Common.DTO.IndependentParameterTypeAssignment(guid, revisionNumber);
        }
    }
}
