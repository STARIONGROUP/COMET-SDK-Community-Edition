// --------------------------------------------------------------------------------------------------------------------
// <copyright file="PersonPermissionMetaInfo.cs" company="Starion Group S.A.">
...
namespace CDP4Common.MetaInfo
{
    ...
    public partial class PersonPermissionMetaInfo : IPersonPermissionMetaInfo
    {
        ...
        public IEnumerable<Guid> GetContainmentIds(CDP4Common.DTO.Thing personPermission, string propertyName)
        {
            ...
            {
                throw new ArgumentException($"'{propertyName}' is not a valid containment property of 'PersonPermission'");
            }
        ...
        private readonly Dictionary<string, Action<CDP4Common.DTO.PersonPermission, object>> propertyValueAssignmentMap = new Dictionary<string, Action<CDP4Common.DTO.PersonPermission, object>>
        {
            ...
            { "Actor", (personPermission, value) => personPermission.Actor = value == null ? (Guid?)null : (Guid)value },
            ...
            { "ThingPreference", (personPermission, value) => personPermission.ThingPreference = value == null ? (string)null : value.ToString() },
        };
        ...
        public object DeserializeCollectionValue(string propertyName, object value)
        {
            ...
            {
                throw new ArgumentException($"'{propertyName}' is not a valid collection property of 'PersonPermission'");
            }
