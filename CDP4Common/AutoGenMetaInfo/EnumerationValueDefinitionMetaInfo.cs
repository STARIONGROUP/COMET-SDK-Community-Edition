// --------------------------------------------------------------------------------------------------------------------
// <copyright file="EnumerationValueDefinitionMetaInfo.cs" company="Starion Group S.A.">
...
namespace CDP4Common.MetaInfo
{
    ...
    /// <summary>
    /// This a class that holds meta info for <see cref="EnumerationValueDefinition"/>.
    /// </summary>
    public partial class EnumerationValueDefinitionMetaInfo : IEnumerationValueDefinitionMetaInfo
    {
        /// <summary>
        ...
        /// </summary>
        private readonly Dictionary<string, Func<CDP4Common.DTO.EnumerationValueDefinition, IEnumerable<OrderedItem>>> orderedContainmentPropertyValueMap = new Dictionary<string, Func<CDP4Common.DTO.EnumerationValueDefinition, IEnumerable<OrderedItem>>>();

        /// <summary>
        /// The validation rules that should pass for an instance of <see cref="CDP4Common.DTO.EnumerationValueDefinition"/>.
        /// </summary>
        private readonly Dictionary<string, DtoValidationHelper<CDP4Common.DTO.EnumerationValueDefinition>> validationRules = new Dictionary<string, DtoValidationHelper<CDP4Common.DTO.EnumerationValueDefinition>>
        {
            ...
            { "HyperLink", new DtoValidationHelper<CDP4Common.DTO.EnumerationValueDefinition>(item => item.HyperLink != null, "The 'HyperLink' property of a 'EnumerationValueDefinition' is mandatory and cannot be null.") },
            { "Name", new DtoValidationHelper<CDP4Common.DTO.EnumerationValueDefinition>(item => !string.IsNullOrWhiteSpace(item.Name), "The 'Name' property of a 'EnumerationValueDefinition' is mandatory and cannot be empty or null.") },
            { "ShortName", new DtoValidationHelper<CDP4Common.DTO.EnumerationValueDefinition>(item => !string.IsNullOrWhiteSpace(item.ShortName), "The 'ShortName' property of a 'EnumerationValueDefinition' is mandatory and cannot be empty or null.") },
        };
        ...
        /// </exception>
        public void Validate(CDP4Common.DTO.Thing enumerationValueDefinition)
        {
            this.Validate(enumerationValueDefinition, x => true);
        }
        ...
        /// If any validation rule failed.
        /// </exception>
        public void Validate(CDP4Common.DTO.Thing enumerationValueDefinition, Func<string, bool> validateProperty)
        {
            foreach (var applicableRule in this.validationRules.Where(x => validateProperty(x.Key)))
            {
                applicableRule.Value.Validate((CDP4Common.DTO.EnumerationValueDefinition)enumerationValueDefinition);
            }
        }
        ...
        /// </returns>
        public bool TryValidate(CDP4Common.DTO.Thing enumerationValueDefinition)
        {
            return this.TryValidate(enumerationValueDefinition, x => true);
        }
        ...
        /// True if all validation rules have passed or if none are defined.
        /// </returns>
        public bool TryValidate(CDP4Common.DTO.Thing enumerationValueDefinition, Func<string, bool> validateProperty)
        {
            var applicableValidationRules = this.validationRules.Where(x => validateProperty(x.Key)).Select(x => x.Value);

            return applicableValidationRules.All(applicableRule => applicableRule.TryValidate((CDP4Common.DTO.EnumerationValueDefinition)enumerationValueDefinition));
        }

        /// <summary>
        /// Returns the containment property value for the supplied <see cref="CDP4Common.DTO.EnumerationValueDefinition"/>.
        /// </summary>
        /// <param name="enumerationValueDefinition">
        /// The <see cref="CDP4Common.DTO.EnumerationValueDefinition"/> for which to return the containment property value.
        /// </param>
        ...
        /// If the property name is not supported for the <see cref="CDP4Common.DTO.EnumerationValueDefinition"/>.
        /// </exception>
        public IEnumerable<Guid> GetContainmentIds(CDP4Common.DTO.Thing enumerationValueDefinition, string propertyName)
        {
            if (!this.containmentPropertyValueMap.ContainsKey(propertyName))
            {
                throw new ArgumentException($"'{propertyName}' is not a valid containment property of 'EnumerationValueDefinition'");
            }

            return this.containmentPropertyValueMap[propertyName]((CDP4Common.DTO.EnumerationValueDefinition)enumerationValueDefinition);
        }

        /// <summary>
        /// Returns the ordered containment property value for the supplied <see cref="CDP4Common.DTO.EnumerationValueDefinition"/>.
        /// </summary>
        /// <param name="enumerationValueDefinition">
        /// The <see cref="CDP4Common.DTO.EnumerationValueDefinition"/> for which to return the containment property value.
        /// </param>
        ...
        /// If the property name is not supported for the <see cref="CDP4Common.DTO.EnumerationValueDefinition"/>.
        /// </exception>
        public IEnumerable<OrderedItem> GetOrderedContainmentIds(CDP4Common.DTO.Thing enumerationValueDefinition, string propertyName)
        {
            ...
            return this.orderedContainmentPropertyValueMap[propertyName]((CDP4Common.DTO.EnumerationValueDefinition)enumerationValueDefinition);
        }
        ...
        /// <summary>
        /// Gets the <see cref="PropertyMetaInfo"/> for the <see cref="EnumerationValueDefinition"/> class
        /// </summary>
        ...
        /// </summary>
        private readonly Dictionary<string, Action<CDP4Common.DTO.EnumerationValueDefinition, object>> propertyValueAssignmentMap = new Dictionary<string, Action<CDP4Common.DTO.EnumerationValueDefinition, object>>
        {
            { "Actor", (enumerationValueDefinition, value) => enumerationValueDefinition.Actor = value == null ? (Guid?)null : (Guid)value },
            { "Iid", (enumerationValueDefinition, value) => enumerationValueDefinition.Iid = (Guid)value },
            { "ModifiedOn", (enumerationValueDefinition, value) => enumerationValueDefinition.ModifiedOn = (DateTime)value },
            { "Name", (enumerationValueDefinition, value) => enumerationValueDefinition.Name = value.ToString() },
            { "ShortName", (enumerationValueDefinition, value) => enumerationValueDefinition.ShortName = value.ToString() },
            { "ThingPreference", (enumerationValueDefinition, value) => enumerationValueDefinition.ThingPreference = value == null ? (string)null : value.ToString() },
        };
        ...
        {
            { "EnumerationParameterType", new PropertyMetaInfo("ValueDefinition", "EnumerationValueDefinition", PropertyKind.OrderedList, AggregationKind.Composite, false, true, true, 1, "*", true) },
        };
        ...
        /// <summary>
        /// Returns the <see cref="CDP4Common.DTO.EnumerationValueDefinition"/> containment property type from the supplied property name.
        /// </summary>
        /// <param name="propertyName">
        ...
        /// <summary>
        /// Returns the <see cref="CDP4Common.DTO.EnumerationValueDefinition"/> property type from the supplied property name.
        /// </summary>
        /// <param name="propertyName">
        /// The property name.
        /// </param>
        ...
        /// <summary>
        /// Returns the container property for the supplied type name is a possible container for <see cref="CDP4Common.DTO.EnumerationValueDefinition"/>.
        /// </summary>
        /// <param name="typeName">
        /// Name of the type for which to check if it is a container of <see cref="CDP4Common.DTO.EnumerationValueDefinition"/>.
        /// </param>
        /// <param name="containerProperty">
        /// Supplied container property info instance that will be set if the supplied type name is a container of <see cref="CDP4Common.DTO.EnumerationValueDefinition"/>.
        /// </param>
        /// <returns>
        /// True if the supplied typeName is a container for <see cref="CDP4Common.DTO.EnumerationValueDefinition"/> and sets the container property name.
        /// </returns>
        ...
        /// <summary>
        /// Check if the supplied property name for <see cref="CDP4Common.DTO.EnumerationValueDefinition"/> is scalar.
        /// </summary>
        /// <param name="propertyName">
        /// Name of the property for which to check if it is scalar.
        /// </param>
        ...
        public bool ApplyPropertyUpdate(CDP4Common.DTO.Thing updatableThing, string propertyName, object value)
        {
            ...
            this.propertyValueAssignmentMap[propertyName]((CDP4Common.DTO.EnumerationValueDefinition)updatableThing, value);
        ...
        public object DeserializeCollectionValue(string propertyName, object value)
        {
            ...
            {
                throw new ArgumentException($"'{propertyName}' is not a valid collection property of 'EnumerationValueDefinition'");
            }
        ...
        public object GetValue(string propertyName, CDP4Common.DTO.Thing thing)
        {
            ...
            return this.propertyValueMap[propertyName]((CDP4Common.DTO.EnumerationValueDefinition)thing);
        }
        ...
        /// <summary>
        /// Instantiates a <see cref="CDP4Common.DTO.EnumerationValueDefinition"/>
        /// </summary>
        /// <returns>
        ...
        {
            return new CDP4Common.DTO.EnumerationValueDefinition(guid, revisionNumber);
        }
    }
}
