...
namespace CDP4Common.MetaInfo
{
    ...
    public partial class EnumerationValueDefinitionMetaInfo : IEnumerationValueDefinitionMetaInfo
    {
        ...
        public IEnumerable<Guid> GetContainmentIds(CDP4Common.DTO.Thing enumerationValueDefinition, string propertyName)
        {
            ...
            {
                throw new ArgumentException(string.Format("'{0}' is not a valid containment property of 'EnumerationValueDefinition'", propertyName));
            }
        ...
        public object DeserializeCollectionValue(string propertyName, object value)
        {
            ...
            {
                throw new ArgumentException(string.Format("'{0}' is not a valid collection property of 'EnumerationValueDefinition'", propertyName));
            }
