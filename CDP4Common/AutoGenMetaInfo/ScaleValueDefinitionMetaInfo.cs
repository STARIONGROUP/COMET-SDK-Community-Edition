...
namespace CDP4Common.MetaInfo
{
    ...
    public partial class ScaleValueDefinitionMetaInfo : IScaleValueDefinitionMetaInfo
    {
        ...
        public IEnumerable<Guid> GetContainmentIds(CDP4Common.DTO.Thing scaleValueDefinition, string propertyName)
        {
            ...
            {
                throw new ArgumentException(string.Format("'{0}' is not a valid containment property of 'ScaleValueDefinition'", propertyName));
            }
        ...
        public object DeserializeCollectionValue(string propertyName, object value)
        {
            ...
            {
                throw new ArgumentException(string.Format("'{0}' is not a valid collection property of 'ScaleValueDefinition'", propertyName));
            }
