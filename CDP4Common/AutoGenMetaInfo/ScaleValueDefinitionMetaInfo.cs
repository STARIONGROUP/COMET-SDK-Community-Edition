// --------------------------------------------------------------------------------------------------------------------
// <copyright file="ScaleValueDefinitionMetaInfo.cs" company="RHEA System S.A.">
...
namespace CDP4Common.MetaInfo
{
    ...
    /// </summary>
    public partial class ScaleValueDefinitionMetaInfo : IScaleValueDefinitionMetaInfo
    {
        /// <summary>
        /// The containment property value map.
        /// </summary>
        private readonly Dictionary<string, Func<CDP4Common.DTO.ScaleValueDefinition, IEnumerable<Guid>>> containmentPropertyValueMap = new Dictionary<string, Func<CDP4Common.DTO.ScaleValueDefinition, IEnumerable<Guid>>>
        {
            { "Alias", scaleValueDefinition => scaleValueDefinition.Alias },
            { "Attachment", scaleValueDefinition => scaleValueDefinition.Attachment },
            { "Definition", scaleValueDefinition => scaleValueDefinition.Definition },
            { "HyperLink", scaleValueDefinition => scaleValueDefinition.HyperLink },
        };

        /// <summary>
        /// The ordered containment property value map.
        /// </summary>
        private readonly Dictionary<string, Func<CDP4Common.DTO.ScaleValueDefinition, IEnumerable<OrderedItem>>> orderedContainmentPropertyValueMap = new Dictionary<string, Func<CDP4Common.DTO.ScaleValueDefinition, IEnumerable<OrderedItem>>>();

        /// <summary>
        /// The validation rules that should pass for an instance of <see cref="CDP4Common.DTO.ScaleValueDefinition"/>.
        /// </summary>
        private readonly Dictionary<string, DtoValidationHelper<CDP4Common.DTO.ScaleValueDefinition>> validationRules = new Dictionary<string, DtoValidationHelper<CDP4Common.DTO.ScaleValueDefinition>>
        {
            { "Alias", new DtoValidationHelper<CDP4Common.DTO.ScaleValueDefinition>(item => item.Alias != null, "The 'Alias' property of a 'ScaleValueDefinition' is mandatory and cannot be null.") },
            { "Attachment", new DtoValidationHelper<CDP4Common.DTO.ScaleValueDefinition>(item => item.Attachment != null, "The 'Attachment' property of a 'ScaleValueDefinition' is mandatory and cannot be null.") },
            { "Definition", new DtoValidationHelper<CDP4Common.DTO.ScaleValueDefinition>(item => item.Definition != null, "The 'Definition' property of a 'ScaleValueDefinition' is mandatory and cannot be null.") },
            { "ExcludedDomain", new DtoValidationHelper<CDP4Common.DTO.ScaleValueDefinition>(item => item.ExcludedDomain != null, "The 'ExcludedDomain' property of a 'ScaleValueDefinition' is mandatory and cannot be null.") },
            { "ExcludedPerson", new DtoValidationHelper<CDP4Common.DTO.ScaleValueDefinition>(item => item.ExcludedPerson != null, "The 'ExcludedPerson' property of a 'ScaleValueDefinition' is mandatory and cannot be null.") },
            { "HyperLink", new DtoValidationHelper<CDP4Common.DTO.ScaleValueDefinition>(item => item.HyperLink != null, "The 'HyperLink' property of a 'ScaleValueDefinition' is mandatory and cannot be null.") },
            { "Name", new DtoValidationHelper<CDP4Common.DTO.ScaleValueDefinition>(item => !string.IsNullOrWhiteSpace(item.Name), "The 'Name' property of a 'ScaleValueDefinition' is mandatory and cannot be empty or null.") },
            { "ShortName", new DtoValidationHelper<CDP4Common.DTO.ScaleValueDefinition>(item => !string.IsNullOrWhiteSpace(item.ShortName), "The 'ShortName' property of a 'ScaleValueDefinition' is mandatory and cannot be empty or null.") },
            { "Value", new DtoValidationHelper<CDP4Common.DTO.ScaleValueDefinition>(item => !string.IsNullOrWhiteSpace(item.Value), "The 'Value' property of a 'ScaleValueDefinition' is mandatory and cannot be empty or null.") },
        };
        ...
        /// </exception>
        public void Validate(CDP4Common.DTO.Thing scaleValueDefinition)
        {
            this.Validate(scaleValueDefinition, x => true);
        }
        ...
        /// If any validation rule failed.
        /// </exception>
        public void Validate(CDP4Common.DTO.Thing scaleValueDefinition, Func<string, bool> validateProperty)
        {
            foreach (var applicableRule in this.validationRules.Where(x => validateProperty(x.Key)))
            {
                applicableRule.Value.Validate((CDP4Common.DTO.ScaleValueDefinition)scaleValueDefinition);
            }
        }
        ...
        /// </returns>
        public bool TryValidate(CDP4Common.DTO.Thing scaleValueDefinition)
        {
            return this.TryValidate(scaleValueDefinition, x => true);
        }
        ...
        /// True if all validation rules have passed or if none are defined.
        /// </returns>
        public bool TryValidate(CDP4Common.DTO.Thing scaleValueDefinition, Func<string, bool> validateProperty)
        {
            var applicableValidationRules = this.validationRules.Where(x => validateProperty(x.Key)).Select(x => x.Value);

            return applicableValidationRules.All(applicableRule => applicableRule.TryValidate((CDP4Common.DTO.ScaleValueDefinition)scaleValueDefinition));
        }

        /// <summary>
        /// Returns the containment property value for the supplied <see cref="CDP4Common.DTO.ScaleValueDefinition"/>.
        /// </summary>
        /// <param name="scaleValueDefinition">
        /// The <see cref="CDP4Common.DTO.ScaleValueDefinition"/> for which to return the containment property value.
        /// </param>
        ...
        /// If the property name is not supported for the <see cref="CDP4Common.DTO.ScaleValueDefinition"/>.
        /// </exception>
        public IEnumerable<Guid> GetContainmentIds(CDP4Common.DTO.Thing scaleValueDefinition, string propertyName)
        {
            if (!this.containmentPropertyValueMap.ContainsKey(propertyName))
            {
                throw new ArgumentException($"'{propertyName}' is not a valid containment property of 'ScaleValueDefinition'");
            }

            return this.containmentPropertyValueMap[propertyName]((CDP4Common.DTO.ScaleValueDefinition)scaleValueDefinition);
        }

        /// <summary>
        /// Returns the ordered containment property value for the supplied <see cref="CDP4Common.DTO.ScaleValueDefinition"/>.
        /// </summary>
        /// <param name="scaleValueDefinition">
        /// The <see cref="CDP4Common.DTO.ScaleValueDefinition"/> for which to return the containment property value.
        /// </param>
        ...
        /// If the property name is not supported for the <see cref="CDP4Common.DTO.ScaleValueDefinition"/>.
        /// </exception>
        public IEnumerable<OrderedItem> GetOrderedContainmentIds(CDP4Common.DTO.Thing scaleValueDefinition, string propertyName)
        {
            ...
            return this.orderedContainmentPropertyValueMap[propertyName]((CDP4Common.DTO.ScaleValueDefinition)scaleValueDefinition);
        }
        ...
        /// <summary>
        /// Gets the <see cref="PropertyMetaInfo"/> for the <see cref="ScaleValueDefinition"/> class
        /// </summary>
        ...
        /// </summary>
        private readonly Dictionary<string, Func<CDP4Common.DTO.ScaleValueDefinition, object>> propertyValueMap = new Dictionary<string, Func<CDP4Common.DTO.ScaleValueDefinition, object>>
        {
        ...
        /// </summary>
        private readonly Dictionary<string, Action<CDP4Common.DTO.ScaleValueDefinition, object>> propertyValueAssignmentMap = new Dictionary<string, Action<CDP4Common.DTO.ScaleValueDefinition, object>>
        {
            { "Actor", (scaleValueDefinition, value) => scaleValueDefinition.Actor = value == null ? (Guid?)null : (Guid)value },
            { "Iid", (scaleValueDefinition, value) => scaleValueDefinition.Iid = (Guid)value },
            { "ModifiedOn", (scaleValueDefinition, value) => scaleValueDefinition.ModifiedOn = (DateTime)value },
            { "Name", (scaleValueDefinition, value) => scaleValueDefinition.Name = value.ToString() },
            { "ShortName", (scaleValueDefinition, value) => scaleValueDefinition.ShortName = value.ToString() },
            { "ThingPreference", (scaleValueDefinition, value) => scaleValueDefinition.ThingPreference = value == null ? (string)null : value.ToString() },
            { "Value", (scaleValueDefinition, value) => scaleValueDefinition.Value = value.ToString() },
        };
        ...
        /// <summary>
        /// Returns the <see cref="CDP4Common.DTO.ScaleValueDefinition"/> containment property type from the supplied property name.
        /// </summary>
        /// <param name="propertyName">
        ...
        /// <summary>
        /// Returns the <see cref="CDP4Common.DTO.ScaleValueDefinition"/> property type from the supplied property name.
        /// </summary>
        /// <param name="propertyName">
        /// The property name.
        /// </param>
        ...
        /// <summary>
        /// Returns the container property for the supplied type name is a possible container for <see cref="CDP4Common.DTO.ScaleValueDefinition"/>.
        /// </summary>
        /// <param name="typeName">
        /// Name of the type for which to check if it is a container of <see cref="CDP4Common.DTO.ScaleValueDefinition"/>.
        /// </param>
        /// <param name="containerProperty">
        /// Supplied container property info instance that will be set if the supplied type name is a container of <see cref="CDP4Common.DTO.ScaleValueDefinition"/>.
        /// </param>
        /// <returns>
        /// True if the supplied typeName is a container for <see cref="CDP4Common.DTO.ScaleValueDefinition"/> and sets the container property name.
        /// </returns>
        ...
        /// <summary>
        /// Check if the supplied property name for <see cref="CDP4Common.DTO.ScaleValueDefinition"/> is scalar.
        /// </summary>
        /// <param name="propertyName">
        /// Name of the property for which to check if it is scalar.
        /// </param>
        ...
        public bool ApplyPropertyUpdate(CDP4Common.DTO.Thing updatableThing, string propertyName, object value)
        {
            ...
            this.propertyValueAssignmentMap[propertyName]((CDP4Common.DTO.ScaleValueDefinition)updatableThing, value);
        ...
        public object DeserializeCollectionValue(string propertyName, object value)
        {
            ...
            {
                throw new ArgumentException($"'{propertyName}' is not a valid collection property of 'ScaleValueDefinition'");
            }
        ...
        public object GetValue(string propertyName, CDP4Common.DTO.Thing thing)
        {
            ...
            return this.propertyValueMap[propertyName]((CDP4Common.DTO.ScaleValueDefinition)thing);
        }
        ...
        /// <summary>
        /// Instantiates a <see cref="CDP4Common.DTO.ScaleValueDefinition"/>
        /// </summary>
        /// <returns>
        ...
        {
            return new CDP4Common.DTO.ScaleValueDefinition(guid, revisionNumber);
        }
    }
}
