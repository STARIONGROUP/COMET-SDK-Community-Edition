// --------------------------------------------------------------------------------------------------------------------
// <copyright file="ArchitectureElementMetaInfo.cs" company="RHEA System S.A.">
...
namespace CDP4Common.MetaInfo
{
    ...
    /// <summary>
    /// This a class that holds meta info for <see cref="ArchitectureElement"/>.
    /// </summary>
    public partial class ArchitectureElementMetaInfo : IArchitectureElementMetaInfo
    {
        ...
        /// </summary>
        private readonly Dictionary<string, Func<CDP4Common.DTO.ArchitectureElement, IEnumerable<Guid>>> containmentPropertyValueMap = new Dictionary<string, Func<CDP4Common.DTO.ArchitectureElement, IEnumerable<Guid>>>
        {
        ...
        /// </summary>
        private readonly Dictionary<string, Func<CDP4Common.DTO.ArchitectureElement, IEnumerable<OrderedItem>>> orderedContainmentPropertyValueMap = new Dictionary<string, Func<CDP4Common.DTO.ArchitectureElement, IEnumerable<OrderedItem>>>();

        /// <summary>
        /// The validation rules that should pass for an instance of <see cref="CDP4Common.DTO.ArchitectureElement"/>.
        /// </summary>
        private readonly Dictionary<string, DtoValidationHelper<CDP4Common.DTO.ArchitectureElement>> validationRules = new Dictionary<string, DtoValidationHelper<CDP4Common.DTO.ArchitectureElement>>
        {
            ...
            { "LocalStyle", new DtoValidationHelper<CDP4Common.DTO.ArchitectureElement>(item => item.LocalStyle != null, "The 'LocalStyle' property of a 'ArchitectureElement' is mandatory and cannot be null.") },
            { "Name", new DtoValidationHelper<CDP4Common.DTO.ArchitectureElement>(item => !string.IsNullOrWhiteSpace(item.Name), "The 'Name' property of a 'ArchitectureElement' is mandatory and cannot be empty or null.") },
        };
        ...
        /// </exception>
        public void Validate(CDP4Common.DTO.Thing architectureElement)
        {
            this.Validate(architectureElement, x => true);
        }
        ...
        /// If any validation rule failed.
        /// </exception>
        public void Validate(CDP4Common.DTO.Thing architectureElement, Func<string, bool> validateProperty)
        {
            foreach (var applicableRule in this.validationRules.Where(x => validateProperty(x.Key)))
            {
                applicableRule.Value.Validate((CDP4Common.DTO.ArchitectureElement)architectureElement);
            }
        }
        ...
        /// </returns>
        public bool TryValidate(CDP4Common.DTO.Thing architectureElement)
        {
            return this.TryValidate(architectureElement, x => true);
        }
        ...
        /// True if all validation rules have passed or if none are defined.
        /// </returns>
        public bool TryValidate(CDP4Common.DTO.Thing architectureElement, Func<string, bool> validateProperty)
        {
            var applicableValidationRules = this.validationRules.Where(x => validateProperty(x.Key)).Select(x => x.Value);

            return applicableValidationRules.All(applicableRule => applicableRule.TryValidate((CDP4Common.DTO.ArchitectureElement)architectureElement));
        }

        /// <summary>
        /// Returns the containment property value for the supplied <see cref="CDP4Common.DTO.ArchitectureElement"/>.
        /// </summary>
        /// <param name="architectureElement">
        /// The <see cref="CDP4Common.DTO.ArchitectureElement"/> for which to return the containment property value.
        /// </param>
        ...
        /// If the property name is not supported for the <see cref="CDP4Common.DTO.ArchitectureElement"/>.
        /// </exception>
        public IEnumerable<Guid> GetContainmentIds(CDP4Common.DTO.Thing architectureElement, string propertyName)
        {
            if (!this.containmentPropertyValueMap.ContainsKey(propertyName))
            {
                throw new ArgumentException($"'{propertyName}' is not a valid containment property of 'ArchitectureElement'");
            }

            return this.containmentPropertyValueMap[propertyName]((CDP4Common.DTO.ArchitectureElement)architectureElement);
        }

        /// <summary>
        /// Returns the ordered containment property value for the supplied <see cref="CDP4Common.DTO.ArchitectureElement"/>.
        /// </summary>
        /// <param name="architectureElement">
        /// The <see cref="CDP4Common.DTO.ArchitectureElement"/> for which to return the containment property value.
        /// </param>
        ...
        /// If the property name is not supported for the <see cref="CDP4Common.DTO.ArchitectureElement"/>.
        /// </exception>
        public IEnumerable<OrderedItem> GetOrderedContainmentIds(CDP4Common.DTO.Thing architectureElement, string propertyName)
        {
            ...
            return this.orderedContainmentPropertyValueMap[propertyName]((CDP4Common.DTO.ArchitectureElement)architectureElement);
        }
        ...
        /// <summary>
        /// Gets the <see cref="PropertyMetaInfo"/> for the <see cref="ArchitectureElement"/> class
        /// </summary>
        ...
        /// </summary>
        private readonly Dictionary<string, Func<CDP4Common.DTO.ArchitectureElement, object>> propertyValueMap = new Dictionary<string, Func<CDP4Common.DTO.ArchitectureElement, object>>
        {
        ...
        /// </summary>
        private readonly Dictionary<string, Action<CDP4Common.DTO.ArchitectureElement, object>> propertyValueAssignmentMap = new Dictionary<string, Action<CDP4Common.DTO.ArchitectureElement, object>>
        {
            { "Actor", (architectureElement, value) => architectureElement.Actor = value == null ? (Guid?)null : (Guid)value },
            { "DepictedThing", (architectureElement, value) => architectureElement.DepictedThing = value == null ? (Guid?)null : (Guid)value },
            { "Documentation", (architectureElement, value) => architectureElement.Documentation = value.ToString() },
            { "Iid", (architectureElement, value) => architectureElement.Iid = (Guid)value },
            { "ModifiedOn", (architectureElement, value) => architectureElement.ModifiedOn = (DateTime)value },
            { "Name", (architectureElement, value) => architectureElement.Name = value.ToString() },
            { "Resolution", (architectureElement, value) => architectureElement.Resolution = (float)value },
            { "SharedStyle", (architectureElement, value) => architectureElement.SharedStyle = value == null ? (Guid?)null : (Guid)value },
            { "ThingPreference", (architectureElement, value) => architectureElement.ThingPreference = value == null ? (string)null : value.ToString() },
        };
        ...
        /// <summary>
        /// Returns the <see cref="CDP4Common.DTO.ArchitectureElement"/> containment property type from the supplied property name.
        /// </summary>
        /// <param name="propertyName">
        ...
        /// <summary>
        /// Returns the <see cref="CDP4Common.DTO.ArchitectureElement"/> property type from the supplied property name.
        /// </summary>
        /// <param name="propertyName">
        /// The property name.
        /// </param>
        ...
        /// <summary>
        /// Returns the container property for the supplied type name is a possible container for <see cref="CDP4Common.DTO.ArchitectureElement"/>.
        /// </summary>
        /// <param name="typeName">
        /// Name of the type for which to check if it is a container of <see cref="CDP4Common.DTO.ArchitectureElement"/>.
        /// </param>
        /// <param name="containerProperty">
        /// Supplied container property info instance that will be set if the supplied type name is a container of <see cref="CDP4Common.DTO.ArchitectureElement"/>.
        /// </param>
        /// <returns>
        /// True if the supplied typeName is a container for <see cref="CDP4Common.DTO.ArchitectureElement"/> and sets the container property name.
        /// </returns>
        ...
        /// <summary>
        /// Check if the supplied property name for <see cref="CDP4Common.DTO.ArchitectureElement"/> is scalar.
        /// </summary>
        /// <param name="propertyName">
        /// Name of the property for which to check if it is scalar.
        /// </param>
        ...
        public bool ApplyPropertyUpdate(CDP4Common.DTO.Thing updatableThing, string propertyName, object value)
        {
            ...
            this.propertyValueAssignmentMap[propertyName]((CDP4Common.DTO.ArchitectureElement)updatableThing, value);
        ...
        public object DeserializeCollectionValue(string propertyName, object value)
        {
            ...
            {
                throw new ArgumentException($"'{propertyName}' is not a valid collection property of 'ArchitectureElement'");
            }
        ...
        public object GetValue(string propertyName, CDP4Common.DTO.Thing thing)
        {
            ...
            return this.propertyValueMap[propertyName]((CDP4Common.DTO.ArchitectureElement)thing);
        }
        ...
        /// <summary>
        /// Instantiates a <see cref="CDP4Common.DTO.ArchitectureElement"/>
        /// </summary>
        /// <returns>
        ...
        {
            return new CDP4Common.DTO.ArchitectureElement(guid, revisionNumber);
        }
    }
}
