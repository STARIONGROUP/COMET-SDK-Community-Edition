...
namespace CDP4Common.MetaInfo
{
    ...
    public partial class SectionMetaInfo : ISectionMetaInfo
    {
        ...
        public IEnumerable<Guid> GetContainmentIds(CDP4Common.DTO.Thing section, string propertyName)
        {
            ...
            {
                throw new ArgumentException(string.Format("'{0}' is not a valid containment property of 'Section'", propertyName));
            }
        ...
        {
            { "Page", new PropertyMetaInfo("Page", "Guid", PropertyKind.OrderedList, AggregationKind.Composite, false, true, true, 0, "*", true) },
        };
        ...
        {
            { "Book", new PropertyMetaInfo("Section", "Guid", PropertyKind.OrderedList, AggregationKind.Composite, false, true, true, 0, "*", true) },
        };
        ...
        public object DeserializeCollectionValue(string propertyName, object value)
        {
            ...
            {
                throw new ArgumentException(string.Format("'{0}' is not a valid collection property of 'Section'", propertyName));
            }
