// --------------------------------------------------------------------------------------------------------------------
// <copyright file="SectionMetaInfo.cs" company="Starion Group S.A.">
...
namespace CDP4Common.MetaInfo
{
    ...
    /// <summary>
    /// This a class that holds meta info for <see cref="Section"/>.
    /// </summary>
    public partial class SectionMetaInfo : ISectionMetaInfo
    {
        /// <summary>
        ...
        /// </summary>
        private readonly Dictionary<string, Func<CDP4Common.DTO.Section, IEnumerable<OrderedItem>>> orderedContainmentPropertyValueMap = new Dictionary<string, Func<CDP4Common.DTO.Section, IEnumerable<OrderedItem>>>
        {
            { "Page", section => section.Page },
        };

        /// <summary>
        /// The validation rules that should pass for an instance of <see cref="CDP4Common.DTO.Section"/>.
        /// </summary>
        private readonly Dictionary<string, DtoValidationHelper<CDP4Common.DTO.Section>> validationRules = new Dictionary<string, DtoValidationHelper<CDP4Common.DTO.Section>>
        {
            { "Category", new DtoValidationHelper<CDP4Common.DTO.Section>(item => item.Category != null, "The 'Category' property of a 'Section' is mandatory and cannot be null.") },
            { "ExcludedDomain", new DtoValidationHelper<CDP4Common.DTO.Section>(item => item.ExcludedDomain != null, "The 'ExcludedDomain' property of a 'Section' is mandatory and cannot be null.") },
            { "ExcludedPerson", new DtoValidationHelper<CDP4Common.DTO.Section>(item => item.ExcludedPerson != null, "The 'ExcludedPerson' property of a 'Section' is mandatory and cannot be null.") },
            { "Name", new DtoValidationHelper<CDP4Common.DTO.Section>(item => !string.IsNullOrWhiteSpace(item.Name), "The 'Name' property of a 'Section' is mandatory and cannot be empty or null.") },
            { "Page", new DtoValidationHelper<CDP4Common.DTO.Section>(item => item.Page != null, "The 'Page' property of a 'Section' is mandatory and cannot be null.") },
            { "ShortName", new DtoValidationHelper<CDP4Common.DTO.Section>(item => !string.IsNullOrWhiteSpace(item.ShortName), "The 'ShortName' property of a 'Section' is mandatory and cannot be empty or null.") },
        };
        ...
        /// </exception>
        public void Validate(CDP4Common.DTO.Thing section)
        {
            this.Validate(section, x => true);
        }
        ...
        /// If any validation rule failed.
        /// </exception>
        public void Validate(CDP4Common.DTO.Thing section, Func<string, bool> validateProperty)
        {
            foreach (var applicableRule in this.validationRules.Where(x => validateProperty(x.Key)))
            {
                applicableRule.Value.Validate((CDP4Common.DTO.Section)section);
            }
        }
        ...
        /// </returns>
        public bool TryValidate(CDP4Common.DTO.Thing section)
        {
            return this.TryValidate(section, x => true);
        }
        ...
        /// True if all validation rules have passed or if none are defined.
        /// </returns>
        public bool TryValidate(CDP4Common.DTO.Thing section, Func<string, bool> validateProperty)
        {
            var applicableValidationRules = this.validationRules.Where(x => validateProperty(x.Key)).Select(x => x.Value);

            return applicableValidationRules.All(applicableRule => applicableRule.TryValidate((CDP4Common.DTO.Section)section));
        }

        /// <summary>
        /// Returns the containment property value for the supplied <see cref="CDP4Common.DTO.Section"/>.
        /// </summary>
        /// <param name="section">
        /// The <see cref="CDP4Common.DTO.Section"/> for which to return the containment property value.
        /// </param>
        ...
        /// If the property name is not supported for the <see cref="CDP4Common.DTO.Section"/>.
        /// </exception>
        public IEnumerable<Guid> GetContainmentIds(CDP4Common.DTO.Thing section, string propertyName)
        {
            if (!this.containmentPropertyValueMap.ContainsKey(propertyName))
            {
                throw new ArgumentException($"'{propertyName}' is not a valid containment property of 'Section'");
            }

            return this.containmentPropertyValueMap[propertyName]((CDP4Common.DTO.Section)section);
        }

        /// <summary>
        /// Returns the ordered containment property value for the supplied <see cref="CDP4Common.DTO.Section"/>.
        /// </summary>
        /// <param name="section">
        /// The <see cref="CDP4Common.DTO.Section"/> for which to return the containment property value.
        /// </param>
        ...
        /// If the property name is not supported for the <see cref="CDP4Common.DTO.Section"/>.
        /// </exception>
        public IEnumerable<OrderedItem> GetOrderedContainmentIds(CDP4Common.DTO.Thing section, string propertyName)
        {
            ...
            return this.orderedContainmentPropertyValueMap[propertyName]((CDP4Common.DTO.Section)section);
        }
        ...
        /// </summary>
        private readonly Dictionary<string, Func<CDP4Common.DTO.Section, object>> propertyValueMap = new Dictionary<string, Func<CDP4Common.DTO.Section, object>>
        {
        ...
        private readonly Dictionary<string, Func<object, object>> collectionPropertyValueDeserializationMap = new Dictionary<string, Func<object, object>>
        {
            ...
            { "Page", (value) => (Guid)value },
        };

        /// <summary>
        /// The property value assignment map.
        /// </summary>
        private readonly Dictionary<string, Action<CDP4Common.DTO.Section, object>> propertyValueAssignmentMap = new Dictionary<string, Action<CDP4Common.DTO.Section, object>>
        {
            { "Actor", (section, value) => section.Actor = value == null ? (Guid?)null : (Guid)value },
            { "CreatedOn", (section, value) => section.CreatedOn = (DateTime)value },
            { "Iid", (section, value) => section.Iid = (Guid)value },
            { "ModifiedOn", (section, value) => section.ModifiedOn = (DateTime)value },
            { "Name", (section, value) => section.Name = value.ToString() },
            { "Owner", (section, value) => section.Owner = (Guid)value },
            { "ShortName", (section, value) => section.ShortName = value.ToString() },
            { "ThingPreference", (section, value) => section.ThingPreference = value == null ? (string)null : value.ToString() },
        };
        ...
        {
            { "Book", new PropertyMetaInfo("Section", "Section", PropertyKind.OrderedList, AggregationKind.Composite, false, true, true, 0, "*", true) },
        };
        ...
        /// <summary>
        /// Returns the <see cref="CDP4Common.DTO.Section"/> containment property type from the supplied property name.
        /// </summary>
        /// <param name="propertyName">
        ...
        /// <summary>
        /// Returns the <see cref="CDP4Common.DTO.Section"/> property type from the supplied property name.
        /// </summary>
        /// <param name="propertyName">
        /// The property name.
        /// </param>
        ...
        /// <summary>
        /// Returns the container property for the supplied type name is a possible container for <see cref="CDP4Common.DTO.Section"/>.
        /// </summary>
        /// <param name="typeName">
        /// Name of the type for which to check if it is a container of <see cref="CDP4Common.DTO.Section"/>.
        /// </param>
        /// <param name="containerProperty">
        /// Supplied container property info instance that will be set if the supplied type name is a container of <see cref="CDP4Common.DTO.Section"/>.
        /// </param>
        /// <returns>
        /// True if the supplied typeName is a container for <see cref="CDP4Common.DTO.Section"/> and sets the container property name.
        /// </returns>
        ...
        /// <summary>
        /// Check if the supplied property name for <see cref="CDP4Common.DTO.Section"/> is scalar.
        /// </summary>
        /// <param name="propertyName">
        /// Name of the property for which to check if it is scalar.
        /// </param>
        ...
        public bool ApplyPropertyUpdate(CDP4Common.DTO.Thing updatableThing, string propertyName, object value)
        {
            ...
            this.propertyValueAssignmentMap[propertyName]((CDP4Common.DTO.Section)updatableThing, value);
        ...
        public object DeserializeCollectionValue(string propertyName, object value)
        {
            ...
            {
                throw new ArgumentException($"'{propertyName}' is not a valid collection property of 'Section'");
            }
        ...
        public object GetValue(string propertyName, CDP4Common.DTO.Thing thing)
        {
            ...
            return this.propertyValueMap[propertyName]((CDP4Common.DTO.Section)thing);
        }
        ...
        /// <summary>
        /// Instantiates a <see cref="CDP4Common.DTO.Section"/>
        /// </summary>
        /// <returns>
        ...
        {
            return new CDP4Common.DTO.Section(guid, revisionNumber);
        }
    }
}
