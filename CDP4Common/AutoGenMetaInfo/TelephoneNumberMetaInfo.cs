...
namespace CDP4Common.MetaInfo
{
    ...
    public partial class TelephoneNumberMetaInfo : ITelephoneNumberMetaInfo
    {
        ...
        public IEnumerable<Guid> GetContainmentIds(CDP4Common.DTO.Thing telephoneNumber, string propertyName)
        {
            ...
            {
                throw new ArgumentException(string.Format("'{0}' is not a valid containment property of 'TelephoneNumber'", propertyName));
            }
        ...
        public object DeserializeCollectionValue(string propertyName, object value)
        {
            ...
            {
                throw new ArgumentException(string.Format("'{0}' is not a valid collection property of 'TelephoneNumber'", propertyName));
            }
