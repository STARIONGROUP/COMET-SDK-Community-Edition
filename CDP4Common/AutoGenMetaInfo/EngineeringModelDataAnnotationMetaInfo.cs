// --------------------------------------------------------------------------------------------------------------------
// <copyright file="EngineeringModelDataAnnotationMetaInfo.cs" company="RHEA System S.A.">
...
namespace CDP4Common.MetaInfo
{
    ...
    /// <summary>
    /// This a class that holds meta info for <see cref="EngineeringModelDataAnnotation"/>.
    /// </summary>
    public partial class EngineeringModelDataAnnotationMetaInfo : IEngineeringModelDataAnnotationMetaInfo
    {
        /// <summary>
        /// The containment property value map.
        /// </summary>
        private readonly Dictionary<string, Func<CDP4Common.DTO.EngineeringModelDataAnnotation, IEnumerable<Guid>>> containmentPropertyValueMap = new Dictionary<string, Func<CDP4Common.DTO.EngineeringModelDataAnnotation, IEnumerable<Guid>>>
        {
            { "Discussion", engineeringModelDataAnnotation => engineeringModelDataAnnotation.Discussion },
            { "RelatedThing", engineeringModelDataAnnotation => engineeringModelDataAnnotation.RelatedThing },
        };

        /// <summary>
        /// The ordered containment property value map.
        /// </summary>
        private readonly Dictionary<string, Func<CDP4Common.DTO.EngineeringModelDataAnnotation, IEnumerable<OrderedItem>>> orderedContainmentPropertyValueMap = new Dictionary<string, Func<CDP4Common.DTO.EngineeringModelDataAnnotation, IEnumerable<OrderedItem>>>();

        /// <summary>
        /// The validation rules that should pass for an instance of <see cref="CDP4Common.DTO.EngineeringModelDataAnnotation"/>.
        /// </summary>
        private readonly Dictionary<string, DtoValidationHelper<CDP4Common.DTO.EngineeringModelDataAnnotation>> validationRules = new Dictionary<string, DtoValidationHelper<CDP4Common.DTO.EngineeringModelDataAnnotation>>
        {
            { "Content", new DtoValidationHelper<CDP4Common.DTO.EngineeringModelDataAnnotation>(item => !string.IsNullOrWhiteSpace(item.Content), "The 'Content' property of a 'EngineeringModelDataAnnotation' is mandatory and cannot be empty or null.") },
            { "Discussion", new DtoValidationHelper<CDP4Common.DTO.EngineeringModelDataAnnotation>(item => item.Discussion != null, "The 'Discussion' property of a 'EngineeringModelDataAnnotation' is mandatory and cannot be null.") },
            { "ExcludedDomain", new DtoValidationHelper<CDP4Common.DTO.EngineeringModelDataAnnotation>(item => item.ExcludedDomain != null, "The 'ExcludedDomain' property of a 'EngineeringModelDataAnnotation' is mandatory and cannot be null.") },
            { "ExcludedPerson", new DtoValidationHelper<CDP4Common.DTO.EngineeringModelDataAnnotation>(item => item.ExcludedPerson != null, "The 'ExcludedPerson' property of a 'EngineeringModelDataAnnotation' is mandatory and cannot be null.") },
            { "LanguageCode", new DtoValidationHelper<CDP4Common.DTO.EngineeringModelDataAnnotation>(item => !string.IsNullOrWhiteSpace(item.LanguageCode), "The 'LanguageCode' property of a 'EngineeringModelDataAnnotation' is mandatory and cannot be empty or null.") },
            { "RelatedThing", new DtoValidationHelper<CDP4Common.DTO.EngineeringModelDataAnnotation>(item => item.RelatedThing != null, "The 'RelatedThing' property of a 'EngineeringModelDataAnnotation' is mandatory and cannot be null.") },
        };
        ...
        /// </exception>
        public void Validate(CDP4Common.DTO.Thing engineeringModelDataAnnotation)
        {
            this.Validate(engineeringModelDataAnnotation, x => true);
        }
        ...
        /// If any validation rule failed.
        /// </exception>
        public void Validate(CDP4Common.DTO.Thing engineeringModelDataAnnotation, Func<string, bool> validateProperty)
        {
            foreach (var applicableRule in this.validationRules.Where(x => validateProperty(x.Key)))
            {
                applicableRule.Value.Validate((CDP4Common.DTO.EngineeringModelDataAnnotation)engineeringModelDataAnnotation);
            }
        }
        ...
        /// </returns>
        public bool TryValidate(CDP4Common.DTO.Thing engineeringModelDataAnnotation)
        {
            return this.TryValidate(engineeringModelDataAnnotation, x => true);
        }
        ...
        /// True if all validation rules have passed or if none are defined.
        /// </returns>
        public bool TryValidate(CDP4Common.DTO.Thing engineeringModelDataAnnotation, Func<string, bool> validateProperty)
        {
            var applicableValidationRules = this.validationRules.Where(x => validateProperty(x.Key)).Select(x => x.Value);

            return applicableValidationRules.All(applicableRule => applicableRule.TryValidate((CDP4Common.DTO.EngineeringModelDataAnnotation)engineeringModelDataAnnotation));
        }

        /// <summary>
        /// Returns the containment property value for the supplied <see cref="CDP4Common.DTO.EngineeringModelDataAnnotation"/>.
        /// </summary>
        /// <param name="engineeringModelDataAnnotation">
        /// The <see cref="CDP4Common.DTO.EngineeringModelDataAnnotation"/> for which to return the containment property value.
        /// </param>
        ...
        /// If the property name is not supported for the <see cref="CDP4Common.DTO.EngineeringModelDataAnnotation"/>.
        /// </exception>
        public IEnumerable<Guid> GetContainmentIds(CDP4Common.DTO.Thing engineeringModelDataAnnotation, string propertyName)
        {
            if (!this.containmentPropertyValueMap.ContainsKey(propertyName))
            {
                throw new ArgumentException(string.Format("'{0}' is not a valid containment property of 'EngineeringModelDataAnnotation'", propertyName));
            }

            return this.containmentPropertyValueMap[propertyName]((CDP4Common.DTO.EngineeringModelDataAnnotation)engineeringModelDataAnnotation);
        }

        /// <summary>
        /// Returns the ordered containment property value for the supplied <see cref="CDP4Common.DTO.EngineeringModelDataAnnotation"/>.
        /// </summary>
        /// <param name="engineeringModelDataAnnotation">
        /// The <see cref="CDP4Common.DTO.EngineeringModelDataAnnotation"/> for which to return the containment property value.
        /// </param>
        ...
        /// If the property name is not supported for the <see cref="CDP4Common.DTO.EngineeringModelDataAnnotation"/>.
        /// </exception>
        public IEnumerable<OrderedItem> GetOrderedContainmentIds(CDP4Common.DTO.Thing engineeringModelDataAnnotation, string propertyName)
        {
            ...
            return this.orderedContainmentPropertyValueMap[propertyName]((CDP4Common.DTO.EngineeringModelDataAnnotation)engineeringModelDataAnnotation);
        }
        ...
        /// <summary>
        /// Gets the <see cref="PropertyMetaInfo"/> for the <see cref="EngineeringModelDataAnnotation"/> class
        /// </summary>
        ...
        private readonly Dictionary<string, Action<CDP4Common.DTO.EngineeringModelDataAnnotation, object>> propertyValueAssignmentMap = new Dictionary<string, Action<CDP4Common.DTO.EngineeringModelDataAnnotation, object>>
        {
            ...
            { "Iid", (engineeringModelDataAnnotation, value) => engineeringModelDataAnnotation.Iid = (Guid)value },
        ...
        /// <summary>
        /// Returns the <see cref="CDP4Common.DTO.EngineeringModelDataAnnotation"/> containment property type from the supplied property name.
        /// </summary>
        /// <param name="propertyName">
        ...
        /// <summary>
        /// Returns the <see cref="CDP4Common.DTO.EngineeringModelDataAnnotation"/> property type from the supplied property name.
        /// </summary>
        /// <param name="propertyName">
        /// The property name.
        /// </param>
        ...
        /// <summary>
        /// Returns the container property for the supplied type name is a possible container for <see cref="CDP4Common.DTO.EngineeringModelDataAnnotation"/>.
        /// </summary>
        /// <param name="typeName">
        /// Name of the type for which to check if it is a container of <see cref="CDP4Common.DTO.EngineeringModelDataAnnotation"/>.
        /// </param>
        /// <param name="containerProperty">
        /// Supplied container property info instance that will be set if the supplied type name is a container of <see cref="CDP4Common.DTO.EngineeringModelDataAnnotation"/>.
        /// </param>
        /// <returns>
        /// True if the supplied typeName is a container for <see cref="CDP4Common.DTO.EngineeringModelDataAnnotation"/> and sets the container property name.
        /// </returns>
        ...
        /// <summary>
        /// Check if the supplied property name for <see cref="CDP4Common.DTO.EngineeringModelDataAnnotation"/> is scalar.
        /// </summary>
        /// <param name="propertyName">
        /// Name of the property for which to check if it is scalar.
        /// </param>
        ...
        public bool ApplyPropertyUpdate(CDP4Common.DTO.Thing updatableThing, string propertyName, object value)
        {
            ...
            this.propertyValueAssignmentMap[propertyName]((CDP4Common.DTO.EngineeringModelDataAnnotation)updatableThing, value);
        ...
        public object DeserializeCollectionValue(string propertyName, object value)
        {
            ...
            {
                throw new ArgumentException(string.Format("'{0}' is not a valid collection property of 'EngineeringModelDataAnnotation'", propertyName));
            }
        ...
        public object GetValue(string propertyName, CDP4Common.DTO.Thing thing)
        {
            ...
            return this.propertyValueMap[propertyName]((CDP4Common.DTO.EngineeringModelDataAnnotation)thing);
        }
        ...
        /// <summary>
        /// Instantiates a <see cref="CDP4Common.DTO.EngineeringModelDataAnnotation"/>
        /// </summary>
        /// <returns>
