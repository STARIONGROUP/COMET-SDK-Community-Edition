// --------------------------------------------------------------------------------------------------------------------
// <copyright file="EngineeringModelDataAnnotationMetaInfo.cs" company="Starion Group S.A.">
...
namespace CDP4Common.MetaInfo
{
    ...
    public partial class EngineeringModelDataAnnotationMetaInfo : IEngineeringModelDataAnnotationMetaInfo
    {
        ...
        public IEnumerable<Guid> GetContainmentIds(CDP4Common.DTO.Thing engineeringModelDataAnnotation, string propertyName)
        {
            ...
            {
                throw new ArgumentException($"'{propertyName}' is not a valid containment property of 'EngineeringModelDataAnnotation'");
            }
        ...
        public object DeserializeCollectionValue(string propertyName, object value)
        {
            ...
            {
                throw new ArgumentException($"'{propertyName}' is not a valid collection property of 'EngineeringModelDataAnnotation'");
            }
