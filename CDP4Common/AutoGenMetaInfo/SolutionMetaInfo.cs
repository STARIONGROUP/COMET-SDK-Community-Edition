// --------------------------------------------------------------------------------------------------------------------
// <copyright file="SolutionMetaInfo.cs" company="Starion Group S.A.">
...
namespace CDP4Common.MetaInfo
{
    ...
    /// <summary>
    /// This a class that holds meta info for <see cref="Solution"/>.
    /// </summary>
    public partial class SolutionMetaInfo : ISolutionMetaInfo
    {
        /// <summary>
        /// The containment property value map.
        /// </summary>
        private readonly Dictionary<string, Func<CDP4Common.DTO.Solution, IEnumerable<Guid>>> containmentPropertyValueMap = new Dictionary<string, Func<CDP4Common.DTO.Solution, IEnumerable<Guid>>>();

        /// <summary>
        /// The ordered containment property value map.
        /// </summary>
        private readonly Dictionary<string, Func<CDP4Common.DTO.Solution, IEnumerable<OrderedItem>>> orderedContainmentPropertyValueMap = new Dictionary<string, Func<CDP4Common.DTO.Solution, IEnumerable<OrderedItem>>>();

        /// <summary>
        /// The validation rules that should pass for an instance of <see cref="CDP4Common.DTO.Solution"/>.
        /// </summary>
        private readonly Dictionary<string, DtoValidationHelper<CDP4Common.DTO.Solution>> validationRules = new Dictionary<string, DtoValidationHelper<CDP4Common.DTO.Solution>>
        {
            { "Content", new DtoValidationHelper<CDP4Common.DTO.Solution>(item => !string.IsNullOrWhiteSpace(item.Content), "The 'Content' property of a 'Solution' is mandatory and cannot be empty or null.") },
            { "ExcludedDomain", new DtoValidationHelper<CDP4Common.DTO.Solution>(item => item.ExcludedDomain != null, "The 'ExcludedDomain' property of a 'Solution' is mandatory and cannot be null.") },
            { "ExcludedPerson", new DtoValidationHelper<CDP4Common.DTO.Solution>(item => item.ExcludedPerson != null, "The 'ExcludedPerson' property of a 'Solution' is mandatory and cannot be null.") },
            { "LanguageCode", new DtoValidationHelper<CDP4Common.DTO.Solution>(item => !string.IsNullOrWhiteSpace(item.LanguageCode), "The 'LanguageCode' property of a 'Solution' is mandatory and cannot be empty or null.") },
        };
        ...
        /// </exception>
        public void Validate(CDP4Common.DTO.Thing solution)
        {
            this.Validate(solution, x => true);
        }
        ...
        /// If any validation rule failed.
        /// </exception>
        public void Validate(CDP4Common.DTO.Thing solution, Func<string, bool> validateProperty)
        {
            foreach (var applicableRule in this.validationRules.Where(x => validateProperty(x.Key)))
            {
                applicableRule.Value.Validate((CDP4Common.DTO.Solution)solution);
            }
        }
        ...
        /// </returns>
        public bool TryValidate(CDP4Common.DTO.Thing solution)
        {
            return this.TryValidate(solution, x => true);
        }
        ...
        /// True if all validation rules have passed or if none are defined.
        /// </returns>
        public bool TryValidate(CDP4Common.DTO.Thing solution, Func<string, bool> validateProperty)
        {
            var applicableValidationRules = this.validationRules.Where(x => validateProperty(x.Key)).Select(x => x.Value);

            return applicableValidationRules.All(applicableRule => applicableRule.TryValidate((CDP4Common.DTO.Solution)solution));
        }

        /// <summary>
        /// Returns the containment property value for the supplied <see cref="CDP4Common.DTO.Solution"/>.
        /// </summary>
        /// <param name="solution">
        /// The <see cref="CDP4Common.DTO.Solution"/> for which to return the containment property value.
        /// </param>
        ...
        /// If the property name is not supported for the <see cref="CDP4Common.DTO.Solution"/>.
        /// </exception>
        public IEnumerable<Guid> GetContainmentIds(CDP4Common.DTO.Thing solution, string propertyName)
        {
            if (!this.containmentPropertyValueMap.ContainsKey(propertyName))
            {
                throw new ArgumentException($"'{propertyName}' is not a valid containment property of 'Solution'");
            }

            return this.containmentPropertyValueMap[propertyName]((CDP4Common.DTO.Solution)solution);
        }

        /// <summary>
        /// Returns the ordered containment property value for the supplied <see cref="CDP4Common.DTO.Solution"/>.
        /// </summary>
        /// <param name="solution">
        /// The <see cref="CDP4Common.DTO.Solution"/> for which to return the containment property value.
        /// </param>
        ...
        /// If the property name is not supported for the <see cref="CDP4Common.DTO.Solution"/>.
        /// </exception>
        public IEnumerable<OrderedItem> GetOrderedContainmentIds(CDP4Common.DTO.Thing solution, string propertyName)
        {
            ...
            return this.orderedContainmentPropertyValueMap[propertyName]((CDP4Common.DTO.Solution)solution);
        }
        ...
        /// <summary>
        /// Gets the <see cref="PropertyMetaInfo"/> for the <see cref="Solution"/> class
        /// </summary>
        ...
        /// </summary>
        private readonly Dictionary<string, Func<CDP4Common.DTO.Solution, object>> propertyValueMap = new Dictionary<string, Func<CDP4Common.DTO.Solution, object>>
        {
        ...
        /// </summary>
        private readonly Dictionary<string, Action<CDP4Common.DTO.Solution, object>> propertyValueAssignmentMap = new Dictionary<string, Action<CDP4Common.DTO.Solution, object>>
        {
            { "Actor", (solution, value) => solution.Actor = value == null ? (Guid?)null : (Guid)value },
            { "Author", (solution, value) => solution.Author = (Guid)value },
            { "Content", (solution, value) => solution.Content = value.ToString() },
            { "CreatedOn", (solution, value) => solution.CreatedOn = (DateTime)value },
            { "Iid", (solution, value) => solution.Iid = (Guid)value },
            { "LanguageCode", (solution, value) => solution.LanguageCode = value.ToString() },
            { "ModifiedOn", (solution, value) => solution.ModifiedOn = (DateTime)value },
            { "Owner", (solution, value) => solution.Owner = (Guid)value },
            { "ThingPreference", (solution, value) => solution.ThingPreference = value == null ? (string)null : value.ToString() },
        };
        ...
        {
            { "ReviewItemDiscrepancy", new PropertyMetaInfo("Solution", "Solution", PropertyKind.List, AggregationKind.Composite, false, false, true, 0, "1", true) },
        };
        ...
        /// <summary>
        /// Returns the <see cref="CDP4Common.DTO.Solution"/> containment property type from the supplied property name.
        /// </summary>
        /// <param name="propertyName">
        ...
        /// <summary>
        /// Returns the <see cref="CDP4Common.DTO.Solution"/> property type from the supplied property name.
        /// </summary>
        /// <param name="propertyName">
        /// The property name.
        /// </param>
        ...
        /// <summary>
        /// Returns the container property for the supplied type name is a possible container for <see cref="CDP4Common.DTO.Solution"/>.
        /// </summary>
        /// <param name="typeName">
        /// Name of the type for which to check if it is a container of <see cref="CDP4Common.DTO.Solution"/>.
        /// </param>
        /// <param name="containerProperty">
        /// Supplied container property info instance that will be set if the supplied type name is a container of <see cref="CDP4Common.DTO.Solution"/>.
        /// </param>
        /// <returns>
        /// True if the supplied typeName is a container for <see cref="CDP4Common.DTO.Solution"/> and sets the container property name.
        /// </returns>
        ...
        /// <summary>
        /// Check if the supplied property name for <see cref="CDP4Common.DTO.Solution"/> is scalar.
        /// </summary>
        /// <param name="propertyName">
        /// Name of the property for which to check if it is scalar.
        /// </param>
        ...
        public bool ApplyPropertyUpdate(CDP4Common.DTO.Thing updatableThing, string propertyName, object value)
        {
            ...
            this.propertyValueAssignmentMap[propertyName]((CDP4Common.DTO.Solution)updatableThing, value);
        ...
        public object DeserializeCollectionValue(string propertyName, object value)
        {
            ...
            {
                throw new ArgumentException($"'{propertyName}' is not a valid collection property of 'Solution'");
            }
        ...
        public object GetValue(string propertyName, CDP4Common.DTO.Thing thing)
        {
            ...
            return this.propertyValueMap[propertyName]((CDP4Common.DTO.Solution)thing);
        }
        ...
        /// <summary>
        /// Instantiates a <see cref="CDP4Common.DTO.Solution"/>
        /// </summary>
        /// <returns>
        ...
        {
            return new CDP4Common.DTO.Solution(guid, revisionNumber);
        }
    }
}
