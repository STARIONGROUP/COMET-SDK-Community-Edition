// --------------------------------------------------------------------------------------------------------------------
// <copyright file="ChangeProposalMetaInfo.cs" company="Starion Group S.A.">
...
namespace CDP4Common.MetaInfo
{
    ...
    /// <summary>
    /// This a class that holds meta info for <see cref="ChangeProposal"/>.
    /// </summary>
    public partial class ChangeProposalMetaInfo : IChangeProposalMetaInfo
    {
        /// <summary>
        /// The containment property value map.
        /// </summary>
        private readonly Dictionary<string, Func<CDP4Common.DTO.ChangeProposal, IEnumerable<Guid>>> containmentPropertyValueMap = new Dictionary<string, Func<CDP4Common.DTO.ChangeProposal, IEnumerable<Guid>>>
        {
            { "ApprovedBy", changeProposal => changeProposal.ApprovedBy },
            { "Discussion", changeProposal => changeProposal.Discussion },
            { "RelatedThing", changeProposal => changeProposal.RelatedThing },
        };

        /// <summary>
        /// The ordered containment property value map.
        /// </summary>
        private readonly Dictionary<string, Func<CDP4Common.DTO.ChangeProposal, IEnumerable<OrderedItem>>> orderedContainmentPropertyValueMap = new Dictionary<string, Func<CDP4Common.DTO.ChangeProposal, IEnumerable<OrderedItem>>>();

        /// <summary>
        /// The validation rules that should pass for an instance of <see cref="CDP4Common.DTO.ChangeProposal"/>.
        /// </summary>
        private readonly Dictionary<string, DtoValidationHelper<CDP4Common.DTO.ChangeProposal>> validationRules = new Dictionary<string, DtoValidationHelper<CDP4Common.DTO.ChangeProposal>>
        {
            { "ApprovedBy", new DtoValidationHelper<CDP4Common.DTO.ChangeProposal>(item => item.ApprovedBy != null, "The 'ApprovedBy' property of a 'ChangeProposal' is mandatory and cannot be null.") },
            { "Category", new DtoValidationHelper<CDP4Common.DTO.ChangeProposal>(item => item.Category != null, "The 'Category' property of a 'ChangeProposal' is mandatory and cannot be null.") },
            { "Content", new DtoValidationHelper<CDP4Common.DTO.ChangeProposal>(item => !string.IsNullOrWhiteSpace(item.Content), "The 'Content' property of a 'ChangeProposal' is mandatory and cannot be empty or null.") },
            { "Discussion", new DtoValidationHelper<CDP4Common.DTO.ChangeProposal>(item => item.Discussion != null, "The 'Discussion' property of a 'ChangeProposal' is mandatory and cannot be null.") },
            { "ExcludedDomain", new DtoValidationHelper<CDP4Common.DTO.ChangeProposal>(item => item.ExcludedDomain != null, "The 'ExcludedDomain' property of a 'ChangeProposal' is mandatory and cannot be null.") },
            { "ExcludedPerson", new DtoValidationHelper<CDP4Common.DTO.ChangeProposal>(item => item.ExcludedPerson != null, "The 'ExcludedPerson' property of a 'ChangeProposal' is mandatory and cannot be null.") },
            { "LanguageCode", new DtoValidationHelper<CDP4Common.DTO.ChangeProposal>(item => !string.IsNullOrWhiteSpace(item.LanguageCode), "The 'LanguageCode' property of a 'ChangeProposal' is mandatory and cannot be empty or null.") },
            { "RelatedThing", new DtoValidationHelper<CDP4Common.DTO.ChangeProposal>(item => item.RelatedThing != null, "The 'RelatedThing' property of a 'ChangeProposal' is mandatory and cannot be null.") },
            { "ShortName", new DtoValidationHelper<CDP4Common.DTO.ChangeProposal>(item => !string.IsNullOrWhiteSpace(item.ShortName), "The 'ShortName' property of a 'ChangeProposal' is mandatory and cannot be empty or null.") },
            { "SourceAnnotation", new DtoValidationHelper<CDP4Common.DTO.ChangeProposal>(item => item.SourceAnnotation != null, "The 'SourceAnnotation' property of a 'ChangeProposal' is mandatory and cannot be null.") },
            { "Title", new DtoValidationHelper<CDP4Common.DTO.ChangeProposal>(item => !string.IsNullOrWhiteSpace(item.Title), "The 'Title' property of a 'ChangeProposal' is mandatory and cannot be empty or null.") },
        };
        ...
        /// </exception>
        public void Validate(CDP4Common.DTO.Thing changeProposal)
        {
            this.Validate(changeProposal, x => true);
        }
        ...
        /// If any validation rule failed.
        /// </exception>
        public void Validate(CDP4Common.DTO.Thing changeProposal, Func<string, bool> validateProperty)
        {
            foreach (var applicableRule in this.validationRules.Where(x => validateProperty(x.Key)))
            {
                applicableRule.Value.Validate((CDP4Common.DTO.ChangeProposal)changeProposal);
            }
        }
        ...
        /// </returns>
        public bool TryValidate(CDP4Common.DTO.Thing changeProposal)
        {
            return this.TryValidate(changeProposal, x => true);
        }
        ...
        /// True if all validation rules have passed or if none are defined.
        /// </returns>
        public bool TryValidate(CDP4Common.DTO.Thing changeProposal, Func<string, bool> validateProperty)
        {
            var applicableValidationRules = this.validationRules.Where(x => validateProperty(x.Key)).Select(x => x.Value);

            return applicableValidationRules.All(applicableRule => applicableRule.TryValidate((CDP4Common.DTO.ChangeProposal)changeProposal));
        }

        /// <summary>
        /// Returns the containment property value for the supplied <see cref="CDP4Common.DTO.ChangeProposal"/>.
        /// </summary>
        /// <param name="changeProposal">
        /// The <see cref="CDP4Common.DTO.ChangeProposal"/> for which to return the containment property value.
        /// </param>
        ...
        /// If the property name is not supported for the <see cref="CDP4Common.DTO.ChangeProposal"/>.
        /// </exception>
        public IEnumerable<Guid> GetContainmentIds(CDP4Common.DTO.Thing changeProposal, string propertyName)
        {
        ...
        /// <summary>
        /// Returns the ordered containment property value for the supplied <see cref="CDP4Common.DTO.ChangeProposal"/>.
        /// </summary>
        /// <param name="changeProposal">
        /// The <see cref="CDP4Common.DTO.ChangeProposal"/> for which to return the containment property value.
        /// </param>
        ...
        /// If the property name is not supported for the <see cref="CDP4Common.DTO.ChangeProposal"/>.
        /// </exception>
        public IEnumerable<OrderedItem> GetOrderedContainmentIds(CDP4Common.DTO.Thing changeProposal, string propertyName)
        {
        ...
        /// <summary>
        /// Gets the <see cref="PropertyMetaInfo"/> for the <see cref="ChangeProposal"/> class
        /// </summary>
        ...
        private readonly Dictionary<string, Func<CDP4Common.DTO.ChangeProposal, object>> propertyValueMap = new Dictionary<string, Func<CDP4Common.DTO.ChangeProposal, object>>
        {
            ...
            { "ChangeRequest", thing => thing.ChangeRequest },
        ...
        private readonly Dictionary<string, Action<CDP4Common.DTO.ChangeProposal, object>> propertyValueAssignmentMap = new Dictionary<string, Action<CDP4Common.DTO.ChangeProposal, object>>
        {
            ...
            { "Content", (changeProposal, value) => changeProposal.Content = value.ToString() },
            { "CreatedOn", (changeProposal, value) => changeProposal.CreatedOn = (DateTime)value },
            { "Iid", (changeProposal, value) => changeProposal.Iid = (Guid)value },
            { "LanguageCode", (changeProposal, value) => changeProposal.LanguageCode = value.ToString() },
            { "ModifiedOn", (changeProposal, value) => changeProposal.ModifiedOn = (DateTime)value },
            { "Owner", (changeProposal, value) => changeProposal.Owner = (Guid)value },
            { "PrimaryAnnotatedThing", (changeProposal, value) => changeProposal.PrimaryAnnotatedThing = value == null ? (Guid?)null : (Guid)value },
            { "ShortName", (changeProposal, value) => changeProposal.ShortName = value.ToString() },
            { "Status", (changeProposal, value) => changeProposal.Status = (AnnotationStatusKind)value },
            { "ThingPreference", (changeProposal, value) => changeProposal.ThingPreference = value == null ? (string)null : value.ToString() },
            { "Title", (changeProposal, value) => changeProposal.Title = value.ToString() },
        };
        ...
        /// <summary>
        /// Returns the <see cref="CDP4Common.DTO.ChangeProposal"/> containment property type from the supplied property name.
        /// </summary>
        /// <param name="propertyName">
        ...
        /// <summary>
        /// Returns the <see cref="CDP4Common.DTO.ChangeProposal"/> property type from the supplied property name.
        /// </summary>
        /// <param name="propertyName">
        /// The property name.
        /// </param>
        ...
        /// <summary>
        /// Returns the container property for the supplied type name is a possible container for <see cref="CDP4Common.DTO.ChangeProposal"/>.
        /// </summary>
        /// <param name="typeName">
        /// Name of the type for which to check if it is a container of <see cref="CDP4Common.DTO.ChangeProposal"/>.
        /// </param>
        /// <param name="containerProperty">
        /// Supplied container property info instance that will be set if the supplied type name is a container of <see cref="CDP4Common.DTO.ChangeProposal"/>.
        /// </param>
        /// <returns>
        /// True if the supplied typeName is a container for <see cref="CDP4Common.DTO.ChangeProposal"/> and sets the container property name.
        /// </returns>
        ...
        /// <summary>
        /// Check if the supplied property name for <see cref="CDP4Common.DTO.ChangeProposal"/> is scalar.
        /// </summary>
        /// <param name="propertyName">
        /// Name of the property for which to check if it is scalar.
        /// </param>
        ...
        public bool ApplyPropertyUpdate(CDP4Common.DTO.Thing updatableThing, string propertyName, object value)
        {
            ...
            this.propertyValueAssignmentMap[propertyName]((CDP4Common.DTO.ChangeProposal)updatableThing, value);
        ...
        /// <summary>
        /// Instantiates a <see cref="CDP4Common.DTO.ChangeProposal"/>
        /// </summary>
        /// <returns>
        ...
        {
            return new CDP4Common.DTO.ChangeProposal(guid, revisionNumber);
        }
    }
}
