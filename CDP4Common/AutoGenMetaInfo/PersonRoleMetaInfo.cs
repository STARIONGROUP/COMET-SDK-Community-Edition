// --------------------------------------------------------------------------------------------------------------------
// <copyright file="PersonRoleMetaInfo.cs" company="RHEA System S.A.">
...
namespace CDP4Common.MetaInfo
{
    ...
    /// <summary>
    /// This a class that holds meta info for <see cref="PersonRole"/>.
    /// </summary>
    public partial class PersonRoleMetaInfo : IPersonRoleMetaInfo
    {
        /// <summary>
        /// The containment property value map.
        /// </summary>
        private readonly Dictionary<string, Func<CDP4Common.DTO.PersonRole, IEnumerable<Guid>>> containmentPropertyValueMap = new Dictionary<string, Func<CDP4Common.DTO.PersonRole, IEnumerable<Guid>>>
        {
            { "Alias", personRole => personRole.Alias },
            { "Attachment", personRole => personRole.Attachment },
            { "Definition", personRole => personRole.Definition },
            { "HyperLink", personRole => personRole.HyperLink },
            { "PersonPermission", personRole => personRole.PersonPermission },
        };

        /// <summary>
        /// The ordered containment property value map.
        /// </summary>
        private readonly Dictionary<string, Func<CDP4Common.DTO.PersonRole, IEnumerable<OrderedItem>>> orderedContainmentPropertyValueMap = new Dictionary<string, Func<CDP4Common.DTO.PersonRole, IEnumerable<OrderedItem>>>();

        /// <summary>
        /// The validation rules that should pass for an instance of <see cref="CDP4Common.DTO.PersonRole"/>.
        /// </summary>
        private readonly Dictionary<string, DtoValidationHelper<CDP4Common.DTO.PersonRole>> validationRules = new Dictionary<string, DtoValidationHelper<CDP4Common.DTO.PersonRole>>
        {
            { "Alias", new DtoValidationHelper<CDP4Common.DTO.PersonRole>(item => item.Alias != null, "The 'Alias' property of a 'PersonRole' is mandatory and cannot be null.") },
            { "Attachment", new DtoValidationHelper<CDP4Common.DTO.PersonRole>(item => item.Attachment != null, "The 'Attachment' property of a 'PersonRole' is mandatory and cannot be null.") },
            { "Definition", new DtoValidationHelper<CDP4Common.DTO.PersonRole>(item => item.Definition != null, "The 'Definition' property of a 'PersonRole' is mandatory and cannot be null.") },
            { "ExcludedDomain", new DtoValidationHelper<CDP4Common.DTO.PersonRole>(item => item.ExcludedDomain != null, "The 'ExcludedDomain' property of a 'PersonRole' is mandatory and cannot be null.") },
            { "ExcludedPerson", new DtoValidationHelper<CDP4Common.DTO.PersonRole>(item => item.ExcludedPerson != null, "The 'ExcludedPerson' property of a 'PersonRole' is mandatory and cannot be null.") },
            { "HyperLink", new DtoValidationHelper<CDP4Common.DTO.PersonRole>(item => item.HyperLink != null, "The 'HyperLink' property of a 'PersonRole' is mandatory and cannot be null.") },
            { "Name", new DtoValidationHelper<CDP4Common.DTO.PersonRole>(item => !string.IsNullOrWhiteSpace(item.Name), "The 'Name' property of a 'PersonRole' is mandatory and cannot be empty or null.") },
            { "PersonPermission", new DtoValidationHelper<CDP4Common.DTO.PersonRole>(item => item.PersonPermission != null, "The 'PersonPermission' property of a 'PersonRole' is mandatory and cannot be null.") },
            { "ShortName", new DtoValidationHelper<CDP4Common.DTO.PersonRole>(item => !string.IsNullOrWhiteSpace(item.ShortName), "The 'ShortName' property of a 'PersonRole' is mandatory and cannot be empty or null.") },
        };
        ...
        /// </exception>
        public void Validate(CDP4Common.DTO.Thing personRole)
        {
            this.Validate(personRole, x => true);
        }
        ...
        /// If any validation rule failed.
        /// </exception>
        public void Validate(CDP4Common.DTO.Thing personRole, Func<string, bool> validateProperty)
        {
            foreach (var applicableRule in this.validationRules.Where(x => validateProperty(x.Key)))
            {
                applicableRule.Value.Validate((CDP4Common.DTO.PersonRole)personRole);
            }
        }
        ...
        /// </returns>
        public bool TryValidate(CDP4Common.DTO.Thing personRole)
        {
            return this.TryValidate(personRole, x => true);
        }
        ...
        /// True if all validation rules have passed or if none are defined.
        /// </returns>
        public bool TryValidate(CDP4Common.DTO.Thing personRole, Func<string, bool> validateProperty)
        {
            var applicableValidationRules = this.validationRules.Where(x => validateProperty(x.Key)).Select(x => x.Value);

            return applicableValidationRules.All(applicableRule => applicableRule.TryValidate((CDP4Common.DTO.PersonRole)personRole));
        }

        /// <summary>
        /// Returns the containment property value for the supplied <see cref="CDP4Common.DTO.PersonRole"/>.
        /// </summary>
        /// <param name="personRole">
        /// The <see cref="CDP4Common.DTO.PersonRole"/> for which to return the containment property value.
        /// </param>
        ...
        /// If the property name is not supported for the <see cref="CDP4Common.DTO.PersonRole"/>.
        /// </exception>
        public IEnumerable<Guid> GetContainmentIds(CDP4Common.DTO.Thing personRole, string propertyName)
        {
            if (!this.containmentPropertyValueMap.ContainsKey(propertyName))
            {
                throw new ArgumentException($"'{propertyName}' is not a valid containment property of 'PersonRole'");
            }

            return this.containmentPropertyValueMap[propertyName]((CDP4Common.DTO.PersonRole)personRole);
        }

        /// <summary>
        /// Returns the ordered containment property value for the supplied <see cref="CDP4Common.DTO.PersonRole"/>.
        /// </summary>
        /// <param name="personRole">
        /// The <see cref="CDP4Common.DTO.PersonRole"/> for which to return the containment property value.
        /// </param>
        ...
        /// If the property name is not supported for the <see cref="CDP4Common.DTO.PersonRole"/>.
        /// </exception>
        public IEnumerable<OrderedItem> GetOrderedContainmentIds(CDP4Common.DTO.Thing personRole, string propertyName)
        {
            ...
            return this.orderedContainmentPropertyValueMap[propertyName]((CDP4Common.DTO.PersonRole)personRole);
        }
        ...
        private readonly Dictionary<string, PropertyMetaInfo> containmentTypeMap = new Dictionary<string, PropertyMetaInfo>
        {
            ...
            { "PersonPermission", new PropertyMetaInfo("PersonPermission", "PersonPermission", PropertyKind.List, AggregationKind.Composite, false, false, true, 0, "*", true) },
        };

        /// <summary>
        /// Gets the <see cref="PropertyMetaInfo"/> for the <see cref="PersonRole"/> class
        /// </summary>
        ...
        /// </summary>
        private readonly Dictionary<string, Func<CDP4Common.DTO.PersonRole, object>> propertyValueMap = new Dictionary<string, Func<CDP4Common.DTO.PersonRole, object>>
        {
        ...
        private readonly Dictionary<string, Func<object, object>> collectionPropertyValueDeserializationMap = new Dictionary<string, Func<object, object>>
        {
            ...
            { "PersonPermission", (value) => (Guid)value },
        };

        /// <summary>
        /// The property value assignment map.
        /// </summary>
        private readonly Dictionary<string, Action<CDP4Common.DTO.PersonRole, object>> propertyValueAssignmentMap = new Dictionary<string, Action<CDP4Common.DTO.PersonRole, object>>
        {
            { "Actor", (personRole, value) => personRole.Actor = value == null ? (Guid?)null : (Guid)value },
            { "Iid", (personRole, value) => personRole.Iid = (Guid)value },
            { "IsDeprecated", (personRole, value) => personRole.IsDeprecated = (bool)value },
        ...
        {
            { "SiteDirectory", new PropertyMetaInfo("PersonRole", "PersonRole", PropertyKind.List, AggregationKind.Composite, false, false, true, 0, "*", true) },
        };
        ...
        /// <summary>
        /// Returns the <see cref="CDP4Common.DTO.PersonRole"/> containment property type from the supplied property name.
        /// </summary>
        /// <param name="propertyName">
        ...
        /// <summary>
        /// Returns the <see cref="CDP4Common.DTO.PersonRole"/> property type from the supplied property name.
        /// </summary>
        /// <param name="propertyName">
        /// The property name.
        /// </param>
        ...
        /// <summary>
        /// Returns the container property for the supplied type name is a possible container for <see cref="CDP4Common.DTO.PersonRole"/>.
        /// </summary>
        /// <param name="typeName">
        /// Name of the type for which to check if it is a container of <see cref="CDP4Common.DTO.PersonRole"/>.
        /// </param>
        /// <param name="containerProperty">
        /// Supplied container property info instance that will be set if the supplied type name is a container of <see cref="CDP4Common.DTO.PersonRole"/>.
        /// </param>
        /// <returns>
        /// True if the supplied typeName is a container for <see cref="CDP4Common.DTO.PersonRole"/> and sets the container property name.
        /// </returns>
        ...
        /// <summary>
        /// Check if the supplied property name for <see cref="CDP4Common.DTO.PersonRole"/> is scalar.
        /// </summary>
        /// <param name="propertyName">
        /// Name of the property for which to check if it is scalar.
        /// </param>
        ...
        public bool ApplyPropertyUpdate(CDP4Common.DTO.Thing updatableThing, string propertyName, object value)
        {
            ...
            this.propertyValueAssignmentMap[propertyName]((CDP4Common.DTO.PersonRole)updatableThing, value);
        ...
        public object DeserializeCollectionValue(string propertyName, object value)
        {
            ...
            {
                throw new ArgumentException($"'{propertyName}' is not a valid collection property of 'PersonRole'");
            }
        ...
        public object GetValue(string propertyName, CDP4Common.DTO.Thing thing)
        {
            ...
            return this.propertyValueMap[propertyName]((CDP4Common.DTO.PersonRole)thing);
        }
        ...
        /// <summary>
        /// Instantiates a <see cref="CDP4Common.DTO.PersonRole"/>
        /// </summary>
        /// <returns>
        ...
        {
            return new CDP4Common.DTO.PersonRole(guid, revisionNumber);
        }
    }
}
