...
namespace CDP4Common.MetaInfo
{
    ...
    public partial class PersonRoleMetaInfo : IPersonRoleMetaInfo
    {
        ...
        private readonly Dictionary<string, PropertyMetaInfo> containmentTypeMap = new Dictionary<string, PropertyMetaInfo>
        {
            ...
            { "PersonPermission", new PropertyMetaInfo("PersonPermission", "Guid", PropertyKind.List, AggregationKind.Composite, false, false, true, 0, "*", true) },
        };
        ...
        {
            { "SiteDirectory", new PropertyMetaInfo("PersonRole", "Guid", PropertyKind.List, AggregationKind.Composite, false, false, true, 0, "*", true) },
        };
