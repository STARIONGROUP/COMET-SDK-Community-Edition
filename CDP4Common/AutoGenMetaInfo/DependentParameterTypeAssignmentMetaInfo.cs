...
namespace CDP4Common.MetaInfo
{
    ...
    public partial class DependentParameterTypeAssignmentMetaInfo : IDependentParameterTypeAssignmentMetaInfo
    {
        ...
        public IEnumerable<Guid> GetContainmentIds(CDP4Common.DTO.Thing dependentParameterTypeAssignment, string propertyName)
        {
            ...
            {
                throw new ArgumentException(string.Format("'{0}' is not a valid containment property of 'DependentParameterTypeAssignment'", propertyName));
            }
        ...
        public object DeserializeCollectionValue(string propertyName, object value)
        {
            ...
            {
                throw new ArgumentException(string.Format("'{0}' is not a valid collection property of 'DependentParameterTypeAssignment'", propertyName));
            }
