// --------------------------------------------------------------------------------------------------------------------
// <copyright file="DependentParameterTypeAssignmentMetaInfo.cs" company="Starion Group S.A.">
...
namespace CDP4Common.MetaInfo
{
    ...
    /// <summary>
    /// This a class that holds meta info for <see cref="DependentParameterTypeAssignment"/>.
    /// </summary>
    public partial class DependentParameterTypeAssignmentMetaInfo : IDependentParameterTypeAssignmentMetaInfo
    {
        /// <summary>
        /// The containment property value map.
        /// </summary>
        private readonly Dictionary<string, Func<CDP4Common.DTO.DependentParameterTypeAssignment, IEnumerable<Guid>>> containmentPropertyValueMap = new Dictionary<string, Func<CDP4Common.DTO.DependentParameterTypeAssignment, IEnumerable<Guid>>>();

        /// <summary>
        /// The ordered containment property value map.
        /// </summary>
        private readonly Dictionary<string, Func<CDP4Common.DTO.DependentParameterTypeAssignment, IEnumerable<OrderedItem>>> orderedContainmentPropertyValueMap = new Dictionary<string, Func<CDP4Common.DTO.DependentParameterTypeAssignment, IEnumerable<OrderedItem>>>();

        /// <summary>
        /// The validation rules that should pass for an instance of <see cref="CDP4Common.DTO.DependentParameterTypeAssignment"/>.
        /// </summary>
        private readonly Dictionary<string, DtoValidationHelper<CDP4Common.DTO.DependentParameterTypeAssignment>> validationRules = new Dictionary<string, DtoValidationHelper<CDP4Common.DTO.DependentParameterTypeAssignment>>
        {
            { "ExcludedDomain", new DtoValidationHelper<CDP4Common.DTO.DependentParameterTypeAssignment>(item => item.ExcludedDomain != null, "The 'ExcludedDomain' property of a 'DependentParameterTypeAssignment' is mandatory and cannot be null.") },
            { "ExcludedPerson", new DtoValidationHelper<CDP4Common.DTO.DependentParameterTypeAssignment>(item => item.ExcludedPerson != null, "The 'ExcludedPerson' property of a 'DependentParameterTypeAssignment' is mandatory and cannot be null.") },
        };
        ...
        /// If any validation rule failed.
        /// </exception>
        public void Validate(CDP4Common.DTO.Thing dependentParameterTypeAssignment, Func<string, bool> validateProperty)
        {
            foreach (var applicableRule in this.validationRules.Where(x => validateProperty(x.Key)))
            {
                applicableRule.Value.Validate((CDP4Common.DTO.DependentParameterTypeAssignment)dependentParameterTypeAssignment);
            }
        }
        ...
        /// <summary>
        /// Returns the containment property value for the supplied <see cref="CDP4Common.DTO.DependentParameterTypeAssignment"/>.
        /// </summary>
        /// <param name="dependentParameterTypeAssignment">
        /// The <see cref="CDP4Common.DTO.DependentParameterTypeAssignment"/> for which to return the containment property value.
        /// </param>
        ...
        /// If the property name is not supported for the <see cref="CDP4Common.DTO.DependentParameterTypeAssignment"/>.
        /// </exception>
        public IEnumerable<Guid> GetContainmentIds(CDP4Common.DTO.Thing dependentParameterTypeAssignment, string propertyName)
        {
            if (!this.containmentPropertyValueMap.ContainsKey(propertyName))
            {
                throw new ArgumentException($"'{propertyName}' is not a valid containment property of 'DependentParameterTypeAssignment'");
            }

            return this.containmentPropertyValueMap[propertyName]((CDP4Common.DTO.DependentParameterTypeAssignment)dependentParameterTypeAssignment);
        }

        /// <summary>
        /// Returns the ordered containment property value for the supplied <see cref="CDP4Common.DTO.DependentParameterTypeAssignment"/>.
        /// </summary>
        /// <param name="dependentParameterTypeAssignment">
        /// The <see cref="CDP4Common.DTO.DependentParameterTypeAssignment"/> for which to return the containment property value.
        /// </param>
        ...
        /// If the property name is not supported for the <see cref="CDP4Common.DTO.DependentParameterTypeAssignment"/>.
        /// </exception>
        public IEnumerable<OrderedItem> GetOrderedContainmentIds(CDP4Common.DTO.Thing dependentParameterTypeAssignment, string propertyName)
        {
            ...
            return this.orderedContainmentPropertyValueMap[propertyName]((CDP4Common.DTO.DependentParameterTypeAssignment)dependentParameterTypeAssignment);
        }
        ...
        /// <summary>
        /// Gets the <see cref="PropertyMetaInfo"/> for the <see cref="DependentParameterTypeAssignment"/> class
        /// </summary>
        ...
        /// </summary>
        private readonly Dictionary<string, Func<CDP4Common.DTO.DependentParameterTypeAssignment, object>> propertyValueMap = new Dictionary<string, Func<CDP4Common.DTO.DependentParameterTypeAssignment, object>>
        {
        ...
        /// </summary>
        private readonly Dictionary<string, Action<CDP4Common.DTO.DependentParameterTypeAssignment, object>> propertyValueAssignmentMap = new Dictionary<string, Action<CDP4Common.DTO.DependentParameterTypeAssignment, object>>
        {
            { "Actor", (dependentParameterTypeAssignment, value) => dependentParameterTypeAssignment.Actor = value == null ? (Guid?)null : (Guid)value },
            { "Iid", (dependentParameterTypeAssignment, value) => dependentParameterTypeAssignment.Iid = (Guid)value },
            { "MeasurementScale", (dependentParameterTypeAssignment, value) => dependentParameterTypeAssignment.MeasurementScale = value == null ? (Guid?)null : (Guid)value },
            { "ModifiedOn", (dependentParameterTypeAssignment, value) => dependentParameterTypeAssignment.ModifiedOn = (DateTime)value },
            { "ParameterType", (dependentParameterTypeAssignment, value) => dependentParameterTypeAssignment.ParameterType = (Guid)value },
            { "ThingPreference", (dependentParameterTypeAssignment, value) => dependentParameterTypeAssignment.ThingPreference = value == null ? (string)null : value.ToString() },
        };
        ...
        {
            { "SampledFunctionParameterType", new PropertyMetaInfo("DependentParameterType", "DependentParameterTypeAssignment", PropertyKind.OrderedList, AggregationKind.Composite, false, true, true, 1, "*", true) },
        };
        ...
        /// <summary>
        /// Returns the <see cref="CDP4Common.DTO.DependentParameterTypeAssignment"/> containment property type from the supplied property name.
        /// </summary>
        /// <param name="propertyName">
        ...
        /// <summary>
        /// Returns the <see cref="CDP4Common.DTO.DependentParameterTypeAssignment"/> property type from the supplied property name.
        /// </summary>
        /// <param name="propertyName">
        /// The property name.
        /// </param>
        ...
        /// <summary>
        /// Returns the container property for the supplied type name is a possible container for <see cref="CDP4Common.DTO.DependentParameterTypeAssignment"/>.
        /// </summary>
        /// <param name="typeName">
        /// Name of the type for which to check if it is a container of <see cref="CDP4Common.DTO.DependentParameterTypeAssignment"/>.
        /// </param>
        /// <param name="containerProperty">
        /// Supplied container property info instance that will be set if the supplied type name is a container of <see cref="CDP4Common.DTO.DependentParameterTypeAssignment"/>.
        /// </param>
        /// <returns>
        /// True if the supplied typeName is a container for <see cref="CDP4Common.DTO.DependentParameterTypeAssignment"/> and sets the container property name.
        /// </returns>
        ...
        /// <summary>
        /// Check if the supplied property name for <see cref="CDP4Common.DTO.DependentParameterTypeAssignment"/> is scalar.
        /// </summary>
        /// <param name="propertyName">
        /// Name of the property for which to check if it is scalar.
        /// </param>
        ...
        public bool ApplyPropertyUpdate(CDP4Common.DTO.Thing updatableThing, string propertyName, object value)
        {
            ...
            this.propertyValueAssignmentMap[propertyName]((CDP4Common.DTO.DependentParameterTypeAssignment)updatableThing, value);
        ...
        public object DeserializeCollectionValue(string propertyName, object value)
        {
            ...
            {
                throw new ArgumentException($"'{propertyName}' is not a valid collection property of 'DependentParameterTypeAssignment'");
            }
        ...
        public object GetValue(string propertyName, CDP4Common.DTO.Thing thing)
        {
            ...
            return this.propertyValueMap[propertyName]((CDP4Common.DTO.DependentParameterTypeAssignment)thing);
        }
        ...
        /// <summary>
        /// Instantiates a <see cref="CDP4Common.DTO.DependentParameterTypeAssignment"/>
        /// </summary>
        /// <returns>
        ...
        {
            return new CDP4Common.DTO.DependentParameterTypeAssignment(guid, revisionNumber);
        }
    }
}
