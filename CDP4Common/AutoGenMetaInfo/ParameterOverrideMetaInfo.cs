// --------------------------------------------------------------------------------------------------------------------
// <copyright file="ParameterOverrideMetaInfo.cs" company="RHEA System S.A.">
...
namespace CDP4Common.MetaInfo
{
    ...
    /// <summary>
    /// This a class that holds meta info for <see cref="ParameterOverride"/>.
    /// </summary>
    public partial class ParameterOverrideMetaInfo : IParameterOverrideMetaInfo
    {
        /// <summary>
        /// The containment property value map.
        /// </summary>
        private readonly Dictionary<string, Func<CDP4Common.DTO.ParameterOverride, IEnumerable<Guid>>> containmentPropertyValueMap = new Dictionary<string, Func<CDP4Common.DTO.ParameterOverride, IEnumerable<Guid>>>
        {
            { "ParameterSubscription", parameterOverride => parameterOverride.ParameterSubscription },
            { "ValueSet", parameterOverride => parameterOverride.ValueSet },
        };

        /// <summary>
        /// The ordered containment property value map.
        /// </summary>
        private readonly Dictionary<string, Func<CDP4Common.DTO.ParameterOverride, IEnumerable<OrderedItem>>> orderedContainmentPropertyValueMap = new Dictionary<string, Func<CDP4Common.DTO.ParameterOverride, IEnumerable<OrderedItem>>>();

        /// <summary>
        /// The validation rules that should pass for an instance of <see cref="CDP4Common.DTO.ParameterOverride"/>.
        /// </summary>
        private readonly Dictionary<string, DtoValidationHelper<CDP4Common.DTO.ParameterOverride>> validationRules = new Dictionary<string, DtoValidationHelper<CDP4Common.DTO.ParameterOverride>>
        {
            { "ExcludedDomain", new DtoValidationHelper<CDP4Common.DTO.ParameterOverride>(item => item.ExcludedDomain != null, "The 'ExcludedDomain' property of a 'ParameterOverride' is mandatory and cannot be null.") },
            { "ExcludedPerson", new DtoValidationHelper<CDP4Common.DTO.ParameterOverride>(item => item.ExcludedPerson != null, "The 'ExcludedPerson' property of a 'ParameterOverride' is mandatory and cannot be null.") },
            { "ParameterSubscription", new DtoValidationHelper<CDP4Common.DTO.ParameterOverride>(item => item.ParameterSubscription != null, "The 'ParameterSubscription' property of a 'ParameterOverride' is mandatory and cannot be null.") },
            { "ValueSet", new DtoValidationHelper<CDP4Common.DTO.ParameterOverride>(item => item.ValueSet != null && item.ValueSet.Any(), "The 'ValueSet' property of a 'ParameterOverride' is mandatory and must have at least one entry.") },
        };
        ...
        /// </exception>
        public void Validate(CDP4Common.DTO.Thing parameterOverride)
        {
            this.Validate(parameterOverride, x => true);
        }
        ...
        /// If any validation rule failed.
        /// </exception>
        public void Validate(CDP4Common.DTO.Thing parameterOverride, Func<string, bool> validateProperty)
        {
            foreach (var applicableRule in this.validationRules.Where(x => validateProperty(x.Key)))
            {
                applicableRule.Value.Validate((CDP4Common.DTO.ParameterOverride)parameterOverride);
            }
        }
        ...
        /// </returns>
        public bool TryValidate(CDP4Common.DTO.Thing parameterOverride)
        {
            return this.TryValidate(parameterOverride, x => true);
        }
        ...
        /// True if all validation rules have passed or if none are defined.
        /// </returns>
        public bool TryValidate(CDP4Common.DTO.Thing parameterOverride, Func<string, bool> validateProperty)
        {
            var applicableValidationRules = this.validationRules.Where(x => validateProperty(x.Key)).Select(x => x.Value);

            return applicableValidationRules.All(applicableRule => applicableRule.TryValidate((CDP4Common.DTO.ParameterOverride)parameterOverride));
        }

        /// <summary>
        /// Returns the containment property value for the supplied <see cref="CDP4Common.DTO.ParameterOverride"/>.
        /// </summary>
        /// <param name="parameterOverride">
        /// The <see cref="CDP4Common.DTO.ParameterOverride"/> for which to return the containment property value.
        /// </param>
        ...
        /// If the property name is not supported for the <see cref="CDP4Common.DTO.ParameterOverride"/>.
        /// </exception>
        public IEnumerable<Guid> GetContainmentIds(CDP4Common.DTO.Thing parameterOverride, string propertyName)
        {
            if (!this.containmentPropertyValueMap.ContainsKey(propertyName))
            {
                throw new ArgumentException(string.Format("'{0}' is not a valid containment property of 'ParameterOverride'", propertyName));
            }

            return this.containmentPropertyValueMap[propertyName]((CDP4Common.DTO.ParameterOverride)parameterOverride);
        }

        /// <summary>
        /// Returns the ordered containment property value for the supplied <see cref="CDP4Common.DTO.ParameterOverride"/>.
        /// </summary>
        /// <param name="parameterOverride">
        /// The <see cref="CDP4Common.DTO.ParameterOverride"/> for which to return the containment property value.
        /// </param>
        ...
        /// If the property name is not supported for the <see cref="CDP4Common.DTO.ParameterOverride"/>.
        /// </exception>
        public IEnumerable<OrderedItem> GetOrderedContainmentIds(CDP4Common.DTO.Thing parameterOverride, string propertyName)
        {
            ...
            return this.orderedContainmentPropertyValueMap[propertyName]((CDP4Common.DTO.ParameterOverride)parameterOverride);
        }
        ...
        {
            { "ParameterSubscription", new PropertyMetaInfo("ParameterSubscription", "Guid", PropertyKind.List, AggregationKind.Composite, false, false, true, 0, "*", true) },
            { "ValueSet", new PropertyMetaInfo("ValueSet", "Guid", PropertyKind.List, AggregationKind.Composite, false, false, true, 1, "*", true) },
        };

        /// <summary>
        /// Gets the <see cref="PropertyMetaInfo"/> for the <see cref="ParameterOverride"/> class
        /// </summary>
        ...
        /// </summary>
        private readonly Dictionary<string, Func<CDP4Common.DTO.ParameterOverride, object>> propertyValueMap = new Dictionary<string, Func<CDP4Common.DTO.ParameterOverride, object>>
        {
        ...
        private readonly Dictionary<string, PropertyMetaInfo> propertyTypeMap = new Dictionary<string, PropertyMetaInfo>
        {
            ...
            { "Group", new PropertyMetaInfo("Group", "Guid", PropertyKind.Scalar, AggregationKind.None, true, false, true, 0, "1", false) },
            ...
            { "Parameter", new PropertyMetaInfo("Parameter", "Guid", PropertyKind.Scalar, AggregationKind.None, false, false, true, 1, "1", true) },
            { "ParameterType", new PropertyMetaInfo("ParameterType", "Guid", PropertyKind.Scalar, AggregationKind.None, true, false, true, 1, "1", false) },
            { "RevisionNumber", new PropertyMetaInfo("RevisionNumber", "int", PropertyKind.Scalar, AggregationKind.None, false, false, true, 1, "1", true) },
            { "Scale", new PropertyMetaInfo("Scale", "Guid", PropertyKind.Scalar, AggregationKind.None, true, false, true, 0, "1", false) },
            { "StateDependence", new PropertyMetaInfo("StateDependence", "Guid", PropertyKind.Scalar, AggregationKind.None, true, false, true, 0, "1", false) },
        };
        ...
        /// </summary>
        private readonly Dictionary<string, Action<CDP4Common.DTO.ParameterOverride, object>> propertyValueAssignmentMap = new Dictionary<string, Action<CDP4Common.DTO.ParameterOverride, object>>
        {
            { "Iid", (parameterOverride, value) => parameterOverride.Iid = (Guid)value },
        ...
        {
            { "ElementUsage", new PropertyMetaInfo("ParameterOverride", "Guid", PropertyKind.List, AggregationKind.Composite, false, false, true, 0, "*", true) },
        };
        ...
        {
            get { return "ParameterOrOverrideBase"; }
        }
        ...
        /// <summary>
        /// Returns the <see cref="CDP4Common.DTO.ParameterOverride"/> containment property type from the supplied property name.
        /// </summary>
        /// <param name="propertyName">
        ...
        /// <summary>
        /// Returns the <see cref="CDP4Common.DTO.ParameterOverride"/> property type from the supplied property name.
        /// </summary>
        /// <param name="propertyName">
        /// The property name.
        /// </param>
        ...
        /// <summary>
        /// Returns the container property for the supplied type name is a possible container for <see cref="CDP4Common.DTO.ParameterOverride"/>.
        /// </summary>
        /// <param name="typeName">
        /// Name of the type for which to check if it is a container of <see cref="CDP4Common.DTO.ParameterOverride"/>.
        /// </param>
        /// <param name="containerProperty">
        /// Supplied container property info instance that will be set if the supplied type name is a container of <see cref="CDP4Common.DTO.ParameterOverride"/>.
        /// </param>
        /// <returns>
        /// True if the supplied typeName is a container for <see cref="CDP4Common.DTO.ParameterOverride"/> and sets the container property name.
        /// </returns>
        ...
        /// <summary>
        /// Check if the supplied property name for <see cref="CDP4Common.DTO.ParameterOverride"/> is scalar.
        /// </summary>
        /// <param name="propertyName">
        /// Name of the property for which to check if it is scalar.
        /// </param>
        ...
        public bool ApplyPropertyUpdate(CDP4Common.DTO.Thing updatableThing, string propertyName, object value)
        {
            ...
            this.propertyValueAssignmentMap[propertyName]((CDP4Common.DTO.ParameterOverride)updatableThing, value);
        ...
        public object DeserializeCollectionValue(string propertyName, object value)
        {
            ...
            {
                throw new ArgumentException(string.Format("'{0}' is not a valid collection property of 'ParameterOverride'", propertyName));
            }
        ...
        public object GetValue(string propertyName, CDP4Common.DTO.Thing thing)
        {
            ...
            return this.propertyValueMap[propertyName]((CDP4Common.DTO.ParameterOverride)thing);
        }
        ...
        /// <summary>
        /// Instantiates a <see cref="CDP4Common.DTO.ParameterOverride"/>
        /// </summary>
        /// <returns>
        ...
        {
            return new CDP4Common.DTO.ParameterOverride(guid, revisionNumber);
        }
    }
}
