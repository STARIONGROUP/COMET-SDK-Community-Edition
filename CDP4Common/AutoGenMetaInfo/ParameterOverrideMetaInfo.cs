// --------------------------------------------------------------------------------------------------------------------
// <copyright file="ParameterOverrideMetaInfo.cs" company="Starion Group S.A.">
...
namespace CDP4Common.MetaInfo
{
    ...
    public partial class ParameterOverrideMetaInfo : IParameterOverrideMetaInfo
    {
        ...
        public IEnumerable<Guid> GetContainmentIds(CDP4Common.DTO.Thing parameterOverride, string propertyName)
        {
            ...
            {
                throw new ArgumentException($"'{propertyName}' is not a valid containment property of 'ParameterOverride'");
            }
        ...
        private readonly Dictionary<string, PropertyMetaInfo> containmentTypeMap = new Dictionary<string, PropertyMetaInfo>
        {
            ...
            { "ValueSet", new PropertyMetaInfo("ValueSet", "ParameterOverrideValueSet", PropertyKind.List, AggregationKind.Composite, false, false, true, 1, "*", true) },
        };
        ...
        {
            { "Actor", (parameterOverride, value) => parameterOverride.Actor = value == null ? (Guid?)null : (Guid)value },
        ...
        {
            { "ElementUsage", new PropertyMetaInfo("ParameterOverride", "ParameterOverride", PropertyKind.List, AggregationKind.Composite, false, false, true, 0, "*", true) },
        };
        ...
        public object DeserializeCollectionValue(string propertyName, object value)
        {
            ...
            {
                throw new ArgumentException($"'{propertyName}' is not a valid collection property of 'ParameterOverride'");
            }
