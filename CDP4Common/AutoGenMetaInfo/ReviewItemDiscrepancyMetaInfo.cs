// --------------------------------------------------------------------------------------------------------------------
// <copyright file="ReviewItemDiscrepancyMetaInfo.cs" company="Starion Group S.A.">
...
namespace CDP4Common.MetaInfo
{
    ...
    public partial class ReviewItemDiscrepancyMetaInfo : IReviewItemDiscrepancyMetaInfo
    {
        ...
        {
            { "Actor", (reviewItemDiscrepancy, value) => reviewItemDiscrepancy.Actor = value == null ? (Guid?)null : (Guid)value },
