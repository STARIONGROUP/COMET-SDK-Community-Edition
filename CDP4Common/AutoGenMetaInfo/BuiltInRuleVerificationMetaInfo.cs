// --------------------------------------------------------------------------------------------------------------------
// <copyright file="BuiltInRuleVerificationMetaInfo.cs" company="Starion Group S.A.">
...
namespace CDP4Common.MetaInfo
{
    ...
    public partial class BuiltInRuleVerificationMetaInfo : IBuiltInRuleVerificationMetaInfo
    {
        ...
        public IEnumerable<Guid> GetContainmentIds(CDP4Common.DTO.Thing builtInRuleVerification, string propertyName)
        {
            ...
            {
                throw new ArgumentException($"'{propertyName}' is not a valid containment property of 'BuiltInRuleVerification'");
            }
        ...
        public object DeserializeCollectionValue(string propertyName, object value)
        {
            ...
            {
                throw new ArgumentException($"'{propertyName}' is not a valid collection property of 'BuiltInRuleVerification'");
            }
