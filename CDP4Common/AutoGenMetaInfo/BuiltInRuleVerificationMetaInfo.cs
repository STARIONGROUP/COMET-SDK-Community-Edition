// --------------------------------------------------------------------------------------------------------------------
// <copyright file="BuiltInRuleVerificationMetaInfo.cs" company="RHEA System S.A.">
...
namespace CDP4Common.MetaInfo
{
    ...
    /// <summary>
    /// This a class that holds meta info for <see cref="BuiltInRuleVerification"/>.
    /// </summary>
    public partial class BuiltInRuleVerificationMetaInfo : IBuiltInRuleVerificationMetaInfo
    {
        /// <summary>
        /// The containment property value map.
        /// </summary>
        private readonly Dictionary<string, Func<CDP4Common.DTO.BuiltInRuleVerification, IEnumerable<Guid>>> containmentPropertyValueMap = new Dictionary<string, Func<CDP4Common.DTO.BuiltInRuleVerification, IEnumerable<Guid>>>
        {
            { "Violation", builtInRuleVerification => builtInRuleVerification.Violation },
        };

        /// <summary>
        /// The ordered containment property value map.
        /// </summary>
        private readonly Dictionary<string, Func<CDP4Common.DTO.BuiltInRuleVerification, IEnumerable<OrderedItem>>> orderedContainmentPropertyValueMap = new Dictionary<string, Func<CDP4Common.DTO.BuiltInRuleVerification, IEnumerable<OrderedItem>>>();

        /// <summary>
        /// The validation rules that should pass for an instance of <see cref="CDP4Common.DTO.BuiltInRuleVerification"/>.
        /// </summary>
        private readonly Dictionary<string, DtoValidationHelper<CDP4Common.DTO.BuiltInRuleVerification>> validationRules = new Dictionary<string, DtoValidationHelper<CDP4Common.DTO.BuiltInRuleVerification>>
        {
            { "ExcludedDomain", new DtoValidationHelper<CDP4Common.DTO.BuiltInRuleVerification>(item => item.ExcludedDomain != null, "The 'ExcludedDomain' property of a 'BuiltInRuleVerification' is mandatory and cannot be null.") },
            { "ExcludedPerson", new DtoValidationHelper<CDP4Common.DTO.BuiltInRuleVerification>(item => item.ExcludedPerson != null, "The 'ExcludedPerson' property of a 'BuiltInRuleVerification' is mandatory and cannot be null.") },
            { "Name", new DtoValidationHelper<CDP4Common.DTO.BuiltInRuleVerification>(item => !string.IsNullOrWhiteSpace(item.Name), "The 'Name' property of a 'BuiltInRuleVerification' is mandatory and cannot be empty or null.") },
            { "Violation", new DtoValidationHelper<CDP4Common.DTO.BuiltInRuleVerification>(item => item.Violation != null, "The 'Violation' property of a 'BuiltInRuleVerification' is mandatory and cannot be null.") },
        };
        ...
        /// </exception>
        public void Validate(CDP4Common.DTO.Thing builtInRuleVerification)
        {
            this.Validate(builtInRuleVerification, x => true);
        }
        ...
        /// If any validation rule failed.
        /// </exception>
        public void Validate(CDP4Common.DTO.Thing builtInRuleVerification, Func<string, bool> validateProperty)
        {
            foreach (var applicableRule in this.validationRules.Where(x => validateProperty(x.Key)))
            {
                applicableRule.Value.Validate((CDP4Common.DTO.BuiltInRuleVerification)builtInRuleVerification);
            }
        }
        ...
        /// </returns>
        public bool TryValidate(CDP4Common.DTO.Thing builtInRuleVerification)
        {
            return this.TryValidate(builtInRuleVerification, x => true);
        }
        ...
        /// True if all validation rules have passed or if none are defined.
        /// </returns>
        public bool TryValidate(CDP4Common.DTO.Thing builtInRuleVerification, Func<string, bool> validateProperty)
        {
            var applicableValidationRules = this.validationRules.Where(x => validateProperty(x.Key)).Select(x => x.Value);

            return applicableValidationRules.All(applicableRule => applicableRule.TryValidate((CDP4Common.DTO.BuiltInRuleVerification)builtInRuleVerification));
        }

        /// <summary>
        /// Returns the containment property value for the supplied <see cref="CDP4Common.DTO.BuiltInRuleVerification"/>.
        /// </summary>
        /// <param name="builtInRuleVerification">
        /// The <see cref="CDP4Common.DTO.BuiltInRuleVerification"/> for which to return the containment property value.
        /// </param>
        ...
        /// If the property name is not supported for the <see cref="CDP4Common.DTO.BuiltInRuleVerification"/>.
        /// </exception>
        public IEnumerable<Guid> GetContainmentIds(CDP4Common.DTO.Thing builtInRuleVerification, string propertyName)
        {
            if (!this.containmentPropertyValueMap.ContainsKey(propertyName))
            {
                throw new ArgumentException(string.Format("'{0}' is not a valid containment property of 'BuiltInRuleVerification'", propertyName));
            }

            return this.containmentPropertyValueMap[propertyName]((CDP4Common.DTO.BuiltInRuleVerification)builtInRuleVerification);
        }

        /// <summary>
        /// Returns the ordered containment property value for the supplied <see cref="CDP4Common.DTO.BuiltInRuleVerification"/>.
        /// </summary>
        /// <param name="builtInRuleVerification">
        /// The <see cref="CDP4Common.DTO.BuiltInRuleVerification"/> for which to return the containment property value.
        /// </param>
        ...
        /// If the property name is not supported for the <see cref="CDP4Common.DTO.BuiltInRuleVerification"/>.
        /// </exception>
        public IEnumerable<OrderedItem> GetOrderedContainmentIds(CDP4Common.DTO.Thing builtInRuleVerification, string propertyName)
        {
            ...
            return this.orderedContainmentPropertyValueMap[propertyName]((CDP4Common.DTO.BuiltInRuleVerification)builtInRuleVerification);
        }
        ...
        /// <summary>
        /// Gets the <see cref="PropertyMetaInfo"/> for the <see cref="BuiltInRuleVerification"/> class
        /// </summary>
        ...
        private readonly Dictionary<string, Action<CDP4Common.DTO.BuiltInRuleVerification, object>> propertyValueAssignmentMap = new Dictionary<string, Action<CDP4Common.DTO.BuiltInRuleVerification, object>>
        {
            ...
            { "ModifiedOn", (builtInRuleVerification, value) => builtInRuleVerification.ModifiedOn = (DateTime)value },
            { "Name", (builtInRuleVerification, value) => builtInRuleVerification.Name = value.ToString() },
            { "Status", (builtInRuleVerification, value) => builtInRuleVerification.Status = (RuleVerificationStatusKind)value },
            { "ThingPreference", (builtInRuleVerification, value) => builtInRuleVerification.ThingPreference = value == null ? (string)null : value.ToString() },
        };
        ...
        /// <summary>
        /// Returns the <see cref="CDP4Common.DTO.BuiltInRuleVerification"/> containment property type from the supplied property name.
        /// </summary>
        /// <param name="propertyName">
        ...
        /// <summary>
        /// Returns the <see cref="CDP4Common.DTO.BuiltInRuleVerification"/> property type from the supplied property name.
        /// </summary>
        /// <param name="propertyName">
        /// The property name.
        /// </param>
        ...
        /// <summary>
        /// Returns the container property for the supplied type name is a possible container for <see cref="CDP4Common.DTO.BuiltInRuleVerification"/>.
        /// </summary>
        /// <param name="typeName">
        /// Name of the type for which to check if it is a container of <see cref="CDP4Common.DTO.BuiltInRuleVerification"/>.
        /// </param>
        /// <param name="containerProperty">
        /// Supplied container property info instance that will be set if the supplied type name is a container of <see cref="CDP4Common.DTO.BuiltInRuleVerification"/>.
        /// </param>
        /// <returns>
        /// True if the supplied typeName is a container for <see cref="CDP4Common.DTO.BuiltInRuleVerification"/> and sets the container property name.
        /// </returns>
        ...
        /// <summary>
        /// Check if the supplied property name for <see cref="CDP4Common.DTO.BuiltInRuleVerification"/> is scalar.
        /// </summary>
        /// <param name="propertyName">
        /// Name of the property for which to check if it is scalar.
        /// </param>
        ...
        public object DeserializeCollectionValue(string propertyName, object value)
        {
            ...
            {
                throw new ArgumentException(string.Format("'{0}' is not a valid collection property of 'BuiltInRuleVerification'", propertyName));
            }
        ...
        public object GetValue(string propertyName, CDP4Common.DTO.Thing thing)
        {
            ...
            return this.propertyValueMap[propertyName]((CDP4Common.DTO.BuiltInRuleVerification)thing);
        }
        ...
        /// <summary>
        /// Instantiates a <see cref="CDP4Common.DTO.BuiltInRuleVerification"/>
        /// </summary>
        /// <returns>
        ...
        {
            return new CDP4Common.DTO.BuiltInRuleVerification(guid, revisionNumber);
        }
    }
}
