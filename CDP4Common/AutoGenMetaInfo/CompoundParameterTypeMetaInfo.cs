...
namespace CDP4Common.MetaInfo
{
    ...
    public partial class CompoundParameterTypeMetaInfo : ICompoundParameterTypeMetaInfo
    {
        ...
        public IEnumerable<Guid> GetContainmentIds(CDP4Common.DTO.Thing compoundParameterType, string propertyName)
        {
            ...
            {
                throw new ArgumentException(string.Format("'{0}' is not a valid containment property of 'CompoundParameterType'", propertyName));
            }
        ...
        public object DeserializeCollectionValue(string propertyName, object value)
        {
            ...
            {
                throw new ArgumentException(string.Format("'{0}' is not a valid collection property of 'CompoundParameterType'", propertyName));
            }
