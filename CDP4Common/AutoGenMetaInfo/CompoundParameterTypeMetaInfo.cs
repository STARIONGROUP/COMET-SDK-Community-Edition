// --------------------------------------------------------------------------------------------------------------------
// <copyright file="CompoundParameterTypeMetaInfo.cs" company="Starion Group S.A.">
...
namespace CDP4Common.MetaInfo
{
    ...
    /// <summary>
    /// This a class that holds meta info for <see cref="CompoundParameterType"/>.
    /// </summary>
    public partial class CompoundParameterTypeMetaInfo : ICompoundParameterTypeMetaInfo
    {
        /// <summary>
        ...
        /// </summary>
        private readonly Dictionary<string, Func<CDP4Common.DTO.CompoundParameterType, IEnumerable<OrderedItem>>> orderedContainmentPropertyValueMap = new Dictionary<string, Func<CDP4Common.DTO.CompoundParameterType, IEnumerable<OrderedItem>>>
        {
            { "Component", compoundParameterType => compoundParameterType.Component },
        };

        /// <summary>
        /// The validation rules that should pass for an instance of <see cref="CDP4Common.DTO.CompoundParameterType"/>.
        /// </summary>
        private readonly Dictionary<string, DtoValidationHelper<CDP4Common.DTO.CompoundParameterType>> validationRules = new Dictionary<string, DtoValidationHelper<CDP4Common.DTO.CompoundParameterType>>
        {
            ...
            { "ExcludedDomain", new DtoValidationHelper<CDP4Common.DTO.CompoundParameterType>(item => item.ExcludedDomain != null, "The 'ExcludedDomain' property of a 'CompoundParameterType' is mandatory and cannot be null.") },
            { "ExcludedPerson", new DtoValidationHelper<CDP4Common.DTO.CompoundParameterType>(item => item.ExcludedPerson != null, "The 'ExcludedPerson' property of a 'CompoundParameterType' is mandatory and cannot be null.") },
            { "HyperLink", new DtoValidationHelper<CDP4Common.DTO.CompoundParameterType>(item => item.HyperLink != null, "The 'HyperLink' property of a 'CompoundParameterType' is mandatory and cannot be null.") },
            { "Name", new DtoValidationHelper<CDP4Common.DTO.CompoundParameterType>(item => !string.IsNullOrWhiteSpace(item.Name), "The 'Name' property of a 'CompoundParameterType' is mandatory and cannot be empty or null.") },
            { "ShortName", new DtoValidationHelper<CDP4Common.DTO.CompoundParameterType>(item => !string.IsNullOrWhiteSpace(item.ShortName), "The 'ShortName' property of a 'CompoundParameterType' is mandatory and cannot be empty or null.") },
            { "Symbol", new DtoValidationHelper<CDP4Common.DTO.CompoundParameterType>(item => !string.IsNullOrWhiteSpace(item.Symbol), "The 'Symbol' property of a 'CompoundParameterType' is mandatory and cannot be empty or null.") },
        };
        ...
        /// </exception>
        public void Validate(CDP4Common.DTO.Thing compoundParameterType)
        {
            this.Validate(compoundParameterType, x => true);
        }
        ...
        /// If any validation rule failed.
        /// </exception>
        public void Validate(CDP4Common.DTO.Thing compoundParameterType, Func<string, bool> validateProperty)
        {
            foreach (var applicableRule in this.validationRules.Where(x => validateProperty(x.Key)))
            {
                applicableRule.Value.Validate((CDP4Common.DTO.CompoundParameterType)compoundParameterType);
            }
        }
        ...
        /// </returns>
        public bool TryValidate(CDP4Common.DTO.Thing compoundParameterType)
        {
            return this.TryValidate(compoundParameterType, x => true);
        }
        ...
        /// True if all validation rules have passed or if none are defined.
        /// </returns>
        public bool TryValidate(CDP4Common.DTO.Thing compoundParameterType, Func<string, bool> validateProperty)
        {
            var applicableValidationRules = this.validationRules.Where(x => validateProperty(x.Key)).Select(x => x.Value);

            return applicableValidationRules.All(applicableRule => applicableRule.TryValidate((CDP4Common.DTO.CompoundParameterType)compoundParameterType));
        }

        /// <summary>
        /// Returns the containment property value for the supplied <see cref="CDP4Common.DTO.CompoundParameterType"/>.
        /// </summary>
        /// <param name="compoundParameterType">
        /// The <see cref="CDP4Common.DTO.CompoundParameterType"/> for which to return the containment property value.
        /// </param>
        ...
        /// If the property name is not supported for the <see cref="CDP4Common.DTO.CompoundParameterType"/>.
        /// </exception>
        public IEnumerable<Guid> GetContainmentIds(CDP4Common.DTO.Thing compoundParameterType, string propertyName)
        {
            if (!this.containmentPropertyValueMap.ContainsKey(propertyName))
            {
                throw new ArgumentException($"'{propertyName}' is not a valid containment property of 'CompoundParameterType'");
            }

            return this.containmentPropertyValueMap[propertyName]((CDP4Common.DTO.CompoundParameterType)compoundParameterType);
        }

        /// <summary>
        /// Returns the ordered containment property value for the supplied <see cref="CDP4Common.DTO.CompoundParameterType"/>.
        /// </summary>
        /// <param name="compoundParameterType">
        /// The <see cref="CDP4Common.DTO.CompoundParameterType"/> for which to return the containment property value.
        /// </param>
        ...
        /// If the property name is not supported for the <see cref="CDP4Common.DTO.CompoundParameterType"/>.
        /// </exception>
        public IEnumerable<OrderedItem> GetOrderedContainmentIds(CDP4Common.DTO.Thing compoundParameterType, string propertyName)
        {
            ...
            return this.orderedContainmentPropertyValueMap[propertyName]((CDP4Common.DTO.CompoundParameterType)compoundParameterType);
        }
        ...
        /// <summary>
        /// Gets the <see cref="PropertyMetaInfo"/> for the <see cref="CompoundParameterType"/> class
        /// </summary>
        ...
        /// </summary>
        private readonly Dictionary<string, Action<CDP4Common.DTO.CompoundParameterType, object>> propertyValueAssignmentMap = new Dictionary<string, Action<CDP4Common.DTO.CompoundParameterType, object>>
        {
            { "Actor", (compoundParameterType, value) => compoundParameterType.Actor = value == null ? (Guid?)null : (Guid)value },
            { "Iid", (compoundParameterType, value) => compoundParameterType.Iid = (Guid)value },
            { "IsDeprecated", (compoundParameterType, value) => compoundParameterType.IsDeprecated = (bool)value },
            { "IsFinalized", (compoundParameterType, value) => compoundParameterType.IsFinalized = (bool)value },
            { "ModifiedOn", (compoundParameterType, value) => compoundParameterType.ModifiedOn = (DateTime)value },
            { "Name", (compoundParameterType, value) => compoundParameterType.Name = value.ToString() },
            { "ShortName", (compoundParameterType, value) => compoundParameterType.ShortName = value.ToString() },
            { "Symbol", (compoundParameterType, value) => compoundParameterType.Symbol = value.ToString() },
            { "ThingPreference", (compoundParameterType, value) => compoundParameterType.ThingPreference = value == null ? (string)null : value.ToString() },
        };
        ...
        /// <summary>
        /// Returns the <see cref="CDP4Common.DTO.CompoundParameterType"/> containment property type from the supplied property name.
        /// </summary>
        /// <param name="propertyName">
        ...
        /// <summary>
        /// Returns the <see cref="CDP4Common.DTO.CompoundParameterType"/> property type from the supplied property name.
        /// </summary>
        /// <param name="propertyName">
        /// The property name.
        /// </param>
        ...
        /// <summary>
        /// Returns the container property for the supplied type name is a possible container for <see cref="CDP4Common.DTO.CompoundParameterType"/>.
        /// </summary>
        /// <param name="typeName">
        /// Name of the type for which to check if it is a container of <see cref="CDP4Common.DTO.CompoundParameterType"/>.
        /// </param>
        /// <param name="containerProperty">
        /// Supplied container property info instance that will be set if the supplied type name is a container of <see cref="CDP4Common.DTO.CompoundParameterType"/>.
        /// </param>
        /// <returns>
        /// True if the supplied typeName is a container for <see cref="CDP4Common.DTO.CompoundParameterType"/> and sets the container property name.
        /// </returns>
        ...
        /// <summary>
        /// Check if the supplied property name for <see cref="CDP4Common.DTO.CompoundParameterType"/> is scalar.
        /// </summary>
        /// <param name="propertyName">
        /// Name of the property for which to check if it is scalar.
        /// </param>
        ...
        public bool ApplyPropertyUpdate(CDP4Common.DTO.Thing updatableThing, string propertyName, object value)
        {
            ...
            this.propertyValueAssignmentMap[propertyName]((CDP4Common.DTO.CompoundParameterType)updatableThing, value);
        ...
        public object DeserializeCollectionValue(string propertyName, object value)
        {
            ...
            {
                throw new ArgumentException($"'{propertyName}' is not a valid collection property of 'CompoundParameterType'");
            }
        ...
        public object GetValue(string propertyName, CDP4Common.DTO.Thing thing)
        {
            ...
            return this.propertyValueMap[propertyName]((CDP4Common.DTO.CompoundParameterType)thing);
        }
        ...
        /// <summary>
        /// Instantiates a <see cref="CDP4Common.DTO.CompoundParameterType"/>
        /// </summary>
        /// <returns>
        ...
        {
            return new CDP4Common.DTO.CompoundParameterType(guid, revisionNumber);
        }
    }
}
