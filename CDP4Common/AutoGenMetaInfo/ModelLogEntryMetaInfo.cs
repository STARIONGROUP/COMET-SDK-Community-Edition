// --------------------------------------------------------------------------------------------------------------------
// <copyright file="ModelLogEntryMetaInfo.cs" company="RHEA System S.A.">
...
namespace CDP4Common.MetaInfo
{
    ...
    /// <summary>
    /// This a class that holds meta info for <see cref="ModelLogEntry"/>.
    /// </summary>
    public partial class ModelLogEntryMetaInfo : IModelLogEntryMetaInfo
    {
        /// <summary>
        ...
        /// </summary>
        private readonly Dictionary<string, Func<CDP4Common.DTO.ModelLogEntry, IEnumerable<OrderedItem>>> orderedContainmentPropertyValueMap = new Dictionary<string, Func<CDP4Common.DTO.ModelLogEntry, IEnumerable<OrderedItem>>>();

        /// <summary>
        /// The validation rules that should pass for an instance of <see cref="CDP4Common.DTO.ModelLogEntry"/>.
        /// </summary>
        ...
        /// </exception>
        public void Validate(CDP4Common.DTO.Thing modelLogEntry)
        {
            this.Validate(modelLogEntry, x => true);
        }
        ...
        /// If any validation rule failed.
        /// </exception>
        public void Validate(CDP4Common.DTO.Thing modelLogEntry, Func<string, bool> validateProperty)
        {
            foreach (var applicableRule in this.validationRules.Where(x => validateProperty(x.Key)))
            {
                applicableRule.Value.Validate((CDP4Common.DTO.ModelLogEntry)modelLogEntry);
            }
        }
        ...
        /// </returns>
        public bool TryValidate(CDP4Common.DTO.Thing modelLogEntry)
        {
            return this.TryValidate(modelLogEntry, x => true);
        }
        ...
        /// True if all validation rules have passed or if none are defined.
        /// </returns>
        public bool TryValidate(CDP4Common.DTO.Thing modelLogEntry, Func<string, bool> validateProperty)
        {
            var applicableValidationRules = this.validationRules.Where(x => validateProperty(x.Key)).Select(x => x.Value);

            return applicableValidationRules.All(applicableRule => applicableRule.TryValidate((CDP4Common.DTO.ModelLogEntry)modelLogEntry));
        }

        /// <summary>
        /// Returns the containment property value for the supplied <see cref="CDP4Common.DTO.ModelLogEntry"/>.
        /// </summary>
        /// <param name="modelLogEntry">
        /// The <see cref="CDP4Common.DTO.ModelLogEntry"/> for which to return the containment property value.
        /// </param>
        ...
        /// If the property name is not supported for the <see cref="CDP4Common.DTO.ModelLogEntry"/>.
        /// </exception>
        public IEnumerable<Guid> GetContainmentIds(CDP4Common.DTO.Thing modelLogEntry, string propertyName)
        {
            if (!this.containmentPropertyValueMap.ContainsKey(propertyName))
            {
                throw new ArgumentException(string.Format("'{0}' is not a valid containment property of 'ModelLogEntry'", propertyName));
            }

            return this.containmentPropertyValueMap[propertyName]((CDP4Common.DTO.ModelLogEntry)modelLogEntry);
        }

        /// <summary>
        /// Returns the ordered containment property value for the supplied <see cref="CDP4Common.DTO.ModelLogEntry"/>.
        /// </summary>
        /// <param name="modelLogEntry">
        /// The <see cref="CDP4Common.DTO.ModelLogEntry"/> for which to return the containment property value.
        /// </param>
        ...
        /// If the property name is not supported for the <see cref="CDP4Common.DTO.ModelLogEntry"/>.
        /// </exception>
        public IEnumerable<OrderedItem> GetOrderedContainmentIds(CDP4Common.DTO.Thing modelLogEntry, string propertyName)
        {
            ...
            return this.orderedContainmentPropertyValueMap[propertyName]((CDP4Common.DTO.ModelLogEntry)modelLogEntry);
        }
        ...
        /// </summary>
        private readonly Dictionary<string, Action<CDP4Common.DTO.ModelLogEntry, object>> propertyValueAssignmentMap = new Dictionary<string, Action<CDP4Common.DTO.ModelLogEntry, object>>
        {
            { "Author", (modelLogEntry, value) => modelLogEntry.Author = value == null ? (Guid?)null : (Guid)value },
            { "Content", (modelLogEntry, value) => modelLogEntry.Content = value.ToString() },
            { "CreatedOn", (modelLogEntry, value) => modelLogEntry.CreatedOn = (DateTime)value },
            { "Iid", (modelLogEntry, value) => modelLogEntry.Iid = (Guid)value },
        ...
        {
            { "EngineeringModel", new PropertyMetaInfo("LogEntry", "Guid", PropertyKind.List, AggregationKind.Composite, false, false, true, 0, "*", true) },
        };
        ...
        /// <summary>
        /// Returns the <see cref="CDP4Common.DTO.ModelLogEntry"/> containment property type from the supplied property name.
        /// </summary>
        /// <param name="propertyName">
        ...
        /// <summary>
        /// Returns the <see cref="CDP4Common.DTO.ModelLogEntry"/> property type from the supplied property name.
        /// </summary>
        /// <param name="propertyName">
        /// The property name.
        /// </param>
        ...
        /// <summary>
        /// Returns the container property for the supplied type name is a possible container for <see cref="CDP4Common.DTO.ModelLogEntry"/>.
        /// </summary>
        /// <param name="typeName">
        /// Name of the type for which to check if it is a container of <see cref="CDP4Common.DTO.ModelLogEntry"/>.
        /// </param>
        /// <param name="containerProperty">
        /// Supplied container property info instance that will be set if the supplied type name is a container of <see cref="CDP4Common.DTO.ModelLogEntry"/>.
        /// </param>
        /// <returns>
        /// True if the supplied typeName is a container for <see cref="CDP4Common.DTO.ModelLogEntry"/> and sets the container property name.
        /// </returns>
        ...
        /// <summary>
        /// Check if the supplied property name for <see cref="CDP4Common.DTO.ModelLogEntry"/> is scalar.
        /// </summary>
        /// <param name="propertyName">
        /// Name of the property for which to check if it is scalar.
        /// </param>
        ...
        public bool ApplyPropertyUpdate(CDP4Common.DTO.Thing updatableThing, string propertyName, object value)
        {
            ...
            this.propertyValueAssignmentMap[propertyName]((CDP4Common.DTO.ModelLogEntry)updatableThing, value);
        ...
        public object DeserializeCollectionValue(string propertyName, object value)
        {
            ...
            {
                throw new ArgumentException(string.Format("'{0}' is not a valid collection property of 'ModelLogEntry'", propertyName));
            }
        ...
        public object GetValue(string propertyName, CDP4Common.DTO.Thing thing)
        {
            ...
            return this.propertyValueMap[propertyName]((CDP4Common.DTO.ModelLogEntry)thing);
        }
        ...
        /// <summary>
        /// Instantiates a <see cref="CDP4Common.DTO.ModelLogEntry"/>
        /// </summary>
        /// <returns>
        ...
        {
            return new CDP4Common.DTO.ModelLogEntry(guid, revisionNumber);
        }
    }
}
