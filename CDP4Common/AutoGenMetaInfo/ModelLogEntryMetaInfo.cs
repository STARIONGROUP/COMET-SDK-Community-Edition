// --------------------------------------------------------------------------------------------------------------------
// <copyright file="ModelLogEntryMetaInfo.cs" company="Starion Group S.A.">
...
namespace CDP4Common.MetaInfo
{
    ...
    public partial class ModelLogEntryMetaInfo : IModelLogEntryMetaInfo
    {
        ...
        public IEnumerable<Guid> GetContainmentIds(CDP4Common.DTO.Thing modelLogEntry, string propertyName)
        {
            ...
            {
                throw new ArgumentException($"'{propertyName}' is not a valid containment property of 'ModelLogEntry'");
            }
        ...
        {
            { "Actor", (modelLogEntry, value) => modelLogEntry.Actor = value == null ? (Guid?)null : (Guid)value },
        ...
        {
            { "EngineeringModel", new PropertyMetaInfo("LogEntry", "ModelLogEntry", PropertyKind.List, AggregationKind.Composite, false, false, true, 0, "*", true) },
        };
        ...
        public object DeserializeCollectionValue(string propertyName, object value)
        {
            ...
            {
                throw new ArgumentException($"'{propertyName}' is not a valid collection property of 'ModelLogEntry'");
            }
