// --------------------------------------------------------------------------------------------------------------------
// <copyright file="RuleViolationMetaInfo.cs" company="RHEA System S.A.">
...
namespace CDP4Common.MetaInfo
{
    ...
    /// <summary>
    /// This a class that holds meta info for <see cref="RuleViolation"/>.
    /// </summary>
    public partial class RuleViolationMetaInfo : IRuleViolationMetaInfo
    {
        /// <summary>
        /// The containment property value map.
        /// </summary>
        private readonly Dictionary<string, Func<CDP4Common.DTO.RuleViolation, IEnumerable<Guid>>> containmentPropertyValueMap = new Dictionary<string, Func<CDP4Common.DTO.RuleViolation, IEnumerable<Guid>>>();

        /// <summary>
        /// The ordered containment property value map.
        /// </summary>
        private readonly Dictionary<string, Func<CDP4Common.DTO.RuleViolation, IEnumerable<OrderedItem>>> orderedContainmentPropertyValueMap = new Dictionary<string, Func<CDP4Common.DTO.RuleViolation, IEnumerable<OrderedItem>>>();

        /// <summary>
        /// The validation rules that should pass for an instance of <see cref="CDP4Common.DTO.RuleViolation"/>.
        /// </summary>
        private readonly Dictionary<string, DtoValidationHelper<CDP4Common.DTO.RuleViolation>> validationRules = new Dictionary<string, DtoValidationHelper<CDP4Common.DTO.RuleViolation>>
        {
            { "Description", new DtoValidationHelper<CDP4Common.DTO.RuleViolation>(item => !string.IsNullOrWhiteSpace(item.Description), "The 'Description' property of a 'RuleViolation' is mandatory and cannot be empty or null.") },
            { "ExcludedDomain", new DtoValidationHelper<CDP4Common.DTO.RuleViolation>(item => item.ExcludedDomain != null, "The 'ExcludedDomain' property of a 'RuleViolation' is mandatory and cannot be null.") },
            { "ExcludedPerson", new DtoValidationHelper<CDP4Common.DTO.RuleViolation>(item => item.ExcludedPerson != null, "The 'ExcludedPerson' property of a 'RuleViolation' is mandatory and cannot be null.") },
            { "ViolatingThing", new DtoValidationHelper<CDP4Common.DTO.RuleViolation>(item => item.ViolatingThing != null, "The 'ViolatingThing' property of a 'RuleViolation' is mandatory and cannot be null.") },
        };
        ...
        /// </exception>
        public void Validate(CDP4Common.DTO.Thing ruleViolation)
        {
            this.Validate(ruleViolation, x => true);
        }
        ...
        /// If any validation rule failed.
        /// </exception>
        public void Validate(CDP4Common.DTO.Thing ruleViolation, Func<string, bool> validateProperty)
        {
            foreach (var applicableRule in this.validationRules.Where(x => validateProperty(x.Key)))
            {
                applicableRule.Value.Validate((CDP4Common.DTO.RuleViolation)ruleViolation);
            }
        }
        ...
        /// </returns>
        public bool TryValidate(CDP4Common.DTO.Thing ruleViolation)
        {
            return this.TryValidate(ruleViolation, x => true);
        }
        ...
        /// True if all validation rules have passed or if none are defined.
        /// </returns>
        public bool TryValidate(CDP4Common.DTO.Thing ruleViolation, Func<string, bool> validateProperty)
        {
            var applicableValidationRules = this.validationRules.Where(x => validateProperty(x.Key)).Select(x => x.Value);

            return applicableValidationRules.All(applicableRule => applicableRule.TryValidate((CDP4Common.DTO.RuleViolation)ruleViolation));
        }

        /// <summary>
        /// Returns the containment property value for the supplied <see cref="CDP4Common.DTO.RuleViolation"/>.
        /// </summary>
        /// <param name="ruleViolation">
        /// The <see cref="CDP4Common.DTO.RuleViolation"/> for which to return the containment property value.
        /// </param>
        ...
        /// If the property name is not supported for the <see cref="CDP4Common.DTO.RuleViolation"/>.
        /// </exception>
        public IEnumerable<Guid> GetContainmentIds(CDP4Common.DTO.Thing ruleViolation, string propertyName)
        {
            if (!this.containmentPropertyValueMap.ContainsKey(propertyName))
            {
                throw new ArgumentException(string.Format("'{0}' is not a valid containment property of 'RuleViolation'", propertyName));
            }

            return this.containmentPropertyValueMap[propertyName]((CDP4Common.DTO.RuleViolation)ruleViolation);
        }

        /// <summary>
        /// Returns the ordered containment property value for the supplied <see cref="CDP4Common.DTO.RuleViolation"/>.
        /// </summary>
        /// <param name="ruleViolation">
        /// The <see cref="CDP4Common.DTO.RuleViolation"/> for which to return the containment property value.
        /// </param>
        ...
        /// If the property name is not supported for the <see cref="CDP4Common.DTO.RuleViolation"/>.
        /// </exception>
        public IEnumerable<OrderedItem> GetOrderedContainmentIds(CDP4Common.DTO.Thing ruleViolation, string propertyName)
        {
            ...
            return this.orderedContainmentPropertyValueMap[propertyName]((CDP4Common.DTO.RuleViolation)ruleViolation);
        }
        ...
        /// <summary>
        /// Gets the <see cref="PropertyMetaInfo"/> for the <see cref="RuleViolation"/> class
        /// </summary>
        ...
        private readonly Dictionary<string, Func<object, object>> collectionPropertyValueDeserializationMap = new Dictionary<string, Func<object, object>>
        {
            ...
            { "ViolatingThing", (value) => (Guid)value },
        };
        ...
        {
            { "BuiltInRuleVerification", new PropertyMetaInfo("Violation", "Guid", PropertyKind.List, AggregationKind.Composite, false, false, false, 0, "*", false) },
            { "UserRuleVerification", new PropertyMetaInfo("Violation", "Guid", PropertyKind.List, AggregationKind.Composite, false, false, false, 0, "*", false) },
        };
        ...
        /// <summary>
        /// Returns the <see cref="CDP4Common.DTO.RuleViolation"/> containment property type from the supplied property name.
        /// </summary>
        /// <param name="propertyName">
        ...
        /// <summary>
        /// Returns the <see cref="CDP4Common.DTO.RuleViolation"/> property type from the supplied property name.
        /// </summary>
        /// <param name="propertyName">
        /// The property name.
        /// </param>
        ...
        /// <summary>
        /// Returns the container property for the supplied type name is a possible container for <see cref="CDP4Common.DTO.RuleViolation"/>.
        /// </summary>
        /// <param name="typeName">
        /// Name of the type for which to check if it is a container of <see cref="CDP4Common.DTO.RuleViolation"/>.
        /// </param>
        /// <param name="containerProperty">
        /// Supplied container property info instance that will be set if the supplied type name is a container of <see cref="CDP4Common.DTO.RuleViolation"/>.
        /// </param>
        /// <returns>
        /// True if the supplied typeName is a container for <see cref="CDP4Common.DTO.RuleViolation"/> and sets the container property name.
        /// </returns>
        ...
        /// <summary>
        /// Check if the supplied property name for <see cref="CDP4Common.DTO.RuleViolation"/> is scalar.
        /// </summary>
        /// <param name="propertyName">
        /// Name of the property for which to check if it is scalar.
        /// </param>
        ...
        public bool ApplyPropertyUpdate(CDP4Common.DTO.Thing updatableThing, string propertyName, object value)
        {
            ...
            this.propertyValueAssignmentMap[propertyName]((CDP4Common.DTO.RuleViolation)updatableThing, value);
        ...
        public object DeserializeCollectionValue(string propertyName, object value)
        {
            ...
            {
                throw new ArgumentException(string.Format("'{0}' is not a valid collection property of 'RuleViolation'", propertyName));
            }
        ...
        public object GetValue(string propertyName, CDP4Common.DTO.Thing thing)
        {
            ...
            return this.propertyValueMap[propertyName]((CDP4Common.DTO.RuleViolation)thing);
        }
        ...
        /// <summary>
        /// Instantiates a <see cref="CDP4Common.DTO.RuleViolation"/>
        /// </summary>
        /// <returns>
        ...
        {
            return new CDP4Common.DTO.RuleViolation(guid, revisionNumber);
        }
    }
}
