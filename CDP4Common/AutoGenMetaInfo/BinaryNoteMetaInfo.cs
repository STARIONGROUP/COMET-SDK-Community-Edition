// --------------------------------------------------------------------------------------------------------------------
// <copyright file="BinaryNoteMetaInfo.cs" company="RHEA System S.A.">
...
namespace CDP4Common.MetaInfo
{
    ...
    /// <summary>
    /// This a class that holds meta info for <see cref="BinaryNote"/>.
    /// </summary>
    public partial class BinaryNoteMetaInfo : IBinaryNoteMetaInfo
    {
        /// <summary>
        /// The containment property value map.
        /// </summary>
        private readonly Dictionary<string, Func<CDP4Common.DTO.BinaryNote, IEnumerable<Guid>>> containmentPropertyValueMap = new Dictionary<string, Func<CDP4Common.DTO.BinaryNote, IEnumerable<Guid>>>();

        /// <summary>
        /// The ordered containment property value map.
        /// </summary>
        private readonly Dictionary<string, Func<CDP4Common.DTO.BinaryNote, IEnumerable<OrderedItem>>> orderedContainmentPropertyValueMap = new Dictionary<string, Func<CDP4Common.DTO.BinaryNote, IEnumerable<OrderedItem>>>();

        /// <summary>
        /// The validation rules that should pass for an instance of <see cref="CDP4Common.DTO.BinaryNote"/>.
        /// </summary>
        private readonly Dictionary<string, DtoValidationHelper<CDP4Common.DTO.BinaryNote>> validationRules = new Dictionary<string, DtoValidationHelper<CDP4Common.DTO.BinaryNote>>
        {
            { "Caption", new DtoValidationHelper<CDP4Common.DTO.BinaryNote>(item => !string.IsNullOrWhiteSpace(item.Caption), "The 'Caption' property of a 'BinaryNote' is mandatory and cannot be empty or null.") },
            { "Category", new DtoValidationHelper<CDP4Common.DTO.BinaryNote>(item => item.Category != null, "The 'Category' property of a 'BinaryNote' is mandatory and cannot be null.") },
            { "ExcludedDomain", new DtoValidationHelper<CDP4Common.DTO.BinaryNote>(item => item.ExcludedDomain != null, "The 'ExcludedDomain' property of a 'BinaryNote' is mandatory and cannot be null.") },
            { "ExcludedPerson", new DtoValidationHelper<CDP4Common.DTO.BinaryNote>(item => item.ExcludedPerson != null, "The 'ExcludedPerson' property of a 'BinaryNote' is mandatory and cannot be null.") },
            { "Name", new DtoValidationHelper<CDP4Common.DTO.BinaryNote>(item => !string.IsNullOrWhiteSpace(item.Name), "The 'Name' property of a 'BinaryNote' is mandatory and cannot be empty or null.") },
            { "ShortName", new DtoValidationHelper<CDP4Common.DTO.BinaryNote>(item => !string.IsNullOrWhiteSpace(item.ShortName), "The 'ShortName' property of a 'BinaryNote' is mandatory and cannot be empty or null.") },
        };
        ...
        /// </exception>
        public void Validate(CDP4Common.DTO.Thing binaryNote)
        {
            this.Validate(binaryNote, x => true);
        }
        ...
        /// If any validation rule failed.
        /// </exception>
        public void Validate(CDP4Common.DTO.Thing binaryNote, Func<string, bool> validateProperty)
        {
            foreach (var applicableRule in this.validationRules.Where(x => validateProperty(x.Key)))
            {
                applicableRule.Value.Validate((CDP4Common.DTO.BinaryNote)binaryNote);
            }
        }
        ...
        /// </returns>
        public bool TryValidate(CDP4Common.DTO.Thing binaryNote)
        {
            return this.TryValidate(binaryNote, x => true);
        }
        ...
        /// True if all validation rules have passed or if none are defined.
        /// </returns>
        public bool TryValidate(CDP4Common.DTO.Thing binaryNote, Func<string, bool> validateProperty)
        {
            var applicableValidationRules = this.validationRules.Where(x => validateProperty(x.Key)).Select(x => x.Value);

            return applicableValidationRules.All(applicableRule => applicableRule.TryValidate((CDP4Common.DTO.BinaryNote)binaryNote));
        }

        /// <summary>
        /// Returns the containment property value for the supplied <see cref="CDP4Common.DTO.BinaryNote"/>.
        /// </summary>
        /// <param name="binaryNote">
        /// The <see cref="CDP4Common.DTO.BinaryNote"/> for which to return the containment property value.
        /// </param>
        ...
        /// If the property name is not supported for the <see cref="CDP4Common.DTO.BinaryNote"/>.
        /// </exception>
        public IEnumerable<Guid> GetContainmentIds(CDP4Common.DTO.Thing binaryNote, string propertyName)
        {
            if (!this.containmentPropertyValueMap.ContainsKey(propertyName))
            {
                throw new ArgumentException(string.Format("'{0}' is not a valid containment property of 'BinaryNote'", propertyName));
            }

            return this.containmentPropertyValueMap[propertyName]((CDP4Common.DTO.BinaryNote)binaryNote);
        }

        /// <summary>
        /// Returns the ordered containment property value for the supplied <see cref="CDP4Common.DTO.BinaryNote"/>.
        /// </summary>
        /// <param name="binaryNote">
        /// The <see cref="CDP4Common.DTO.BinaryNote"/> for which to return the containment property value.
        /// </param>
        ...
        /// If the property name is not supported for the <see cref="CDP4Common.DTO.BinaryNote"/>.
        /// </exception>
        public IEnumerable<OrderedItem> GetOrderedContainmentIds(CDP4Common.DTO.Thing binaryNote, string propertyName)
        {
            ...
            return this.orderedContainmentPropertyValueMap[propertyName]((CDP4Common.DTO.BinaryNote)binaryNote);
        }
        ...
        /// <summary>
        /// Gets the <see cref="PropertyMetaInfo"/> for the <see cref="BinaryNote"/> class
        /// </summary>
        ...
        private readonly Dictionary<string, PropertyMetaInfo> propertyTypeMap = new Dictionary<string, PropertyMetaInfo>
        {
            ...
            { "FileType", new PropertyMetaInfo("FileType", "FileType", PropertyKind.Scalar, AggregationKind.None, false, false, true, 1, "1", true) },
        ...
        private readonly Dictionary<string, Action<CDP4Common.DTO.BinaryNote, object>> propertyValueAssignmentMap = new Dictionary<string, Action<CDP4Common.DTO.BinaryNote, object>>
        {
            ...
            { "Iid", (binaryNote, value) => binaryNote.Iid = (Guid)value },
            { "ModifiedOn", (binaryNote, value) => binaryNote.ModifiedOn = (DateTime)value },
            { "Name", (binaryNote, value) => binaryNote.Name = value.ToString() },
            { "Owner", (binaryNote, value) => binaryNote.Owner = (Guid)value },
            { "ShortName", (binaryNote, value) => binaryNote.ShortName = value.ToString() },
            { "ThingPreference", (binaryNote, value) => binaryNote.ThingPreference = value == null ? (string)null : value.ToString() },
        };
        ...
        /// <summary>
        /// Returns the <see cref="CDP4Common.DTO.BinaryNote"/> containment property type from the supplied property name.
        /// </summary>
        /// <param name="propertyName">
        ...
        /// <summary>
        /// Returns the <see cref="CDP4Common.DTO.BinaryNote"/> property type from the supplied property name.
        /// </summary>
        /// <param name="propertyName">
        /// The property name.
        /// </param>
        ...
        /// <summary>
        /// Returns the container property for the supplied type name is a possible container for <see cref="CDP4Common.DTO.BinaryNote"/>.
        /// </summary>
        /// <param name="typeName">
        /// Name of the type for which to check if it is a container of <see cref="CDP4Common.DTO.BinaryNote"/>.
        /// </param>
        /// <param name="containerProperty">
        /// Supplied container property info instance that will be set if the supplied type name is a container of <see cref="CDP4Common.DTO.BinaryNote"/>.
        /// </param>
        /// <returns>
        /// True if the supplied typeName is a container for <see cref="CDP4Common.DTO.BinaryNote"/> and sets the container property name.
        /// </returns>
        ...
        /// <summary>
        /// Check if the supplied property name for <see cref="CDP4Common.DTO.BinaryNote"/> is scalar.
        /// </summary>
        /// <param name="propertyName">
        /// Name of the property for which to check if it is scalar.
        /// </param>
        ...
        public bool ApplyPropertyUpdate(CDP4Common.DTO.Thing updatableThing, string propertyName, object value)
        {
            ...
            this.propertyValueAssignmentMap[propertyName]((CDP4Common.DTO.BinaryNote)updatableThing, value);
        ...
        public object DeserializeCollectionValue(string propertyName, object value)
        {
            ...
            {
                throw new ArgumentException(string.Format("'{0}' is not a valid collection property of 'BinaryNote'", propertyName));
            }
        ...
        public object GetValue(string propertyName, CDP4Common.DTO.Thing thing)
        {
            ...
            return this.propertyValueMap[propertyName]((CDP4Common.DTO.BinaryNote)thing);
        }
        ...
        /// <summary>
        /// Instantiates a <see cref="CDP4Common.DTO.BinaryNote"/>
        /// </summary>
        /// <returns>
        ...
        {
            return new CDP4Common.DTO.BinaryNote(guid, revisionNumber);
        }
    }
}
