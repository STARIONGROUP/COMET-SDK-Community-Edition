...
namespace CDP4Common.MetaInfo
{
    ...
    public partial class ReferenceDataLibraryMetaInfo : IReferenceDataLibraryMetaInfo
    {
        ...
        public IEnumerable<Guid> GetContainmentIds(CDP4Common.DTO.Thing referenceDataLibrary, string propertyName)
        {
            ...
            {
                throw new ArgumentException(string.Format("'{0}' is not a valid containment property of 'ReferenceDataLibrary'", propertyName));
            }
        ...
        public object DeserializeCollectionValue(string propertyName, object value)
        {
            ...
            {
                throw new ArgumentException(string.Format("'{0}' is not a valid collection property of 'ReferenceDataLibrary'", propertyName));
            }
