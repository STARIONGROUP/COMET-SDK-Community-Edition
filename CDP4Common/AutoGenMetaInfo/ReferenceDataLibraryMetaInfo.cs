// --------------------------------------------------------------------------------------------------------------------
// <copyright file="ReferenceDataLibraryMetaInfo.cs" company="Starion Group S.A.">
...
namespace CDP4Common.MetaInfo
{
    ...
    /// </summary>
    public partial class ReferenceDataLibraryMetaInfo : IReferenceDataLibraryMetaInfo
    {
        /// <summary>
        ...
        private readonly Dictionary<string, Func<CDP4Common.DTO.ReferenceDataLibrary, IEnumerable<Guid>>> containmentPropertyValueMap = new Dictionary<string, Func<CDP4Common.DTO.ReferenceDataLibrary, IEnumerable<Guid>>>
        {
            ...
            { "FileType", referenceDataLibrary => referenceDataLibrary.FileType },
            { "Glossary", referenceDataLibrary => referenceDataLibrary.Glossary },
            { "HyperLink", referenceDataLibrary => referenceDataLibrary.HyperLink },
            { "ParameterType", referenceDataLibrary => referenceDataLibrary.ParameterType },
            { "ReferenceSource", referenceDataLibrary => referenceDataLibrary.ReferenceSource },
            { "Rule", referenceDataLibrary => referenceDataLibrary.Rule },
            { "Scale", referenceDataLibrary => referenceDataLibrary.Scale },
            { "Unit", referenceDataLibrary => referenceDataLibrary.Unit },
            { "UnitPrefix", referenceDataLibrary => referenceDataLibrary.UnitPrefix },
        };

        /// <summary>
        /// The ordered containment property value map.
        /// </summary>
        private readonly Dictionary<string, Func<CDP4Common.DTO.ReferenceDataLibrary, IEnumerable<OrderedItem>>> orderedContainmentPropertyValueMap = new Dictionary<string, Func<CDP4Common.DTO.ReferenceDataLibrary, IEnumerable<OrderedItem>>>();

        /// <summary>
        /// The validation rules that should pass for an instance of <see cref="CDP4Common.DTO.ReferenceDataLibrary"/>.
        /// </summary>
        private readonly Dictionary<string, DtoValidationHelper<CDP4Common.DTO.ReferenceDataLibrary>> validationRules = new Dictionary<string, DtoValidationHelper<CDP4Common.DTO.ReferenceDataLibrary>>
        {
            ...
            { "DefinedCategory", new DtoValidationHelper<CDP4Common.DTO.ReferenceDataLibrary>(item => item.DefinedCategory != null, "The 'DefinedCategory' property of a 'ReferenceDataLibrary' is mandatory and cannot be null.") },
            { "Definition", new DtoValidationHelper<CDP4Common.DTO.ReferenceDataLibrary>(item => item.Definition != null, "The 'Definition' property of a 'ReferenceDataLibrary' is mandatory and cannot be null.") },
            { "ExcludedDomain", new DtoValidationHelper<CDP4Common.DTO.ReferenceDataLibrary>(item => item.ExcludedDomain != null, "The 'ExcludedDomain' property of a 'ReferenceDataLibrary' is mandatory and cannot be null.") },
            { "ExcludedPerson", new DtoValidationHelper<CDP4Common.DTO.ReferenceDataLibrary>(item => item.ExcludedPerson != null, "The 'ExcludedPerson' property of a 'ReferenceDataLibrary' is mandatory and cannot be null.") },
            { "FileType", new DtoValidationHelper<CDP4Common.DTO.ReferenceDataLibrary>(item => item.FileType != null, "The 'FileType' property of a 'ReferenceDataLibrary' is mandatory and cannot be null.") },
            { "Glossary", new DtoValidationHelper<CDP4Common.DTO.ReferenceDataLibrary>(item => item.Glossary != null, "The 'Glossary' property of a 'ReferenceDataLibrary' is mandatory and cannot be null.") },
            { "HyperLink", new DtoValidationHelper<CDP4Common.DTO.ReferenceDataLibrary>(item => item.HyperLink != null, "The 'HyperLink' property of a 'ReferenceDataLibrary' is mandatory and cannot be null.") },
            { "Name", new DtoValidationHelper<CDP4Common.DTO.ReferenceDataLibrary>(item => !string.IsNullOrWhiteSpace(item.Name), "The 'Name' property of a 'ReferenceDataLibrary' is mandatory and cannot be empty or null.") },
            { "ParameterType", new DtoValidationHelper<CDP4Common.DTO.ReferenceDataLibrary>(item => item.ParameterType != null, "The 'ParameterType' property of a 'ReferenceDataLibrary' is mandatory and cannot be null.") },
            { "ReferenceSource", new DtoValidationHelper<CDP4Common.DTO.ReferenceDataLibrary>(item => item.ReferenceSource != null, "The 'ReferenceSource' property of a 'ReferenceDataLibrary' is mandatory and cannot be null.") },
            { "Rule", new DtoValidationHelper<CDP4Common.DTO.ReferenceDataLibrary>(item => item.Rule != null, "The 'Rule' property of a 'ReferenceDataLibrary' is mandatory and cannot be null.") },
            { "Scale", new DtoValidationHelper<CDP4Common.DTO.ReferenceDataLibrary>(item => item.Scale != null, "The 'Scale' property of a 'ReferenceDataLibrary' is mandatory and cannot be null.") },
            { "ShortName", new DtoValidationHelper<CDP4Common.DTO.ReferenceDataLibrary>(item => !string.IsNullOrWhiteSpace(item.ShortName), "The 'ShortName' property of a 'ReferenceDataLibrary' is mandatory and cannot be empty or null.") },
            { "Unit", new DtoValidationHelper<CDP4Common.DTO.ReferenceDataLibrary>(item => item.Unit != null, "The 'Unit' property of a 'ReferenceDataLibrary' is mandatory and cannot be null.") },
            { "UnitPrefix", new DtoValidationHelper<CDP4Common.DTO.ReferenceDataLibrary>(item => item.UnitPrefix != null, "The 'UnitPrefix' property of a 'ReferenceDataLibrary' is mandatory and cannot be null.") },
        };
        ...
        /// </exception>
        public void Validate(CDP4Common.DTO.Thing referenceDataLibrary)
        {
            this.Validate(referenceDataLibrary, x => true);
        }
        ...
        /// If any validation rule failed.
        /// </exception>
        public void Validate(CDP4Common.DTO.Thing referenceDataLibrary, Func<string, bool> validateProperty)
        {
            foreach (var applicableRule in this.validationRules.Where(x => validateProperty(x.Key)))
            {
                applicableRule.Value.Validate((CDP4Common.DTO.ReferenceDataLibrary)referenceDataLibrary);
            }
        }
        ...
        /// </returns>
        public bool TryValidate(CDP4Common.DTO.Thing referenceDataLibrary)
        {
            return this.TryValidate(referenceDataLibrary, x => true);
        }
        ...
        /// True if all validation rules have passed or if none are defined.
        /// </returns>
        public bool TryValidate(CDP4Common.DTO.Thing referenceDataLibrary, Func<string, bool> validateProperty)
        {
            var applicableValidationRules = this.validationRules.Where(x => validateProperty(x.Key)).Select(x => x.Value);

            return applicableValidationRules.All(applicableRule => applicableRule.TryValidate((CDP4Common.DTO.ReferenceDataLibrary)referenceDataLibrary));
        }

        /// <summary>
        /// Returns the containment property value for the supplied <see cref="CDP4Common.DTO.ReferenceDataLibrary"/>.
        /// </summary>
        /// <param name="referenceDataLibrary">
        /// The <see cref="CDP4Common.DTO.ReferenceDataLibrary"/> for which to return the containment property value.
        /// </param>
        ...
        /// If the property name is not supported for the <see cref="CDP4Common.DTO.ReferenceDataLibrary"/>.
        /// </exception>
        public IEnumerable<Guid> GetContainmentIds(CDP4Common.DTO.Thing referenceDataLibrary, string propertyName)
        {
            if (!this.containmentPropertyValueMap.ContainsKey(propertyName))
            {
                throw new ArgumentException($"'{propertyName}' is not a valid containment property of 'ReferenceDataLibrary'");
            }

            return this.containmentPropertyValueMap[propertyName]((CDP4Common.DTO.ReferenceDataLibrary)referenceDataLibrary);
        }

        /// <summary>
        /// Returns the ordered containment property value for the supplied <see cref="CDP4Common.DTO.ReferenceDataLibrary"/>.
        /// </summary>
        /// <param name="referenceDataLibrary">
        /// The <see cref="CDP4Common.DTO.ReferenceDataLibrary"/> for which to return the containment property value.
        /// </param>
        ...
        /// If the property name is not supported for the <see cref="CDP4Common.DTO.ReferenceDataLibrary"/>.
        /// </exception>
        public IEnumerable<OrderedItem> GetOrderedContainmentIds(CDP4Common.DTO.Thing referenceDataLibrary, string propertyName)
        {
            ...
            return this.orderedContainmentPropertyValueMap[propertyName]((CDP4Common.DTO.ReferenceDataLibrary)referenceDataLibrary);
        }
        ...
        /// <summary>
        /// Gets the <see cref="PropertyMetaInfo"/> for the <see cref="ReferenceDataLibrary"/> class
        /// </summary>
        ...
        /// </summary>
        private readonly Dictionary<string, Action<CDP4Common.DTO.ReferenceDataLibrary, object>> propertyValueAssignmentMap = new Dictionary<string, Action<CDP4Common.DTO.ReferenceDataLibrary, object>>
        {
            { "Actor", (referenceDataLibrary, value) => referenceDataLibrary.Actor = value == null ? (Guid?)null : (Guid)value },
            { "Iid", (referenceDataLibrary, value) => referenceDataLibrary.Iid = (Guid)value },
            { "ModifiedOn", (referenceDataLibrary, value) => referenceDataLibrary.ModifiedOn = (DateTime)value },
        ...
        /// <summary>
        /// Returns the <see cref="CDP4Common.DTO.ReferenceDataLibrary"/> containment property type from the supplied property name.
        /// </summary>
        /// <param name="propertyName">
        ...
        /// <summary>
        /// Returns the <see cref="CDP4Common.DTO.ReferenceDataLibrary"/> property type from the supplied property name.
        /// </summary>
        /// <param name="propertyName">
        /// The property name.
        /// </param>
        ...
        /// <summary>
        /// Returns the container property for the supplied type name is a possible container for <see cref="CDP4Common.DTO.ReferenceDataLibrary"/>.
        /// </summary>
        /// <param name="typeName">
        /// Name of the type for which to check if it is a container of <see cref="CDP4Common.DTO.ReferenceDataLibrary"/>.
        /// </param>
        /// <param name="containerProperty">
        /// Supplied container property info instance that will be set if the supplied type name is a container of <see cref="CDP4Common.DTO.ReferenceDataLibrary"/>.
        /// </param>
        /// <returns>
        /// True if the supplied typeName is a container for <see cref="CDP4Common.DTO.ReferenceDataLibrary"/> and sets the container property name.
        /// </returns>
        ...
        /// <summary>
        /// Check if the supplied property name for <see cref="CDP4Common.DTO.ReferenceDataLibrary"/> is scalar.
        /// </summary>
        /// <param name="propertyName">
        /// Name of the property for which to check if it is scalar.
        /// </param>
        ...
        public bool ApplyPropertyUpdate(CDP4Common.DTO.Thing updatableThing, string propertyName, object value)
        {
            ...
            this.propertyValueAssignmentMap[propertyName]((CDP4Common.DTO.ReferenceDataLibrary)updatableThing, value);
        ...
        public object DeserializeCollectionValue(string propertyName, object value)
        {
            ...
            {
                throw new ArgumentException($"'{propertyName}' is not a valid collection property of 'ReferenceDataLibrary'");
            }
        ...
        public object GetValue(string propertyName, CDP4Common.DTO.Thing thing)
        {
            ...
            return this.propertyValueMap[propertyName]((CDP4Common.DTO.ReferenceDataLibrary)thing);
        }
        ...
        /// <summary>
        /// Instantiates a <see cref="CDP4Common.DTO.ReferenceDataLibrary"/>
        /// </summary>
        /// <returns>
