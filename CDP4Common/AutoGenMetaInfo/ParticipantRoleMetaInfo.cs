...
namespace CDP4Common.MetaInfo
{
    ...
    public partial class ParticipantRoleMetaInfo : IParticipantRoleMetaInfo
    {
        ...
        private readonly Dictionary<string, PropertyMetaInfo> containmentTypeMap = new Dictionary<string, PropertyMetaInfo>
        {
            ...
            { "ParticipantPermission", new PropertyMetaInfo("ParticipantPermission", "Guid", PropertyKind.List, AggregationKind.Composite, false, false, true, 0, "*", true) },
        };
        ...
        {
            { "SiteDirectory", new PropertyMetaInfo("ParticipantRole", "Guid", PropertyKind.List, AggregationKind.Composite, false, false, true, 0, "*", true) },
        };
