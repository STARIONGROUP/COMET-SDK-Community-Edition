...
namespace CDP4Common.MetaInfo
{
    ...
    public partial class DiagramElementContainerMetaInfo : IDiagramElementContainerMetaInfo
    {
        ...
        public IEnumerable<Guid> GetContainmentIds(CDP4Common.DTO.Thing diagramElementContainer, string propertyName)
        {
            ...
            {
                throw new ArgumentException(string.Format("'{0}' is not a valid containment property of 'DiagramElementContainer'", propertyName));
            }
        ...
        public object DeserializeCollectionValue(string propertyName, object value)
        {
            ...
            {
                throw new ArgumentException(string.Format("'{0}' is not a valid collection property of 'DiagramElementContainer'", propertyName));
            }
