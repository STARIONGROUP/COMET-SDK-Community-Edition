// --------------------------------------------------------------------------------------------------------------------
// <copyright file="DiagramElementContainerMetaInfo.cs" company="Starion Group S.A.">
...
namespace CDP4Common.MetaInfo
{
    ...
    /// <summary>
    /// This a class that holds meta info for <see cref="DiagramElementContainer"/>.
    /// </summary>
    public partial class DiagramElementContainerMetaInfo : IDiagramElementContainerMetaInfo
    {
        /// <summary>
        /// The containment property value map.
        /// </summary>
        private readonly Dictionary<string, Func<CDP4Common.DTO.DiagramElementContainer, IEnumerable<Guid>>> containmentPropertyValueMap = new Dictionary<string, Func<CDP4Common.DTO.DiagramElementContainer, IEnumerable<Guid>>>
        {
            { "Bounds", diagramElementContainer => diagramElementContainer.Bounds },
            { "DiagramElement", diagramElementContainer => diagramElementContainer.DiagramElement },
        };

        /// <summary>
        /// The ordered containment property value map.
        /// </summary>
        private readonly Dictionary<string, Func<CDP4Common.DTO.DiagramElementContainer, IEnumerable<OrderedItem>>> orderedContainmentPropertyValueMap = new Dictionary<string, Func<CDP4Common.DTO.DiagramElementContainer, IEnumerable<OrderedItem>>>();

        /// <summary>
        /// The validation rules that should pass for an instance of <see cref="CDP4Common.DTO.DiagramElementContainer"/>.
        /// </summary>
        private readonly Dictionary<string, DtoValidationHelper<CDP4Common.DTO.DiagramElementContainer>> validationRules = new Dictionary<string, DtoValidationHelper<CDP4Common.DTO.DiagramElementContainer>>
        {
            { "Bounds", new DtoValidationHelper<CDP4Common.DTO.DiagramElementContainer>(item => item.Bounds != null, "The 'Bounds' property of a 'DiagramElementContainer' is mandatory and cannot be null.") },
            { "DiagramElement", new DtoValidationHelper<CDP4Common.DTO.DiagramElementContainer>(item => item.DiagramElement != null, "The 'DiagramElement' property of a 'DiagramElementContainer' is mandatory and cannot be null.") },
            { "ExcludedDomain", new DtoValidationHelper<CDP4Common.DTO.DiagramElementContainer>(item => item.ExcludedDomain != null, "The 'ExcludedDomain' property of a 'DiagramElementContainer' is mandatory and cannot be null.") },
            { "ExcludedPerson", new DtoValidationHelper<CDP4Common.DTO.DiagramElementContainer>(item => item.ExcludedPerson != null, "The 'ExcludedPerson' property of a 'DiagramElementContainer' is mandatory and cannot be null.") },
            { "Name", new DtoValidationHelper<CDP4Common.DTO.DiagramElementContainer>(item => !string.IsNullOrWhiteSpace(item.Name), "The 'Name' property of a 'DiagramElementContainer' is mandatory and cannot be empty or null.") },
        };
        ...
        /// </exception>
        public void Validate(CDP4Common.DTO.Thing diagramElementContainer)
        {
            this.Validate(diagramElementContainer, x => true);
        }
        ...
        /// If any validation rule failed.
        /// </exception>
        public void Validate(CDP4Common.DTO.Thing diagramElementContainer, Func<string, bool> validateProperty)
        {
            foreach (var applicableRule in this.validationRules.Where(x => validateProperty(x.Key)))
            {
                applicableRule.Value.Validate((CDP4Common.DTO.DiagramElementContainer)diagramElementContainer);
            }
        }
        ...
        /// </returns>
        public bool TryValidate(CDP4Common.DTO.Thing diagramElementContainer)
        {
            return this.TryValidate(diagramElementContainer, x => true);
        }
        ...
        /// True if all validation rules have passed or if none are defined.
        /// </returns>
        public bool TryValidate(CDP4Common.DTO.Thing diagramElementContainer, Func<string, bool> validateProperty)
        {
            var applicableValidationRules = this.validationRules.Where(x => validateProperty(x.Key)).Select(x => x.Value);

            return applicableValidationRules.All(applicableRule => applicableRule.TryValidate((CDP4Common.DTO.DiagramElementContainer)diagramElementContainer));
        }

        /// <summary>
        /// Returns the containment property value for the supplied <see cref="CDP4Common.DTO.DiagramElementContainer"/>.
        /// </summary>
        /// <param name="diagramElementContainer">
        /// The <see cref="CDP4Common.DTO.DiagramElementContainer"/> for which to return the containment property value.
        /// </param>
        ...
        /// If the property name is not supported for the <see cref="CDP4Common.DTO.DiagramElementContainer"/>.
        /// </exception>
        public IEnumerable<Guid> GetContainmentIds(CDP4Common.DTO.Thing diagramElementContainer, string propertyName)
        {
            if (!this.containmentPropertyValueMap.ContainsKey(propertyName))
            {
                throw new ArgumentException($"'{propertyName}' is not a valid containment property of 'DiagramElementContainer'");
            }

            return this.containmentPropertyValueMap[propertyName]((CDP4Common.DTO.DiagramElementContainer)diagramElementContainer);
        }

        /// <summary>
        /// Returns the ordered containment property value for the supplied <see cref="CDP4Common.DTO.DiagramElementContainer"/>.
        /// </summary>
        /// <param name="diagramElementContainer">
        /// The <see cref="CDP4Common.DTO.DiagramElementContainer"/> for which to return the containment property value.
        /// </param>
        ...
        /// If the property name is not supported for the <see cref="CDP4Common.DTO.DiagramElementContainer"/>.
        /// </exception>
        public IEnumerable<OrderedItem> GetOrderedContainmentIds(CDP4Common.DTO.Thing diagramElementContainer, string propertyName)
        {
            ...
            return this.orderedContainmentPropertyValueMap[propertyName]((CDP4Common.DTO.DiagramElementContainer)diagramElementContainer);
        }
        ...
        /// <summary>
        /// Gets the <see cref="PropertyMetaInfo"/> for the <see cref="DiagramElementContainer"/> class
        /// </summary>
        ...
        /// </summary>
        private readonly Dictionary<string, Func<CDP4Common.DTO.DiagramElementContainer, object>> propertyValueMap = new Dictionary<string, Func<CDP4Common.DTO.DiagramElementContainer, object>>
        {
        ...
        /// </summary>
        private readonly Dictionary<string, Action<CDP4Common.DTO.DiagramElementContainer, object>> propertyValueAssignmentMap = new Dictionary<string, Action<CDP4Common.DTO.DiagramElementContainer, object>>
        {
            { "Actor", (diagramElementContainer, value) => diagramElementContainer.Actor = value == null ? (Guid?)null : (Guid)value },
            { "Iid", (diagramElementContainer, value) => diagramElementContainer.Iid = (Guid)value },
            { "ModifiedOn", (diagramElementContainer, value) => diagramElementContainer.ModifiedOn = (DateTime)value },
            { "Name", (diagramElementContainer, value) => diagramElementContainer.Name = value.ToString() },
            { "ThingPreference", (diagramElementContainer, value) => diagramElementContainer.ThingPreference = value == null ? (string)null : value.ToString() },
        };
        ...
        /// <summary>
        /// Returns the <see cref="CDP4Common.DTO.DiagramElementContainer"/> containment property type from the supplied property name.
        /// </summary>
        /// <param name="propertyName">
        ...
        /// <summary>
        /// Returns the <see cref="CDP4Common.DTO.DiagramElementContainer"/> property type from the supplied property name.
        /// </summary>
        /// <param name="propertyName">
        /// The property name.
        /// </param>
        ...
        /// <summary>
        /// Returns the container property for the supplied type name is a possible container for <see cref="CDP4Common.DTO.DiagramElementContainer"/>.
        /// </summary>
        /// <param name="typeName">
        /// Name of the type for which to check if it is a container of <see cref="CDP4Common.DTO.DiagramElementContainer"/>.
        /// </param>
        /// <param name="containerProperty">
        /// Supplied container property info instance that will be set if the supplied type name is a container of <see cref="CDP4Common.DTO.DiagramElementContainer"/>.
        /// </param>
        /// <returns>
        /// True if the supplied typeName is a container for <see cref="CDP4Common.DTO.DiagramElementContainer"/> and sets the container property name.
        /// </returns>
        ...
        /// <summary>
        /// Check if the supplied property name for <see cref="CDP4Common.DTO.DiagramElementContainer"/> is scalar.
        /// </summary>
        /// <param name="propertyName">
        /// Name of the property for which to check if it is scalar.
        /// </param>
        ...
        public object DeserializeCollectionValue(string propertyName, object value)
        {
            ...
            {
                throw new ArgumentException($"'{propertyName}' is not a valid collection property of 'DiagramElementContainer'");
            }
        ...
        public object GetValue(string propertyName, CDP4Common.DTO.Thing thing)
        {
            ...
            return this.propertyValueMap[propertyName]((CDP4Common.DTO.DiagramElementContainer)thing);
        }
        ...
        /// <summary>
        /// Instantiates a <see cref="CDP4Common.DTO.DiagramElementContainer"/>
        /// </summary>
        /// <returns>
