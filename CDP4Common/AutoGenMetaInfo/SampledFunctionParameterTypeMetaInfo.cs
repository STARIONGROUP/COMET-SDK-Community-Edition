// --------------------------------------------------------------------------------------------------------------------
// <copyright file="SampledFunctionParameterTypeMetaInfo.cs" company="Starion Group S.A.">
...
namespace CDP4Common.MetaInfo
{
    ...
    public partial class SampledFunctionParameterTypeMetaInfo : ISampledFunctionParameterTypeMetaInfo
    {
        ...
        public IEnumerable<Guid> GetContainmentIds(CDP4Common.DTO.Thing sampledFunctionParameterType, string propertyName)
        {
            ...
            {
                throw new ArgumentException($"'{propertyName}' is not a valid containment property of 'SampledFunctionParameterType'");
            }
        ...
        public object DeserializeCollectionValue(string propertyName, object value)
        {
            ...
            {
                throw new ArgumentException($"'{propertyName}' is not a valid collection property of 'SampledFunctionParameterType'");
            }
