// --------------------------------------------------------------------------------------------------------------------
// <copyright file="ParticipantMetaInfo.cs" company="Starion Group S.A.">
...
namespace CDP4Common.MetaInfo
{
    ...
    public partial class ParticipantMetaInfo : IParticipantMetaInfo
    {
        ...
        public IEnumerable<Guid> GetContainmentIds(CDP4Common.DTO.Thing participant, string propertyName)
        {
            ...
            {
                throw new ArgumentException($"'{propertyName}' is not a valid containment property of 'Participant'");
            }
        ...
        private readonly Dictionary<string, PropertyMetaInfo> propertyTypeMap = new Dictionary<string, PropertyMetaInfo>
        {
            ...
            { "Domain", new PropertyMetaInfo("Domain", "DomainOfExpertise", PropertyKind.List, AggregationKind.None, false, false, true, 1, "*", true) },
            ...
            { "Person", new PropertyMetaInfo("Person", "Person", PropertyKind.Scalar, AggregationKind.None, false, false, true, 1, "1", true) },
        ...
        {
            { "Actor", (participant, value) => participant.Actor = value == null ? (Guid?)null : (Guid)value },
        ...
        {
            { "EngineeringModelSetup", new PropertyMetaInfo("Participant", "Participant", PropertyKind.List, AggregationKind.Composite, false, false, true, 1, "*", true) },
        };
        ...
        public object DeserializeCollectionValue(string propertyName, object value)
        {
            ...
            {
                throw new ArgumentException($"'{propertyName}' is not a valid collection property of 'Participant'");
            }
