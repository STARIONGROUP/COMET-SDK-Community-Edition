// --------------------------------------------------------------------------------------------------------------------
// <copyright file="ParticipantMetaInfo.cs" company="RHEA System S.A.">
...
namespace CDP4Common.MetaInfo
{
    ...
    /// <summary>
    /// This a class that holds meta info for <see cref="Participant"/>.
    /// </summary>
    public partial class ParticipantMetaInfo : IParticipantMetaInfo
    {
        /// <summary>
        /// The containment property value map.
        /// </summary>
        private readonly Dictionary<string, Func<CDP4Common.DTO.Participant, IEnumerable<Guid>>> containmentPropertyValueMap = new Dictionary<string, Func<CDP4Common.DTO.Participant, IEnumerable<Guid>>>();

        /// <summary>
        /// The ordered containment property value map.
        /// </summary>
        private readonly Dictionary<string, Func<CDP4Common.DTO.Participant, IEnumerable<OrderedItem>>> orderedContainmentPropertyValueMap = new Dictionary<string, Func<CDP4Common.DTO.Participant, IEnumerable<OrderedItem>>>();

        /// <summary>
        /// The validation rules that should pass for an instance of <see cref="CDP4Common.DTO.Participant"/>.
        /// </summary>
        private readonly Dictionary<string, DtoValidationHelper<CDP4Common.DTO.Participant>> validationRules = new Dictionary<string, DtoValidationHelper<CDP4Common.DTO.Participant>>
        {
            { "Domain", new DtoValidationHelper<CDP4Common.DTO.Participant>(item => item.Domain != null && item.Domain.Any(), "The 'Domain' property of a 'Participant' is mandatory and must have at least one entry.") },
            { "ExcludedDomain", new DtoValidationHelper<CDP4Common.DTO.Participant>(item => item.ExcludedDomain != null, "The 'ExcludedDomain' property of a 'Participant' is mandatory and cannot be null.") },
            { "ExcludedPerson", new DtoValidationHelper<CDP4Common.DTO.Participant>(item => item.ExcludedPerson != null, "The 'ExcludedPerson' property of a 'Participant' is mandatory and cannot be null.") },
        };
        ...
        /// </exception>
        public void Validate(CDP4Common.DTO.Thing participant)
        {
            this.Validate(participant, x => true);
        }
        ...
        /// If any validation rule failed.
        /// </exception>
        public void Validate(CDP4Common.DTO.Thing participant, Func<string, bool> validateProperty)
        {
            foreach (var applicableRule in this.validationRules.Where(x => validateProperty(x.Key)))
            {
                applicableRule.Value.Validate((CDP4Common.DTO.Participant)participant);
            }
        }
        ...
        /// </returns>
        public bool TryValidate(CDP4Common.DTO.Thing participant)
        {
            return this.TryValidate(participant, x => true);
        }
        ...
        /// True if all validation rules have passed or if none are defined.
        /// </returns>
        public bool TryValidate(CDP4Common.DTO.Thing participant, Func<string, bool> validateProperty)
        {
            var applicableValidationRules = this.validationRules.Where(x => validateProperty(x.Key)).Select(x => x.Value);

            return applicableValidationRules.All(applicableRule => applicableRule.TryValidate((CDP4Common.DTO.Participant)participant));
        }

        /// <summary>
        /// Returns the containment property value for the supplied <see cref="CDP4Common.DTO.Participant"/>.
        /// </summary>
        /// <param name="participant">
        /// The <see cref="CDP4Common.DTO.Participant"/> for which to return the containment property value.
        /// </param>
        ...
        /// If the property name is not supported for the <see cref="CDP4Common.DTO.Participant"/>.
        /// </exception>
        public IEnumerable<Guid> GetContainmentIds(CDP4Common.DTO.Thing participant, string propertyName)
        {
            if (!this.containmentPropertyValueMap.ContainsKey(propertyName))
            {
                throw new ArgumentException(string.Format("'{0}' is not a valid containment property of 'Participant'", propertyName));
            }

            return this.containmentPropertyValueMap[propertyName]((CDP4Common.DTO.Participant)participant);
        }

        /// <summary>
        /// Returns the ordered containment property value for the supplied <see cref="CDP4Common.DTO.Participant"/>.
        /// </summary>
        /// <param name="participant">
        /// The <see cref="CDP4Common.DTO.Participant"/> for which to return the containment property value.
        /// </param>
        ...
        /// If the property name is not supported for the <see cref="CDP4Common.DTO.Participant"/>.
        /// </exception>
        public IEnumerable<OrderedItem> GetOrderedContainmentIds(CDP4Common.DTO.Thing participant, string propertyName)
        {
            ...
            return this.orderedContainmentPropertyValueMap[propertyName]((CDP4Common.DTO.Participant)participant);
        }
        ...
        /// <summary>
        /// Gets the <see cref="PropertyMetaInfo"/> for the <see cref="Participant"/> class
        /// </summary>
        ...
        /// </summary>
        private readonly Dictionary<string, Func<CDP4Common.DTO.Participant, object>> propertyValueMap = new Dictionary<string, Func<CDP4Common.DTO.Participant, object>>
        {
        ...
        private readonly Dictionary<string, PropertyMetaInfo> propertyTypeMap = new Dictionary<string, PropertyMetaInfo>
        {
            ...
            { "Domain", new PropertyMetaInfo("Domain", "Guid", PropertyKind.List, AggregationKind.None, false, false, true, 1, "*", true) },
            ...
            { "Person", new PropertyMetaInfo("Person", "Guid", PropertyKind.Scalar, AggregationKind.None, false, false, true, 1, "1", true) },
            { "RevisionNumber", new PropertyMetaInfo("RevisionNumber", "int", PropertyKind.Scalar, AggregationKind.None, false, false, true, 1, "1", true) },
            { "Role", new PropertyMetaInfo("Role", "Guid", PropertyKind.Scalar, AggregationKind.None, false, false, true, 1, "1", true) },
            { "SelectedDomain", new PropertyMetaInfo("SelectedDomain", "Guid", PropertyKind.Scalar, AggregationKind.None, false, false, true, 1, "1", true) },
        };
        ...
        /// </summary>
        private readonly Dictionary<string, Action<CDP4Common.DTO.Participant, object>> propertyValueAssignmentMap = new Dictionary<string, Action<CDP4Common.DTO.Participant, object>>
        {
            { "Iid", (participant, value) => participant.Iid = (Guid)value },
            { "IsActive", (participant, value) => participant.IsActive = (bool)value },
            { "ModifiedOn", (participant, value) => participant.ModifiedOn = (DateTime)value },
        ...
        {
            { "EngineeringModelSetup", new PropertyMetaInfo("Participant", "Guid", PropertyKind.List, AggregationKind.Composite, false, false, true, 1, "*", true) },
        };
        ...
        /// <summary>
        /// Returns the <see cref="CDP4Common.DTO.Participant"/> containment property type from the supplied property name.
        /// </summary>
        /// <param name="propertyName">
        ...
        /// <summary>
        /// Returns the <see cref="CDP4Common.DTO.Participant"/> property type from the supplied property name.
        /// </summary>
        /// <param name="propertyName">
        /// The property name.
        /// </param>
        ...
        /// <summary>
        /// Returns the container property for the supplied type name is a possible container for <see cref="CDP4Common.DTO.Participant"/>.
        /// </summary>
        /// <param name="typeName">
        /// Name of the type for which to check if it is a container of <see cref="CDP4Common.DTO.Participant"/>.
        /// </param>
        /// <param name="containerProperty">
        /// Supplied container property info instance that will be set if the supplied type name is a container of <see cref="CDP4Common.DTO.Participant"/>.
        /// </param>
        /// <returns>
        /// True if the supplied typeName is a container for <see cref="CDP4Common.DTO.Participant"/> and sets the container property name.
        /// </returns>
        ...
        /// <summary>
        /// Check if the supplied property name for <see cref="CDP4Common.DTO.Participant"/> is scalar.
        /// </summary>
        /// <param name="propertyName">
        /// Name of the property for which to check if it is scalar.
        /// </param>
        ...
        public bool ApplyPropertyUpdate(CDP4Common.DTO.Thing updatableThing, string propertyName, object value)
        {
            ...
            this.propertyValueAssignmentMap[propertyName]((CDP4Common.DTO.Participant)updatableThing, value);
        ...
        public object DeserializeCollectionValue(string propertyName, object value)
        {
            ...
            {
                throw new ArgumentException(string.Format("'{0}' is not a valid collection property of 'Participant'", propertyName));
            }
        ...
        public object GetValue(string propertyName, CDP4Common.DTO.Thing thing)
        {
            ...
            return this.propertyValueMap[propertyName]((CDP4Common.DTO.Participant)thing);
        }
        ...
        /// <summary>
        /// Instantiates a <see cref="CDP4Common.DTO.Participant"/>
        /// </summary>
        /// <returns>
        ...
        {
            return new CDP4Common.DTO.Participant(guid, revisionNumber);
        }
    }
}
