...
namespace CDP4Common.MetaInfo
{
    ...
    /// <summary>
    /// This a class that holds meta info for <see cref="RequirementsGroup"/>.
    /// </summary>
    public partial class RequirementsGroupMetaInfo : IRequirementsGroupMetaInfo
    {
        /// <summary>
        /// The containment property value map.
        /// </summary>
        private readonly Dictionary<string, Func<CDP4Common.DTO.RequirementsGroup, IEnumerable<Guid>>> containmentPropertyValueMap = new Dictionary<string, Func<CDP4Common.DTO.RequirementsGroup, IEnumerable<Guid>>>
        {
            { "Alias", requirementsGroup => requirementsGroup.Alias },
            { "Attachment", requirementsGroup => requirementsGroup.Attachment },
            { "Definition", requirementsGroup => requirementsGroup.Definition },
            { "Group", requirementsGroup => requirementsGroup.Group },
            { "HyperLink", requirementsGroup => requirementsGroup.HyperLink },
            { "ParameterValue", requirementsGroup => requirementsGroup.ParameterValue },
        };

        /// <summary>
        /// The ordered containment property value map.
        /// </summary>
        private readonly Dictionary<string, Func<CDP4Common.DTO.RequirementsGroup, IEnumerable<OrderedItem>>> orderedContainmentPropertyValueMap = new Dictionary<string, Func<CDP4Common.DTO.RequirementsGroup, IEnumerable<OrderedItem>>>();

        /// <summary>
        /// The validation rules that should pass for an instance of <see cref="CDP4Common.DTO.RequirementsGroup"/>.
        /// </summary>
        private readonly Dictionary<string, DtoValidationHelper<CDP4Common.DTO.RequirementsGroup>> validationRules = new Dictionary<string, DtoValidationHelper<CDP4Common.DTO.RequirementsGroup>>
        {
            { "Alias", new DtoValidationHelper<CDP4Common.DTO.RequirementsGroup>(item => item.Alias != null, "The 'Alias' property of a 'RequirementsGroup' is mandatory and cannot be null.") },
            { "Attachment", new DtoValidationHelper<CDP4Common.DTO.RequirementsGroup>(item => item.Attachment != null, "The 'Attachment' property of a 'RequirementsGroup' is mandatory and cannot be null.") },
            { "Category", new DtoValidationHelper<CDP4Common.DTO.RequirementsGroup>(item => item.Category != null, "The 'Category' property of a 'RequirementsGroup' is mandatory and cannot be null.") },
            { "Definition", new DtoValidationHelper<CDP4Common.DTO.RequirementsGroup>(item => item.Definition != null, "The 'Definition' property of a 'RequirementsGroup' is mandatory and cannot be null.") },
            { "ExcludedDomain", new DtoValidationHelper<CDP4Common.DTO.RequirementsGroup>(item => item.ExcludedDomain != null, "The 'ExcludedDomain' property of a 'RequirementsGroup' is mandatory and cannot be null.") },
            { "ExcludedPerson", new DtoValidationHelper<CDP4Common.DTO.RequirementsGroup>(item => item.ExcludedPerson != null, "The 'ExcludedPerson' property of a 'RequirementsGroup' is mandatory and cannot be null.") },
            { "Group", new DtoValidationHelper<CDP4Common.DTO.RequirementsGroup>(item => item.Group != null, "The 'Group' property of a 'RequirementsGroup' is mandatory and cannot be null.") },
            { "HyperLink", new DtoValidationHelper<CDP4Common.DTO.RequirementsGroup>(item => item.HyperLink != null, "The 'HyperLink' property of a 'RequirementsGroup' is mandatory and cannot be null.") },
            { "Name", new DtoValidationHelper<CDP4Common.DTO.RequirementsGroup>(item => !string.IsNullOrWhiteSpace(item.Name), "The 'Name' property of a 'RequirementsGroup' is mandatory and cannot be empty or null.") },
            { "ParameterValue", new DtoValidationHelper<CDP4Common.DTO.RequirementsGroup>(item => item.ParameterValue != null, "The 'ParameterValue' property of a 'RequirementsGroup' is mandatory and cannot be null.") },
            { "ShortName", new DtoValidationHelper<CDP4Common.DTO.RequirementsGroup>(item => !string.IsNullOrWhiteSpace(item.ShortName), "The 'ShortName' property of a 'RequirementsGroup' is mandatory and cannot be empty or null.") },
        };
        ...
        /// </exception>
        public void Validate(CDP4Common.DTO.Thing requirementsGroup)
        {
            this.Validate(requirementsGroup, x => true);
        }
        ...
        /// If any validation rule failed.
        /// </exception>
        public void Validate(CDP4Common.DTO.Thing requirementsGroup, Func<string, bool> validateProperty)
        {
            foreach (var applicableRule in this.validationRules.Where(x => validateProperty(x.Key)))
            {
                applicableRule.Value.Validate((CDP4Common.DTO.RequirementsGroup)requirementsGroup);
            }
        }
        ...
        /// </returns>
        public bool TryValidate(CDP4Common.DTO.Thing requirementsGroup)
        {
            return this.TryValidate(requirementsGroup, x => true);
        }
        ...
        /// True if all validation rules have passed or if none are defined.
        /// </returns>
        public bool TryValidate(CDP4Common.DTO.Thing requirementsGroup, Func<string, bool> validateProperty)
        {
            var applicableValidationRules = this.validationRules.Where(x => validateProperty(x.Key)).Select(x => x.Value);

            return applicableValidationRules.All(applicableRule => applicableRule.TryValidate((CDP4Common.DTO.RequirementsGroup)requirementsGroup));
        }

        /// <summary>
        /// Returns the containment property value for the supplied <see cref="CDP4Common.DTO.RequirementsGroup"/>.
        /// </summary>
        /// <param name="requirementsGroup">
        /// The <see cref="CDP4Common.DTO.RequirementsGroup"/> for which to return the containment property value.
        /// </param>
        ...
        /// If the property name is not supported for the <see cref="CDP4Common.DTO.RequirementsGroup"/>.
        /// </exception>
        public IEnumerable<Guid> GetContainmentIds(CDP4Common.DTO.Thing requirementsGroup, string propertyName)
        {
        ...
        /// <summary>
        /// Returns the ordered containment property value for the supplied <see cref="CDP4Common.DTO.RequirementsGroup"/>.
        /// </summary>
        /// <param name="requirementsGroup">
        /// The <see cref="CDP4Common.DTO.RequirementsGroup"/> for which to return the containment property value.
        /// </param>
        ...
        /// If the property name is not supported for the <see cref="CDP4Common.DTO.RequirementsGroup"/>.
        /// </exception>
        public IEnumerable<OrderedItem> GetOrderedContainmentIds(CDP4Common.DTO.Thing requirementsGroup, string propertyName)
        {
        ...
        /// <summary>
        /// Gets the <see cref="PropertyMetaInfo"/> for the <see cref="RequirementsGroup"/> class
        /// </summary>
        ...
        /// </summary>
        private readonly Dictionary<string, Func<CDP4Common.DTO.RequirementsGroup, object>> propertyValueMap = new Dictionary<string, Func<CDP4Common.DTO.RequirementsGroup, object>>
        {
        ...
        /// </summary>
        private readonly Dictionary<string, Action<CDP4Common.DTO.RequirementsGroup, object>> propertyValueAssignmentMap = new Dictionary<string, Action<CDP4Common.DTO.RequirementsGroup, object>>
        {
            { "Actor", (requirementsGroup, value) => requirementsGroup.Actor = value == null ? (Guid?)null : (Guid)value },
            { "Iid", (requirementsGroup, value) => requirementsGroup.Iid = (Guid)value },
            { "ModifiedOn", (requirementsGroup, value) => requirementsGroup.ModifiedOn = (DateTime)value },
            { "Name", (requirementsGroup, value) => requirementsGroup.Name = value.ToString() },
            { "Owner", (requirementsGroup, value) => requirementsGroup.Owner = (Guid)value },
            { "ShortName", (requirementsGroup, value) => requirementsGroup.ShortName = value.ToString() },
            { "ThingPreference", (requirementsGroup, value) => requirementsGroup.ThingPreference = value == null ? (string)null : value.ToString() },
        };
        ...
        {
            { "RequirementsGroup", new PropertyMetaInfo("Group", "RequirementsGroup", PropertyKind.List, AggregationKind.Composite, false, false, true, 0, "*", true) },
            { "RequirementsSpecification", new PropertyMetaInfo("Group", "RequirementsGroup", PropertyKind.List, AggregationKind.Composite, false, false, true, 0, "*", true) },
        };
        ...
        /// <summary>
        /// Returns the <see cref="CDP4Common.DTO.RequirementsGroup"/> containment property type from the supplied property name.
        /// </summary>
        /// <param name="propertyName">
        ...
        /// <summary>
        /// Returns the <see cref="CDP4Common.DTO.RequirementsGroup"/> property type from the supplied property name.
        /// </summary>
        /// <param name="propertyName">
        /// The property name.
        /// </param>
        ...
        /// <summary>
        /// Returns the container property for the supplied type name is a possible container for <see cref="CDP4Common.DTO.RequirementsGroup"/>.
        /// </summary>
        /// <param name="typeName">
        /// Name of the type for which to check if it is a container of <see cref="CDP4Common.DTO.RequirementsGroup"/>.
        /// </param>
        /// <param name="containerProperty">
        /// Supplied container property info instance that will be set if the supplied type name is a container of <see cref="CDP4Common.DTO.RequirementsGroup"/>.
        /// </param>
        /// <returns>
        /// True if the supplied typeName is a container for <see cref="CDP4Common.DTO.RequirementsGroup"/> and sets the container property name.
        /// </returns>
        ...
        /// <summary>
        /// Check if the supplied property name for <see cref="CDP4Common.DTO.RequirementsGroup"/> is scalar.
        /// </summary>
        /// <param name="propertyName">
        /// Name of the property for which to check if it is scalar.
        /// </param>
        ...
        public bool ApplyPropertyUpdate(CDP4Common.DTO.Thing updatableThing, string propertyName, object value)
        {
            ...
            this.propertyValueAssignmentMap[propertyName]((CDP4Common.DTO.RequirementsGroup)updatableThing, value);
        ...
        /// <summary>
        /// Instantiates a <see cref="CDP4Common.DTO.RequirementsGroup"/>
        /// </summary>
        /// <returns>
        ...
        {
            return new CDP4Common.DTO.RequirementsGroup(guid, revisionNumber);
        }
    }
}
