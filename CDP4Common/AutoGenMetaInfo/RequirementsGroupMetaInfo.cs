...
namespace CDP4Common.MetaInfo
{
    ...
    public partial class RequirementsGroupMetaInfo : IRequirementsGroupMetaInfo
    {
        ...
        {
            { "RequirementsGroup", new PropertyMetaInfo("Group", "Guid", PropertyKind.List, AggregationKind.Composite, false, false, true, 0, "*", true) },
            { "RequirementsSpecification", new PropertyMetaInfo("Group", "Guid", PropertyKind.List, AggregationKind.Composite, false, false, true, 0, "*", true) },
        };
