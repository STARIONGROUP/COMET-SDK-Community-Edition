// --------------------------------------------------------------------------------------------------------------------
// <copyright file="SiteLogEntryMetaInfo.cs" company="RHEA System S.A.">
...
namespace CDP4Common.MetaInfo
{
    ...
    /// <summary>
    /// This a class that holds meta info for <see cref="SiteLogEntry"/>.
    /// </summary>
    public partial class SiteLogEntryMetaInfo : ISiteLogEntryMetaInfo
    {
        /// <summary>
        /// The containment property value map.
        /// </summary>
        private readonly Dictionary<string, Func<CDP4Common.DTO.SiteLogEntry, IEnumerable<Guid>>> containmentPropertyValueMap = new Dictionary<string, Func<CDP4Common.DTO.SiteLogEntry, IEnumerable<Guid>>>
        {
            { "LogEntryChangelogItem", siteLogEntry => siteLogEntry.LogEntryChangelogItem },
        };

        /// <summary>
        /// The ordered containment property value map.
        /// </summary>
        private readonly Dictionary<string, Func<CDP4Common.DTO.SiteLogEntry, IEnumerable<OrderedItem>>> orderedContainmentPropertyValueMap = new Dictionary<string, Func<CDP4Common.DTO.SiteLogEntry, IEnumerable<OrderedItem>>>();

        /// <summary>
        /// The validation rules that should pass for an instance of <see cref="CDP4Common.DTO.SiteLogEntry"/>.
        /// </summary>
        private readonly Dictionary<string, DtoValidationHelper<CDP4Common.DTO.SiteLogEntry>> validationRules = new Dictionary<string, DtoValidationHelper<CDP4Common.DTO.SiteLogEntry>>
        {
            { "AffectedDomainIid", new DtoValidationHelper<CDP4Common.DTO.SiteLogEntry>(item => item.AffectedDomainIid != null, "The 'AffectedDomainIid' property of a 'SiteLogEntry' is mandatory and cannot be null.") },
            { "AffectedItemIid", new DtoValidationHelper<CDP4Common.DTO.SiteLogEntry>(item => item.AffectedItemIid != null, "The 'AffectedItemIid' property of a 'SiteLogEntry' is mandatory and cannot be null.") },
            { "Category", new DtoValidationHelper<CDP4Common.DTO.SiteLogEntry>(item => item.Category != null, "The 'Category' property of a 'SiteLogEntry' is mandatory and cannot be null.") },
            { "Content", new DtoValidationHelper<CDP4Common.DTO.SiteLogEntry>(item => !string.IsNullOrWhiteSpace(item.Content), "The 'Content' property of a 'SiteLogEntry' is mandatory and cannot be empty or null.") },
            { "ExcludedDomain", new DtoValidationHelper<CDP4Common.DTO.SiteLogEntry>(item => item.ExcludedDomain != null, "The 'ExcludedDomain' property of a 'SiteLogEntry' is mandatory and cannot be null.") },
            { "ExcludedPerson", new DtoValidationHelper<CDP4Common.DTO.SiteLogEntry>(item => item.ExcludedPerson != null, "The 'ExcludedPerson' property of a 'SiteLogEntry' is mandatory and cannot be null.") },
            { "LanguageCode", new DtoValidationHelper<CDP4Common.DTO.SiteLogEntry>(item => !string.IsNullOrWhiteSpace(item.LanguageCode), "The 'LanguageCode' property of a 'SiteLogEntry' is mandatory and cannot be empty or null.") },
            { "LogEntryChangelogItem", new DtoValidationHelper<CDP4Common.DTO.SiteLogEntry>(item => item.LogEntryChangelogItem != null, "The 'LogEntryChangelogItem' property of a 'SiteLogEntry' is mandatory and cannot be null.") },
        };
        ...
        /// </exception>
        public void Validate(CDP4Common.DTO.Thing siteLogEntry)
        {
            this.Validate(siteLogEntry, x => true);
        }
        ...
        /// If any validation rule failed.
        /// </exception>
        public void Validate(CDP4Common.DTO.Thing siteLogEntry, Func<string, bool> validateProperty)
        {
            foreach (var applicableRule in this.validationRules.Where(x => validateProperty(x.Key)))
            {
                applicableRule.Value.Validate((CDP4Common.DTO.SiteLogEntry)siteLogEntry);
            }
        }
        ...
        /// </returns>
        public bool TryValidate(CDP4Common.DTO.Thing siteLogEntry)
        {
            return this.TryValidate(siteLogEntry, x => true);
        }
        ...
        /// True if all validation rules have passed or if none are defined.
        /// </returns>
        public bool TryValidate(CDP4Common.DTO.Thing siteLogEntry, Func<string, bool> validateProperty)
        {
            var applicableValidationRules = this.validationRules.Where(x => validateProperty(x.Key)).Select(x => x.Value);

            return applicableValidationRules.All(applicableRule => applicableRule.TryValidate((CDP4Common.DTO.SiteLogEntry)siteLogEntry));
        }

        /// <summary>
        /// Returns the containment property value for the supplied <see cref="CDP4Common.DTO.SiteLogEntry"/>.
        /// </summary>
        /// <param name="siteLogEntry">
        /// The <see cref="CDP4Common.DTO.SiteLogEntry"/> for which to return the containment property value.
        /// </param>
        ...
        /// If the property name is not supported for the <see cref="CDP4Common.DTO.SiteLogEntry"/>.
        /// </exception>
        public IEnumerable<Guid> GetContainmentIds(CDP4Common.DTO.Thing siteLogEntry, string propertyName)
        {
            if (!this.containmentPropertyValueMap.ContainsKey(propertyName))
            {
                throw new ArgumentException(string.Format("'{0}' is not a valid containment property of 'SiteLogEntry'", propertyName));
            }

            return this.containmentPropertyValueMap[propertyName]((CDP4Common.DTO.SiteLogEntry)siteLogEntry);
        }

        /// <summary>
        /// Returns the ordered containment property value for the supplied <see cref="CDP4Common.DTO.SiteLogEntry"/>.
        /// </summary>
        /// <param name="siteLogEntry">
        /// The <see cref="CDP4Common.DTO.SiteLogEntry"/> for which to return the containment property value.
        /// </param>
        ...
        /// If the property name is not supported for the <see cref="CDP4Common.DTO.SiteLogEntry"/>.
        /// </exception>
        public IEnumerable<OrderedItem> GetOrderedContainmentIds(CDP4Common.DTO.Thing siteLogEntry, string propertyName)
        {
            ...
            return this.orderedContainmentPropertyValueMap[propertyName]((CDP4Common.DTO.SiteLogEntry)siteLogEntry);
        }
        ...
        /// <summary>
        /// Gets the <see cref="PropertyMetaInfo"/> for the <see cref="SiteLogEntry"/> class
        /// </summary>
        ...
        private readonly Dictionary<string, Action<CDP4Common.DTO.SiteLogEntry, object>> propertyValueAssignmentMap = new Dictionary<string, Action<CDP4Common.DTO.SiteLogEntry, object>>
        {
            ...
            { "Iid", (siteLogEntry, value) => siteLogEntry.Iid = (Guid)value },
            { "LanguageCode", (siteLogEntry, value) => siteLogEntry.LanguageCode = value.ToString() },
            { "Level", (siteLogEntry, value) => siteLogEntry.Level = (LogLevelKind)value },
            { "ModifiedOn", (siteLogEntry, value) => siteLogEntry.ModifiedOn = (DateTime)value },
            { "ThingPreference", (siteLogEntry, value) => siteLogEntry.ThingPreference = value == null ? (string)null : value.ToString() },
        };
        ...
        {
            { "SiteDirectory", new PropertyMetaInfo("LogEntry", "SiteLogEntry", PropertyKind.List, AggregationKind.Composite, false, false, true, 0, "*", true) },
        };
        ...
        /// <summary>
        /// Returns the <see cref="CDP4Common.DTO.SiteLogEntry"/> containment property type from the supplied property name.
        /// </summary>
        /// <param name="propertyName">
        ...
        /// <summary>
        /// Returns the <see cref="CDP4Common.DTO.SiteLogEntry"/> property type from the supplied property name.
        /// </summary>
        /// <param name="propertyName">
        /// The property name.
        /// </param>
        ...
        /// <summary>
        /// Returns the container property for the supplied type name is a possible container for <see cref="CDP4Common.DTO.SiteLogEntry"/>.
        /// </summary>
        /// <param name="typeName">
        /// Name of the type for which to check if it is a container of <see cref="CDP4Common.DTO.SiteLogEntry"/>.
        /// </param>
        /// <param name="containerProperty">
        /// Supplied container property info instance that will be set if the supplied type name is a container of <see cref="CDP4Common.DTO.SiteLogEntry"/>.
        /// </param>
        /// <returns>
        /// True if the supplied typeName is a container for <see cref="CDP4Common.DTO.SiteLogEntry"/> and sets the container property name.
        /// </returns>
        ...
        /// <summary>
        /// Check if the supplied property name for <see cref="CDP4Common.DTO.SiteLogEntry"/> is scalar.
        /// </summary>
        /// <param name="propertyName">
        /// Name of the property for which to check if it is scalar.
        /// </param>
        ...
        public bool ApplyPropertyUpdate(CDP4Common.DTO.Thing updatableThing, string propertyName, object value)
        {
            ...
            this.propertyValueAssignmentMap[propertyName]((CDP4Common.DTO.SiteLogEntry)updatableThing, value);
        ...
        public object DeserializeCollectionValue(string propertyName, object value)
        {
            ...
            {
                throw new ArgumentException(string.Format("'{0}' is not a valid collection property of 'SiteLogEntry'", propertyName));
            }
        ...
        public object GetValue(string propertyName, CDP4Common.DTO.Thing thing)
        {
            ...
            return this.propertyValueMap[propertyName]((CDP4Common.DTO.SiteLogEntry)thing);
        }
        ...
        /// <summary>
        /// Instantiates a <see cref="CDP4Common.DTO.SiteLogEntry"/>
        /// </summary>
        /// <returns>
        ...
        {
            return new CDP4Common.DTO.SiteLogEntry(guid, revisionNumber);
        }
    }
}
