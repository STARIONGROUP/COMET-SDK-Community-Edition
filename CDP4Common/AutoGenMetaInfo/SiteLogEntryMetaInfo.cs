...
namespace CDP4Common.MetaInfo
{
    ...
    public partial class SiteLogEntryMetaInfo : ISiteLogEntryMetaInfo
    {
        ...
        private readonly Dictionary<string, PropertyMetaInfo> propertyTypeMap = new Dictionary<string, PropertyMetaInfo>
        {
            ...
            { "Author", new PropertyMetaInfo("Author", "Guid", PropertyKind.Scalar, AggregationKind.None, false, false, true, 0, "1", true) },
        ...
        {
            { "SiteDirectory", new PropertyMetaInfo("LogEntry", "Guid", PropertyKind.List, AggregationKind.Composite, false, false, true, 0, "*", true) },
        };
