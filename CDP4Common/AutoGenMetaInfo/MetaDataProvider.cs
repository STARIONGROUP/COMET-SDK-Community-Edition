// --------------------------------------------------------------------------------------------------------------------
// <copyright file="MetaDataProvider.cs" company="Starion Group S.A.">
...
namespace CDP4Common.MetaInfo
{
    ...
    public class MetaDataProvider : IMetaDataProvider
    {
        ...
        private readonly Dictionary<string, IMetaInfo> metaDataMap = new Dictionary<string, IMetaInfo>
        {
            ...
            { "DependentParameterTypeAssignment", new DependentParameterTypeAssignmentMetaInfo() },
            ...
            { "IndependentParameterTypeAssignment", new IndependentParameterTypeAssignmentMetaInfo() },
            ...
            { "LogEntryChangelogItem", new LogEntryChangelogItemMetaInfo() },
            ...
            { "SampledFunctionParameterType", new SampledFunctionParameterTypeMetaInfo() },
