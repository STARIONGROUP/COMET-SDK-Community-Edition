// --------------------------------------------------------------------------------------------------------------------
// <copyright file="ThingReferenceMetaInfo.cs" company="Starion Group S.A.">
...
namespace CDP4Common.MetaInfo
{
    ...
    public partial class ThingReferenceMetaInfo : IThingReferenceMetaInfo
    {
        ...
        public IEnumerable<Guid> GetContainmentIds(CDP4Common.DTO.Thing thingReference, string propertyName)
        {
            ...
            {
                throw new ArgumentException($"'{propertyName}' is not a valid containment property of 'ThingReference'");
            }
        ...
        {
            { "Actor", (thingReference, value) => thingReference.Actor = value == null ? (Guid?)null : (Guid)value },
        ...
        public object DeserializeCollectionValue(string propertyName, object value)
        {
            ...
            {
                throw new ArgumentException($"'{propertyName}' is not a valid collection property of 'ThingReference'");
            }
