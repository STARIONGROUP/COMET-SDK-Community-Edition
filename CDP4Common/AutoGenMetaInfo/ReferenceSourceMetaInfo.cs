// --------------------------------------------------------------------------------------------------------------------
// <copyright file="ReferenceSourceMetaInfo.cs" company="RHEA System S.A.">
...
namespace CDP4Common.MetaInfo
{
    ...
    /// <summary>
    /// This a class that holds meta info for <see cref="ReferenceSource"/>.
    /// </summary>
    public partial class ReferenceSourceMetaInfo : IReferenceSourceMetaInfo
    {
        /// <summary>
        /// The containment property value map.
        /// </summary>
        private readonly Dictionary<string, Func<CDP4Common.DTO.ReferenceSource, IEnumerable<Guid>>> containmentPropertyValueMap = new Dictionary<string, Func<CDP4Common.DTO.ReferenceSource, IEnumerable<Guid>>>
        {
            { "Alias", referenceSource => referenceSource.Alias },
            { "Attachment", referenceSource => referenceSource.Attachment },
            { "Definition", referenceSource => referenceSource.Definition },
            { "HyperLink", referenceSource => referenceSource.HyperLink },
        };

        /// <summary>
        /// The ordered containment property value map.
        /// </summary>
        private readonly Dictionary<string, Func<CDP4Common.DTO.ReferenceSource, IEnumerable<OrderedItem>>> orderedContainmentPropertyValueMap = new Dictionary<string, Func<CDP4Common.DTO.ReferenceSource, IEnumerable<OrderedItem>>>();

        /// <summary>
        /// The validation rules that should pass for an instance of <see cref="CDP4Common.DTO.ReferenceSource"/>.
        /// </summary>
        private readonly Dictionary<string, DtoValidationHelper<CDP4Common.DTO.ReferenceSource>> validationRules = new Dictionary<string, DtoValidationHelper<CDP4Common.DTO.ReferenceSource>>
        {
            { "Alias", new DtoValidationHelper<CDP4Common.DTO.ReferenceSource>(item => item.Alias != null, "The 'Alias' property of a 'ReferenceSource' is mandatory and cannot be null.") },
            { "Attachment", new DtoValidationHelper<CDP4Common.DTO.ReferenceSource>(item => item.Attachment != null, "The 'Attachment' property of a 'ReferenceSource' is mandatory and cannot be null.") },
            { "Category", new DtoValidationHelper<CDP4Common.DTO.ReferenceSource>(item => item.Category != null, "The 'Category' property of a 'ReferenceSource' is mandatory and cannot be null.") },
            { "Definition", new DtoValidationHelper<CDP4Common.DTO.ReferenceSource>(item => item.Definition != null, "The 'Definition' property of a 'ReferenceSource' is mandatory and cannot be null.") },
            { "ExcludedDomain", new DtoValidationHelper<CDP4Common.DTO.ReferenceSource>(item => item.ExcludedDomain != null, "The 'ExcludedDomain' property of a 'ReferenceSource' is mandatory and cannot be null.") },
            { "ExcludedPerson", new DtoValidationHelper<CDP4Common.DTO.ReferenceSource>(item => item.ExcludedPerson != null, "The 'ExcludedPerson' property of a 'ReferenceSource' is mandatory and cannot be null.") },
            { "HyperLink", new DtoValidationHelper<CDP4Common.DTO.ReferenceSource>(item => item.HyperLink != null, "The 'HyperLink' property of a 'ReferenceSource' is mandatory and cannot be null.") },
            { "Name", new DtoValidationHelper<CDP4Common.DTO.ReferenceSource>(item => !string.IsNullOrWhiteSpace(item.Name), "The 'Name' property of a 'ReferenceSource' is mandatory and cannot be empty or null.") },
            { "ShortName", new DtoValidationHelper<CDP4Common.DTO.ReferenceSource>(item => !string.IsNullOrWhiteSpace(item.ShortName), "The 'ShortName' property of a 'ReferenceSource' is mandatory and cannot be empty or null.") },
        };
        ...
        /// </exception>
        public void Validate(CDP4Common.DTO.Thing referenceSource)
        {
            this.Validate(referenceSource, x => true);
        }
        ...
        /// If any validation rule failed.
        /// </exception>
        public void Validate(CDP4Common.DTO.Thing referenceSource, Func<string, bool> validateProperty)
        {
            foreach (var applicableRule in this.validationRules.Where(x => validateProperty(x.Key)))
            {
                applicableRule.Value.Validate((CDP4Common.DTO.ReferenceSource)referenceSource);
            }
        }
        ...
        /// </returns>
        public bool TryValidate(CDP4Common.DTO.Thing referenceSource)
        {
            return this.TryValidate(referenceSource, x => true);
        }
        ...
        /// True if all validation rules have passed or if none are defined.
        /// </returns>
        public bool TryValidate(CDP4Common.DTO.Thing referenceSource, Func<string, bool> validateProperty)
        {
            var applicableValidationRules = this.validationRules.Where(x => validateProperty(x.Key)).Select(x => x.Value);

            return applicableValidationRules.All(applicableRule => applicableRule.TryValidate((CDP4Common.DTO.ReferenceSource)referenceSource));
        }

        /// <summary>
        /// Returns the containment property value for the supplied <see cref="CDP4Common.DTO.ReferenceSource"/>.
        /// </summary>
        /// <param name="referenceSource">
        /// The <see cref="CDP4Common.DTO.ReferenceSource"/> for which to return the containment property value.
        /// </param>
        ...
        /// If the property name is not supported for the <see cref="CDP4Common.DTO.ReferenceSource"/>.
        /// </exception>
        public IEnumerable<Guid> GetContainmentIds(CDP4Common.DTO.Thing referenceSource, string propertyName)
        {
            if (!this.containmentPropertyValueMap.ContainsKey(propertyName))
            {
                throw new ArgumentException(string.Format("'{0}' is not a valid containment property of 'ReferenceSource'", propertyName));
            }

            return this.containmentPropertyValueMap[propertyName]((CDP4Common.DTO.ReferenceSource)referenceSource);
        }

        /// <summary>
        /// Returns the ordered containment property value for the supplied <see cref="CDP4Common.DTO.ReferenceSource"/>.
        /// </summary>
        /// <param name="referenceSource">
        /// The <see cref="CDP4Common.DTO.ReferenceSource"/> for which to return the containment property value.
        /// </param>
        ...
        /// If the property name is not supported for the <see cref="CDP4Common.DTO.ReferenceSource"/>.
        /// </exception>
        public IEnumerable<OrderedItem> GetOrderedContainmentIds(CDP4Common.DTO.Thing referenceSource, string propertyName)
        {
            ...
            return this.orderedContainmentPropertyValueMap[propertyName]((CDP4Common.DTO.ReferenceSource)referenceSource);
        }
        ...
        /// <summary>
        /// Gets the <see cref="PropertyMetaInfo"/> for the <see cref="ReferenceSource"/> class
        /// </summary>
        ...
        private readonly Dictionary<string, Func<CDP4Common.DTO.ReferenceSource, object>> propertyValueMap = new Dictionary<string, Func<CDP4Common.DTO.ReferenceSource, object>>
        {
            ...
            { "Language", thing => thing.Language },
            { "ModifiedOn", thing => thing.ModifiedOn },
            { "Name", thing => thing.Name },
            { "PublicationYear", thing => thing.PublicationYear },
            { "PublishedIn", thing => thing.PublishedIn },
        ...
        private readonly Dictionary<string, PropertyMetaInfo> propertyTypeMap = new Dictionary<string, PropertyMetaInfo>
        {
            ...
            { "Language", new PropertyMetaInfo("Language", "string", PropertyKind.Scalar, AggregationKind.None, false, false, true, 0, "1", true) },
            ...
            { "PublicationYear", new PropertyMetaInfo("PublicationYear", "int", PropertyKind.Scalar, AggregationKind.None, false, false, true, 0, "1", true) },
            { "PublishedIn", new PropertyMetaInfo("PublishedIn", "ReferenceSource", PropertyKind.Scalar, AggregationKind.None, false, false, true, 0, "1", true) },
        ...
        private readonly Dictionary<string, Action<CDP4Common.DTO.ReferenceSource, object>> propertyValueAssignmentMap = new Dictionary<string, Action<CDP4Common.DTO.ReferenceSource, object>>
        {
            ...
            { "Language", (referenceSource, value) => referenceSource.Language = value == null ? (string)null : value.ToString() },
            { "ModifiedOn", (referenceSource, value) => referenceSource.ModifiedOn = (DateTime)value },
            { "Name", (referenceSource, value) => referenceSource.Name = value.ToString() },
            { "PublicationYear", (referenceSource, value) => referenceSource.PublicationYear = value == null ? (int?)null : (int)value },
        ...
        {
            { "ModelReferenceDataLibrary", new PropertyMetaInfo("ReferenceSource", "ReferenceSource", PropertyKind.List, AggregationKind.Composite, false, false, true, 0, "*", true) },
            { "SiteReferenceDataLibrary", new PropertyMetaInfo("ReferenceSource", "ReferenceSource", PropertyKind.List, AggregationKind.Composite, false, false, true, 0, "*", true) },
        };
        ...
        /// <summary>
        /// Returns the <see cref="CDP4Common.DTO.ReferenceSource"/> containment property type from the supplied property name.
        /// </summary>
        /// <param name="propertyName">
        ...
        /// <summary>
        /// Returns the <see cref="CDP4Common.DTO.ReferenceSource"/> property type from the supplied property name.
        /// </summary>
        /// <param name="propertyName">
        /// The property name.
        /// </param>
        ...
        /// <summary>
        /// Returns the container property for the supplied type name is a possible container for <see cref="CDP4Common.DTO.ReferenceSource"/>.
        /// </summary>
        /// <param name="typeName">
        /// Name of the type for which to check if it is a container of <see cref="CDP4Common.DTO.ReferenceSource"/>.
        /// </param>
        /// <param name="containerProperty">
        /// Supplied container property info instance that will be set if the supplied type name is a container of <see cref="CDP4Common.DTO.ReferenceSource"/>.
        /// </param>
        /// <returns>
        /// True if the supplied typeName is a container for <see cref="CDP4Common.DTO.ReferenceSource"/> and sets the container property name.
        /// </returns>
        ...
        /// <summary>
        /// Check if the supplied property name for <see cref="CDP4Common.DTO.ReferenceSource"/> is scalar.
        /// </summary>
        /// <param name="propertyName">
        /// Name of the property for which to check if it is scalar.
        /// </param>
        ...
        public bool ApplyPropertyUpdate(CDP4Common.DTO.Thing updatableThing, string propertyName, object value)
        {
            ...
            this.propertyValueAssignmentMap[propertyName]((CDP4Common.DTO.ReferenceSource)updatableThing, value);
        ...
        public object DeserializeCollectionValue(string propertyName, object value)
        {
            ...
            {
                throw new ArgumentException(string.Format("'{0}' is not a valid collection property of 'ReferenceSource'", propertyName));
            }
        ...
        public object GetValue(string propertyName, CDP4Common.DTO.Thing thing)
        {
            ...
            return this.propertyValueMap[propertyName]((CDP4Common.DTO.ReferenceSource)thing);
        }
        ...
        /// <summary>
        /// Instantiates a <see cref="CDP4Common.DTO.ReferenceSource"/>
        /// </summary>
        /// <returns>
        ...
        {
            return new CDP4Common.DTO.ReferenceSource(guid, revisionNumber);
        }
    }
}
