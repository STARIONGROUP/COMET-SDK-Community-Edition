...
namespace CDP4Common.MetaInfo
{
    ...
    public partial class ReferenceSourceMetaInfo : IReferenceSourceMetaInfo
    {
        ...
        public IEnumerable<Guid> GetContainmentIds(CDP4Common.DTO.Thing referenceSource, string propertyName)
        {
            ...
            {
                throw new ArgumentException($"'{propertyName}' is not a valid containment property of 'ReferenceSource'");
            }
        ...
        public object DeserializeCollectionValue(string propertyName, object value)
        {
            ...
            {
                throw new ArgumentException($"'{propertyName}' is not a valid collection property of 'ReferenceSource'");
            }
