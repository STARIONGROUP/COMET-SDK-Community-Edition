// --------------------------------------------------------------------------------------------------------------------
// <copyright file="MeasurementScaleMetaInfo.cs" company="RHEA System S.A.">
...
namespace CDP4Common.MetaInfo
{
    ...
    /// <summary>
    /// This a class that holds meta info for <see cref="MeasurementScale"/>.
    /// </summary>
    public partial class MeasurementScaleMetaInfo : IMeasurementScaleMetaInfo
    {
        /// <summary>
        /// The containment property value map.
        /// </summary>
        private readonly Dictionary<string, Func<CDP4Common.DTO.MeasurementScale, IEnumerable<Guid>>> containmentPropertyValueMap = new Dictionary<string, Func<CDP4Common.DTO.MeasurementScale, IEnumerable<Guid>>>
        {
            { "Alias", measurementScale => measurementScale.Alias },
            { "Attachment", measurementScale => measurementScale.Attachment },
            { "Definition", measurementScale => measurementScale.Definition },
            { "HyperLink", measurementScale => measurementScale.HyperLink },
            { "MappingToReferenceScale", measurementScale => measurementScale.MappingToReferenceScale },
            { "ValueDefinition", measurementScale => measurementScale.ValueDefinition },
        };

        /// <summary>
        /// The ordered containment property value map.
        /// </summary>
        private readonly Dictionary<string, Func<CDP4Common.DTO.MeasurementScale, IEnumerable<OrderedItem>>> orderedContainmentPropertyValueMap = new Dictionary<string, Func<CDP4Common.DTO.MeasurementScale, IEnumerable<OrderedItem>>>();

        /// <summary>
        /// The validation rules that should pass for an instance of <see cref="CDP4Common.DTO.MeasurementScale"/>.
        /// </summary>
        private readonly Dictionary<string, DtoValidationHelper<CDP4Common.DTO.MeasurementScale>> validationRules = new Dictionary<string, DtoValidationHelper<CDP4Common.DTO.MeasurementScale>>
        {
            { "Alias", new DtoValidationHelper<CDP4Common.DTO.MeasurementScale>(item => item.Alias != null, "The 'Alias' property of a 'MeasurementScale' is mandatory and cannot be null.") },
            { "Attachment", new DtoValidationHelper<CDP4Common.DTO.MeasurementScale>(item => item.Attachment != null, "The 'Attachment' property of a 'MeasurementScale' is mandatory and cannot be null.") },
            { "Definition", new DtoValidationHelper<CDP4Common.DTO.MeasurementScale>(item => item.Definition != null, "The 'Definition' property of a 'MeasurementScale' is mandatory and cannot be null.") },
            { "ExcludedDomain", new DtoValidationHelper<CDP4Common.DTO.MeasurementScale>(item => item.ExcludedDomain != null, "The 'ExcludedDomain' property of a 'MeasurementScale' is mandatory and cannot be null.") },
            { "ExcludedPerson", new DtoValidationHelper<CDP4Common.DTO.MeasurementScale>(item => item.ExcludedPerson != null, "The 'ExcludedPerson' property of a 'MeasurementScale' is mandatory and cannot be null.") },
            { "HyperLink", new DtoValidationHelper<CDP4Common.DTO.MeasurementScale>(item => item.HyperLink != null, "The 'HyperLink' property of a 'MeasurementScale' is mandatory and cannot be null.") },
            { "MappingToReferenceScale", new DtoValidationHelper<CDP4Common.DTO.MeasurementScale>(item => item.MappingToReferenceScale != null, "The 'MappingToReferenceScale' property of a 'MeasurementScale' is mandatory and cannot be null.") },
            { "Name", new DtoValidationHelper<CDP4Common.DTO.MeasurementScale>(item => !string.IsNullOrWhiteSpace(item.Name), "The 'Name' property of a 'MeasurementScale' is mandatory and cannot be empty or null.") },
            { "ShortName", new DtoValidationHelper<CDP4Common.DTO.MeasurementScale>(item => !string.IsNullOrWhiteSpace(item.ShortName), "The 'ShortName' property of a 'MeasurementScale' is mandatory and cannot be empty or null.") },
            { "ValueDefinition", new DtoValidationHelper<CDP4Common.DTO.MeasurementScale>(item => item.ValueDefinition != null, "The 'ValueDefinition' property of a 'MeasurementScale' is mandatory and cannot be null.") },
        };
        ...
        /// </exception>
        public void Validate(CDP4Common.DTO.Thing measurementScale)
        {
            this.Validate(measurementScale, x => true);
        }
        ...
        /// If any validation rule failed.
        /// </exception>
        public void Validate(CDP4Common.DTO.Thing measurementScale, Func<string, bool> validateProperty)
        {
            foreach (var applicableRule in this.validationRules.Where(x => validateProperty(x.Key)))
            {
                applicableRule.Value.Validate((CDP4Common.DTO.MeasurementScale)measurementScale);
            }
        }
        ...
        /// </returns>
        public bool TryValidate(CDP4Common.DTO.Thing measurementScale)
        {
            return this.TryValidate(measurementScale, x => true);
        }
        ...
        /// True if all validation rules have passed or if none are defined.
        /// </returns>
        public bool TryValidate(CDP4Common.DTO.Thing measurementScale, Func<string, bool> validateProperty)
        {
            var applicableValidationRules = this.validationRules.Where(x => validateProperty(x.Key)).Select(x => x.Value);

            return applicableValidationRules.All(applicableRule => applicableRule.TryValidate((CDP4Common.DTO.MeasurementScale)measurementScale));
        }

        /// <summary>
        /// Returns the containment property value for the supplied <see cref="CDP4Common.DTO.MeasurementScale"/>.
        /// </summary>
        /// <param name="measurementScale">
        /// The <see cref="CDP4Common.DTO.MeasurementScale"/> for which to return the containment property value.
        /// </param>
        ...
        /// If the property name is not supported for the <see cref="CDP4Common.DTO.MeasurementScale"/>.
        /// </exception>
        public IEnumerable<Guid> GetContainmentIds(CDP4Common.DTO.Thing measurementScale, string propertyName)
        {
            if (!this.containmentPropertyValueMap.ContainsKey(propertyName))
            {
                throw new ArgumentException($"'{propertyName}' is not a valid containment property of 'MeasurementScale'");
            }

            return this.containmentPropertyValueMap[propertyName]((CDP4Common.DTO.MeasurementScale)measurementScale);
        }

        /// <summary>
        /// Returns the ordered containment property value for the supplied <see cref="CDP4Common.DTO.MeasurementScale"/>.
        /// </summary>
        /// <param name="measurementScale">
        /// The <see cref="CDP4Common.DTO.MeasurementScale"/> for which to return the containment property value.
        /// </param>
        ...
        /// If the property name is not supported for the <see cref="CDP4Common.DTO.MeasurementScale"/>.
        /// </exception>
        public IEnumerable<OrderedItem> GetOrderedContainmentIds(CDP4Common.DTO.Thing measurementScale, string propertyName)
        {
            ...
            return this.orderedContainmentPropertyValueMap[propertyName]((CDP4Common.DTO.MeasurementScale)measurementScale);
        }
        ...
        /// <summary>
        /// Gets the <see cref="PropertyMetaInfo"/> for the <see cref="MeasurementScale"/> class
        /// </summary>
        ...
        /// </summary>
        private readonly Dictionary<string, Func<CDP4Common.DTO.MeasurementScale, object>> propertyValueMap = new Dictionary<string, Func<CDP4Common.DTO.MeasurementScale, object>>
        {
        ...
        /// </summary>
        private readonly Dictionary<string, Action<CDP4Common.DTO.MeasurementScale, object>> propertyValueAssignmentMap = new Dictionary<string, Action<CDP4Common.DTO.MeasurementScale, object>>
        {
            { "Actor", (measurementScale, value) => measurementScale.Actor = value == null ? (Guid?)null : (Guid)value },
            { "Iid", (measurementScale, value) => measurementScale.Iid = (Guid)value },
            { "IsDeprecated", (measurementScale, value) => measurementScale.IsDeprecated = (bool)value },
            { "IsMaximumInclusive", (measurementScale, value) => measurementScale.IsMaximumInclusive = (bool)value },
            { "IsMinimumInclusive", (measurementScale, value) => measurementScale.IsMinimumInclusive = (bool)value },
            { "MaximumPermissibleValue", (measurementScale, value) => measurementScale.MaximumPermissibleValue = value == null ? (string)null : value.ToString() },
            { "MinimumPermissibleValue", (measurementScale, value) => measurementScale.MinimumPermissibleValue = value == null ? (string)null : value.ToString() },
            { "ModifiedOn", (measurementScale, value) => measurementScale.ModifiedOn = (DateTime)value },
            { "Name", (measurementScale, value) => measurementScale.Name = value.ToString() },
            { "NegativeValueConnotation", (measurementScale, value) => measurementScale.NegativeValueConnotation = value == null ? (string)null : value.ToString() },
            { "NumberSet", (measurementScale, value) => measurementScale.NumberSet = (NumberSetKind)value },
            { "PositiveValueConnotation", (measurementScale, value) => measurementScale.PositiveValueConnotation = value == null ? (string)null : value.ToString() },
            { "ShortName", (measurementScale, value) => measurementScale.ShortName = value.ToString() },
            { "ThingPreference", (measurementScale, value) => measurementScale.ThingPreference = value == null ? (string)null : value.ToString() },
            { "Unit", (measurementScale, value) => measurementScale.Unit = (Guid)value },
        };
        ...
        /// <summary>
        /// Returns the <see cref="CDP4Common.DTO.MeasurementScale"/> containment property type from the supplied property name.
        /// </summary>
        /// <param name="propertyName">
        ...
        /// <summary>
        /// Returns the <see cref="CDP4Common.DTO.MeasurementScale"/> property type from the supplied property name.
        /// </summary>
        /// <param name="propertyName">
        /// The property name.
        /// </param>
        ...
        /// <summary>
        /// Returns the container property for the supplied type name is a possible container for <see cref="CDP4Common.DTO.MeasurementScale"/>.
        /// </summary>
        /// <param name="typeName">
        /// Name of the type for which to check if it is a container of <see cref="CDP4Common.DTO.MeasurementScale"/>.
        /// </param>
        /// <param name="containerProperty">
        /// Supplied container property info instance that will be set if the supplied type name is a container of <see cref="CDP4Common.DTO.MeasurementScale"/>.
        /// </param>
        /// <returns>
        /// True if the supplied typeName is a container for <see cref="CDP4Common.DTO.MeasurementScale"/> and sets the container property name.
        /// </returns>
        ...
        /// <summary>
        /// Check if the supplied property name for <see cref="CDP4Common.DTO.MeasurementScale"/> is scalar.
        /// </summary>
        /// <param name="propertyName">
        /// Name of the property for which to check if it is scalar.
        /// </param>
        ...
        public bool ApplyPropertyUpdate(CDP4Common.DTO.Thing updatableThing, string propertyName, object value)
        {
            ...
            this.propertyValueAssignmentMap[propertyName]((CDP4Common.DTO.MeasurementScale)updatableThing, value);
        ...
        public object DeserializeCollectionValue(string propertyName, object value)
        {
            ...
            {
                throw new ArgumentException($"'{propertyName}' is not a valid collection property of 'MeasurementScale'");
            }
        ...
        public object GetValue(string propertyName, CDP4Common.DTO.Thing thing)
        {
            ...
            return this.propertyValueMap[propertyName]((CDP4Common.DTO.MeasurementScale)thing);
        }
        ...
        /// <summary>
        /// Instantiates a <see cref="CDP4Common.DTO.MeasurementScale"/>
        /// </summary>
        /// <returns>
