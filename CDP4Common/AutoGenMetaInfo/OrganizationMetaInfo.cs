// --------------------------------------------------------------------------------------------------------------------
// <copyright file="OrganizationMetaInfo.cs" company="Starion Group S.A.">
...
namespace CDP4Common.MetaInfo
{
    ...
    /// <summary>
    /// This a class that holds meta info for <see cref="Organization"/>.
    /// </summary>
    public partial class OrganizationMetaInfo : IOrganizationMetaInfo
    {
        /// <summary>
        /// The containment property value map.
        /// </summary>
        private readonly Dictionary<string, Func<CDP4Common.DTO.Organization, IEnumerable<Guid>>> containmentPropertyValueMap = new Dictionary<string, Func<CDP4Common.DTO.Organization, IEnumerable<Guid>>>();

        /// <summary>
        /// The ordered containment property value map.
        /// </summary>
        private readonly Dictionary<string, Func<CDP4Common.DTO.Organization, IEnumerable<OrderedItem>>> orderedContainmentPropertyValueMap = new Dictionary<string, Func<CDP4Common.DTO.Organization, IEnumerable<OrderedItem>>>();

        /// <summary>
        /// The validation rules that should pass for an instance of <see cref="CDP4Common.DTO.Organization"/>.
        /// </summary>
        private readonly Dictionary<string, DtoValidationHelper<CDP4Common.DTO.Organization>> validationRules = new Dictionary<string, DtoValidationHelper<CDP4Common.DTO.Organization>>
        {
            { "ExcludedDomain", new DtoValidationHelper<CDP4Common.DTO.Organization>(item => item.ExcludedDomain != null, "The 'ExcludedDomain' property of a 'Organization' is mandatory and cannot be null.") },
            { "ExcludedPerson", new DtoValidationHelper<CDP4Common.DTO.Organization>(item => item.ExcludedPerson != null, "The 'ExcludedPerson' property of a 'Organization' is mandatory and cannot be null.") },
            { "Name", new DtoValidationHelper<CDP4Common.DTO.Organization>(item => !string.IsNullOrWhiteSpace(item.Name), "The 'Name' property of a 'Organization' is mandatory and cannot be empty or null.") },
            { "ShortName", new DtoValidationHelper<CDP4Common.DTO.Organization>(item => !string.IsNullOrWhiteSpace(item.ShortName), "The 'ShortName' property of a 'Organization' is mandatory and cannot be empty or null.") },
        };
        ...
        /// </exception>
        public void Validate(CDP4Common.DTO.Thing organization)
        {
            this.Validate(organization, x => true);
        }
        ...
        /// If any validation rule failed.
        /// </exception>
        public void Validate(CDP4Common.DTO.Thing organization, Func<string, bool> validateProperty)
        {
            foreach (var applicableRule in this.validationRules.Where(x => validateProperty(x.Key)))
            {
                applicableRule.Value.Validate((CDP4Common.DTO.Organization)organization);
            }
        }
        ...
        /// </returns>
        public bool TryValidate(CDP4Common.DTO.Thing organization)
        {
            return this.TryValidate(organization, x => true);
        }
        ...
        /// True if all validation rules have passed or if none are defined.
        /// </returns>
        public bool TryValidate(CDP4Common.DTO.Thing organization, Func<string, bool> validateProperty)
        {
            var applicableValidationRules = this.validationRules.Where(x => validateProperty(x.Key)).Select(x => x.Value);

            return applicableValidationRules.All(applicableRule => applicableRule.TryValidate((CDP4Common.DTO.Organization)organization));
        }

        /// <summary>
        /// Returns the containment property value for the supplied <see cref="CDP4Common.DTO.Organization"/>.
        /// </summary>
        /// <param name="organization">
        /// The <see cref="CDP4Common.DTO.Organization"/> for which to return the containment property value.
        /// </param>
        ...
        /// If the property name is not supported for the <see cref="CDP4Common.DTO.Organization"/>.
        /// </exception>
        public IEnumerable<Guid> GetContainmentIds(CDP4Common.DTO.Thing organization, string propertyName)
        {
            if (!this.containmentPropertyValueMap.ContainsKey(propertyName))
            {
                throw new ArgumentException($"'{propertyName}' is not a valid containment property of 'Organization'");
            }

            return this.containmentPropertyValueMap[propertyName]((CDP4Common.DTO.Organization)organization);
        }

        /// <summary>
        /// Returns the ordered containment property value for the supplied <see cref="CDP4Common.DTO.Organization"/>.
        /// </summary>
        /// <param name="organization">
        /// The <see cref="CDP4Common.DTO.Organization"/> for which to return the containment property value.
        /// </param>
        ...
        /// If the property name is not supported for the <see cref="CDP4Common.DTO.Organization"/>.
        /// </exception>
        public IEnumerable<OrderedItem> GetOrderedContainmentIds(CDP4Common.DTO.Thing organization, string propertyName)
        {
            ...
            return this.orderedContainmentPropertyValueMap[propertyName]((CDP4Common.DTO.Organization)organization);
        }
        ...
        /// <summary>
        /// Gets the <see cref="PropertyMetaInfo"/> for the <see cref="Organization"/> class
        /// </summary>
        ...
        /// </summary>
        private readonly Dictionary<string, Func<CDP4Common.DTO.Organization, object>> propertyValueMap = new Dictionary<string, Func<CDP4Common.DTO.Organization, object>>
        {
        ...
        /// </summary>
        private readonly Dictionary<string, Action<CDP4Common.DTO.Organization, object>> propertyValueAssignmentMap = new Dictionary<string, Action<CDP4Common.DTO.Organization, object>>
        {
            { "Actor", (organization, value) => organization.Actor = value == null ? (Guid?)null : (Guid)value },
            { "Iid", (organization, value) => organization.Iid = (Guid)value },
            { "IsDeprecated", (organization, value) => organization.IsDeprecated = (bool)value },
            { "ModifiedOn", (organization, value) => organization.ModifiedOn = (DateTime)value },
            { "Name", (organization, value) => organization.Name = value.ToString() },
            { "ShortName", (organization, value) => organization.ShortName = value.ToString() },
            { "ThingPreference", (organization, value) => organization.ThingPreference = value == null ? (string)null : value.ToString() },
        };
        ...
        {
            { "SiteDirectory", new PropertyMetaInfo("Organization", "Organization", PropertyKind.List, AggregationKind.Composite, false, false, true, 0, "*", true) },
        };
        ...
        /// <summary>
        /// Returns the <see cref="CDP4Common.DTO.Organization"/> containment property type from the supplied property name.
        /// </summary>
        /// <param name="propertyName">
        ...
        /// <summary>
        /// Returns the <see cref="CDP4Common.DTO.Organization"/> property type from the supplied property name.
        /// </summary>
        /// <param name="propertyName">
        /// The property name.
        /// </param>
        ...
        /// <summary>
        /// Returns the container property for the supplied type name is a possible container for <see cref="CDP4Common.DTO.Organization"/>.
        /// </summary>
        /// <param name="typeName">
        /// Name of the type for which to check if it is a container of <see cref="CDP4Common.DTO.Organization"/>.
        /// </param>
        /// <param name="containerProperty">
        /// Supplied container property info instance that will be set if the supplied type name is a container of <see cref="CDP4Common.DTO.Organization"/>.
        /// </param>
        /// <returns>
        /// True if the supplied typeName is a container for <see cref="CDP4Common.DTO.Organization"/> and sets the container property name.
        /// </returns>
        ...
        /// <summary>
        /// Check if the supplied property name for <see cref="CDP4Common.DTO.Organization"/> is scalar.
        /// </summary>
        /// <param name="propertyName">
        /// Name of the property for which to check if it is scalar.
        /// </param>
        ...
        public bool ApplyPropertyUpdate(CDP4Common.DTO.Thing updatableThing, string propertyName, object value)
        {
            ...
            this.propertyValueAssignmentMap[propertyName]((CDP4Common.DTO.Organization)updatableThing, value);
        ...
        public object DeserializeCollectionValue(string propertyName, object value)
        {
            ...
            {
                throw new ArgumentException($"'{propertyName}' is not a valid collection property of 'Organization'");
            }
        ...
        public object GetValue(string propertyName, CDP4Common.DTO.Thing thing)
        {
            ...
            return this.propertyValueMap[propertyName]((CDP4Common.DTO.Organization)thing);
        }
        ...
        /// <summary>
        /// Instantiates a <see cref="CDP4Common.DTO.Organization"/>
        /// </summary>
        /// <returns>
        ...
        {
            return new CDP4Common.DTO.Organization(guid, revisionNumber);
        }
    }
}
