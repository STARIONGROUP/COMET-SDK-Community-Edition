// --------------------------------------------------------------------------------------------------------------------
// <copyright file="SimpleUnitMetaInfo.cs" company="RHEA System S.A.">
...
namespace CDP4Common.MetaInfo
{
    ...
    /// <summary>
    /// This a class that holds meta info for <see cref="SimpleUnit"/>.
    /// </summary>
    public partial class SimpleUnitMetaInfo : ISimpleUnitMetaInfo
    {
        /// <summary>
        /// The containment property value map.
        /// </summary>
        private readonly Dictionary<string, Func<CDP4Common.DTO.SimpleUnit, IEnumerable<Guid>>> containmentPropertyValueMap = new Dictionary<string, Func<CDP4Common.DTO.SimpleUnit, IEnumerable<Guid>>>
        {
            { "Alias", simpleUnit => simpleUnit.Alias },
            { "Attachment", simpleUnit => simpleUnit.Attachment },
            { "Definition", simpleUnit => simpleUnit.Definition },
            { "HyperLink", simpleUnit => simpleUnit.HyperLink },
        };

        /// <summary>
        /// The ordered containment property value map.
        /// </summary>
        private readonly Dictionary<string, Func<CDP4Common.DTO.SimpleUnit, IEnumerable<OrderedItem>>> orderedContainmentPropertyValueMap = new Dictionary<string, Func<CDP4Common.DTO.SimpleUnit, IEnumerable<OrderedItem>>>();

        /// <summary>
        /// The validation rules that should pass for an instance of <see cref="CDP4Common.DTO.SimpleUnit"/>.
        /// </summary>
        private readonly Dictionary<string, DtoValidationHelper<CDP4Common.DTO.SimpleUnit>> validationRules = new Dictionary<string, DtoValidationHelper<CDP4Common.DTO.SimpleUnit>>
        {
            { "Alias", new DtoValidationHelper<CDP4Common.DTO.SimpleUnit>(item => item.Alias != null, "The 'Alias' property of a 'SimpleUnit' is mandatory and cannot be null.") },
            { "Attachment", new DtoValidationHelper<CDP4Common.DTO.SimpleUnit>(item => item.Attachment != null, "The 'Attachment' property of a 'SimpleUnit' is mandatory and cannot be null.") },
            { "Definition", new DtoValidationHelper<CDP4Common.DTO.SimpleUnit>(item => item.Definition != null, "The 'Definition' property of a 'SimpleUnit' is mandatory and cannot be null.") },
            { "ExcludedDomain", new DtoValidationHelper<CDP4Common.DTO.SimpleUnit>(item => item.ExcludedDomain != null, "The 'ExcludedDomain' property of a 'SimpleUnit' is mandatory and cannot be null.") },
            { "ExcludedPerson", new DtoValidationHelper<CDP4Common.DTO.SimpleUnit>(item => item.ExcludedPerson != null, "The 'ExcludedPerson' property of a 'SimpleUnit' is mandatory and cannot be null.") },
            { "HyperLink", new DtoValidationHelper<CDP4Common.DTO.SimpleUnit>(item => item.HyperLink != null, "The 'HyperLink' property of a 'SimpleUnit' is mandatory and cannot be null.") },
            { "Name", new DtoValidationHelper<CDP4Common.DTO.SimpleUnit>(item => !string.IsNullOrWhiteSpace(item.Name), "The 'Name' property of a 'SimpleUnit' is mandatory and cannot be empty or null.") },
            { "ShortName", new DtoValidationHelper<CDP4Common.DTO.SimpleUnit>(item => !string.IsNullOrWhiteSpace(item.ShortName), "The 'ShortName' property of a 'SimpleUnit' is mandatory and cannot be empty or null.") },
        };
        ...
        /// </exception>
        public void Validate(CDP4Common.DTO.Thing simpleUnit)
        {
            this.Validate(simpleUnit, x => true);
        }
        ...
        /// If any validation rule failed.
        /// </exception>
        public void Validate(CDP4Common.DTO.Thing simpleUnit, Func<string, bool> validateProperty)
        {
            foreach (var applicableRule in this.validationRules.Where(x => validateProperty(x.Key)))
            {
                applicableRule.Value.Validate((CDP4Common.DTO.SimpleUnit)simpleUnit);
            }
        }
        ...
        /// </returns>
        public bool TryValidate(CDP4Common.DTO.Thing simpleUnit)
        {
            return this.TryValidate(simpleUnit, x => true);
        }
        ...
        /// True if all validation rules have passed or if none are defined.
        /// </returns>
        public bool TryValidate(CDP4Common.DTO.Thing simpleUnit, Func<string, bool> validateProperty)
        {
            var applicableValidationRules = this.validationRules.Where(x => validateProperty(x.Key)).Select(x => x.Value);

            return applicableValidationRules.All(applicableRule => applicableRule.TryValidate((CDP4Common.DTO.SimpleUnit)simpleUnit));
        }

        /// <summary>
        /// Returns the containment property value for the supplied <see cref="CDP4Common.DTO.SimpleUnit"/>.
        /// </summary>
        /// <param name="simpleUnit">
        /// The <see cref="CDP4Common.DTO.SimpleUnit"/> for which to return the containment property value.
        /// </param>
        ...
        /// If the property name is not supported for the <see cref="CDP4Common.DTO.SimpleUnit"/>.
        /// </exception>
        public IEnumerable<Guid> GetContainmentIds(CDP4Common.DTO.Thing simpleUnit, string propertyName)
        {
            if (!this.containmentPropertyValueMap.ContainsKey(propertyName))
            {
                throw new ArgumentException($"'{propertyName}' is not a valid containment property of 'SimpleUnit'");
            }

            return this.containmentPropertyValueMap[propertyName]((CDP4Common.DTO.SimpleUnit)simpleUnit);
        }

        /// <summary>
        /// Returns the ordered containment property value for the supplied <see cref="CDP4Common.DTO.SimpleUnit"/>.
        /// </summary>
        /// <param name="simpleUnit">
        /// The <see cref="CDP4Common.DTO.SimpleUnit"/> for which to return the containment property value.
        /// </param>
        ...
        /// If the property name is not supported for the <see cref="CDP4Common.DTO.SimpleUnit"/>.
        /// </exception>
        public IEnumerable<OrderedItem> GetOrderedContainmentIds(CDP4Common.DTO.Thing simpleUnit, string propertyName)
        {
            ...
            return this.orderedContainmentPropertyValueMap[propertyName]((CDP4Common.DTO.SimpleUnit)simpleUnit);
        }
        ...
        /// <summary>
        /// Gets the <see cref="PropertyMetaInfo"/> for the <see cref="SimpleUnit"/> class
        /// </summary>
        ...
        /// </summary>
        private readonly Dictionary<string, Func<CDP4Common.DTO.SimpleUnit, object>> propertyValueMap = new Dictionary<string, Func<CDP4Common.DTO.SimpleUnit, object>>
        {
        ...
        /// </summary>
        private readonly Dictionary<string, Action<CDP4Common.DTO.SimpleUnit, object>> propertyValueAssignmentMap = new Dictionary<string, Action<CDP4Common.DTO.SimpleUnit, object>>
        {
            { "Actor", (simpleUnit, value) => simpleUnit.Actor = value == null ? (Guid?)null : (Guid)value },
            { "Iid", (simpleUnit, value) => simpleUnit.Iid = (Guid)value },
            { "IsDeprecated", (simpleUnit, value) => simpleUnit.IsDeprecated = (bool)value },
            { "ModifiedOn", (simpleUnit, value) => simpleUnit.ModifiedOn = (DateTime)value },
            { "Name", (simpleUnit, value) => simpleUnit.Name = value.ToString() },
            { "ShortName", (simpleUnit, value) => simpleUnit.ShortName = value.ToString() },
            { "ThingPreference", (simpleUnit, value) => simpleUnit.ThingPreference = value == null ? (string)null : value.ToString() },
        };
        ...
        /// <summary>
        /// Returns the <see cref="CDP4Common.DTO.SimpleUnit"/> containment property type from the supplied property name.
        /// </summary>
        /// <param name="propertyName">
        ...
        /// <summary>
        /// Returns the <see cref="CDP4Common.DTO.SimpleUnit"/> property type from the supplied property name.
        /// </summary>
        /// <param name="propertyName">
        /// The property name.
        /// </param>
        ...
        /// <summary>
        /// Returns the container property for the supplied type name is a possible container for <see cref="CDP4Common.DTO.SimpleUnit"/>.
        /// </summary>
        /// <param name="typeName">
        /// Name of the type for which to check if it is a container of <see cref="CDP4Common.DTO.SimpleUnit"/>.
        /// </param>
        /// <param name="containerProperty">
        /// Supplied container property info instance that will be set if the supplied type name is a container of <see cref="CDP4Common.DTO.SimpleUnit"/>.
        /// </param>
        /// <returns>
        /// True if the supplied typeName is a container for <see cref="CDP4Common.DTO.SimpleUnit"/> and sets the container property name.
        /// </returns>
        ...
        /// <summary>
        /// Check if the supplied property name for <see cref="CDP4Common.DTO.SimpleUnit"/> is scalar.
        /// </summary>
        /// <param name="propertyName">
        /// Name of the property for which to check if it is scalar.
        /// </param>
        ...
        public bool ApplyPropertyUpdate(CDP4Common.DTO.Thing updatableThing, string propertyName, object value)
        {
            ...
            this.propertyValueAssignmentMap[propertyName]((CDP4Common.DTO.SimpleUnit)updatableThing, value);
        ...
        public object DeserializeCollectionValue(string propertyName, object value)
        {
            ...
            {
                throw new ArgumentException($"'{propertyName}' is not a valid collection property of 'SimpleUnit'");
            }
        ...
        public object GetValue(string propertyName, CDP4Common.DTO.Thing thing)
        {
            ...
            return this.propertyValueMap[propertyName]((CDP4Common.DTO.SimpleUnit)thing);
        }
        ...
        /// <summary>
        /// Instantiates a <see cref="CDP4Common.DTO.SimpleUnit"/>
        /// </summary>
        /// <returns>
        ...
        {
            return new CDP4Common.DTO.SimpleUnit(guid, revisionNumber);
        }
    }
}
