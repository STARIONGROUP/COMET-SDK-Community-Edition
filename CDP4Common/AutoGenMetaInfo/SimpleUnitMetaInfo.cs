...
namespace CDP4Common.MetaInfo
{
    ...
    public partial class SimpleUnitMetaInfo : ISimpleUnitMetaInfo
    {
        ...
        public IEnumerable<Guid> GetContainmentIds(CDP4Common.DTO.Thing simpleUnit, string propertyName)
        {
            ...
            {
                throw new ArgumentException(string.Format("'{0}' is not a valid containment property of 'SimpleUnit'", propertyName));
            }
        ...
        public object DeserializeCollectionValue(string propertyName, object value)
        {
            ...
            {
                throw new ArgumentException(string.Format("'{0}' is not a valid collection property of 'SimpleUnit'", propertyName));
            }
