...
namespace CDP4Common.MetaInfo
{
    ...
    public partial class SimpleParameterizableThingMetaInfo : ISimpleParameterizableThingMetaInfo
    {
        ...
        public IEnumerable<Guid> GetContainmentIds(CDP4Common.DTO.Thing simpleParameterizableThing, string propertyName)
        {
            ...
            {
                throw new ArgumentException($"'{propertyName}' is not a valid containment property of 'SimpleParameterizableThing'");
            }
        ...
        public object DeserializeCollectionValue(string propertyName, object value)
        {
            ...
            {
                throw new ArgumentException($"'{propertyName}' is not a valid collection property of 'SimpleParameterizableThing'");
            }
