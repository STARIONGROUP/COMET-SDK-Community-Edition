// --------------------------------------------------------------------------------------------------------------------
// <copyright file="SimpleParameterizableThingMetaInfo.cs" company="RHEA System S.A.">
...
namespace CDP4Common.MetaInfo
{
    ...
    /// <summary>
    /// This a class that holds meta info for <see cref="SimpleParameterizableThing"/>.
    /// </summary>
    public partial class SimpleParameterizableThingMetaInfo : ISimpleParameterizableThingMetaInfo
    {
        /// <summary>
        /// The containment property value map.
        /// </summary>
        private readonly Dictionary<string, Func<CDP4Common.DTO.SimpleParameterizableThing, IEnumerable<Guid>>> containmentPropertyValueMap = new Dictionary<string, Func<CDP4Common.DTO.SimpleParameterizableThing, IEnumerable<Guid>>>
        {
            { "Alias", simpleParameterizableThing => simpleParameterizableThing.Alias },
            { "Attachment", simpleParameterizableThing => simpleParameterizableThing.Attachment },
            { "Definition", simpleParameterizableThing => simpleParameterizableThing.Definition },
            { "HyperLink", simpleParameterizableThing => simpleParameterizableThing.HyperLink },
            { "ParameterValue", simpleParameterizableThing => simpleParameterizableThing.ParameterValue },
        };

        /// <summary>
        /// The ordered containment property value map.
        /// </summary>
        private readonly Dictionary<string, Func<CDP4Common.DTO.SimpleParameterizableThing, IEnumerable<OrderedItem>>> orderedContainmentPropertyValueMap = new Dictionary<string, Func<CDP4Common.DTO.SimpleParameterizableThing, IEnumerable<OrderedItem>>>();

        /// <summary>
        /// The validation rules that should pass for an instance of <see cref="CDP4Common.DTO.SimpleParameterizableThing"/>.
        /// </summary>
        private readonly Dictionary<string, DtoValidationHelper<CDP4Common.DTO.SimpleParameterizableThing>> validationRules = new Dictionary<string, DtoValidationHelper<CDP4Common.DTO.SimpleParameterizableThing>>
        {
            { "Alias", new DtoValidationHelper<CDP4Common.DTO.SimpleParameterizableThing>(item => item.Alias != null, "The 'Alias' property of a 'SimpleParameterizableThing' is mandatory and cannot be null.") },
            { "Attachment", new DtoValidationHelper<CDP4Common.DTO.SimpleParameterizableThing>(item => item.Attachment != null, "The 'Attachment' property of a 'SimpleParameterizableThing' is mandatory and cannot be null.") },
            { "Definition", new DtoValidationHelper<CDP4Common.DTO.SimpleParameterizableThing>(item => item.Definition != null, "The 'Definition' property of a 'SimpleParameterizableThing' is mandatory and cannot be null.") },
            { "ExcludedDomain", new DtoValidationHelper<CDP4Common.DTO.SimpleParameterizableThing>(item => item.ExcludedDomain != null, "The 'ExcludedDomain' property of a 'SimpleParameterizableThing' is mandatory and cannot be null.") },
            { "ExcludedPerson", new DtoValidationHelper<CDP4Common.DTO.SimpleParameterizableThing>(item => item.ExcludedPerson != null, "The 'ExcludedPerson' property of a 'SimpleParameterizableThing' is mandatory and cannot be null.") },
            { "HyperLink", new DtoValidationHelper<CDP4Common.DTO.SimpleParameterizableThing>(item => item.HyperLink != null, "The 'HyperLink' property of a 'SimpleParameterizableThing' is mandatory and cannot be null.") },
            { "Name", new DtoValidationHelper<CDP4Common.DTO.SimpleParameterizableThing>(item => !string.IsNullOrWhiteSpace(item.Name), "The 'Name' property of a 'SimpleParameterizableThing' is mandatory and cannot be empty or null.") },
            { "ParameterValue", new DtoValidationHelper<CDP4Common.DTO.SimpleParameterizableThing>(item => item.ParameterValue != null, "The 'ParameterValue' property of a 'SimpleParameterizableThing' is mandatory and cannot be null.") },
            { "ShortName", new DtoValidationHelper<CDP4Common.DTO.SimpleParameterizableThing>(item => !string.IsNullOrWhiteSpace(item.ShortName), "The 'ShortName' property of a 'SimpleParameterizableThing' is mandatory and cannot be empty or null.") },
        };
        ...
        /// </exception>
        public void Validate(CDP4Common.DTO.Thing simpleParameterizableThing)
        {
            this.Validate(simpleParameterizableThing, x => true);
        }
        ...
        /// If any validation rule failed.
        /// </exception>
        public void Validate(CDP4Common.DTO.Thing simpleParameterizableThing, Func<string, bool> validateProperty)
        {
            foreach (var applicableRule in this.validationRules.Where(x => validateProperty(x.Key)))
            {
                applicableRule.Value.Validate((CDP4Common.DTO.SimpleParameterizableThing)simpleParameterizableThing);
            }
        }
        ...
        /// </returns>
        public bool TryValidate(CDP4Common.DTO.Thing simpleParameterizableThing)
        {
            return this.TryValidate(simpleParameterizableThing, x => true);
        }
        ...
        /// True if all validation rules have passed or if none are defined.
        /// </returns>
        public bool TryValidate(CDP4Common.DTO.Thing simpleParameterizableThing, Func<string, bool> validateProperty)
        {
            var applicableValidationRules = this.validationRules.Where(x => validateProperty(x.Key)).Select(x => x.Value);

            return applicableValidationRules.All(applicableRule => applicableRule.TryValidate((CDP4Common.DTO.SimpleParameterizableThing)simpleParameterizableThing));
        }

        /// <summary>
        /// Returns the containment property value for the supplied <see cref="CDP4Common.DTO.SimpleParameterizableThing"/>.
        /// </summary>
        /// <param name="simpleParameterizableThing">
        /// The <see cref="CDP4Common.DTO.SimpleParameterizableThing"/> for which to return the containment property value.
        /// </param>
        ...
        /// If the property name is not supported for the <see cref="CDP4Common.DTO.SimpleParameterizableThing"/>.
        /// </exception>
        public IEnumerable<Guid> GetContainmentIds(CDP4Common.DTO.Thing simpleParameterizableThing, string propertyName)
        {
            if (!this.containmentPropertyValueMap.ContainsKey(propertyName))
            {
                throw new ArgumentException(string.Format("'{0}' is not a valid containment property of 'SimpleParameterizableThing'", propertyName));
            }

            return this.containmentPropertyValueMap[propertyName]((CDP4Common.DTO.SimpleParameterizableThing)simpleParameterizableThing);
        }

        /// <summary>
        /// Returns the ordered containment property value for the supplied <see cref="CDP4Common.DTO.SimpleParameterizableThing"/>.
        /// </summary>
        /// <param name="simpleParameterizableThing">
        /// The <see cref="CDP4Common.DTO.SimpleParameterizableThing"/> for which to return the containment property value.
        /// </param>
        ...
        /// If the property name is not supported for the <see cref="CDP4Common.DTO.SimpleParameterizableThing"/>.
        /// </exception>
        public IEnumerable<OrderedItem> GetOrderedContainmentIds(CDP4Common.DTO.Thing simpleParameterizableThing, string propertyName)
        {
            ...
            return this.orderedContainmentPropertyValueMap[propertyName]((CDP4Common.DTO.SimpleParameterizableThing)simpleParameterizableThing);
        }
        ...
        /// <summary>
        /// Gets the <see cref="PropertyMetaInfo"/> for the <see cref="SimpleParameterizableThing"/> class
        /// </summary>
        ...
        private readonly Dictionary<string, Action<CDP4Common.DTO.SimpleParameterizableThing, object>> propertyValueAssignmentMap = new Dictionary<string, Action<CDP4Common.DTO.SimpleParameterizableThing, object>>
        {
            ...
            { "Owner", (simpleParameterizableThing, value) => simpleParameterizableThing.Owner = (Guid)value },
            { "ShortName", (simpleParameterizableThing, value) => simpleParameterizableThing.ShortName = value.ToString() },
            { "ThingPreference", (simpleParameterizableThing, value) => simpleParameterizableThing.ThingPreference = value == null ? (string)null : value.ToString() },
        };
        ...
        /// <summary>
        /// Returns the <see cref="CDP4Common.DTO.SimpleParameterizableThing"/> containment property type from the supplied property name.
        /// </summary>
        /// <param name="propertyName">
        ...
        /// <summary>
        /// Returns the <see cref="CDP4Common.DTO.SimpleParameterizableThing"/> property type from the supplied property name.
        /// </summary>
        /// <param name="propertyName">
        /// The property name.
        /// </param>
        ...
        /// <summary>
        /// Returns the container property for the supplied type name is a possible container for <see cref="CDP4Common.DTO.SimpleParameterizableThing"/>.
        /// </summary>
        /// <param name="typeName">
        /// Name of the type for which to check if it is a container of <see cref="CDP4Common.DTO.SimpleParameterizableThing"/>.
        /// </param>
        /// <param name="containerProperty">
        /// Supplied container property info instance that will be set if the supplied type name is a container of <see cref="CDP4Common.DTO.SimpleParameterizableThing"/>.
        /// </param>
        /// <returns>
        /// True if the supplied typeName is a container for <see cref="CDP4Common.DTO.SimpleParameterizableThing"/> and sets the container property name.
        /// </returns>
        ...
        /// <summary>
        /// Check if the supplied property name for <see cref="CDP4Common.DTO.SimpleParameterizableThing"/> is scalar.
        /// </summary>
        /// <param name="propertyName">
        /// Name of the property for which to check if it is scalar.
        /// </param>
        ...
        public bool ApplyPropertyUpdate(CDP4Common.DTO.Thing updatableThing, string propertyName, object value)
        {
            ...
            this.propertyValueAssignmentMap[propertyName]((CDP4Common.DTO.SimpleParameterizableThing)updatableThing, value);
        ...
        public object DeserializeCollectionValue(string propertyName, object value)
        {
            ...
            {
                throw new ArgumentException(string.Format("'{0}' is not a valid collection property of 'SimpleParameterizableThing'", propertyName));
            }
        ...
        public object GetValue(string propertyName, CDP4Common.DTO.Thing thing)
        {
            ...
            return this.propertyValueMap[propertyName]((CDP4Common.DTO.SimpleParameterizableThing)thing);
        }
        ...
        /// <summary>
        /// Instantiates a <see cref="CDP4Common.DTO.SimpleParameterizableThing"/>
        /// </summary>
        /// <returns>
