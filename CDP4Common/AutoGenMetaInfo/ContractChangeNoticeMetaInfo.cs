// --------------------------------------------------------------------------------------------------------------------
// <copyright file="ContractChangeNoticeMetaInfo.cs" company="Starion Group S.A.">
...
namespace CDP4Common.MetaInfo
{
    ...
    public partial class ContractChangeNoticeMetaInfo : IContractChangeNoticeMetaInfo
    {
        ...
        public IEnumerable<Guid> GetContainmentIds(CDP4Common.DTO.Thing contractChangeNotice, string propertyName)
        {
            ...
            {
                throw new ArgumentException($"'{propertyName}' is not a valid containment property of 'ContractChangeNotice'");
            }
        ...
        {
            { "Actor", (contractChangeNotice, value) => contractChangeNotice.Actor = value == null ? (Guid?)null : (Guid)value },
        ...
        public object DeserializeCollectionValue(string propertyName, object value)
        {
            ...
            {
                throw new ArgumentException($"'{propertyName}' is not a valid collection property of 'ContractChangeNotice'");
            }
