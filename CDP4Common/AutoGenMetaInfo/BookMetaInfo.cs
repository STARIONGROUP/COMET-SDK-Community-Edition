...
namespace CDP4Common.MetaInfo
{
    ...
    public partial class BookMetaInfo : IBookMetaInfo
    {
        ...
        {
            { "Section", new PropertyMetaInfo("Section", "Guid", PropertyKind.OrderedList, AggregationKind.Composite, false, true, true, 0, "*", true) },
        };
        ...
        {
            { "EngineeringModel", new PropertyMetaInfo("Book", "Guid", PropertyKind.OrderedList, AggregationKind.Composite, false, true, true, 0, "*", true) },
        };
