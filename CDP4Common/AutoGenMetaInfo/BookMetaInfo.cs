// --------------------------------------------------------------------------------------------------------------------
// <copyright file="BookMetaInfo.cs" company="Starion Group S.A.">
...
namespace CDP4Common.MetaInfo
{
    ...
    /// <summary>
    /// This a class that holds meta info for <see cref="Book"/>.
    /// </summary>
    public partial class BookMetaInfo : IBookMetaInfo
    {
        /// <summary>
        /// The containment property value map.
        /// </summary>
        private readonly Dictionary<string, Func<CDP4Common.DTO.Book, IEnumerable<Guid>>> containmentPropertyValueMap = new Dictionary<string, Func<CDP4Common.DTO.Book, IEnumerable<Guid>>>
        {
            { "Section", book => book.Section.ToIdList() },
        };

        /// <summary>
        /// The ordered containment property value map.
        /// </summary>
        private readonly Dictionary<string, Func<CDP4Common.DTO.Book, IEnumerable<OrderedItem>>> orderedContainmentPropertyValueMap = new Dictionary<string, Func<CDP4Common.DTO.Book, IEnumerable<OrderedItem>>>
        {
            { "Section", book => book.Section },
        };

        /// <summary>
        /// The validation rules that should pass for an instance of <see cref="CDP4Common.DTO.Book"/>.
        /// </summary>
        private readonly Dictionary<string, DtoValidationHelper<CDP4Common.DTO.Book>> validationRules = new Dictionary<string, DtoValidationHelper<CDP4Common.DTO.Book>>
        {
            { "Category", new DtoValidationHelper<CDP4Common.DTO.Book>(item => item.Category != null, "The 'Category' property of a 'Book' is mandatory and cannot be null.") },
            { "ExcludedDomain", new DtoValidationHelper<CDP4Common.DTO.Book>(item => item.ExcludedDomain != null, "The 'ExcludedDomain' property of a 'Book' is mandatory and cannot be null.") },
            { "ExcludedPerson", new DtoValidationHelper<CDP4Common.DTO.Book>(item => item.ExcludedPerson != null, "The 'ExcludedPerson' property of a 'Book' is mandatory and cannot be null.") },
            { "Name", new DtoValidationHelper<CDP4Common.DTO.Book>(item => !string.IsNullOrWhiteSpace(item.Name), "The 'Name' property of a 'Book' is mandatory and cannot be empty or null.") },
            { "Section", new DtoValidationHelper<CDP4Common.DTO.Book>(item => item.Section != null, "The 'Section' property of a 'Book' is mandatory and cannot be null.") },
            { "ShortName", new DtoValidationHelper<CDP4Common.DTO.Book>(item => !string.IsNullOrWhiteSpace(item.ShortName), "The 'ShortName' property of a 'Book' is mandatory and cannot be empty or null.") },
        };
        ...
        /// </exception>
        public void Validate(CDP4Common.DTO.Thing book)
        {
            this.Validate(book, x => true);
        }
        ...
        /// If any validation rule failed.
        /// </exception>
        public void Validate(CDP4Common.DTO.Thing book, Func<string, bool> validateProperty)
        {
            foreach (var applicableRule in this.validationRules.Where(x => validateProperty(x.Key)))
            {
                applicableRule.Value.Validate((CDP4Common.DTO.Book)book);
            }
        }
        ...
        /// </returns>
        public bool TryValidate(CDP4Common.DTO.Thing book)
        {
            return this.TryValidate(book, x => true);
        }
        ...
        /// True if all validation rules have passed or if none are defined.
        /// </returns>
        public bool TryValidate(CDP4Common.DTO.Thing book, Func<string, bool> validateProperty)
        {
            var applicableValidationRules = this.validationRules.Where(x => validateProperty(x.Key)).Select(x => x.Value);

            return applicableValidationRules.All(applicableRule => applicableRule.TryValidate((CDP4Common.DTO.Book)book));
        }

        /// <summary>
        /// Returns the containment property value for the supplied <see cref="CDP4Common.DTO.Book"/>.
        /// </summary>
        /// <param name="book">
        /// The <see cref="CDP4Common.DTO.Book"/> for which to return the containment property value.
        /// </param>
        ...
        /// If the property name is not supported for the <see cref="CDP4Common.DTO.Book"/>.
        /// </exception>
        public IEnumerable<Guid> GetContainmentIds(CDP4Common.DTO.Thing book, string propertyName)
        {
            if (!this.containmentPropertyValueMap.ContainsKey(propertyName))
            {
                throw new ArgumentException($"'{propertyName}' is not a valid containment property of 'Book'");
            }

            return this.containmentPropertyValueMap[propertyName]((CDP4Common.DTO.Book)book);
        }

        /// <summary>
        /// Returns the ordered containment property value for the supplied <see cref="CDP4Common.DTO.Book"/>.
        /// </summary>
        /// <param name="book">
        /// The <see cref="CDP4Common.DTO.Book"/> for which to return the containment property value.
        /// </param>
        ...
        /// If the property name is not supported for the <see cref="CDP4Common.DTO.Book"/>.
        /// </exception>
        public IEnumerable<OrderedItem> GetOrderedContainmentIds(CDP4Common.DTO.Thing book, string propertyName)
        {
            ...
            return this.orderedContainmentPropertyValueMap[propertyName]((CDP4Common.DTO.Book)book);
        }
        ...
        {
            { "Section", new PropertyMetaInfo("Section", "Section", PropertyKind.OrderedList, AggregationKind.Composite, false, true, true, 0, "*", true) },
        };

        /// <summary>
        /// Gets the <see cref="PropertyMetaInfo"/> for the <see cref="Book"/> class
        /// </summary>
        ...
        /// </summary>
        private readonly Dictionary<string, Func<CDP4Common.DTO.Book, object>> propertyValueMap = new Dictionary<string, Func<CDP4Common.DTO.Book, object>>
        {
        ...
        private readonly Dictionary<string, Func<object, object>> collectionPropertyValueDeserializationMap = new Dictionary<string, Func<object, object>>
        {
            ...
            { "Section", (value) => (Guid)value },
        };

        /// <summary>
        /// The property value assignment map.
        /// </summary>
        private readonly Dictionary<string, Action<CDP4Common.DTO.Book, object>> propertyValueAssignmentMap = new Dictionary<string, Action<CDP4Common.DTO.Book, object>>
        {
            { "Actor", (book, value) => book.Actor = value == null ? (Guid?)null : (Guid)value },
            { "CreatedOn", (book, value) => book.CreatedOn = (DateTime)value },
            { "Iid", (book, value) => book.Iid = (Guid)value },
            { "ModifiedOn", (book, value) => book.ModifiedOn = (DateTime)value },
            { "Name", (book, value) => book.Name = value.ToString() },
            { "Owner", (book, value) => book.Owner = (Guid)value },
            { "ShortName", (book, value) => book.ShortName = value.ToString() },
            { "ThingPreference", (book, value) => book.ThingPreference = value == null ? (string)null : value.ToString() },
        };
        ...
        {
            { "EngineeringModel", new PropertyMetaInfo("Book", "Book", PropertyKind.OrderedList, AggregationKind.Composite, false, true, true, 0, "*", true) },
        };
        ...
        /// <summary>
        /// Returns the <see cref="CDP4Common.DTO.Book"/> containment property type from the supplied property name.
        /// </summary>
        /// <param name="propertyName">
        ...
        /// <summary>
        /// Returns the <see cref="CDP4Common.DTO.Book"/> property type from the supplied property name.
        /// </summary>
        /// <param name="propertyName">
        /// The property name.
        /// </param>
        ...
        /// <summary>
        /// Returns the container property for the supplied type name is a possible container for <see cref="CDP4Common.DTO.Book"/>.
        /// </summary>
        /// <param name="typeName">
        /// Name of the type for which to check if it is a container of <see cref="CDP4Common.DTO.Book"/>.
        /// </param>
        /// <param name="containerProperty">
        /// Supplied container property info instance that will be set if the supplied type name is a container of <see cref="CDP4Common.DTO.Book"/>.
        /// </param>
        /// <returns>
        /// True if the supplied typeName is a container for <see cref="CDP4Common.DTO.Book"/> and sets the container property name.
        /// </returns>
        ...
        /// <summary>
        /// Check if the supplied property name for <see cref="CDP4Common.DTO.Book"/> is scalar.
        /// </summary>
        /// <param name="propertyName">
        /// Name of the property for which to check if it is scalar.
        /// </param>
        ...
        public bool ApplyPropertyUpdate(CDP4Common.DTO.Thing updatableThing, string propertyName, object value)
        {
            ...
            this.propertyValueAssignmentMap[propertyName]((CDP4Common.DTO.Book)updatableThing, value);
        ...
        public object DeserializeCollectionValue(string propertyName, object value)
        {
            ...
            {
                throw new ArgumentException($"'{propertyName}' is not a valid collection property of 'Book'");
            }
        ...
        public object GetValue(string propertyName, CDP4Common.DTO.Thing thing)
        {
            ...
            return this.propertyValueMap[propertyName]((CDP4Common.DTO.Book)thing);
        }
        ...
        /// <summary>
        /// Instantiates a <see cref="CDP4Common.DTO.Book"/>
        /// </summary>
        /// <returns>
        ...
        {
            return new CDP4Common.DTO.Book(guid, revisionNumber);
        }
    }
}
