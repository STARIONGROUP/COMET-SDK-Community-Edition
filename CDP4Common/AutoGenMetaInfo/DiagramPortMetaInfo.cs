// --------------------------------------------------------------------------------------------------------------------
// <copyright file="DiagramPortMetaInfo.cs" company="RHEA System S.A.">
...
namespace CDP4Common.MetaInfo
{
    ...
    /// <summary>
    /// This a class that holds meta info for <see cref="DiagramPort"/>.
    /// </summary>
    public partial class DiagramPortMetaInfo : IDiagramPortMetaInfo
    {
        /// <summary>
        /// The containment property value map.
        /// </summary>
        private readonly Dictionary<string, Func<CDP4Common.DTO.DiagramPort, IEnumerable<Guid>>> containmentPropertyValueMap = new Dictionary<string, Func<CDP4Common.DTO.DiagramPort, IEnumerable<Guid>>>
        {
            { "Bounds", diagramPort => diagramPort.Bounds },
            { "DiagramElement", diagramPort => diagramPort.DiagramElement },
            { "LocalStyle", diagramPort => diagramPort.LocalStyle },
        };

        /// <summary>
        /// The ordered containment property value map.
        /// </summary>
        private readonly Dictionary<string, Func<CDP4Common.DTO.DiagramPort, IEnumerable<OrderedItem>>> orderedContainmentPropertyValueMap = new Dictionary<string, Func<CDP4Common.DTO.DiagramPort, IEnumerable<OrderedItem>>>();

        /// <summary>
        /// The validation rules that should pass for an instance of <see cref="CDP4Common.DTO.DiagramPort"/>.
        /// </summary>
        private readonly Dictionary<string, DtoValidationHelper<CDP4Common.DTO.DiagramPort>> validationRules = new Dictionary<string, DtoValidationHelper<CDP4Common.DTO.DiagramPort>>
        {
            { "Bounds", new DtoValidationHelper<CDP4Common.DTO.DiagramPort>(item => item.Bounds != null, "The 'Bounds' property of a 'DiagramPort' is mandatory and cannot be null.") },
            { "DiagramElement", new DtoValidationHelper<CDP4Common.DTO.DiagramPort>(item => item.DiagramElement != null, "The 'DiagramElement' property of a 'DiagramPort' is mandatory and cannot be null.") },
            { "ExcludedDomain", new DtoValidationHelper<CDP4Common.DTO.DiagramPort>(item => item.ExcludedDomain != null, "The 'ExcludedDomain' property of a 'DiagramPort' is mandatory and cannot be null.") },
            { "ExcludedPerson", new DtoValidationHelper<CDP4Common.DTO.DiagramPort>(item => item.ExcludedPerson != null, "The 'ExcludedPerson' property of a 'DiagramPort' is mandatory and cannot be null.") },
            { "LocalStyle", new DtoValidationHelper<CDP4Common.DTO.DiagramPort>(item => item.LocalStyle != null, "The 'LocalStyle' property of a 'DiagramPort' is mandatory and cannot be null.") },
            { "Name", new DtoValidationHelper<CDP4Common.DTO.DiagramPort>(item => !string.IsNullOrWhiteSpace(item.Name), "The 'Name' property of a 'DiagramPort' is mandatory and cannot be empty or null.") },
        };
        ...
        /// </exception>
        public void Validate(CDP4Common.DTO.Thing diagramPort)
        {
            this.Validate(diagramPort, x => true);
        }
        ...
        /// If any validation rule failed.
        /// </exception>
        public void Validate(CDP4Common.DTO.Thing diagramPort, Func<string, bool> validateProperty)
        {
            foreach (var applicableRule in this.validationRules.Where(x => validateProperty(x.Key)))
            {
                applicableRule.Value.Validate((CDP4Common.DTO.DiagramPort)diagramPort);
            }
        }
        ...
        /// </returns>
        public bool TryValidate(CDP4Common.DTO.Thing diagramPort)
        {
            return this.TryValidate(diagramPort, x => true);
        }
        ...
        /// True if all validation rules have passed or if none are defined.
        /// </returns>
        public bool TryValidate(CDP4Common.DTO.Thing diagramPort, Func<string, bool> validateProperty)
        {
            var applicableValidationRules = this.validationRules.Where(x => validateProperty(x.Key)).Select(x => x.Value);

            return applicableValidationRules.All(applicableRule => applicableRule.TryValidate((CDP4Common.DTO.DiagramPort)diagramPort));
        }

        /// <summary>
        /// Returns the containment property value for the supplied <see cref="CDP4Common.DTO.DiagramPort"/>.
        /// </summary>
        /// <param name="diagramPort">
        /// The <see cref="CDP4Common.DTO.DiagramPort"/> for which to return the containment property value.
        /// </param>
        ...
        /// If the property name is not supported for the <see cref="CDP4Common.DTO.DiagramPort"/>.
        /// </exception>
        public IEnumerable<Guid> GetContainmentIds(CDP4Common.DTO.Thing diagramPort, string propertyName)
        {
            if (!this.containmentPropertyValueMap.ContainsKey(propertyName))
            {
                throw new ArgumentException(string.Format("'{0}' is not a valid containment property of 'DiagramPort'", propertyName));
            }

            return this.containmentPropertyValueMap[propertyName]((CDP4Common.DTO.DiagramPort)diagramPort);
        }

        /// <summary>
        /// Returns the ordered containment property value for the supplied <see cref="CDP4Common.DTO.DiagramPort"/>.
        /// </summary>
        /// <param name="diagramPort">
        /// The <see cref="CDP4Common.DTO.DiagramPort"/> for which to return the containment property value.
        /// </param>
        ...
        /// If the property name is not supported for the <see cref="CDP4Common.DTO.DiagramPort"/>.
        /// </exception>
        public IEnumerable<OrderedItem> GetOrderedContainmentIds(CDP4Common.DTO.Thing diagramPort, string propertyName)
        {
            ...
            return this.orderedContainmentPropertyValueMap[propertyName]((CDP4Common.DTO.DiagramPort)diagramPort);
        }
        ...
        /// <summary>
        /// Gets the <see cref="PropertyMetaInfo"/> for the <see cref="DiagramPort"/> class
        /// </summary>
        ...
        /// </summary>
        private readonly Dictionary<string, Func<CDP4Common.DTO.DiagramPort, object>> propertyValueMap = new Dictionary<string, Func<CDP4Common.DTO.DiagramPort, object>>
        {
        ...
        /// </summary>
        private readonly Dictionary<string, Action<CDP4Common.DTO.DiagramPort, object>> propertyValueAssignmentMap = new Dictionary<string, Action<CDP4Common.DTO.DiagramPort, object>>
        {
            { "DepictedThing", (diagramPort, value) => diagramPort.DepictedThing = value == null ? (Guid?)null : (Guid)value },
            { "Iid", (diagramPort, value) => diagramPort.Iid = (Guid)value },
            { "ModifiedOn", (diagramPort, value) => diagramPort.ModifiedOn = (DateTime)value },
            { "Name", (diagramPort, value) => diagramPort.Name = value.ToString() },
            { "SharedStyle", (diagramPort, value) => diagramPort.SharedStyle = value == null ? (Guid?)null : (Guid)value },
            { "ThingPreference", (diagramPort, value) => diagramPort.ThingPreference = value == null ? (string)null : value.ToString() },
        };
        ...
        {
            { "ArchitectureElement", new PropertyMetaInfo("DiagramPort", "DiagramPort", PropertyKind.List, AggregationKind.Composite, false, false, true, 0, "*", true) },
        };
        ...
        /// <summary>
        /// Returns the <see cref="CDP4Common.DTO.DiagramPort"/> containment property type from the supplied property name.
        /// </summary>
        /// <param name="propertyName">
        ...
        /// <summary>
        /// Returns the <see cref="CDP4Common.DTO.DiagramPort"/> property type from the supplied property name.
        /// </summary>
        /// <param name="propertyName">
        /// The property name.
        /// </param>
        ...
        /// <summary>
        /// Returns the container property for the supplied type name is a possible container for <see cref="CDP4Common.DTO.DiagramPort"/>.
        /// </summary>
        /// <param name="typeName">
        /// Name of the type for which to check if it is a container of <see cref="CDP4Common.DTO.DiagramPort"/>.
        /// </param>
        /// <param name="containerProperty">
        /// Supplied container property info instance that will be set if the supplied type name is a container of <see cref="CDP4Common.DTO.DiagramPort"/>.
        /// </param>
        /// <returns>
        /// True if the supplied typeName is a container for <see cref="CDP4Common.DTO.DiagramPort"/> and sets the container property name.
        /// </returns>
        ...
        /// <summary>
        /// Check if the supplied property name for <see cref="CDP4Common.DTO.DiagramPort"/> is scalar.
        /// </summary>
        /// <param name="propertyName">
        /// Name of the property for which to check if it is scalar.
        /// </param>
        ...
        public bool ApplyPropertyUpdate(CDP4Common.DTO.Thing updatableThing, string propertyName, object value)
        {
            ...
            this.propertyValueAssignmentMap[propertyName]((CDP4Common.DTO.DiagramPort)updatableThing, value);
        ...
        public object DeserializeCollectionValue(string propertyName, object value)
        {
            ...
            {
                throw new ArgumentException(string.Format("'{0}' is not a valid collection property of 'DiagramPort'", propertyName));
            }
        ...
        public object GetValue(string propertyName, CDP4Common.DTO.Thing thing)
        {
            ...
            return this.propertyValueMap[propertyName]((CDP4Common.DTO.DiagramPort)thing);
        }
        ...
        /// <summary>
        /// Instantiates a <see cref="CDP4Common.DTO.DiagramPort"/>
        /// </summary>
        /// <returns>
        ...
        {
            return new CDP4Common.DTO.DiagramPort(guid, revisionNumber);
        }
    }
}
