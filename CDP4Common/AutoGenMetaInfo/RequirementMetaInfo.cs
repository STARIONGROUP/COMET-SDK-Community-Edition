...
namespace CDP4Common.MetaInfo
{
    ...
    public partial class RequirementMetaInfo : IRequirementMetaInfo
    {
        ...
        private readonly Dictionary<string, PropertyMetaInfo> containmentTypeMap = new Dictionary<string, PropertyMetaInfo>
        {
            ...
            { "ParametricConstraint", new PropertyMetaInfo("ParametricConstraint", "Guid", PropertyKind.OrderedList, AggregationKind.Composite, false, true, true, 0, "*", true) },
        };
        ...
        {
            { "RequirementsSpecification", new PropertyMetaInfo("Requirement", "Guid", PropertyKind.List, AggregationKind.Composite, false, false, true, 0, "*", true) },
        };
