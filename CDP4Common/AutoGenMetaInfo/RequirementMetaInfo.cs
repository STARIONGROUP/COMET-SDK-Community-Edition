// --------------------------------------------------------------------------------------------------------------------
// <copyright file="RequirementMetaInfo.cs" company="Starion Group S.A.">
...
namespace CDP4Common.MetaInfo
{
    ...
    /// <summary>
    /// This a class that holds meta info for <see cref="Requirement"/>.
    /// </summary>
    public partial class RequirementMetaInfo : IRequirementMetaInfo
    {
        /// <summary>
        ...
        private readonly Dictionary<string, Func<CDP4Common.DTO.Requirement, IEnumerable<Guid>>> containmentPropertyValueMap = new Dictionary<string, Func<CDP4Common.DTO.Requirement, IEnumerable<Guid>>>
        {
            ...
            { "ParametricConstraint", requirement => requirement.ParametricConstraint.ToIdList() },
        };

        /// <summary>
        /// The ordered containment property value map.
        /// </summary>
        private readonly Dictionary<string, Func<CDP4Common.DTO.Requirement, IEnumerable<OrderedItem>>> orderedContainmentPropertyValueMap = new Dictionary<string, Func<CDP4Common.DTO.Requirement, IEnumerable<OrderedItem>>>
        {
            { "ParametricConstraint", requirement => requirement.ParametricConstraint },
        };

        /// <summary>
        /// The validation rules that should pass for an instance of <see cref="CDP4Common.DTO.Requirement"/>.
        /// </summary>
        private readonly Dictionary<string, DtoValidationHelper<CDP4Common.DTO.Requirement>> validationRules = new Dictionary<string, DtoValidationHelper<CDP4Common.DTO.Requirement>>
        {
            ...
            { "ExcludedPerson", new DtoValidationHelper<CDP4Common.DTO.Requirement>(item => item.ExcludedPerson != null, "The 'ExcludedPerson' property of a 'Requirement' is mandatory and cannot be null.") },
            { "HyperLink", new DtoValidationHelper<CDP4Common.DTO.Requirement>(item => item.HyperLink != null, "The 'HyperLink' property of a 'Requirement' is mandatory and cannot be null.") },
            { "Name", new DtoValidationHelper<CDP4Common.DTO.Requirement>(item => !string.IsNullOrWhiteSpace(item.Name), "The 'Name' property of a 'Requirement' is mandatory and cannot be empty or null.") },
            { "ParameterValue", new DtoValidationHelper<CDP4Common.DTO.Requirement>(item => item.ParameterValue != null, "The 'ParameterValue' property of a 'Requirement' is mandatory and cannot be null.") },
            { "ParametricConstraint", new DtoValidationHelper<CDP4Common.DTO.Requirement>(item => item.ParametricConstraint != null, "The 'ParametricConstraint' property of a 'Requirement' is mandatory and cannot be null.") },
            { "ShortName", new DtoValidationHelper<CDP4Common.DTO.Requirement>(item => !string.IsNullOrWhiteSpace(item.ShortName), "The 'ShortName' property of a 'Requirement' is mandatory and cannot be empty or null.") },
        };
        ...
        /// </exception>
        public void Validate(CDP4Common.DTO.Thing requirement)
        {
            this.Validate(requirement, x => true);
        }
        ...
        /// If any validation rule failed.
        /// </exception>
        public void Validate(CDP4Common.DTO.Thing requirement, Func<string, bool> validateProperty)
        {
            foreach (var applicableRule in this.validationRules.Where(x => validateProperty(x.Key)))
            {
                applicableRule.Value.Validate((CDP4Common.DTO.Requirement)requirement);
            }
        }
        ...
        /// </returns>
        public bool TryValidate(CDP4Common.DTO.Thing requirement)
        {
            return this.TryValidate(requirement, x => true);
        }
        ...
        /// True if all validation rules have passed or if none are defined.
        /// </returns>
        public bool TryValidate(CDP4Common.DTO.Thing requirement, Func<string, bool> validateProperty)
        {
            var applicableValidationRules = this.validationRules.Where(x => validateProperty(x.Key)).Select(x => x.Value);

            return applicableValidationRules.All(applicableRule => applicableRule.TryValidate((CDP4Common.DTO.Requirement)requirement));
        }

        /// <summary>
        /// Returns the containment property value for the supplied <see cref="CDP4Common.DTO.Requirement"/>.
        /// </summary>
        /// <param name="requirement">
        /// The <see cref="CDP4Common.DTO.Requirement"/> for which to return the containment property value.
        /// </param>
        ...
        /// If the property name is not supported for the <see cref="CDP4Common.DTO.Requirement"/>.
        /// </exception>
        public IEnumerable<Guid> GetContainmentIds(CDP4Common.DTO.Thing requirement, string propertyName)
        {
            if (!this.containmentPropertyValueMap.ContainsKey(propertyName))
            {
                throw new ArgumentException($"'{propertyName}' is not a valid containment property of 'Requirement'");
            }

            return this.containmentPropertyValueMap[propertyName]((CDP4Common.DTO.Requirement)requirement);
        }

        /// <summary>
        /// Returns the ordered containment property value for the supplied <see cref="CDP4Common.DTO.Requirement"/>.
        /// </summary>
        /// <param name="requirement">
        /// The <see cref="CDP4Common.DTO.Requirement"/> for which to return the containment property value.
        /// </param>
        ...
        /// If the property name is not supported for the <see cref="CDP4Common.DTO.Requirement"/>.
        /// </exception>
        public IEnumerable<OrderedItem> GetOrderedContainmentIds(CDP4Common.DTO.Thing requirement, string propertyName)
        {
            ...
            return this.orderedContainmentPropertyValueMap[propertyName]((CDP4Common.DTO.Requirement)requirement);
        }
        ...
        private readonly Dictionary<string, PropertyMetaInfo> containmentTypeMap = new Dictionary<string, PropertyMetaInfo>
        {
            ...
            { "ParametricConstraint", new PropertyMetaInfo("ParametricConstraint", "ParametricConstraint", PropertyKind.OrderedList, AggregationKind.Composite, false, true, true, 0, "*", true) },
        };

        /// <summary>
        /// Gets the <see cref="PropertyMetaInfo"/> for the <see cref="Requirement"/> class
        /// </summary>
        ...
        private readonly Dictionary<string, Func<CDP4Common.DTO.Requirement, object>> propertyValueMap = new Dictionary<string, Func<CDP4Common.DTO.Requirement, object>>
        {
            ...
            { "ParametricConstraint", thing => thing.ParametricConstraint },
        ...
        private readonly Dictionary<string, PropertyMetaInfo> propertyTypeMap = new Dictionary<string, PropertyMetaInfo>
        {
            ...
            { "Group", new PropertyMetaInfo("Group", "RequirementsGroup", PropertyKind.Scalar, AggregationKind.None, false, false, true, 0, "1", true) },
        ...
        private readonly Dictionary<string, Func<object, object>> collectionPropertyValueDeserializationMap = new Dictionary<string, Func<object, object>>
        {
            ...
            { "ParametricConstraint", (value) => (Guid)value },
        };

        /// <summary>
        /// The property value assignment map.
        /// </summary>
        private readonly Dictionary<string, Action<CDP4Common.DTO.Requirement, object>> propertyValueAssignmentMap = new Dictionary<string, Action<CDP4Common.DTO.Requirement, object>>
        {
            { "Actor", (requirement, value) => requirement.Actor = value == null ? (Guid?)null : (Guid)value },
            { "Group", (requirement, value) => requirement.Group = value == null ? (Guid?)null : (Guid)value },
            { "Iid", (requirement, value) => requirement.Iid = (Guid)value },
            { "IsDeprecated", (requirement, value) => requirement.IsDeprecated = (bool)value },
            { "ModifiedOn", (requirement, value) => requirement.ModifiedOn = (DateTime)value },
            { "Name", (requirement, value) => requirement.Name = value.ToString() },
            { "Owner", (requirement, value) => requirement.Owner = (Guid)value },
            { "ShortName", (requirement, value) => requirement.ShortName = value.ToString() },
            { "ThingPreference", (requirement, value) => requirement.ThingPreference = value == null ? (string)null : value.ToString() },
        };
        ...
        {
            { "RequirementsSpecification", new PropertyMetaInfo("Requirement", "Requirement", PropertyKind.List, AggregationKind.Composite, false, false, true, 0, "*", true) },
        };
        ...
        {
            get { return "SimpleParameterizableThing"; }
        }
        ...
        /// <summary>
        /// Returns the <see cref="CDP4Common.DTO.Requirement"/> containment property type from the supplied property name.
        /// </summary>
        /// <param name="propertyName">
        ...
        /// <summary>
        /// Returns the <see cref="CDP4Common.DTO.Requirement"/> property type from the supplied property name.
        /// </summary>
        /// <param name="propertyName">
        /// The property name.
        /// </param>
        ...
        /// <summary>
        /// Returns the container property for the supplied type name is a possible container for <see cref="CDP4Common.DTO.Requirement"/>.
        /// </summary>
        /// <param name="typeName">
        /// Name of the type for which to check if it is a container of <see cref="CDP4Common.DTO.Requirement"/>.
        /// </param>
        /// <param name="containerProperty">
        /// Supplied container property info instance that will be set if the supplied type name is a container of <see cref="CDP4Common.DTO.Requirement"/>.
        /// </param>
        /// <returns>
        /// True if the supplied typeName is a container for <see cref="CDP4Common.DTO.Requirement"/> and sets the container property name.
        /// </returns>
        ...
        /// <summary>
        /// Check if the supplied property name for <see cref="CDP4Common.DTO.Requirement"/> is scalar.
        /// </summary>
        /// <param name="propertyName">
        /// Name of the property for which to check if it is scalar.
        /// </param>
        ...
        public object DeserializeCollectionValue(string propertyName, object value)
        {
            ...
            {
                throw new ArgumentException($"'{propertyName}' is not a valid collection property of 'Requirement'");
            }
        ...
        public object GetValue(string propertyName, CDP4Common.DTO.Thing thing)
        {
            ...
            return this.propertyValueMap[propertyName]((CDP4Common.DTO.Requirement)thing);
        }
        ...
        /// <summary>
        /// Instantiates a <see cref="CDP4Common.DTO.Requirement"/>
        /// </summary>
        /// <returns>
        ...
        {
            return new CDP4Common.DTO.Requirement(guid, revisionNumber);
        }
    }
}
