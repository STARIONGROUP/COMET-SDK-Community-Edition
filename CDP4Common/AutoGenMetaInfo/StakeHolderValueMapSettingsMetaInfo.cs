// --------------------------------------------------------------------------------------------------------------------
// <copyright file="StakeHolderValueMapSettingsMetaInfo.cs" company="Starion Group S.A.">
...
namespace CDP4Common.MetaInfo
{
    ...
    public partial class StakeHolderValueMapSettingsMetaInfo : IStakeHolderValueMapSettingsMetaInfo
    {
        ...
        public IEnumerable<Guid> GetContainmentIds(CDP4Common.DTO.Thing stakeHolderValueMapSettings, string propertyName)
        {
            ...
            {
                throw new ArgumentException($"'{propertyName}' is not a valid containment property of 'StakeHolderValueMapSettings'");
            }
        ...
        public object DeserializeCollectionValue(string propertyName, object value)
        {
            ...
            {
                throw new ArgumentException($"'{propertyName}' is not a valid collection property of 'StakeHolderValueMapSettings'");
            }
