// --------------------------------------------------------------------------------------------------------------------
// <copyright file="StakeHolderValueMapSettingsMetaInfo.cs" company="RHEA System S.A.">
...
namespace CDP4Common.MetaInfo
{
    ...
    /// <summary>
    /// This a class that holds meta info for <see cref="StakeHolderValueMapSettings"/>.
    /// </summary>
    public partial class StakeHolderValueMapSettingsMetaInfo : IStakeHolderValueMapSettingsMetaInfo
    {
        /// <summary>
        /// The containment property value map.
        /// </summary>
        private readonly Dictionary<string, Func<CDP4Common.DTO.StakeHolderValueMapSettings, IEnumerable<Guid>>> containmentPropertyValueMap = new Dictionary<string, Func<CDP4Common.DTO.StakeHolderValueMapSettings, IEnumerable<Guid>>>();

        /// <summary>
        /// The ordered containment property value map.
        /// </summary>
        private readonly Dictionary<string, Func<CDP4Common.DTO.StakeHolderValueMapSettings, IEnumerable<OrderedItem>>> orderedContainmentPropertyValueMap = new Dictionary<string, Func<CDP4Common.DTO.StakeHolderValueMapSettings, IEnumerable<OrderedItem>>>();

        /// <summary>
        /// The validation rules that should pass for an instance of <see cref="CDP4Common.DTO.StakeHolderValueMapSettings"/>.
        /// </summary>
        private readonly Dictionary<string, DtoValidationHelper<CDP4Common.DTO.StakeHolderValueMapSettings>> validationRules = new Dictionary<string, DtoValidationHelper<CDP4Common.DTO.StakeHolderValueMapSettings>>
        {
            { "ExcludedDomain", new DtoValidationHelper<CDP4Common.DTO.StakeHolderValueMapSettings>(item => item.ExcludedDomain != null, "The 'ExcludedDomain' property of a 'StakeHolderValueMapSettings' is mandatory and cannot be null.") },
            { "ExcludedPerson", new DtoValidationHelper<CDP4Common.DTO.StakeHolderValueMapSettings>(item => item.ExcludedPerson != null, "The 'ExcludedPerson' property of a 'StakeHolderValueMapSettings' is mandatory and cannot be null.") },
        };
        ...
        /// </exception>
        public void Validate(CDP4Common.DTO.Thing stakeHolderValueMapSettings)
        {
            this.Validate(stakeHolderValueMapSettings, x => true);
        }
        ...
        /// If any validation rule failed.
        /// </exception>
        public void Validate(CDP4Common.DTO.Thing stakeHolderValueMapSettings, Func<string, bool> validateProperty)
        {
            foreach (var applicableRule in this.validationRules.Where(x => validateProperty(x.Key)))
            {
                applicableRule.Value.Validate((CDP4Common.DTO.StakeHolderValueMapSettings)stakeHolderValueMapSettings);
            }
        }
        ...
        /// </returns>
        public bool TryValidate(CDP4Common.DTO.Thing stakeHolderValueMapSettings)
        {
            return this.TryValidate(stakeHolderValueMapSettings, x => true);
        }
        ...
        /// True if all validation rules have passed or if none are defined.
        /// </returns>
        public bool TryValidate(CDP4Common.DTO.Thing stakeHolderValueMapSettings, Func<string, bool> validateProperty)
        {
            var applicableValidationRules = this.validationRules.Where(x => validateProperty(x.Key)).Select(x => x.Value);

            return applicableValidationRules.All(applicableRule => applicableRule.TryValidate((CDP4Common.DTO.StakeHolderValueMapSettings)stakeHolderValueMapSettings));
        }

        /// <summary>
        /// Returns the containment property value for the supplied <see cref="CDP4Common.DTO.StakeHolderValueMapSettings"/>.
        /// </summary>
        /// <param name="stakeHolderValueMapSettings">
        /// The <see cref="CDP4Common.DTO.StakeHolderValueMapSettings"/> for which to return the containment property value.
        /// </param>
        ...
        /// If the property name is not supported for the <see cref="CDP4Common.DTO.StakeHolderValueMapSettings"/>.
        /// </exception>
        public IEnumerable<Guid> GetContainmentIds(CDP4Common.DTO.Thing stakeHolderValueMapSettings, string propertyName)
        {
            if (!this.containmentPropertyValueMap.ContainsKey(propertyName))
            {
                throw new ArgumentException(string.Format("'{0}' is not a valid containment property of 'StakeHolderValueMapSettings'", propertyName));
            }

            return this.containmentPropertyValueMap[propertyName]((CDP4Common.DTO.StakeHolderValueMapSettings)stakeHolderValueMapSettings);
        }

        /// <summary>
        /// Returns the ordered containment property value for the supplied <see cref="CDP4Common.DTO.StakeHolderValueMapSettings"/>.
        /// </summary>
        /// <param name="stakeHolderValueMapSettings">
        /// The <see cref="CDP4Common.DTO.StakeHolderValueMapSettings"/> for which to return the containment property value.
        /// </param>
        ...
        /// If the property name is not supported for the <see cref="CDP4Common.DTO.StakeHolderValueMapSettings"/>.
        /// </exception>
        public IEnumerable<OrderedItem> GetOrderedContainmentIds(CDP4Common.DTO.Thing stakeHolderValueMapSettings, string propertyName)
        {
            ...
            return this.orderedContainmentPropertyValueMap[propertyName]((CDP4Common.DTO.StakeHolderValueMapSettings)stakeHolderValueMapSettings);
        }
        ...
        /// <summary>
        /// Gets the <see cref="PropertyMetaInfo"/> for the <see cref="StakeHolderValueMapSettings"/> class
        /// </summary>
        ...
        private readonly Dictionary<string, Func<CDP4Common.DTO.StakeHolderValueMapSettings, object>> propertyValueMap = new Dictionary<string, Func<CDP4Common.DTO.StakeHolderValueMapSettings, object>>
        {
            ...
            { "GoalToValueGroupRelationship", thing => thing.GoalToValueGroupRelationship },
            { "Iid", thing => thing.Iid },
        ...
        private readonly Dictionary<string, PropertyMetaInfo> propertyTypeMap = new Dictionary<string, PropertyMetaInfo>
        {
            ...
            { "GoalToValueGroupRelationship", new PropertyMetaInfo("GoalToValueGroupRelationship", "Guid", PropertyKind.Scalar, AggregationKind.None, false, false, true, 0, "1", true) },
            { "Iid", new PropertyMetaInfo("Iid", "Guid", PropertyKind.Scalar, AggregationKind.None, false, false, true, 1, "1", true) },
            { "ModifiedOn", new PropertyMetaInfo("ModifiedOn", "DateTime", PropertyKind.Scalar, AggregationKind.None, false, false, true, 1, "1", true) },
            { "RevisionNumber", new PropertyMetaInfo("RevisionNumber", "int", PropertyKind.Scalar, AggregationKind.None, false, false, true, 1, "1", true) },
            { "StakeholderValueToRequirementRelationship", new PropertyMetaInfo("StakeholderValueToRequirementRelationship", "Guid", PropertyKind.Scalar, AggregationKind.None, false, false, true, 0, "1", true) },
            { "ValueGroupToStakeholderValueRelationship", new PropertyMetaInfo("ValueGroupToStakeholderValueRelationship", "Guid", PropertyKind.Scalar, AggregationKind.None, false, false, true, 0, "1", true) },
        };
        ...
        {
            { "StakeHolderValueMap", new PropertyMetaInfo("Settings", "Guid", PropertyKind.List, AggregationKind.Composite, false, false, true, 1, "1", true) },
        };
        ...
        /// <summary>
        /// Returns the <see cref="CDP4Common.DTO.StakeHolderValueMapSettings"/> containment property type from the supplied property name.
        /// </summary>
        /// <param name="propertyName">
        ...
        /// <summary>
        /// Returns the <see cref="CDP4Common.DTO.StakeHolderValueMapSettings"/> property type from the supplied property name.
        /// </summary>
        /// <param name="propertyName">
        /// The property name.
        /// </param>
        ...
        /// <summary>
        /// Returns the container property for the supplied type name is a possible container for <see cref="CDP4Common.DTO.StakeHolderValueMapSettings"/>.
        /// </summary>
        /// <param name="typeName">
        /// Name of the type for which to check if it is a container of <see cref="CDP4Common.DTO.StakeHolderValueMapSettings"/>.
        /// </param>
        /// <param name="containerProperty">
        /// Supplied container property info instance that will be set if the supplied type name is a container of <see cref="CDP4Common.DTO.StakeHolderValueMapSettings"/>.
        /// </param>
        /// <returns>
        /// True if the supplied typeName is a container for <see cref="CDP4Common.DTO.StakeHolderValueMapSettings"/> and sets the container property name.
        /// </returns>
        ...
        /// <summary>
        /// Check if the supplied property name for <see cref="CDP4Common.DTO.StakeHolderValueMapSettings"/> is scalar.
        /// </summary>
        /// <param name="propertyName">
        /// Name of the property for which to check if it is scalar.
        /// </param>
        ...
        public bool ApplyPropertyUpdate(CDP4Common.DTO.Thing updatableThing, string propertyName, object value)
        {
            ...
            this.propertyValueAssignmentMap[propertyName]((CDP4Common.DTO.StakeHolderValueMapSettings)updatableThing, value);
        ...
        public object DeserializeCollectionValue(string propertyName, object value)
        {
            ...
            {
                throw new ArgumentException(string.Format("'{0}' is not a valid collection property of 'StakeHolderValueMapSettings'", propertyName));
            }
        ...
        public object GetValue(string propertyName, CDP4Common.DTO.Thing thing)
        {
            ...
            return this.propertyValueMap[propertyName]((CDP4Common.DTO.StakeHolderValueMapSettings)thing);
        }
        ...
        /// <summary>
        /// Instantiates a <see cref="CDP4Common.DTO.StakeHolderValueMapSettings"/>
        /// </summary>
        /// <returns>
        ...
        {
            return new CDP4Common.DTO.StakeHolderValueMapSettings(guid, revisionNumber);
        }
    }
}
