...
namespace CDP4Common.MetaInfo
{
    ...
    /// <summary>
    /// This a class that holds meta info for <see cref="DecompositionRule"/>.
    /// </summary>
    public partial class DecompositionRuleMetaInfo : IDecompositionRuleMetaInfo
    {
        /// <summary>
        ...
        /// </summary>
        private readonly Dictionary<string, Func<CDP4Common.DTO.DecompositionRule, IEnumerable<OrderedItem>>> orderedContainmentPropertyValueMap = new Dictionary<string, Func<CDP4Common.DTO.DecompositionRule, IEnumerable<OrderedItem>>>();

        /// <summary>
        /// The validation rules that should pass for an instance of <see cref="CDP4Common.DTO.DecompositionRule"/>.
        /// </summary>
        private readonly Dictionary<string, DtoValidationHelper<CDP4Common.DTO.DecompositionRule>> validationRules = new Dictionary<string, DtoValidationHelper<CDP4Common.DTO.DecompositionRule>>
        {
            ...
            { "ExcludedPerson", new DtoValidationHelper<CDP4Common.DTO.DecompositionRule>(item => item.ExcludedPerson != null, "The 'ExcludedPerson' property of a 'DecompositionRule' is mandatory and cannot be null.") },
            { "HyperLink", new DtoValidationHelper<CDP4Common.DTO.DecompositionRule>(item => item.HyperLink != null, "The 'HyperLink' property of a 'DecompositionRule' is mandatory and cannot be null.") },
            { "Name", new DtoValidationHelper<CDP4Common.DTO.DecompositionRule>(item => !string.IsNullOrWhiteSpace(item.Name), "The 'Name' property of a 'DecompositionRule' is mandatory and cannot be empty or null.") },
            { "ShortName", new DtoValidationHelper<CDP4Common.DTO.DecompositionRule>(item => !string.IsNullOrWhiteSpace(item.ShortName), "The 'ShortName' property of a 'DecompositionRule' is mandatory and cannot be empty or null.") },
        };
        ...
        /// </exception>
        public void Validate(CDP4Common.DTO.Thing decompositionRule)
        {
            this.Validate(decompositionRule, x => true);
        }
        ...
        /// If any validation rule failed.
        /// </exception>
        public void Validate(CDP4Common.DTO.Thing decompositionRule, Func<string, bool> validateProperty)
        {
            foreach (var applicableRule in this.validationRules.Where(x => validateProperty(x.Key)))
            {
                applicableRule.Value.Validate((CDP4Common.DTO.DecompositionRule)decompositionRule);
            }
        }
        ...
        /// </returns>
        public bool TryValidate(CDP4Common.DTO.Thing decompositionRule)
        {
            return this.TryValidate(decompositionRule, x => true);
        }
        ...
        /// True if all validation rules have passed or if none are defined.
        /// </returns>
        public bool TryValidate(CDP4Common.DTO.Thing decompositionRule, Func<string, bool> validateProperty)
        {
            var applicableValidationRules = this.validationRules.Where(x => validateProperty(x.Key)).Select(x => x.Value);

            return applicableValidationRules.All(applicableRule => applicableRule.TryValidate((CDP4Common.DTO.DecompositionRule)decompositionRule));
        }

        /// <summary>
        /// Returns the containment property value for the supplied <see cref="CDP4Common.DTO.DecompositionRule"/>.
        /// </summary>
        /// <param name="decompositionRule">
        /// The <see cref="CDP4Common.DTO.DecompositionRule"/> for which to return the containment property value.
        /// </param>
        ...
        /// If the property name is not supported for the <see cref="CDP4Common.DTO.DecompositionRule"/>.
        /// </exception>
        public IEnumerable<Guid> GetContainmentIds(CDP4Common.DTO.Thing decompositionRule, string propertyName)
        {
        ...
        /// <summary>
        /// Returns the ordered containment property value for the supplied <see cref="CDP4Common.DTO.DecompositionRule"/>.
        /// </summary>
        /// <param name="decompositionRule">
        /// The <see cref="CDP4Common.DTO.DecompositionRule"/> for which to return the containment property value.
        /// </param>
        ...
        /// If the property name is not supported for the <see cref="CDP4Common.DTO.DecompositionRule"/>.
        /// </exception>
        public IEnumerable<OrderedItem> GetOrderedContainmentIds(CDP4Common.DTO.Thing decompositionRule, string propertyName)
        {
        ...
        /// <summary>
        /// Gets the <see cref="PropertyMetaInfo"/> for the <see cref="DecompositionRule"/> class
        /// </summary>
        ...
        private readonly Dictionary<string, Func<CDP4Common.DTO.DecompositionRule, object>> propertyValueMap = new Dictionary<string, Func<CDP4Common.DTO.DecompositionRule, object>>
        {
            ...
            { "MaxContained", thing => thing.MaxContained },
            { "MinContained", thing => thing.MinContained },
        ...
        private readonly Dictionary<string, PropertyMetaInfo> propertyTypeMap = new Dictionary<string, PropertyMetaInfo>
        {
            ...
            { "ContainedCategory", new PropertyMetaInfo("ContainedCategory", "Guid", PropertyKind.List, AggregationKind.None, false, false, true, 1, "*", true) },
            { "ContainingCategory", new PropertyMetaInfo("ContainingCategory", "Guid", PropertyKind.Scalar, AggregationKind.None, false, false, true, 1, "1", true) },
            ...
            { "MaxContained", new PropertyMetaInfo("MaxContained", "int", PropertyKind.Scalar, AggregationKind.None, false, false, true, 0, "1", true) },
            { "MinContained", new PropertyMetaInfo("MinContained", "int", PropertyKind.Scalar, AggregationKind.None, false, false, true, 1, "1", true) },
        ...
        private readonly Dictionary<string, Action<CDP4Common.DTO.DecompositionRule, object>> propertyValueAssignmentMap = new Dictionary<string, Action<CDP4Common.DTO.DecompositionRule, object>>
        {
            ...
            { "MaxContained", (decompositionRule, value) => decompositionRule.MaxContained = value == null ? (int?)null : (int)value },
            { "MinContained", (decompositionRule, value) => decompositionRule.MinContained = (int)value },
            { "ModifiedOn", (decompositionRule, value) => decompositionRule.ModifiedOn = (DateTime)value },
            { "Name", (decompositionRule, value) => decompositionRule.Name = value.ToString() },
            { "ShortName", (decompositionRule, value) => decompositionRule.ShortName = value.ToString() },
        };
        ...
        /// <summary>
        /// Returns the <see cref="CDP4Common.DTO.DecompositionRule"/> containment property type from the supplied property name.
        /// </summary>
        /// <param name="propertyName">
        ...
        /// <summary>
        /// Returns the <see cref="CDP4Common.DTO.DecompositionRule"/> property type from the supplied property name.
        /// </summary>
        /// <param name="propertyName">
        /// The property name.
        /// </param>
        ...
        /// <summary>
        /// Returns the container property for the supplied type name is a possible container for <see cref="CDP4Common.DTO.DecompositionRule"/>.
        /// </summary>
        /// <param name="typeName">
        /// Name of the type for which to check if it is a container of <see cref="CDP4Common.DTO.DecompositionRule"/>.
        /// </param>
        /// <param name="containerProperty">
        /// Supplied container property info instance that will be set if the supplied type name is a container of <see cref="CDP4Common.DTO.DecompositionRule"/>.
        /// </param>
        /// <returns>
        /// True if the supplied typeName is a container for <see cref="CDP4Common.DTO.DecompositionRule"/> and sets the container property name.
        /// </returns>
        ...
        /// <summary>
        /// Check if the supplied property name for <see cref="CDP4Common.DTO.DecompositionRule"/> is scalar.
        /// </summary>
        /// <param name="propertyName">
        /// Name of the property for which to check if it is scalar.
        /// </param>
        ...
        public bool ApplyPropertyUpdate(CDP4Common.DTO.Thing updatableThing, string propertyName, object value)
        {
            ...
            this.propertyValueAssignmentMap[propertyName]((CDP4Common.DTO.DecompositionRule)updatableThing, value);
        ...
        /// <summary>
        /// Instantiates a <see cref="CDP4Common.DTO.DecompositionRule"/>
        /// </summary>
        /// <returns>
        ...
        {
            return new CDP4Common.DTO.DecompositionRule(guid, revisionNumber);
        }
    }
}
