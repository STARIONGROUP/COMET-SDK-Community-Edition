// --------------------------------------------------------------------------------------------------------------------
// <copyright file="NestedElementMetaInfo.cs" company="Starion Group S.A.">
...
namespace CDP4Common.MetaInfo
{
    ...
    public partial class NestedElementMetaInfo : INestedElementMetaInfo
    {
        ...
        public IEnumerable<Guid> GetContainmentIds(CDP4Common.DTO.Thing nestedElement, string propertyName)
        {
            ...
            {
                throw new ArgumentException($"'{propertyName}' is not a valid containment property of 'NestedElement'");
            }
        ...
        {
            { "NestedParameter", new PropertyMetaInfo("NestedParameter", "NestedParameter", PropertyKind.List, AggregationKind.Composite, false, false, true, 0, "*", true) },
        };
        ...
        private readonly Dictionary<string, PropertyMetaInfo> propertyTypeMap = new Dictionary<string, PropertyMetaInfo>
        {
            ...
            { "ElementUsage", new PropertyMetaInfo("ElementUsage", "ElementUsage", PropertyKind.OrderedList, AggregationKind.None, false, true, true, 1, "*", true) },
        ...
        {
            { "Actor", (nestedElement, value) => nestedElement.Actor = value == null ? (Guid?)null : (Guid)value },
        ...
        {
            { "Option", new PropertyMetaInfo("NestedElement", "NestedElement", PropertyKind.List, AggregationKind.Composite, false, false, true, 0, "*", true) },
        };
        ...
        public object DeserializeCollectionValue(string propertyName, object value)
        {
            ...
            {
                throw new ArgumentException($"'{propertyName}' is not a valid collection property of 'NestedElement'");
            }
