// --------------------------------------------------------------------------------------------------------------------
// <copyright file="NestedElementMetaInfo.cs" company="RHEA System S.A.">
...
namespace CDP4Common.MetaInfo
{
    ...
    /// <summary>
    /// This a class that holds meta info for <see cref="NestedElement"/>.
    /// </summary>
    public partial class NestedElementMetaInfo : INestedElementMetaInfo
    {
        /// <summary>
        /// The containment property value map.
        /// </summary>
        private readonly Dictionary<string, Func<CDP4Common.DTO.NestedElement, IEnumerable<Guid>>> containmentPropertyValueMap = new Dictionary<string, Func<CDP4Common.DTO.NestedElement, IEnumerable<Guid>>>
        {
            { "NestedParameter", nestedElement => nestedElement.NestedParameter },
        };

        /// <summary>
        /// The ordered containment property value map.
        /// </summary>
        private readonly Dictionary<string, Func<CDP4Common.DTO.NestedElement, IEnumerable<OrderedItem>>> orderedContainmentPropertyValueMap = new Dictionary<string, Func<CDP4Common.DTO.NestedElement, IEnumerable<OrderedItem>>>();

        /// <summary>
        /// The validation rules that should pass for an instance of <see cref="CDP4Common.DTO.NestedElement"/>.
        /// </summary>
        private readonly Dictionary<string, DtoValidationHelper<CDP4Common.DTO.NestedElement>> validationRules = new Dictionary<string, DtoValidationHelper<CDP4Common.DTO.NestedElement>>
        {
            { "ElementUsage", new DtoValidationHelper<CDP4Common.DTO.NestedElement>(item => item.ElementUsage != null && item.ElementUsage.Any(), "The 'ElementUsage' property of a 'NestedElement' is mandatory and must have at least one entry.") },
            { "ExcludedDomain", new DtoValidationHelper<CDP4Common.DTO.NestedElement>(item => item.ExcludedDomain != null, "The 'ExcludedDomain' property of a 'NestedElement' is mandatory and cannot be null.") },
            { "ExcludedPerson", new DtoValidationHelper<CDP4Common.DTO.NestedElement>(item => item.ExcludedPerson != null, "The 'ExcludedPerson' property of a 'NestedElement' is mandatory and cannot be null.") },
            { "NestedParameter", new DtoValidationHelper<CDP4Common.DTO.NestedElement>(item => item.NestedParameter != null, "The 'NestedParameter' property of a 'NestedElement' is mandatory and cannot be null.") },
        };
        ...
        /// </exception>
        public void Validate(CDP4Common.DTO.Thing nestedElement)
        {
            this.Validate(nestedElement, x => true);
        }
        ...
        /// If any validation rule failed.
        /// </exception>
        public void Validate(CDP4Common.DTO.Thing nestedElement, Func<string, bool> validateProperty)
        {
            foreach (var applicableRule in this.validationRules.Where(x => validateProperty(x.Key)))
            {
                applicableRule.Value.Validate((CDP4Common.DTO.NestedElement)nestedElement);
            }
        }
        ...
        /// </returns>
        public bool TryValidate(CDP4Common.DTO.Thing nestedElement)
        {
            return this.TryValidate(nestedElement, x => true);
        }
        ...
        /// True if all validation rules have passed or if none are defined.
        /// </returns>
        public bool TryValidate(CDP4Common.DTO.Thing nestedElement, Func<string, bool> validateProperty)
        {
            var applicableValidationRules = this.validationRules.Where(x => validateProperty(x.Key)).Select(x => x.Value);

            return applicableValidationRules.All(applicableRule => applicableRule.TryValidate((CDP4Common.DTO.NestedElement)nestedElement));
        }

        /// <summary>
        /// Returns the containment property value for the supplied <see cref="CDP4Common.DTO.NestedElement"/>.
        /// </summary>
        /// <param name="nestedElement">
        /// The <see cref="CDP4Common.DTO.NestedElement"/> for which to return the containment property value.
        /// </param>
        ...
        /// If the property name is not supported for the <see cref="CDP4Common.DTO.NestedElement"/>.
        /// </exception>
        public IEnumerable<Guid> GetContainmentIds(CDP4Common.DTO.Thing nestedElement, string propertyName)
        {
            if (!this.containmentPropertyValueMap.ContainsKey(propertyName))
            {
                throw new ArgumentException(string.Format("'{0}' is not a valid containment property of 'NestedElement'", propertyName));
            }

            return this.containmentPropertyValueMap[propertyName]((CDP4Common.DTO.NestedElement)nestedElement);
        }

        /// <summary>
        /// Returns the ordered containment property value for the supplied <see cref="CDP4Common.DTO.NestedElement"/>.
        /// </summary>
        /// <param name="nestedElement">
        /// The <see cref="CDP4Common.DTO.NestedElement"/> for which to return the containment property value.
        /// </param>
        ...
        /// If the property name is not supported for the <see cref="CDP4Common.DTO.NestedElement"/>.
        /// </exception>
        public IEnumerable<OrderedItem> GetOrderedContainmentIds(CDP4Common.DTO.Thing nestedElement, string propertyName)
        {
            ...
            return this.orderedContainmentPropertyValueMap[propertyName]((CDP4Common.DTO.NestedElement)nestedElement);
        }
        ...
        {
            { "NestedParameter", new PropertyMetaInfo("NestedParameter", "Guid", PropertyKind.List, AggregationKind.Composite, false, false, true, 0, "*", true) },
        };

        /// <summary>
        /// Gets the <see cref="PropertyMetaInfo"/> for the <see cref="NestedElement"/> class
        /// </summary>
        ...
        /// </summary>
        private readonly Dictionary<string, Func<CDP4Common.DTO.NestedElement, object>> propertyValueMap = new Dictionary<string, Func<CDP4Common.DTO.NestedElement, object>>
        {
            { "ClassKind", thing => thing.ClassKind },
            { "ElementUsage", thing => thing.ElementUsage },
        ...
        private readonly Dictionary<string, PropertyMetaInfo> propertyTypeMap = new Dictionary<string, PropertyMetaInfo>
        {
            ...
            { "ElementUsage", new PropertyMetaInfo("ElementUsage", "Guid", PropertyKind.OrderedList, AggregationKind.None, false, true, true, 1, "*", true) },
            ...
            { "RootElement", new PropertyMetaInfo("RootElement", "Guid", PropertyKind.Scalar, AggregationKind.None, false, false, true, 1, "1", true) },
        ...
        {
            { "ElementUsage", (value) => (Guid)value },
            { "ExcludedDomain", (value) => (Guid)value },
            { "ExcludedPerson", (value) => (Guid)value },
            { "NestedParameter", (value) => (Guid)value },
        };

        /// <summary>
        /// The property value assignment map.
        /// </summary>
        private readonly Dictionary<string, Action<CDP4Common.DTO.NestedElement, object>> propertyValueAssignmentMap = new Dictionary<string, Action<CDP4Common.DTO.NestedElement, object>>
        {
            { "Iid", (nestedElement, value) => nestedElement.Iid = (Guid)value },
        ...
        {
            { "Option", new PropertyMetaInfo("NestedElement", "Guid", PropertyKind.List, AggregationKind.Composite, false, false, true, 0, "*", true) },
        };
        ...
        /// <summary>
        /// Returns the <see cref="CDP4Common.DTO.NestedElement"/> containment property type from the supplied property name.
        /// </summary>
        /// <param name="propertyName">
        ...
        /// <summary>
        /// Returns the <see cref="CDP4Common.DTO.NestedElement"/> property type from the supplied property name.
        /// </summary>
        /// <param name="propertyName">
        /// The property name.
        /// </param>
        ...
        /// <summary>
        /// Returns the container property for the supplied type name is a possible container for <see cref="CDP4Common.DTO.NestedElement"/>.
        /// </summary>
        /// <param name="typeName">
        /// Name of the type for which to check if it is a container of <see cref="CDP4Common.DTO.NestedElement"/>.
        /// </param>
        /// <param name="containerProperty">
        /// Supplied container property info instance that will be set if the supplied type name is a container of <see cref="CDP4Common.DTO.NestedElement"/>.
        /// </param>
        /// <returns>
        /// True if the supplied typeName is a container for <see cref="CDP4Common.DTO.NestedElement"/> and sets the container property name.
        /// </returns>
        ...
        /// <summary>
        /// Check if the supplied property name for <see cref="CDP4Common.DTO.NestedElement"/> is scalar.
        /// </summary>
        /// <param name="propertyName">
        /// Name of the property for which to check if it is scalar.
        /// </param>
        ...
        public bool ApplyPropertyUpdate(CDP4Common.DTO.Thing updatableThing, string propertyName, object value)
        {
            ...
            this.propertyValueAssignmentMap[propertyName]((CDP4Common.DTO.NestedElement)updatableThing, value);
        ...
        public object DeserializeCollectionValue(string propertyName, object value)
        {
            ...
            {
                throw new ArgumentException(string.Format("'{0}' is not a valid collection property of 'NestedElement'", propertyName));
            }
        ...
        public object GetValue(string propertyName, CDP4Common.DTO.Thing thing)
        {
            ...
            return this.propertyValueMap[propertyName]((CDP4Common.DTO.NestedElement)thing);
        }
        ...
        /// <summary>
        /// Instantiates a <see cref="CDP4Common.DTO.NestedElement"/>
        /// </summary>
        /// <returns>
        ...
        {
            return new CDP4Common.DTO.NestedElement(guid, revisionNumber);
        }
    }
}
