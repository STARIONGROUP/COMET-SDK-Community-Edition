// --------------------------------------------------------------------------------------------------------------------
// <copyright file="ParameterSubscriptionMetaInfo.cs" company="Starion Group S.A.">
...
namespace CDP4Common.MetaInfo
{
    ...
    public partial class ParameterSubscriptionMetaInfo : IParameterSubscriptionMetaInfo
    {
        ...
        public IEnumerable<Guid> GetContainmentIds(CDP4Common.DTO.Thing parameterSubscription, string propertyName)
        {
            ...
            {
                throw new ArgumentException($"'{propertyName}' is not a valid containment property of 'ParameterSubscription'");
            }
        ...
        {
            { "Actor", (parameterSubscription, value) => parameterSubscription.Actor = value == null ? (Guid?)null : (Guid)value },
            ...
            { "ThingPreference", (parameterSubscription, value) => parameterSubscription.ThingPreference = value == null ? (string)null : value.ToString() },
        };
        ...
        public object DeserializeCollectionValue(string propertyName, object value)
        {
            ...
            {
                throw new ArgumentException($"'{propertyName}' is not a valid collection property of 'ParameterSubscription'");
            }
