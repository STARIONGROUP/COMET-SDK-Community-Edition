// --------------------------------------------------------------------------------------------------------------------
// <copyright file="OptionMetaInfo.cs" company="RHEA System S.A.">
...
namespace CDP4Common.MetaInfo
{
    ...
    /// <summary>
    /// This a class that holds meta info for <see cref="Option"/>.
    /// </summary>
    public partial class OptionMetaInfo : IOptionMetaInfo
    {
        /// <summary>
        /// The containment property value map.
        /// </summary>
        private readonly Dictionary<string, Func<CDP4Common.DTO.Option, IEnumerable<Guid>>> containmentPropertyValueMap = new Dictionary<string, Func<CDP4Common.DTO.Option, IEnumerable<Guid>>>
        {
            { "Alias", option => option.Alias },
            { "Attachment", option => option.Attachment },
            { "Definition", option => option.Definition },
            { "HyperLink", option => option.HyperLink },
            { "NestedElement", option => option.NestedElement },
        };

        /// <summary>
        /// The ordered containment property value map.
        /// </summary>
        private readonly Dictionary<string, Func<CDP4Common.DTO.Option, IEnumerable<OrderedItem>>> orderedContainmentPropertyValueMap = new Dictionary<string, Func<CDP4Common.DTO.Option, IEnumerable<OrderedItem>>>();

        /// <summary>
        /// The validation rules that should pass for an instance of <see cref="CDP4Common.DTO.Option"/>.
        /// </summary>
        private readonly Dictionary<string, DtoValidationHelper<CDP4Common.DTO.Option>> validationRules = new Dictionary<string, DtoValidationHelper<CDP4Common.DTO.Option>>
        {
            { "Alias", new DtoValidationHelper<CDP4Common.DTO.Option>(item => item.Alias != null, "The 'Alias' property of a 'Option' is mandatory and cannot be null.") },
            { "Attachment", new DtoValidationHelper<CDP4Common.DTO.Option>(item => item.Attachment != null, "The 'Attachment' property of a 'Option' is mandatory and cannot be null.") },
            { "Category", new DtoValidationHelper<CDP4Common.DTO.Option>(item => item.Category != null, "The 'Category' property of a 'Option' is mandatory and cannot be null.") },
            { "Definition", new DtoValidationHelper<CDP4Common.DTO.Option>(item => item.Definition != null, "The 'Definition' property of a 'Option' is mandatory and cannot be null.") },
            { "ExcludedDomain", new DtoValidationHelper<CDP4Common.DTO.Option>(item => item.ExcludedDomain != null, "The 'ExcludedDomain' property of a 'Option' is mandatory and cannot be null.") },
            { "ExcludedPerson", new DtoValidationHelper<CDP4Common.DTO.Option>(item => item.ExcludedPerson != null, "The 'ExcludedPerson' property of a 'Option' is mandatory and cannot be null.") },
            { "HyperLink", new DtoValidationHelper<CDP4Common.DTO.Option>(item => item.HyperLink != null, "The 'HyperLink' property of a 'Option' is mandatory and cannot be null.") },
            { "Name", new DtoValidationHelper<CDP4Common.DTO.Option>(item => !string.IsNullOrWhiteSpace(item.Name), "The 'Name' property of a 'Option' is mandatory and cannot be empty or null.") },
            { "NestedElement", new DtoValidationHelper<CDP4Common.DTO.Option>(item => item.NestedElement != null, "The 'NestedElement' property of a 'Option' is mandatory and cannot be null.") },
            { "ShortName", new DtoValidationHelper<CDP4Common.DTO.Option>(item => !string.IsNullOrWhiteSpace(item.ShortName), "The 'ShortName' property of a 'Option' is mandatory and cannot be empty or null.") },
        };
        ...
        /// </exception>
        public void Validate(CDP4Common.DTO.Thing option)
        {
            this.Validate(option, x => true);
        }
        ...
        /// If any validation rule failed.
        /// </exception>
        public void Validate(CDP4Common.DTO.Thing option, Func<string, bool> validateProperty)
        {
            foreach (var applicableRule in this.validationRules.Where(x => validateProperty(x.Key)))
            {
                applicableRule.Value.Validate((CDP4Common.DTO.Option)option);
            }
        }
        ...
        /// </returns>
        public bool TryValidate(CDP4Common.DTO.Thing option)
        {
            return this.TryValidate(option, x => true);
        }
        ...
        /// True if all validation rules have passed or if none are defined.
        /// </returns>
        public bool TryValidate(CDP4Common.DTO.Thing option, Func<string, bool> validateProperty)
        {
            var applicableValidationRules = this.validationRules.Where(x => validateProperty(x.Key)).Select(x => x.Value);

            return applicableValidationRules.All(applicableRule => applicableRule.TryValidate((CDP4Common.DTO.Option)option));
        }

        /// <summary>
        /// Returns the containment property value for the supplied <see cref="CDP4Common.DTO.Option"/>.
        /// </summary>
        /// <param name="option">
        /// The <see cref="CDP4Common.DTO.Option"/> for which to return the containment property value.
        /// </param>
        ...
        /// If the property name is not supported for the <see cref="CDP4Common.DTO.Option"/>.
        /// </exception>
        public IEnumerable<Guid> GetContainmentIds(CDP4Common.DTO.Thing option, string propertyName)
        {
            if (!this.containmentPropertyValueMap.ContainsKey(propertyName))
            {
                throw new ArgumentException($"'{propertyName}' is not a valid containment property of 'Option'");
            }

            return this.containmentPropertyValueMap[propertyName]((CDP4Common.DTO.Option)option);
        }

        /// <summary>
        /// Returns the ordered containment property value for the supplied <see cref="CDP4Common.DTO.Option"/>.
        /// </summary>
        /// <param name="option">
        /// The <see cref="CDP4Common.DTO.Option"/> for which to return the containment property value.
        /// </param>
        ...
        /// If the property name is not supported for the <see cref="CDP4Common.DTO.Option"/>.
        /// </exception>
        public IEnumerable<OrderedItem> GetOrderedContainmentIds(CDP4Common.DTO.Thing option, string propertyName)
        {
            ...
            return this.orderedContainmentPropertyValueMap[propertyName]((CDP4Common.DTO.Option)option);
        }
        ...
        private readonly Dictionary<string, PropertyMetaInfo> containmentTypeMap = new Dictionary<string, PropertyMetaInfo>
        {
            ...
            { "NestedElement", new PropertyMetaInfo("NestedElement", "NestedElement", PropertyKind.List, AggregationKind.Composite, false, false, true, 0, "*", true) },
        };

        /// <summary>
        /// Gets the <see cref="PropertyMetaInfo"/> for the <see cref="Option"/> class
        /// </summary>
        ...
        /// </summary>
        private readonly Dictionary<string, Func<CDP4Common.DTO.Option, object>> propertyValueMap = new Dictionary<string, Func<CDP4Common.DTO.Option, object>>
        {
            ...
            { "NestedElement", thing => thing.NestedElement },
        ...
        private readonly Dictionary<string, Func<object, object>> collectionPropertyValueDeserializationMap = new Dictionary<string, Func<object, object>>
        {
            ...
            { "NestedElement", (value) => (Guid)value },
        };

        /// <summary>
        /// The property value assignment map.
        /// </summary>
        private readonly Dictionary<string, Action<CDP4Common.DTO.Option, object>> propertyValueAssignmentMap = new Dictionary<string, Action<CDP4Common.DTO.Option, object>>
        {
            { "Actor", (option, value) => option.Actor = value == null ? (Guid?)null : (Guid)value },
            { "Iid", (option, value) => option.Iid = (Guid)value },
            { "ModifiedOn", (option, value) => option.ModifiedOn = (DateTime)value },
            { "Name", (option, value) => option.Name = value.ToString() },
            { "ShortName", (option, value) => option.ShortName = value.ToString() },
            { "ThingPreference", (option, value) => option.ThingPreference = value == null ? (string)null : value.ToString() },
        };
        ...
        {
            { "Iteration", new PropertyMetaInfo("Option", "Option", PropertyKind.OrderedList, AggregationKind.Composite, false, true, true, 1, "*", true) },
        };
        ...
        /// <summary>
        /// Returns the <see cref="CDP4Common.DTO.Option"/> containment property type from the supplied property name.
        /// </summary>
        /// <param name="propertyName">
        ...
        /// <summary>
        /// Returns the <see cref="CDP4Common.DTO.Option"/> property type from the supplied property name.
        /// </summary>
        /// <param name="propertyName">
        /// The property name.
        /// </param>
        ...
        /// <summary>
        /// Returns the container property for the supplied type name is a possible container for <see cref="CDP4Common.DTO.Option"/>.
        /// </summary>
        /// <param name="typeName">
        /// Name of the type for which to check if it is a container of <see cref="CDP4Common.DTO.Option"/>.
        /// </param>
        /// <param name="containerProperty">
        /// Supplied container property info instance that will be set if the supplied type name is a container of <see cref="CDP4Common.DTO.Option"/>.
        /// </param>
        /// <returns>
        /// True if the supplied typeName is a container for <see cref="CDP4Common.DTO.Option"/> and sets the container property name.
        /// </returns>
        ...
        /// <summary>
        /// Check if the supplied property name for <see cref="CDP4Common.DTO.Option"/> is scalar.
        /// </summary>
        /// <param name="propertyName">
        /// Name of the property for which to check if it is scalar.
        /// </param>
        ...
        public bool ApplyPropertyUpdate(CDP4Common.DTO.Thing updatableThing, string propertyName, object value)
        {
            ...
            this.propertyValueAssignmentMap[propertyName]((CDP4Common.DTO.Option)updatableThing, value);
        ...
        public object DeserializeCollectionValue(string propertyName, object value)
        {
            ...
            {
                throw new ArgumentException($"'{propertyName}' is not a valid collection property of 'Option'");
            }
        ...
        public object GetValue(string propertyName, CDP4Common.DTO.Thing thing)
        {
            ...
            return this.propertyValueMap[propertyName]((CDP4Common.DTO.Option)thing);
        }
        ...
        /// <summary>
        /// Instantiates a <see cref="CDP4Common.DTO.Option"/>
        /// </summary>
        /// <returns>
        ...
        {
            return new CDP4Common.DTO.Option(guid, revisionNumber);
        }
    }
}
