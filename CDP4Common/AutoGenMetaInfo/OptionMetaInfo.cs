...
namespace CDP4Common.MetaInfo
{
    ...
    public partial class OptionMetaInfo : IOptionMetaInfo
    {
        ...
        private readonly Dictionary<string, PropertyMetaInfo> containmentTypeMap = new Dictionary<string, PropertyMetaInfo>
        {
            ...
            { "NestedElement", new PropertyMetaInfo("NestedElement", "Guid", PropertyKind.List, AggregationKind.Composite, false, false, true, 0, "*", true) },
        };
        ...
        {
            { "Iteration", new PropertyMetaInfo("Option", "Guid", PropertyKind.OrderedList, AggregationKind.Composite, false, true, true, 1, "*", true) },
        };
