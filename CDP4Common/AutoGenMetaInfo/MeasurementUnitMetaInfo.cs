// --------------------------------------------------------------------------------------------------------------------
// <copyright file="MeasurementUnitMetaInfo.cs" company="RHEA System S.A.">
...
namespace CDP4Common.MetaInfo
{
    ...
    /// <summary>
    /// This a class that holds meta info for <see cref="MeasurementUnit"/>.
    /// </summary>
    public partial class MeasurementUnitMetaInfo : IMeasurementUnitMetaInfo
    {
        /// <summary>
        /// The containment property value map.
        /// </summary>
        private readonly Dictionary<string, Func<CDP4Common.DTO.MeasurementUnit, IEnumerable<Guid>>> containmentPropertyValueMap = new Dictionary<string, Func<CDP4Common.DTO.MeasurementUnit, IEnumerable<Guid>>>
        {
            { "Alias", measurementUnit => measurementUnit.Alias },
            { "Attachment", measurementUnit => measurementUnit.Attachment },
            { "Definition", measurementUnit => measurementUnit.Definition },
            { "HyperLink", measurementUnit => measurementUnit.HyperLink },
        };

        /// <summary>
        /// The ordered containment property value map.
        /// </summary>
        private readonly Dictionary<string, Func<CDP4Common.DTO.MeasurementUnit, IEnumerable<OrderedItem>>> orderedContainmentPropertyValueMap = new Dictionary<string, Func<CDP4Common.DTO.MeasurementUnit, IEnumerable<OrderedItem>>>();

        /// <summary>
        /// The validation rules that should pass for an instance of <see cref="CDP4Common.DTO.MeasurementUnit"/>.
        /// </summary>
        private readonly Dictionary<string, DtoValidationHelper<CDP4Common.DTO.MeasurementUnit>> validationRules = new Dictionary<string, DtoValidationHelper<CDP4Common.DTO.MeasurementUnit>>
        {
            { "Alias", new DtoValidationHelper<CDP4Common.DTO.MeasurementUnit>(item => item.Alias != null, "The 'Alias' property of a 'MeasurementUnit' is mandatory and cannot be null.") },
            { "Attachment", new DtoValidationHelper<CDP4Common.DTO.MeasurementUnit>(item => item.Attachment != null, "The 'Attachment' property of a 'MeasurementUnit' is mandatory and cannot be null.") },
            { "Definition", new DtoValidationHelper<CDP4Common.DTO.MeasurementUnit>(item => item.Definition != null, "The 'Definition' property of a 'MeasurementUnit' is mandatory and cannot be null.") },
            { "ExcludedDomain", new DtoValidationHelper<CDP4Common.DTO.MeasurementUnit>(item => item.ExcludedDomain != null, "The 'ExcludedDomain' property of a 'MeasurementUnit' is mandatory and cannot be null.") },
            { "ExcludedPerson", new DtoValidationHelper<CDP4Common.DTO.MeasurementUnit>(item => item.ExcludedPerson != null, "The 'ExcludedPerson' property of a 'MeasurementUnit' is mandatory and cannot be null.") },
            { "HyperLink", new DtoValidationHelper<CDP4Common.DTO.MeasurementUnit>(item => item.HyperLink != null, "The 'HyperLink' property of a 'MeasurementUnit' is mandatory and cannot be null.") },
            { "Name", new DtoValidationHelper<CDP4Common.DTO.MeasurementUnit>(item => !string.IsNullOrWhiteSpace(item.Name), "The 'Name' property of a 'MeasurementUnit' is mandatory and cannot be empty or null.") },
            { "ShortName", new DtoValidationHelper<CDP4Common.DTO.MeasurementUnit>(item => !string.IsNullOrWhiteSpace(item.ShortName), "The 'ShortName' property of a 'MeasurementUnit' is mandatory and cannot be empty or null.") },
        };
        ...
        /// </exception>
        public void Validate(CDP4Common.DTO.Thing measurementUnit)
        {
            this.Validate(measurementUnit, x => true);
        }
        ...
        /// If any validation rule failed.
        /// </exception>
        public void Validate(CDP4Common.DTO.Thing measurementUnit, Func<string, bool> validateProperty)
        {
            foreach (var applicableRule in this.validationRules.Where(x => validateProperty(x.Key)))
            {
                applicableRule.Value.Validate((CDP4Common.DTO.MeasurementUnit)measurementUnit);
            }
        }
        ...
        /// </returns>
        public bool TryValidate(CDP4Common.DTO.Thing measurementUnit)
        {
            return this.TryValidate(measurementUnit, x => true);
        }
        ...
        /// True if all validation rules have passed or if none are defined.
        /// </returns>
        public bool TryValidate(CDP4Common.DTO.Thing measurementUnit, Func<string, bool> validateProperty)
        {
            var applicableValidationRules = this.validationRules.Where(x => validateProperty(x.Key)).Select(x => x.Value);

            return applicableValidationRules.All(applicableRule => applicableRule.TryValidate((CDP4Common.DTO.MeasurementUnit)measurementUnit));
        }

        /// <summary>
        /// Returns the containment property value for the supplied <see cref="CDP4Common.DTO.MeasurementUnit"/>.
        /// </summary>
        /// <param name="measurementUnit">
        /// The <see cref="CDP4Common.DTO.MeasurementUnit"/> for which to return the containment property value.
        /// </param>
        ...
        /// If the property name is not supported for the <see cref="CDP4Common.DTO.MeasurementUnit"/>.
        /// </exception>
        public IEnumerable<Guid> GetContainmentIds(CDP4Common.DTO.Thing measurementUnit, string propertyName)
        {
            if (!this.containmentPropertyValueMap.ContainsKey(propertyName))
            {
                throw new ArgumentException($"'{propertyName}' is not a valid containment property of 'MeasurementUnit'");
            }

            return this.containmentPropertyValueMap[propertyName]((CDP4Common.DTO.MeasurementUnit)measurementUnit);
        }

        /// <summary>
        /// Returns the ordered containment property value for the supplied <see cref="CDP4Common.DTO.MeasurementUnit"/>.
        /// </summary>
        /// <param name="measurementUnit">
        /// The <see cref="CDP4Common.DTO.MeasurementUnit"/> for which to return the containment property value.
        /// </param>
        ...
        /// If the property name is not supported for the <see cref="CDP4Common.DTO.MeasurementUnit"/>.
        /// </exception>
        public IEnumerable<OrderedItem> GetOrderedContainmentIds(CDP4Common.DTO.Thing measurementUnit, string propertyName)
        {
            ...
            return this.orderedContainmentPropertyValueMap[propertyName]((CDP4Common.DTO.MeasurementUnit)measurementUnit);
        }
        ...
        /// <summary>
        /// Gets the <see cref="PropertyMetaInfo"/> for the <see cref="MeasurementUnit"/> class
        /// </summary>
        ...
        /// </summary>
        private readonly Dictionary<string, Func<CDP4Common.DTO.MeasurementUnit, object>> propertyValueMap = new Dictionary<string, Func<CDP4Common.DTO.MeasurementUnit, object>>
        {
        ...
        /// </summary>
        private readonly Dictionary<string, Action<CDP4Common.DTO.MeasurementUnit, object>> propertyValueAssignmentMap = new Dictionary<string, Action<CDP4Common.DTO.MeasurementUnit, object>>
        {
            { "Actor", (measurementUnit, value) => measurementUnit.Actor = value == null ? (Guid?)null : (Guid)value },
            { "Iid", (measurementUnit, value) => measurementUnit.Iid = (Guid)value },
            { "IsDeprecated", (measurementUnit, value) => measurementUnit.IsDeprecated = (bool)value },
            { "ModifiedOn", (measurementUnit, value) => measurementUnit.ModifiedOn = (DateTime)value },
            { "Name", (measurementUnit, value) => measurementUnit.Name = value.ToString() },
            { "ShortName", (measurementUnit, value) => measurementUnit.ShortName = value.ToString() },
            { "ThingPreference", (measurementUnit, value) => measurementUnit.ThingPreference = value == null ? (string)null : value.ToString() },
        };
        ...
        /// <summary>
        /// Returns the <see cref="CDP4Common.DTO.MeasurementUnit"/> containment property type from the supplied property name.
        /// </summary>
        /// <param name="propertyName">
        ...
        /// <summary>
        /// Returns the <see cref="CDP4Common.DTO.MeasurementUnit"/> property type from the supplied property name.
        /// </summary>
        /// <param name="propertyName">
        /// The property name.
        /// </param>
        ...
        /// <summary>
        /// Returns the container property for the supplied type name is a possible container for <see cref="CDP4Common.DTO.MeasurementUnit"/>.
        /// </summary>
        /// <param name="typeName">
        /// Name of the type for which to check if it is a container of <see cref="CDP4Common.DTO.MeasurementUnit"/>.
        /// </param>
        /// <param name="containerProperty">
        /// Supplied container property info instance that will be set if the supplied type name is a container of <see cref="CDP4Common.DTO.MeasurementUnit"/>.
        /// </param>
        /// <returns>
        /// True if the supplied typeName is a container for <see cref="CDP4Common.DTO.MeasurementUnit"/> and sets the container property name.
        /// </returns>
        ...
        /// <summary>
        /// Check if the supplied property name for <see cref="CDP4Common.DTO.MeasurementUnit"/> is scalar.
        /// </summary>
        /// <param name="propertyName">
        /// Name of the property for which to check if it is scalar.
        /// </param>
        ...
        public bool ApplyPropertyUpdate(CDP4Common.DTO.Thing updatableThing, string propertyName, object value)
        {
            ...
            this.propertyValueAssignmentMap[propertyName]((CDP4Common.DTO.MeasurementUnit)updatableThing, value);
        ...
        public object DeserializeCollectionValue(string propertyName, object value)
        {
            ...
            {
                throw new ArgumentException($"'{propertyName}' is not a valid collection property of 'MeasurementUnit'");
            }
        ...
        public object GetValue(string propertyName, CDP4Common.DTO.Thing thing)
        {
            ...
            return this.propertyValueMap[propertyName]((CDP4Common.DTO.MeasurementUnit)thing);
        }
        ...
        /// <summary>
        /// Instantiates a <see cref="CDP4Common.DTO.MeasurementUnit"/>
        /// </summary>
        /// <returns>
