...
namespace CDP4Common.MetaInfo
{
    ...
    public partial class MeasurementUnitMetaInfo : IMeasurementUnitMetaInfo
    {
        ...
        public IEnumerable<Guid> GetContainmentIds(CDP4Common.DTO.Thing measurementUnit, string propertyName)
        {
            ...
            {
                throw new ArgumentException(string.Format("'{0}' is not a valid containment property of 'MeasurementUnit'", propertyName));
            }
        ...
        public object DeserializeCollectionValue(string propertyName, object value)
        {
            ...
            {
                throw new ArgumentException(string.Format("'{0}' is not a valid collection property of 'MeasurementUnit'", propertyName));
            }
