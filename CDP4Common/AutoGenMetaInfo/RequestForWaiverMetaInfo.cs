...
namespace CDP4Common.MetaInfo
{
    ...
    public partial class RequestForWaiverMetaInfo : IRequestForWaiverMetaInfo
    {
        ...
        public IEnumerable<Guid> GetContainmentIds(CDP4Common.DTO.Thing requestForWaiver, string propertyName)
        {
            ...
            {
                throw new ArgumentException(string.Format("'{0}' is not a valid containment property of 'RequestForWaiver'", propertyName));
            }
        ...
        public object DeserializeCollectionValue(string propertyName, object value)
        {
            ...
            {
                throw new ArgumentException(string.Format("'{0}' is not a valid collection property of 'RequestForWaiver'", propertyName));
            }
