// --------------------------------------------------------------------------------------------------------------------
// <copyright file="RequestForWaiverMetaInfo.cs" company="Starion Group S.A.">
...
namespace CDP4Common.MetaInfo
{
    ...
    /// <summary>
    /// This a class that holds meta info for <see cref="RequestForWaiver"/>.
    /// </summary>
    public partial class RequestForWaiverMetaInfo : IRequestForWaiverMetaInfo
    {
        /// <summary>
        /// The containment property value map.
        /// </summary>
        private readonly Dictionary<string, Func<CDP4Common.DTO.RequestForWaiver, IEnumerable<Guid>>> containmentPropertyValueMap = new Dictionary<string, Func<CDP4Common.DTO.RequestForWaiver, IEnumerable<Guid>>>
        {
            { "ApprovedBy", requestForWaiver => requestForWaiver.ApprovedBy },
            { "Discussion", requestForWaiver => requestForWaiver.Discussion },
            { "RelatedThing", requestForWaiver => requestForWaiver.RelatedThing },
        };

        /// <summary>
        /// The ordered containment property value map.
        /// </summary>
        private readonly Dictionary<string, Func<CDP4Common.DTO.RequestForWaiver, IEnumerable<OrderedItem>>> orderedContainmentPropertyValueMap = new Dictionary<string, Func<CDP4Common.DTO.RequestForWaiver, IEnumerable<OrderedItem>>>();

        /// <summary>
        /// The validation rules that should pass for an instance of <see cref="CDP4Common.DTO.RequestForWaiver"/>.
        /// </summary>
        private readonly Dictionary<string, DtoValidationHelper<CDP4Common.DTO.RequestForWaiver>> validationRules = new Dictionary<string, DtoValidationHelper<CDP4Common.DTO.RequestForWaiver>>
        {
            { "ApprovedBy", new DtoValidationHelper<CDP4Common.DTO.RequestForWaiver>(item => item.ApprovedBy != null, "The 'ApprovedBy' property of a 'RequestForWaiver' is mandatory and cannot be null.") },
            { "Category", new DtoValidationHelper<CDP4Common.DTO.RequestForWaiver>(item => item.Category != null, "The 'Category' property of a 'RequestForWaiver' is mandatory and cannot be null.") },
            { "Content", new DtoValidationHelper<CDP4Common.DTO.RequestForWaiver>(item => !string.IsNullOrWhiteSpace(item.Content), "The 'Content' property of a 'RequestForWaiver' is mandatory and cannot be empty or null.") },
            { "Discussion", new DtoValidationHelper<CDP4Common.DTO.RequestForWaiver>(item => item.Discussion != null, "The 'Discussion' property of a 'RequestForWaiver' is mandatory and cannot be null.") },
            { "ExcludedDomain", new DtoValidationHelper<CDP4Common.DTO.RequestForWaiver>(item => item.ExcludedDomain != null, "The 'ExcludedDomain' property of a 'RequestForWaiver' is mandatory and cannot be null.") },
            { "ExcludedPerson", new DtoValidationHelper<CDP4Common.DTO.RequestForWaiver>(item => item.ExcludedPerson != null, "The 'ExcludedPerson' property of a 'RequestForWaiver' is mandatory and cannot be null.") },
            { "LanguageCode", new DtoValidationHelper<CDP4Common.DTO.RequestForWaiver>(item => !string.IsNullOrWhiteSpace(item.LanguageCode), "The 'LanguageCode' property of a 'RequestForWaiver' is mandatory and cannot be empty or null.") },
            { "RelatedThing", new DtoValidationHelper<CDP4Common.DTO.RequestForWaiver>(item => item.RelatedThing != null, "The 'RelatedThing' property of a 'RequestForWaiver' is mandatory and cannot be null.") },
            { "ShortName", new DtoValidationHelper<CDP4Common.DTO.RequestForWaiver>(item => !string.IsNullOrWhiteSpace(item.ShortName), "The 'ShortName' property of a 'RequestForWaiver' is mandatory and cannot be empty or null.") },
            { "SourceAnnotation", new DtoValidationHelper<CDP4Common.DTO.RequestForWaiver>(item => item.SourceAnnotation != null, "The 'SourceAnnotation' property of a 'RequestForWaiver' is mandatory and cannot be null.") },
            { "Title", new DtoValidationHelper<CDP4Common.DTO.RequestForWaiver>(item => !string.IsNullOrWhiteSpace(item.Title), "The 'Title' property of a 'RequestForWaiver' is mandatory and cannot be empty or null.") },
        };
        ...
        /// </exception>
        public void Validate(CDP4Common.DTO.Thing requestForWaiver)
        {
            this.Validate(requestForWaiver, x => true);
        }
        ...
        /// If any validation rule failed.
        /// </exception>
        public void Validate(CDP4Common.DTO.Thing requestForWaiver, Func<string, bool> validateProperty)
        {
            foreach (var applicableRule in this.validationRules.Where(x => validateProperty(x.Key)))
            {
                applicableRule.Value.Validate((CDP4Common.DTO.RequestForWaiver)requestForWaiver);
            }
        }
        ...
        /// </returns>
        public bool TryValidate(CDP4Common.DTO.Thing requestForWaiver)
        {
            return this.TryValidate(requestForWaiver, x => true);
        }
        ...
        /// True if all validation rules have passed or if none are defined.
        /// </returns>
        public bool TryValidate(CDP4Common.DTO.Thing requestForWaiver, Func<string, bool> validateProperty)
        {
            var applicableValidationRules = this.validationRules.Where(x => validateProperty(x.Key)).Select(x => x.Value);

            return applicableValidationRules.All(applicableRule => applicableRule.TryValidate((CDP4Common.DTO.RequestForWaiver)requestForWaiver));
        }

        /// <summary>
        /// Returns the containment property value for the supplied <see cref="CDP4Common.DTO.RequestForWaiver"/>.
        /// </summary>
        /// <param name="requestForWaiver">
        /// The <see cref="CDP4Common.DTO.RequestForWaiver"/> for which to return the containment property value.
        /// </param>
        ...
        /// If the property name is not supported for the <see cref="CDP4Common.DTO.RequestForWaiver"/>.
        /// </exception>
        public IEnumerable<Guid> GetContainmentIds(CDP4Common.DTO.Thing requestForWaiver, string propertyName)
        {
            if (!this.containmentPropertyValueMap.ContainsKey(propertyName))
            {
                throw new ArgumentException($"'{propertyName}' is not a valid containment property of 'RequestForWaiver'");
            }

            return this.containmentPropertyValueMap[propertyName]((CDP4Common.DTO.RequestForWaiver)requestForWaiver);
        }

        /// <summary>
        /// Returns the ordered containment property value for the supplied <see cref="CDP4Common.DTO.RequestForWaiver"/>.
        /// </summary>
        /// <param name="requestForWaiver">
        /// The <see cref="CDP4Common.DTO.RequestForWaiver"/> for which to return the containment property value.
        /// </param>
        ...
        /// If the property name is not supported for the <see cref="CDP4Common.DTO.RequestForWaiver"/>.
        /// </exception>
        public IEnumerable<OrderedItem> GetOrderedContainmentIds(CDP4Common.DTO.Thing requestForWaiver, string propertyName)
        {
            ...
            return this.orderedContainmentPropertyValueMap[propertyName]((CDP4Common.DTO.RequestForWaiver)requestForWaiver);
        }
        ...
        /// <summary>
        /// Gets the <see cref="PropertyMetaInfo"/> for the <see cref="RequestForWaiver"/> class
        /// </summary>
        ...
        /// </summary>
        private readonly Dictionary<string, Func<CDP4Common.DTO.RequestForWaiver, object>> propertyValueMap = new Dictionary<string, Func<CDP4Common.DTO.RequestForWaiver, object>>
        {
        ...
        /// </summary>
        private readonly Dictionary<string, Action<CDP4Common.DTO.RequestForWaiver, object>> propertyValueAssignmentMap = new Dictionary<string, Action<CDP4Common.DTO.RequestForWaiver, object>>
        {
            { "Actor", (requestForWaiver, value) => requestForWaiver.Actor = value == null ? (Guid?)null : (Guid)value },
            { "Author", (requestForWaiver, value) => requestForWaiver.Author = (Guid)value },
            { "Classification", (requestForWaiver, value) => requestForWaiver.Classification = (AnnotationClassificationKind)value },
            { "Content", (requestForWaiver, value) => requestForWaiver.Content = value.ToString() },
            { "CreatedOn", (requestForWaiver, value) => requestForWaiver.CreatedOn = (DateTime)value },
            { "Iid", (requestForWaiver, value) => requestForWaiver.Iid = (Guid)value },
            { "LanguageCode", (requestForWaiver, value) => requestForWaiver.LanguageCode = value.ToString() },
            { "ModifiedOn", (requestForWaiver, value) => requestForWaiver.ModifiedOn = (DateTime)value },
            { "Owner", (requestForWaiver, value) => requestForWaiver.Owner = (Guid)value },
        ...
        /// <summary>
        /// Returns the <see cref="CDP4Common.DTO.RequestForWaiver"/> containment property type from the supplied property name.
        /// </summary>
        /// <param name="propertyName">
        ...
        /// <summary>
        /// Returns the <see cref="CDP4Common.DTO.RequestForWaiver"/> property type from the supplied property name.
        /// </summary>
        /// <param name="propertyName">
        /// The property name.
        /// </param>
        ...
        /// <summary>
        /// Returns the container property for the supplied type name is a possible container for <see cref="CDP4Common.DTO.RequestForWaiver"/>.
        /// </summary>
        /// <param name="typeName">
        /// Name of the type for which to check if it is a container of <see cref="CDP4Common.DTO.RequestForWaiver"/>.
        /// </param>
        /// <param name="containerProperty">
        /// Supplied container property info instance that will be set if the supplied type name is a container of <see cref="CDP4Common.DTO.RequestForWaiver"/>.
        /// </param>
        /// <returns>
        /// True if the supplied typeName is a container for <see cref="CDP4Common.DTO.RequestForWaiver"/> and sets the container property name.
        /// </returns>
        ...
        /// <summary>
        /// Check if the supplied property name for <see cref="CDP4Common.DTO.RequestForWaiver"/> is scalar.
        /// </summary>
        /// <param name="propertyName">
        /// Name of the property for which to check if it is scalar.
        /// </param>
        ...
        public bool ApplyPropertyUpdate(CDP4Common.DTO.Thing updatableThing, string propertyName, object value)
        {
            ...
            this.propertyValueAssignmentMap[propertyName]((CDP4Common.DTO.RequestForWaiver)updatableThing, value);
        ...
        public object DeserializeCollectionValue(string propertyName, object value)
        {
            ...
            {
                throw new ArgumentException($"'{propertyName}' is not a valid collection property of 'RequestForWaiver'");
            }
        ...
        public object GetValue(string propertyName, CDP4Common.DTO.Thing thing)
        {
            ...
            return this.propertyValueMap[propertyName]((CDP4Common.DTO.RequestForWaiver)thing);
        }
        ...
        /// <summary>
        /// Instantiates a <see cref="CDP4Common.DTO.RequestForWaiver"/>
        /// </summary>
        /// <returns>
        ...
        {
            return new CDP4Common.DTO.RequestForWaiver(guid, revisionNumber);
        }
    }
}
