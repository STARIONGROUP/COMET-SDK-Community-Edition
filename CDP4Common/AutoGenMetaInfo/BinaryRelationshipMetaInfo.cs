...
namespace CDP4Common.MetaInfo
{
    ...
    public partial class BinaryRelationshipMetaInfo : IBinaryRelationshipMetaInfo
    {
        ...
        public IEnumerable<Guid> GetContainmentIds(CDP4Common.DTO.Thing binaryRelationship, string propertyName)
        {
            ...
            {
                throw new ArgumentException(string.Format("'{0}' is not a valid containment property of 'BinaryRelationship'", propertyName));
            }
        ...
        public object DeserializeCollectionValue(string propertyName, object value)
        {
            ...
            {
                throw new ArgumentException(string.Format("'{0}' is not a valid collection property of 'BinaryRelationship'", propertyName));
            }
