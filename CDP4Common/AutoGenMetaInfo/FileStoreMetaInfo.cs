// --------------------------------------------------------------------------------------------------------------------
// <copyright file="FileStoreMetaInfo.cs" company="Starion Group S.A.">
...
namespace CDP4Common.MetaInfo
{
    ...
    /// <summary>
    /// This a class that holds meta info for <see cref="FileStore"/>.
    /// </summary>
    public partial class FileStoreMetaInfo : IFileStoreMetaInfo
    {
        /// <summary>
        /// The containment property value map.
        /// </summary>
        private readonly Dictionary<string, Func<CDP4Common.DTO.FileStore, IEnumerable<Guid>>> containmentPropertyValueMap = new Dictionary<string, Func<CDP4Common.DTO.FileStore, IEnumerable<Guid>>>
        {
            { "File", fileStore => fileStore.File },
            { "Folder", fileStore => fileStore.Folder },
        };

        /// <summary>
        /// The ordered containment property value map.
        /// </summary>
        private readonly Dictionary<string, Func<CDP4Common.DTO.FileStore, IEnumerable<OrderedItem>>> orderedContainmentPropertyValueMap = new Dictionary<string, Func<CDP4Common.DTO.FileStore, IEnumerable<OrderedItem>>>();

        /// <summary>
        /// The validation rules that should pass for an instance of <see cref="CDP4Common.DTO.FileStore"/>.
        /// </summary>
        private readonly Dictionary<string, DtoValidationHelper<CDP4Common.DTO.FileStore>> validationRules = new Dictionary<string, DtoValidationHelper<CDP4Common.DTO.FileStore>>
        {
            { "ExcludedDomain", new DtoValidationHelper<CDP4Common.DTO.FileStore>(item => item.ExcludedDomain != null, "The 'ExcludedDomain' property of a 'FileStore' is mandatory and cannot be null.") },
            { "ExcludedPerson", new DtoValidationHelper<CDP4Common.DTO.FileStore>(item => item.ExcludedPerson != null, "The 'ExcludedPerson' property of a 'FileStore' is mandatory and cannot be null.") },
            { "File", new DtoValidationHelper<CDP4Common.DTO.FileStore>(item => item.File != null, "The 'File' property of a 'FileStore' is mandatory and cannot be null.") },
            { "Folder", new DtoValidationHelper<CDP4Common.DTO.FileStore>(item => item.Folder != null, "The 'Folder' property of a 'FileStore' is mandatory and cannot be null.") },
            { "Name", new DtoValidationHelper<CDP4Common.DTO.FileStore>(item => !string.IsNullOrWhiteSpace(item.Name), "The 'Name' property of a 'FileStore' is mandatory and cannot be empty or null.") },
        };
        ...
        /// </exception>
        public void Validate(CDP4Common.DTO.Thing fileStore)
        {
            this.Validate(fileStore, x => true);
        }
        ...
        /// If any validation rule failed.
        /// </exception>
        public void Validate(CDP4Common.DTO.Thing fileStore, Func<string, bool> validateProperty)
        {
            foreach (var applicableRule in this.validationRules.Where(x => validateProperty(x.Key)))
            {
                applicableRule.Value.Validate((CDP4Common.DTO.FileStore)fileStore);
            }
        }
        ...
        /// </returns>
        public bool TryValidate(CDP4Common.DTO.Thing fileStore)
        {
            return this.TryValidate(fileStore, x => true);
        }
        ...
        /// True if all validation rules have passed or if none are defined.
        /// </returns>
        public bool TryValidate(CDP4Common.DTO.Thing fileStore, Func<string, bool> validateProperty)
        {
            var applicableValidationRules = this.validationRules.Where(x => validateProperty(x.Key)).Select(x => x.Value);

            return applicableValidationRules.All(applicableRule => applicableRule.TryValidate((CDP4Common.DTO.FileStore)fileStore));
        }

        /// <summary>
        /// Returns the containment property value for the supplied <see cref="CDP4Common.DTO.FileStore"/>.
        /// </summary>
        /// <param name="fileStore">
        /// The <see cref="CDP4Common.DTO.FileStore"/> for which to return the containment property value.
        /// </param>
        ...
        /// If the property name is not supported for the <see cref="CDP4Common.DTO.FileStore"/>.
        /// </exception>
        public IEnumerable<Guid> GetContainmentIds(CDP4Common.DTO.Thing fileStore, string propertyName)
        {
            if (!this.containmentPropertyValueMap.ContainsKey(propertyName))
            {
                throw new ArgumentException($"'{propertyName}' is not a valid containment property of 'FileStore'");
            }

            return this.containmentPropertyValueMap[propertyName]((CDP4Common.DTO.FileStore)fileStore);
        }

        /// <summary>
        /// Returns the ordered containment property value for the supplied <see cref="CDP4Common.DTO.FileStore"/>.
        /// </summary>
        /// <param name="fileStore">
        /// The <see cref="CDP4Common.DTO.FileStore"/> for which to return the containment property value.
        /// </param>
        ...
        /// If the property name is not supported for the <see cref="CDP4Common.DTO.FileStore"/>.
        /// </exception>
        public IEnumerable<OrderedItem> GetOrderedContainmentIds(CDP4Common.DTO.Thing fileStore, string propertyName)
        {
            ...
            return this.orderedContainmentPropertyValueMap[propertyName]((CDP4Common.DTO.FileStore)fileStore);
        }
        ...
        /// <summary>
        /// Gets the <see cref="PropertyMetaInfo"/> for the <see cref="FileStore"/> class
        /// </summary>
        ...
        /// </summary>
        private readonly Dictionary<string, Func<CDP4Common.DTO.FileStore, object>> propertyValueMap = new Dictionary<string, Func<CDP4Common.DTO.FileStore, object>>
        {
        ...
        /// </summary>
        private readonly Dictionary<string, Action<CDP4Common.DTO.FileStore, object>> propertyValueAssignmentMap = new Dictionary<string, Action<CDP4Common.DTO.FileStore, object>>
        {
            { "Actor", (fileStore, value) => fileStore.Actor = value == null ? (Guid?)null : (Guid)value },
            { "CreatedOn", (fileStore, value) => fileStore.CreatedOn = (DateTime)value },
            { "Iid", (fileStore, value) => fileStore.Iid = (Guid)value },
            { "ModifiedOn", (fileStore, value) => fileStore.ModifiedOn = (DateTime)value },
            { "Name", (fileStore, value) => fileStore.Name = value.ToString() },
            { "Owner", (fileStore, value) => fileStore.Owner = (Guid)value },
            { "ThingPreference", (fileStore, value) => fileStore.ThingPreference = value == null ? (string)null : value.ToString() },
        };
        ...
        /// <summary>
        /// Returns the <see cref="CDP4Common.DTO.FileStore"/> containment property type from the supplied property name.
        /// </summary>
        /// <param name="propertyName">
        ...
        /// <summary>
        /// Returns the <see cref="CDP4Common.DTO.FileStore"/> property type from the supplied property name.
        /// </summary>
        /// <param name="propertyName">
        /// The property name.
        /// </param>
        ...
        /// <summary>
        /// Returns the container property for the supplied type name is a possible container for <see cref="CDP4Common.DTO.FileStore"/>.
        /// </summary>
        /// <param name="typeName">
        /// Name of the type for which to check if it is a container of <see cref="CDP4Common.DTO.FileStore"/>.
        /// </param>
        /// <param name="containerProperty">
        /// Supplied container property info instance that will be set if the supplied type name is a container of <see cref="CDP4Common.DTO.FileStore"/>.
        /// </param>
        /// <returns>
        /// True if the supplied typeName is a container for <see cref="CDP4Common.DTO.FileStore"/> and sets the container property name.
        /// </returns>
        ...
        /// <summary>
        /// Check if the supplied property name for <see cref="CDP4Common.DTO.FileStore"/> is scalar.
        /// </summary>
        /// <param name="propertyName">
        /// Name of the property for which to check if it is scalar.
        /// </param>
        ...
        public bool ApplyPropertyUpdate(CDP4Common.DTO.Thing updatableThing, string propertyName, object value)
        {
            ...
            this.propertyValueAssignmentMap[propertyName]((CDP4Common.DTO.FileStore)updatableThing, value);
        ...
        public object DeserializeCollectionValue(string propertyName, object value)
        {
            ...
            {
                throw new ArgumentException($"'{propertyName}' is not a valid collection property of 'FileStore'");
            }
        ...
        public object GetValue(string propertyName, CDP4Common.DTO.Thing thing)
        {
            ...
            return this.propertyValueMap[propertyName]((CDP4Common.DTO.FileStore)thing);
        }
        ...
        /// <summary>
        /// Instantiates a <see cref="CDP4Common.DTO.FileStore"/>
        /// </summary>
        /// <returns>
