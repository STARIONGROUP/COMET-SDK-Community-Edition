// --------------------------------------------------------------------------------------------------------------------
// <copyright file="SiteDirectoryDataDiscussionItemMetaInfo.cs" company="RHEA System S.A.">
...
namespace CDP4Common.MetaInfo
{
    ...
    /// <summary>
    /// This a class that holds meta info for <see cref="SiteDirectoryDataDiscussionItem"/>.
    /// </summary>
    public partial class SiteDirectoryDataDiscussionItemMetaInfo : ISiteDirectoryDataDiscussionItemMetaInfo
    {
        /// <summary>
        /// The containment property value map.
        /// </summary>
        private readonly Dictionary<string, Func<CDP4Common.DTO.SiteDirectoryDataDiscussionItem, IEnumerable<Guid>>> containmentPropertyValueMap = new Dictionary<string, Func<CDP4Common.DTO.SiteDirectoryDataDiscussionItem, IEnumerable<Guid>>>();

        /// <summary>
        /// The ordered containment property value map.
        /// </summary>
        private readonly Dictionary<string, Func<CDP4Common.DTO.SiteDirectoryDataDiscussionItem, IEnumerable<OrderedItem>>> orderedContainmentPropertyValueMap = new Dictionary<string, Func<CDP4Common.DTO.SiteDirectoryDataDiscussionItem, IEnumerable<OrderedItem>>>();

        /// <summary>
        /// The validation rules that should pass for an instance of <see cref="CDP4Common.DTO.SiteDirectoryDataDiscussionItem"/>.
        /// </summary>
        private readonly Dictionary<string, DtoValidationHelper<CDP4Common.DTO.SiteDirectoryDataDiscussionItem>> validationRules = new Dictionary<string, DtoValidationHelper<CDP4Common.DTO.SiteDirectoryDataDiscussionItem>>
        {
            { "Content", new DtoValidationHelper<CDP4Common.DTO.SiteDirectoryDataDiscussionItem>(item => !string.IsNullOrWhiteSpace(item.Content), "The 'Content' property of a 'SiteDirectoryDataDiscussionItem' is mandatory and cannot be empty or null.") },
            { "ExcludedDomain", new DtoValidationHelper<CDP4Common.DTO.SiteDirectoryDataDiscussionItem>(item => item.ExcludedDomain != null, "The 'ExcludedDomain' property of a 'SiteDirectoryDataDiscussionItem' is mandatory and cannot be null.") },
            { "ExcludedPerson", new DtoValidationHelper<CDP4Common.DTO.SiteDirectoryDataDiscussionItem>(item => item.ExcludedPerson != null, "The 'ExcludedPerson' property of a 'SiteDirectoryDataDiscussionItem' is mandatory and cannot be null.") },
            { "LanguageCode", new DtoValidationHelper<CDP4Common.DTO.SiteDirectoryDataDiscussionItem>(item => !string.IsNullOrWhiteSpace(item.LanguageCode), "The 'LanguageCode' property of a 'SiteDirectoryDataDiscussionItem' is mandatory and cannot be empty or null.") },
        };
        ...
        /// </exception>
        public void Validate(CDP4Common.DTO.Thing siteDirectoryDataDiscussionItem)
        {
            this.Validate(siteDirectoryDataDiscussionItem, x => true);
        }
        ...
        /// If any validation rule failed.
        /// </exception>
        public void Validate(CDP4Common.DTO.Thing siteDirectoryDataDiscussionItem, Func<string, bool> validateProperty)
        {
            foreach (var applicableRule in this.validationRules.Where(x => validateProperty(x.Key)))
            {
                applicableRule.Value.Validate((CDP4Common.DTO.SiteDirectoryDataDiscussionItem)siteDirectoryDataDiscussionItem);
            }
        }
        ...
        /// </returns>
        public bool TryValidate(CDP4Common.DTO.Thing siteDirectoryDataDiscussionItem)
        {
            return this.TryValidate(siteDirectoryDataDiscussionItem, x => true);
        }
        ...
        /// True if all validation rules have passed or if none are defined.
        /// </returns>
        public bool TryValidate(CDP4Common.DTO.Thing siteDirectoryDataDiscussionItem, Func<string, bool> validateProperty)
        {
            var applicableValidationRules = this.validationRules.Where(x => validateProperty(x.Key)).Select(x => x.Value);

            return applicableValidationRules.All(applicableRule => applicableRule.TryValidate((CDP4Common.DTO.SiteDirectoryDataDiscussionItem)siteDirectoryDataDiscussionItem));
        }

        /// <summary>
        /// Returns the containment property value for the supplied <see cref="CDP4Common.DTO.SiteDirectoryDataDiscussionItem"/>.
        /// </summary>
        /// <param name="siteDirectoryDataDiscussionItem">
        /// The <see cref="CDP4Common.DTO.SiteDirectoryDataDiscussionItem"/> for which to return the containment property value.
        /// </param>
        ...
        /// If the property name is not supported for the <see cref="CDP4Common.DTO.SiteDirectoryDataDiscussionItem"/>.
        /// </exception>
        public IEnumerable<Guid> GetContainmentIds(CDP4Common.DTO.Thing siteDirectoryDataDiscussionItem, string propertyName)
        {
            if (!this.containmentPropertyValueMap.ContainsKey(propertyName))
            {
                throw new ArgumentException(string.Format("'{0}' is not a valid containment property of 'SiteDirectoryDataDiscussionItem'", propertyName));
            }

            return this.containmentPropertyValueMap[propertyName]((CDP4Common.DTO.SiteDirectoryDataDiscussionItem)siteDirectoryDataDiscussionItem);
        }

        /// <summary>
        /// Returns the ordered containment property value for the supplied <see cref="CDP4Common.DTO.SiteDirectoryDataDiscussionItem"/>.
        /// </summary>
        /// <param name="siteDirectoryDataDiscussionItem">
        /// The <see cref="CDP4Common.DTO.SiteDirectoryDataDiscussionItem"/> for which to return the containment property value.
        /// </param>
        ...
        /// If the property name is not supported for the <see cref="CDP4Common.DTO.SiteDirectoryDataDiscussionItem"/>.
        /// </exception>
        public IEnumerable<OrderedItem> GetOrderedContainmentIds(CDP4Common.DTO.Thing siteDirectoryDataDiscussionItem, string propertyName)
        {
            ...
            return this.orderedContainmentPropertyValueMap[propertyName]((CDP4Common.DTO.SiteDirectoryDataDiscussionItem)siteDirectoryDataDiscussionItem);
        }
        ...
        /// <summary>
        /// Gets the <see cref="PropertyMetaInfo"/> for the <see cref="SiteDirectoryDataDiscussionItem"/> class
        /// </summary>
        ...
        private readonly Dictionary<string, Action<CDP4Common.DTO.SiteDirectoryDataDiscussionItem, object>> propertyValueAssignmentMap = new Dictionary<string, Action<CDP4Common.DTO.SiteDirectoryDataDiscussionItem, object>>
        {
            ...
            { "Iid", (siteDirectoryDataDiscussionItem, value) => siteDirectoryDataDiscussionItem.Iid = (Guid)value },
            { "LanguageCode", (siteDirectoryDataDiscussionItem, value) => siteDirectoryDataDiscussionItem.LanguageCode = value.ToString() },
            { "ModifiedOn", (siteDirectoryDataDiscussionItem, value) => siteDirectoryDataDiscussionItem.ModifiedOn = (DateTime)value },
            { "ReplyTo", (siteDirectoryDataDiscussionItem, value) => siteDirectoryDataDiscussionItem.ReplyTo = value == null ? (Guid?)null : (Guid)value },
            { "ThingPreference", (siteDirectoryDataDiscussionItem, value) => siteDirectoryDataDiscussionItem.ThingPreference = value == null ? (string)null : value.ToString() },
        };
        ...
        {
            { "SiteDirectoryDataAnnotation", new PropertyMetaInfo("Discussion", "SiteDirectoryDataDiscussionItem", PropertyKind.List, AggregationKind.Composite, false, false, true, 0, "*", true) },
        };
        ...
        /// <summary>
        /// Returns the <see cref="CDP4Common.DTO.SiteDirectoryDataDiscussionItem"/> containment property type from the supplied property name.
        /// </summary>
        /// <param name="propertyName">
        ...
        /// <summary>
        /// Returns the <see cref="CDP4Common.DTO.SiteDirectoryDataDiscussionItem"/> property type from the supplied property name.
        /// </summary>
        /// <param name="propertyName">
        /// The property name.
        /// </param>
        ...
        /// <summary>
        /// Returns the container property for the supplied type name is a possible container for <see cref="CDP4Common.DTO.SiteDirectoryDataDiscussionItem"/>.
        /// </summary>
        /// <param name="typeName">
        /// Name of the type for which to check if it is a container of <see cref="CDP4Common.DTO.SiteDirectoryDataDiscussionItem"/>.
        /// </param>
        /// <param name="containerProperty">
        /// Supplied container property info instance that will be set if the supplied type name is a container of <see cref="CDP4Common.DTO.SiteDirectoryDataDiscussionItem"/>.
        /// </param>
        /// <returns>
        /// True if the supplied typeName is a container for <see cref="CDP4Common.DTO.SiteDirectoryDataDiscussionItem"/> and sets the container property name.
        /// </returns>
        ...
        /// <summary>
        /// Check if the supplied property name for <see cref="CDP4Common.DTO.SiteDirectoryDataDiscussionItem"/> is scalar.
        /// </summary>
        /// <param name="propertyName">
        /// Name of the property for which to check if it is scalar.
        /// </param>
        ...
        public bool ApplyPropertyUpdate(CDP4Common.DTO.Thing updatableThing, string propertyName, object value)
        {
            ...
            this.propertyValueAssignmentMap[propertyName]((CDP4Common.DTO.SiteDirectoryDataDiscussionItem)updatableThing, value);
        ...
        public object DeserializeCollectionValue(string propertyName, object value)
        {
            ...
            {
                throw new ArgumentException(string.Format("'{0}' is not a valid collection property of 'SiteDirectoryDataDiscussionItem'", propertyName));
            }
        ...
        public object GetValue(string propertyName, CDP4Common.DTO.Thing thing)
        {
            ...
            return this.propertyValueMap[propertyName]((CDP4Common.DTO.SiteDirectoryDataDiscussionItem)thing);
        }
        ...
        /// <summary>
        /// Instantiates a <see cref="CDP4Common.DTO.SiteDirectoryDataDiscussionItem"/>
        /// </summary>
        /// <returns>
        ...
        {
            return new CDP4Common.DTO.SiteDirectoryDataDiscussionItem(guid, revisionNumber);
        }
    }
}
