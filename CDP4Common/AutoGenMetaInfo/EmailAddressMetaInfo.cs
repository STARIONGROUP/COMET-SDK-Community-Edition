// --------------------------------------------------------------------------------------------------------------------
// <copyright file="EmailAddressMetaInfo.cs" company="Starion Group S.A.">
...
namespace CDP4Common.MetaInfo
{
    ...
    /// <summary>
    /// This a class that holds meta info for <see cref="EmailAddress"/>.
    /// </summary>
    public partial class EmailAddressMetaInfo : IEmailAddressMetaInfo
    {
        /// <summary>
        /// The containment property value map.
        /// </summary>
        private readonly Dictionary<string, Func<CDP4Common.DTO.EmailAddress, IEnumerable<Guid>>> containmentPropertyValueMap = new Dictionary<string, Func<CDP4Common.DTO.EmailAddress, IEnumerable<Guid>>>();

        /// <summary>
        /// The ordered containment property value map.
        /// </summary>
        private readonly Dictionary<string, Func<CDP4Common.DTO.EmailAddress, IEnumerable<OrderedItem>>> orderedContainmentPropertyValueMap = new Dictionary<string, Func<CDP4Common.DTO.EmailAddress, IEnumerable<OrderedItem>>>();

        /// <summary>
        /// The validation rules that should pass for an instance of <see cref="CDP4Common.DTO.EmailAddress"/>.
        /// </summary>
        private readonly Dictionary<string, DtoValidationHelper<CDP4Common.DTO.EmailAddress>> validationRules = new Dictionary<string, DtoValidationHelper<CDP4Common.DTO.EmailAddress>>
        {
            { "ExcludedDomain", new DtoValidationHelper<CDP4Common.DTO.EmailAddress>(item => item.ExcludedDomain != null, "The 'ExcludedDomain' property of a 'EmailAddress' is mandatory and cannot be null.") },
            { "ExcludedPerson", new DtoValidationHelper<CDP4Common.DTO.EmailAddress>(item => item.ExcludedPerson != null, "The 'ExcludedPerson' property of a 'EmailAddress' is mandatory and cannot be null.") },
            { "Value", new DtoValidationHelper<CDP4Common.DTO.EmailAddress>(item => !string.IsNullOrWhiteSpace(item.Value), "The 'Value' property of a 'EmailAddress' is mandatory and cannot be empty or null.") },
        };
        ...
        /// </exception>
        public void Validate(CDP4Common.DTO.Thing emailAddress)
        {
            this.Validate(emailAddress, x => true);
        }
        ...
        /// If any validation rule failed.
        /// </exception>
        public void Validate(CDP4Common.DTO.Thing emailAddress, Func<string, bool> validateProperty)
        {
            foreach (var applicableRule in this.validationRules.Where(x => validateProperty(x.Key)))
            {
                applicableRule.Value.Validate((CDP4Common.DTO.EmailAddress)emailAddress);
            }
        }
        ...
        /// </returns>
        public bool TryValidate(CDP4Common.DTO.Thing emailAddress)
        {
            return this.TryValidate(emailAddress, x => true);
        }
        ...
        /// True if all validation rules have passed or if none are defined.
        /// </returns>
        public bool TryValidate(CDP4Common.DTO.Thing emailAddress, Func<string, bool> validateProperty)
        {
            var applicableValidationRules = this.validationRules.Where(x => validateProperty(x.Key)).Select(x => x.Value);

            return applicableValidationRules.All(applicableRule => applicableRule.TryValidate((CDP4Common.DTO.EmailAddress)emailAddress));
        }

        /// <summary>
        /// Returns the containment property value for the supplied <see cref="CDP4Common.DTO.EmailAddress"/>.
        /// </summary>
        /// <param name="emailAddress">
        /// The <see cref="CDP4Common.DTO.EmailAddress"/> for which to return the containment property value.
        /// </param>
        ...
        /// If the property name is not supported for the <see cref="CDP4Common.DTO.EmailAddress"/>.
        /// </exception>
        public IEnumerable<Guid> GetContainmentIds(CDP4Common.DTO.Thing emailAddress, string propertyName)
        {
            if (!this.containmentPropertyValueMap.ContainsKey(propertyName))
            {
                throw new ArgumentException($"'{propertyName}' is not a valid containment property of 'EmailAddress'");
            }

            return this.containmentPropertyValueMap[propertyName]((CDP4Common.DTO.EmailAddress)emailAddress);
        }

        /// <summary>
        /// Returns the ordered containment property value for the supplied <see cref="CDP4Common.DTO.EmailAddress"/>.
        /// </summary>
        /// <param name="emailAddress">
        /// The <see cref="CDP4Common.DTO.EmailAddress"/> for which to return the containment property value.
        /// </param>
        ...
        /// If the property name is not supported for the <see cref="CDP4Common.DTO.EmailAddress"/>.
        /// </exception>
        public IEnumerable<OrderedItem> GetOrderedContainmentIds(CDP4Common.DTO.Thing emailAddress, string propertyName)
        {
            ...
            return this.orderedContainmentPropertyValueMap[propertyName]((CDP4Common.DTO.EmailAddress)emailAddress);
        }
        ...
        /// <summary>
        /// Gets the <see cref="PropertyMetaInfo"/> for the <see cref="EmailAddress"/> class
        /// </summary>
        ...
        /// </summary>
        private readonly Dictionary<string, Func<CDP4Common.DTO.EmailAddress, object>> propertyValueMap = new Dictionary<string, Func<CDP4Common.DTO.EmailAddress, object>>
        {
        ...
        /// </summary>
        private readonly Dictionary<string, Action<CDP4Common.DTO.EmailAddress, object>> propertyValueAssignmentMap = new Dictionary<string, Action<CDP4Common.DTO.EmailAddress, object>>
        {
            { "Actor", (emailAddress, value) => emailAddress.Actor = value == null ? (Guid?)null : (Guid)value },
        ...
        {
            { "Person", new PropertyMetaInfo("EmailAddress", "EmailAddress", PropertyKind.List, AggregationKind.Composite, false, false, true, 0, "*", true) },
        };
        ...
        /// <summary>
        /// Returns the <see cref="CDP4Common.DTO.EmailAddress"/> containment property type from the supplied property name.
        /// </summary>
        /// <param name="propertyName">
        ...
        /// <summary>
        /// Returns the <see cref="CDP4Common.DTO.EmailAddress"/> property type from the supplied property name.
        /// </summary>
        /// <param name="propertyName">
        /// The property name.
        /// </param>
        ...
        /// <summary>
        /// Returns the container property for the supplied type name is a possible container for <see cref="CDP4Common.DTO.EmailAddress"/>.
        /// </summary>
        /// <param name="typeName">
        /// Name of the type for which to check if it is a container of <see cref="CDP4Common.DTO.EmailAddress"/>.
        /// </param>
        /// <param name="containerProperty">
        /// Supplied container property info instance that will be set if the supplied type name is a container of <see cref="CDP4Common.DTO.EmailAddress"/>.
        /// </param>
        /// <returns>
        /// True if the supplied typeName is a container for <see cref="CDP4Common.DTO.EmailAddress"/> and sets the container property name.
        /// </returns>
        ...
        /// <summary>
        /// Check if the supplied property name for <see cref="CDP4Common.DTO.EmailAddress"/> is scalar.
        /// </summary>
        /// <param name="propertyName">
        /// Name of the property for which to check if it is scalar.
        /// </param>
        ...
        public bool ApplyPropertyUpdate(CDP4Common.DTO.Thing updatableThing, string propertyName, object value)
        {
            ...
            this.propertyValueAssignmentMap[propertyName]((CDP4Common.DTO.EmailAddress)updatableThing, value);
        ...
        public object DeserializeCollectionValue(string propertyName, object value)
        {
            ...
            {
                throw new ArgumentException($"'{propertyName}' is not a valid collection property of 'EmailAddress'");
            }
        ...
        public object GetValue(string propertyName, CDP4Common.DTO.Thing thing)
        {
            ...
            return this.propertyValueMap[propertyName]((CDP4Common.DTO.EmailAddress)thing);
        }
        ...
        /// <summary>
        /// Instantiates a <see cref="CDP4Common.DTO.EmailAddress"/>
        /// </summary>
        /// <returns>
        ...
        {
            return new CDP4Common.DTO.EmailAddress(guid, revisionNumber);
        }
    }
}
