// --------------------------------------------------------------------------------------------------------------------
// <copyright file="UserPreferenceMetaInfo.cs" company="Starion Group S.A.">
...
namespace CDP4Common.MetaInfo
{
    ...
    /// <summary>
    /// This a class that holds meta info for <see cref="UserPreference"/>.
    /// </summary>
    public partial class UserPreferenceMetaInfo : IUserPreferenceMetaInfo
    {
        /// <summary>
        /// The containment property value map.
        /// </summary>
        private readonly Dictionary<string, Func<CDP4Common.DTO.UserPreference, IEnumerable<Guid>>> containmentPropertyValueMap = new Dictionary<string, Func<CDP4Common.DTO.UserPreference, IEnumerable<Guid>>>();

        /// <summary>
        /// The ordered containment property value map.
        /// </summary>
        private readonly Dictionary<string, Func<CDP4Common.DTO.UserPreference, IEnumerable<OrderedItem>>> orderedContainmentPropertyValueMap = new Dictionary<string, Func<CDP4Common.DTO.UserPreference, IEnumerable<OrderedItem>>>();

        /// <summary>
        /// The validation rules that should pass for an instance of <see cref="CDP4Common.DTO.UserPreference"/>.
        /// </summary>
        private readonly Dictionary<string, DtoValidationHelper<CDP4Common.DTO.UserPreference>> validationRules = new Dictionary<string, DtoValidationHelper<CDP4Common.DTO.UserPreference>>
        {
            { "ExcludedDomain", new DtoValidationHelper<CDP4Common.DTO.UserPreference>(item => item.ExcludedDomain != null, "The 'ExcludedDomain' property of a 'UserPreference' is mandatory and cannot be null.") },
            { "ExcludedPerson", new DtoValidationHelper<CDP4Common.DTO.UserPreference>(item => item.ExcludedPerson != null, "The 'ExcludedPerson' property of a 'UserPreference' is mandatory and cannot be null.") },
            { "ShortName", new DtoValidationHelper<CDP4Common.DTO.UserPreference>(item => !string.IsNullOrWhiteSpace(item.ShortName), "The 'ShortName' property of a 'UserPreference' is mandatory and cannot be empty or null.") },
            { "Value", new DtoValidationHelper<CDP4Common.DTO.UserPreference>(item => !string.IsNullOrWhiteSpace(item.Value), "The 'Value' property of a 'UserPreference' is mandatory and cannot be empty or null.") },
        };
        ...
        /// </exception>
        public void Validate(CDP4Common.DTO.Thing userPreference)
        {
            this.Validate(userPreference, x => true);
        }
        ...
        /// If any validation rule failed.
        /// </exception>
        public void Validate(CDP4Common.DTO.Thing userPreference, Func<string, bool> validateProperty)
        {
            foreach (var applicableRule in this.validationRules.Where(x => validateProperty(x.Key)))
            {
                applicableRule.Value.Validate((CDP4Common.DTO.UserPreference)userPreference);
            }
        }
        ...
        /// </returns>
        public bool TryValidate(CDP4Common.DTO.Thing userPreference)
        {
            return this.TryValidate(userPreference, x => true);
        }
        ...
        /// True if all validation rules have passed or if none are defined.
        /// </returns>
        public bool TryValidate(CDP4Common.DTO.Thing userPreference, Func<string, bool> validateProperty)
        {
            var applicableValidationRules = this.validationRules.Where(x => validateProperty(x.Key)).Select(x => x.Value);

            return applicableValidationRules.All(applicableRule => applicableRule.TryValidate((CDP4Common.DTO.UserPreference)userPreference));
        }

        /// <summary>
        /// Returns the containment property value for the supplied <see cref="CDP4Common.DTO.UserPreference"/>.
        /// </summary>
        /// <param name="userPreference">
        /// The <see cref="CDP4Common.DTO.UserPreference"/> for which to return the containment property value.
        /// </param>
        ...
        /// If the property name is not supported for the <see cref="CDP4Common.DTO.UserPreference"/>.
        /// </exception>
        public IEnumerable<Guid> GetContainmentIds(CDP4Common.DTO.Thing userPreference, string propertyName)
        {
            if (!this.containmentPropertyValueMap.ContainsKey(propertyName))
            {
                throw new ArgumentException($"'{propertyName}' is not a valid containment property of 'UserPreference'");
            }

            return this.containmentPropertyValueMap[propertyName]((CDP4Common.DTO.UserPreference)userPreference);
        }

        /// <summary>
        /// Returns the ordered containment property value for the supplied <see cref="CDP4Common.DTO.UserPreference"/>.
        /// </summary>
        /// <param name="userPreference">
        /// The <see cref="CDP4Common.DTO.UserPreference"/> for which to return the containment property value.
        /// </param>
        ...
        /// If the property name is not supported for the <see cref="CDP4Common.DTO.UserPreference"/>.
        /// </exception>
        public IEnumerable<OrderedItem> GetOrderedContainmentIds(CDP4Common.DTO.Thing userPreference, string propertyName)
        {
            ...
            return this.orderedContainmentPropertyValueMap[propertyName]((CDP4Common.DTO.UserPreference)userPreference);
        }
        ...
        /// <summary>
        /// Gets the <see cref="PropertyMetaInfo"/> for the <see cref="UserPreference"/> class
        /// </summary>
        ...
        /// </summary>
        private readonly Dictionary<string, Func<CDP4Common.DTO.UserPreference, object>> propertyValueMap = new Dictionary<string, Func<CDP4Common.DTO.UserPreference, object>>
        {
        ...
        /// </summary>
        private readonly Dictionary<string, Action<CDP4Common.DTO.UserPreference, object>> propertyValueAssignmentMap = new Dictionary<string, Action<CDP4Common.DTO.UserPreference, object>>
        {
            { "Actor", (userPreference, value) => userPreference.Actor = value == null ? (Guid?)null : (Guid)value },
            { "Iid", (userPreference, value) => userPreference.Iid = (Guid)value },
            { "ModifiedOn", (userPreference, value) => userPreference.ModifiedOn = (DateTime)value },
            { "ShortName", (userPreference, value) => userPreference.ShortName = value.ToString() },
            { "ThingPreference", (userPreference, value) => userPreference.ThingPreference = value == null ? (string)null : value.ToString() },
            { "Value", (userPreference, value) => userPreference.Value = value.ToString() },
        };
        ...
        {
            { "Person", new PropertyMetaInfo("UserPreference", "UserPreference", PropertyKind.List, AggregationKind.Composite, false, false, true, 0, "*", true) },
        };
        ...
        /// <summary>
        /// Returns the <see cref="CDP4Common.DTO.UserPreference"/> containment property type from the supplied property name.
        /// </summary>
        /// <param name="propertyName">
        ...
        /// <summary>
        /// Returns the <see cref="CDP4Common.DTO.UserPreference"/> property type from the supplied property name.
        /// </summary>
        /// <param name="propertyName">
        /// The property name.
        /// </param>
        ...
        /// <summary>
        /// Returns the container property for the supplied type name is a possible container for <see cref="CDP4Common.DTO.UserPreference"/>.
        /// </summary>
        /// <param name="typeName">
        /// Name of the type for which to check if it is a container of <see cref="CDP4Common.DTO.UserPreference"/>.
        /// </param>
        /// <param name="containerProperty">
        /// Supplied container property info instance that will be set if the supplied type name is a container of <see cref="CDP4Common.DTO.UserPreference"/>.
        /// </param>
        /// <returns>
        /// True if the supplied typeName is a container for <see cref="CDP4Common.DTO.UserPreference"/> and sets the container property name.
        /// </returns>
        ...
        /// <summary>
        /// Check if the supplied property name for <see cref="CDP4Common.DTO.UserPreference"/> is scalar.
        /// </summary>
        /// <param name="propertyName">
        /// Name of the property for which to check if it is scalar.
        /// </param>
        ...
        public bool ApplyPropertyUpdate(CDP4Common.DTO.Thing updatableThing, string propertyName, object value)
        {
            ...
            this.propertyValueAssignmentMap[propertyName]((CDP4Common.DTO.UserPreference)updatableThing, value);
        ...
        public object DeserializeCollectionValue(string propertyName, object value)
        {
            ...
            {
                throw new ArgumentException($"'{propertyName}' is not a valid collection property of 'UserPreference'");
            }
        ...
        public object GetValue(string propertyName, CDP4Common.DTO.Thing thing)
        {
            ...
            return this.propertyValueMap[propertyName]((CDP4Common.DTO.UserPreference)thing);
        }
        ...
        /// <summary>
        /// Instantiates a <see cref="CDP4Common.DTO.UserPreference"/>
        /// </summary>
        /// <returns>
        ...
        {
            return new CDP4Common.DTO.UserPreference(guid, revisionNumber);
        }
    }
}
