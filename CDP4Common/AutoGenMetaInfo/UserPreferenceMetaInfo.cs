...
namespace CDP4Common.MetaInfo
{
    ...
    public partial class UserPreferenceMetaInfo : IUserPreferenceMetaInfo
    {
        ...
        public IEnumerable<Guid> GetContainmentIds(CDP4Common.DTO.Thing userPreference, string propertyName)
        {
            ...
            {
                throw new ArgumentException(string.Format("'{0}' is not a valid containment property of 'UserPreference'", propertyName));
            }
        ...
        public object DeserializeCollectionValue(string propertyName, object value)
        {
            ...
            {
                throw new ArgumentException(string.Format("'{0}' is not a valid collection property of 'UserPreference'", propertyName));
            }
