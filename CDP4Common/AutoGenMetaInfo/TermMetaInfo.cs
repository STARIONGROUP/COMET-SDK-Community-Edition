// --------------------------------------------------------------------------------------------------------------------
// <copyright file="TermMetaInfo.cs" company="RHEA System S.A.">
...
namespace CDP4Common.MetaInfo
{
    ...
    /// <summary>
    /// This a class that holds meta info for <see cref="Term"/>.
    /// </summary>
    public partial class TermMetaInfo : ITermMetaInfo
    {
        /// <summary>
        /// The containment property value map.
        /// </summary>
        private readonly Dictionary<string, Func<CDP4Common.DTO.Term, IEnumerable<Guid>>> containmentPropertyValueMap = new Dictionary<string, Func<CDP4Common.DTO.Term, IEnumerable<Guid>>>
        {
            { "Alias", term => term.Alias },
            { "Attachment", term => term.Attachment },
            { "Definition", term => term.Definition },
            { "HyperLink", term => term.HyperLink },
        };

        /// <summary>
        /// The ordered containment property value map.
        /// </summary>
        private readonly Dictionary<string, Func<CDP4Common.DTO.Term, IEnumerable<OrderedItem>>> orderedContainmentPropertyValueMap = new Dictionary<string, Func<CDP4Common.DTO.Term, IEnumerable<OrderedItem>>>();

        /// <summary>
        /// The validation rules that should pass for an instance of <see cref="CDP4Common.DTO.Term"/>.
        /// </summary>
        private readonly Dictionary<string, DtoValidationHelper<CDP4Common.DTO.Term>> validationRules = new Dictionary<string, DtoValidationHelper<CDP4Common.DTO.Term>>
        {
            { "Alias", new DtoValidationHelper<CDP4Common.DTO.Term>(item => item.Alias != null, "The 'Alias' property of a 'Term' is mandatory and cannot be null.") },
            { "Attachment", new DtoValidationHelper<CDP4Common.DTO.Term>(item => item.Attachment != null, "The 'Attachment' property of a 'Term' is mandatory and cannot be null.") },
            { "Definition", new DtoValidationHelper<CDP4Common.DTO.Term>(item => item.Definition != null, "The 'Definition' property of a 'Term' is mandatory and cannot be null.") },
            { "ExcludedDomain", new DtoValidationHelper<CDP4Common.DTO.Term>(item => item.ExcludedDomain != null, "The 'ExcludedDomain' property of a 'Term' is mandatory and cannot be null.") },
            { "ExcludedPerson", new DtoValidationHelper<CDP4Common.DTO.Term>(item => item.ExcludedPerson != null, "The 'ExcludedPerson' property of a 'Term' is mandatory and cannot be null.") },
            { "HyperLink", new DtoValidationHelper<CDP4Common.DTO.Term>(item => item.HyperLink != null, "The 'HyperLink' property of a 'Term' is mandatory and cannot be null.") },
            { "Name", new DtoValidationHelper<CDP4Common.DTO.Term>(item => !string.IsNullOrWhiteSpace(item.Name), "The 'Name' property of a 'Term' is mandatory and cannot be empty or null.") },
            { "ShortName", new DtoValidationHelper<CDP4Common.DTO.Term>(item => !string.IsNullOrWhiteSpace(item.ShortName), "The 'ShortName' property of a 'Term' is mandatory and cannot be empty or null.") },
        };
        ...
        /// </exception>
        public void Validate(CDP4Common.DTO.Thing term)
        {
            this.Validate(term, x => true);
        }
        ...
        /// If any validation rule failed.
        /// </exception>
        public void Validate(CDP4Common.DTO.Thing term, Func<string, bool> validateProperty)
        {
            foreach (var applicableRule in this.validationRules.Where(x => validateProperty(x.Key)))
            {
                applicableRule.Value.Validate((CDP4Common.DTO.Term)term);
            }
        }
        ...
        /// </returns>
        public bool TryValidate(CDP4Common.DTO.Thing term)
        {
            return this.TryValidate(term, x => true);
        }
        ...
        /// True if all validation rules have passed or if none are defined.
        /// </returns>
        public bool TryValidate(CDP4Common.DTO.Thing term, Func<string, bool> validateProperty)
        {
            var applicableValidationRules = this.validationRules.Where(x => validateProperty(x.Key)).Select(x => x.Value);

            return applicableValidationRules.All(applicableRule => applicableRule.TryValidate((CDP4Common.DTO.Term)term));
        }

        /// <summary>
        /// Returns the containment property value for the supplied <see cref="CDP4Common.DTO.Term"/>.
        /// </summary>
        /// <param name="term">
        /// The <see cref="CDP4Common.DTO.Term"/> for which to return the containment property value.
        /// </param>
        ...
        /// If the property name is not supported for the <see cref="CDP4Common.DTO.Term"/>.
        /// </exception>
        public IEnumerable<Guid> GetContainmentIds(CDP4Common.DTO.Thing term, string propertyName)
        {
            if (!this.containmentPropertyValueMap.ContainsKey(propertyName))
            {
                throw new ArgumentException($"'{propertyName}' is not a valid containment property of 'Term'");
            }

            return this.containmentPropertyValueMap[propertyName]((CDP4Common.DTO.Term)term);
        }

        /// <summary>
        /// Returns the ordered containment property value for the supplied <see cref="CDP4Common.DTO.Term"/>.
        /// </summary>
        /// <param name="term">
        /// The <see cref="CDP4Common.DTO.Term"/> for which to return the containment property value.
        /// </param>
        ...
        /// If the property name is not supported for the <see cref="CDP4Common.DTO.Term"/>.
        /// </exception>
        public IEnumerable<OrderedItem> GetOrderedContainmentIds(CDP4Common.DTO.Thing term, string propertyName)
        {
            ...
            return this.orderedContainmentPropertyValueMap[propertyName]((CDP4Common.DTO.Term)term);
        }
        ...
        /// <summary>
        /// Gets the <see cref="PropertyMetaInfo"/> for the <see cref="Term"/> class
        /// </summary>
        ...
        /// </summary>
        private readonly Dictionary<string, Func<CDP4Common.DTO.Term, object>> propertyValueMap = new Dictionary<string, Func<CDP4Common.DTO.Term, object>>
        {
        ...
        /// </summary>
        private readonly Dictionary<string, Action<CDP4Common.DTO.Term, object>> propertyValueAssignmentMap = new Dictionary<string, Action<CDP4Common.DTO.Term, object>>
        {
            { "Actor", (term, value) => term.Actor = value == null ? (Guid?)null : (Guid)value },
            { "Iid", (term, value) => term.Iid = (Guid)value },
            { "IsDeprecated", (term, value) => term.IsDeprecated = (bool)value },
            { "ModifiedOn", (term, value) => term.ModifiedOn = (DateTime)value },
            { "Name", (term, value) => term.Name = value.ToString() },
            { "ShortName", (term, value) => term.ShortName = value.ToString() },
            { "ThingPreference", (term, value) => term.ThingPreference = value == null ? (string)null : value.ToString() },
        };
        ...
        {
            { "Glossary", new PropertyMetaInfo("Term", "Term", PropertyKind.List, AggregationKind.Composite, false, false, true, 0, "*", true) },
        };
        ...
        /// <summary>
        /// Returns the <see cref="CDP4Common.DTO.Term"/> containment property type from the supplied property name.
        /// </summary>
        /// <param name="propertyName">
        ...
        /// <summary>
        /// Returns the <see cref="CDP4Common.DTO.Term"/> property type from the supplied property name.
        /// </summary>
        /// <param name="propertyName">
        /// The property name.
        /// </param>
        ...
        /// <summary>
        /// Returns the container property for the supplied type name is a possible container for <see cref="CDP4Common.DTO.Term"/>.
        /// </summary>
        /// <param name="typeName">
        /// Name of the type for which to check if it is a container of <see cref="CDP4Common.DTO.Term"/>.
        /// </param>
        /// <param name="containerProperty">
        /// Supplied container property info instance that will be set if the supplied type name is a container of <see cref="CDP4Common.DTO.Term"/>.
        /// </param>
        /// <returns>
        /// True if the supplied typeName is a container for <see cref="CDP4Common.DTO.Term"/> and sets the container property name.
        /// </returns>
        ...
        /// <summary>
        /// Check if the supplied property name for <see cref="CDP4Common.DTO.Term"/> is scalar.
        /// </summary>
        /// <param name="propertyName">
        /// Name of the property for which to check if it is scalar.
        /// </param>
        ...
        public bool ApplyPropertyUpdate(CDP4Common.DTO.Thing updatableThing, string propertyName, object value)
        {
            ...
            this.propertyValueAssignmentMap[propertyName]((CDP4Common.DTO.Term)updatableThing, value);
        ...
        public object DeserializeCollectionValue(string propertyName, object value)
        {
            ...
            {
                throw new ArgumentException($"'{propertyName}' is not a valid collection property of 'Term'");
            }
        ...
        public object GetValue(string propertyName, CDP4Common.DTO.Thing thing)
        {
            ...
            return this.propertyValueMap[propertyName]((CDP4Common.DTO.Term)thing);
        }
        ...
        /// <summary>
        /// Instantiates a <see cref="CDP4Common.DTO.Term"/>
        /// </summary>
        /// <returns>
        ...
        {
            return new CDP4Common.DTO.Term(guid, revisionNumber);
        }
    }
}
