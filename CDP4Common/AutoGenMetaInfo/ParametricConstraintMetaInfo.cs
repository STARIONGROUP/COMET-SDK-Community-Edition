...
namespace CDP4Common.MetaInfo
{
    ...
    public partial class ParametricConstraintMetaInfo : IParametricConstraintMetaInfo
    {
        ...
        {
            { "Expression", new PropertyMetaInfo("Expression", "Guid", PropertyKind.List, AggregationKind.Composite, false, false, true, 1, "*", true) },
        };
        ...
        private readonly Dictionary<string, PropertyMetaInfo> propertyTypeMap = new Dictionary<string, PropertyMetaInfo>
        {
            ...
            { "TopExpression", new PropertyMetaInfo("TopExpression", "Guid", PropertyKind.Scalar, AggregationKind.None, false, false, true, 0, "1", true) },
        };
        ...
        {
            { "Requirement", new PropertyMetaInfo("ParametricConstraint", "Guid", PropertyKind.OrderedList, AggregationKind.Composite, false, true, true, 0, "*", true) },
        };
