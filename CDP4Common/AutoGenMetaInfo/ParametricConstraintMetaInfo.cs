// --------------------------------------------------------------------------------------------------------------------
// <copyright file="ParametricConstraintMetaInfo.cs" company="Starion Group S.A.">
...
namespace CDP4Common.MetaInfo
{
    ...
    /// <summary>
    /// This a class that holds meta info for <see cref="ParametricConstraint"/>.
    /// </summary>
    public partial class ParametricConstraintMetaInfo : IParametricConstraintMetaInfo
    {
        /// <summary>
        /// The containment property value map.
        /// </summary>
        private readonly Dictionary<string, Func<CDP4Common.DTO.ParametricConstraint, IEnumerable<Guid>>> containmentPropertyValueMap = new Dictionary<string, Func<CDP4Common.DTO.ParametricConstraint, IEnumerable<Guid>>>
        {
            { "Expression", parametricConstraint => parametricConstraint.Expression },
        };

        /// <summary>
        /// The ordered containment property value map.
        /// </summary>
        private readonly Dictionary<string, Func<CDP4Common.DTO.ParametricConstraint, IEnumerable<OrderedItem>>> orderedContainmentPropertyValueMap = new Dictionary<string, Func<CDP4Common.DTO.ParametricConstraint, IEnumerable<OrderedItem>>>();

        /// <summary>
        /// The validation rules that should pass for an instance of <see cref="CDP4Common.DTO.ParametricConstraint"/>.
        /// </summary>
        private readonly Dictionary<string, DtoValidationHelper<CDP4Common.DTO.ParametricConstraint>> validationRules = new Dictionary<string, DtoValidationHelper<CDP4Common.DTO.ParametricConstraint>>
        {
            { "ExcludedDomain", new DtoValidationHelper<CDP4Common.DTO.ParametricConstraint>(item => item.ExcludedDomain != null, "The 'ExcludedDomain' property of a 'ParametricConstraint' is mandatory and cannot be null.") },
            { "ExcludedPerson", new DtoValidationHelper<CDP4Common.DTO.ParametricConstraint>(item => item.ExcludedPerson != null, "The 'ExcludedPerson' property of a 'ParametricConstraint' is mandatory and cannot be null.") },
            { "Expression", new DtoValidationHelper<CDP4Common.DTO.ParametricConstraint>(item => item.Expression != null && item.Expression.Any(), "The 'Expression' property of a 'ParametricConstraint' is mandatory and must have at least one entry.") },
        };
        ...
        /// </exception>
        public void Validate(CDP4Common.DTO.Thing parametricConstraint)
        {
            this.Validate(parametricConstraint, x => true);
        }
        ...
        /// If any validation rule failed.
        /// </exception>
        public void Validate(CDP4Common.DTO.Thing parametricConstraint, Func<string, bool> validateProperty)
        {
            foreach (var applicableRule in this.validationRules.Where(x => validateProperty(x.Key)))
            {
                applicableRule.Value.Validate((CDP4Common.DTO.ParametricConstraint)parametricConstraint);
            }
        }
        ...
        /// </returns>
        public bool TryValidate(CDP4Common.DTO.Thing parametricConstraint)
        {
            return this.TryValidate(parametricConstraint, x => true);
        }
        ...
        /// True if all validation rules have passed or if none are defined.
        /// </returns>
        public bool TryValidate(CDP4Common.DTO.Thing parametricConstraint, Func<string, bool> validateProperty)
        {
            var applicableValidationRules = this.validationRules.Where(x => validateProperty(x.Key)).Select(x => x.Value);

            return applicableValidationRules.All(applicableRule => applicableRule.TryValidate((CDP4Common.DTO.ParametricConstraint)parametricConstraint));
        }

        /// <summary>
        /// Returns the containment property value for the supplied <see cref="CDP4Common.DTO.ParametricConstraint"/>.
        /// </summary>
        /// <param name="parametricConstraint">
        /// The <see cref="CDP4Common.DTO.ParametricConstraint"/> for which to return the containment property value.
        /// </param>
        ...
        /// If the property name is not supported for the <see cref="CDP4Common.DTO.ParametricConstraint"/>.
        /// </exception>
        public IEnumerable<Guid> GetContainmentIds(CDP4Common.DTO.Thing parametricConstraint, string propertyName)
        {
        ...
        /// <summary>
        /// Returns the ordered containment property value for the supplied <see cref="CDP4Common.DTO.ParametricConstraint"/>.
        /// </summary>
        /// <param name="parametricConstraint">
        /// The <see cref="CDP4Common.DTO.ParametricConstraint"/> for which to return the containment property value.
        /// </param>
        ...
        /// If the property name is not supported for the <see cref="CDP4Common.DTO.ParametricConstraint"/>.
        /// </exception>
        public IEnumerable<OrderedItem> GetOrderedContainmentIds(CDP4Common.DTO.Thing parametricConstraint, string propertyName)
        {
        ...
        {
            { "Expression", new PropertyMetaInfo("Expression", "BooleanExpression", PropertyKind.List, AggregationKind.Composite, false, false, true, 1, "*", true) },
        };

        /// <summary>
        /// Gets the <see cref="PropertyMetaInfo"/> for the <see cref="ParametricConstraint"/> class
        /// </summary>
        ...
        /// </summary>
        private readonly Dictionary<string, Func<CDP4Common.DTO.ParametricConstraint, object>> propertyValueMap = new Dictionary<string, Func<CDP4Common.DTO.ParametricConstraint, object>>
        {
            { "Actor", thing => thing.Actor },
            { "ClassKind", thing => thing.ClassKind },
            { "ExcludedDomain", thing => thing.ExcludedDomain },
            { "ExcludedPerson", thing => thing.ExcludedPerson },
            { "Expression", thing => thing.Expression },
            { "Iid", thing => thing.Iid },
        ...
        private readonly Dictionary<string, Func<object, object>> collectionPropertyValueDeserializationMap = new Dictionary<string, Func<object, object>>
        {
            ...
            { "Expression", (value) => (Guid)value },
        };

        /// <summary>
        /// The property value assignment map.
        /// </summary>
        private readonly Dictionary<string, Action<CDP4Common.DTO.ParametricConstraint, object>> propertyValueAssignmentMap = new Dictionary<string, Action<CDP4Common.DTO.ParametricConstraint, object>>
        {
            { "Actor", (parametricConstraint, value) => parametricConstraint.Actor = value == null ? (Guid?)null : (Guid)value },
        ...
        {
            { "Requirement", new PropertyMetaInfo("ParametricConstraint", "ParametricConstraint", PropertyKind.OrderedList, AggregationKind.Composite, false, true, true, 0, "*", true) },
        };
        ...
        /// <summary>
        /// Returns the <see cref="CDP4Common.DTO.ParametricConstraint"/> containment property type from the supplied property name.
        /// </summary>
        /// <param name="propertyName">
        ...
        /// <summary>
        /// Returns the <see cref="CDP4Common.DTO.ParametricConstraint"/> property type from the supplied property name.
        /// </summary>
        /// <param name="propertyName">
        /// The property name.
        /// </param>
        ...
        /// <summary>
        /// Returns the container property for the supplied type name is a possible container for <see cref="CDP4Common.DTO.ParametricConstraint"/>.
        /// </summary>
        /// <param name="typeName">
        /// Name of the type for which to check if it is a container of <see cref="CDP4Common.DTO.ParametricConstraint"/>.
        /// </param>
        /// <param name="containerProperty">
        /// Supplied container property info instance that will be set if the supplied type name is a container of <see cref="CDP4Common.DTO.ParametricConstraint"/>.
        /// </param>
        /// <returns>
        /// True if the supplied typeName is a container for <see cref="CDP4Common.DTO.ParametricConstraint"/> and sets the container property name.
        /// </returns>
        ...
        /// <summary>
        /// Check if the supplied property name for <see cref="CDP4Common.DTO.ParametricConstraint"/> is scalar.
        /// </summary>
        /// <param name="propertyName">
        /// Name of the property for which to check if it is scalar.
        /// </param>
        ...
        public bool ApplyPropertyUpdate(CDP4Common.DTO.Thing updatableThing, string propertyName, object value)
        {
            ...
            this.propertyValueAssignmentMap[propertyName]((CDP4Common.DTO.ParametricConstraint)updatableThing, value);
        ...
        /// <summary>
        /// Instantiates a <see cref="CDP4Common.DTO.ParametricConstraint"/>
        /// </summary>
        /// <returns>
        ...
        {
            return new CDP4Common.DTO.ParametricConstraint(guid, revisionNumber);
        }
    }
}
