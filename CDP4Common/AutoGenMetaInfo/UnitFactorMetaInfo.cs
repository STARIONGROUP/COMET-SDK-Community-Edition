// --------------------------------------------------------------------------------------------------------------------
// <copyright file="UnitFactorMetaInfo.cs" company="Starion Group S.A.">
...
namespace CDP4Common.MetaInfo
{
    ...
    /// <summary>
    /// This a class that holds meta info for <see cref="UnitFactor"/>.
    /// </summary>
    public partial class UnitFactorMetaInfo : IUnitFactorMetaInfo
    {
        /// <summary>
        /// The containment property value map.
        /// </summary>
        private readonly Dictionary<string, Func<CDP4Common.DTO.UnitFactor, IEnumerable<Guid>>> containmentPropertyValueMap = new Dictionary<string, Func<CDP4Common.DTO.UnitFactor, IEnumerable<Guid>>>();

        /// <summary>
        /// The ordered containment property value map.
        /// </summary>
        private readonly Dictionary<string, Func<CDP4Common.DTO.UnitFactor, IEnumerable<OrderedItem>>> orderedContainmentPropertyValueMap = new Dictionary<string, Func<CDP4Common.DTO.UnitFactor, IEnumerable<OrderedItem>>>();

        /// <summary>
        /// The validation rules that should pass for an instance of <see cref="CDP4Common.DTO.UnitFactor"/>.
        /// </summary>
        private readonly Dictionary<string, DtoValidationHelper<CDP4Common.DTO.UnitFactor>> validationRules = new Dictionary<string, DtoValidationHelper<CDP4Common.DTO.UnitFactor>>
        {
            { "ExcludedDomain", new DtoValidationHelper<CDP4Common.DTO.UnitFactor>(item => item.ExcludedDomain != null, "The 'ExcludedDomain' property of a 'UnitFactor' is mandatory and cannot be null.") },
            { "ExcludedPerson", new DtoValidationHelper<CDP4Common.DTO.UnitFactor>(item => item.ExcludedPerson != null, "The 'ExcludedPerson' property of a 'UnitFactor' is mandatory and cannot be null.") },
            { "Exponent", new DtoValidationHelper<CDP4Common.DTO.UnitFactor>(item => !string.IsNullOrWhiteSpace(item.Exponent), "The 'Exponent' property of a 'UnitFactor' is mandatory and cannot be empty or null.") },
        };
        ...
        /// </exception>
        public void Validate(CDP4Common.DTO.Thing unitFactor)
        {
            this.Validate(unitFactor, x => true);
        }
        ...
        /// If any validation rule failed.
        /// </exception>
        public void Validate(CDP4Common.DTO.Thing unitFactor, Func<string, bool> validateProperty)
        {
            foreach (var applicableRule in this.validationRules.Where(x => validateProperty(x.Key)))
            {
                applicableRule.Value.Validate((CDP4Common.DTO.UnitFactor)unitFactor);
            }
        }
        ...
        /// </returns>
        public bool TryValidate(CDP4Common.DTO.Thing unitFactor)
        {
            return this.TryValidate(unitFactor, x => true);
        }
        ...
        /// True if all validation rules have passed or if none are defined.
        /// </returns>
        public bool TryValidate(CDP4Common.DTO.Thing unitFactor, Func<string, bool> validateProperty)
        {
            var applicableValidationRules = this.validationRules.Where(x => validateProperty(x.Key)).Select(x => x.Value);

            return applicableValidationRules.All(applicableRule => applicableRule.TryValidate((CDP4Common.DTO.UnitFactor)unitFactor));
        }

        /// <summary>
        /// Returns the containment property value for the supplied <see cref="CDP4Common.DTO.UnitFactor"/>.
        /// </summary>
        /// <param name="unitFactor">
        /// The <see cref="CDP4Common.DTO.UnitFactor"/> for which to return the containment property value.
        /// </param>
        ...
        /// If the property name is not supported for the <see cref="CDP4Common.DTO.UnitFactor"/>.
        /// </exception>
        public IEnumerable<Guid> GetContainmentIds(CDP4Common.DTO.Thing unitFactor, string propertyName)
        {
            if (!this.containmentPropertyValueMap.ContainsKey(propertyName))
            {
                throw new ArgumentException($"'{propertyName}' is not a valid containment property of 'UnitFactor'");
            }

            return this.containmentPropertyValueMap[propertyName]((CDP4Common.DTO.UnitFactor)unitFactor);
        }

        /// <summary>
        /// Returns the ordered containment property value for the supplied <see cref="CDP4Common.DTO.UnitFactor"/>.
        /// </summary>
        /// <param name="unitFactor">
        /// The <see cref="CDP4Common.DTO.UnitFactor"/> for which to return the containment property value.
        /// </param>
        ...
        /// If the property name is not supported for the <see cref="CDP4Common.DTO.UnitFactor"/>.
        /// </exception>
        public IEnumerable<OrderedItem> GetOrderedContainmentIds(CDP4Common.DTO.Thing unitFactor, string propertyName)
        {
            ...
            return this.orderedContainmentPropertyValueMap[propertyName]((CDP4Common.DTO.UnitFactor)unitFactor);
        }
        ...
        /// <summary>
        /// Gets the <see cref="PropertyMetaInfo"/> for the <see cref="UnitFactor"/> class
        /// </summary>
        ...
        /// </summary>
        private readonly Dictionary<string, Func<CDP4Common.DTO.UnitFactor, object>> propertyValueMap = new Dictionary<string, Func<CDP4Common.DTO.UnitFactor, object>>
        {
        ...
        /// </summary>
        private readonly Dictionary<string, Action<CDP4Common.DTO.UnitFactor, object>> propertyValueAssignmentMap = new Dictionary<string, Action<CDP4Common.DTO.UnitFactor, object>>
        {
            { "Actor", (unitFactor, value) => unitFactor.Actor = value == null ? (Guid?)null : (Guid)value },
            { "Exponent", (unitFactor, value) => unitFactor.Exponent = value.ToString() },
            { "Iid", (unitFactor, value) => unitFactor.Iid = (Guid)value },
            { "ModifiedOn", (unitFactor, value) => unitFactor.ModifiedOn = (DateTime)value },
            { "ThingPreference", (unitFactor, value) => unitFactor.ThingPreference = value == null ? (string)null : value.ToString() },
            { "Unit", (unitFactor, value) => unitFactor.Unit = (Guid)value },
        };
        ...
        {
            { "DerivedUnit", new PropertyMetaInfo("UnitFactor", "UnitFactor", PropertyKind.OrderedList, AggregationKind.Composite, false, true, true, 1, "*", true) },
        };
        ...
        /// <summary>
        /// Returns the <see cref="CDP4Common.DTO.UnitFactor"/> containment property type from the supplied property name.
        /// </summary>
        /// <param name="propertyName">
        ...
        /// <summary>
        /// Returns the <see cref="CDP4Common.DTO.UnitFactor"/> property type from the supplied property name.
        /// </summary>
        /// <param name="propertyName">
        /// The property name.
        /// </param>
        ...
        /// <summary>
        /// Returns the container property for the supplied type name is a possible container for <see cref="CDP4Common.DTO.UnitFactor"/>.
        /// </summary>
        /// <param name="typeName">
        /// Name of the type for which to check if it is a container of <see cref="CDP4Common.DTO.UnitFactor"/>.
        /// </param>
        /// <param name="containerProperty">
        /// Supplied container property info instance that will be set if the supplied type name is a container of <see cref="CDP4Common.DTO.UnitFactor"/>.
        /// </param>
        /// <returns>
        /// True if the supplied typeName is a container for <see cref="CDP4Common.DTO.UnitFactor"/> and sets the container property name.
        /// </returns>
        ...
        /// <summary>
        /// Check if the supplied property name for <see cref="CDP4Common.DTO.UnitFactor"/> is scalar.
        /// </summary>
        /// <param name="propertyName">
        /// Name of the property for which to check if it is scalar.
        /// </param>
        ...
        public bool ApplyPropertyUpdate(CDP4Common.DTO.Thing updatableThing, string propertyName, object value)
        {
            ...
            this.propertyValueAssignmentMap[propertyName]((CDP4Common.DTO.UnitFactor)updatableThing, value);
        ...
        public object DeserializeCollectionValue(string propertyName, object value)
        {
            ...
            {
                throw new ArgumentException($"'{propertyName}' is not a valid collection property of 'UnitFactor'");
            }
        ...
        public object GetValue(string propertyName, CDP4Common.DTO.Thing thing)
        {
            ...
            return this.propertyValueMap[propertyName]((CDP4Common.DTO.UnitFactor)thing);
        }
        ...
        /// <summary>
        /// Instantiates a <see cref="CDP4Common.DTO.UnitFactor"/>
        /// </summary>
        /// <returns>
        ...
        {
            return new CDP4Common.DTO.UnitFactor(guid, revisionNumber);
        }
    }
}
