...
namespace CDP4Common.MetaInfo
{
    ...
    public partial class UnitFactorMetaInfo : IUnitFactorMetaInfo
    {
        ...
        public IEnumerable<Guid> GetContainmentIds(CDP4Common.DTO.Thing unitFactor, string propertyName)
        {
            ...
            {
                throw new ArgumentException(string.Format("'{0}' is not a valid containment property of 'UnitFactor'", propertyName));
            }
        ...
        public object DeserializeCollectionValue(string propertyName, object value)
        {
            ...
            {
                throw new ArgumentException(string.Format("'{0}' is not a valid collection property of 'UnitFactor'", propertyName));
            }
