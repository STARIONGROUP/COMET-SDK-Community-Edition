...
namespace CDP4Common.MetaInfo
{
    ...
    public partial class BoundsMetaInfo : IBoundsMetaInfo
    {
        ...
        {
            { "DiagramCanvas", new PropertyMetaInfo("Bounds", "Guid", PropertyKind.List, AggregationKind.Composite, false, false, true, 0, "1", true) },
            { "DiagramEdge", new PropertyMetaInfo("Bounds", "Guid", PropertyKind.List, AggregationKind.Composite, false, false, true, 0, "1", true) },
            { "DiagramObject", new PropertyMetaInfo("Bounds", "Guid", PropertyKind.List, AggregationKind.Composite, false, false, true, 0, "1", true) },
        };
