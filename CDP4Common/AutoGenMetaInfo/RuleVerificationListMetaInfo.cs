// --------------------------------------------------------------------------------------------------------------------
// <copyright file="RuleVerificationListMetaInfo.cs" company="Starion Group S.A.">
...
namespace CDP4Common.MetaInfo
{
    ...
    public partial class RuleVerificationListMetaInfo : IRuleVerificationListMetaInfo
    {
        ...
        public IEnumerable<Guid> GetContainmentIds(CDP4Common.DTO.Thing ruleVerificationList, string propertyName)
        {
            ...
            {
                throw new ArgumentException($"'{propertyName}' is not a valid containment property of 'RuleVerificationList'");
            }
        ...
        {
            { "Actor", (ruleVerificationList, value) => ruleVerificationList.Actor = value == null ? (Guid?)null : (Guid)value },
        ...
        {
            { "Iteration", new PropertyMetaInfo("RuleVerificationList", "RuleVerificationList", PropertyKind.List, AggregationKind.Composite, false, false, true, 0, "*", true) },
        };
        ...
        public object DeserializeCollectionValue(string propertyName, object value)
        {
            ...
            {
                throw new ArgumentException($"'{propertyName}' is not a valid collection property of 'RuleVerificationList'");
            }
