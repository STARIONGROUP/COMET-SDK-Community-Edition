// --------------------------------------------------------------------------------------------------------------------
// <copyright file="RuleVerificationListMetaInfo.cs" company="RHEA System S.A.">
...
namespace CDP4Common.MetaInfo
{
    ...
    /// <summary>
    /// This a class that holds meta info for <see cref="RuleVerificationList"/>.
    /// </summary>
    public partial class RuleVerificationListMetaInfo : IRuleVerificationListMetaInfo
    {
        /// <summary>
        ...
        /// </summary>
        private readonly Dictionary<string, Func<CDP4Common.DTO.RuleVerificationList, IEnumerable<OrderedItem>>> orderedContainmentPropertyValueMap = new Dictionary<string, Func<CDP4Common.DTO.RuleVerificationList, IEnumerable<OrderedItem>>>
        {
            { "RuleVerification", ruleVerificationList => ruleVerificationList.RuleVerification },
        };

        /// <summary>
        /// The validation rules that should pass for an instance of <see cref="CDP4Common.DTO.RuleVerificationList"/>.
        /// </summary>
        private readonly Dictionary<string, DtoValidationHelper<CDP4Common.DTO.RuleVerificationList>> validationRules = new Dictionary<string, DtoValidationHelper<CDP4Common.DTO.RuleVerificationList>>
        {
            ...
            { "HyperLink", new DtoValidationHelper<CDP4Common.DTO.RuleVerificationList>(item => item.HyperLink != null, "The 'HyperLink' property of a 'RuleVerificationList' is mandatory and cannot be null.") },
            { "Name", new DtoValidationHelper<CDP4Common.DTO.RuleVerificationList>(item => !string.IsNullOrWhiteSpace(item.Name), "The 'Name' property of a 'RuleVerificationList' is mandatory and cannot be empty or null.") },
            { "RuleVerification", new DtoValidationHelper<CDP4Common.DTO.RuleVerificationList>(item => item.RuleVerification != null, "The 'RuleVerification' property of a 'RuleVerificationList' is mandatory and cannot be null.") },
            { "ShortName", new DtoValidationHelper<CDP4Common.DTO.RuleVerificationList>(item => !string.IsNullOrWhiteSpace(item.ShortName), "The 'ShortName' property of a 'RuleVerificationList' is mandatory and cannot be empty or null.") },
        };
        ...
        /// </exception>
        public void Validate(CDP4Common.DTO.Thing ruleVerificationList)
        {
            this.Validate(ruleVerificationList, x => true);
        }
        ...
        /// If any validation rule failed.
        /// </exception>
        public void Validate(CDP4Common.DTO.Thing ruleVerificationList, Func<string, bool> validateProperty)
        {
            foreach (var applicableRule in this.validationRules.Where(x => validateProperty(x.Key)))
            {
                applicableRule.Value.Validate((CDP4Common.DTO.RuleVerificationList)ruleVerificationList);
            }
        }
        ...
        /// </returns>
        public bool TryValidate(CDP4Common.DTO.Thing ruleVerificationList)
        {
            return this.TryValidate(ruleVerificationList, x => true);
        }
        ...
        /// True if all validation rules have passed or if none are defined.
        /// </returns>
        public bool TryValidate(CDP4Common.DTO.Thing ruleVerificationList, Func<string, bool> validateProperty)
        {
            var applicableValidationRules = this.validationRules.Where(x => validateProperty(x.Key)).Select(x => x.Value);

            return applicableValidationRules.All(applicableRule => applicableRule.TryValidate((CDP4Common.DTO.RuleVerificationList)ruleVerificationList));
        }

        /// <summary>
        /// Returns the containment property value for the supplied <see cref="CDP4Common.DTO.RuleVerificationList"/>.
        /// </summary>
        /// <param name="ruleVerificationList">
        /// The <see cref="CDP4Common.DTO.RuleVerificationList"/> for which to return the containment property value.
        /// </param>
        ...
        /// If the property name is not supported for the <see cref="CDP4Common.DTO.RuleVerificationList"/>.
        /// </exception>
        public IEnumerable<Guid> GetContainmentIds(CDP4Common.DTO.Thing ruleVerificationList, string propertyName)
        {
            if (!this.containmentPropertyValueMap.ContainsKey(propertyName))
            {
                throw new ArgumentException(string.Format("'{0}' is not a valid containment property of 'RuleVerificationList'", propertyName));
            }

            return this.containmentPropertyValueMap[propertyName]((CDP4Common.DTO.RuleVerificationList)ruleVerificationList);
        }

        /// <summary>
        /// Returns the ordered containment property value for the supplied <see cref="CDP4Common.DTO.RuleVerificationList"/>.
        /// </summary>
        /// <param name="ruleVerificationList">
        /// The <see cref="CDP4Common.DTO.RuleVerificationList"/> for which to return the containment property value.
        /// </param>
        ...
        /// If the property name is not supported for the <see cref="CDP4Common.DTO.RuleVerificationList"/>.
        /// </exception>
        public IEnumerable<OrderedItem> GetOrderedContainmentIds(CDP4Common.DTO.Thing ruleVerificationList, string propertyName)
        {
            ...
            return this.orderedContainmentPropertyValueMap[propertyName]((CDP4Common.DTO.RuleVerificationList)ruleVerificationList);
        }
        ...
        private readonly Dictionary<string, PropertyMetaInfo> containmentTypeMap = new Dictionary<string, PropertyMetaInfo>
        {
            ...
            { "RuleVerification", new PropertyMetaInfo("RuleVerification", "Guid", PropertyKind.OrderedList, AggregationKind.Composite, false, true, true, 0, "*", true) },
        };

        /// <summary>
        /// Gets the <see cref="PropertyMetaInfo"/> for the <see cref="RuleVerificationList"/> class
        /// </summary>
        ...
        private readonly Dictionary<string, Func<object, object>> collectionPropertyValueDeserializationMap = new Dictionary<string, Func<object, object>>
        {
            ...
            { "RuleVerification", (value) => (Guid)value },
        };

        /// <summary>
        /// The property value assignment map.
        /// </summary>
        private readonly Dictionary<string, Action<CDP4Common.DTO.RuleVerificationList, object>> propertyValueAssignmentMap = new Dictionary<string, Action<CDP4Common.DTO.RuleVerificationList, object>>
        {
            { "Iid", (ruleVerificationList, value) => ruleVerificationList.Iid = (Guid)value },
            { "ModifiedOn", (ruleVerificationList, value) => ruleVerificationList.ModifiedOn = (DateTime)value },
        ...
        {
            { "Iteration", new PropertyMetaInfo("RuleVerificationList", "Guid", PropertyKind.List, AggregationKind.Composite, false, false, true, 0, "*", true) },
        };
        ...
        /// <summary>
        /// Returns the <see cref="CDP4Common.DTO.RuleVerificationList"/> containment property type from the supplied property name.
        /// </summary>
        /// <param name="propertyName">
        ...
        /// <summary>
        /// Returns the <see cref="CDP4Common.DTO.RuleVerificationList"/> property type from the supplied property name.
        /// </summary>
        /// <param name="propertyName">
        /// The property name.
        /// </param>
        ...
        /// <summary>
        /// Returns the container property for the supplied type name is a possible container for <see cref="CDP4Common.DTO.RuleVerificationList"/>.
        /// </summary>
        /// <param name="typeName">
        /// Name of the type for which to check if it is a container of <see cref="CDP4Common.DTO.RuleVerificationList"/>.
        /// </param>
        /// <param name="containerProperty">
        /// Supplied container property info instance that will be set if the supplied type name is a container of <see cref="CDP4Common.DTO.RuleVerificationList"/>.
        /// </param>
        /// <returns>
        /// True if the supplied typeName is a container for <see cref="CDP4Common.DTO.RuleVerificationList"/> and sets the container property name.
        /// </returns>
        ...
        /// <summary>
        /// Check if the supplied property name for <see cref="CDP4Common.DTO.RuleVerificationList"/> is scalar.
        /// </summary>
        /// <param name="propertyName">
        /// Name of the property for which to check if it is scalar.
        /// </param>
        ...
        public bool ApplyPropertyUpdate(CDP4Common.DTO.Thing updatableThing, string propertyName, object value)
        {
            ...
            this.propertyValueAssignmentMap[propertyName]((CDP4Common.DTO.RuleVerificationList)updatableThing, value);
        ...
        public object DeserializeCollectionValue(string propertyName, object value)
        {
            ...
            {
                throw new ArgumentException(string.Format("'{0}' is not a valid collection property of 'RuleVerificationList'", propertyName));
            }
        ...
        public object GetValue(string propertyName, CDP4Common.DTO.Thing thing)
        {
            ...
            return this.propertyValueMap[propertyName]((CDP4Common.DTO.RuleVerificationList)thing);
        }
        ...
        /// <summary>
        /// Instantiates a <see cref="CDP4Common.DTO.RuleVerificationList"/>
        /// </summary>
        /// <returns>
        ...
        {
            return new CDP4Common.DTO.RuleVerificationList(guid, revisionNumber);
        }
    }
}
