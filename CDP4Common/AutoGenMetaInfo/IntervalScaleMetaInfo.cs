// --------------------------------------------------------------------------------------------------------------------
// <copyright file="IntervalScaleMetaInfo.cs" company="RHEA System S.A.">
...
namespace CDP4Common.MetaInfo
{
    ...
    /// <summary>
    /// This a class that holds meta info for <see cref="IntervalScale"/>.
    /// </summary>
    public partial class IntervalScaleMetaInfo : IIntervalScaleMetaInfo
    {
        /// <summary>
        /// The containment property value map.
        /// </summary>
        private readonly Dictionary<string, Func<CDP4Common.DTO.IntervalScale, IEnumerable<Guid>>> containmentPropertyValueMap = new Dictionary<string, Func<CDP4Common.DTO.IntervalScale, IEnumerable<Guid>>>
        {
            { "Alias", intervalScale => intervalScale.Alias },
            { "Attachment", intervalScale => intervalScale.Attachment },
            { "Definition", intervalScale => intervalScale.Definition },
            { "HyperLink", intervalScale => intervalScale.HyperLink },
            { "MappingToReferenceScale", intervalScale => intervalScale.MappingToReferenceScale },
            { "ValueDefinition", intervalScale => intervalScale.ValueDefinition },
        };

        /// <summary>
        /// The ordered containment property value map.
        /// </summary>
        private readonly Dictionary<string, Func<CDP4Common.DTO.IntervalScale, IEnumerable<OrderedItem>>> orderedContainmentPropertyValueMap = new Dictionary<string, Func<CDP4Common.DTO.IntervalScale, IEnumerable<OrderedItem>>>();

        /// <summary>
        /// The validation rules that should pass for an instance of <see cref="CDP4Common.DTO.IntervalScale"/>.
        /// </summary>
        private readonly Dictionary<string, DtoValidationHelper<CDP4Common.DTO.IntervalScale>> validationRules = new Dictionary<string, DtoValidationHelper<CDP4Common.DTO.IntervalScale>>
        {
            { "Alias", new DtoValidationHelper<CDP4Common.DTO.IntervalScale>(item => item.Alias != null, "The 'Alias' property of a 'IntervalScale' is mandatory and cannot be null.") },
            { "Attachment", new DtoValidationHelper<CDP4Common.DTO.IntervalScale>(item => item.Attachment != null, "The 'Attachment' property of a 'IntervalScale' is mandatory and cannot be null.") },
            { "Definition", new DtoValidationHelper<CDP4Common.DTO.IntervalScale>(item => item.Definition != null, "The 'Definition' property of a 'IntervalScale' is mandatory and cannot be null.") },
            { "ExcludedDomain", new DtoValidationHelper<CDP4Common.DTO.IntervalScale>(item => item.ExcludedDomain != null, "The 'ExcludedDomain' property of a 'IntervalScale' is mandatory and cannot be null.") },
            { "ExcludedPerson", new DtoValidationHelper<CDP4Common.DTO.IntervalScale>(item => item.ExcludedPerson != null, "The 'ExcludedPerson' property of a 'IntervalScale' is mandatory and cannot be null.") },
            { "HyperLink", new DtoValidationHelper<CDP4Common.DTO.IntervalScale>(item => item.HyperLink != null, "The 'HyperLink' property of a 'IntervalScale' is mandatory and cannot be null.") },
            { "MappingToReferenceScale", new DtoValidationHelper<CDP4Common.DTO.IntervalScale>(item => item.MappingToReferenceScale != null, "The 'MappingToReferenceScale' property of a 'IntervalScale' is mandatory and cannot be null.") },
            { "Name", new DtoValidationHelper<CDP4Common.DTO.IntervalScale>(item => !string.IsNullOrWhiteSpace(item.Name), "The 'Name' property of a 'IntervalScale' is mandatory and cannot be empty or null.") },
            { "ShortName", new DtoValidationHelper<CDP4Common.DTO.IntervalScale>(item => !string.IsNullOrWhiteSpace(item.ShortName), "The 'ShortName' property of a 'IntervalScale' is mandatory and cannot be empty or null.") },
            { "ValueDefinition", new DtoValidationHelper<CDP4Common.DTO.IntervalScale>(item => item.ValueDefinition != null, "The 'ValueDefinition' property of a 'IntervalScale' is mandatory and cannot be null.") },
        };
        ...
        /// </exception>
        public void Validate(CDP4Common.DTO.Thing intervalScale)
        {
            this.Validate(intervalScale, x => true);
        }
        ...
        /// If any validation rule failed.
        /// </exception>
        public void Validate(CDP4Common.DTO.Thing intervalScale, Func<string, bool> validateProperty)
        {
            foreach (var applicableRule in this.validationRules.Where(x => validateProperty(x.Key)))
            {
                applicableRule.Value.Validate((CDP4Common.DTO.IntervalScale)intervalScale);
            }
        }
        ...
        /// </returns>
        public bool TryValidate(CDP4Common.DTO.Thing intervalScale)
        {
            return this.TryValidate(intervalScale, x => true);
        }
        ...
        /// True if all validation rules have passed or if none are defined.
        /// </returns>
        public bool TryValidate(CDP4Common.DTO.Thing intervalScale, Func<string, bool> validateProperty)
        {
            var applicableValidationRules = this.validationRules.Where(x => validateProperty(x.Key)).Select(x => x.Value);

            return applicableValidationRules.All(applicableRule => applicableRule.TryValidate((CDP4Common.DTO.IntervalScale)intervalScale));
        }

        /// <summary>
        /// Returns the containment property value for the supplied <see cref="CDP4Common.DTO.IntervalScale"/>.
        /// </summary>
        /// <param name="intervalScale">
        /// The <see cref="CDP4Common.DTO.IntervalScale"/> for which to return the containment property value.
        /// </param>
        ...
        /// If the property name is not supported for the <see cref="CDP4Common.DTO.IntervalScale"/>.
        /// </exception>
        public IEnumerable<Guid> GetContainmentIds(CDP4Common.DTO.Thing intervalScale, string propertyName)
        {
            if (!this.containmentPropertyValueMap.ContainsKey(propertyName))
            {
                throw new ArgumentException($"'{propertyName}' is not a valid containment property of 'IntervalScale'");
            }

            return this.containmentPropertyValueMap[propertyName]((CDP4Common.DTO.IntervalScale)intervalScale);
        }

        /// <summary>
        /// Returns the ordered containment property value for the supplied <see cref="CDP4Common.DTO.IntervalScale"/>.
        /// </summary>
        /// <param name="intervalScale">
        /// The <see cref="CDP4Common.DTO.IntervalScale"/> for which to return the containment property value.
        /// </param>
        ...
        /// If the property name is not supported for the <see cref="CDP4Common.DTO.IntervalScale"/>.
        /// </exception>
        public IEnumerable<OrderedItem> GetOrderedContainmentIds(CDP4Common.DTO.Thing intervalScale, string propertyName)
        {
            ...
            return this.orderedContainmentPropertyValueMap[propertyName]((CDP4Common.DTO.IntervalScale)intervalScale);
        }
        ...
        /// <summary>
        /// Gets the <see cref="PropertyMetaInfo"/> for the <see cref="IntervalScale"/> class
        /// </summary>
        ...
        /// </summary>
        private readonly Dictionary<string, Func<CDP4Common.DTO.IntervalScale, object>> propertyValueMap = new Dictionary<string, Func<CDP4Common.DTO.IntervalScale, object>>
        {
        ...
        /// </summary>
        private readonly Dictionary<string, Action<CDP4Common.DTO.IntervalScale, object>> propertyValueAssignmentMap = new Dictionary<string, Action<CDP4Common.DTO.IntervalScale, object>>
        {
            { "Actor", (intervalScale, value) => intervalScale.Actor = value == null ? (Guid?)null : (Guid)value },
            { "Iid", (intervalScale, value) => intervalScale.Iid = (Guid)value },
            { "IsDeprecated", (intervalScale, value) => intervalScale.IsDeprecated = (bool)value },
            { "IsMaximumInclusive", (intervalScale, value) => intervalScale.IsMaximumInclusive = (bool)value },
            { "IsMinimumInclusive", (intervalScale, value) => intervalScale.IsMinimumInclusive = (bool)value },
            { "MaximumPermissibleValue", (intervalScale, value) => intervalScale.MaximumPermissibleValue = value == null ? (string)null : value.ToString() },
            { "MinimumPermissibleValue", (intervalScale, value) => intervalScale.MinimumPermissibleValue = value == null ? (string)null : value.ToString() },
            { "ModifiedOn", (intervalScale, value) => intervalScale.ModifiedOn = (DateTime)value },
            { "Name", (intervalScale, value) => intervalScale.Name = value.ToString() },
            { "NegativeValueConnotation", (intervalScale, value) => intervalScale.NegativeValueConnotation = value == null ? (string)null : value.ToString() },
            { "NumberSet", (intervalScale, value) => intervalScale.NumberSet = (NumberSetKind)value },
            { "PositiveValueConnotation", (intervalScale, value) => intervalScale.PositiveValueConnotation = value == null ? (string)null : value.ToString() },
            { "ShortName", (intervalScale, value) => intervalScale.ShortName = value.ToString() },
            { "ThingPreference", (intervalScale, value) => intervalScale.ThingPreference = value == null ? (string)null : value.ToString() },
            { "Unit", (intervalScale, value) => intervalScale.Unit = (Guid)value },
        };
        ...
        /// <summary>
        /// Returns the <see cref="CDP4Common.DTO.IntervalScale"/> containment property type from the supplied property name.
        /// </summary>
        /// <param name="propertyName">
        ...
        /// <summary>
        /// Returns the <see cref="CDP4Common.DTO.IntervalScale"/> property type from the supplied property name.
        /// </summary>
        /// <param name="propertyName">
        /// The property name.
        /// </param>
        ...
        /// <summary>
        /// Returns the container property for the supplied type name is a possible container for <see cref="CDP4Common.DTO.IntervalScale"/>.
        /// </summary>
        /// <param name="typeName">
        /// Name of the type for which to check if it is a container of <see cref="CDP4Common.DTO.IntervalScale"/>.
        /// </param>
        /// <param name="containerProperty">
        /// Supplied container property info instance that will be set if the supplied type name is a container of <see cref="CDP4Common.DTO.IntervalScale"/>.
        /// </param>
        /// <returns>
        /// True if the supplied typeName is a container for <see cref="CDP4Common.DTO.IntervalScale"/> and sets the container property name.
        /// </returns>
        ...
        /// <summary>
        /// Check if the supplied property name for <see cref="CDP4Common.DTO.IntervalScale"/> is scalar.
        /// </summary>
        /// <param name="propertyName">
        /// Name of the property for which to check if it is scalar.
        /// </param>
        ...
        public bool ApplyPropertyUpdate(CDP4Common.DTO.Thing updatableThing, string propertyName, object value)
        {
            ...
            this.propertyValueAssignmentMap[propertyName]((CDP4Common.DTO.IntervalScale)updatableThing, value);
        ...
        public object DeserializeCollectionValue(string propertyName, object value)
        {
            ...
            {
                throw new ArgumentException($"'{propertyName}' is not a valid collection property of 'IntervalScale'");
            }
        ...
        public object GetValue(string propertyName, CDP4Common.DTO.Thing thing)
        {
            ...
            return this.propertyValueMap[propertyName]((CDP4Common.DTO.IntervalScale)thing);
        }
        ...
        /// <summary>
        /// Instantiates a <see cref="CDP4Common.DTO.IntervalScale"/>
        /// </summary>
        /// <returns>
        ...
        {
            return new CDP4Common.DTO.IntervalScale(guid, revisionNumber);
        }
    }
}
