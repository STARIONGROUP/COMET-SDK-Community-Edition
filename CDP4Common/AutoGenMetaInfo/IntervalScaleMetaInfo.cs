...
namespace CDP4Common.MetaInfo
{
    ...
    public partial class IntervalScaleMetaInfo : IIntervalScaleMetaInfo
    {
        ...
        public IEnumerable<Guid> GetContainmentIds(CDP4Common.DTO.Thing intervalScale, string propertyName)
        {
            ...
            {
                throw new ArgumentException(string.Format("'{0}' is not a valid containment property of 'IntervalScale'", propertyName));
            }
        ...
        public object DeserializeCollectionValue(string propertyName, object value)
        {
            ...
            {
                throw new ArgumentException(string.Format("'{0}' is not a valid collection property of 'IntervalScale'", propertyName));
            }
