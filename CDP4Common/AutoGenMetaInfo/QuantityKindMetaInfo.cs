...
namespace CDP4Common.MetaInfo
{
    ...
    public partial class QuantityKindMetaInfo : IQuantityKindMetaInfo
    {
        ...
        public IEnumerable<Guid> GetContainmentIds(CDP4Common.DTO.Thing quantityKind, string propertyName)
        {
            ...
            {
                throw new ArgumentException(string.Format("'{0}' is not a valid containment property of 'QuantityKind'", propertyName));
            }
        ...
        public object DeserializeCollectionValue(string propertyName, object value)
        {
            ...
            {
                throw new ArgumentException(string.Format("'{0}' is not a valid collection property of 'QuantityKind'", propertyName));
            }
