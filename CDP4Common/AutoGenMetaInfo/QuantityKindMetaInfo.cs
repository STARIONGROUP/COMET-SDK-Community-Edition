// --------------------------------------------------------------------------------------------------------------------
// <copyright file="QuantityKindMetaInfo.cs" company="RHEA System S.A.">
...
namespace CDP4Common.MetaInfo
{
    ...
    /// <summary>
    /// This a class that holds meta info for <see cref="QuantityKind"/>.
    /// </summary>
    public partial class QuantityKindMetaInfo : IQuantityKindMetaInfo
    {
        /// <summary>
        /// The containment property value map.
        /// </summary>
        private readonly Dictionary<string, Func<CDP4Common.DTO.QuantityKind, IEnumerable<Guid>>> containmentPropertyValueMap = new Dictionary<string, Func<CDP4Common.DTO.QuantityKind, IEnumerable<Guid>>>
        {
            { "Alias", quantityKind => quantityKind.Alias },
            { "Attachment", quantityKind => quantityKind.Attachment },
            { "Definition", quantityKind => quantityKind.Definition },
            { "HyperLink", quantityKind => quantityKind.HyperLink },
        };

        /// <summary>
        /// The ordered containment property value map.
        /// </summary>
        private readonly Dictionary<string, Func<CDP4Common.DTO.QuantityKind, IEnumerable<OrderedItem>>> orderedContainmentPropertyValueMap = new Dictionary<string, Func<CDP4Common.DTO.QuantityKind, IEnumerable<OrderedItem>>>();

        /// <summary>
        /// The validation rules that should pass for an instance of <see cref="CDP4Common.DTO.QuantityKind"/>.
        /// </summary>
        private readonly Dictionary<string, DtoValidationHelper<CDP4Common.DTO.QuantityKind>> validationRules = new Dictionary<string, DtoValidationHelper<CDP4Common.DTO.QuantityKind>>
        {
            { "Alias", new DtoValidationHelper<CDP4Common.DTO.QuantityKind>(item => item.Alias != null, "The 'Alias' property of a 'QuantityKind' is mandatory and cannot be null.") },
            { "Attachment", new DtoValidationHelper<CDP4Common.DTO.QuantityKind>(item => item.Attachment != null, "The 'Attachment' property of a 'QuantityKind' is mandatory and cannot be null.") },
            { "Category", new DtoValidationHelper<CDP4Common.DTO.QuantityKind>(item => item.Category != null, "The 'Category' property of a 'QuantityKind' is mandatory and cannot be null.") },
            { "Definition", new DtoValidationHelper<CDP4Common.DTO.QuantityKind>(item => item.Definition != null, "The 'Definition' property of a 'QuantityKind' is mandatory and cannot be null.") },
            { "ExcludedDomain", new DtoValidationHelper<CDP4Common.DTO.QuantityKind>(item => item.ExcludedDomain != null, "The 'ExcludedDomain' property of a 'QuantityKind' is mandatory and cannot be null.") },
            { "ExcludedPerson", new DtoValidationHelper<CDP4Common.DTO.QuantityKind>(item => item.ExcludedPerson != null, "The 'ExcludedPerson' property of a 'QuantityKind' is mandatory and cannot be null.") },
            { "HyperLink", new DtoValidationHelper<CDP4Common.DTO.QuantityKind>(item => item.HyperLink != null, "The 'HyperLink' property of a 'QuantityKind' is mandatory and cannot be null.") },
            { "Name", new DtoValidationHelper<CDP4Common.DTO.QuantityKind>(item => !string.IsNullOrWhiteSpace(item.Name), "The 'Name' property of a 'QuantityKind' is mandatory and cannot be empty or null.") },
            { "PossibleScale", new DtoValidationHelper<CDP4Common.DTO.QuantityKind>(item => item.PossibleScale != null, "The 'PossibleScale' property of a 'QuantityKind' is mandatory and cannot be null.") },
            { "ShortName", new DtoValidationHelper<CDP4Common.DTO.QuantityKind>(item => !string.IsNullOrWhiteSpace(item.ShortName), "The 'ShortName' property of a 'QuantityKind' is mandatory and cannot be empty or null.") },
            { "Symbol", new DtoValidationHelper<CDP4Common.DTO.QuantityKind>(item => !string.IsNullOrWhiteSpace(item.Symbol), "The 'Symbol' property of a 'QuantityKind' is mandatory and cannot be empty or null.") },
        };
        ...
        /// </exception>
        public void Validate(CDP4Common.DTO.Thing quantityKind)
        {
            this.Validate(quantityKind, x => true);
        }
        ...
        /// If any validation rule failed.
        /// </exception>
        public void Validate(CDP4Common.DTO.Thing quantityKind, Func<string, bool> validateProperty)
        {
            foreach (var applicableRule in this.validationRules.Where(x => validateProperty(x.Key)))
            {
                applicableRule.Value.Validate((CDP4Common.DTO.QuantityKind)quantityKind);
            }
        }
        ...
        /// </returns>
        public bool TryValidate(CDP4Common.DTO.Thing quantityKind)
        {
            return this.TryValidate(quantityKind, x => true);
        }
        ...
        /// True if all validation rules have passed or if none are defined.
        /// </returns>
        public bool TryValidate(CDP4Common.DTO.Thing quantityKind, Func<string, bool> validateProperty)
        {
            var applicableValidationRules = this.validationRules.Where(x => validateProperty(x.Key)).Select(x => x.Value);

            return applicableValidationRules.All(applicableRule => applicableRule.TryValidate((CDP4Common.DTO.QuantityKind)quantityKind));
        }

        /// <summary>
        /// Returns the containment property value for the supplied <see cref="CDP4Common.DTO.QuantityKind"/>.
        /// </summary>
        /// <param name="quantityKind">
        /// The <see cref="CDP4Common.DTO.QuantityKind"/> for which to return the containment property value.
        /// </param>
        ...
        /// If the property name is not supported for the <see cref="CDP4Common.DTO.QuantityKind"/>.
        /// </exception>
        public IEnumerable<Guid> GetContainmentIds(CDP4Common.DTO.Thing quantityKind, string propertyName)
        {
            if (!this.containmentPropertyValueMap.ContainsKey(propertyName))
            {
                throw new ArgumentException($"'{propertyName}' is not a valid containment property of 'QuantityKind'");
            }

            return this.containmentPropertyValueMap[propertyName]((CDP4Common.DTO.QuantityKind)quantityKind);
        }

        /// <summary>
        /// Returns the ordered containment property value for the supplied <see cref="CDP4Common.DTO.QuantityKind"/>.
        /// </summary>
        /// <param name="quantityKind">
        /// The <see cref="CDP4Common.DTO.QuantityKind"/> for which to return the containment property value.
        /// </param>
        ...
        /// If the property name is not supported for the <see cref="CDP4Common.DTO.QuantityKind"/>.
        /// </exception>
        public IEnumerable<OrderedItem> GetOrderedContainmentIds(CDP4Common.DTO.Thing quantityKind, string propertyName)
        {
            ...
            return this.orderedContainmentPropertyValueMap[propertyName]((CDP4Common.DTO.QuantityKind)quantityKind);
        }
        ...
        /// <summary>
        /// Gets the <see cref="PropertyMetaInfo"/> for the <see cref="QuantityKind"/> class
        /// </summary>
        ...
        /// </summary>
        private readonly Dictionary<string, Func<CDP4Common.DTO.QuantityKind, object>> propertyValueMap = new Dictionary<string, Func<CDP4Common.DTO.QuantityKind, object>>
        {
        ...
        /// </summary>
        private readonly Dictionary<string, Action<CDP4Common.DTO.QuantityKind, object>> propertyValueAssignmentMap = new Dictionary<string, Action<CDP4Common.DTO.QuantityKind, object>>
        {
            { "Actor", (quantityKind, value) => quantityKind.Actor = value == null ? (Guid?)null : (Guid)value },
            { "DefaultScale", (quantityKind, value) => quantityKind.DefaultScale = (Guid)value },
            { "Iid", (quantityKind, value) => quantityKind.Iid = (Guid)value },
            { "IsDeprecated", (quantityKind, value) => quantityKind.IsDeprecated = (bool)value },
            { "ModifiedOn", (quantityKind, value) => quantityKind.ModifiedOn = (DateTime)value },
            { "Name", (quantityKind, value) => quantityKind.Name = value.ToString() },
        ...
        /// <summary>
        /// Returns the <see cref="CDP4Common.DTO.QuantityKind"/> containment property type from the supplied property name.
        /// </summary>
        /// <param name="propertyName">
        ...
        /// <summary>
        /// Returns the <see cref="CDP4Common.DTO.QuantityKind"/> property type from the supplied property name.
        /// </summary>
        /// <param name="propertyName">
        /// The property name.
        /// </param>
        ...
        /// <summary>
        /// Returns the container property for the supplied type name is a possible container for <see cref="CDP4Common.DTO.QuantityKind"/>.
        /// </summary>
        /// <param name="typeName">
        /// Name of the type for which to check if it is a container of <see cref="CDP4Common.DTO.QuantityKind"/>.
        /// </param>
        /// <param name="containerProperty">
        /// Supplied container property info instance that will be set if the supplied type name is a container of <see cref="CDP4Common.DTO.QuantityKind"/>.
        /// </param>
        /// <returns>
        /// True if the supplied typeName is a container for <see cref="CDP4Common.DTO.QuantityKind"/> and sets the container property name.
        /// </returns>
        ...
        /// <summary>
        /// Check if the supplied property name for <see cref="CDP4Common.DTO.QuantityKind"/> is scalar.
        /// </summary>
        /// <param name="propertyName">
        /// Name of the property for which to check if it is scalar.
        /// </param>
        ...
        public bool ApplyPropertyUpdate(CDP4Common.DTO.Thing updatableThing, string propertyName, object value)
        {
            ...
            this.propertyValueAssignmentMap[propertyName]((CDP4Common.DTO.QuantityKind)updatableThing, value);
        ...
        public object DeserializeCollectionValue(string propertyName, object value)
        {
            ...
            {
                throw new ArgumentException($"'{propertyName}' is not a valid collection property of 'QuantityKind'");
            }
        ...
        public object GetValue(string propertyName, CDP4Common.DTO.Thing thing)
        {
            ...
            return this.propertyValueMap[propertyName]((CDP4Common.DTO.QuantityKind)thing);
        }
        ...
        /// <summary>
        /// Instantiates a <see cref="CDP4Common.DTO.QuantityKind"/>
        /// </summary>
        /// <returns>
