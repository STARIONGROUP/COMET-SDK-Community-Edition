// --------------------------------------------------------------------------------------------------------------------
// <copyright file="ParameterTypeComponentMetaInfo.cs" company="Starion Group S.A.">
...
namespace CDP4Common.MetaInfo
{
    ...
    public partial class ParameterTypeComponentMetaInfo : IParameterTypeComponentMetaInfo
    {
        ...
        public IEnumerable<Guid> GetContainmentIds(CDP4Common.DTO.Thing parameterTypeComponent, string propertyName)
        {
            ...
            {
                throw new ArgumentException($"'{propertyName}' is not a valid containment property of 'ParameterTypeComponent'");
            }
        ...
        {
            { "Actor", (parameterTypeComponent, value) => parameterTypeComponent.Actor = value == null ? (Guid?)null : (Guid)value },
        ...
        public object DeserializeCollectionValue(string propertyName, object value)
        {
            ...
            {
                throw new ArgumentException($"'{propertyName}' is not a valid collection property of 'ParameterTypeComponent'");
            }
