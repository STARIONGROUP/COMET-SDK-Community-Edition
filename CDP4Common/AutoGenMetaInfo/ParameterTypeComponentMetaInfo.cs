// --------------------------------------------------------------------------------------------------------------------
// <copyright file="ParameterTypeComponentMetaInfo.cs" company="RHEA System S.A.">
...
namespace CDP4Common.MetaInfo
{
    ...
    /// <summary>
    /// This a class that holds meta info for <see cref="ParameterTypeComponent"/>.
    /// </summary>
    public partial class ParameterTypeComponentMetaInfo : IParameterTypeComponentMetaInfo
    {
        /// <summary>
        /// The containment property value map.
        /// </summary>
        private readonly Dictionary<string, Func<CDP4Common.DTO.ParameterTypeComponent, IEnumerable<Guid>>> containmentPropertyValueMap = new Dictionary<string, Func<CDP4Common.DTO.ParameterTypeComponent, IEnumerable<Guid>>>();

        /// <summary>
        /// The ordered containment property value map.
        /// </summary>
        private readonly Dictionary<string, Func<CDP4Common.DTO.ParameterTypeComponent, IEnumerable<OrderedItem>>> orderedContainmentPropertyValueMap = new Dictionary<string, Func<CDP4Common.DTO.ParameterTypeComponent, IEnumerable<OrderedItem>>>();

        /// <summary>
        /// The validation rules that should pass for an instance of <see cref="CDP4Common.DTO.ParameterTypeComponent"/>.
        /// </summary>
        private readonly Dictionary<string, DtoValidationHelper<CDP4Common.DTO.ParameterTypeComponent>> validationRules = new Dictionary<string, DtoValidationHelper<CDP4Common.DTO.ParameterTypeComponent>>
        {
            { "ExcludedDomain", new DtoValidationHelper<CDP4Common.DTO.ParameterTypeComponent>(item => item.ExcludedDomain != null, "The 'ExcludedDomain' property of a 'ParameterTypeComponent' is mandatory and cannot be null.") },
            { "ExcludedPerson", new DtoValidationHelper<CDP4Common.DTO.ParameterTypeComponent>(item => item.ExcludedPerson != null, "The 'ExcludedPerson' property of a 'ParameterTypeComponent' is mandatory and cannot be null.") },
            { "ShortName", new DtoValidationHelper<CDP4Common.DTO.ParameterTypeComponent>(item => !string.IsNullOrWhiteSpace(item.ShortName), "The 'ShortName' property of a 'ParameterTypeComponent' is mandatory and cannot be empty or null.") },
        };
        ...
        /// </exception>
        public void Validate(CDP4Common.DTO.Thing parameterTypeComponent)
        {
            this.Validate(parameterTypeComponent, x => true);
        }
        ...
        /// If any validation rule failed.
        /// </exception>
        public void Validate(CDP4Common.DTO.Thing parameterTypeComponent, Func<string, bool> validateProperty)
        {
            foreach (var applicableRule in this.validationRules.Where(x => validateProperty(x.Key)))
            {
                applicableRule.Value.Validate((CDP4Common.DTO.ParameterTypeComponent)parameterTypeComponent);
            }
        }
        ...
        /// </returns>
        public bool TryValidate(CDP4Common.DTO.Thing parameterTypeComponent)
        {
            return this.TryValidate(parameterTypeComponent, x => true);
        }
        ...
        /// True if all validation rules have passed or if none are defined.
        /// </returns>
        public bool TryValidate(CDP4Common.DTO.Thing parameterTypeComponent, Func<string, bool> validateProperty)
        {
            var applicableValidationRules = this.validationRules.Where(x => validateProperty(x.Key)).Select(x => x.Value);

            return applicableValidationRules.All(applicableRule => applicableRule.TryValidate((CDP4Common.DTO.ParameterTypeComponent)parameterTypeComponent));
        }

        /// <summary>
        /// Returns the containment property value for the supplied <see cref="CDP4Common.DTO.ParameterTypeComponent"/>.
        /// </summary>
        /// <param name="parameterTypeComponent">
        /// The <see cref="CDP4Common.DTO.ParameterTypeComponent"/> for which to return the containment property value.
        /// </param>
        ...
        /// If the property name is not supported for the <see cref="CDP4Common.DTO.ParameterTypeComponent"/>.
        /// </exception>
        public IEnumerable<Guid> GetContainmentIds(CDP4Common.DTO.Thing parameterTypeComponent, string propertyName)
        {
            if (!this.containmentPropertyValueMap.ContainsKey(propertyName))
            {
                throw new ArgumentException(string.Format("'{0}' is not a valid containment property of 'ParameterTypeComponent'", propertyName));
            }

            return this.containmentPropertyValueMap[propertyName]((CDP4Common.DTO.ParameterTypeComponent)parameterTypeComponent);
        }

        /// <summary>
        /// Returns the ordered containment property value for the supplied <see cref="CDP4Common.DTO.ParameterTypeComponent"/>.
        /// </summary>
        /// <param name="parameterTypeComponent">
        /// The <see cref="CDP4Common.DTO.ParameterTypeComponent"/> for which to return the containment property value.
        /// </param>
        ...
        /// If the property name is not supported for the <see cref="CDP4Common.DTO.ParameterTypeComponent"/>.
        /// </exception>
        public IEnumerable<OrderedItem> GetOrderedContainmentIds(CDP4Common.DTO.Thing parameterTypeComponent, string propertyName)
        {
            ...
            return this.orderedContainmentPropertyValueMap[propertyName]((CDP4Common.DTO.ParameterTypeComponent)parameterTypeComponent);
        }
        ...
        /// <summary>
        /// Gets the <see cref="PropertyMetaInfo"/> for the <see cref="ParameterTypeComponent"/> class
        /// </summary>
        ...
        /// </summary>
        private readonly Dictionary<string, Func<CDP4Common.DTO.ParameterTypeComponent, object>> propertyValueMap = new Dictionary<string, Func<CDP4Common.DTO.ParameterTypeComponent, object>>
        {
        ...
        /// </summary>
        private readonly Dictionary<string, Action<CDP4Common.DTO.ParameterTypeComponent, object>> propertyValueAssignmentMap = new Dictionary<string, Action<CDP4Common.DTO.ParameterTypeComponent, object>>
        {
            { "Iid", (parameterTypeComponent, value) => parameterTypeComponent.Iid = (Guid)value },
            { "ModifiedOn", (parameterTypeComponent, value) => parameterTypeComponent.ModifiedOn = (DateTime)value },
        ...
        {
            { "ArrayParameterType", new PropertyMetaInfo("Component", "Guid", PropertyKind.OrderedList, AggregationKind.Composite, false, true, true, 1, "*", true) },
            { "CompoundParameterType", new PropertyMetaInfo("Component", "Guid", PropertyKind.OrderedList, AggregationKind.Composite, false, true, true, 1, "*", true) },
        };
        ...
        /// <summary>
        /// Returns the <see cref="CDP4Common.DTO.ParameterTypeComponent"/> containment property type from the supplied property name.
        /// </summary>
        /// <param name="propertyName">
        ...
        /// <summary>
        /// Returns the <see cref="CDP4Common.DTO.ParameterTypeComponent"/> property type from the supplied property name.
        /// </summary>
        /// <param name="propertyName">
        /// The property name.
        /// </param>
        ...
        /// <summary>
        /// Returns the container property for the supplied type name is a possible container for <see cref="CDP4Common.DTO.ParameterTypeComponent"/>.
        /// </summary>
        /// <param name="typeName">
        /// Name of the type for which to check if it is a container of <see cref="CDP4Common.DTO.ParameterTypeComponent"/>.
        /// </param>
        /// <param name="containerProperty">
        /// Supplied container property info instance that will be set if the supplied type name is a container of <see cref="CDP4Common.DTO.ParameterTypeComponent"/>.
        /// </param>
        /// <returns>
        /// True if the supplied typeName is a container for <see cref="CDP4Common.DTO.ParameterTypeComponent"/> and sets the container property name.
        /// </returns>
        ...
        /// <summary>
        /// Check if the supplied property name for <see cref="CDP4Common.DTO.ParameterTypeComponent"/> is scalar.
        /// </summary>
        /// <param name="propertyName">
        /// Name of the property for which to check if it is scalar.
        /// </param>
        ...
        public bool ApplyPropertyUpdate(CDP4Common.DTO.Thing updatableThing, string propertyName, object value)
        {
            ...
            this.propertyValueAssignmentMap[propertyName]((CDP4Common.DTO.ParameterTypeComponent)updatableThing, value);
        ...
        public object DeserializeCollectionValue(string propertyName, object value)
        {
            ...
            {
                throw new ArgumentException(string.Format("'{0}' is not a valid collection property of 'ParameterTypeComponent'", propertyName));
            }
        ...
        public object GetValue(string propertyName, CDP4Common.DTO.Thing thing)
        {
            ...
            return this.propertyValueMap[propertyName]((CDP4Common.DTO.ParameterTypeComponent)thing);
        }
        ...
        /// <summary>
        /// Instantiates a <see cref="CDP4Common.DTO.ParameterTypeComponent"/>
        /// </summary>
        /// <returns>
        ...
        {
            return new CDP4Common.DTO.ParameterTypeComponent(guid, revisionNumber);
        }
    }
}
