// --------------------------------------------------------------------------------------------------------------------
// <copyright file="OwnedStyleMetaInfo.cs" company="Starion Group S.A.">
...
namespace CDP4Common.MetaInfo
{
    ...
    public partial class OwnedStyleMetaInfo : IOwnedStyleMetaInfo
    {
        ...
        public IEnumerable<Guid> GetContainmentIds(CDP4Common.DTO.Thing ownedStyle, string propertyName)
        {
            ...
            {
                throw new ArgumentException($"'{propertyName}' is not a valid containment property of 'OwnedStyle'");
            }
        ...
        {
            { "Actor", (ownedStyle, value) => ownedStyle.Actor = value == null ? (Guid?)null : (Guid)value },
            ...
            { "ThingPreference", (ownedStyle, value) => ownedStyle.ThingPreference = value == null ? (string)null : value.ToString() },
        };
        ...
        public object DeserializeCollectionValue(string propertyName, object value)
        {
            ...
            {
                throw new ArgumentException($"'{propertyName}' is not a valid collection property of 'OwnedStyle'");
            }
