// --------------------------------------------------------------------------------------------------------------------
// <copyright file="OwnedStyleMetaInfo.cs" company="RHEA System S.A.">
...
namespace CDP4Common.MetaInfo
{
    ...
    /// <summary>
    /// This a class that holds meta info for <see cref="OwnedStyle"/>.
    /// </summary>
    public partial class OwnedStyleMetaInfo : IOwnedStyleMetaInfo
    {
        /// <summary>
        /// The containment property value map.
        /// </summary>
        private readonly Dictionary<string, Func<CDP4Common.DTO.OwnedStyle, IEnumerable<Guid>>> containmentPropertyValueMap = new Dictionary<string, Func<CDP4Common.DTO.OwnedStyle, IEnumerable<Guid>>>
        {
            { "UsedColor", ownedStyle => ownedStyle.UsedColor },
        };

        /// <summary>
        /// The ordered containment property value map.
        /// </summary>
        private readonly Dictionary<string, Func<CDP4Common.DTO.OwnedStyle, IEnumerable<OrderedItem>>> orderedContainmentPropertyValueMap = new Dictionary<string, Func<CDP4Common.DTO.OwnedStyle, IEnumerable<OrderedItem>>>();

        /// <summary>
        /// The validation rules that should pass for an instance of <see cref="CDP4Common.DTO.OwnedStyle"/>.
        /// </summary>
        private readonly Dictionary<string, DtoValidationHelper<CDP4Common.DTO.OwnedStyle>> validationRules = new Dictionary<string, DtoValidationHelper<CDP4Common.DTO.OwnedStyle>>
        {
            { "ExcludedDomain", new DtoValidationHelper<CDP4Common.DTO.OwnedStyle>(item => item.ExcludedDomain != null, "The 'ExcludedDomain' property of a 'OwnedStyle' is mandatory and cannot be null.") },
            { "ExcludedPerson", new DtoValidationHelper<CDP4Common.DTO.OwnedStyle>(item => item.ExcludedPerson != null, "The 'ExcludedPerson' property of a 'OwnedStyle' is mandatory and cannot be null.") },
            { "Name", new DtoValidationHelper<CDP4Common.DTO.OwnedStyle>(item => !string.IsNullOrWhiteSpace(item.Name), "The 'Name' property of a 'OwnedStyle' is mandatory and cannot be empty or null.") },
            { "UsedColor", new DtoValidationHelper<CDP4Common.DTO.OwnedStyle>(item => item.UsedColor != null, "The 'UsedColor' property of a 'OwnedStyle' is mandatory and cannot be null.") },
        };
        ...
        /// </exception>
        public void Validate(CDP4Common.DTO.Thing ownedStyle)
        {
            this.Validate(ownedStyle, x => true);
        }
        ...
        /// If any validation rule failed.
        /// </exception>
        public void Validate(CDP4Common.DTO.Thing ownedStyle, Func<string, bool> validateProperty)
        {
            foreach (var applicableRule in this.validationRules.Where(x => validateProperty(x.Key)))
            {
                applicableRule.Value.Validate((CDP4Common.DTO.OwnedStyle)ownedStyle);
            }
        }
        ...
        /// </returns>
        public bool TryValidate(CDP4Common.DTO.Thing ownedStyle)
        {
            return this.TryValidate(ownedStyle, x => true);
        }
        ...
        /// True if all validation rules have passed or if none are defined.
        /// </returns>
        public bool TryValidate(CDP4Common.DTO.Thing ownedStyle, Func<string, bool> validateProperty)
        {
            var applicableValidationRules = this.validationRules.Where(x => validateProperty(x.Key)).Select(x => x.Value);

            return applicableValidationRules.All(applicableRule => applicableRule.TryValidate((CDP4Common.DTO.OwnedStyle)ownedStyle));
        }

        /// <summary>
        /// Returns the containment property value for the supplied <see cref="CDP4Common.DTO.OwnedStyle"/>.
        /// </summary>
        /// <param name="ownedStyle">
        /// The <see cref="CDP4Common.DTO.OwnedStyle"/> for which to return the containment property value.
        /// </param>
        ...
        /// If the property name is not supported for the <see cref="CDP4Common.DTO.OwnedStyle"/>.
        /// </exception>
        public IEnumerable<Guid> GetContainmentIds(CDP4Common.DTO.Thing ownedStyle, string propertyName)
        {
            if (!this.containmentPropertyValueMap.ContainsKey(propertyName))
            {
                throw new ArgumentException(string.Format("'{0}' is not a valid containment property of 'OwnedStyle'", propertyName));
            }

            return this.containmentPropertyValueMap[propertyName]((CDP4Common.DTO.OwnedStyle)ownedStyle);
        }

        /// <summary>
        /// Returns the ordered containment property value for the supplied <see cref="CDP4Common.DTO.OwnedStyle"/>.
        /// </summary>
        /// <param name="ownedStyle">
        /// The <see cref="CDP4Common.DTO.OwnedStyle"/> for which to return the containment property value.
        /// </param>
        ...
        /// If the property name is not supported for the <see cref="CDP4Common.DTO.OwnedStyle"/>.
        /// </exception>
        public IEnumerable<OrderedItem> GetOrderedContainmentIds(CDP4Common.DTO.Thing ownedStyle, string propertyName)
        {
            ...
            return this.orderedContainmentPropertyValueMap[propertyName]((CDP4Common.DTO.OwnedStyle)ownedStyle);
        }
        ...
        /// <summary>
        /// Gets the <see cref="PropertyMetaInfo"/> for the <see cref="OwnedStyle"/> class
        /// </summary>
        ...
        /// </summary>
        private readonly Dictionary<string, Func<CDP4Common.DTO.OwnedStyle, object>> propertyValueMap = new Dictionary<string, Func<CDP4Common.DTO.OwnedStyle, object>>
        {
            { "ClassKind", thing => thing.ClassKind },
            { "ExcludedDomain", thing => thing.ExcludedDomain },
            { "ExcludedPerson", thing => thing.ExcludedPerson },
            { "FillColor", thing => thing.FillColor },
            { "FillOpacity", thing => thing.FillOpacity },
            { "FontBold", thing => thing.FontBold },
            { "FontColor", thing => thing.FontColor },
            { "FontItalic", thing => thing.FontItalic },
            { "FontName", thing => thing.FontName },
            { "FontSize", thing => thing.FontSize },
            { "FontStrokeThrough", thing => thing.FontStrokeThrough },
            { "FontUnderline", thing => thing.FontUnderline },
            { "Iid", thing => thing.Iid },
        ...
        private readonly Dictionary<string, PropertyMetaInfo> propertyTypeMap = new Dictionary<string, PropertyMetaInfo>
        {
            ...
            { "FontStrokeThrough", new PropertyMetaInfo("FontStrokeThrough", "bool", PropertyKind.Scalar, AggregationKind.None, false, false, true, 0, "1", true) },
            { "FontUnderline", new PropertyMetaInfo("FontUnderline", "bool", PropertyKind.Scalar, AggregationKind.None, false, false, true, 0, "1", true) },
        ...
        private readonly Dictionary<string, Func<object, object>> collectionPropertyValueDeserializationMap = new Dictionary<string, Func<object, object>>
        {
            ...
            { "UsedColor", (value) => (Guid)value },
        };

        /// <summary>
        /// The property value assignment map.
        /// </summary>
        private readonly Dictionary<string, Action<CDP4Common.DTO.OwnedStyle, object>> propertyValueAssignmentMap = new Dictionary<string, Action<CDP4Common.DTO.OwnedStyle, object>>
        {
            { "FillColor", (ownedStyle, value) => ownedStyle.FillColor = value == null ? (Guid?)null : (Guid)value },
            { "FillOpacity", (ownedStyle, value) => ownedStyle.FillOpacity = value == null ? (float?)null : (float)value },
            { "FontBold", (ownedStyle, value) => ownedStyle.FontBold = value == null ? (bool?)null : (bool)value },
            { "FontColor", (ownedStyle, value) => ownedStyle.FontColor = value == null ? (Guid?)null : (Guid)value },
            { "FontItalic", (ownedStyle, value) => ownedStyle.FontItalic = value == null ? (bool?)null : (bool)value },
            { "FontName", (ownedStyle, value) => ownedStyle.FontName = value == null ? (string)null : value.ToString() },
            { "FontSize", (ownedStyle, value) => ownedStyle.FontSize = value == null ? (float?)null : (float)value },
            { "FontStrokeThrough", (ownedStyle, value) => ownedStyle.FontStrokeThrough = value == null ? (bool?)null : (bool)value },
            { "FontUnderline", (ownedStyle, value) => ownedStyle.FontUnderline = value == null ? (bool?)null : (bool)value },
            { "Iid", (ownedStyle, value) => ownedStyle.Iid = (Guid)value },
            { "ModifiedOn", (ownedStyle, value) => ownedStyle.ModifiedOn = (DateTime)value },
            { "Name", (ownedStyle, value) => ownedStyle.Name = value.ToString() },
            { "StrokeColor", (ownedStyle, value) => ownedStyle.StrokeColor = value == null ? (Guid?)null : (Guid)value },
            { "StrokeOpacity", (ownedStyle, value) => ownedStyle.StrokeOpacity = value == null ? (float?)null : (float)value },
            { "StrokeWidth", (ownedStyle, value) => ownedStyle.StrokeWidth = value == null ? (float?)null : (float)value },
        };
        ...
        {
            { "DiagramEdge", new PropertyMetaInfo("LocalStyle", "Guid", PropertyKind.List, AggregationKind.Composite, false, false, true, 0, "1", true) },
            { "DiagramObject", new PropertyMetaInfo("LocalStyle", "Guid", PropertyKind.List, AggregationKind.Composite, false, false, true, 0, "1", true) },
        };
        ...
        /// <summary>
        /// Returns the <see cref="CDP4Common.DTO.OwnedStyle"/> containment property type from the supplied property name.
        /// </summary>
        /// <param name="propertyName">
        ...
        /// <summary>
        /// Returns the <see cref="CDP4Common.DTO.OwnedStyle"/> property type from the supplied property name.
        /// </summary>
        /// <param name="propertyName">
        /// The property name.
        /// </param>
        ...
        /// <summary>
        /// Returns the container property for the supplied type name is a possible container for <see cref="CDP4Common.DTO.OwnedStyle"/>.
        /// </summary>
        /// <param name="typeName">
        /// Name of the type for which to check if it is a container of <see cref="CDP4Common.DTO.OwnedStyle"/>.
        /// </param>
        /// <param name="containerProperty">
        /// Supplied container property info instance that will be set if the supplied type name is a container of <see cref="CDP4Common.DTO.OwnedStyle"/>.
        /// </param>
        /// <returns>
        /// True if the supplied typeName is a container for <see cref="CDP4Common.DTO.OwnedStyle"/> and sets the container property name.
        /// </returns>
        ...
        /// <summary>
        /// Check if the supplied property name for <see cref="CDP4Common.DTO.OwnedStyle"/> is scalar.
        /// </summary>
        /// <param name="propertyName">
        /// Name of the property for which to check if it is scalar.
        /// </param>
        ...
        public bool ApplyPropertyUpdate(CDP4Common.DTO.Thing updatableThing, string propertyName, object value)
        {
            ...
            this.propertyValueAssignmentMap[propertyName]((CDP4Common.DTO.OwnedStyle)updatableThing, value);
        ...
        public object DeserializeCollectionValue(string propertyName, object value)
        {
            ...
            {
                throw new ArgumentException(string.Format("'{0}' is not a valid collection property of 'OwnedStyle'", propertyName));
            }
        ...
        public object GetValue(string propertyName, CDP4Common.DTO.Thing thing)
        {
            ...
            return this.propertyValueMap[propertyName]((CDP4Common.DTO.OwnedStyle)thing);
        }
        ...
        /// <summary>
        /// Instantiates a <see cref="CDP4Common.DTO.OwnedStyle"/>
        /// </summary>
        /// <returns>
        ...
        {
            return new CDP4Common.DTO.OwnedStyle(guid, revisionNumber);
        }
    }
}
