// --------------------------------------------------------------------------------------------------------------------
// <copyright file="CitationMetaInfo.cs" company="Starion Group S.A.">
...
namespace CDP4Common.MetaInfo
{
    ...
    /// <summary>
    /// This a class that holds meta info for <see cref="Citation"/>.
    /// </summary>
    public partial class CitationMetaInfo : ICitationMetaInfo
    {
        /// <summary>
        /// The containment property value map.
        /// </summary>
        private readonly Dictionary<string, Func<CDP4Common.DTO.Citation, IEnumerable<Guid>>> containmentPropertyValueMap = new Dictionary<string, Func<CDP4Common.DTO.Citation, IEnumerable<Guid>>>();

        /// <summary>
        /// The ordered containment property value map.
        /// </summary>
        private readonly Dictionary<string, Func<CDP4Common.DTO.Citation, IEnumerable<OrderedItem>>> orderedContainmentPropertyValueMap = new Dictionary<string, Func<CDP4Common.DTO.Citation, IEnumerable<OrderedItem>>>();

        /// <summary>
        /// The validation rules that should pass for an instance of <see cref="CDP4Common.DTO.Citation"/>.
        /// </summary>
        private readonly Dictionary<string, DtoValidationHelper<CDP4Common.DTO.Citation>> validationRules = new Dictionary<string, DtoValidationHelper<CDP4Common.DTO.Citation>>
        {
            { "ExcludedDomain", new DtoValidationHelper<CDP4Common.DTO.Citation>(item => item.ExcludedDomain != null, "The 'ExcludedDomain' property of a 'Citation' is mandatory and cannot be null.") },
            { "ExcludedPerson", new DtoValidationHelper<CDP4Common.DTO.Citation>(item => item.ExcludedPerson != null, "The 'ExcludedPerson' property of a 'Citation' is mandatory and cannot be null.") },
            { "ShortName", new DtoValidationHelper<CDP4Common.DTO.Citation>(item => !string.IsNullOrWhiteSpace(item.ShortName), "The 'ShortName' property of a 'Citation' is mandatory and cannot be empty or null.") },
        };
        ...
        /// If any validation rule failed.
        /// </exception>
        public void Validate(CDP4Common.DTO.Thing citation, Func<string, bool> validateProperty)
        {
            foreach (var applicableRule in this.validationRules.Where(x => validateProperty(x.Key)))
            {
                applicableRule.Value.Validate((CDP4Common.DTO.Citation)citation);
            }
        }
        ...
        /// <summary>
        /// Returns the containment property value for the supplied <see cref="CDP4Common.DTO.Citation"/>.
        /// </summary>
        /// <param name="citation">
        /// The <see cref="CDP4Common.DTO.Citation"/> for which to return the containment property value.
        /// </param>
        ...
        /// If the property name is not supported for the <see cref="CDP4Common.DTO.Citation"/>.
        /// </exception>
        public IEnumerable<Guid> GetContainmentIds(CDP4Common.DTO.Thing citation, string propertyName)
        {
            if (!this.containmentPropertyValueMap.ContainsKey(propertyName))
            {
                throw new ArgumentException($"'{propertyName}' is not a valid containment property of 'Citation'");
            }

            return this.containmentPropertyValueMap[propertyName]((CDP4Common.DTO.Citation)citation);
        }

        /// <summary>
        /// Returns the ordered containment property value for the supplied <see cref="CDP4Common.DTO.Citation"/>.
        /// </summary>
        /// <param name="citation">
        /// The <see cref="CDP4Common.DTO.Citation"/> for which to return the containment property value.
        /// </param>
        ...
        /// If the property name is not supported for the <see cref="CDP4Common.DTO.Citation"/>.
        /// </exception>
        public IEnumerable<OrderedItem> GetOrderedContainmentIds(CDP4Common.DTO.Thing citation, string propertyName)
        {
            ...
            return this.orderedContainmentPropertyValueMap[propertyName]((CDP4Common.DTO.Citation)citation);
        }
        ...
        /// <summary>
        /// Gets the <see cref="PropertyMetaInfo"/> for the <see cref="Citation"/> class
        /// </summary>
        ...
        /// </summary>
        private readonly Dictionary<string, Func<CDP4Common.DTO.Citation, object>> propertyValueMap = new Dictionary<string, Func<CDP4Common.DTO.Citation, object>>
        {
            ...
            { "Iid", thing => thing.Iid },
            { "IsAdaptation", thing => thing.IsAdaptation },
            { "Location", thing => thing.Location },
            { "ModifiedOn", thing => thing.ModifiedOn },
            { "Remark", thing => thing.Remark },
        ...
        private readonly Dictionary<string, PropertyMetaInfo> propertyTypeMap = new Dictionary<string, PropertyMetaInfo>
        {
            ...
            { "IsAdaptation", new PropertyMetaInfo("IsAdaptation", "bool", PropertyKind.Scalar, AggregationKind.None, false, false, true, 1, "1", true) },
            { "Location", new PropertyMetaInfo("Location", "string", PropertyKind.Scalar, AggregationKind.None, false, false, true, 0, "1", true) },
            { "ModifiedOn", new PropertyMetaInfo("ModifiedOn", "DateTime", PropertyKind.Scalar, AggregationKind.None, false, false, true, 1, "1", true) },
            { "Remark", new PropertyMetaInfo("Remark", "string", PropertyKind.Scalar, AggregationKind.None, false, false, true, 0, "1", true) },
            ...
            { "Source", new PropertyMetaInfo("Source", "ReferenceSource", PropertyKind.Scalar, AggregationKind.None, false, false, true, 1, "1", true) },
        ...
        /// </summary>
        private readonly Dictionary<string, Action<CDP4Common.DTO.Citation, object>> propertyValueAssignmentMap = new Dictionary<string, Action<CDP4Common.DTO.Citation, object>>
        {
            { "Actor", (citation, value) => citation.Actor = value == null ? (Guid?)null : (Guid)value },
            { "Iid", (citation, value) => citation.Iid = (Guid)value },
            { "IsAdaptation", (citation, value) => citation.IsAdaptation = (bool)value },
            { "Location", (citation, value) => citation.Location = value == null ? (string)null : value.ToString() },
            { "ModifiedOn", (citation, value) => citation.ModifiedOn = (DateTime)value },
            { "Remark", (citation, value) => citation.Remark = value == null ? (string)null : value.ToString() },
            { "ShortName", (citation, value) => citation.ShortName = value.ToString() },
            { "Source", (citation, value) => citation.Source = (Guid)value },
            { "ThingPreference", (citation, value) => citation.ThingPreference = value == null ? (string)null : value.ToString() },
        };
        ...
        {
            { "Definition", new PropertyMetaInfo("Citation", "Citation", PropertyKind.List, AggregationKind.Composite, false, false, true, 0, "*", true) },
        };
        ...
        /// <summary>
        /// Returns the <see cref="CDP4Common.DTO.Citation"/> containment property type from the supplied property name.
        /// </summary>
        /// <param name="propertyName">
        ...
        /// <summary>
        /// Returns the <see cref="CDP4Common.DTO.Citation"/> property type from the supplied property name.
        /// </summary>
        /// <param name="propertyName">
        /// The property name.
        /// </param>
        ...
        /// <summary>
        /// Returns the container property for the supplied type name is a possible container for <see cref="CDP4Common.DTO.Citation"/>.
        /// </summary>
        /// <param name="typeName">
        /// Name of the type for which to check if it is a container of <see cref="CDP4Common.DTO.Citation"/>.
        /// </param>
        /// <param name="containerProperty">
        /// Supplied container property info instance that will be set if the supplied type name is a container of <see cref="CDP4Common.DTO.Citation"/>.
        /// </param>
        /// <returns>
        /// True if the supplied typeName is a container for <see cref="CDP4Common.DTO.Citation"/> and sets the container property name.
        /// </returns>
        ...
        /// <summary>
        /// Check if the supplied property name for <see cref="CDP4Common.DTO.Citation"/> is scalar.
        /// </summary>
        /// <param name="propertyName">
        /// Name of the property for which to check if it is scalar.
        /// </param>
        ...
        public bool ApplyPropertyUpdate(CDP4Common.DTO.Thing updatableThing, string propertyName, object value)
        {
            ...
            this.propertyValueAssignmentMap[propertyName]((CDP4Common.DTO.Citation)updatableThing, value);
        ...
        public object DeserializeCollectionValue(string propertyName, object value)
        {
            ...
            {
                throw new ArgumentException($"'{propertyName}' is not a valid collection property of 'Citation'");
            }
        ...
        public object GetValue(string propertyName, CDP4Common.DTO.Thing thing)
        {
            ...
            return this.propertyValueMap[propertyName]((CDP4Common.DTO.Citation)thing);
        }
        ...
        /// <summary>
        /// Instantiates a <see cref="CDP4Common.DTO.Citation"/>
        /// </summary>
        /// <returns>
        ...
        {
            return new CDP4Common.DTO.Citation(guid, revisionNumber);
        }
    }
}
