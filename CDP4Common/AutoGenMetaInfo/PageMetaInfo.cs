// --------------------------------------------------------------------------------------------------------------------
// <copyright file="PageMetaInfo.cs" company="Starion Group S.A.">
...
namespace CDP4Common.MetaInfo
{
    ...
    /// <summary>
    /// This a class that holds meta info for <see cref="Page"/>.
    /// </summary>
    public partial class PageMetaInfo : IPageMetaInfo
    {
        /// <summary>
        /// The containment property value map.
        /// </summary>
        private readonly Dictionary<string, Func<CDP4Common.DTO.Page, IEnumerable<Guid>>> containmentPropertyValueMap = new Dictionary<string, Func<CDP4Common.DTO.Page, IEnumerable<Guid>>>
        {
            { "Note", page => page.Note.ToIdList() },
        };

        /// <summary>
        /// The ordered containment property value map.
        /// </summary>
        private readonly Dictionary<string, Func<CDP4Common.DTO.Page, IEnumerable<OrderedItem>>> orderedContainmentPropertyValueMap = new Dictionary<string, Func<CDP4Common.DTO.Page, IEnumerable<OrderedItem>>>
        {
            { "Note", page => page.Note },
        };

        /// <summary>
        /// The validation rules that should pass for an instance of <see cref="CDP4Common.DTO.Page"/>.
        /// </summary>
        private readonly Dictionary<string, DtoValidationHelper<CDP4Common.DTO.Page>> validationRules = new Dictionary<string, DtoValidationHelper<CDP4Common.DTO.Page>>
        {
            { "Category", new DtoValidationHelper<CDP4Common.DTO.Page>(item => item.Category != null, "The 'Category' property of a 'Page' is mandatory and cannot be null.") },
            { "ExcludedDomain", new DtoValidationHelper<CDP4Common.DTO.Page>(item => item.ExcludedDomain != null, "The 'ExcludedDomain' property of a 'Page' is mandatory and cannot be null.") },
            { "ExcludedPerson", new DtoValidationHelper<CDP4Common.DTO.Page>(item => item.ExcludedPerson != null, "The 'ExcludedPerson' property of a 'Page' is mandatory and cannot be null.") },
            { "Name", new DtoValidationHelper<CDP4Common.DTO.Page>(item => !string.IsNullOrWhiteSpace(item.Name), "The 'Name' property of a 'Page' is mandatory and cannot be empty or null.") },
            { "Note", new DtoValidationHelper<CDP4Common.DTO.Page>(item => item.Note != null, "The 'Note' property of a 'Page' is mandatory and cannot be null.") },
            { "ShortName", new DtoValidationHelper<CDP4Common.DTO.Page>(item => !string.IsNullOrWhiteSpace(item.ShortName), "The 'ShortName' property of a 'Page' is mandatory and cannot be empty or null.") },
        };
        ...
        /// </exception>
        public void Validate(CDP4Common.DTO.Thing page)
        {
            this.Validate(page, x => true);
        }
        ...
        /// If any validation rule failed.
        /// </exception>
        public void Validate(CDP4Common.DTO.Thing page, Func<string, bool> validateProperty)
        {
            foreach (var applicableRule in this.validationRules.Where(x => validateProperty(x.Key)))
            {
                applicableRule.Value.Validate((CDP4Common.DTO.Page)page);
            }
        }
        ...
        /// </returns>
        public bool TryValidate(CDP4Common.DTO.Thing page)
        {
            return this.TryValidate(page, x => true);
        }
        ...
        /// True if all validation rules have passed or if none are defined.
        /// </returns>
        public bool TryValidate(CDP4Common.DTO.Thing page, Func<string, bool> validateProperty)
        {
            var applicableValidationRules = this.validationRules.Where(x => validateProperty(x.Key)).Select(x => x.Value);

            return applicableValidationRules.All(applicableRule => applicableRule.TryValidate((CDP4Common.DTO.Page)page));
        }

        /// <summary>
        /// Returns the containment property value for the supplied <see cref="CDP4Common.DTO.Page"/>.
        /// </summary>
        /// <param name="page">
        /// The <see cref="CDP4Common.DTO.Page"/> for which to return the containment property value.
        /// </param>
        ...
        /// If the property name is not supported for the <see cref="CDP4Common.DTO.Page"/>.
        /// </exception>
        public IEnumerable<Guid> GetContainmentIds(CDP4Common.DTO.Thing page, string propertyName)
        {
            if (!this.containmentPropertyValueMap.ContainsKey(propertyName))
            {
                throw new ArgumentException($"'{propertyName}' is not a valid containment property of 'Page'");
            }

            return this.containmentPropertyValueMap[propertyName]((CDP4Common.DTO.Page)page);
        }

        /// <summary>
        /// Returns the ordered containment property value for the supplied <see cref="CDP4Common.DTO.Page"/>.
        /// </summary>
        /// <param name="page">
        /// The <see cref="CDP4Common.DTO.Page"/> for which to return the containment property value.
        /// </param>
        ...
        /// If the property name is not supported for the <see cref="CDP4Common.DTO.Page"/>.
        /// </exception>
        public IEnumerable<OrderedItem> GetOrderedContainmentIds(CDP4Common.DTO.Thing page, string propertyName)
        {
            ...
            return this.orderedContainmentPropertyValueMap[propertyName]((CDP4Common.DTO.Page)page);
        }
        ...
        {
            { "Note", new PropertyMetaInfo("Note", "Note", PropertyKind.OrderedList, AggregationKind.Composite, false, true, true, 0, "*", true) },
        };

        /// <summary>
        /// Gets the <see cref="PropertyMetaInfo"/> for the <see cref="Page"/> class
        /// </summary>
        ...
        /// </summary>
        private readonly Dictionary<string, Func<CDP4Common.DTO.Page, object>> propertyValueMap = new Dictionary<string, Func<CDP4Common.DTO.Page, object>>
        {
        ...
        private readonly Dictionary<string, Func<object, object>> collectionPropertyValueDeserializationMap = new Dictionary<string, Func<object, object>>
        {
            ...
            { "Note", (value) => (Guid)value },
        };

        /// <summary>
        /// The property value assignment map.
        /// </summary>
        private readonly Dictionary<string, Action<CDP4Common.DTO.Page, object>> propertyValueAssignmentMap = new Dictionary<string, Action<CDP4Common.DTO.Page, object>>
        {
            { "Actor", (page, value) => page.Actor = value == null ? (Guid?)null : (Guid)value },
            { "CreatedOn", (page, value) => page.CreatedOn = (DateTime)value },
            { "Iid", (page, value) => page.Iid = (Guid)value },
            { "ModifiedOn", (page, value) => page.ModifiedOn = (DateTime)value },
            { "Name", (page, value) => page.Name = value.ToString() },
            { "Owner", (page, value) => page.Owner = (Guid)value },
            { "ShortName", (page, value) => page.ShortName = value.ToString() },
            { "ThingPreference", (page, value) => page.ThingPreference = value == null ? (string)null : value.ToString() },
        };
        ...
        {
            { "Section", new PropertyMetaInfo("Page", "Page", PropertyKind.OrderedList, AggregationKind.Composite, false, true, true, 0, "*", true) },
        };
        ...
        /// <summary>
        /// Returns the <see cref="CDP4Common.DTO.Page"/> containment property type from the supplied property name.
        /// </summary>
        /// <param name="propertyName">
        ...
        /// <summary>
        /// Returns the <see cref="CDP4Common.DTO.Page"/> property type from the supplied property name.
        /// </summary>
        /// <param name="propertyName">
        /// The property name.
        /// </param>
        ...
        /// <summary>
        /// Returns the container property for the supplied type name is a possible container for <see cref="CDP4Common.DTO.Page"/>.
        /// </summary>
        /// <param name="typeName">
        /// Name of the type for which to check if it is a container of <see cref="CDP4Common.DTO.Page"/>.
        /// </param>
        /// <param name="containerProperty">
        /// Supplied container property info instance that will be set if the supplied type name is a container of <see cref="CDP4Common.DTO.Page"/>.
        /// </param>
        /// <returns>
        /// True if the supplied typeName is a container for <see cref="CDP4Common.DTO.Page"/> and sets the container property name.
        /// </returns>
        ...
        /// <summary>
        /// Check if the supplied property name for <see cref="CDP4Common.DTO.Page"/> is scalar.
        /// </summary>
        /// <param name="propertyName">
        /// Name of the property for which to check if it is scalar.
        /// </param>
        ...
        public bool ApplyPropertyUpdate(CDP4Common.DTO.Thing updatableThing, string propertyName, object value)
        {
            ...
            this.propertyValueAssignmentMap[propertyName]((CDP4Common.DTO.Page)updatableThing, value);
        ...
        public object DeserializeCollectionValue(string propertyName, object value)
        {
            ...
            {
                throw new ArgumentException($"'{propertyName}' is not a valid collection property of 'Page'");
            }
        ...
        public object GetValue(string propertyName, CDP4Common.DTO.Thing thing)
        {
            ...
            return this.propertyValueMap[propertyName]((CDP4Common.DTO.Page)thing);
        }
        ...
        /// <summary>
        /// Instantiates a <see cref="CDP4Common.DTO.Page"/>
        /// </summary>
        /// <returns>
        ...
        {
            return new CDP4Common.DTO.Page(guid, revisionNumber);
        }
    }
}
