// --------------------------------------------------------------------------------------------------------------------
// <copyright file="ValueGroupMetaInfo.cs" company="RHEA System S.A.">
...
namespace CDP4Common.MetaInfo
{
    ...
    /// <summary>
    /// This a class that holds meta info for <see cref="ValueGroup"/>.
    /// </summary>
    public partial class ValueGroupMetaInfo : IValueGroupMetaInfo
    {
        /// <summary>
        /// The containment property value map.
        /// </summary>
        private readonly Dictionary<string, Func<CDP4Common.DTO.ValueGroup, IEnumerable<Guid>>> containmentPropertyValueMap = new Dictionary<string, Func<CDP4Common.DTO.ValueGroup, IEnumerable<Guid>>>
        {
            { "Alias", valueGroup => valueGroup.Alias },
            { "Attachment", valueGroup => valueGroup.Attachment },
            { "Definition", valueGroup => valueGroup.Definition },
            { "HyperLink", valueGroup => valueGroup.HyperLink },
        };

        /// <summary>
        /// The ordered containment property value map.
        /// </summary>
        private readonly Dictionary<string, Func<CDP4Common.DTO.ValueGroup, IEnumerable<OrderedItem>>> orderedContainmentPropertyValueMap = new Dictionary<string, Func<CDP4Common.DTO.ValueGroup, IEnumerable<OrderedItem>>>();

        /// <summary>
        /// The validation rules that should pass for an instance of <see cref="CDP4Common.DTO.ValueGroup"/>.
        /// </summary>
        private readonly Dictionary<string, DtoValidationHelper<CDP4Common.DTO.ValueGroup>> validationRules = new Dictionary<string, DtoValidationHelper<CDP4Common.DTO.ValueGroup>>
        {
            { "Alias", new DtoValidationHelper<CDP4Common.DTO.ValueGroup>(item => item.Alias != null, "The 'Alias' property of a 'ValueGroup' is mandatory and cannot be null.") },
            { "Attachment", new DtoValidationHelper<CDP4Common.DTO.ValueGroup>(item => item.Attachment != null, "The 'Attachment' property of a 'ValueGroup' is mandatory and cannot be null.") },
            { "Category", new DtoValidationHelper<CDP4Common.DTO.ValueGroup>(item => item.Category != null, "The 'Category' property of a 'ValueGroup' is mandatory and cannot be null.") },
            { "Definition", new DtoValidationHelper<CDP4Common.DTO.ValueGroup>(item => item.Definition != null, "The 'Definition' property of a 'ValueGroup' is mandatory and cannot be null.") },
            { "ExcludedDomain", new DtoValidationHelper<CDP4Common.DTO.ValueGroup>(item => item.ExcludedDomain != null, "The 'ExcludedDomain' property of a 'ValueGroup' is mandatory and cannot be null.") },
            { "ExcludedPerson", new DtoValidationHelper<CDP4Common.DTO.ValueGroup>(item => item.ExcludedPerson != null, "The 'ExcludedPerson' property of a 'ValueGroup' is mandatory and cannot be null.") },
            { "HyperLink", new DtoValidationHelper<CDP4Common.DTO.ValueGroup>(item => item.HyperLink != null, "The 'HyperLink' property of a 'ValueGroup' is mandatory and cannot be null.") },
            { "Name", new DtoValidationHelper<CDP4Common.DTO.ValueGroup>(item => !string.IsNullOrWhiteSpace(item.Name), "The 'Name' property of a 'ValueGroup' is mandatory and cannot be empty or null.") },
            { "ShortName", new DtoValidationHelper<CDP4Common.DTO.ValueGroup>(item => !string.IsNullOrWhiteSpace(item.ShortName), "The 'ShortName' property of a 'ValueGroup' is mandatory and cannot be empty or null.") },
        };
        ...
        /// </exception>
        public void Validate(CDP4Common.DTO.Thing valueGroup)
        {
            this.Validate(valueGroup, x => true);
        }
        ...
        /// If any validation rule failed.
        /// </exception>
        public void Validate(CDP4Common.DTO.Thing valueGroup, Func<string, bool> validateProperty)
        {
            foreach (var applicableRule in this.validationRules.Where(x => validateProperty(x.Key)))
            {
                applicableRule.Value.Validate((CDP4Common.DTO.ValueGroup)valueGroup);
            }
        }
        ...
        /// </returns>
        public bool TryValidate(CDP4Common.DTO.Thing valueGroup)
        {
            return this.TryValidate(valueGroup, x => true);
        }
        ...
        /// True if all validation rules have passed or if none are defined.
        /// </returns>
        public bool TryValidate(CDP4Common.DTO.Thing valueGroup, Func<string, bool> validateProperty)
        {
            var applicableValidationRules = this.validationRules.Where(x => validateProperty(x.Key)).Select(x => x.Value);

            return applicableValidationRules.All(applicableRule => applicableRule.TryValidate((CDP4Common.DTO.ValueGroup)valueGroup));
        }

        /// <summary>
        /// Returns the containment property value for the supplied <see cref="CDP4Common.DTO.ValueGroup"/>.
        /// </summary>
        /// <param name="valueGroup">
        /// The <see cref="CDP4Common.DTO.ValueGroup"/> for which to return the containment property value.
        /// </param>
        ...
        /// If the property name is not supported for the <see cref="CDP4Common.DTO.ValueGroup"/>.
        /// </exception>
        public IEnumerable<Guid> GetContainmentIds(CDP4Common.DTO.Thing valueGroup, string propertyName)
        {
            if (!this.containmentPropertyValueMap.ContainsKey(propertyName))
            {
                throw new ArgumentException(string.Format("'{0}' is not a valid containment property of 'ValueGroup'", propertyName));
            }

            return this.containmentPropertyValueMap[propertyName]((CDP4Common.DTO.ValueGroup)valueGroup);
        }

        /// <summary>
        /// Returns the ordered containment property value for the supplied <see cref="CDP4Common.DTO.ValueGroup"/>.
        /// </summary>
        /// <param name="valueGroup">
        /// The <see cref="CDP4Common.DTO.ValueGroup"/> for which to return the containment property value.
        /// </param>
        ...
        /// If the property name is not supported for the <see cref="CDP4Common.DTO.ValueGroup"/>.
        /// </exception>
        public IEnumerable<OrderedItem> GetOrderedContainmentIds(CDP4Common.DTO.Thing valueGroup, string propertyName)
        {
            ...
            return this.orderedContainmentPropertyValueMap[propertyName]((CDP4Common.DTO.ValueGroup)valueGroup);
        }
        ...
        /// <summary>
        /// Gets the <see cref="PropertyMetaInfo"/> for the <see cref="ValueGroup"/> class
        /// </summary>
        ...
        private readonly Dictionary<string, Action<CDP4Common.DTO.ValueGroup, object>> propertyValueAssignmentMap = new Dictionary<string, Action<CDP4Common.DTO.ValueGroup, object>>
        {
            ...
            { "ShortName", (valueGroup, value) => valueGroup.ShortName = value.ToString() },
            { "ThingPreference", (valueGroup, value) => valueGroup.ThingPreference = value == null ? (string)null : value.ToString() },
        };
        ...
        {
            { "Iteration", new PropertyMetaInfo("ValueGroup", "ValueGroup", PropertyKind.List, AggregationKind.Composite, false, false, true, 0, "*", true) },
        };
        ...
        /// <summary>
        /// Returns the <see cref="CDP4Common.DTO.ValueGroup"/> containment property type from the supplied property name.
        /// </summary>
        /// <param name="propertyName">
        ...
        /// <summary>
        /// Returns the <see cref="CDP4Common.DTO.ValueGroup"/> property type from the supplied property name.
        /// </summary>
        /// <param name="propertyName">
        /// The property name.
        /// </param>
        ...
        /// <summary>
        /// Returns the container property for the supplied type name is a possible container for <see cref="CDP4Common.DTO.ValueGroup"/>.
        /// </summary>
        /// <param name="typeName">
        /// Name of the type for which to check if it is a container of <see cref="CDP4Common.DTO.ValueGroup"/>.
        /// </param>
        /// <param name="containerProperty">
        /// Supplied container property info instance that will be set if the supplied type name is a container of <see cref="CDP4Common.DTO.ValueGroup"/>.
        /// </param>
        /// <returns>
        /// True if the supplied typeName is a container for <see cref="CDP4Common.DTO.ValueGroup"/> and sets the container property name.
        /// </returns>
        ...
        /// <summary>
        /// Check if the supplied property name for <see cref="CDP4Common.DTO.ValueGroup"/> is scalar.
        /// </summary>
        /// <param name="propertyName">
        /// Name of the property for which to check if it is scalar.
        /// </param>
        ...
        public bool ApplyPropertyUpdate(CDP4Common.DTO.Thing updatableThing, string propertyName, object value)
        {
            ...
            this.propertyValueAssignmentMap[propertyName]((CDP4Common.DTO.ValueGroup)updatableThing, value);
        ...
        public object DeserializeCollectionValue(string propertyName, object value)
        {
            ...
            {
                throw new ArgumentException(string.Format("'{0}' is not a valid collection property of 'ValueGroup'", propertyName));
            }
        ...
        public object GetValue(string propertyName, CDP4Common.DTO.Thing thing)
        {
            ...
            return this.propertyValueMap[propertyName]((CDP4Common.DTO.ValueGroup)thing);
        }
        ...
        /// <summary>
        /// Instantiates a <see cref="CDP4Common.DTO.ValueGroup"/>
        /// </summary>
        /// <returns>
        ...
        {
            return new CDP4Common.DTO.ValueGroup(guid, revisionNumber);
        }
    }
}
