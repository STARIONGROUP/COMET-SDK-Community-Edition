...
namespace CDP4Common.MetaInfo
{
    ...
    public partial class FileRevisionMetaInfo : IFileRevisionMetaInfo
    {
        ...
        private readonly Dictionary<string, PropertyMetaInfo> propertyTypeMap = new Dictionary<string, PropertyMetaInfo>
        {
            ...
            { "Creator", new PropertyMetaInfo("Creator", "Participant", PropertyKind.Scalar, AggregationKind.None, false, false, true, 1, "1", true) },
            { "ExcludedDomain", new PropertyMetaInfo("ExcludedDomain", "DomainOfExpertise", PropertyKind.List, AggregationKind.None, false, false, true, 0, "*", true) },
            { "ExcludedPerson", new PropertyMetaInfo("ExcludedPerson", "Person", PropertyKind.List, AggregationKind.None, false, false, true, 0, "*", true) },
            { "FileType", new PropertyMetaInfo("FileType", "FileType", PropertyKind.OrderedList, AggregationKind.None, false, true, true, 1, "*", true) },
        ...
        {
            { "File", new PropertyMetaInfo("FileRevision", "FileRevision", PropertyKind.List, AggregationKind.Composite, false, false, true, 1, "*", true) },
        };
