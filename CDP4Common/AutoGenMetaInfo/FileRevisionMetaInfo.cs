// --------------------------------------------------------------------------------------------------------------------
// <copyright file="FileRevisionMetaInfo.cs" company="RHEA System S.A.">
...
namespace CDP4Common.MetaInfo
{
    ...
    /// <summary>
    /// This a class that holds meta info for <see cref="FileRevision"/>.
    /// </summary>
    public partial class FileRevisionMetaInfo : IFileRevisionMetaInfo
    {
        /// <summary>
        /// The containment property value map.
        /// </summary>
        private readonly Dictionary<string, Func<CDP4Common.DTO.FileRevision, IEnumerable<Guid>>> containmentPropertyValueMap = new Dictionary<string, Func<CDP4Common.DTO.FileRevision, IEnumerable<Guid>>>();

        /// <summary>
        /// The ordered containment property value map.
        /// </summary>
        private readonly Dictionary<string, Func<CDP4Common.DTO.FileRevision, IEnumerable<OrderedItem>>> orderedContainmentPropertyValueMap = new Dictionary<string, Func<CDP4Common.DTO.FileRevision, IEnumerable<OrderedItem>>>();

        /// <summary>
        /// The validation rules that should pass for an instance of <see cref="CDP4Common.DTO.FileRevision"/>.
        /// </summary>
        private readonly Dictionary<string, DtoValidationHelper<CDP4Common.DTO.FileRevision>> validationRules = new Dictionary<string, DtoValidationHelper<CDP4Common.DTO.FileRevision>>
        {
            { "ContentHash", new DtoValidationHelper<CDP4Common.DTO.FileRevision>(item => !string.IsNullOrWhiteSpace(item.ContentHash), "The 'ContentHash' property of a 'FileRevision' is mandatory and cannot be empty or null.") },
            { "ExcludedDomain", new DtoValidationHelper<CDP4Common.DTO.FileRevision>(item => item.ExcludedDomain != null, "The 'ExcludedDomain' property of a 'FileRevision' is mandatory and cannot be null.") },
            { "ExcludedPerson", new DtoValidationHelper<CDP4Common.DTO.FileRevision>(item => item.ExcludedPerson != null, "The 'ExcludedPerson' property of a 'FileRevision' is mandatory and cannot be null.") },
            { "FileType", new DtoValidationHelper<CDP4Common.DTO.FileRevision>(item => item.FileType != null && item.FileType.Any(), "The 'FileType' property of a 'FileRevision' is mandatory and must have at least one entry.") },
            { "Name", new DtoValidationHelper<CDP4Common.DTO.FileRevision>(item => !string.IsNullOrWhiteSpace(item.Name), "The 'Name' property of a 'FileRevision' is mandatory and cannot be empty or null.") },
        };
        ...
        /// </exception>
        public void Validate(CDP4Common.DTO.Thing fileRevision)
        {
            this.Validate(fileRevision, x => true);
        }
        ...
        /// If any validation rule failed.
        /// </exception>
        public void Validate(CDP4Common.DTO.Thing fileRevision, Func<string, bool> validateProperty)
        {
            foreach (var applicableRule in this.validationRules.Where(x => validateProperty(x.Key)))
            {
                applicableRule.Value.Validate((CDP4Common.DTO.FileRevision)fileRevision);
            }
        }
        ...
        /// </returns>
        public bool TryValidate(CDP4Common.DTO.Thing fileRevision)
        {
            return this.TryValidate(fileRevision, x => true);
        }
        ...
        /// True if all validation rules have passed or if none are defined.
        /// </returns>
        public bool TryValidate(CDP4Common.DTO.Thing fileRevision, Func<string, bool> validateProperty)
        {
            var applicableValidationRules = this.validationRules.Where(x => validateProperty(x.Key)).Select(x => x.Value);

            return applicableValidationRules.All(applicableRule => applicableRule.TryValidate((CDP4Common.DTO.FileRevision)fileRevision));
        }

        /// <summary>
        /// Returns the containment property value for the supplied <see cref="CDP4Common.DTO.FileRevision"/>.
        /// </summary>
        /// <param name="fileRevision">
        /// The <see cref="CDP4Common.DTO.FileRevision"/> for which to return the containment property value.
        /// </param>
        ...
        /// If the property name is not supported for the <see cref="CDP4Common.DTO.FileRevision"/>.
        /// </exception>
        public IEnumerable<Guid> GetContainmentIds(CDP4Common.DTO.Thing fileRevision, string propertyName)
        {
            if (!this.containmentPropertyValueMap.ContainsKey(propertyName))
            {
                throw new ArgumentException(string.Format("'{0}' is not a valid containment property of 'FileRevision'", propertyName));
            }

            return this.containmentPropertyValueMap[propertyName]((CDP4Common.DTO.FileRevision)fileRevision);
        }

        /// <summary>
        /// Returns the ordered containment property value for the supplied <see cref="CDP4Common.DTO.FileRevision"/>.
        /// </summary>
        /// <param name="fileRevision">
        /// The <see cref="CDP4Common.DTO.FileRevision"/> for which to return the containment property value.
        /// </param>
        ...
        /// If the property name is not supported for the <see cref="CDP4Common.DTO.FileRevision"/>.
        /// </exception>
        public IEnumerable<OrderedItem> GetOrderedContainmentIds(CDP4Common.DTO.Thing fileRevision, string propertyName)
        {
            ...
            return this.orderedContainmentPropertyValueMap[propertyName]((CDP4Common.DTO.FileRevision)fileRevision);
        }
        ...
        /// <summary>
        /// Gets the <see cref="PropertyMetaInfo"/> for the <see cref="FileRevision"/> class
        /// </summary>
        ...
        private readonly Dictionary<string, PropertyMetaInfo> propertyTypeMap = new Dictionary<string, PropertyMetaInfo>
        {
            ...
            { "ContainingFolder", new PropertyMetaInfo("ContainingFolder", "Guid", PropertyKind.Scalar, AggregationKind.None, false, false, true, 0, "1", true) },
            ...
            { "Creator", new PropertyMetaInfo("Creator", "Guid", PropertyKind.Scalar, AggregationKind.None, false, false, true, 1, "1", true) },
            ...
            { "FileType", new PropertyMetaInfo("FileType", "Guid", PropertyKind.OrderedList, AggregationKind.None, false, true, true, 1, "*", true) },
        ...
        private readonly Dictionary<string, Action<CDP4Common.DTO.FileRevision, object>> propertyValueAssignmentMap = new Dictionary<string, Action<CDP4Common.DTO.FileRevision, object>>
        {
            ...
            { "Creator", (fileRevision, value) => fileRevision.Creator = (Guid)value },
        ...
        {
            { "File", new PropertyMetaInfo("FileRevision", "Guid", PropertyKind.List, AggregationKind.Composite, false, false, true, 1, "*", true) },
        };
        ...
        /// <summary>
        /// Returns the <see cref="CDP4Common.DTO.FileRevision"/> containment property type from the supplied property name.
        /// </summary>
        /// <param name="propertyName">
        ...
        /// <summary>
        /// Returns the <see cref="CDP4Common.DTO.FileRevision"/> property type from the supplied property name.
        /// </summary>
        /// <param name="propertyName">
        /// The property name.
        /// </param>
        ...
        /// <summary>
        /// Returns the container property for the supplied type name is a possible container for <see cref="CDP4Common.DTO.FileRevision"/>.
        /// </summary>
        /// <param name="typeName">
        /// Name of the type for which to check if it is a container of <see cref="CDP4Common.DTO.FileRevision"/>.
        /// </param>
        /// <param name="containerProperty">
        /// Supplied container property info instance that will be set if the supplied type name is a container of <see cref="CDP4Common.DTO.FileRevision"/>.
        /// </param>
        /// <returns>
        /// True if the supplied typeName is a container for <see cref="CDP4Common.DTO.FileRevision"/> and sets the container property name.
        /// </returns>
        ...
        /// <summary>
        /// Check if the supplied property name for <see cref="CDP4Common.DTO.FileRevision"/> is scalar.
        /// </summary>
        /// <param name="propertyName">
        /// Name of the property for which to check if it is scalar.
        /// </param>
        ...
        public bool ApplyPropertyUpdate(CDP4Common.DTO.Thing updatableThing, string propertyName, object value)
        {
            ...
            this.propertyValueAssignmentMap[propertyName]((CDP4Common.DTO.FileRevision)updatableThing, value);
        ...
        public object DeserializeCollectionValue(string propertyName, object value)
        {
            ...
            {
                throw new ArgumentException(string.Format("'{0}' is not a valid collection property of 'FileRevision'", propertyName));
            }
        ...
        public object GetValue(string propertyName, CDP4Common.DTO.Thing thing)
        {
            ...
            return this.propertyValueMap[propertyName]((CDP4Common.DTO.FileRevision)thing);
        }
        ...
        /// <summary>
        /// Instantiates a <see cref="CDP4Common.DTO.FileRevision"/>
        /// </summary>
        /// <returns>
        ...
        {
            return new CDP4Common.DTO.FileRevision(guid, revisionNumber);
        }
    }
}
