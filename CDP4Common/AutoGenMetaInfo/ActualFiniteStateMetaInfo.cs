// --------------------------------------------------------------------------------------------------------------------
// <copyright file="ActualFiniteStateMetaInfo.cs" company="RHEA System S.A.">
...
namespace CDP4Common.MetaInfo
{
    ...
    /// <summary>
    /// This a class that holds meta info for <see cref="ActualFiniteState"/>.
    /// </summary>
    public partial class ActualFiniteStateMetaInfo : IActualFiniteStateMetaInfo
    {
        /// <summary>
        /// The containment property value map.
        /// </summary>
        private readonly Dictionary<string, Func<CDP4Common.DTO.ActualFiniteState, IEnumerable<Guid>>> containmentPropertyValueMap = new Dictionary<string, Func<CDP4Common.DTO.ActualFiniteState, IEnumerable<Guid>>>();

        /// <summary>
        /// The ordered containment property value map.
        /// </summary>
        private readonly Dictionary<string, Func<CDP4Common.DTO.ActualFiniteState, IEnumerable<OrderedItem>>> orderedContainmentPropertyValueMap = new Dictionary<string, Func<CDP4Common.DTO.ActualFiniteState, IEnumerable<OrderedItem>>>();

        /// <summary>
        /// The validation rules that should pass for an instance of <see cref="CDP4Common.DTO.ActualFiniteState"/>.
        /// </summary>
        private readonly Dictionary<string, DtoValidationHelper<CDP4Common.DTO.ActualFiniteState>> validationRules = new Dictionary<string, DtoValidationHelper<CDP4Common.DTO.ActualFiniteState>>
        {
            { "ExcludedDomain", new DtoValidationHelper<CDP4Common.DTO.ActualFiniteState>(item => item.ExcludedDomain != null, "The 'ExcludedDomain' property of a 'ActualFiniteState' is mandatory and cannot be null.") },
            { "ExcludedPerson", new DtoValidationHelper<CDP4Common.DTO.ActualFiniteState>(item => item.ExcludedPerson != null, "The 'ExcludedPerson' property of a 'ActualFiniteState' is mandatory and cannot be null.") },
            { "PossibleState", new DtoValidationHelper<CDP4Common.DTO.ActualFiniteState>(item => item.PossibleState != null && item.PossibleState.Any(), "The 'PossibleState' property of a 'ActualFiniteState' is mandatory and must have at least one entry.") },
        };
        ...
        /// </exception>
        public void Validate(CDP4Common.DTO.Thing actualFiniteState)
        {
            this.Validate(actualFiniteState, x => true);
        }
        ...
        /// If any validation rule failed.
        /// </exception>
        public void Validate(CDP4Common.DTO.Thing actualFiniteState, Func<string, bool> validateProperty)
        {
            foreach (var applicableRule in this.validationRules.Where(x => validateProperty(x.Key)))
            {
                applicableRule.Value.Validate((CDP4Common.DTO.ActualFiniteState)actualFiniteState);
            }
        }
        ...
        /// </returns>
        public bool TryValidate(CDP4Common.DTO.Thing actualFiniteState)
        {
            return this.TryValidate(actualFiniteState, x => true);
        }
        ...
        /// True if all validation rules have passed or if none are defined.
        /// </returns>
        public bool TryValidate(CDP4Common.DTO.Thing actualFiniteState, Func<string, bool> validateProperty)
        {
            var applicableValidationRules = this.validationRules.Where(x => validateProperty(x.Key)).Select(x => x.Value);

            return applicableValidationRules.All(applicableRule => applicableRule.TryValidate((CDP4Common.DTO.ActualFiniteState)actualFiniteState));
        }

        /// <summary>
        /// Returns the containment property value for the supplied <see cref="CDP4Common.DTO.ActualFiniteState"/>.
        /// </summary>
        /// <param name="actualFiniteState">
        /// The <see cref="CDP4Common.DTO.ActualFiniteState"/> for which to return the containment property value.
        /// </param>
        ...
        /// If the property name is not supported for the <see cref="CDP4Common.DTO.ActualFiniteState"/>.
        /// </exception>
        public IEnumerable<Guid> GetContainmentIds(CDP4Common.DTO.Thing actualFiniteState, string propertyName)
        {
            if (!this.containmentPropertyValueMap.ContainsKey(propertyName))
            {
                throw new ArgumentException(string.Format("'{0}' is not a valid containment property of 'ActualFiniteState'", propertyName));
            }

            return this.containmentPropertyValueMap[propertyName]((CDP4Common.DTO.ActualFiniteState)actualFiniteState);
        }

        /// <summary>
        /// Returns the ordered containment property value for the supplied <see cref="CDP4Common.DTO.ActualFiniteState"/>.
        /// </summary>
        /// <param name="actualFiniteState">
        /// The <see cref="CDP4Common.DTO.ActualFiniteState"/> for which to return the containment property value.
        /// </param>
        ...
        /// If the property name is not supported for the <see cref="CDP4Common.DTO.ActualFiniteState"/>.
        /// </exception>
        public IEnumerable<OrderedItem> GetOrderedContainmentIds(CDP4Common.DTO.Thing actualFiniteState, string propertyName)
        {
            ...
            return this.orderedContainmentPropertyValueMap[propertyName]((CDP4Common.DTO.ActualFiniteState)actualFiniteState);
        }
        ...
        /// <summary>
        /// Gets the <see cref="PropertyMetaInfo"/> for the <see cref="ActualFiniteState"/> class
        /// </summary>
        ...
        /// </summary>
        private readonly Dictionary<string, Func<CDP4Common.DTO.ActualFiniteState, object>> propertyValueMap = new Dictionary<string, Func<CDP4Common.DTO.ActualFiniteState, object>>
        {
        ...
        private readonly Dictionary<string, PropertyMetaInfo> propertyTypeMap = new Dictionary<string, PropertyMetaInfo>
        {
            ...
            { "Kind", new PropertyMetaInfo("Kind", "CDP4Common.EngineeringModelData.ActualFiniteStateKind", PropertyKind.Scalar, AggregationKind.None, false, false, true, 1, "1", true) },
            ...
            { "PossibleState", new PropertyMetaInfo("PossibleState", "Guid", PropertyKind.List, AggregationKind.None, false, false, true, 1, "*", true) },
        ...
        private readonly Dictionary<string, Func<object, object>> collectionPropertyValueDeserializationMap = new Dictionary<string, Func<object, object>>
        {
            ...
            { "PossibleState", (value) => (Guid)value },
        };

        /// <summary>
        /// The property value assignment map.
        /// </summary>
        private readonly Dictionary<string, Action<CDP4Common.DTO.ActualFiniteState, object>> propertyValueAssignmentMap = new Dictionary<string, Action<CDP4Common.DTO.ActualFiniteState, object>>
        {
        ...
        {
            { "ActualFiniteStateList", new PropertyMetaInfo("ActualState", "Guid", PropertyKind.List, AggregationKind.Composite, false, false, true, 0, "*", true) },
        };
        ...
        /// <summary>
        /// Returns the <see cref="CDP4Common.DTO.ActualFiniteState"/> containment property type from the supplied property name.
        /// </summary>
        /// <param name="propertyName">
        ...
        /// <summary>
        /// Returns the <see cref="CDP4Common.DTO.ActualFiniteState"/> property type from the supplied property name.
        /// </summary>
        /// <param name="propertyName">
        /// The property name.
        /// </param>
        ...
        /// <summary>
        /// Returns the container property for the supplied type name is a possible container for <see cref="CDP4Common.DTO.ActualFiniteState"/>.
        /// </summary>
        /// <param name="typeName">
        /// Name of the type for which to check if it is a container of <see cref="CDP4Common.DTO.ActualFiniteState"/>.
        /// </param>
        /// <param name="containerProperty">
        /// Supplied container property info instance that will be set if the supplied type name is a container of <see cref="CDP4Common.DTO.ActualFiniteState"/>.
        /// </param>
        /// <returns>
        /// True if the supplied typeName is a container for <see cref="CDP4Common.DTO.ActualFiniteState"/> and sets the container property name.
        /// </returns>
        ...
        /// <summary>
        /// Check if the supplied property name for <see cref="CDP4Common.DTO.ActualFiniteState"/> is scalar.
        /// </summary>
        /// <param name="propertyName">
        /// Name of the property for which to check if it is scalar.
        /// </param>
        ...
        public bool ApplyPropertyUpdate(CDP4Common.DTO.Thing updatableThing, string propertyName, object value)
        {
            ...
            this.propertyValueAssignmentMap[propertyName]((CDP4Common.DTO.ActualFiniteState)updatableThing, value);
        ...
        public object DeserializeCollectionValue(string propertyName, object value)
        {
            ...
            {
                throw new ArgumentException(string.Format("'{0}' is not a valid collection property of 'ActualFiniteState'", propertyName));
            }
        ...
        public object GetValue(string propertyName, CDP4Common.DTO.Thing thing)
        {
            ...
            return this.propertyValueMap[propertyName]((CDP4Common.DTO.ActualFiniteState)thing);
        }
        ...
        /// <summary>
        /// Instantiates a <see cref="CDP4Common.DTO.ActualFiniteState"/>
        /// </summary>
        /// <returns>
        ...
        {
            return new CDP4Common.DTO.ActualFiniteState(guid, revisionNumber);
        }
    }
}
