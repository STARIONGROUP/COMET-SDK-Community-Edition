// --------------------------------------------------------------------------------------------------------------------
// <copyright file="ActualFiniteStateMetaInfo.cs" company="Starion Group S.A.">
...
namespace CDP4Common.MetaInfo
{
    ...
    public partial class ActualFiniteStateMetaInfo : IActualFiniteStateMetaInfo
    {
        ...
        public IEnumerable<Guid> GetContainmentIds(CDP4Common.DTO.Thing actualFiniteState, string propertyName)
        {
            ...
            {
                throw new ArgumentException($"'{propertyName}' is not a valid containment property of 'ActualFiniteState'");
            }
        ...
        {
            { "Actor", (actualFiniteState, value) => actualFiniteState.Actor = value == null ? (Guid?)null : (Guid)value },
        ...
        {
            { "ActualFiniteStateList", new PropertyMetaInfo("ActualState", "ActualFiniteState", PropertyKind.List, AggregationKind.Composite, false, false, true, 0, "*", true) },
        };
        ...
        public object DeserializeCollectionValue(string propertyName, object value)
        {
            ...
            {
                throw new ArgumentException($"'{propertyName}' is not a valid collection property of 'ActualFiniteState'");
            }
