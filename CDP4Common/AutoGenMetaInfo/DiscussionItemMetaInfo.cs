// --------------------------------------------------------------------------------------------------------------------
// <copyright file="DiscussionItemMetaInfo.cs" company="Starion Group S.A.">
...
namespace CDP4Common.MetaInfo
{
    ...
    /// <summary>
    /// This a class that holds meta info for <see cref="DiscussionItem"/>.
    /// </summary>
    public partial class DiscussionItemMetaInfo : IDiscussionItemMetaInfo
    {
        /// <summary>
        /// The containment property value map.
        /// </summary>
        private readonly Dictionary<string, Func<CDP4Common.DTO.DiscussionItem, IEnumerable<Guid>>> containmentPropertyValueMap = new Dictionary<string, Func<CDP4Common.DTO.DiscussionItem, IEnumerable<Guid>>>();

        /// <summary>
        /// The ordered containment property value map.
        /// </summary>
        private readonly Dictionary<string, Func<CDP4Common.DTO.DiscussionItem, IEnumerable<OrderedItem>>> orderedContainmentPropertyValueMap = new Dictionary<string, Func<CDP4Common.DTO.DiscussionItem, IEnumerable<OrderedItem>>>();

        /// <summary>
        /// The validation rules that should pass for an instance of <see cref="CDP4Common.DTO.DiscussionItem"/>.
        /// </summary>
        private readonly Dictionary<string, DtoValidationHelper<CDP4Common.DTO.DiscussionItem>> validationRules = new Dictionary<string, DtoValidationHelper<CDP4Common.DTO.DiscussionItem>>
        {
            { "Content", new DtoValidationHelper<CDP4Common.DTO.DiscussionItem>(item => !string.IsNullOrWhiteSpace(item.Content), "The 'Content' property of a 'DiscussionItem' is mandatory and cannot be empty or null.") },
            { "ExcludedDomain", new DtoValidationHelper<CDP4Common.DTO.DiscussionItem>(item => item.ExcludedDomain != null, "The 'ExcludedDomain' property of a 'DiscussionItem' is mandatory and cannot be null.") },
            { "ExcludedPerson", new DtoValidationHelper<CDP4Common.DTO.DiscussionItem>(item => item.ExcludedPerson != null, "The 'ExcludedPerson' property of a 'DiscussionItem' is mandatory and cannot be null.") },
            { "LanguageCode", new DtoValidationHelper<CDP4Common.DTO.DiscussionItem>(item => !string.IsNullOrWhiteSpace(item.LanguageCode), "The 'LanguageCode' property of a 'DiscussionItem' is mandatory and cannot be empty or null.") },
        };
        ...
        /// </exception>
        public void Validate(CDP4Common.DTO.Thing discussionItem)
        {
            this.Validate(discussionItem, x => true);
        }
        ...
        /// If any validation rule failed.
        /// </exception>
        public void Validate(CDP4Common.DTO.Thing discussionItem, Func<string, bool> validateProperty)
        {
            foreach (var applicableRule in this.validationRules.Where(x => validateProperty(x.Key)))
            {
                applicableRule.Value.Validate((CDP4Common.DTO.DiscussionItem)discussionItem);
            }
        }
        ...
        /// </returns>
        public bool TryValidate(CDP4Common.DTO.Thing discussionItem)
        {
            return this.TryValidate(discussionItem, x => true);
        }
        ...
        /// True if all validation rules have passed or if none are defined.
        /// </returns>
        public bool TryValidate(CDP4Common.DTO.Thing discussionItem, Func<string, bool> validateProperty)
        {
            var applicableValidationRules = this.validationRules.Where(x => validateProperty(x.Key)).Select(x => x.Value);

            return applicableValidationRules.All(applicableRule => applicableRule.TryValidate((CDP4Common.DTO.DiscussionItem)discussionItem));
        }

        /// <summary>
        /// Returns the containment property value for the supplied <see cref="CDP4Common.DTO.DiscussionItem"/>.
        /// </summary>
        /// <param name="discussionItem">
        /// The <see cref="CDP4Common.DTO.DiscussionItem"/> for which to return the containment property value.
        /// </param>
        ...
        /// If the property name is not supported for the <see cref="CDP4Common.DTO.DiscussionItem"/>.
        /// </exception>
        public IEnumerable<Guid> GetContainmentIds(CDP4Common.DTO.Thing discussionItem, string propertyName)
        {
        ...
        /// <summary>
        /// Returns the ordered containment property value for the supplied <see cref="CDP4Common.DTO.DiscussionItem"/>.
        /// </summary>
        /// <param name="discussionItem">
        /// The <see cref="CDP4Common.DTO.DiscussionItem"/> for which to return the containment property value.
        /// </param>
        ...
        /// If the property name is not supported for the <see cref="CDP4Common.DTO.DiscussionItem"/>.
        /// </exception>
        public IEnumerable<OrderedItem> GetOrderedContainmentIds(CDP4Common.DTO.Thing discussionItem, string propertyName)
        {
        ...
        /// <summary>
        /// Gets the <see cref="PropertyMetaInfo"/> for the <see cref="DiscussionItem"/> class
        /// </summary>
        ...
        /// </summary>
        private readonly Dictionary<string, Func<CDP4Common.DTO.DiscussionItem, object>> propertyValueMap = new Dictionary<string, Func<CDP4Common.DTO.DiscussionItem, object>>
        {
        ...
        /// </summary>
        private readonly Dictionary<string, Action<CDP4Common.DTO.DiscussionItem, object>> propertyValueAssignmentMap = new Dictionary<string, Action<CDP4Common.DTO.DiscussionItem, object>>
        {
            { "Actor", (discussionItem, value) => discussionItem.Actor = value == null ? (Guid?)null : (Guid)value },
            { "Content", (discussionItem, value) => discussionItem.Content = value.ToString() },
            { "CreatedOn", (discussionItem, value) => discussionItem.CreatedOn = (DateTime)value },
            { "Iid", (discussionItem, value) => discussionItem.Iid = (Guid)value },
            { "LanguageCode", (discussionItem, value) => discussionItem.LanguageCode = value.ToString() },
            { "ModifiedOn", (discussionItem, value) => discussionItem.ModifiedOn = (DateTime)value },
            { "ReplyTo", (discussionItem, value) => discussionItem.ReplyTo = value == null ? (Guid?)null : (Guid)value },
            { "ThingPreference", (discussionItem, value) => discussionItem.ThingPreference = value == null ? (string)null : value.ToString() },
        };
        ...
        /// <summary>
        /// Returns the <see cref="CDP4Common.DTO.DiscussionItem"/> containment property type from the supplied property name.
        /// </summary>
        /// <param name="propertyName">
        ...
        /// <summary>
        /// Returns the <see cref="CDP4Common.DTO.DiscussionItem"/> property type from the supplied property name.
        /// </summary>
        /// <param name="propertyName">
        /// The property name.
        /// </param>
        ...
        /// <summary>
        /// Returns the container property for the supplied type name is a possible container for <see cref="CDP4Common.DTO.DiscussionItem"/>.
        /// </summary>
        /// <param name="typeName">
        /// Name of the type for which to check if it is a container of <see cref="CDP4Common.DTO.DiscussionItem"/>.
        /// </param>
        /// <param name="containerProperty">
        /// Supplied container property info instance that will be set if the supplied type name is a container of <see cref="CDP4Common.DTO.DiscussionItem"/>.
        /// </param>
        /// <returns>
        /// True if the supplied typeName is a container for <see cref="CDP4Common.DTO.DiscussionItem"/> and sets the container property name.
        /// </returns>
        ...
        /// <summary>
        /// Check if the supplied property name for <see cref="CDP4Common.DTO.DiscussionItem"/> is scalar.
        /// </summary>
        /// <param name="propertyName">
        /// Name of the property for which to check if it is scalar.
        /// </param>
        ...
        public bool ApplyPropertyUpdate(CDP4Common.DTO.Thing updatableThing, string propertyName, object value)
        {
            ...
            this.propertyValueAssignmentMap[propertyName]((CDP4Common.DTO.DiscussionItem)updatableThing, value);
        ...
        /// <summary>
        /// Instantiates a <see cref="CDP4Common.DTO.DiscussionItem"/>
        /// </summary>
        /// <returns>
