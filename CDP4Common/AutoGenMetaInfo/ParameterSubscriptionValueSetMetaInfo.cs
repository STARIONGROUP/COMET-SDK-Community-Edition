...
namespace CDP4Common.MetaInfo
{
    ...
    /// <summary>
    /// This a class that holds meta info for <see cref="ParameterSubscriptionValueSet"/>.
    /// </summary>
    public partial class ParameterSubscriptionValueSetMetaInfo : IParameterSubscriptionValueSetMetaInfo
    {
        /// <summary>
        /// The containment property value map.
        /// </summary>
        private readonly Dictionary<string, Func<CDP4Common.DTO.ParameterSubscriptionValueSet, IEnumerable<Guid>>> containmentPropertyValueMap = new Dictionary<string, Func<CDP4Common.DTO.ParameterSubscriptionValueSet, IEnumerable<Guid>>>();

        /// <summary>
        /// The ordered containment property value map.
        /// </summary>
        private readonly Dictionary<string, Func<CDP4Common.DTO.ParameterSubscriptionValueSet, IEnumerable<OrderedItem>>> orderedContainmentPropertyValueMap = new Dictionary<string, Func<CDP4Common.DTO.ParameterSubscriptionValueSet, IEnumerable<OrderedItem>>>();

        /// <summary>
        /// The validation rules that should pass for an instance of <see cref="CDP4Common.DTO.ParameterSubscriptionValueSet"/>.
        /// </summary>
        private readonly Dictionary<string, DtoValidationHelper<CDP4Common.DTO.ParameterSubscriptionValueSet>> validationRules = new Dictionary<string, DtoValidationHelper<CDP4Common.DTO.ParameterSubscriptionValueSet>>
        {
            { "ExcludedDomain", new DtoValidationHelper<CDP4Common.DTO.ParameterSubscriptionValueSet>(item => item.ExcludedDomain != null, "The 'ExcludedDomain' property of a 'ParameterSubscriptionValueSet' is mandatory and cannot be null.") },
            { "ExcludedPerson", new DtoValidationHelper<CDP4Common.DTO.ParameterSubscriptionValueSet>(item => item.ExcludedPerson != null, "The 'ExcludedPerson' property of a 'ParameterSubscriptionValueSet' is mandatory and cannot be null.") },
            { "Manual", new DtoValidationHelper<CDP4Common.DTO.ParameterSubscriptionValueSet>(item => item.Manual != null && item.Manual.Any(), "The 'Manual' property of a 'ParameterSubscriptionValueSet' is mandatory and must have at least one entry.") },
        };
        ...
        /// </exception>
        public void Validate(CDP4Common.DTO.Thing parameterSubscriptionValueSet)
        {
            this.Validate(parameterSubscriptionValueSet, x => true);
        }
        ...
        /// If any validation rule failed.
        /// </exception>
        public void Validate(CDP4Common.DTO.Thing parameterSubscriptionValueSet, Func<string, bool> validateProperty)
        {
            foreach (var applicableRule in this.validationRules.Where(x => validateProperty(x.Key)))
            {
                applicableRule.Value.Validate((CDP4Common.DTO.ParameterSubscriptionValueSet)parameterSubscriptionValueSet);
            }
        }
        ...
        /// </returns>
        public bool TryValidate(CDP4Common.DTO.Thing parameterSubscriptionValueSet)
        {
            return this.TryValidate(parameterSubscriptionValueSet, x => true);
        }
        ...
        /// True if all validation rules have passed or if none are defined.
        /// </returns>
        public bool TryValidate(CDP4Common.DTO.Thing parameterSubscriptionValueSet, Func<string, bool> validateProperty)
        {
            var applicableValidationRules = this.validationRules.Where(x => validateProperty(x.Key)).Select(x => x.Value);

            return applicableValidationRules.All(applicableRule => applicableRule.TryValidate((CDP4Common.DTO.ParameterSubscriptionValueSet)parameterSubscriptionValueSet));
        }

        /// <summary>
        /// Returns the containment property value for the supplied <see cref="CDP4Common.DTO.ParameterSubscriptionValueSet"/>.
        /// </summary>
        /// <param name="parameterSubscriptionValueSet">
        /// The <see cref="CDP4Common.DTO.ParameterSubscriptionValueSet"/> for which to return the containment property value.
        /// </param>
        ...
        /// If the property name is not supported for the <see cref="CDP4Common.DTO.ParameterSubscriptionValueSet"/>.
        /// </exception>
        public IEnumerable<Guid> GetContainmentIds(CDP4Common.DTO.Thing parameterSubscriptionValueSet, string propertyName)
        {
        ...
        /// <summary>
        /// Returns the ordered containment property value for the supplied <see cref="CDP4Common.DTO.ParameterSubscriptionValueSet"/>.
        /// </summary>
        /// <param name="parameterSubscriptionValueSet">
        /// The <see cref="CDP4Common.DTO.ParameterSubscriptionValueSet"/> for which to return the containment property value.
        /// </param>
        ...
        /// If the property name is not supported for the <see cref="CDP4Common.DTO.ParameterSubscriptionValueSet"/>.
        /// </exception>
        public IEnumerable<OrderedItem> GetOrderedContainmentIds(CDP4Common.DTO.Thing parameterSubscriptionValueSet, string propertyName)
        {
        ...
        /// <summary>
        /// Gets the <see cref="PropertyMetaInfo"/> for the <see cref="ParameterSubscriptionValueSet"/> class
        /// </summary>
        ...
        private readonly Dictionary<string, PropertyMetaInfo> propertyTypeMap = new Dictionary<string, PropertyMetaInfo>
        {
            ...
            { "Computed", new PropertyMetaInfo("Computed", "string", PropertyKind.ValueArray, AggregationKind.None, true, true, true, 1, "*", false) },
            ...
            { "SubscribedValueSet", new PropertyMetaInfo("SubscribedValueSet", "Guid", PropertyKind.Scalar, AggregationKind.None, false, false, true, 1, "1", true) },
        ...
        {
            { "ParameterSubscription", new PropertyMetaInfo("ValueSet", "Guid", PropertyKind.List, AggregationKind.Composite, false, false, true, 1, "*", true) },
        };
        ...
        /// <summary>
        /// Returns the <see cref="CDP4Common.DTO.ParameterSubscriptionValueSet"/> containment property type from the supplied property name.
        /// </summary>
        /// <param name="propertyName">
        ...
        /// <summary>
        /// Returns the <see cref="CDP4Common.DTO.ParameterSubscriptionValueSet"/> property type from the supplied property name.
        /// </summary>
        /// <param name="propertyName">
        /// The property name.
        /// </param>
        ...
        /// <summary>
        /// Returns the container property for the supplied type name is a possible container for <see cref="CDP4Common.DTO.ParameterSubscriptionValueSet"/>.
        /// </summary>
        /// <param name="typeName">
        /// Name of the type for which to check if it is a container of <see cref="CDP4Common.DTO.ParameterSubscriptionValueSet"/>.
        /// </param>
        /// <param name="containerProperty">
        /// Supplied container property info instance that will be set if the supplied type name is a container of <see cref="CDP4Common.DTO.ParameterSubscriptionValueSet"/>.
        /// </param>
        /// <returns>
        /// True if the supplied typeName is a container for <see cref="CDP4Common.DTO.ParameterSubscriptionValueSet"/> and sets the container property name.
        /// </returns>
        ...
        /// <summary>
        /// Check if the supplied property name for <see cref="CDP4Common.DTO.ParameterSubscriptionValueSet"/> is scalar.
        /// </summary>
        /// <param name="propertyName">
        /// Name of the property for which to check if it is scalar.
        /// </param>
        ...
        public bool ApplyPropertyUpdate(CDP4Common.DTO.Thing updatableThing, string propertyName, object value)
        {
            ...
            this.propertyValueAssignmentMap[propertyName]((CDP4Common.DTO.ParameterSubscriptionValueSet)updatableThing, value);
        ...
        /// <summary>
        /// Instantiates a <see cref="CDP4Common.DTO.ParameterSubscriptionValueSet"/>
        /// </summary>
        /// <returns>
        ...
        {
            return new CDP4Common.DTO.ParameterSubscriptionValueSet(guid, revisionNumber);
        }
    }
}
