// --------------------------------------------------------------------------------------------------------------------
// <copyright file="ParameterSubscriptionValueSetMetaInfo.cs" company="Starion Group S.A.">
...
namespace CDP4Common.MetaInfo
{
    ...
    public partial class ParameterSubscriptionValueSetMetaInfo : IParameterSubscriptionValueSetMetaInfo
    {
        ...
        {
            { "ParameterSubscription", new PropertyMetaInfo("ValueSet", "ParameterSubscriptionValueSet", PropertyKind.List, AggregationKind.Composite, false, false, true, 1, "*", true) },
        };
