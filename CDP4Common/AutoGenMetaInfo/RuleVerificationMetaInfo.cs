...
namespace CDP4Common.MetaInfo
{
    ...
    public partial class RuleVerificationMetaInfo : IRuleVerificationMetaInfo
    {
        ...
        public IEnumerable<Guid> GetContainmentIds(CDP4Common.DTO.Thing ruleVerification, string propertyName)
        {
            ...
            {
                throw new ArgumentException(string.Format("'{0}' is not a valid containment property of 'RuleVerification'", propertyName));
            }
        ...
        public object DeserializeCollectionValue(string propertyName, object value)
        {
            ...
            {
                throw new ArgumentException(string.Format("'{0}' is not a valid collection property of 'RuleVerification'", propertyName));
            }
