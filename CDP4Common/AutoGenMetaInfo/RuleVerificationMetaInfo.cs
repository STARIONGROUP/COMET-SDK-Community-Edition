// --------------------------------------------------------------------------------------------------------------------
// <copyright file="RuleVerificationMetaInfo.cs" company="Starion Group S.A.">
...
namespace CDP4Common.MetaInfo
{
    ...
    /// <summary>
    /// This a class that holds meta info for <see cref="RuleVerification"/>.
    /// </summary>
    public partial class RuleVerificationMetaInfo : IRuleVerificationMetaInfo
    {
        /// <summary>
        /// The containment property value map.
        /// </summary>
        private readonly Dictionary<string, Func<CDP4Common.DTO.RuleVerification, IEnumerable<Guid>>> containmentPropertyValueMap = new Dictionary<string, Func<CDP4Common.DTO.RuleVerification, IEnumerable<Guid>>>
        {
            { "Violation", ruleVerification => ruleVerification.Violation },
        };

        /// <summary>
        /// The ordered containment property value map.
        /// </summary>
        private readonly Dictionary<string, Func<CDP4Common.DTO.RuleVerification, IEnumerable<OrderedItem>>> orderedContainmentPropertyValueMap = new Dictionary<string, Func<CDP4Common.DTO.RuleVerification, IEnumerable<OrderedItem>>>();

        /// <summary>
        /// The validation rules that should pass for an instance of <see cref="CDP4Common.DTO.RuleVerification"/>.
        /// </summary>
        private readonly Dictionary<string, DtoValidationHelper<CDP4Common.DTO.RuleVerification>> validationRules = new Dictionary<string, DtoValidationHelper<CDP4Common.DTO.RuleVerification>>
        {
            { "ExcludedDomain", new DtoValidationHelper<CDP4Common.DTO.RuleVerification>(item => item.ExcludedDomain != null, "The 'ExcludedDomain' property of a 'RuleVerification' is mandatory and cannot be null.") },
            { "ExcludedPerson", new DtoValidationHelper<CDP4Common.DTO.RuleVerification>(item => item.ExcludedPerson != null, "The 'ExcludedPerson' property of a 'RuleVerification' is mandatory and cannot be null.") },
            { "Name", new DtoValidationHelper<CDP4Common.DTO.RuleVerification>(item => !string.IsNullOrWhiteSpace(item.Name), "The 'Name' property of a 'RuleVerification' is mandatory and cannot be empty or null.") },
            { "Violation", new DtoValidationHelper<CDP4Common.DTO.RuleVerification>(item => item.Violation != null, "The 'Violation' property of a 'RuleVerification' is mandatory and cannot be null.") },
        };
        ...
        /// </exception>
        public void Validate(CDP4Common.DTO.Thing ruleVerification)
        {
            this.Validate(ruleVerification, x => true);
        }
        ...
        /// If any validation rule failed.
        /// </exception>
        public void Validate(CDP4Common.DTO.Thing ruleVerification, Func<string, bool> validateProperty)
        {
            foreach (var applicableRule in this.validationRules.Where(x => validateProperty(x.Key)))
            {
                applicableRule.Value.Validate((CDP4Common.DTO.RuleVerification)ruleVerification);
            }
        }
        ...
        /// </returns>
        public bool TryValidate(CDP4Common.DTO.Thing ruleVerification)
        {
            return this.TryValidate(ruleVerification, x => true);
        }
        ...
        /// True if all validation rules have passed or if none are defined.
        /// </returns>
        public bool TryValidate(CDP4Common.DTO.Thing ruleVerification, Func<string, bool> validateProperty)
        {
            var applicableValidationRules = this.validationRules.Where(x => validateProperty(x.Key)).Select(x => x.Value);

            return applicableValidationRules.All(applicableRule => applicableRule.TryValidate((CDP4Common.DTO.RuleVerification)ruleVerification));
        }

        /// <summary>
        /// Returns the containment property value for the supplied <see cref="CDP4Common.DTO.RuleVerification"/>.
        /// </summary>
        /// <param name="ruleVerification">
        /// The <see cref="CDP4Common.DTO.RuleVerification"/> for which to return the containment property value.
        /// </param>
        ...
        /// If the property name is not supported for the <see cref="CDP4Common.DTO.RuleVerification"/>.
        /// </exception>
        public IEnumerable<Guid> GetContainmentIds(CDP4Common.DTO.Thing ruleVerification, string propertyName)
        {
            if (!this.containmentPropertyValueMap.ContainsKey(propertyName))
            {
                throw new ArgumentException($"'{propertyName}' is not a valid containment property of 'RuleVerification'");
            }

            return this.containmentPropertyValueMap[propertyName]((CDP4Common.DTO.RuleVerification)ruleVerification);
        }

        /// <summary>
        /// Returns the ordered containment property value for the supplied <see cref="CDP4Common.DTO.RuleVerification"/>.
        /// </summary>
        /// <param name="ruleVerification">
        /// The <see cref="CDP4Common.DTO.RuleVerification"/> for which to return the containment property value.
        /// </param>
        ...
        /// If the property name is not supported for the <see cref="CDP4Common.DTO.RuleVerification"/>.
        /// </exception>
        public IEnumerable<OrderedItem> GetOrderedContainmentIds(CDP4Common.DTO.Thing ruleVerification, string propertyName)
        {
            ...
            return this.orderedContainmentPropertyValueMap[propertyName]((CDP4Common.DTO.RuleVerification)ruleVerification);
        }
        ...
        /// <summary>
        /// Gets the <see cref="PropertyMetaInfo"/> for the <see cref="RuleVerification"/> class
        /// </summary>
        ...
        /// </summary>
        private readonly Dictionary<string, Func<CDP4Common.DTO.RuleVerification, object>> propertyValueMap = new Dictionary<string, Func<CDP4Common.DTO.RuleVerification, object>>
        {
        ...
        /// </summary>
        private readonly Dictionary<string, Action<CDP4Common.DTO.RuleVerification, object>> propertyValueAssignmentMap = new Dictionary<string, Action<CDP4Common.DTO.RuleVerification, object>>
        {
            { "Actor", (ruleVerification, value) => ruleVerification.Actor = value == null ? (Guid?)null : (Guid)value },
            { "ExecutedOn", (ruleVerification, value) => ruleVerification.ExecutedOn = value == null ? (DateTime?)null : (DateTime)value },
            { "Iid", (ruleVerification, value) => ruleVerification.Iid = (Guid)value },
            { "IsActive", (ruleVerification, value) => ruleVerification.IsActive = (bool)value },
        ...
        /// <summary>
        /// Returns the <see cref="CDP4Common.DTO.RuleVerification"/> containment property type from the supplied property name.
        /// </summary>
        /// <param name="propertyName">
        ...
        /// <summary>
        /// Returns the <see cref="CDP4Common.DTO.RuleVerification"/> property type from the supplied property name.
        /// </summary>
        /// <param name="propertyName">
        /// The property name.
        /// </param>
        ...
        /// <summary>
        /// Returns the container property for the supplied type name is a possible container for <see cref="CDP4Common.DTO.RuleVerification"/>.
        /// </summary>
        /// <param name="typeName">
        /// Name of the type for which to check if it is a container of <see cref="CDP4Common.DTO.RuleVerification"/>.
        /// </param>
        /// <param name="containerProperty">
        /// Supplied container property info instance that will be set if the supplied type name is a container of <see cref="CDP4Common.DTO.RuleVerification"/>.
        /// </param>
        /// <returns>
        /// True if the supplied typeName is a container for <see cref="CDP4Common.DTO.RuleVerification"/> and sets the container property name.
        /// </returns>
        ...
        /// <summary>
        /// Check if the supplied property name for <see cref="CDP4Common.DTO.RuleVerification"/> is scalar.
        /// </summary>
        /// <param name="propertyName">
        /// Name of the property for which to check if it is scalar.
        /// </param>
        ...
        public bool ApplyPropertyUpdate(CDP4Common.DTO.Thing updatableThing, string propertyName, object value)
        {
            ...
            this.propertyValueAssignmentMap[propertyName]((CDP4Common.DTO.RuleVerification)updatableThing, value);
        ...
        public object DeserializeCollectionValue(string propertyName, object value)
        {
            ...
            {
                throw new ArgumentException($"'{propertyName}' is not a valid collection property of 'RuleVerification'");
            }
        ...
        public object GetValue(string propertyName, CDP4Common.DTO.Thing thing)
        {
            ...
            return this.propertyValueMap[propertyName]((CDP4Common.DTO.RuleVerification)thing);
        }
        ...
        /// <summary>
        /// Instantiates a <see cref="CDP4Common.DTO.RuleVerification"/>
        /// </summary>
        /// <returns>
