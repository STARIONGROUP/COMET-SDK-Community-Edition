// --------------------------------------------------------------------------------------------------------------------
// <copyright file="ParameterValueMetaInfo.cs" company="Starion Group S.A.">
...
namespace CDP4Common.MetaInfo
{
    ...
    public partial class ParameterValueMetaInfo : IParameterValueMetaInfo
    {
        ...
        public IEnumerable<Guid> GetContainmentIds(CDP4Common.DTO.Thing parameterValue, string propertyName)
        {
            ...
            {
                throw new ArgumentException($"'{propertyName}' is not a valid containment property of 'ParameterValue'");
            }
        ...
        {
            { "Actor", (parameterValue, value) => parameterValue.Actor = value == null ? (Guid?)null : (Guid)value },
            ...
            { "ThingPreference", (parameterValue, value) => parameterValue.ThingPreference = value == null ? (string)null : value.ToString() },
        ...
        public object DeserializeCollectionValue(string propertyName, object value)
        {
            ...
            {
                throw new ArgumentException($"'{propertyName}' is not a valid collection property of 'ParameterValue'");
            }
