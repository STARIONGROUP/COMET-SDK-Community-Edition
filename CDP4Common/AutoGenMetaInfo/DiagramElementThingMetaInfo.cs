// --------------------------------------------------------------------------------------------------------------------
// <copyright file="DiagramElementThingMetaInfo.cs" company="RHEA System S.A.">
...
namespace CDP4Common.MetaInfo
{
    ...
    /// <summary>
    /// This a class that holds meta info for <see cref="DiagramElementThing"/>.
    /// </summary>
    public partial class DiagramElementThingMetaInfo : IDiagramElementThingMetaInfo
    {
        /// <summary>
        /// The containment property value map.
        /// </summary>
        private readonly Dictionary<string, Func<CDP4Common.DTO.DiagramElementThing, IEnumerable<Guid>>> containmentPropertyValueMap = new Dictionary<string, Func<CDP4Common.DTO.DiagramElementThing, IEnumerable<Guid>>>
        {
            { "Bounds", diagramElementThing => diagramElementThing.Bounds },
            { "DiagramElement", diagramElementThing => diagramElementThing.DiagramElement },
            { "LocalStyle", diagramElementThing => diagramElementThing.LocalStyle },
        };

        /// <summary>
        /// The ordered containment property value map.
        /// </summary>
        private readonly Dictionary<string, Func<CDP4Common.DTO.DiagramElementThing, IEnumerable<OrderedItem>>> orderedContainmentPropertyValueMap = new Dictionary<string, Func<CDP4Common.DTO.DiagramElementThing, IEnumerable<OrderedItem>>>();

        /// <summary>
        /// The validation rules that should pass for an instance of <see cref="CDP4Common.DTO.DiagramElementThing"/>.
        /// </summary>
        private readonly Dictionary<string, DtoValidationHelper<CDP4Common.DTO.DiagramElementThing>> validationRules = new Dictionary<string, DtoValidationHelper<CDP4Common.DTO.DiagramElementThing>>
        {
            { "Bounds", new DtoValidationHelper<CDP4Common.DTO.DiagramElementThing>(item => item.Bounds != null, "The 'Bounds' property of a 'DiagramElementThing' is mandatory and cannot be null.") },
            { "DiagramElement", new DtoValidationHelper<CDP4Common.DTO.DiagramElementThing>(item => item.DiagramElement != null, "The 'DiagramElement' property of a 'DiagramElementThing' is mandatory and cannot be null.") },
            { "ExcludedDomain", new DtoValidationHelper<CDP4Common.DTO.DiagramElementThing>(item => item.ExcludedDomain != null, "The 'ExcludedDomain' property of a 'DiagramElementThing' is mandatory and cannot be null.") },
            { "ExcludedPerson", new DtoValidationHelper<CDP4Common.DTO.DiagramElementThing>(item => item.ExcludedPerson != null, "The 'ExcludedPerson' property of a 'DiagramElementThing' is mandatory and cannot be null.") },
            { "LocalStyle", new DtoValidationHelper<CDP4Common.DTO.DiagramElementThing>(item => item.LocalStyle != null, "The 'LocalStyle' property of a 'DiagramElementThing' is mandatory and cannot be null.") },
            { "Name", new DtoValidationHelper<CDP4Common.DTO.DiagramElementThing>(item => !string.IsNullOrWhiteSpace(item.Name), "The 'Name' property of a 'DiagramElementThing' is mandatory and cannot be empty or null.") },
        };
        ...
        /// </exception>
        public void Validate(CDP4Common.DTO.Thing diagramElementThing)
        {
            this.Validate(diagramElementThing, x => true);
        }
        ...
        /// If any validation rule failed.
        /// </exception>
        public void Validate(CDP4Common.DTO.Thing diagramElementThing, Func<string, bool> validateProperty)
        {
            foreach (var applicableRule in this.validationRules.Where(x => validateProperty(x.Key)))
            {
                applicableRule.Value.Validate((CDP4Common.DTO.DiagramElementThing)diagramElementThing);
            }
        }
        ...
        /// </returns>
        public bool TryValidate(CDP4Common.DTO.Thing diagramElementThing)
        {
            return this.TryValidate(diagramElementThing, x => true);
        }
        ...
        /// True if all validation rules have passed or if none are defined.
        /// </returns>
        public bool TryValidate(CDP4Common.DTO.Thing diagramElementThing, Func<string, bool> validateProperty)
        {
            var applicableValidationRules = this.validationRules.Where(x => validateProperty(x.Key)).Select(x => x.Value);

            return applicableValidationRules.All(applicableRule => applicableRule.TryValidate((CDP4Common.DTO.DiagramElementThing)diagramElementThing));
        }

        /// <summary>
        /// Returns the containment property value for the supplied <see cref="CDP4Common.DTO.DiagramElementThing"/>.
        /// </summary>
        /// <param name="diagramElementThing">
        /// The <see cref="CDP4Common.DTO.DiagramElementThing"/> for which to return the containment property value.
        /// </param>
        ...
        /// If the property name is not supported for the <see cref="CDP4Common.DTO.DiagramElementThing"/>.
        /// </exception>
        public IEnumerable<Guid> GetContainmentIds(CDP4Common.DTO.Thing diagramElementThing, string propertyName)
        {
            if (!this.containmentPropertyValueMap.ContainsKey(propertyName))
            {
                throw new ArgumentException(string.Format("'{0}' is not a valid containment property of 'DiagramElementThing'", propertyName));
            }

            return this.containmentPropertyValueMap[propertyName]((CDP4Common.DTO.DiagramElementThing)diagramElementThing);
        }

        /// <summary>
        /// Returns the ordered containment property value for the supplied <see cref="CDP4Common.DTO.DiagramElementThing"/>.
        /// </summary>
        /// <param name="diagramElementThing">
        /// The <see cref="CDP4Common.DTO.DiagramElementThing"/> for which to return the containment property value.
        /// </param>
        ...
        /// If the property name is not supported for the <see cref="CDP4Common.DTO.DiagramElementThing"/>.
        /// </exception>
        public IEnumerable<OrderedItem> GetOrderedContainmentIds(CDP4Common.DTO.Thing diagramElementThing, string propertyName)
        {
            ...
            return this.orderedContainmentPropertyValueMap[propertyName]((CDP4Common.DTO.DiagramElementThing)diagramElementThing);
        }
        ...
        /// <summary>
        /// Gets the <see cref="PropertyMetaInfo"/> for the <see cref="DiagramElementThing"/> class
        /// </summary>
        ...
        private readonly Dictionary<string, Action<CDP4Common.DTO.DiagramElementThing, object>> propertyValueAssignmentMap = new Dictionary<string, Action<CDP4Common.DTO.DiagramElementThing, object>>
        {
            ...
            { "Name", (diagramElementThing, value) => diagramElementThing.Name = value.ToString() },
            { "SharedStyle", (diagramElementThing, value) => diagramElementThing.SharedStyle = value == null ? (Guid?)null : (Guid)value },
            { "ThingPreference", (diagramElementThing, value) => diagramElementThing.ThingPreference = value == null ? (string)null : value.ToString() },
        };
        ...
        {
            get { return "DiagramElementContainer"; }
        }
        ...
        /// <summary>
        /// Returns the <see cref="CDP4Common.DTO.DiagramElementThing"/> containment property type from the supplied property name.
        /// </summary>
        /// <param name="propertyName">
        ...
        /// <summary>
        /// Returns the <see cref="CDP4Common.DTO.DiagramElementThing"/> property type from the supplied property name.
        /// </summary>
        /// <param name="propertyName">
        /// The property name.
        /// </param>
        ...
        /// <summary>
        /// Returns the container property for the supplied type name is a possible container for <see cref="CDP4Common.DTO.DiagramElementThing"/>.
        /// </summary>
        /// <param name="typeName">
        /// Name of the type for which to check if it is a container of <see cref="CDP4Common.DTO.DiagramElementThing"/>.
        /// </param>
        /// <param name="containerProperty">
        /// Supplied container property info instance that will be set if the supplied type name is a container of <see cref="CDP4Common.DTO.DiagramElementThing"/>.
        /// </param>
        /// <returns>
        /// True if the supplied typeName is a container for <see cref="CDP4Common.DTO.DiagramElementThing"/> and sets the container property name.
        /// </returns>
        ...
        /// <summary>
        /// Check if the supplied property name for <see cref="CDP4Common.DTO.DiagramElementThing"/> is scalar.
        /// </summary>
        /// <param name="propertyName">
        /// Name of the property for which to check if it is scalar.
        /// </param>
        ...
        public bool ApplyPropertyUpdate(CDP4Common.DTO.Thing updatableThing, string propertyName, object value)
        {
            ...
            this.propertyValueAssignmentMap[propertyName]((CDP4Common.DTO.DiagramElementThing)updatableThing, value);
        ...
        public object DeserializeCollectionValue(string propertyName, object value)
        {
            ...
            {
                throw new ArgumentException(string.Format("'{0}' is not a valid collection property of 'DiagramElementThing'", propertyName));
            }
        ...
        public object GetValue(string propertyName, CDP4Common.DTO.Thing thing)
        {
            ...
            return this.propertyValueMap[propertyName]((CDP4Common.DTO.DiagramElementThing)thing);
        }
        ...
        /// <summary>
        /// Instantiates a <see cref="CDP4Common.DTO.DiagramElementThing"/>
        /// </summary>
        /// <returns>
