...
namespace CDP4Common.MetaInfo
{
    ...
    /// </summary>
    public partial class DefinitionMetaInfo : IDefinitionMetaInfo
    {
        /// <summary>
        /// The containment property value map.
        /// </summary>
        private readonly Dictionary<string, Func<CDP4Common.DTO.Definition, IEnumerable<Guid>>> containmentPropertyValueMap = new Dictionary<string, Func<CDP4Common.DTO.Definition, IEnumerable<Guid>>>
        {
            { "Citation", definition => definition.Citation },
        };

        /// <summary>
        /// The ordered containment property value map.
        /// </summary>
        private readonly Dictionary<string, Func<CDP4Common.DTO.Definition, IEnumerable<OrderedItem>>> orderedContainmentPropertyValueMap = new Dictionary<string, Func<CDP4Common.DTO.Definition, IEnumerable<OrderedItem>>>();

        /// <summary>
        /// The validation rules that should pass for an instance of <see cref="CDP4Common.DTO.Definition"/>.
        /// </summary>
        private readonly Dictionary<string, DtoValidationHelper<CDP4Common.DTO.Definition>> validationRules = new Dictionary<string, DtoValidationHelper<CDP4Common.DTO.Definition>>
        {
            { "Citation", new DtoValidationHelper<CDP4Common.DTO.Definition>(item => item.Citation != null, "The 'Citation' property of a 'Definition' is mandatory and cannot be null.") },
            { "Content", new DtoValidationHelper<CDP4Common.DTO.Definition>(item => !string.IsNullOrWhiteSpace(item.Content), "The 'Content' property of a 'Definition' is mandatory and cannot be empty or null.") },
            { "Example", new DtoValidationHelper<CDP4Common.DTO.Definition>(item => item.Example != null, "The 'Example' property of a 'Definition' is mandatory and cannot be null.") },
            { "ExcludedDomain", new DtoValidationHelper<CDP4Common.DTO.Definition>(item => item.ExcludedDomain != null, "The 'ExcludedDomain' property of a 'Definition' is mandatory and cannot be null.") },
            { "ExcludedPerson", new DtoValidationHelper<CDP4Common.DTO.Definition>(item => item.ExcludedPerson != null, "The 'ExcludedPerson' property of a 'Definition' is mandatory and cannot be null.") },
            { "LanguageCode", new DtoValidationHelper<CDP4Common.DTO.Definition>(item => !string.IsNullOrWhiteSpace(item.LanguageCode), "The 'LanguageCode' property of a 'Definition' is mandatory and cannot be empty or null.") },
            { "Note", new DtoValidationHelper<CDP4Common.DTO.Definition>(item => item.Note != null, "The 'Note' property of a 'Definition' is mandatory and cannot be null.") },
        };
        ...
        /// </exception>
        public void Validate(CDP4Common.DTO.Thing definition)
        {
            this.Validate(definition, x => true);
        }
        ...
        /// If any validation rule failed.
        /// </exception>
        public void Validate(CDP4Common.DTO.Thing definition, Func<string, bool> validateProperty)
        {
            foreach (var applicableRule in this.validationRules.Where(x => validateProperty(x.Key)))
            {
                applicableRule.Value.Validate((CDP4Common.DTO.Definition)definition);
            }
        }
        ...
        /// </returns>
        public bool TryValidate(CDP4Common.DTO.Thing definition)
        {
            return this.TryValidate(definition, x => true);
        }
        ...
        /// True if all validation rules have passed or if none are defined.
        /// </returns>
        public bool TryValidate(CDP4Common.DTO.Thing definition, Func<string, bool> validateProperty)
        {
            var applicableValidationRules = this.validationRules.Where(x => validateProperty(x.Key)).Select(x => x.Value);

            return applicableValidationRules.All(applicableRule => applicableRule.TryValidate((CDP4Common.DTO.Definition)definition));
        }

        /// <summary>
        /// Returns the containment property value for the supplied <see cref="CDP4Common.DTO.Definition"/>.
        /// </summary>
        /// <param name="definition">
        /// The <see cref="CDP4Common.DTO.Definition"/> for which to return the containment property value.
        /// </param>
        ...
        /// If the property name is not supported for the <see cref="CDP4Common.DTO.Definition"/>.
        /// </exception>
        public IEnumerable<Guid> GetContainmentIds(CDP4Common.DTO.Thing definition, string propertyName)
        {
        ...
        /// <summary>
        /// Returns the ordered containment property value for the supplied <see cref="CDP4Common.DTO.Definition"/>.
        /// </summary>
        /// <param name="definition">
        /// The <see cref="CDP4Common.DTO.Definition"/> for which to return the containment property value.
        /// </param>
        ...
        /// If the property name is not supported for the <see cref="CDP4Common.DTO.Definition"/>.
        /// </exception>
        public IEnumerable<OrderedItem> GetOrderedContainmentIds(CDP4Common.DTO.Thing definition, string propertyName)
        {
        ...
        /// <summary>
        /// Gets the <see cref="PropertyMetaInfo"/> for the <see cref="Definition"/> class
        /// </summary>
        ...
        private readonly Dictionary<string, PropertyMetaInfo> propertyTypeMap = new Dictionary<string, PropertyMetaInfo>
        {
            ...
            { "Note", new PropertyMetaInfo("Note", "string", PropertyKind.OrderedList, AggregationKind.None, false, true, true, 0, "*", true) },
        ...
        private readonly Dictionary<string, Action<CDP4Common.DTO.Definition, object>> propertyValueAssignmentMap = new Dictionary<string, Action<CDP4Common.DTO.Definition, object>>
        {
            ...
            { "ModifiedOn", (definition, value) => definition.ModifiedOn = (DateTime)value },
            { "ThingPreference", (definition, value) => definition.ThingPreference = value == null ? (string)null : value.ToString() },
        };
        ...
        private readonly Dictionary<string, PropertyMetaInfo> possibleContainerProperties = new Dictionary<string, PropertyMetaInfo>
        {
            ...
            { "Behavior", new PropertyMetaInfo("Definition", "Definition", PropertyKind.List, AggregationKind.Composite, false, false, true, 0, "*", true) },
            ...
            { "SampledFunctionParameterType", new PropertyMetaInfo("Definition", "Definition", PropertyKind.List, AggregationKind.Composite, false, false, true, 0, "*", true) },
        ...
        /// <summary>
        /// Returns the <see cref="CDP4Common.DTO.Definition"/> containment property type from the supplied property name.
        /// </summary>
        /// <param name="propertyName">
        ...
        /// <summary>
        /// Returns the <see cref="CDP4Common.DTO.Definition"/> property type from the supplied property name.
        /// </summary>
        /// <param name="propertyName">
        /// The property name.
        /// </param>
        ...
        /// <summary>
        /// Returns the container property for the supplied type name is a possible container for <see cref="CDP4Common.DTO.Definition"/>.
        /// </summary>
        /// <param name="typeName">
        /// Name of the type for which to check if it is a container of <see cref="CDP4Common.DTO.Definition"/>.
        /// </param>
        /// <param name="containerProperty">
        /// Supplied container property info instance that will be set if the supplied type name is a container of <see cref="CDP4Common.DTO.Definition"/>.
        /// </param>
        /// <returns>
        /// True if the supplied typeName is a container for <see cref="CDP4Common.DTO.Definition"/> and sets the container property name.
        /// </returns>
        ...
        /// <summary>
        /// Check if the supplied property name for <see cref="CDP4Common.DTO.Definition"/> is scalar.
        /// </summary>
        /// <param name="propertyName">
        /// Name of the property for which to check if it is scalar.
        /// </param>
        ...
        public bool ApplyPropertyUpdate(CDP4Common.DTO.Thing updatableThing, string propertyName, object value)
        {
            ...
            this.propertyValueAssignmentMap[propertyName]((CDP4Common.DTO.Definition)updatableThing, value);
        ...
        /// <summary>
        /// Instantiates a <see cref="CDP4Common.DTO.Definition"/>
        /// </summary>
        /// <returns>
        ...
        {
            return new CDP4Common.DTO.Definition(guid, revisionNumber);
        }
    }
}
