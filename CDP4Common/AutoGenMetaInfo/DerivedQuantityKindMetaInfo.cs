// --------------------------------------------------------------------------------------------------------------------
// <copyright file="DerivedQuantityKindMetaInfo.cs" company="Starion Group S.A.">
...
namespace CDP4Common.MetaInfo
{
    ...
    /// <summary>
    /// This a class that holds meta info for <see cref="DerivedQuantityKind"/>.
    /// </summary>
    public partial class DerivedQuantityKindMetaInfo : IDerivedQuantityKindMetaInfo
    {
        /// <summary>
        ...
        /// </summary>
        private readonly Dictionary<string, Func<CDP4Common.DTO.DerivedQuantityKind, IEnumerable<OrderedItem>>> orderedContainmentPropertyValueMap = new Dictionary<string, Func<CDP4Common.DTO.DerivedQuantityKind, IEnumerable<OrderedItem>>>
        {
            { "QuantityKindFactor", derivedQuantityKind => derivedQuantityKind.QuantityKindFactor },
        };

        /// <summary>
        /// The validation rules that should pass for an instance of <see cref="CDP4Common.DTO.DerivedQuantityKind"/>.
        /// </summary>
        private readonly Dictionary<string, DtoValidationHelper<CDP4Common.DTO.DerivedQuantityKind>> validationRules = new Dictionary<string, DtoValidationHelper<CDP4Common.DTO.DerivedQuantityKind>>
        {
            ...
            { "ExcludedPerson", new DtoValidationHelper<CDP4Common.DTO.DerivedQuantityKind>(item => item.ExcludedPerson != null, "The 'ExcludedPerson' property of a 'DerivedQuantityKind' is mandatory and cannot be null.") },
            { "HyperLink", new DtoValidationHelper<CDP4Common.DTO.DerivedQuantityKind>(item => item.HyperLink != null, "The 'HyperLink' property of a 'DerivedQuantityKind' is mandatory and cannot be null.") },
            { "Name", new DtoValidationHelper<CDP4Common.DTO.DerivedQuantityKind>(item => !string.IsNullOrWhiteSpace(item.Name), "The 'Name' property of a 'DerivedQuantityKind' is mandatory and cannot be empty or null.") },
            { "PossibleScale", new DtoValidationHelper<CDP4Common.DTO.DerivedQuantityKind>(item => item.PossibleScale != null, "The 'PossibleScale' property of a 'DerivedQuantityKind' is mandatory and cannot be null.") },
            { "QuantityKindFactor", new DtoValidationHelper<CDP4Common.DTO.DerivedQuantityKind>(item => item.QuantityKindFactor != null && item.QuantityKindFactor.Any(), "The 'QuantityKindFactor' property of a 'DerivedQuantityKind' is mandatory and must have at least one entry.") },
            { "ShortName", new DtoValidationHelper<CDP4Common.DTO.DerivedQuantityKind>(item => !string.IsNullOrWhiteSpace(item.ShortName), "The 'ShortName' property of a 'DerivedQuantityKind' is mandatory and cannot be empty or null.") },
            { "Symbol", new DtoValidationHelper<CDP4Common.DTO.DerivedQuantityKind>(item => !string.IsNullOrWhiteSpace(item.Symbol), "The 'Symbol' property of a 'DerivedQuantityKind' is mandatory and cannot be empty or null.") },
        };
        ...
        /// </exception>
        public void Validate(CDP4Common.DTO.Thing derivedQuantityKind)
        {
            this.Validate(derivedQuantityKind, x => true);
        }
        ...
        /// If any validation rule failed.
        /// </exception>
        public void Validate(CDP4Common.DTO.Thing derivedQuantityKind, Func<string, bool> validateProperty)
        {
            foreach (var applicableRule in this.validationRules.Where(x => validateProperty(x.Key)))
            {
                applicableRule.Value.Validate((CDP4Common.DTO.DerivedQuantityKind)derivedQuantityKind);
            }
        }
        ...
        /// </returns>
        public bool TryValidate(CDP4Common.DTO.Thing derivedQuantityKind)
        {
            return this.TryValidate(derivedQuantityKind, x => true);
        }
        ...
        /// True if all validation rules have passed or if none are defined.
        /// </returns>
        public bool TryValidate(CDP4Common.DTO.Thing derivedQuantityKind, Func<string, bool> validateProperty)
        {
            var applicableValidationRules = this.validationRules.Where(x => validateProperty(x.Key)).Select(x => x.Value);

            return applicableValidationRules.All(applicableRule => applicableRule.TryValidate((CDP4Common.DTO.DerivedQuantityKind)derivedQuantityKind));
        }

        /// <summary>
        /// Returns the containment property value for the supplied <see cref="CDP4Common.DTO.DerivedQuantityKind"/>.
        /// </summary>
        /// <param name="derivedQuantityKind">
        /// The <see cref="CDP4Common.DTO.DerivedQuantityKind"/> for which to return the containment property value.
        /// </param>
        ...
        /// If the property name is not supported for the <see cref="CDP4Common.DTO.DerivedQuantityKind"/>.
        /// </exception>
        public IEnumerable<Guid> GetContainmentIds(CDP4Common.DTO.Thing derivedQuantityKind, string propertyName)
        {
        ...
        /// <summary>
        /// Returns the ordered containment property value for the supplied <see cref="CDP4Common.DTO.DerivedQuantityKind"/>.
        /// </summary>
        /// <param name="derivedQuantityKind">
        /// The <see cref="CDP4Common.DTO.DerivedQuantityKind"/> for which to return the containment property value.
        /// </param>
        ...
        /// If the property name is not supported for the <see cref="CDP4Common.DTO.DerivedQuantityKind"/>.
        /// </exception>
        public IEnumerable<OrderedItem> GetOrderedContainmentIds(CDP4Common.DTO.Thing derivedQuantityKind, string propertyName)
        {
        ...
        /// <summary>
        /// Gets the <see cref="PropertyMetaInfo"/> for the <see cref="DerivedQuantityKind"/> class
        /// </summary>
        ...
        private readonly Dictionary<string, Func<CDP4Common.DTO.DerivedQuantityKind, object>> propertyValueMap = new Dictionary<string, Func<CDP4Common.DTO.DerivedQuantityKind, object>>
        {
            ...
            { "QuantityKindFactor", thing => thing.QuantityKindFactor },
        ...
        private readonly Dictionary<string, Func<object, object>> collectionPropertyValueDeserializationMap = new Dictionary<string, Func<object, object>>
        {
            ...
            { "QuantityKindFactor", (value) => (Guid)value },
        };

        /// <summary>
        /// The property value assignment map.
        /// </summary>
        private readonly Dictionary<string, Action<CDP4Common.DTO.DerivedQuantityKind, object>> propertyValueAssignmentMap = new Dictionary<string, Action<CDP4Common.DTO.DerivedQuantityKind, object>>
        {
            { "Actor", (derivedQuantityKind, value) => derivedQuantityKind.Actor = value == null ? (Guid?)null : (Guid)value },
            { "DefaultScale", (derivedQuantityKind, value) => derivedQuantityKind.DefaultScale = (Guid)value },
            { "Iid", (derivedQuantityKind, value) => derivedQuantityKind.Iid = (Guid)value },
            { "IsDeprecated", (derivedQuantityKind, value) => derivedQuantityKind.IsDeprecated = (bool)value },
            { "ModifiedOn", (derivedQuantityKind, value) => derivedQuantityKind.ModifiedOn = (DateTime)value },
            { "Name", (derivedQuantityKind, value) => derivedQuantityKind.Name = value.ToString() },
            { "QuantityDimensionSymbol", (derivedQuantityKind, value) => derivedQuantityKind.QuantityDimensionSymbol = value == null ? (string)null : value.ToString() },
            { "ShortName", (derivedQuantityKind, value) => derivedQuantityKind.ShortName = value.ToString() },
            { "Symbol", (derivedQuantityKind, value) => derivedQuantityKind.Symbol = value.ToString() },
            { "ThingPreference", (derivedQuantityKind, value) => derivedQuantityKind.ThingPreference = value == null ? (string)null : value.ToString() },
        };
        ...
        /// <summary>
        /// Returns the <see cref="CDP4Common.DTO.DerivedQuantityKind"/> containment property type from the supplied property name.
        /// </summary>
        /// <param name="propertyName">
        ...
        /// <summary>
        /// Returns the <see cref="CDP4Common.DTO.DerivedQuantityKind"/> property type from the supplied property name.
        /// </summary>
        /// <param name="propertyName">
        /// The property name.
        /// </param>
        ...
        /// <summary>
        /// Returns the container property for the supplied type name is a possible container for <see cref="CDP4Common.DTO.DerivedQuantityKind"/>.
        /// </summary>
        /// <param name="typeName">
        /// Name of the type for which to check if it is a container of <see cref="CDP4Common.DTO.DerivedQuantityKind"/>.
        /// </param>
        /// <param name="containerProperty">
        /// Supplied container property info instance that will be set if the supplied type name is a container of <see cref="CDP4Common.DTO.DerivedQuantityKind"/>.
        /// </param>
        /// <returns>
        /// True if the supplied typeName is a container for <see cref="CDP4Common.DTO.DerivedQuantityKind"/> and sets the container property name.
        /// </returns>
        ...
        /// <summary>
        /// Check if the supplied property name for <see cref="CDP4Common.DTO.DerivedQuantityKind"/> is scalar.
        /// </summary>
        /// <param name="propertyName">
        /// Name of the property for which to check if it is scalar.
        /// </param>
        ...
        public bool ApplyPropertyUpdate(CDP4Common.DTO.Thing updatableThing, string propertyName, object value)
        {
            ...
            this.propertyValueAssignmentMap[propertyName]((CDP4Common.DTO.DerivedQuantityKind)updatableThing, value);
        ...
        /// <summary>
        /// Instantiates a <see cref="CDP4Common.DTO.DerivedQuantityKind"/>
        /// </summary>
        /// <returns>
        ...
        {
            return new CDP4Common.DTO.DerivedQuantityKind(guid, revisionNumber);
        }
    }
}
