// --------------------------------------------------------------------------------------------------------------------
// <copyright file="DerivedUnitMetaInfo.cs" company="RHEA System S.A.">
...
namespace CDP4Common.MetaInfo
{
    ...
    /// <summary>
    /// This a class that holds meta info for <see cref="DerivedUnit"/>.
    /// </summary>
    public partial class DerivedUnitMetaInfo : IDerivedUnitMetaInfo
    {
        /// <summary>
        /// The containment property value map.
        /// </summary>
        private readonly Dictionary<string, Func<CDP4Common.DTO.DerivedUnit, IEnumerable<Guid>>> containmentPropertyValueMap = new Dictionary<string, Func<CDP4Common.DTO.DerivedUnit, IEnumerable<Guid>>>
        {
            { "Alias", derivedUnit => derivedUnit.Alias },
            { "Attachment", derivedUnit => derivedUnit.Attachment },
            { "Definition", derivedUnit => derivedUnit.Definition },
            { "HyperLink", derivedUnit => derivedUnit.HyperLink },
            { "UnitFactor", derivedUnit => derivedUnit.UnitFactor.ToIdList() },
        };

        /// <summary>
        /// The ordered containment property value map.
        /// </summary>
        private readonly Dictionary<string, Func<CDP4Common.DTO.DerivedUnit, IEnumerable<OrderedItem>>> orderedContainmentPropertyValueMap = new Dictionary<string, Func<CDP4Common.DTO.DerivedUnit, IEnumerable<OrderedItem>>>
        {
            { "UnitFactor", derivedUnit => derivedUnit.UnitFactor },
        };

        /// <summary>
        /// The validation rules that should pass for an instance of <see cref="CDP4Common.DTO.DerivedUnit"/>.
        /// </summary>
        private readonly Dictionary<string, DtoValidationHelper<CDP4Common.DTO.DerivedUnit>> validationRules = new Dictionary<string, DtoValidationHelper<CDP4Common.DTO.DerivedUnit>>
        {
            { "Alias", new DtoValidationHelper<CDP4Common.DTO.DerivedUnit>(item => item.Alias != null, "The 'Alias' property of a 'DerivedUnit' is mandatory and cannot be null.") },
            { "Attachment", new DtoValidationHelper<CDP4Common.DTO.DerivedUnit>(item => item.Attachment != null, "The 'Attachment' property of a 'DerivedUnit' is mandatory and cannot be null.") },
            { "Definition", new DtoValidationHelper<CDP4Common.DTO.DerivedUnit>(item => item.Definition != null, "The 'Definition' property of a 'DerivedUnit' is mandatory and cannot be null.") },
            { "ExcludedDomain", new DtoValidationHelper<CDP4Common.DTO.DerivedUnit>(item => item.ExcludedDomain != null, "The 'ExcludedDomain' property of a 'DerivedUnit' is mandatory and cannot be null.") },
            { "ExcludedPerson", new DtoValidationHelper<CDP4Common.DTO.DerivedUnit>(item => item.ExcludedPerson != null, "The 'ExcludedPerson' property of a 'DerivedUnit' is mandatory and cannot be null.") },
            { "HyperLink", new DtoValidationHelper<CDP4Common.DTO.DerivedUnit>(item => item.HyperLink != null, "The 'HyperLink' property of a 'DerivedUnit' is mandatory and cannot be null.") },
            { "Name", new DtoValidationHelper<CDP4Common.DTO.DerivedUnit>(item => !string.IsNullOrWhiteSpace(item.Name), "The 'Name' property of a 'DerivedUnit' is mandatory and cannot be empty or null.") },
            { "ShortName", new DtoValidationHelper<CDP4Common.DTO.DerivedUnit>(item => !string.IsNullOrWhiteSpace(item.ShortName), "The 'ShortName' property of a 'DerivedUnit' is mandatory and cannot be empty or null.") },
            { "UnitFactor", new DtoValidationHelper<CDP4Common.DTO.DerivedUnit>(item => item.UnitFactor != null && item.UnitFactor.Any(), "The 'UnitFactor' property of a 'DerivedUnit' is mandatory and must have at least one entry.") },
        };
        ...
        /// </exception>
        public void Validate(CDP4Common.DTO.Thing derivedUnit)
        {
            this.Validate(derivedUnit, x => true);
        }
        ...
        /// If any validation rule failed.
        /// </exception>
        public void Validate(CDP4Common.DTO.Thing derivedUnit, Func<string, bool> validateProperty)
        {
            foreach (var applicableRule in this.validationRules.Where(x => validateProperty(x.Key)))
            {
                applicableRule.Value.Validate((CDP4Common.DTO.DerivedUnit)derivedUnit);
            }
        }
        ...
        /// </returns>
        public bool TryValidate(CDP4Common.DTO.Thing derivedUnit)
        {
            return this.TryValidate(derivedUnit, x => true);
        }
        ...
        /// True if all validation rules have passed or if none are defined.
        /// </returns>
        public bool TryValidate(CDP4Common.DTO.Thing derivedUnit, Func<string, bool> validateProperty)
        {
            var applicableValidationRules = this.validationRules.Where(x => validateProperty(x.Key)).Select(x => x.Value);

            return applicableValidationRules.All(applicableRule => applicableRule.TryValidate((CDP4Common.DTO.DerivedUnit)derivedUnit));
        }

        /// <summary>
        /// Returns the containment property value for the supplied <see cref="CDP4Common.DTO.DerivedUnit"/>.
        /// </summary>
        /// <param name="derivedUnit">
        /// The <see cref="CDP4Common.DTO.DerivedUnit"/> for which to return the containment property value.
        /// </param>
        ...
        /// If the property name is not supported for the <see cref="CDP4Common.DTO.DerivedUnit"/>.
        /// </exception>
        public IEnumerable<Guid> GetContainmentIds(CDP4Common.DTO.Thing derivedUnit, string propertyName)
        {
            if (!this.containmentPropertyValueMap.ContainsKey(propertyName))
            {
                throw new ArgumentException($"'{propertyName}' is not a valid containment property of 'DerivedUnit'");
            }

            return this.containmentPropertyValueMap[propertyName]((CDP4Common.DTO.DerivedUnit)derivedUnit);
        }

        /// <summary>
        /// Returns the ordered containment property value for the supplied <see cref="CDP4Common.DTO.DerivedUnit"/>.
        /// </summary>
        /// <param name="derivedUnit">
        /// The <see cref="CDP4Common.DTO.DerivedUnit"/> for which to return the containment property value.
        /// </param>
        ...
        /// If the property name is not supported for the <see cref="CDP4Common.DTO.DerivedUnit"/>.
        /// </exception>
        public IEnumerable<OrderedItem> GetOrderedContainmentIds(CDP4Common.DTO.Thing derivedUnit, string propertyName)
        {
            ...
            return this.orderedContainmentPropertyValueMap[propertyName]((CDP4Common.DTO.DerivedUnit)derivedUnit);
        }
        ...
        private readonly Dictionary<string, PropertyMetaInfo> containmentTypeMap = new Dictionary<string, PropertyMetaInfo>
        {
            ...
            { "UnitFactor", new PropertyMetaInfo("UnitFactor", "UnitFactor", PropertyKind.OrderedList, AggregationKind.Composite, false, true, true, 1, "*", true) },
        };

        /// <summary>
        /// Gets the <see cref="PropertyMetaInfo"/> for the <see cref="DerivedUnit"/> class
        /// </summary>
        ...
        /// </summary>
        private readonly Dictionary<string, Func<CDP4Common.DTO.DerivedUnit, object>> propertyValueMap = new Dictionary<string, Func<CDP4Common.DTO.DerivedUnit, object>>
        {
        ...
        private readonly Dictionary<string, Func<object, object>> collectionPropertyValueDeserializationMap = new Dictionary<string, Func<object, object>>
        {
            ...
            { "UnitFactor", (value) => (Guid)value },
        };

        /// <summary>
        /// The property value assignment map.
        /// </summary>
        private readonly Dictionary<string, Action<CDP4Common.DTO.DerivedUnit, object>> propertyValueAssignmentMap = new Dictionary<string, Action<CDP4Common.DTO.DerivedUnit, object>>
        {
            { "Actor", (derivedUnit, value) => derivedUnit.Actor = value == null ? (Guid?)null : (Guid)value },
            { "Iid", (derivedUnit, value) => derivedUnit.Iid = (Guid)value },
            { "IsDeprecated", (derivedUnit, value) => derivedUnit.IsDeprecated = (bool)value },
        ...
        /// <summary>
        /// Returns the <see cref="CDP4Common.DTO.DerivedUnit"/> containment property type from the supplied property name.
        /// </summary>
        /// <param name="propertyName">
        ...
        /// <summary>
        /// Returns the <see cref="CDP4Common.DTO.DerivedUnit"/> property type from the supplied property name.
        /// </summary>
        /// <param name="propertyName">
        /// The property name.
        /// </param>
        ...
        /// <summary>
        /// Returns the container property for the supplied type name is a possible container for <see cref="CDP4Common.DTO.DerivedUnit"/>.
        /// </summary>
        /// <param name="typeName">
        /// Name of the type for which to check if it is a container of <see cref="CDP4Common.DTO.DerivedUnit"/>.
        /// </param>
        /// <param name="containerProperty">
        /// Supplied container property info instance that will be set if the supplied type name is a container of <see cref="CDP4Common.DTO.DerivedUnit"/>.
        /// </param>
        /// <returns>
        /// True if the supplied typeName is a container for <see cref="CDP4Common.DTO.DerivedUnit"/> and sets the container property name.
        /// </returns>
        ...
        /// <summary>
        /// Check if the supplied property name for <see cref="CDP4Common.DTO.DerivedUnit"/> is scalar.
        /// </summary>
        /// <param name="propertyName">
        /// Name of the property for which to check if it is scalar.
        /// </param>
        ...
        public bool ApplyPropertyUpdate(CDP4Common.DTO.Thing updatableThing, string propertyName, object value)
        {
            ...
            this.propertyValueAssignmentMap[propertyName]((CDP4Common.DTO.DerivedUnit)updatableThing, value);
        ...
        public object DeserializeCollectionValue(string propertyName, object value)
        {
            ...
            {
                throw new ArgumentException($"'{propertyName}' is not a valid collection property of 'DerivedUnit'");
            }
        ...
        public object GetValue(string propertyName, CDP4Common.DTO.Thing thing)
        {
            ...
            return this.propertyValueMap[propertyName]((CDP4Common.DTO.DerivedUnit)thing);
        }
        ...
        /// <summary>
        /// Instantiates a <see cref="CDP4Common.DTO.DerivedUnit"/>
        /// </summary>
        /// <returns>
        ...
        {
            return new CDP4Common.DTO.DerivedUnit(guid, revisionNumber);
        }
    }
}
