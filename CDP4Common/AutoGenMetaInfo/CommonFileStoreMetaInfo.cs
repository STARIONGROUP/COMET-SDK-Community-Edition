...
namespace CDP4Common.MetaInfo
{
    ...
    public partial class CommonFileStoreMetaInfo : ICommonFileStoreMetaInfo
    {
        ...
        public IEnumerable<Guid> GetContainmentIds(CDP4Common.DTO.Thing commonFileStore, string propertyName)
        {
            ...
            {
                throw new ArgumentException(string.Format("'{0}' is not a valid containment property of 'CommonFileStore'", propertyName));
            }
        ...
        public object DeserializeCollectionValue(string propertyName, object value)
        {
            ...
            {
                throw new ArgumentException(string.Format("'{0}' is not a valid collection property of 'CommonFileStore'", propertyName));
            }
