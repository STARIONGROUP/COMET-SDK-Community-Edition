...
namespace CDP4Common.MetaInfo
{
    ...
    public partial class CommonFileStoreMetaInfo : ICommonFileStoreMetaInfo
    {
        ...
        {
            { "File", new PropertyMetaInfo("File", "Guid", PropertyKind.List, AggregationKind.Composite, false, false, true, 0, "*", true) },
            { "Folder", new PropertyMetaInfo("Folder", "Guid", PropertyKind.List, AggregationKind.Composite, false, false, true, 0, "*", true) },
        };
        ...
        {
            { "EngineeringModel", new PropertyMetaInfo("CommonFileStore", "Guid", PropertyKind.List, AggregationKind.Composite, false, false, true, 0, "1", true) },
        };
