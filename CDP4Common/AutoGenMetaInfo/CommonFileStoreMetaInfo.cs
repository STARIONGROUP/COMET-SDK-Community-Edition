// --------------------------------------------------------------------------------------------------------------------
// <copyright file="CommonFileStoreMetaInfo.cs" company="Starion Group S.A.">
...
namespace CDP4Common.MetaInfo
{
    ...
    /// <summary>
    /// This a class that holds meta info for <see cref="CommonFileStore"/>.
    /// </summary>
    public partial class CommonFileStoreMetaInfo : ICommonFileStoreMetaInfo
    {
        /// <summary>
        /// The containment property value map.
        /// </summary>
        private readonly Dictionary<string, Func<CDP4Common.DTO.CommonFileStore, IEnumerable<Guid>>> containmentPropertyValueMap = new Dictionary<string, Func<CDP4Common.DTO.CommonFileStore, IEnumerable<Guid>>>
        {
            { "File", commonFileStore => commonFileStore.File },
            { "Folder", commonFileStore => commonFileStore.Folder },
        };

        /// <summary>
        /// The ordered containment property value map.
        /// </summary>
        private readonly Dictionary<string, Func<CDP4Common.DTO.CommonFileStore, IEnumerable<OrderedItem>>> orderedContainmentPropertyValueMap = new Dictionary<string, Func<CDP4Common.DTO.CommonFileStore, IEnumerable<OrderedItem>>>();

        /// <summary>
        /// The validation rules that should pass for an instance of <see cref="CDP4Common.DTO.CommonFileStore"/>.
        /// </summary>
        private readonly Dictionary<string, DtoValidationHelper<CDP4Common.DTO.CommonFileStore>> validationRules = new Dictionary<string, DtoValidationHelper<CDP4Common.DTO.CommonFileStore>>
        {
            { "ExcludedDomain", new DtoValidationHelper<CDP4Common.DTO.CommonFileStore>(item => item.ExcludedDomain != null, "The 'ExcludedDomain' property of a 'CommonFileStore' is mandatory and cannot be null.") },
            { "ExcludedPerson", new DtoValidationHelper<CDP4Common.DTO.CommonFileStore>(item => item.ExcludedPerson != null, "The 'ExcludedPerson' property of a 'CommonFileStore' is mandatory and cannot be null.") },
            { "File", new DtoValidationHelper<CDP4Common.DTO.CommonFileStore>(item => item.File != null, "The 'File' property of a 'CommonFileStore' is mandatory and cannot be null.") },
            { "Folder", new DtoValidationHelper<CDP4Common.DTO.CommonFileStore>(item => item.Folder != null, "The 'Folder' property of a 'CommonFileStore' is mandatory and cannot be null.") },
            { "Name", new DtoValidationHelper<CDP4Common.DTO.CommonFileStore>(item => !string.IsNullOrWhiteSpace(item.Name), "The 'Name' property of a 'CommonFileStore' is mandatory and cannot be empty or null.") },
        };
        ...
        /// </exception>
        public void Validate(CDP4Common.DTO.Thing commonFileStore)
        {
            this.Validate(commonFileStore, x => true);
        }
        ...
        /// If any validation rule failed.
        /// </exception>
        public void Validate(CDP4Common.DTO.Thing commonFileStore, Func<string, bool> validateProperty)
        {
            foreach (var applicableRule in this.validationRules.Where(x => validateProperty(x.Key)))
            {
                applicableRule.Value.Validate((CDP4Common.DTO.CommonFileStore)commonFileStore);
            }
        }
        ...
        /// </returns>
        public bool TryValidate(CDP4Common.DTO.Thing commonFileStore)
        {
            return this.TryValidate(commonFileStore, x => true);
        }
        ...
        /// True if all validation rules have passed or if none are defined.
        /// </returns>
        public bool TryValidate(CDP4Common.DTO.Thing commonFileStore, Func<string, bool> validateProperty)
        {
            var applicableValidationRules = this.validationRules.Where(x => validateProperty(x.Key)).Select(x => x.Value);

            return applicableValidationRules.All(applicableRule => applicableRule.TryValidate((CDP4Common.DTO.CommonFileStore)commonFileStore));
        }

        /// <summary>
        /// Returns the containment property value for the supplied <see cref="CDP4Common.DTO.CommonFileStore"/>.
        /// </summary>
        /// <param name="commonFileStore">
        /// The <see cref="CDP4Common.DTO.CommonFileStore"/> for which to return the containment property value.
        /// </param>
        ...
        /// If the property name is not supported for the <see cref="CDP4Common.DTO.CommonFileStore"/>.
        /// </exception>
        public IEnumerable<Guid> GetContainmentIds(CDP4Common.DTO.Thing commonFileStore, string propertyName)
        {
            if (!this.containmentPropertyValueMap.ContainsKey(propertyName))
            {
                throw new ArgumentException($"'{propertyName}' is not a valid containment property of 'CommonFileStore'");
            }

            return this.containmentPropertyValueMap[propertyName]((CDP4Common.DTO.CommonFileStore)commonFileStore);
        }

        /// <summary>
        /// Returns the ordered containment property value for the supplied <see cref="CDP4Common.DTO.CommonFileStore"/>.
        /// </summary>
        /// <param name="commonFileStore">
        /// The <see cref="CDP4Common.DTO.CommonFileStore"/> for which to return the containment property value.
        /// </param>
        ...
        /// If the property name is not supported for the <see cref="CDP4Common.DTO.CommonFileStore"/>.
        /// </exception>
        public IEnumerable<OrderedItem> GetOrderedContainmentIds(CDP4Common.DTO.Thing commonFileStore, string propertyName)
        {
            ...
            return this.orderedContainmentPropertyValueMap[propertyName]((CDP4Common.DTO.CommonFileStore)commonFileStore);
        }
        ...
        {
            { "File", new PropertyMetaInfo("File", "File", PropertyKind.List, AggregationKind.Composite, false, false, true, 0, "*", true) },
            { "Folder", new PropertyMetaInfo("Folder", "Folder", PropertyKind.List, AggregationKind.Composite, false, false, true, 0, "*", true) },
        };

        /// <summary>
        /// Gets the <see cref="PropertyMetaInfo"/> for the <see cref="CommonFileStore"/> class
        /// </summary>
        ...
        /// </summary>
        private readonly Dictionary<string, Func<CDP4Common.DTO.CommonFileStore, object>> propertyValueMap = new Dictionary<string, Func<CDP4Common.DTO.CommonFileStore, object>>
        {
        ...
        private readonly Dictionary<string, Func<object, object>> collectionPropertyValueDeserializationMap = new Dictionary<string, Func<object, object>>
        {
            ...
            { "File", (value) => (Guid)value },
            { "Folder", (value) => (Guid)value },
        };

        /// <summary>
        /// The property value assignment map.
        /// </summary>
        private readonly Dictionary<string, Action<CDP4Common.DTO.CommonFileStore, object>> propertyValueAssignmentMap = new Dictionary<string, Action<CDP4Common.DTO.CommonFileStore, object>>
        {
            { "Actor", (commonFileStore, value) => commonFileStore.Actor = value == null ? (Guid?)null : (Guid)value },
            { "CreatedOn", (commonFileStore, value) => commonFileStore.CreatedOn = (DateTime)value },
            { "Iid", (commonFileStore, value) => commonFileStore.Iid = (Guid)value },
        ...
        {
            { "EngineeringModel", new PropertyMetaInfo("CommonFileStore", "CommonFileStore", PropertyKind.List, AggregationKind.Composite, false, false, true, 0, "1", true) },
        };
        ...
        /// <summary>
        /// Returns the <see cref="CDP4Common.DTO.CommonFileStore"/> containment property type from the supplied property name.
        /// </summary>
        /// <param name="propertyName">
        ...
        /// <summary>
        /// Returns the <see cref="CDP4Common.DTO.CommonFileStore"/> property type from the supplied property name.
        /// </summary>
        /// <param name="propertyName">
        /// The property name.
        /// </param>
        ...
        /// <summary>
        /// Returns the container property for the supplied type name is a possible container for <see cref="CDP4Common.DTO.CommonFileStore"/>.
        /// </summary>
        /// <param name="typeName">
        /// Name of the type for which to check if it is a container of <see cref="CDP4Common.DTO.CommonFileStore"/>.
        /// </param>
        /// <param name="containerProperty">
        /// Supplied container property info instance that will be set if the supplied type name is a container of <see cref="CDP4Common.DTO.CommonFileStore"/>.
        /// </param>
        /// <returns>
        /// True if the supplied typeName is a container for <see cref="CDP4Common.DTO.CommonFileStore"/> and sets the container property name.
        /// </returns>
        ...
        /// <summary>
        /// Check if the supplied property name for <see cref="CDP4Common.DTO.CommonFileStore"/> is scalar.
        /// </summary>
        /// <param name="propertyName">
        /// Name of the property for which to check if it is scalar.
        /// </param>
        ...
        public bool ApplyPropertyUpdate(CDP4Common.DTO.Thing updatableThing, string propertyName, object value)
        {
            ...
            this.propertyValueAssignmentMap[propertyName]((CDP4Common.DTO.CommonFileStore)updatableThing, value);
        ...
        public object DeserializeCollectionValue(string propertyName, object value)
        {
            ...
            {
                throw new ArgumentException($"'{propertyName}' is not a valid collection property of 'CommonFileStore'");
            }
        ...
        public object GetValue(string propertyName, CDP4Common.DTO.Thing thing)
        {
            ...
            return this.propertyValueMap[propertyName]((CDP4Common.DTO.CommonFileStore)thing);
        }
        ...
        /// <summary>
        /// Instantiates a <see cref="CDP4Common.DTO.CommonFileStore"/>
        /// </summary>
        /// <returns>
        ...
        {
            return new CDP4Common.DTO.CommonFileStore(guid, revisionNumber);
        }
    }
}
