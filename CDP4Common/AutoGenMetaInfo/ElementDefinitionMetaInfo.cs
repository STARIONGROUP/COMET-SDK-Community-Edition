...
namespace CDP4Common.MetaInfo
{
    ...
    public partial class ElementDefinitionMetaInfo : IElementDefinitionMetaInfo
    {
        ...
        private readonly Dictionary<string, PropertyMetaInfo> containmentTypeMap = new Dictionary<string, PropertyMetaInfo>
        {
            ...
            { "ContainedElement", new PropertyMetaInfo("ContainedElement", "Guid", PropertyKind.List, AggregationKind.Composite, false, false, true, 0, "*", true) },
            ...
            { "Parameter", new PropertyMetaInfo("Parameter", "Guid", PropertyKind.List, AggregationKind.Composite, false, false, true, 0, "*", true) },
            { "ParameterGroup", new PropertyMetaInfo("ParameterGroup", "Guid", PropertyKind.List, AggregationKind.Composite, false, false, true, 0, "*", true) },
        };
        ...
        private readonly Dictionary<string, PropertyMetaInfo> propertyTypeMap = new Dictionary<string, PropertyMetaInfo>
        {
            ...
            { "ReferencedElement", new PropertyMetaInfo("ReferencedElement", "Guid", PropertyKind.List, AggregationKind.None, false, false, true, 0, "*", true) },
        ...
        {
            { "Iteration", new PropertyMetaInfo("Element", "Guid", PropertyKind.List, AggregationKind.Composite, false, false, true, 0, "*", true) },
        };
