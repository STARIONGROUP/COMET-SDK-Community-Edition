// --------------------------------------------------------------------------------------------------------------------
// <copyright file="ElementDefinitionMetaInfo.cs" company="Starion Group S.A.">
...
namespace CDP4Common.MetaInfo
{
    ...
    public partial class ElementDefinitionMetaInfo : IElementDefinitionMetaInfo
    {
        ...
        public IEnumerable<Guid> GetContainmentIds(CDP4Common.DTO.Thing elementDefinition, string propertyName)
        {
            ...
            {
                throw new ArgumentException($"'{propertyName}' is not a valid containment property of 'ElementDefinition'");
            }
        ...
        {
            { "Actor", (elementDefinition, value) => elementDefinition.Actor = value == null ? (Guid?)null : (Guid)value },
        ...
        public object DeserializeCollectionValue(string propertyName, object value)
        {
            ...
            {
                throw new ArgumentException($"'{propertyName}' is not a valid collection property of 'ElementDefinition'");
            }
