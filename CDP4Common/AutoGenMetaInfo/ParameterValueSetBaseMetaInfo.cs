// --------------------------------------------------------------------------------------------------------------------
// <copyright file="ParameterValueSetBaseMetaInfo.cs" company="Starion Group S.A.">
...
namespace CDP4Common.MetaInfo
{
    ...
    public partial class ParameterValueSetBaseMetaInfo : IParameterValueSetBaseMetaInfo
    {
        ...
        public IEnumerable<Guid> GetContainmentIds(CDP4Common.DTO.Thing parameterValueSetBase, string propertyName)
        {
            ...
            {
                throw new ArgumentException($"'{propertyName}' is not a valid containment property of 'ParameterValueSetBase'");
            }
        ...
        {
            { "Actor", (parameterValueSetBase, value) => parameterValueSetBase.Actor = value == null ? (Guid?)null : (Guid)value },
            ...
            { "ThingPreference", (parameterValueSetBase, value) => parameterValueSetBase.ThingPreference = value == null ? (string)null : value.ToString() },
        ...
        public object DeserializeCollectionValue(string propertyName, object value)
        {
            ...
            {
                throw new ArgumentException($"'{propertyName}' is not a valid collection property of 'ParameterValueSetBase'");
            }
