...
namespace CDP4Common.MetaInfo
{
    ...
    public partial class ExclusiveOrExpressionMetaInfo : IExclusiveOrExpressionMetaInfo
    {
        ...
        private readonly Dictionary<string, PropertyMetaInfo> propertyTypeMap = new Dictionary<string, PropertyMetaInfo>
        {
            ...
            { "Term", new PropertyMetaInfo("Term", "Guid", PropertyKind.List, AggregationKind.None, false, false, true, 2, "2", true) },
        };
        ...
        {
            { "ParametricConstraint", new PropertyMetaInfo("Expression", "Guid", PropertyKind.List, AggregationKind.Composite, false, false, true, 1, "*", true) },
        };
