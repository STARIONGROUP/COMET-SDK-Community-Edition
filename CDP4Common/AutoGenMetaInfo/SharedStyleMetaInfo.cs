// --------------------------------------------------------------------------------------------------------------------
// <copyright file="SharedStyleMetaInfo.cs" company="RHEA System S.A.">
...
namespace CDP4Common.MetaInfo
{
    ...
    /// </summary>
    public partial class SharedStyleMetaInfo : ISharedStyleMetaInfo
    {
        /// <summary>
        /// The containment property value map.
        /// </summary>
        private readonly Dictionary<string, Func<CDP4Common.DTO.SharedStyle, IEnumerable<Guid>>> containmentPropertyValueMap = new Dictionary<string, Func<CDP4Common.DTO.SharedStyle, IEnumerable<Guid>>>
        {
            { "UsedColor", sharedStyle => sharedStyle.UsedColor },
        };

        /// <summary>
        /// The ordered containment property value map.
        /// </summary>
        private readonly Dictionary<string, Func<CDP4Common.DTO.SharedStyle, IEnumerable<OrderedItem>>> orderedContainmentPropertyValueMap = new Dictionary<string, Func<CDP4Common.DTO.SharedStyle, IEnumerable<OrderedItem>>>();

        /// <summary>
        /// The validation rules that should pass for an instance of <see cref="CDP4Common.DTO.SharedStyle"/>.
        /// </summary>
        private readonly Dictionary<string, DtoValidationHelper<CDP4Common.DTO.SharedStyle>> validationRules = new Dictionary<string, DtoValidationHelper<CDP4Common.DTO.SharedStyle>>
        {
            { "ExcludedDomain", new DtoValidationHelper<CDP4Common.DTO.SharedStyle>(item => item.ExcludedDomain != null, "The 'ExcludedDomain' property of a 'SharedStyle' is mandatory and cannot be null.") },
            { "ExcludedPerson", new DtoValidationHelper<CDP4Common.DTO.SharedStyle>(item => item.ExcludedPerson != null, "The 'ExcludedPerson' property of a 'SharedStyle' is mandatory and cannot be null.") },
            { "Name", new DtoValidationHelper<CDP4Common.DTO.SharedStyle>(item => !string.IsNullOrWhiteSpace(item.Name), "The 'Name' property of a 'SharedStyle' is mandatory and cannot be empty or null.") },
            { "UsedColor", new DtoValidationHelper<CDP4Common.DTO.SharedStyle>(item => item.UsedColor != null, "The 'UsedColor' property of a 'SharedStyle' is mandatory and cannot be null.") },
        };
        ...
        /// </exception>
        public void Validate(CDP4Common.DTO.Thing sharedStyle)
        {
            this.Validate(sharedStyle, x => true);
        }
        ...
        /// If any validation rule failed.
        /// </exception>
        public void Validate(CDP4Common.DTO.Thing sharedStyle, Func<string, bool> validateProperty)
        {
            foreach (var applicableRule in this.validationRules.Where(x => validateProperty(x.Key)))
            {
                applicableRule.Value.Validate((CDP4Common.DTO.SharedStyle)sharedStyle);
            }
        }
        ...
        /// </returns>
        public bool TryValidate(CDP4Common.DTO.Thing sharedStyle)
        {
            return this.TryValidate(sharedStyle, x => true);
        }
        ...
        /// True if all validation rules have passed or if none are defined.
        /// </returns>
        public bool TryValidate(CDP4Common.DTO.Thing sharedStyle, Func<string, bool> validateProperty)
        {
            var applicableValidationRules = this.validationRules.Where(x => validateProperty(x.Key)).Select(x => x.Value);

            return applicableValidationRules.All(applicableRule => applicableRule.TryValidate((CDP4Common.DTO.SharedStyle)sharedStyle));
        }

        /// <summary>
        /// Returns the containment property value for the supplied <see cref="CDP4Common.DTO.SharedStyle"/>.
        /// </summary>
        /// <param name="sharedStyle">
        /// The <see cref="CDP4Common.DTO.SharedStyle"/> for which to return the containment property value.
        /// </param>
        ...
        /// If the property name is not supported for the <see cref="CDP4Common.DTO.SharedStyle"/>.
        /// </exception>
        public IEnumerable<Guid> GetContainmentIds(CDP4Common.DTO.Thing sharedStyle, string propertyName)
        {
            if (!this.containmentPropertyValueMap.ContainsKey(propertyName))
            {
                throw new ArgumentException(string.Format("'{0}' is not a valid containment property of 'SharedStyle'", propertyName));
            }

            return this.containmentPropertyValueMap[propertyName]((CDP4Common.DTO.SharedStyle)sharedStyle);
        }

        /// <summary>
        /// Returns the ordered containment property value for the supplied <see cref="CDP4Common.DTO.SharedStyle"/>.
        /// </summary>
        /// <param name="sharedStyle">
        /// The <see cref="CDP4Common.DTO.SharedStyle"/> for which to return the containment property value.
        /// </param>
        ...
        /// If the property name is not supported for the <see cref="CDP4Common.DTO.SharedStyle"/>.
        /// </exception>
        public IEnumerable<OrderedItem> GetOrderedContainmentIds(CDP4Common.DTO.Thing sharedStyle, string propertyName)
        {
            ...
            return this.orderedContainmentPropertyValueMap[propertyName]((CDP4Common.DTO.SharedStyle)sharedStyle);
        }
        ...
        /// <summary>
        /// Gets the <see cref="PropertyMetaInfo"/> for the <see cref="SharedStyle"/> class
        /// </summary>
        ...
        private readonly Dictionary<string, Action<CDP4Common.DTO.SharedStyle, object>> propertyValueAssignmentMap = new Dictionary<string, Action<CDP4Common.DTO.SharedStyle, object>>
        {
            ...
            { "FontColor", (sharedStyle, value) => sharedStyle.FontColor = value == null ? (Guid?)null : (Guid)value },
            { "FontItalic", (sharedStyle, value) => sharedStyle.FontItalic = value == null ? (bool?)null : (bool)value },
            { "FontName", (sharedStyle, value) => sharedStyle.FontName = value == null ? (string)null : value.ToString() },
            { "FontSize", (sharedStyle, value) => sharedStyle.FontSize = value == null ? (float?)null : (float)value },
            { "FontStrokeThrough", (sharedStyle, value) => sharedStyle.FontStrokeThrough = value == null ? (bool?)null : (bool)value },
            { "FontUnderline", (sharedStyle, value) => sharedStyle.FontUnderline = value == null ? (bool?)null : (bool)value },
            { "Iid", (sharedStyle, value) => sharedStyle.Iid = (Guid)value },
            { "ModifiedOn", (sharedStyle, value) => sharedStyle.ModifiedOn = (DateTime)value },
            { "Name", (sharedStyle, value) => sharedStyle.Name = value.ToString() },
            { "StrokeColor", (sharedStyle, value) => sharedStyle.StrokeColor = value == null ? (Guid?)null : (Guid)value },
            { "StrokeOpacity", (sharedStyle, value) => sharedStyle.StrokeOpacity = value == null ? (float?)null : (float)value },
            { "StrokeWidth", (sharedStyle, value) => sharedStyle.StrokeWidth = value == null ? (float?)null : (float)value },
            { "ThingPreference", (sharedStyle, value) => sharedStyle.ThingPreference = value == null ? (string)null : value.ToString() },
        };
        ...
        /// <summary>
        /// Returns the <see cref="CDP4Common.DTO.SharedStyle"/> containment property type from the supplied property name.
        /// </summary>
        /// <param name="propertyName">
        ...
        /// <summary>
        /// Returns the <see cref="CDP4Common.DTO.SharedStyle"/> property type from the supplied property name.
        /// </summary>
        /// <param name="propertyName">
        /// The property name.
        /// </param>
        ...
        /// <summary>
        /// Returns the container property for the supplied type name is a possible container for <see cref="CDP4Common.DTO.SharedStyle"/>.
        /// </summary>
        /// <param name="typeName">
        /// Name of the type for which to check if it is a container of <see cref="CDP4Common.DTO.SharedStyle"/>.
        /// </param>
        /// <param name="containerProperty">
        /// Supplied container property info instance that will be set if the supplied type name is a container of <see cref="CDP4Common.DTO.SharedStyle"/>.
        /// </param>
        /// <returns>
        /// True if the supplied typeName is a container for <see cref="CDP4Common.DTO.SharedStyle"/> and sets the container property name.
        /// </returns>
        ...
        /// <summary>
        /// Check if the supplied property name for <see cref="CDP4Common.DTO.SharedStyle"/> is scalar.
        /// </summary>
        /// <param name="propertyName">
        /// Name of the property for which to check if it is scalar.
        /// </param>
        ...
        public bool ApplyPropertyUpdate(CDP4Common.DTO.Thing updatableThing, string propertyName, object value)
        {
            ...
            this.propertyValueAssignmentMap[propertyName]((CDP4Common.DTO.SharedStyle)updatableThing, value);
        ...
        public object DeserializeCollectionValue(string propertyName, object value)
        {
            ...
            {
                throw new ArgumentException(string.Format("'{0}' is not a valid collection property of 'SharedStyle'", propertyName));
            }
        ...
        public object GetValue(string propertyName, CDP4Common.DTO.Thing thing)
        {
            ...
            return this.propertyValueMap[propertyName]((CDP4Common.DTO.SharedStyle)thing);
        }
        ...
        /// <summary>
        /// Instantiates a <see cref="CDP4Common.DTO.SharedStyle"/>
        /// </summary>
        /// <returns>
        ...
        {
            return new CDP4Common.DTO.SharedStyle(guid, revisionNumber);
        }
    }
}
