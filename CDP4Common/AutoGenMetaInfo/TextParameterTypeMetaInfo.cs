...
namespace CDP4Common.MetaInfo
{
    ...
    public partial class TextParameterTypeMetaInfo : ITextParameterTypeMetaInfo
    {
        ...
        public IEnumerable<Guid> GetContainmentIds(CDP4Common.DTO.Thing textParameterType, string propertyName)
        {
            ...
            {
                throw new ArgumentException(string.Format("'{0}' is not a valid containment property of 'TextParameterType'", propertyName));
            }
        ...
        public object DeserializeCollectionValue(string propertyName, object value)
        {
            ...
            {
                throw new ArgumentException(string.Format("'{0}' is not a valid collection property of 'TextParameterType'", propertyName));
            }
