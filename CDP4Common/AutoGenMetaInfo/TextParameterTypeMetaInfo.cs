// --------------------------------------------------------------------------------------------------------------------
// <copyright file="TextParameterTypeMetaInfo.cs" company="RHEA System S.A.">
...
namespace CDP4Common.MetaInfo
{
    ...
    /// <summary>
    /// This a class that holds meta info for <see cref="TextParameterType"/>.
    /// </summary>
    public partial class TextParameterTypeMetaInfo : ITextParameterTypeMetaInfo
    {
        /// <summary>
        /// The containment property value map.
        /// </summary>
        private readonly Dictionary<string, Func<CDP4Common.DTO.TextParameterType, IEnumerable<Guid>>> containmentPropertyValueMap = new Dictionary<string, Func<CDP4Common.DTO.TextParameterType, IEnumerable<Guid>>>
        {
            { "Alias", textParameterType => textParameterType.Alias },
            { "Attachment", textParameterType => textParameterType.Attachment },
            { "Definition", textParameterType => textParameterType.Definition },
            { "HyperLink", textParameterType => textParameterType.HyperLink },
        };

        /// <summary>
        /// The ordered containment property value map.
        /// </summary>
        private readonly Dictionary<string, Func<CDP4Common.DTO.TextParameterType, IEnumerable<OrderedItem>>> orderedContainmentPropertyValueMap = new Dictionary<string, Func<CDP4Common.DTO.TextParameterType, IEnumerable<OrderedItem>>>();

        /// <summary>
        /// The validation rules that should pass for an instance of <see cref="CDP4Common.DTO.TextParameterType"/>.
        /// </summary>
        private readonly Dictionary<string, DtoValidationHelper<CDP4Common.DTO.TextParameterType>> validationRules = new Dictionary<string, DtoValidationHelper<CDP4Common.DTO.TextParameterType>>
        {
            { "Alias", new DtoValidationHelper<CDP4Common.DTO.TextParameterType>(item => item.Alias != null, "The 'Alias' property of a 'TextParameterType' is mandatory and cannot be null.") },
            { "Attachment", new DtoValidationHelper<CDP4Common.DTO.TextParameterType>(item => item.Attachment != null, "The 'Attachment' property of a 'TextParameterType' is mandatory and cannot be null.") },
            { "Category", new DtoValidationHelper<CDP4Common.DTO.TextParameterType>(item => item.Category != null, "The 'Category' property of a 'TextParameterType' is mandatory and cannot be null.") },
            { "Definition", new DtoValidationHelper<CDP4Common.DTO.TextParameterType>(item => item.Definition != null, "The 'Definition' property of a 'TextParameterType' is mandatory and cannot be null.") },
            { "ExcludedDomain", new DtoValidationHelper<CDP4Common.DTO.TextParameterType>(item => item.ExcludedDomain != null, "The 'ExcludedDomain' property of a 'TextParameterType' is mandatory and cannot be null.") },
            { "ExcludedPerson", new DtoValidationHelper<CDP4Common.DTO.TextParameterType>(item => item.ExcludedPerson != null, "The 'ExcludedPerson' property of a 'TextParameterType' is mandatory and cannot be null.") },
            { "HyperLink", new DtoValidationHelper<CDP4Common.DTO.TextParameterType>(item => item.HyperLink != null, "The 'HyperLink' property of a 'TextParameterType' is mandatory and cannot be null.") },
            { "Name", new DtoValidationHelper<CDP4Common.DTO.TextParameterType>(item => !string.IsNullOrWhiteSpace(item.Name), "The 'Name' property of a 'TextParameterType' is mandatory and cannot be empty or null.") },
            { "ShortName", new DtoValidationHelper<CDP4Common.DTO.TextParameterType>(item => !string.IsNullOrWhiteSpace(item.ShortName), "The 'ShortName' property of a 'TextParameterType' is mandatory and cannot be empty or null.") },
            { "Symbol", new DtoValidationHelper<CDP4Common.DTO.TextParameterType>(item => !string.IsNullOrWhiteSpace(item.Symbol), "The 'Symbol' property of a 'TextParameterType' is mandatory and cannot be empty or null.") },
        };
        ...
        /// </exception>
        public void Validate(CDP4Common.DTO.Thing textParameterType)
        {
            this.Validate(textParameterType, x => true);
        }
        ...
        /// If any validation rule failed.
        /// </exception>
        public void Validate(CDP4Common.DTO.Thing textParameterType, Func<string, bool> validateProperty)
        {
            foreach (var applicableRule in this.validationRules.Where(x => validateProperty(x.Key)))
            {
                applicableRule.Value.Validate((CDP4Common.DTO.TextParameterType)textParameterType);
            }
        }
        ...
        /// </returns>
        public bool TryValidate(CDP4Common.DTO.Thing textParameterType)
        {
            return this.TryValidate(textParameterType, x => true);
        }
        ...
        /// True if all validation rules have passed or if none are defined.
        /// </returns>
        public bool TryValidate(CDP4Common.DTO.Thing textParameterType, Func<string, bool> validateProperty)
        {
            var applicableValidationRules = this.validationRules.Where(x => validateProperty(x.Key)).Select(x => x.Value);

            return applicableValidationRules.All(applicableRule => applicableRule.TryValidate((CDP4Common.DTO.TextParameterType)textParameterType));
        }

        /// <summary>
        /// Returns the containment property value for the supplied <see cref="CDP4Common.DTO.TextParameterType"/>.
        /// </summary>
        /// <param name="textParameterType">
        /// The <see cref="CDP4Common.DTO.TextParameterType"/> for which to return the containment property value.
        /// </param>
        ...
        /// If the property name is not supported for the <see cref="CDP4Common.DTO.TextParameterType"/>.
        /// </exception>
        public IEnumerable<Guid> GetContainmentIds(CDP4Common.DTO.Thing textParameterType, string propertyName)
        {
            if (!this.containmentPropertyValueMap.ContainsKey(propertyName))
            {
                throw new ArgumentException($"'{propertyName}' is not a valid containment property of 'TextParameterType'");
            }

            return this.containmentPropertyValueMap[propertyName]((CDP4Common.DTO.TextParameterType)textParameterType);
        }

        /// <summary>
        /// Returns the ordered containment property value for the supplied <see cref="CDP4Common.DTO.TextParameterType"/>.
        /// </summary>
        /// <param name="textParameterType">
        /// The <see cref="CDP4Common.DTO.TextParameterType"/> for which to return the containment property value.
        /// </param>
        ...
        /// If the property name is not supported for the <see cref="CDP4Common.DTO.TextParameterType"/>.
        /// </exception>
        public IEnumerable<OrderedItem> GetOrderedContainmentIds(CDP4Common.DTO.Thing textParameterType, string propertyName)
        {
            ...
            return this.orderedContainmentPropertyValueMap[propertyName]((CDP4Common.DTO.TextParameterType)textParameterType);
        }
        ...
        /// <summary>
        /// Gets the <see cref="PropertyMetaInfo"/> for the <see cref="TextParameterType"/> class
        /// </summary>
        ...
        /// </summary>
        private readonly Dictionary<string, Func<CDP4Common.DTO.TextParameterType, object>> propertyValueMap = new Dictionary<string, Func<CDP4Common.DTO.TextParameterType, object>>
        {
        ...
        /// </summary>
        private readonly Dictionary<string, Action<CDP4Common.DTO.TextParameterType, object>> propertyValueAssignmentMap = new Dictionary<string, Action<CDP4Common.DTO.TextParameterType, object>>
        {
            { "Actor", (textParameterType, value) => textParameterType.Actor = value == null ? (Guid?)null : (Guid)value },
            { "Iid", (textParameterType, value) => textParameterType.Iid = (Guid)value },
            { "IsDeprecated", (textParameterType, value) => textParameterType.IsDeprecated = (bool)value },
            { "ModifiedOn", (textParameterType, value) => textParameterType.ModifiedOn = (DateTime)value },
        ...
        /// <summary>
        /// Returns the <see cref="CDP4Common.DTO.TextParameterType"/> containment property type from the supplied property name.
        /// </summary>
        /// <param name="propertyName">
        ...
        /// <summary>
        /// Returns the <see cref="CDP4Common.DTO.TextParameterType"/> property type from the supplied property name.
        /// </summary>
        /// <param name="propertyName">
        /// The property name.
        /// </param>
        ...
        /// <summary>
        /// Returns the container property for the supplied type name is a possible container for <see cref="CDP4Common.DTO.TextParameterType"/>.
        /// </summary>
        /// <param name="typeName">
        /// Name of the type for which to check if it is a container of <see cref="CDP4Common.DTO.TextParameterType"/>.
        /// </param>
        /// <param name="containerProperty">
        /// Supplied container property info instance that will be set if the supplied type name is a container of <see cref="CDP4Common.DTO.TextParameterType"/>.
        /// </param>
        /// <returns>
        /// True if the supplied typeName is a container for <see cref="CDP4Common.DTO.TextParameterType"/> and sets the container property name.
        /// </returns>
        ...
        /// <summary>
        /// Check if the supplied property name for <see cref="CDP4Common.DTO.TextParameterType"/> is scalar.
        /// </summary>
        /// <param name="propertyName">
        /// Name of the property for which to check if it is scalar.
        /// </param>
        ...
        public bool ApplyPropertyUpdate(CDP4Common.DTO.Thing updatableThing, string propertyName, object value)
        {
            ...
            this.propertyValueAssignmentMap[propertyName]((CDP4Common.DTO.TextParameterType)updatableThing, value);
        ...
        public object DeserializeCollectionValue(string propertyName, object value)
        {
            ...
            {
                throw new ArgumentException($"'{propertyName}' is not a valid collection property of 'TextParameterType'");
            }
        ...
        public object GetValue(string propertyName, CDP4Common.DTO.Thing thing)
        {
            ...
            return this.propertyValueMap[propertyName]((CDP4Common.DTO.TextParameterType)thing);
        }
        ...
        /// <summary>
        /// Instantiates a <see cref="CDP4Common.DTO.TextParameterType"/>
        /// </summary>
        /// <returns>
        ...
        {
            return new CDP4Common.DTO.TextParameterType(guid, revisionNumber);
        }
    }
}
