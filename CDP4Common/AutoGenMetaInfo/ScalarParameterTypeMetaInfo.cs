// --------------------------------------------------------------------------------------------------------------------
// <copyright file="ScalarParameterTypeMetaInfo.cs" company="RHEA System S.A.">
...
namespace CDP4Common.MetaInfo
{
    ...
    /// <summary>
    /// This a class that holds meta info for <see cref="ScalarParameterType"/>.
    /// </summary>
    public partial class ScalarParameterTypeMetaInfo : IScalarParameterTypeMetaInfo
    {
        /// <summary>
        /// The containment property value map.
        /// </summary>
        private readonly Dictionary<string, Func<CDP4Common.DTO.ScalarParameterType, IEnumerable<Guid>>> containmentPropertyValueMap = new Dictionary<string, Func<CDP4Common.DTO.ScalarParameterType, IEnumerable<Guid>>>
        {
            { "Alias", scalarParameterType => scalarParameterType.Alias },
            { "Attachment", scalarParameterType => scalarParameterType.Attachment },
            { "Definition", scalarParameterType => scalarParameterType.Definition },
            { "HyperLink", scalarParameterType => scalarParameterType.HyperLink },
        };

        /// <summary>
        /// The ordered containment property value map.
        /// </summary>
        private readonly Dictionary<string, Func<CDP4Common.DTO.ScalarParameterType, IEnumerable<OrderedItem>>> orderedContainmentPropertyValueMap = new Dictionary<string, Func<CDP4Common.DTO.ScalarParameterType, IEnumerable<OrderedItem>>>();

        /// <summary>
        /// The validation rules that should pass for an instance of <see cref="CDP4Common.DTO.ScalarParameterType"/>.
        /// </summary>
        private readonly Dictionary<string, DtoValidationHelper<CDP4Common.DTO.ScalarParameterType>> validationRules = new Dictionary<string, DtoValidationHelper<CDP4Common.DTO.ScalarParameterType>>
        {
            { "Alias", new DtoValidationHelper<CDP4Common.DTO.ScalarParameterType>(item => item.Alias != null, "The 'Alias' property of a 'ScalarParameterType' is mandatory and cannot be null.") },
            { "Attachment", new DtoValidationHelper<CDP4Common.DTO.ScalarParameterType>(item => item.Attachment != null, "The 'Attachment' property of a 'ScalarParameterType' is mandatory and cannot be null.") },
            { "Category", new DtoValidationHelper<CDP4Common.DTO.ScalarParameterType>(item => item.Category != null, "The 'Category' property of a 'ScalarParameterType' is mandatory and cannot be null.") },
            { "Definition", new DtoValidationHelper<CDP4Common.DTO.ScalarParameterType>(item => item.Definition != null, "The 'Definition' property of a 'ScalarParameterType' is mandatory and cannot be null.") },
            { "ExcludedDomain", new DtoValidationHelper<CDP4Common.DTO.ScalarParameterType>(item => item.ExcludedDomain != null, "The 'ExcludedDomain' property of a 'ScalarParameterType' is mandatory and cannot be null.") },
            { "ExcludedPerson", new DtoValidationHelper<CDP4Common.DTO.ScalarParameterType>(item => item.ExcludedPerson != null, "The 'ExcludedPerson' property of a 'ScalarParameterType' is mandatory and cannot be null.") },
            { "HyperLink", new DtoValidationHelper<CDP4Common.DTO.ScalarParameterType>(item => item.HyperLink != null, "The 'HyperLink' property of a 'ScalarParameterType' is mandatory and cannot be null.") },
            { "Name", new DtoValidationHelper<CDP4Common.DTO.ScalarParameterType>(item => !string.IsNullOrWhiteSpace(item.Name), "The 'Name' property of a 'ScalarParameterType' is mandatory and cannot be empty or null.") },
            { "ShortName", new DtoValidationHelper<CDP4Common.DTO.ScalarParameterType>(item => !string.IsNullOrWhiteSpace(item.ShortName), "The 'ShortName' property of a 'ScalarParameterType' is mandatory and cannot be empty or null.") },
            { "Symbol", new DtoValidationHelper<CDP4Common.DTO.ScalarParameterType>(item => !string.IsNullOrWhiteSpace(item.Symbol), "The 'Symbol' property of a 'ScalarParameterType' is mandatory and cannot be empty or null.") },
        };
        ...
        /// </exception>
        public void Validate(CDP4Common.DTO.Thing scalarParameterType)
        {
            this.Validate(scalarParameterType, x => true);
        }
        ...
        /// If any validation rule failed.
        /// </exception>
        public void Validate(CDP4Common.DTO.Thing scalarParameterType, Func<string, bool> validateProperty)
        {
            foreach (var applicableRule in this.validationRules.Where(x => validateProperty(x.Key)))
            {
                applicableRule.Value.Validate((CDP4Common.DTO.ScalarParameterType)scalarParameterType);
            }
        }
        ...
        /// </returns>
        public bool TryValidate(CDP4Common.DTO.Thing scalarParameterType)
        {
            return this.TryValidate(scalarParameterType, x => true);
        }
        ...
        /// True if all validation rules have passed or if none are defined.
        /// </returns>
        public bool TryValidate(CDP4Common.DTO.Thing scalarParameterType, Func<string, bool> validateProperty)
        {
            var applicableValidationRules = this.validationRules.Where(x => validateProperty(x.Key)).Select(x => x.Value);

            return applicableValidationRules.All(applicableRule => applicableRule.TryValidate((CDP4Common.DTO.ScalarParameterType)scalarParameterType));
        }

        /// <summary>
        /// Returns the containment property value for the supplied <see cref="CDP4Common.DTO.ScalarParameterType"/>.
        /// </summary>
        /// <param name="scalarParameterType">
        /// The <see cref="CDP4Common.DTO.ScalarParameterType"/> for which to return the containment property value.
        /// </param>
        ...
        /// If the property name is not supported for the <see cref="CDP4Common.DTO.ScalarParameterType"/>.
        /// </exception>
        public IEnumerable<Guid> GetContainmentIds(CDP4Common.DTO.Thing scalarParameterType, string propertyName)
        {
            if (!this.containmentPropertyValueMap.ContainsKey(propertyName))
            {
                throw new ArgumentException($"'{propertyName}' is not a valid containment property of 'ScalarParameterType'");
            }

            return this.containmentPropertyValueMap[propertyName]((CDP4Common.DTO.ScalarParameterType)scalarParameterType);
        }

        /// <summary>
        /// Returns the ordered containment property value for the supplied <see cref="CDP4Common.DTO.ScalarParameterType"/>.
        /// </summary>
        /// <param name="scalarParameterType">
        /// The <see cref="CDP4Common.DTO.ScalarParameterType"/> for which to return the containment property value.
        /// </param>
        ...
        /// If the property name is not supported for the <see cref="CDP4Common.DTO.ScalarParameterType"/>.
        /// </exception>
        public IEnumerable<OrderedItem> GetOrderedContainmentIds(CDP4Common.DTO.Thing scalarParameterType, string propertyName)
        {
            ...
            return this.orderedContainmentPropertyValueMap[propertyName]((CDP4Common.DTO.ScalarParameterType)scalarParameterType);
        }
        ...
        /// <summary>
        /// Gets the <see cref="PropertyMetaInfo"/> for the <see cref="ScalarParameterType"/> class
        /// </summary>
        ...
        /// </summary>
        private readonly Dictionary<string, Func<CDP4Common.DTO.ScalarParameterType, object>> propertyValueMap = new Dictionary<string, Func<CDP4Common.DTO.ScalarParameterType, object>>
        {
        ...
        /// </summary>
        private readonly Dictionary<string, Action<CDP4Common.DTO.ScalarParameterType, object>> propertyValueAssignmentMap = new Dictionary<string, Action<CDP4Common.DTO.ScalarParameterType, object>>
        {
            { "Actor", (scalarParameterType, value) => scalarParameterType.Actor = value == null ? (Guid?)null : (Guid)value },
            { "Iid", (scalarParameterType, value) => scalarParameterType.Iid = (Guid)value },
            { "IsDeprecated", (scalarParameterType, value) => scalarParameterType.IsDeprecated = (bool)value },
            { "ModifiedOn", (scalarParameterType, value) => scalarParameterType.ModifiedOn = (DateTime)value },
            { "Name", (scalarParameterType, value) => scalarParameterType.Name = value.ToString() },
            { "ShortName", (scalarParameterType, value) => scalarParameterType.ShortName = value.ToString() },
            { "Symbol", (scalarParameterType, value) => scalarParameterType.Symbol = value.ToString() },
            { "ThingPreference", (scalarParameterType, value) => scalarParameterType.ThingPreference = value == null ? (string)null : value.ToString() },
        };
        ...
        /// <summary>
        /// Returns the <see cref="CDP4Common.DTO.ScalarParameterType"/> containment property type from the supplied property name.
        /// </summary>
        /// <param name="propertyName">
        ...
        /// <summary>
        /// Returns the <see cref="CDP4Common.DTO.ScalarParameterType"/> property type from the supplied property name.
        /// </summary>
        /// <param name="propertyName">
        /// The property name.
        /// </param>
        ...
        /// <summary>
        /// Returns the container property for the supplied type name is a possible container for <see cref="CDP4Common.DTO.ScalarParameterType"/>.
        /// </summary>
        /// <param name="typeName">
        /// Name of the type for which to check if it is a container of <see cref="CDP4Common.DTO.ScalarParameterType"/>.
        /// </param>
        /// <param name="containerProperty">
        /// Supplied container property info instance that will be set if the supplied type name is a container of <see cref="CDP4Common.DTO.ScalarParameterType"/>.
        /// </param>
        /// <returns>
        /// True if the supplied typeName is a container for <see cref="CDP4Common.DTO.ScalarParameterType"/> and sets the container property name.
        /// </returns>
        ...
        /// <summary>
        /// Check if the supplied property name for <see cref="CDP4Common.DTO.ScalarParameterType"/> is scalar.
        /// </summary>
        /// <param name="propertyName">
        /// Name of the property for which to check if it is scalar.
        /// </param>
        ...
        public bool ApplyPropertyUpdate(CDP4Common.DTO.Thing updatableThing, string propertyName, object value)
        {
            ...
            this.propertyValueAssignmentMap[propertyName]((CDP4Common.DTO.ScalarParameterType)updatableThing, value);
        ...
        public object DeserializeCollectionValue(string propertyName, object value)
        {
            ...
            {
                throw new ArgumentException($"'{propertyName}' is not a valid collection property of 'ScalarParameterType'");
            }
        ...
        public object GetValue(string propertyName, CDP4Common.DTO.Thing thing)
        {
            ...
            return this.propertyValueMap[propertyName]((CDP4Common.DTO.ScalarParameterType)thing);
        }
        ...
        /// <summary>
        /// Instantiates a <see cref="CDP4Common.DTO.ScalarParameterType"/>
        /// </summary>
        /// <returns>
