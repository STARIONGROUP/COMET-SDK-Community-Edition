...
namespace CDP4Common.MetaInfo
{
    ...
    public partial class ScalarParameterTypeMetaInfo : IScalarParameterTypeMetaInfo
    {
        ...
        public IEnumerable<Guid> GetContainmentIds(CDP4Common.DTO.Thing scalarParameterType, string propertyName)
        {
            ...
            {
                throw new ArgumentException(string.Format("'{0}' is not a valid containment property of 'ScalarParameterType'", propertyName));
            }
        ...
        public object DeserializeCollectionValue(string propertyName, object value)
        {
            ...
            {
                throw new ArgumentException(string.Format("'{0}' is not a valid collection property of 'ScalarParameterType'", propertyName));
            }
