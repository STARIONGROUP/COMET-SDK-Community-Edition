// --------------------------------------------------------------------------------------------------------------------
// <copyright file="TimeOfDayParameterTypeMetaInfo.cs" company="Starion Group S.A.">
...
namespace CDP4Common.MetaInfo
{
    ...
    /// <summary>
    /// This a class that holds meta info for <see cref="TimeOfDayParameterType"/>.
    /// </summary>
    public partial class TimeOfDayParameterTypeMetaInfo : ITimeOfDayParameterTypeMetaInfo
    {
        /// <summary>
        ...
        /// </summary>
        private readonly Dictionary<string, Func<CDP4Common.DTO.TimeOfDayParameterType, IEnumerable<OrderedItem>>> orderedContainmentPropertyValueMap = new Dictionary<string, Func<CDP4Common.DTO.TimeOfDayParameterType, IEnumerable<OrderedItem>>>();

        /// <summary>
        /// The validation rules that should pass for an instance of <see cref="CDP4Common.DTO.TimeOfDayParameterType"/>.
        /// </summary>
        private readonly Dictionary<string, DtoValidationHelper<CDP4Common.DTO.TimeOfDayParameterType>> validationRules = new Dictionary<string, DtoValidationHelper<CDP4Common.DTO.TimeOfDayParameterType>>
        {
            ...
            { "ExcludedPerson", new DtoValidationHelper<CDP4Common.DTO.TimeOfDayParameterType>(item => item.ExcludedPerson != null, "The 'ExcludedPerson' property of a 'TimeOfDayParameterType' is mandatory and cannot be null.") },
            { "HyperLink", new DtoValidationHelper<CDP4Common.DTO.TimeOfDayParameterType>(item => item.HyperLink != null, "The 'HyperLink' property of a 'TimeOfDayParameterType' is mandatory and cannot be null.") },
            { "Name", new DtoValidationHelper<CDP4Common.DTO.TimeOfDayParameterType>(item => !string.IsNullOrWhiteSpace(item.Name), "The 'Name' property of a 'TimeOfDayParameterType' is mandatory and cannot be empty or null.") },
            { "ShortName", new DtoValidationHelper<CDP4Common.DTO.TimeOfDayParameterType>(item => !string.IsNullOrWhiteSpace(item.ShortName), "The 'ShortName' property of a 'TimeOfDayParameterType' is mandatory and cannot be empty or null.") },
            { "Symbol", new DtoValidationHelper<CDP4Common.DTO.TimeOfDayParameterType>(item => !string.IsNullOrWhiteSpace(item.Symbol), "The 'Symbol' property of a 'TimeOfDayParameterType' is mandatory and cannot be empty or null.") },
        };
        ...
        /// </exception>
        public void Validate(CDP4Common.DTO.Thing timeOfDayParameterType)
        {
            this.Validate(timeOfDayParameterType, x => true);
        }
        ...
        /// If any validation rule failed.
        /// </exception>
        public void Validate(CDP4Common.DTO.Thing timeOfDayParameterType, Func<string, bool> validateProperty)
        {
            foreach (var applicableRule in this.validationRules.Where(x => validateProperty(x.Key)))
            {
                applicableRule.Value.Validate((CDP4Common.DTO.TimeOfDayParameterType)timeOfDayParameterType);
            }
        }
        ...
        /// </returns>
        public bool TryValidate(CDP4Common.DTO.Thing timeOfDayParameterType)
        {
            return this.TryValidate(timeOfDayParameterType, x => true);
        }
        ...
        /// True if all validation rules have passed or if none are defined.
        /// </returns>
        public bool TryValidate(CDP4Common.DTO.Thing timeOfDayParameterType, Func<string, bool> validateProperty)
        {
            var applicableValidationRules = this.validationRules.Where(x => validateProperty(x.Key)).Select(x => x.Value);

            return applicableValidationRules.All(applicableRule => applicableRule.TryValidate((CDP4Common.DTO.TimeOfDayParameterType)timeOfDayParameterType));
        }

        /// <summary>
        /// Returns the containment property value for the supplied <see cref="CDP4Common.DTO.TimeOfDayParameterType"/>.
        /// </summary>
        /// <param name="timeOfDayParameterType">
        /// The <see cref="CDP4Common.DTO.TimeOfDayParameterType"/> for which to return the containment property value.
        /// </param>
        ...
        /// If the property name is not supported for the <see cref="CDP4Common.DTO.TimeOfDayParameterType"/>.
        /// </exception>
        public IEnumerable<Guid> GetContainmentIds(CDP4Common.DTO.Thing timeOfDayParameterType, string propertyName)
        {
            if (!this.containmentPropertyValueMap.ContainsKey(propertyName))
            {
                throw new ArgumentException($"'{propertyName}' is not a valid containment property of 'TimeOfDayParameterType'");
            }

            return this.containmentPropertyValueMap[propertyName]((CDP4Common.DTO.TimeOfDayParameterType)timeOfDayParameterType);
        }

        /// <summary>
        /// Returns the ordered containment property value for the supplied <see cref="CDP4Common.DTO.TimeOfDayParameterType"/>.
        /// </summary>
        /// <param name="timeOfDayParameterType">
        /// The <see cref="CDP4Common.DTO.TimeOfDayParameterType"/> for which to return the containment property value.
        /// </param>
        ...
        /// If the property name is not supported for the <see cref="CDP4Common.DTO.TimeOfDayParameterType"/>.
        /// </exception>
        public IEnumerable<OrderedItem> GetOrderedContainmentIds(CDP4Common.DTO.Thing timeOfDayParameterType, string propertyName)
        {
            ...
            return this.orderedContainmentPropertyValueMap[propertyName]((CDP4Common.DTO.TimeOfDayParameterType)timeOfDayParameterType);
        }
        ...
        /// <summary>
        /// Gets the <see cref="PropertyMetaInfo"/> for the <see cref="TimeOfDayParameterType"/> class
        /// </summary>
        ...
        /// </summary>
        private readonly Dictionary<string, Action<CDP4Common.DTO.TimeOfDayParameterType, object>> propertyValueAssignmentMap = new Dictionary<string, Action<CDP4Common.DTO.TimeOfDayParameterType, object>>
        {
            { "Actor", (timeOfDayParameterType, value) => timeOfDayParameterType.Actor = value == null ? (Guid?)null : (Guid)value },
            { "Iid", (timeOfDayParameterType, value) => timeOfDayParameterType.Iid = (Guid)value },
            { "IsDeprecated", (timeOfDayParameterType, value) => timeOfDayParameterType.IsDeprecated = (bool)value },
            { "ModifiedOn", (timeOfDayParameterType, value) => timeOfDayParameterType.ModifiedOn = (DateTime)value },
            { "Name", (timeOfDayParameterType, value) => timeOfDayParameterType.Name = value.ToString() },
            { "ShortName", (timeOfDayParameterType, value) => timeOfDayParameterType.ShortName = value.ToString() },
            { "Symbol", (timeOfDayParameterType, value) => timeOfDayParameterType.Symbol = value.ToString() },
            { "ThingPreference", (timeOfDayParameterType, value) => timeOfDayParameterType.ThingPreference = value == null ? (string)null : value.ToString() },
        };
        ...
        /// <summary>
        /// Returns the <see cref="CDP4Common.DTO.TimeOfDayParameterType"/> containment property type from the supplied property name.
        /// </summary>
        /// <param name="propertyName">
        ...
        /// <summary>
        /// Returns the <see cref="CDP4Common.DTO.TimeOfDayParameterType"/> property type from the supplied property name.
        /// </summary>
        /// <param name="propertyName">
        /// The property name.
        /// </param>
        ...
        /// <summary>
        /// Returns the container property for the supplied type name is a possible container for <see cref="CDP4Common.DTO.TimeOfDayParameterType"/>.
        /// </summary>
        /// <param name="typeName">
        /// Name of the type for which to check if it is a container of <see cref="CDP4Common.DTO.TimeOfDayParameterType"/>.
        /// </param>
        /// <param name="containerProperty">
        /// Supplied container property info instance that will be set if the supplied type name is a container of <see cref="CDP4Common.DTO.TimeOfDayParameterType"/>.
        /// </param>
        /// <returns>
        /// True if the supplied typeName is a container for <see cref="CDP4Common.DTO.TimeOfDayParameterType"/> and sets the container property name.
        /// </returns>
        ...
        /// <summary>
        /// Check if the supplied property name for <see cref="CDP4Common.DTO.TimeOfDayParameterType"/> is scalar.
        /// </summary>
        /// <param name="propertyName">
        /// Name of the property for which to check if it is scalar.
        /// </param>
        ...
        public object DeserializeCollectionValue(string propertyName, object value)
        {
            ...
            {
                throw new ArgumentException($"'{propertyName}' is not a valid collection property of 'TimeOfDayParameterType'");
            }
        ...
        public object GetValue(string propertyName, CDP4Common.DTO.Thing thing)
        {
            ...
            return this.propertyValueMap[propertyName]((CDP4Common.DTO.TimeOfDayParameterType)thing);
        }
        ...
        /// <summary>
        /// Instantiates a <see cref="CDP4Common.DTO.TimeOfDayParameterType"/>
        /// </summary>
        /// <returns>
        ...
        {
            return new CDP4Common.DTO.TimeOfDayParameterType(guid, revisionNumber);
        }
    }
}
