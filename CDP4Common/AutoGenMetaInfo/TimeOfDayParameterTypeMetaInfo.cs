...
namespace CDP4Common.MetaInfo
{
    ...
    public partial class TimeOfDayParameterTypeMetaInfo : ITimeOfDayParameterTypeMetaInfo
    {
        ...
        public IEnumerable<Guid> GetContainmentIds(CDP4Common.DTO.Thing timeOfDayParameterType, string propertyName)
        {
            ...
            {
                throw new ArgumentException(string.Format("'{0}' is not a valid containment property of 'TimeOfDayParameterType'", propertyName));
            }
        ...
        public object DeserializeCollectionValue(string propertyName, object value)
        {
            ...
            {
                throw new ArgumentException(string.Format("'{0}' is not a valid collection property of 'TimeOfDayParameterType'", propertyName));
            }
