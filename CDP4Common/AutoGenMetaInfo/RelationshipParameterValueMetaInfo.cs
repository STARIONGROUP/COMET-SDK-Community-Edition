// --------------------------------------------------------------------------------------------------------------------
// <copyright file="RelationshipParameterValueMetaInfo.cs" company="Starion Group S.A.">
...
namespace CDP4Common.MetaInfo
{
    ...
    public partial class RelationshipParameterValueMetaInfo : IRelationshipParameterValueMetaInfo
    {
        ...
        public IEnumerable<Guid> GetContainmentIds(CDP4Common.DTO.Thing relationshipParameterValue, string propertyName)
        {
            ...
            {
                throw new ArgumentException($"'{propertyName}' is not a valid containment property of 'RelationshipParameterValue'");
            }
        ...
        {
            { "Actor", (relationshipParameterValue, value) => relationshipParameterValue.Actor = value == null ? (Guid?)null : (Guid)value },
        ...
        {
            { "BinaryRelationship", new PropertyMetaInfo("ParameterValue", "RelationshipParameterValue", PropertyKind.List, AggregationKind.Composite, false, false, true, 0, "*", true) },
            { "MultiRelationship", new PropertyMetaInfo("ParameterValue", "RelationshipParameterValue", PropertyKind.List, AggregationKind.Composite, false, false, true, 0, "*", true) },
        };
        ...
        public object DeserializeCollectionValue(string propertyName, object value)
        {
            ...
            {
                throw new ArgumentException($"'{propertyName}' is not a valid collection property of 'RelationshipParameterValue'");
            }
