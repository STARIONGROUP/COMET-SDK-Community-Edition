...
namespace CDP4Common.MetaInfo
{
    ...
    public partial class RequestForDeviationMetaInfo : IRequestForDeviationMetaInfo
    {
        ...
        public IEnumerable<Guid> GetContainmentIds(CDP4Common.DTO.Thing requestForDeviation, string propertyName)
        {
            ...
            {
                throw new ArgumentException(string.Format("'{0}' is not a valid containment property of 'RequestForDeviation'", propertyName));
            }
        ...
        public object DeserializeCollectionValue(string propertyName, object value)
        {
            ...
            {
                throw new ArgumentException(string.Format("'{0}' is not a valid collection property of 'RequestForDeviation'", propertyName));
            }
