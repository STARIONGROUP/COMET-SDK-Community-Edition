// --------------------------------------------------------------------------------------------------------------------
// <copyright file="RequestForDeviationMetaInfo.cs" company="Starion Group S.A.">
...
namespace CDP4Common.MetaInfo
{
    ...
    /// <summary>
    /// This a class that holds meta info for <see cref="RequestForDeviation"/>.
    /// </summary>
    public partial class RequestForDeviationMetaInfo : IRequestForDeviationMetaInfo
    {
        /// <summary>
        /// The containment property value map.
        /// </summary>
        private readonly Dictionary<string, Func<CDP4Common.DTO.RequestForDeviation, IEnumerable<Guid>>> containmentPropertyValueMap = new Dictionary<string, Func<CDP4Common.DTO.RequestForDeviation, IEnumerable<Guid>>>
        {
            { "ApprovedBy", requestForDeviation => requestForDeviation.ApprovedBy },
            { "Discussion", requestForDeviation => requestForDeviation.Discussion },
            { "RelatedThing", requestForDeviation => requestForDeviation.RelatedThing },
        };

        /// <summary>
        /// The ordered containment property value map.
        /// </summary>
        private readonly Dictionary<string, Func<CDP4Common.DTO.RequestForDeviation, IEnumerable<OrderedItem>>> orderedContainmentPropertyValueMap = new Dictionary<string, Func<CDP4Common.DTO.RequestForDeviation, IEnumerable<OrderedItem>>>();

        /// <summary>
        /// The validation rules that should pass for an instance of <see cref="CDP4Common.DTO.RequestForDeviation"/>.
        /// </summary>
        private readonly Dictionary<string, DtoValidationHelper<CDP4Common.DTO.RequestForDeviation>> validationRules = new Dictionary<string, DtoValidationHelper<CDP4Common.DTO.RequestForDeviation>>
        {
            { "ApprovedBy", new DtoValidationHelper<CDP4Common.DTO.RequestForDeviation>(item => item.ApprovedBy != null, "The 'ApprovedBy' property of a 'RequestForDeviation' is mandatory and cannot be null.") },
            { "Category", new DtoValidationHelper<CDP4Common.DTO.RequestForDeviation>(item => item.Category != null, "The 'Category' property of a 'RequestForDeviation' is mandatory and cannot be null.") },
            { "Content", new DtoValidationHelper<CDP4Common.DTO.RequestForDeviation>(item => !string.IsNullOrWhiteSpace(item.Content), "The 'Content' property of a 'RequestForDeviation' is mandatory and cannot be empty or null.") },
            { "Discussion", new DtoValidationHelper<CDP4Common.DTO.RequestForDeviation>(item => item.Discussion != null, "The 'Discussion' property of a 'RequestForDeviation' is mandatory and cannot be null.") },
            { "ExcludedDomain", new DtoValidationHelper<CDP4Common.DTO.RequestForDeviation>(item => item.ExcludedDomain != null, "The 'ExcludedDomain' property of a 'RequestForDeviation' is mandatory and cannot be null.") },
            { "ExcludedPerson", new DtoValidationHelper<CDP4Common.DTO.RequestForDeviation>(item => item.ExcludedPerson != null, "The 'ExcludedPerson' property of a 'RequestForDeviation' is mandatory and cannot be null.") },
            { "LanguageCode", new DtoValidationHelper<CDP4Common.DTO.RequestForDeviation>(item => !string.IsNullOrWhiteSpace(item.LanguageCode), "The 'LanguageCode' property of a 'RequestForDeviation' is mandatory and cannot be empty or null.") },
            { "RelatedThing", new DtoValidationHelper<CDP4Common.DTO.RequestForDeviation>(item => item.RelatedThing != null, "The 'RelatedThing' property of a 'RequestForDeviation' is mandatory and cannot be null.") },
            { "ShortName", new DtoValidationHelper<CDP4Common.DTO.RequestForDeviation>(item => !string.IsNullOrWhiteSpace(item.ShortName), "The 'ShortName' property of a 'RequestForDeviation' is mandatory and cannot be empty or null.") },
            { "SourceAnnotation", new DtoValidationHelper<CDP4Common.DTO.RequestForDeviation>(item => item.SourceAnnotation != null, "The 'SourceAnnotation' property of a 'RequestForDeviation' is mandatory and cannot be null.") },
            { "Title", new DtoValidationHelper<CDP4Common.DTO.RequestForDeviation>(item => !string.IsNullOrWhiteSpace(item.Title), "The 'Title' property of a 'RequestForDeviation' is mandatory and cannot be empty or null.") },
        };
        ...
        /// </exception>
        public void Validate(CDP4Common.DTO.Thing requestForDeviation)
        {
            this.Validate(requestForDeviation, x => true);
        }
        ...
        /// If any validation rule failed.
        /// </exception>
        public void Validate(CDP4Common.DTO.Thing requestForDeviation, Func<string, bool> validateProperty)
        {
            foreach (var applicableRule in this.validationRules.Where(x => validateProperty(x.Key)))
            {
                applicableRule.Value.Validate((CDP4Common.DTO.RequestForDeviation)requestForDeviation);
            }
        }
        ...
        /// </returns>
        public bool TryValidate(CDP4Common.DTO.Thing requestForDeviation)
        {
            return this.TryValidate(requestForDeviation, x => true);
        }
        ...
        /// True if all validation rules have passed or if none are defined.
        /// </returns>
        public bool TryValidate(CDP4Common.DTO.Thing requestForDeviation, Func<string, bool> validateProperty)
        {
            var applicableValidationRules = this.validationRules.Where(x => validateProperty(x.Key)).Select(x => x.Value);

            return applicableValidationRules.All(applicableRule => applicableRule.TryValidate((CDP4Common.DTO.RequestForDeviation)requestForDeviation));
        }

        /// <summary>
        /// Returns the containment property value for the supplied <see cref="CDP4Common.DTO.RequestForDeviation"/>.
        /// </summary>
        /// <param name="requestForDeviation">
        /// The <see cref="CDP4Common.DTO.RequestForDeviation"/> for which to return the containment property value.
        /// </param>
        ...
        /// If the property name is not supported for the <see cref="CDP4Common.DTO.RequestForDeviation"/>.
        /// </exception>
        public IEnumerable<Guid> GetContainmentIds(CDP4Common.DTO.Thing requestForDeviation, string propertyName)
        {
            if (!this.containmentPropertyValueMap.ContainsKey(propertyName))
            {
                throw new ArgumentException($"'{propertyName}' is not a valid containment property of 'RequestForDeviation'");
            }

            return this.containmentPropertyValueMap[propertyName]((CDP4Common.DTO.RequestForDeviation)requestForDeviation);
        }

        /// <summary>
        /// Returns the ordered containment property value for the supplied <see cref="CDP4Common.DTO.RequestForDeviation"/>.
        /// </summary>
        /// <param name="requestForDeviation">
        /// The <see cref="CDP4Common.DTO.RequestForDeviation"/> for which to return the containment property value.
        /// </param>
        ...
        /// If the property name is not supported for the <see cref="CDP4Common.DTO.RequestForDeviation"/>.
        /// </exception>
        public IEnumerable<OrderedItem> GetOrderedContainmentIds(CDP4Common.DTO.Thing requestForDeviation, string propertyName)
        {
            ...
            return this.orderedContainmentPropertyValueMap[propertyName]((CDP4Common.DTO.RequestForDeviation)requestForDeviation);
        }
        ...
        /// <summary>
        /// Gets the <see cref="PropertyMetaInfo"/> for the <see cref="RequestForDeviation"/> class
        /// </summary>
        ...
        /// </summary>
        private readonly Dictionary<string, Func<CDP4Common.DTO.RequestForDeviation, object>> propertyValueMap = new Dictionary<string, Func<CDP4Common.DTO.RequestForDeviation, object>>
        {
        ...
        /// </summary>
        private readonly Dictionary<string, Action<CDP4Common.DTO.RequestForDeviation, object>> propertyValueAssignmentMap = new Dictionary<string, Action<CDP4Common.DTO.RequestForDeviation, object>>
        {
            { "Actor", (requestForDeviation, value) => requestForDeviation.Actor = value == null ? (Guid?)null : (Guid)value },
            { "Author", (requestForDeviation, value) => requestForDeviation.Author = (Guid)value },
            { "Classification", (requestForDeviation, value) => requestForDeviation.Classification = (AnnotationClassificationKind)value },
            { "Content", (requestForDeviation, value) => requestForDeviation.Content = value.ToString() },
            { "CreatedOn", (requestForDeviation, value) => requestForDeviation.CreatedOn = (DateTime)value },
            { "Iid", (requestForDeviation, value) => requestForDeviation.Iid = (Guid)value },
            { "LanguageCode", (requestForDeviation, value) => requestForDeviation.LanguageCode = value.ToString() },
            { "ModifiedOn", (requestForDeviation, value) => requestForDeviation.ModifiedOn = (DateTime)value },
            { "Owner", (requestForDeviation, value) => requestForDeviation.Owner = (Guid)value },
            { "PrimaryAnnotatedThing", (requestForDeviation, value) => requestForDeviation.PrimaryAnnotatedThing = value == null ? (Guid?)null : (Guid)value },
            { "ShortName", (requestForDeviation, value) => requestForDeviation.ShortName = value.ToString() },
            { "Status", (requestForDeviation, value) => requestForDeviation.Status = (AnnotationStatusKind)value },
            { "ThingPreference", (requestForDeviation, value) => requestForDeviation.ThingPreference = value == null ? (string)null : value.ToString() },
            { "Title", (requestForDeviation, value) => requestForDeviation.Title = value.ToString() },
        };
        ...
        /// <summary>
        /// Returns the <see cref="CDP4Common.DTO.RequestForDeviation"/> containment property type from the supplied property name.
        /// </summary>
        /// <param name="propertyName">
        ...
        /// <summary>
        /// Returns the <see cref="CDP4Common.DTO.RequestForDeviation"/> property type from the supplied property name.
        /// </summary>
        /// <param name="propertyName">
        /// The property name.
        /// </param>
        ...
        /// <summary>
        /// Returns the container property for the supplied type name is a possible container for <see cref="CDP4Common.DTO.RequestForDeviation"/>.
        /// </summary>
        /// <param name="typeName">
        /// Name of the type for which to check if it is a container of <see cref="CDP4Common.DTO.RequestForDeviation"/>.
        /// </param>
        /// <param name="containerProperty">
        /// Supplied container property info instance that will be set if the supplied type name is a container of <see cref="CDP4Common.DTO.RequestForDeviation"/>.
        /// </param>
        /// <returns>
        /// True if the supplied typeName is a container for <see cref="CDP4Common.DTO.RequestForDeviation"/> and sets the container property name.
        /// </returns>
        ...
        /// <summary>
        /// Check if the supplied property name for <see cref="CDP4Common.DTO.RequestForDeviation"/> is scalar.
        /// </summary>
        /// <param name="propertyName">
        /// Name of the property for which to check if it is scalar.
        /// </param>
        ...
        public bool ApplyPropertyUpdate(CDP4Common.DTO.Thing updatableThing, string propertyName, object value)
        {
            ...
            this.propertyValueAssignmentMap[propertyName]((CDP4Common.DTO.RequestForDeviation)updatableThing, value);
        ...
        public object DeserializeCollectionValue(string propertyName, object value)
        {
            ...
            {
                throw new ArgumentException($"'{propertyName}' is not a valid collection property of 'RequestForDeviation'");
            }
        ...
        public object GetValue(string propertyName, CDP4Common.DTO.Thing thing)
        {
            ...
            return this.propertyValueMap[propertyName]((CDP4Common.DTO.RequestForDeviation)thing);
        }
        ...
        /// <summary>
        /// Instantiates a <see cref="CDP4Common.DTO.RequestForDeviation"/>
        /// </summary>
        /// <returns>
        ...
        {
            return new CDP4Common.DTO.RequestForDeviation(guid, revisionNumber);
        }
    }
}
