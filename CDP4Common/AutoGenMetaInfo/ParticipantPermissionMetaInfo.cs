...
namespace CDP4Common.MetaInfo
{
    ...
    public partial class ParticipantPermissionMetaInfo : IParticipantPermissionMetaInfo
    {
        ...
        public IEnumerable<Guid> GetContainmentIds(CDP4Common.DTO.Thing participantPermission, string propertyName)
        {
            ...
            {
                throw new ArgumentException(string.Format("'{0}' is not a valid containment property of 'ParticipantPermission'", propertyName));
            }
        ...
        public object DeserializeCollectionValue(string propertyName, object value)
        {
            ...
            {
                throw new ArgumentException(string.Format("'{0}' is not a valid collection property of 'ParticipantPermission'", propertyName));
            }
