// --------------------------------------------------------------------------------------------------------------------
// <copyright file="ScaleReferenceQuantityValueMetaInfo.cs" company="RHEA System S.A.">
...
namespace CDP4Common.MetaInfo
{
    ...
    /// <summary>
    /// This a class that holds meta info for <see cref="ScaleReferenceQuantityValue"/>.
    /// </summary>
    public partial class ScaleReferenceQuantityValueMetaInfo : IScaleReferenceQuantityValueMetaInfo
    {
        /// <summary>
        /// The containment property value map.
        /// </summary>
        private readonly Dictionary<string, Func<CDP4Common.DTO.ScaleReferenceQuantityValue, IEnumerable<Guid>>> containmentPropertyValueMap = new Dictionary<string, Func<CDP4Common.DTO.ScaleReferenceQuantityValue, IEnumerable<Guid>>>();

        /// <summary>
        /// The ordered containment property value map.
        /// </summary>
        private readonly Dictionary<string, Func<CDP4Common.DTO.ScaleReferenceQuantityValue, IEnumerable<OrderedItem>>> orderedContainmentPropertyValueMap = new Dictionary<string, Func<CDP4Common.DTO.ScaleReferenceQuantityValue, IEnumerable<OrderedItem>>>();

        /// <summary>
        /// The validation rules that should pass for an instance of <see cref="CDP4Common.DTO.ScaleReferenceQuantityValue"/>.
        /// </summary>
        private readonly Dictionary<string, DtoValidationHelper<CDP4Common.DTO.ScaleReferenceQuantityValue>> validationRules = new Dictionary<string, DtoValidationHelper<CDP4Common.DTO.ScaleReferenceQuantityValue>>
        {
            { "ExcludedDomain", new DtoValidationHelper<CDP4Common.DTO.ScaleReferenceQuantityValue>(item => item.ExcludedDomain != null, "The 'ExcludedDomain' property of a 'ScaleReferenceQuantityValue' is mandatory and cannot be null.") },
            { "ExcludedPerson", new DtoValidationHelper<CDP4Common.DTO.ScaleReferenceQuantityValue>(item => item.ExcludedPerson != null, "The 'ExcludedPerson' property of a 'ScaleReferenceQuantityValue' is mandatory and cannot be null.") },
            { "Value", new DtoValidationHelper<CDP4Common.DTO.ScaleReferenceQuantityValue>(item => !string.IsNullOrWhiteSpace(item.Value), "The 'Value' property of a 'ScaleReferenceQuantityValue' is mandatory and cannot be empty or null.") },
        };
        ...
        /// If any validation rule failed.
        /// </exception>
        public void Validate(CDP4Common.DTO.Thing scaleReferenceQuantityValue, Func<string, bool> validateProperty)
        {
            foreach (var applicableRule in this.validationRules.Where(x => validateProperty(x.Key)))
            {
                applicableRule.Value.Validate((CDP4Common.DTO.ScaleReferenceQuantityValue)scaleReferenceQuantityValue);
            }
        }
        ...
        /// <summary>
        /// Returns the containment property value for the supplied <see cref="CDP4Common.DTO.ScaleReferenceQuantityValue"/>.
        /// </summary>
        /// <param name="scaleReferenceQuantityValue">
        /// The <see cref="CDP4Common.DTO.ScaleReferenceQuantityValue"/> for which to return the containment property value.
        /// </param>
        ...
        /// If the property name is not supported for the <see cref="CDP4Common.DTO.ScaleReferenceQuantityValue"/>.
        /// </exception>
        public IEnumerable<Guid> GetContainmentIds(CDP4Common.DTO.Thing scaleReferenceQuantityValue, string propertyName)
        {
            if (!this.containmentPropertyValueMap.ContainsKey(propertyName))
            {
                throw new ArgumentException(string.Format("'{0}' is not a valid containment property of 'ScaleReferenceQuantityValue'", propertyName));
            }

            return this.containmentPropertyValueMap[propertyName]((CDP4Common.DTO.ScaleReferenceQuantityValue)scaleReferenceQuantityValue);
        }

        /// <summary>
        /// Returns the ordered containment property value for the supplied <see cref="CDP4Common.DTO.ScaleReferenceQuantityValue"/>.
        /// </summary>
        /// <param name="scaleReferenceQuantityValue">
        /// The <see cref="CDP4Common.DTO.ScaleReferenceQuantityValue"/> for which to return the containment property value.
        /// </param>
        ...
        /// If the property name is not supported for the <see cref="CDP4Common.DTO.ScaleReferenceQuantityValue"/>.
        /// </exception>
        public IEnumerable<OrderedItem> GetOrderedContainmentIds(CDP4Common.DTO.Thing scaleReferenceQuantityValue, string propertyName)
        {
            ...
            return this.orderedContainmentPropertyValueMap[propertyName]((CDP4Common.DTO.ScaleReferenceQuantityValue)scaleReferenceQuantityValue);
        }
        ...
        /// <summary>
        /// Gets the <see cref="PropertyMetaInfo"/> for the <see cref="ScaleReferenceQuantityValue"/> class
        /// </summary>
        ...
        /// </summary>
        private readonly Dictionary<string, Func<CDP4Common.DTO.ScaleReferenceQuantityValue, object>> propertyValueMap = new Dictionary<string, Func<CDP4Common.DTO.ScaleReferenceQuantityValue, object>>
        {
        ...
        private readonly Dictionary<string, PropertyMetaInfo> propertyTypeMap = new Dictionary<string, PropertyMetaInfo>
        {
            ...
            { "Scale", new PropertyMetaInfo("Scale", "Guid", PropertyKind.Scalar, AggregationKind.None, false, false, true, 1, "1", true) },
        ...
        /// </summary>
        private readonly Dictionary<string, Action<CDP4Common.DTO.ScaleReferenceQuantityValue, object>> propertyValueAssignmentMap = new Dictionary<string, Action<CDP4Common.DTO.ScaleReferenceQuantityValue, object>>
        {
        ...
        {
            { "LogarithmicScale", new PropertyMetaInfo("ReferenceQuantityValue", "Guid", PropertyKind.List, AggregationKind.Composite, false, false, true, 0, "1", true) },
        };
        ...
        /// <summary>
        /// Returns the <see cref="CDP4Common.DTO.ScaleReferenceQuantityValue"/> containment property type from the supplied property name.
        /// </summary>
        /// <param name="propertyName">
        ...
        /// <summary>
        /// Returns the <see cref="CDP4Common.DTO.ScaleReferenceQuantityValue"/> property type from the supplied property name.
        /// </summary>
        /// <param name="propertyName">
        /// The property name.
        /// </param>
        ...
        /// <summary>
        /// Returns the container property for the supplied type name is a possible container for <see cref="CDP4Common.DTO.ScaleReferenceQuantityValue"/>.
        /// </summary>
        /// <param name="typeName">
        /// Name of the type for which to check if it is a container of <see cref="CDP4Common.DTO.ScaleReferenceQuantityValue"/>.
        /// </param>
        /// <param name="containerProperty">
        /// Supplied container property info instance that will be set if the supplied type name is a container of <see cref="CDP4Common.DTO.ScaleReferenceQuantityValue"/>.
        /// </param>
        /// <returns>
        /// True if the supplied typeName is a container for <see cref="CDP4Common.DTO.ScaleReferenceQuantityValue"/> and sets the container property name.
        /// </returns>
        ...
        /// <summary>
        /// Check if the supplied property name for <see cref="CDP4Common.DTO.ScaleReferenceQuantityValue"/> is scalar.
        /// </summary>
        /// <param name="propertyName">
        /// Name of the property for which to check if it is scalar.
        /// </param>
        ...
        public bool ApplyPropertyUpdate(CDP4Common.DTO.Thing updatableThing, string propertyName, object value)
        {
            ...
            this.propertyValueAssignmentMap[propertyName]((CDP4Common.DTO.ScaleReferenceQuantityValue)updatableThing, value);
        ...
        public object DeserializeCollectionValue(string propertyName, object value)
        {
            ...
            {
                throw new ArgumentException(string.Format("'{0}' is not a valid collection property of 'ScaleReferenceQuantityValue'", propertyName));
            }
        ...
        public object GetValue(string propertyName, CDP4Common.DTO.Thing thing)
        {
            ...
            return this.propertyValueMap[propertyName]((CDP4Common.DTO.ScaleReferenceQuantityValue)thing);
        }
        ...
        /// <summary>
        /// Instantiates a <see cref="CDP4Common.DTO.ScaleReferenceQuantityValue"/>
        /// </summary>
        /// <returns>
        ...
        {
            return new CDP4Common.DTO.ScaleReferenceQuantityValue(guid, revisionNumber);
        }
    }
}
