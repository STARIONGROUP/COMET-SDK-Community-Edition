// --------------------------------------------------------------------------------------------------------------------
// <copyright file="ScaleReferenceQuantityValueMetaInfo.cs" company="Starion Group S.A.">
...
namespace CDP4Common.MetaInfo
{
    ...
    public partial class ScaleReferenceQuantityValueMetaInfo : IScaleReferenceQuantityValueMetaInfo
    {
        ...
        public IEnumerable<Guid> GetContainmentIds(CDP4Common.DTO.Thing scaleReferenceQuantityValue, string propertyName)
        {
            ...
            {
                throw new ArgumentException($"'{propertyName}' is not a valid containment property of 'ScaleReferenceQuantityValue'");
            }
        ...
        {
            { "Actor", (scaleReferenceQuantityValue, value) => scaleReferenceQuantityValue.Actor = value == null ? (Guid?)null : (Guid)value },
        ...
        {
            { "LogarithmicScale", new PropertyMetaInfo("ReferenceQuantityValue", "ScaleReferenceQuantityValue", PropertyKind.List, AggregationKind.Composite, false, false, true, 0, "1", true) },
        };
        ...
        public object DeserializeCollectionValue(string propertyName, object value)
        {
            ...
            {
                throw new ArgumentException($"'{propertyName}' is not a valid collection property of 'ScaleReferenceQuantityValue'");
            }
