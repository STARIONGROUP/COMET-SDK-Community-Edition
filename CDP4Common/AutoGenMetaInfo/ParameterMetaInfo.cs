// --------------------------------------------------------------------------------------------------------------------
// <copyright file="ParameterMetaInfo.cs" company="RHEA System S.A.">
...
namespace CDP4Common.MetaInfo
{
    ...
    /// <summary>
    /// This a class that holds meta info for <see cref="Parameter"/>.
    /// </summary>
    public partial class ParameterMetaInfo : IParameterMetaInfo
    {
        /// <summary>
        /// The containment property value map.
        /// </summary>
        private readonly Dictionary<string, Func<CDP4Common.DTO.Parameter, IEnumerable<Guid>>> containmentPropertyValueMap = new Dictionary<string, Func<CDP4Common.DTO.Parameter, IEnumerable<Guid>>>
        {
            { "ParameterSubscription", parameter => parameter.ParameterSubscription },
            { "ValueSet", parameter => parameter.ValueSet },
        };

        /// <summary>
        /// The ordered containment property value map.
        /// </summary>
        private readonly Dictionary<string, Func<CDP4Common.DTO.Parameter, IEnumerable<OrderedItem>>> orderedContainmentPropertyValueMap = new Dictionary<string, Func<CDP4Common.DTO.Parameter, IEnumerable<OrderedItem>>>();

        /// <summary>
        /// The validation rules that should pass for an instance of <see cref="CDP4Common.DTO.Parameter"/>.
        /// </summary>
        private readonly Dictionary<string, DtoValidationHelper<CDP4Common.DTO.Parameter>> validationRules = new Dictionary<string, DtoValidationHelper<CDP4Common.DTO.Parameter>>
        {
            { "ExcludedDomain", new DtoValidationHelper<CDP4Common.DTO.Parameter>(item => item.ExcludedDomain != null, "The 'ExcludedDomain' property of a 'Parameter' is mandatory and cannot be null.") },
            { "ExcludedPerson", new DtoValidationHelper<CDP4Common.DTO.Parameter>(item => item.ExcludedPerson != null, "The 'ExcludedPerson' property of a 'Parameter' is mandatory and cannot be null.") },
            { "ParameterSubscription", new DtoValidationHelper<CDP4Common.DTO.Parameter>(item => item.ParameterSubscription != null, "The 'ParameterSubscription' property of a 'Parameter' is mandatory and cannot be null.") },
            { "ValueSet", new DtoValidationHelper<CDP4Common.DTO.Parameter>(item => item.ValueSet != null && item.ValueSet.Any(), "The 'ValueSet' property of a 'Parameter' is mandatory and must have at least one entry.") },
        };
        ...
        /// </exception>
        public void Validate(CDP4Common.DTO.Thing parameter)
        {
            this.Validate(parameter, x => true);
        }
        ...
        /// If any validation rule failed.
        /// </exception>
        public void Validate(CDP4Common.DTO.Thing parameter, Func<string, bool> validateProperty)
        {
            foreach (var applicableRule in this.validationRules.Where(x => validateProperty(x.Key)))
            {
                applicableRule.Value.Validate((CDP4Common.DTO.Parameter)parameter);
            }
        }
        ...
        /// </returns>
        public bool TryValidate(CDP4Common.DTO.Thing parameter)
        {
            return this.TryValidate(parameter, x => true);
        }
        ...
        /// True if all validation rules have passed or if none are defined.
        /// </returns>
        public bool TryValidate(CDP4Common.DTO.Thing parameter, Func<string, bool> validateProperty)
        {
            var applicableValidationRules = this.validationRules.Where(x => validateProperty(x.Key)).Select(x => x.Value);

            return applicableValidationRules.All(applicableRule => applicableRule.TryValidate((CDP4Common.DTO.Parameter)parameter));
        }

        /// <summary>
        /// Returns the containment property value for the supplied <see cref="CDP4Common.DTO.Parameter"/>.
        /// </summary>
        /// <param name="parameter">
        /// The <see cref="CDP4Common.DTO.Parameter"/> for which to return the containment property value.
        /// </param>
        ...
        /// If the property name is not supported for the <see cref="CDP4Common.DTO.Parameter"/>.
        /// </exception>
        public IEnumerable<Guid> GetContainmentIds(CDP4Common.DTO.Thing parameter, string propertyName)
        {
            if (!this.containmentPropertyValueMap.ContainsKey(propertyName))
            {
                throw new ArgumentException(string.Format("'{0}' is not a valid containment property of 'Parameter'", propertyName));
            }

            return this.containmentPropertyValueMap[propertyName]((CDP4Common.DTO.Parameter)parameter);
        }

        /// <summary>
        /// Returns the ordered containment property value for the supplied <see cref="CDP4Common.DTO.Parameter"/>.
        /// </summary>
        /// <param name="parameter">
        /// The <see cref="CDP4Common.DTO.Parameter"/> for which to return the containment property value.
        /// </param>
        ...
        /// If the property name is not supported for the <see cref="CDP4Common.DTO.Parameter"/>.
        /// </exception>
        public IEnumerable<OrderedItem> GetOrderedContainmentIds(CDP4Common.DTO.Thing parameter, string propertyName)
        {
            ...
            return this.orderedContainmentPropertyValueMap[propertyName]((CDP4Common.DTO.Parameter)parameter);
        }
        ...
        /// <summary>
        /// Gets the <see cref="PropertyMetaInfo"/> for the <see cref="Parameter"/> class
        /// </summary>
        ...
        private readonly Dictionary<string, Func<CDP4Common.DTO.Parameter, object>> propertyValueMap = new Dictionary<string, Func<CDP4Common.DTO.Parameter, object>>
        {
            ...
            { "ExpectsOverride", thing => thing.ExpectsOverride },
            ...
            { "RequestedBy", thing => thing.RequestedBy },
        ...
        private readonly Dictionary<string, PropertyMetaInfo> propertyTypeMap = new Dictionary<string, PropertyMetaInfo>
        {
            ...
            { "ExpectsOverride", new PropertyMetaInfo("ExpectsOverride", "bool", PropertyKind.Scalar, AggregationKind.None, false, false, true, 1, "1", true) },
            { "Group", new PropertyMetaInfo("Group", "Guid", PropertyKind.Scalar, AggregationKind.None, false, false, true, 0, "1", true) },
            ...
            { "RequestedBy", new PropertyMetaInfo("RequestedBy", "Guid", PropertyKind.Scalar, AggregationKind.None, false, false, true, 0, "1", true) },
            ...
            { "StateDependence", new PropertyMetaInfo("StateDependence", "Guid", PropertyKind.Scalar, AggregationKind.None, false, false, true, 0, "1", true) },
        };
        ...
        private readonly Dictionary<string, Action<CDP4Common.DTO.Parameter, object>> propertyValueAssignmentMap = new Dictionary<string, Action<CDP4Common.DTO.Parameter, object>>
        {
            ...
            { "Iid", (parameter, value) => parameter.Iid = (Guid)value },
            { "IsOptionDependent", (parameter, value) => parameter.IsOptionDependent = (bool)value },
            { "ModifiedOn", (parameter, value) => parameter.ModifiedOn = (DateTime)value },
            { "Owner", (parameter, value) => parameter.Owner = (Guid)value },
            { "ParameterType", (parameter, value) => parameter.ParameterType = (Guid)value },
            { "RequestedBy", (parameter, value) => parameter.RequestedBy = value == null ? (Guid?)null : (Guid)value },
            { "Scale", (parameter, value) => parameter.Scale = value == null ? (Guid?)null : (Guid)value },
            { "StateDependence", (parameter, value) => parameter.StateDependence = value == null ? (Guid?)null : (Guid)value },
        };
        ...
        {
            { "ElementDefinition", new PropertyMetaInfo("Parameter", "Guid", PropertyKind.List, AggregationKind.Composite, false, false, true, 0, "*", true) },
        };
        ...
        /// <summary>
        /// Returns the <see cref="CDP4Common.DTO.Parameter"/> containment property type from the supplied property name.
        /// </summary>
        /// <param name="propertyName">
        ...
        /// <summary>
        /// Returns the <see cref="CDP4Common.DTO.Parameter"/> property type from the supplied property name.
        /// </summary>
        /// <param name="propertyName">
        /// The property name.
        /// </param>
        ...
        /// <summary>
        /// Returns the container property for the supplied type name is a possible container for <see cref="CDP4Common.DTO.Parameter"/>.
        /// </summary>
        /// <param name="typeName">
        /// Name of the type for which to check if it is a container of <see cref="CDP4Common.DTO.Parameter"/>.
        /// </param>
        /// <param name="containerProperty">
        /// Supplied container property info instance that will be set if the supplied type name is a container of <see cref="CDP4Common.DTO.Parameter"/>.
        /// </param>
        /// <returns>
        /// True if the supplied typeName is a container for <see cref="CDP4Common.DTO.Parameter"/> and sets the container property name.
        /// </returns>
        ...
        /// <summary>
        /// Check if the supplied property name for <see cref="CDP4Common.DTO.Parameter"/> is scalar.
        /// </summary>
        /// <param name="propertyName">
        /// Name of the property for which to check if it is scalar.
        /// </param>
        ...
        public bool ApplyPropertyUpdate(CDP4Common.DTO.Thing updatableThing, string propertyName, object value)
        {
            ...
            this.propertyValueAssignmentMap[propertyName]((CDP4Common.DTO.Parameter)updatableThing, value);
        ...
        public object DeserializeCollectionValue(string propertyName, object value)
        {
            ...
            {
                throw new ArgumentException(string.Format("'{0}' is not a valid collection property of 'Parameter'", propertyName));
            }
        ...
        public object GetValue(string propertyName, CDP4Common.DTO.Thing thing)
        {
            ...
            return this.propertyValueMap[propertyName]((CDP4Common.DTO.Parameter)thing);
        }
        ...
        /// <summary>
        /// Instantiates a <see cref="CDP4Common.DTO.Parameter"/>
        /// </summary>
        /// <returns>
        ...
        {
            return new CDP4Common.DTO.Parameter(guid, revisionNumber);
        }
    }
}
