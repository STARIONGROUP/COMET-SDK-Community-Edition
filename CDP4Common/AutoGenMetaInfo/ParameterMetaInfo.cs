...
namespace CDP4Common.MetaInfo
{
    ...
    public partial class ParameterMetaInfo : IParameterMetaInfo
    {
        ...
        private readonly Dictionary<string, PropertyMetaInfo> containmentTypeMap = new Dictionary<string, PropertyMetaInfo>
        {
            ...
            { "ValueSet", new PropertyMetaInfo("ValueSet", "ParameterValueSet", PropertyKind.List, AggregationKind.Composite, false, false, true, 1, "*", true) },
        };
        ...
        private readonly Dictionary<string, PropertyMetaInfo> propertyTypeMap = new Dictionary<string, PropertyMetaInfo>
        {
            ...
            { "RequestedBy", new PropertyMetaInfo("RequestedBy", "DomainOfExpertise", PropertyKind.Scalar, AggregationKind.None, false, false, true, 0, "1", true) },
        ...
        private readonly Dictionary<string, Action<CDP4Common.DTO.Parameter, object>> propertyValueAssignmentMap = new Dictionary<string, Action<CDP4Common.DTO.Parameter, object>>
        {
            ...
            { "ThingPreference", (parameter, value) => parameter.ThingPreference = value == null ? (string)null : value.ToString() },
        };
        ...
        {
            { "ElementDefinition", new PropertyMetaInfo("Parameter", "Parameter", PropertyKind.List, AggregationKind.Composite, false, false, true, 0, "*", true) },
        };
