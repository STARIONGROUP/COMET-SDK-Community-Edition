...
namespace CDP4Common.MetaInfo
{
    ...
    public partial class FileTypeMetaInfo : IFileTypeMetaInfo
    {
        ...
        {
            { "ModelReferenceDataLibrary", new PropertyMetaInfo("FileType", "Guid", PropertyKind.List, AggregationKind.Composite, false, false, true, 0, "*", true) },
            { "SiteReferenceDataLibrary", new PropertyMetaInfo("FileType", "Guid", PropertyKind.List, AggregationKind.Composite, false, false, true, 0, "*", true) },
        };
