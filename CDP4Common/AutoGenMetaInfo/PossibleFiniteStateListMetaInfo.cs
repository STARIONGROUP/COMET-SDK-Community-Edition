// --------------------------------------------------------------------------------------------------------------------
// <copyright file="PossibleFiniteStateListMetaInfo.cs" company="RHEA System S.A.">
...
namespace CDP4Common.MetaInfo
{
    ...
    /// <summary>
    /// This a class that holds meta info for <see cref="PossibleFiniteStateList"/>.
    /// </summary>
    public partial class PossibleFiniteStateListMetaInfo : IPossibleFiniteStateListMetaInfo
    {
        /// <summary>
        ...
        /// </summary>
        private readonly Dictionary<string, Func<CDP4Common.DTO.PossibleFiniteStateList, IEnumerable<OrderedItem>>> orderedContainmentPropertyValueMap = new Dictionary<string, Func<CDP4Common.DTO.PossibleFiniteStateList, IEnumerable<OrderedItem>>>
        {
            { "PossibleState", possibleFiniteStateList => possibleFiniteStateList.PossibleState },
        };

        /// <summary>
        /// The validation rules that should pass for an instance of <see cref="CDP4Common.DTO.PossibleFiniteStateList"/>.
        /// </summary>
        private readonly Dictionary<string, DtoValidationHelper<CDP4Common.DTO.PossibleFiniteStateList>> validationRules = new Dictionary<string, DtoValidationHelper<CDP4Common.DTO.PossibleFiniteStateList>>
        {
            ...
            { "ExcludedPerson", new DtoValidationHelper<CDP4Common.DTO.PossibleFiniteStateList>(item => item.ExcludedPerson != null, "The 'ExcludedPerson' property of a 'PossibleFiniteStateList' is mandatory and cannot be null.") },
            { "HyperLink", new DtoValidationHelper<CDP4Common.DTO.PossibleFiniteStateList>(item => item.HyperLink != null, "The 'HyperLink' property of a 'PossibleFiniteStateList' is mandatory and cannot be null.") },
            { "Name", new DtoValidationHelper<CDP4Common.DTO.PossibleFiniteStateList>(item => !string.IsNullOrWhiteSpace(item.Name), "The 'Name' property of a 'PossibleFiniteStateList' is mandatory and cannot be empty or null.") },
            { "PossibleState", new DtoValidationHelper<CDP4Common.DTO.PossibleFiniteStateList>(item => item.PossibleState != null && item.PossibleState.Any(), "The 'PossibleState' property of a 'PossibleFiniteStateList' is mandatory and must have at least one entry.") },
            { "ShortName", new DtoValidationHelper<CDP4Common.DTO.PossibleFiniteStateList>(item => !string.IsNullOrWhiteSpace(item.ShortName), "The 'ShortName' property of a 'PossibleFiniteStateList' is mandatory and cannot be empty or null.") },
        };
        ...
        /// </exception>
        public void Validate(CDP4Common.DTO.Thing possibleFiniteStateList)
        {
            this.Validate(possibleFiniteStateList, x => true);
        }
        ...
        /// If any validation rule failed.
        /// </exception>
        public void Validate(CDP4Common.DTO.Thing possibleFiniteStateList, Func<string, bool> validateProperty)
        {
            foreach (var applicableRule in this.validationRules.Where(x => validateProperty(x.Key)))
            {
                applicableRule.Value.Validate((CDP4Common.DTO.PossibleFiniteStateList)possibleFiniteStateList);
            }
        }
        ...
        /// </returns>
        public bool TryValidate(CDP4Common.DTO.Thing possibleFiniteStateList)
        {
            return this.TryValidate(possibleFiniteStateList, x => true);
        }
        ...
        /// True if all validation rules have passed or if none are defined.
        /// </returns>
        public bool TryValidate(CDP4Common.DTO.Thing possibleFiniteStateList, Func<string, bool> validateProperty)
        {
            var applicableValidationRules = this.validationRules.Where(x => validateProperty(x.Key)).Select(x => x.Value);

            return applicableValidationRules.All(applicableRule => applicableRule.TryValidate((CDP4Common.DTO.PossibleFiniteStateList)possibleFiniteStateList));
        }

        /// <summary>
        /// Returns the containment property value for the supplied <see cref="CDP4Common.DTO.PossibleFiniteStateList"/>.
        /// </summary>
        /// <param name="possibleFiniteStateList">
        /// The <see cref="CDP4Common.DTO.PossibleFiniteStateList"/> for which to return the containment property value.
        /// </param>
        ...
        /// If the property name is not supported for the <see cref="CDP4Common.DTO.PossibleFiniteStateList"/>.
        /// </exception>
        public IEnumerable<Guid> GetContainmentIds(CDP4Common.DTO.Thing possibleFiniteStateList, string propertyName)
        {
            if (!this.containmentPropertyValueMap.ContainsKey(propertyName))
            {
                throw new ArgumentException(string.Format("'{0}' is not a valid containment property of 'PossibleFiniteStateList'", propertyName));
            }

            return this.containmentPropertyValueMap[propertyName]((CDP4Common.DTO.PossibleFiniteStateList)possibleFiniteStateList);
        }

        /// <summary>
        /// Returns the ordered containment property value for the supplied <see cref="CDP4Common.DTO.PossibleFiniteStateList"/>.
        /// </summary>
        /// <param name="possibleFiniteStateList">
        /// The <see cref="CDP4Common.DTO.PossibleFiniteStateList"/> for which to return the containment property value.
        /// </param>
        ...
        /// If the property name is not supported for the <see cref="CDP4Common.DTO.PossibleFiniteStateList"/>.
        /// </exception>
        public IEnumerable<OrderedItem> GetOrderedContainmentIds(CDP4Common.DTO.Thing possibleFiniteStateList, string propertyName)
        {
            ...
            return this.orderedContainmentPropertyValueMap[propertyName]((CDP4Common.DTO.PossibleFiniteStateList)possibleFiniteStateList);
        }
        ...
        private readonly Dictionary<string, PropertyMetaInfo> containmentTypeMap = new Dictionary<string, PropertyMetaInfo>
        {
            ...
            { "PossibleState", new PropertyMetaInfo("PossibleState", "Guid", PropertyKind.OrderedList, AggregationKind.Composite, false, true, true, 1, "*", true) },
        };

        /// <summary>
        /// Gets the <see cref="PropertyMetaInfo"/> for the <see cref="PossibleFiniteStateList"/> class
        /// </summary>
        ...
        private readonly Dictionary<string, PropertyMetaInfo> propertyTypeMap = new Dictionary<string, PropertyMetaInfo>
        {
            ...
            { "DefaultState", new PropertyMetaInfo("DefaultState", "Guid", PropertyKind.Scalar, AggregationKind.None, false, false, true, 0, "1", true) },
        ...
        {
            { "Iteration", new PropertyMetaInfo("PossibleFiniteStateList", "Guid", PropertyKind.List, AggregationKind.Composite, false, false, true, 0, "*", true) },
        };
        ...
        /// <summary>
        /// Returns the <see cref="CDP4Common.DTO.PossibleFiniteStateList"/> containment property type from the supplied property name.
        /// </summary>
        /// <param name="propertyName">
        ...
        /// <summary>
        /// Returns the <see cref="CDP4Common.DTO.PossibleFiniteStateList"/> property type from the supplied property name.
        /// </summary>
        /// <param name="propertyName">
        /// The property name.
        /// </param>
        ...
        /// <summary>
        /// Returns the container property for the supplied type name is a possible container for <see cref="CDP4Common.DTO.PossibleFiniteStateList"/>.
        /// </summary>
        /// <param name="typeName">
        /// Name of the type for which to check if it is a container of <see cref="CDP4Common.DTO.PossibleFiniteStateList"/>.
        /// </param>
        /// <param name="containerProperty">
        /// Supplied container property info instance that will be set if the supplied type name is a container of <see cref="CDP4Common.DTO.PossibleFiniteStateList"/>.
        /// </param>
        /// <returns>
        /// True if the supplied typeName is a container for <see cref="CDP4Common.DTO.PossibleFiniteStateList"/> and sets the container property name.
        /// </returns>
        ...
        /// <summary>
        /// Check if the supplied property name for <see cref="CDP4Common.DTO.PossibleFiniteStateList"/> is scalar.
        /// </summary>
        /// <param name="propertyName">
        /// Name of the property for which to check if it is scalar.
        /// </param>
        ...
        public object DeserializeCollectionValue(string propertyName, object value)
        {
            ...
            {
                throw new ArgumentException(string.Format("'{0}' is not a valid collection property of 'PossibleFiniteStateList'", propertyName));
            }
        ...
        public object GetValue(string propertyName, CDP4Common.DTO.Thing thing)
        {
            ...
            return this.propertyValueMap[propertyName]((CDP4Common.DTO.PossibleFiniteStateList)thing);
        }
        ...
        /// <summary>
        /// Instantiates a <see cref="CDP4Common.DTO.PossibleFiniteStateList"/>
        /// </summary>
        /// <returns>
        ...
        {
            return new CDP4Common.DTO.PossibleFiniteStateList(guid, revisionNumber);
        }
    }
}
