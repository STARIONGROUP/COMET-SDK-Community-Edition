// --------------------------------------------------------------------------------------------------------------------
// <copyright file="ActionItemMetaInfo.cs" company="RHEA System S.A.">
...
namespace CDP4Common.MetaInfo
{
    ...
    /// <summary>
    /// This a class that holds meta info for <see cref="ActionItem"/>.
    /// </summary>
    public partial class ActionItemMetaInfo : IActionItemMetaInfo
    {
        /// <summary>
        /// The containment property value map.
        /// </summary>
        private readonly Dictionary<string, Func<CDP4Common.DTO.ActionItem, IEnumerable<Guid>>> containmentPropertyValueMap = new Dictionary<string, Func<CDP4Common.DTO.ActionItem, IEnumerable<Guid>>>
        {
            { "ApprovedBy", actionItem => actionItem.ApprovedBy },
            { "Discussion", actionItem => actionItem.Discussion },
            { "RelatedThing", actionItem => actionItem.RelatedThing },
        };

        /// <summary>
        /// The ordered containment property value map.
        /// </summary>
        private readonly Dictionary<string, Func<CDP4Common.DTO.ActionItem, IEnumerable<OrderedItem>>> orderedContainmentPropertyValueMap = new Dictionary<string, Func<CDP4Common.DTO.ActionItem, IEnumerable<OrderedItem>>>();

        /// <summary>
        /// The validation rules that should pass for an instance of <see cref="CDP4Common.DTO.ActionItem"/>.
        /// </summary>
        private readonly Dictionary<string, DtoValidationHelper<CDP4Common.DTO.ActionItem>> validationRules = new Dictionary<string, DtoValidationHelper<CDP4Common.DTO.ActionItem>>
        {
            { "ApprovedBy", new DtoValidationHelper<CDP4Common.DTO.ActionItem>(item => item.ApprovedBy != null, "The 'ApprovedBy' property of a 'ActionItem' is mandatory and cannot be null.") },
            { "Category", new DtoValidationHelper<CDP4Common.DTO.ActionItem>(item => item.Category != null, "The 'Category' property of a 'ActionItem' is mandatory and cannot be null.") },
            { "Content", new DtoValidationHelper<CDP4Common.DTO.ActionItem>(item => !string.IsNullOrWhiteSpace(item.Content), "The 'Content' property of a 'ActionItem' is mandatory and cannot be empty or null.") },
            { "Discussion", new DtoValidationHelper<CDP4Common.DTO.ActionItem>(item => item.Discussion != null, "The 'Discussion' property of a 'ActionItem' is mandatory and cannot be null.") },
            { "ExcludedDomain", new DtoValidationHelper<CDP4Common.DTO.ActionItem>(item => item.ExcludedDomain != null, "The 'ExcludedDomain' property of a 'ActionItem' is mandatory and cannot be null.") },
            { "ExcludedPerson", new DtoValidationHelper<CDP4Common.DTO.ActionItem>(item => item.ExcludedPerson != null, "The 'ExcludedPerson' property of a 'ActionItem' is mandatory and cannot be null.") },
            { "LanguageCode", new DtoValidationHelper<CDP4Common.DTO.ActionItem>(item => !string.IsNullOrWhiteSpace(item.LanguageCode), "The 'LanguageCode' property of a 'ActionItem' is mandatory and cannot be empty or null.") },
            { "RelatedThing", new DtoValidationHelper<CDP4Common.DTO.ActionItem>(item => item.RelatedThing != null, "The 'RelatedThing' property of a 'ActionItem' is mandatory and cannot be null.") },
            { "ShortName", new DtoValidationHelper<CDP4Common.DTO.ActionItem>(item => !string.IsNullOrWhiteSpace(item.ShortName), "The 'ShortName' property of a 'ActionItem' is mandatory and cannot be empty or null.") },
            { "SourceAnnotation", new DtoValidationHelper<CDP4Common.DTO.ActionItem>(item => item.SourceAnnotation != null, "The 'SourceAnnotation' property of a 'ActionItem' is mandatory and cannot be null.") },
            { "Title", new DtoValidationHelper<CDP4Common.DTO.ActionItem>(item => !string.IsNullOrWhiteSpace(item.Title), "The 'Title' property of a 'ActionItem' is mandatory and cannot be empty or null.") },
        };
        ...
        /// </exception>
        public void Validate(CDP4Common.DTO.Thing actionItem)
        {
            this.Validate(actionItem, x => true);
        }
        ...
        /// If any validation rule failed.
        /// </exception>
        public void Validate(CDP4Common.DTO.Thing actionItem, Func<string, bool> validateProperty)
        {
            foreach (var applicableRule in this.validationRules.Where(x => validateProperty(x.Key)))
            {
                applicableRule.Value.Validate((CDP4Common.DTO.ActionItem)actionItem);
            }
        }
        ...
        /// </returns>
        public bool TryValidate(CDP4Common.DTO.Thing actionItem)
        {
            return this.TryValidate(actionItem, x => true);
        }
        ...
        /// True if all validation rules have passed or if none are defined.
        /// </returns>
        public bool TryValidate(CDP4Common.DTO.Thing actionItem, Func<string, bool> validateProperty)
        {
            var applicableValidationRules = this.validationRules.Where(x => validateProperty(x.Key)).Select(x => x.Value);

            return applicableValidationRules.All(applicableRule => applicableRule.TryValidate((CDP4Common.DTO.ActionItem)actionItem));
        }

        /// <summary>
        /// Returns the containment property value for the supplied <see cref="CDP4Common.DTO.ActionItem"/>.
        /// </summary>
        /// <param name="actionItem">
        /// The <see cref="CDP4Common.DTO.ActionItem"/> for which to return the containment property value.
        /// </param>
        ...
        /// If the property name is not supported for the <see cref="CDP4Common.DTO.ActionItem"/>.
        /// </exception>
        public IEnumerable<Guid> GetContainmentIds(CDP4Common.DTO.Thing actionItem, string propertyName)
        {
            if (!this.containmentPropertyValueMap.ContainsKey(propertyName))
            {
                throw new ArgumentException(string.Format("'{0}' is not a valid containment property of 'ActionItem'", propertyName));
            }

            return this.containmentPropertyValueMap[propertyName]((CDP4Common.DTO.ActionItem)actionItem);
        }

        /// <summary>
        /// Returns the ordered containment property value for the supplied <see cref="CDP4Common.DTO.ActionItem"/>.
        /// </summary>
        /// <param name="actionItem">
        /// The <see cref="CDP4Common.DTO.ActionItem"/> for which to return the containment property value.
        /// </param>
        ...
        /// If the property name is not supported for the <see cref="CDP4Common.DTO.ActionItem"/>.
        /// </exception>
        public IEnumerable<OrderedItem> GetOrderedContainmentIds(CDP4Common.DTO.Thing actionItem, string propertyName)
        {
            ...
            return this.orderedContainmentPropertyValueMap[propertyName]((CDP4Common.DTO.ActionItem)actionItem);
        }
        ...
        /// <summary>
        /// Gets the <see cref="PropertyMetaInfo"/> for the <see cref="ActionItem"/> class
        /// </summary>
        ...
        private readonly Dictionary<string, Func<CDP4Common.DTO.ActionItem, object>> propertyValueMap = new Dictionary<string, Func<CDP4Common.DTO.ActionItem, object>>
        {
            ...
            { "CloseOutDate", thing => thing.CloseOutDate },
            { "CloseOutStatement", thing => thing.CloseOutStatement },
            { "Content", thing => thing.Content },
            { "CreatedOn", thing => thing.CreatedOn },
            { "Discussion", thing => thing.Discussion },
            { "DueDate", thing => thing.DueDate },
        ...
        {
            { "Actionee", new PropertyMetaInfo("Actionee", "Guid", PropertyKind.Scalar, AggregationKind.None, false, false, true, 1, "1", true) },
            ...
            { "CloseOutDate", new PropertyMetaInfo("CloseOutDate", "DateTime", PropertyKind.Scalar, AggregationKind.None, false, false, true, 0, "1", true) },
            { "CloseOutStatement", new PropertyMetaInfo("CloseOutStatement", "string", PropertyKind.Scalar, AggregationKind.None, false, false, true, 0, "1", true) },
            ...
            { "DueDate", new PropertyMetaInfo("DueDate", "DateTime", PropertyKind.Scalar, AggregationKind.None, false, false, true, 1, "1", true) },
        ...
        private readonly Dictionary<string, Action<CDP4Common.DTO.ActionItem, object>> propertyValueAssignmentMap = new Dictionary<string, Action<CDP4Common.DTO.ActionItem, object>>
        {
            ...
            { "CloseOutStatement", (actionItem, value) => actionItem.CloseOutStatement = value == null ? (string)null : value.ToString() },
            { "Content", (actionItem, value) => actionItem.Content = value.ToString() },
            { "CreatedOn", (actionItem, value) => actionItem.CreatedOn = (DateTime)value },
            { "DueDate", (actionItem, value) => actionItem.DueDate = (DateTime)value },
            { "Iid", (actionItem, value) => actionItem.Iid = (Guid)value },
            { "LanguageCode", (actionItem, value) => actionItem.LanguageCode = value.ToString() },
            { "ModifiedOn", (actionItem, value) => actionItem.ModifiedOn = (DateTime)value },
            { "Owner", (actionItem, value) => actionItem.Owner = (Guid)value },
            { "PrimaryAnnotatedThing", (actionItem, value) => actionItem.PrimaryAnnotatedThing = value == null ? (Guid?)null : (Guid)value },
            { "ShortName", (actionItem, value) => actionItem.ShortName = value.ToString() },
            { "Status", (actionItem, value) => actionItem.Status = (AnnotationStatusKind)value },
            { "Title", (actionItem, value) => actionItem.Title = value.ToString() },
        };
        ...
        /// <summary>
        /// Returns the <see cref="CDP4Common.DTO.ActionItem"/> containment property type from the supplied property name.
        /// </summary>
        /// <param name="propertyName">
        ...
        /// <summary>
        /// Returns the <see cref="CDP4Common.DTO.ActionItem"/> property type from the supplied property name.
        /// </summary>
        /// <param name="propertyName">
        /// The property name.
        /// </param>
        ...
        /// <summary>
        /// Returns the container property for the supplied type name is a possible container for <see cref="CDP4Common.DTO.ActionItem"/>.
        /// </summary>
        /// <param name="typeName">
        /// Name of the type for which to check if it is a container of <see cref="CDP4Common.DTO.ActionItem"/>.
        /// </param>
        /// <param name="containerProperty">
        /// Supplied container property info instance that will be set if the supplied type name is a container of <see cref="CDP4Common.DTO.ActionItem"/>.
        /// </param>
        /// <returns>
        /// True if the supplied typeName is a container for <see cref="CDP4Common.DTO.ActionItem"/> and sets the container property name.
        /// </returns>
        ...
        /// <summary>
        /// Check if the supplied property name for <see cref="CDP4Common.DTO.ActionItem"/> is scalar.
        /// </summary>
        /// <param name="propertyName">
        /// Name of the property for which to check if it is scalar.
        /// </param>
        ...
        public bool ApplyPropertyUpdate(CDP4Common.DTO.Thing updatableThing, string propertyName, object value)
        {
            ...
            this.propertyValueAssignmentMap[propertyName]((CDP4Common.DTO.ActionItem)updatableThing, value);
        ...
        public object DeserializeCollectionValue(string propertyName, object value)
        {
            ...
            {
                throw new ArgumentException(string.Format("'{0}' is not a valid collection property of 'ActionItem'", propertyName));
            }
        ...
        public object GetValue(string propertyName, CDP4Common.DTO.Thing thing)
        {
            ...
            return this.propertyValueMap[propertyName]((CDP4Common.DTO.ActionItem)thing);
        }
        ...
        /// <summary>
        /// Instantiates a <see cref="CDP4Common.DTO.ActionItem"/>
        /// </summary>
        /// <returns>
        ...
        {
            return new CDP4Common.DTO.ActionItem(guid, revisionNumber);
        }
    }
}
