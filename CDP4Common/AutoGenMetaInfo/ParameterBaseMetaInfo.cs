// --------------------------------------------------------------------------------------------------------------------
// <copyright file="ParameterBaseMetaInfo.cs" company="Starion Group S.A.">
...
namespace CDP4Common.MetaInfo
{
    ...
    public partial class ParameterBaseMetaInfo : IParameterBaseMetaInfo
    {
        ...
        public IEnumerable<Guid> GetContainmentIds(CDP4Common.DTO.Thing parameterBase, string propertyName)
        {
            ...
            {
                throw new ArgumentException($"'{propertyName}' is not a valid containment property of 'ParameterBase'");
            }
        ...
        {
            { "Actor", (parameterBase, value) => parameterBase.Actor = value == null ? (Guid?)null : (Guid)value },
            ...
            { "ThingPreference", (parameterBase, value) => parameterBase.ThingPreference = value == null ? (string)null : value.ToString() },
        };
        ...
        public object DeserializeCollectionValue(string propertyName, object value)
        {
            ...
            {
                throw new ArgumentException($"'{propertyName}' is not a valid collection property of 'ParameterBase'");
            }
