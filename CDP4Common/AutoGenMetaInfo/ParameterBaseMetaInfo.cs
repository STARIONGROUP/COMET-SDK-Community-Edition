// --------------------------------------------------------------------------------------------------------------------
// <copyright file="ParameterBaseMetaInfo.cs" company="RHEA System S.A.">
...
namespace CDP4Common.MetaInfo
{
    ...
    /// <summary>
    /// This a class that holds meta info for <see cref="ParameterBase"/>.
    /// </summary>
    public partial class ParameterBaseMetaInfo : IParameterBaseMetaInfo
    {
        /// <summary>
        /// The containment property value map.
        /// </summary>
        private readonly Dictionary<string, Func<CDP4Common.DTO.ParameterBase, IEnumerable<Guid>>> containmentPropertyValueMap = new Dictionary<string, Func<CDP4Common.DTO.ParameterBase, IEnumerable<Guid>>>();

        /// <summary>
        /// The ordered containment property value map.
        /// </summary>
        private readonly Dictionary<string, Func<CDP4Common.DTO.ParameterBase, IEnumerable<OrderedItem>>> orderedContainmentPropertyValueMap = new Dictionary<string, Func<CDP4Common.DTO.ParameterBase, IEnumerable<OrderedItem>>>();

        /// <summary>
        /// The validation rules that should pass for an instance of <see cref="CDP4Common.DTO.ParameterBase"/>.
        /// </summary>
        private readonly Dictionary<string, DtoValidationHelper<CDP4Common.DTO.ParameterBase>> validationRules = new Dictionary<string, DtoValidationHelper<CDP4Common.DTO.ParameterBase>>
        {
            { "ExcludedDomain", new DtoValidationHelper<CDP4Common.DTO.ParameterBase>(item => item.ExcludedDomain != null, "The 'ExcludedDomain' property of a 'ParameterBase' is mandatory and cannot be null.") },
            { "ExcludedPerson", new DtoValidationHelper<CDP4Common.DTO.ParameterBase>(item => item.ExcludedPerson != null, "The 'ExcludedPerson' property of a 'ParameterBase' is mandatory and cannot be null.") },
        };
        ...
        /// </exception>
        public void Validate(CDP4Common.DTO.Thing parameterBase)
        {
            this.Validate(parameterBase, x => true);
        }
        ...
        /// If any validation rule failed.
        /// </exception>
        public void Validate(CDP4Common.DTO.Thing parameterBase, Func<string, bool> validateProperty)
        {
            foreach (var applicableRule in this.validationRules.Where(x => validateProperty(x.Key)))
            {
                applicableRule.Value.Validate((CDP4Common.DTO.ParameterBase)parameterBase);
            }
        }
        ...
        /// </returns>
        public bool TryValidate(CDP4Common.DTO.Thing parameterBase)
        {
            return this.TryValidate(parameterBase, x => true);
        }
        ...
        /// True if all validation rules have passed or if none are defined.
        /// </returns>
        public bool TryValidate(CDP4Common.DTO.Thing parameterBase, Func<string, bool> validateProperty)
        {
            var applicableValidationRules = this.validationRules.Where(x => validateProperty(x.Key)).Select(x => x.Value);

            return applicableValidationRules.All(applicableRule => applicableRule.TryValidate((CDP4Common.DTO.ParameterBase)parameterBase));
        }

        /// <summary>
        /// Returns the containment property value for the supplied <see cref="CDP4Common.DTO.ParameterBase"/>.
        /// </summary>
        /// <param name="parameterBase">
        /// The <see cref="CDP4Common.DTO.ParameterBase"/> for which to return the containment property value.
        /// </param>
        ...
        /// If the property name is not supported for the <see cref="CDP4Common.DTO.ParameterBase"/>.
        /// </exception>
        public IEnumerable<Guid> GetContainmentIds(CDP4Common.DTO.Thing parameterBase, string propertyName)
        {
            if (!this.containmentPropertyValueMap.ContainsKey(propertyName))
            {
                throw new ArgumentException(string.Format("'{0}' is not a valid containment property of 'ParameterBase'", propertyName));
            }

            return this.containmentPropertyValueMap[propertyName]((CDP4Common.DTO.ParameterBase)parameterBase);
        }

        /// <summary>
        /// Returns the ordered containment property value for the supplied <see cref="CDP4Common.DTO.ParameterBase"/>.
        /// </summary>
        /// <param name="parameterBase">
        /// The <see cref="CDP4Common.DTO.ParameterBase"/> for which to return the containment property value.
        /// </param>
        ...
        /// If the property name is not supported for the <see cref="CDP4Common.DTO.ParameterBase"/>.
        /// </exception>
        public IEnumerable<OrderedItem> GetOrderedContainmentIds(CDP4Common.DTO.Thing parameterBase, string propertyName)
        {
            ...
            return this.orderedContainmentPropertyValueMap[propertyName]((CDP4Common.DTO.ParameterBase)parameterBase);
        }
        ...
        /// <summary>
        /// Gets the <see cref="PropertyMetaInfo"/> for the <see cref="ParameterBase"/> class
        /// </summary>
        ...
        /// </summary>
        private readonly Dictionary<string, Func<CDP4Common.DTO.ParameterBase, object>> propertyValueMap = new Dictionary<string, Func<CDP4Common.DTO.ParameterBase, object>>
        {
        ...
        /// </summary>
        private readonly Dictionary<string, Action<CDP4Common.DTO.ParameterBase, object>> propertyValueAssignmentMap = new Dictionary<string, Action<CDP4Common.DTO.ParameterBase, object>>
        {
            { "Group", (parameterBase, value) => parameterBase.Group = value == null ? (Guid?)null : (Guid)value },
            { "Iid", (parameterBase, value) => parameterBase.Iid = (Guid)value },
            { "IsOptionDependent", (parameterBase, value) => parameterBase.IsOptionDependent = (bool)value },
            { "ModifiedOn", (parameterBase, value) => parameterBase.ModifiedOn = (DateTime)value },
            { "Owner", (parameterBase, value) => parameterBase.Owner = (Guid)value },
            { "ParameterType", (parameterBase, value) => parameterBase.ParameterType = (Guid)value },
            { "Scale", (parameterBase, value) => parameterBase.Scale = value == null ? (Guid?)null : (Guid)value },
            { "StateDependence", (parameterBase, value) => parameterBase.StateDependence = value == null ? (Guid?)null : (Guid)value },
        };
        ...
        /// <summary>
        /// Returns the <see cref="CDP4Common.DTO.ParameterBase"/> containment property type from the supplied property name.
        /// </summary>
        /// <param name="propertyName">
        ...
        /// <summary>
        /// Returns the <see cref="CDP4Common.DTO.ParameterBase"/> property type from the supplied property name.
        /// </summary>
        /// <param name="propertyName">
        /// The property name.
        /// </param>
        ...
        /// <summary>
        /// Returns the container property for the supplied type name is a possible container for <see cref="CDP4Common.DTO.ParameterBase"/>.
        /// </summary>
        /// <param name="typeName">
        /// Name of the type for which to check if it is a container of <see cref="CDP4Common.DTO.ParameterBase"/>.
        /// </param>
        /// <param name="containerProperty">
        /// Supplied container property info instance that will be set if the supplied type name is a container of <see cref="CDP4Common.DTO.ParameterBase"/>.
        /// </param>
        /// <returns>
        /// True if the supplied typeName is a container for <see cref="CDP4Common.DTO.ParameterBase"/> and sets the container property name.
        /// </returns>
        ...
        /// <summary>
        /// Check if the supplied property name for <see cref="CDP4Common.DTO.ParameterBase"/> is scalar.
        /// </summary>
        /// <param name="propertyName">
        /// Name of the property for which to check if it is scalar.
        /// </param>
        ...
        public bool ApplyPropertyUpdate(CDP4Common.DTO.Thing updatableThing, string propertyName, object value)
        {
            ...
            this.propertyValueAssignmentMap[propertyName]((CDP4Common.DTO.ParameterBase)updatableThing, value);
        ...
        public object DeserializeCollectionValue(string propertyName, object value)
        {
            ...
            {
                throw new ArgumentException(string.Format("'{0}' is not a valid collection property of 'ParameterBase'", propertyName));
            }
        ...
        public object GetValue(string propertyName, CDP4Common.DTO.Thing thing)
        {
            ...
            return this.propertyValueMap[propertyName]((CDP4Common.DTO.ParameterBase)thing);
        }
        ...
        /// <summary>
        /// Instantiates a <see cref="CDP4Common.DTO.ParameterBase"/>
        /// </summary>
        /// <returns>
