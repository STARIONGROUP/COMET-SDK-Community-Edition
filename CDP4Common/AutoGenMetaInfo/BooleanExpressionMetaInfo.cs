...
namespace CDP4Common.MetaInfo
{
    ...
    public partial class BooleanExpressionMetaInfo : IBooleanExpressionMetaInfo
    {
        ...
        public IEnumerable<Guid> GetContainmentIds(CDP4Common.DTO.Thing booleanExpression, string propertyName)
        {
            ...
            {
                throw new ArgumentException(string.Format("'{0}' is not a valid containment property of 'BooleanExpression'", propertyName));
            }
        ...
        public object DeserializeCollectionValue(string propertyName, object value)
        {
            ...
            {
                throw new ArgumentException(string.Format("'{0}' is not a valid collection property of 'BooleanExpression'", propertyName));
            }
