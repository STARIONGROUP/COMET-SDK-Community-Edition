// --------------------------------------------------------------------------------------------------------------------
// <copyright file="BooleanExpressionMetaInfo.cs" company="Starion Group S.A.">
...
namespace CDP4Common.MetaInfo
{
    ...
    /// <summary>
    /// This a class that holds meta info for <see cref="BooleanExpression"/>.
    /// </summary>
    public partial class BooleanExpressionMetaInfo : IBooleanExpressionMetaInfo
    {
        /// <summary>
        /// The containment property value map.
        /// </summary>
        private readonly Dictionary<string, Func<CDP4Common.DTO.BooleanExpression, IEnumerable<Guid>>> containmentPropertyValueMap = new Dictionary<string, Func<CDP4Common.DTO.BooleanExpression, IEnumerable<Guid>>>();

        /// <summary>
        /// The ordered containment property value map.
        /// </summary>
        private readonly Dictionary<string, Func<CDP4Common.DTO.BooleanExpression, IEnumerable<OrderedItem>>> orderedContainmentPropertyValueMap = new Dictionary<string, Func<CDP4Common.DTO.BooleanExpression, IEnumerable<OrderedItem>>>();

        /// <summary>
        /// The validation rules that should pass for an instance of <see cref="CDP4Common.DTO.BooleanExpression"/>.
        /// </summary>
        private readonly Dictionary<string, DtoValidationHelper<CDP4Common.DTO.BooleanExpression>> validationRules = new Dictionary<string, DtoValidationHelper<CDP4Common.DTO.BooleanExpression>>
        {
            { "ExcludedDomain", new DtoValidationHelper<CDP4Common.DTO.BooleanExpression>(item => item.ExcludedDomain != null, "The 'ExcludedDomain' property of a 'BooleanExpression' is mandatory and cannot be null.") },
            { "ExcludedPerson", new DtoValidationHelper<CDP4Common.DTO.BooleanExpression>(item => item.ExcludedPerson != null, "The 'ExcludedPerson' property of a 'BooleanExpression' is mandatory and cannot be null.") },
        };
        ...
        /// </exception>
        public void Validate(CDP4Common.DTO.Thing booleanExpression)
        {
            this.Validate(booleanExpression, x => true);
        }
        ...
        /// If any validation rule failed.
        /// </exception>
        public void Validate(CDP4Common.DTO.Thing booleanExpression, Func<string, bool> validateProperty)
        {
            foreach (var applicableRule in this.validationRules.Where(x => validateProperty(x.Key)))
            {
                applicableRule.Value.Validate((CDP4Common.DTO.BooleanExpression)booleanExpression);
            }
        }
        ...
        /// </returns>
        public bool TryValidate(CDP4Common.DTO.Thing booleanExpression)
        {
            return this.TryValidate(booleanExpression, x => true);
        }
        ...
        /// True if all validation rules have passed or if none are defined.
        /// </returns>
        public bool TryValidate(CDP4Common.DTO.Thing booleanExpression, Func<string, bool> validateProperty)
        {
            var applicableValidationRules = this.validationRules.Where(x => validateProperty(x.Key)).Select(x => x.Value);

            return applicableValidationRules.All(applicableRule => applicableRule.TryValidate((CDP4Common.DTO.BooleanExpression)booleanExpression));
        }

        /// <summary>
        /// Returns the containment property value for the supplied <see cref="CDP4Common.DTO.BooleanExpression"/>.
        /// </summary>
        /// <param name="booleanExpression">
        /// The <see cref="CDP4Common.DTO.BooleanExpression"/> for which to return the containment property value.
        /// </param>
        ...
        /// If the property name is not supported for the <see cref="CDP4Common.DTO.BooleanExpression"/>.
        /// </exception>
        public IEnumerable<Guid> GetContainmentIds(CDP4Common.DTO.Thing booleanExpression, string propertyName)
        {
            if (!this.containmentPropertyValueMap.ContainsKey(propertyName))
            {
                throw new ArgumentException($"'{propertyName}' is not a valid containment property of 'BooleanExpression'");
            }

            return this.containmentPropertyValueMap[propertyName]((CDP4Common.DTO.BooleanExpression)booleanExpression);
        }

        /// <summary>
        /// Returns the ordered containment property value for the supplied <see cref="CDP4Common.DTO.BooleanExpression"/>.
        /// </summary>
        /// <param name="booleanExpression">
        /// The <see cref="CDP4Common.DTO.BooleanExpression"/> for which to return the containment property value.
        /// </param>
        ...
        /// If the property name is not supported for the <see cref="CDP4Common.DTO.BooleanExpression"/>.
        /// </exception>
        public IEnumerable<OrderedItem> GetOrderedContainmentIds(CDP4Common.DTO.Thing booleanExpression, string propertyName)
        {
            ...
            return this.orderedContainmentPropertyValueMap[propertyName]((CDP4Common.DTO.BooleanExpression)booleanExpression);
        }
        ...
        /// <summary>
        /// Gets the <see cref="PropertyMetaInfo"/> for the <see cref="BooleanExpression"/> class
        /// </summary>
        ...
        /// </summary>
        private readonly Dictionary<string, Func<CDP4Common.DTO.BooleanExpression, object>> propertyValueMap = new Dictionary<string, Func<CDP4Common.DTO.BooleanExpression, object>>
        {
        ...
        /// </summary>
        private readonly Dictionary<string, Action<CDP4Common.DTO.BooleanExpression, object>> propertyValueAssignmentMap = new Dictionary<string, Action<CDP4Common.DTO.BooleanExpression, object>>
        {
            { "Actor", (booleanExpression, value) => booleanExpression.Actor = value == null ? (Guid?)null : (Guid)value },
            { "Iid", (booleanExpression, value) => booleanExpression.Iid = (Guid)value },
            { "ModifiedOn", (booleanExpression, value) => booleanExpression.ModifiedOn = (DateTime)value },
            { "ThingPreference", (booleanExpression, value) => booleanExpression.ThingPreference = value == null ? (string)null : value.ToString() },
        };
        ...
        /// <summary>
        /// Returns the <see cref="CDP4Common.DTO.BooleanExpression"/> containment property type from the supplied property name.
        /// </summary>
        /// <param name="propertyName">
        ...
        /// <summary>
        /// Returns the <see cref="CDP4Common.DTO.BooleanExpression"/> property type from the supplied property name.
        /// </summary>
        /// <param name="propertyName">
        /// The property name.
        /// </param>
        ...
        /// <summary>
        /// Returns the container property for the supplied type name is a possible container for <see cref="CDP4Common.DTO.BooleanExpression"/>.
        /// </summary>
        /// <param name="typeName">
        /// Name of the type for which to check if it is a container of <see cref="CDP4Common.DTO.BooleanExpression"/>.
        /// </param>
        /// <param name="containerProperty">
        /// Supplied container property info instance that will be set if the supplied type name is a container of <see cref="CDP4Common.DTO.BooleanExpression"/>.
        /// </param>
        /// <returns>
        /// True if the supplied typeName is a container for <see cref="CDP4Common.DTO.BooleanExpression"/> and sets the container property name.
        /// </returns>
        ...
        /// <summary>
        /// Check if the supplied property name for <see cref="CDP4Common.DTO.BooleanExpression"/> is scalar.
        /// </summary>
        /// <param name="propertyName">
        /// Name of the property for which to check if it is scalar.
        /// </param>
        ...
        public bool ApplyPropertyUpdate(CDP4Common.DTO.Thing updatableThing, string propertyName, object value)
        {
            ...
            this.propertyValueAssignmentMap[propertyName]((CDP4Common.DTO.BooleanExpression)updatableThing, value);
        ...
        public object DeserializeCollectionValue(string propertyName, object value)
        {
            ...
            {
                throw new ArgumentException($"'{propertyName}' is not a valid collection property of 'BooleanExpression'");
            }
        ...
        public object GetValue(string propertyName, CDP4Common.DTO.Thing thing)
        {
            ...
            return this.propertyValueMap[propertyName]((CDP4Common.DTO.BooleanExpression)thing);
        }
        ...
        /// <summary>
        /// Instantiates a <see cref="CDP4Common.DTO.BooleanExpression"/>
        /// </summary>
        /// <returns>
