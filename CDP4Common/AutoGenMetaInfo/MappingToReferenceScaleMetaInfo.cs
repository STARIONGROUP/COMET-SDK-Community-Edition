// --------------------------------------------------------------------------------------------------------------------
// <copyright file="MappingToReferenceScaleMetaInfo.cs" company="Starion Group S.A.">
...
namespace CDP4Common.MetaInfo
{
    ...
    /// </summary>
    public partial class MappingToReferenceScaleMetaInfo : IMappingToReferenceScaleMetaInfo
    {
        /// <summary>
        /// The containment property value map.
        /// </summary>
        private readonly Dictionary<string, Func<CDP4Common.DTO.MappingToReferenceScale, IEnumerable<Guid>>> containmentPropertyValueMap = new Dictionary<string, Func<CDP4Common.DTO.MappingToReferenceScale, IEnumerable<Guid>>>();

        /// <summary>
        /// The ordered containment property value map.
        /// </summary>
        private readonly Dictionary<string, Func<CDP4Common.DTO.MappingToReferenceScale, IEnumerable<OrderedItem>>> orderedContainmentPropertyValueMap = new Dictionary<string, Func<CDP4Common.DTO.MappingToReferenceScale, IEnumerable<OrderedItem>>>();

        /// <summary>
        /// The validation rules that should pass for an instance of <see cref="CDP4Common.DTO.MappingToReferenceScale"/>.
        /// </summary>
        private readonly Dictionary<string, DtoValidationHelper<CDP4Common.DTO.MappingToReferenceScale>> validationRules = new Dictionary<string, DtoValidationHelper<CDP4Common.DTO.MappingToReferenceScale>>
        {
            { "ExcludedDomain", new DtoValidationHelper<CDP4Common.DTO.MappingToReferenceScale>(item => item.ExcludedDomain != null, "The 'ExcludedDomain' property of a 'MappingToReferenceScale' is mandatory and cannot be null.") },
            { "ExcludedPerson", new DtoValidationHelper<CDP4Common.DTO.MappingToReferenceScale>(item => item.ExcludedPerson != null, "The 'ExcludedPerson' property of a 'MappingToReferenceScale' is mandatory and cannot be null.") },
        };
        ...
        /// </exception>
        public void Validate(CDP4Common.DTO.Thing mappingToReferenceScale)
        {
            this.Validate(mappingToReferenceScale, x => true);
        }
        ...
        /// If any validation rule failed.
        /// </exception>
        public void Validate(CDP4Common.DTO.Thing mappingToReferenceScale, Func<string, bool> validateProperty)
        {
            foreach (var applicableRule in this.validationRules.Where(x => validateProperty(x.Key)))
            {
                applicableRule.Value.Validate((CDP4Common.DTO.MappingToReferenceScale)mappingToReferenceScale);
            }
        }
        ...
        /// </returns>
        public bool TryValidate(CDP4Common.DTO.Thing mappingToReferenceScale)
        {
            return this.TryValidate(mappingToReferenceScale, x => true);
        }
        ...
        /// True if all validation rules have passed or if none are defined.
        /// </returns>
        public bool TryValidate(CDP4Common.DTO.Thing mappingToReferenceScale, Func<string, bool> validateProperty)
        {
            var applicableValidationRules = this.validationRules.Where(x => validateProperty(x.Key)).Select(x => x.Value);

            return applicableValidationRules.All(applicableRule => applicableRule.TryValidate((CDP4Common.DTO.MappingToReferenceScale)mappingToReferenceScale));
        }

        /// <summary>
        /// Returns the containment property value for the supplied <see cref="CDP4Common.DTO.MappingToReferenceScale"/>.
        /// </summary>
        /// <param name="mappingToReferenceScale">
        /// The <see cref="CDP4Common.DTO.MappingToReferenceScale"/> for which to return the containment property value.
        /// </param>
        ...
        /// If the property name is not supported for the <see cref="CDP4Common.DTO.MappingToReferenceScale"/>.
        /// </exception>
        public IEnumerable<Guid> GetContainmentIds(CDP4Common.DTO.Thing mappingToReferenceScale, string propertyName)
        {
            if (!this.containmentPropertyValueMap.ContainsKey(propertyName))
            {
                throw new ArgumentException($"'{propertyName}' is not a valid containment property of 'MappingToReferenceScale'");
            }

            return this.containmentPropertyValueMap[propertyName]((CDP4Common.DTO.MappingToReferenceScale)mappingToReferenceScale);
        }

        /// <summary>
        /// Returns the ordered containment property value for the supplied <see cref="CDP4Common.DTO.MappingToReferenceScale"/>.
        /// </summary>
        /// <param name="mappingToReferenceScale">
        /// The <see cref="CDP4Common.DTO.MappingToReferenceScale"/> for which to return the containment property value.
        /// </param>
        ...
        /// If the property name is not supported for the <see cref="CDP4Common.DTO.MappingToReferenceScale"/>.
        /// </exception>
        public IEnumerable<OrderedItem> GetOrderedContainmentIds(CDP4Common.DTO.Thing mappingToReferenceScale, string propertyName)
        {
            ...
            return this.orderedContainmentPropertyValueMap[propertyName]((CDP4Common.DTO.MappingToReferenceScale)mappingToReferenceScale);
        }
        ...
        /// <summary>
        /// Gets the <see cref="PropertyMetaInfo"/> for the <see cref="MappingToReferenceScale"/> class
        /// </summary>
        ...
        /// </summary>
        private readonly Dictionary<string, Func<CDP4Common.DTO.MappingToReferenceScale, object>> propertyValueMap = new Dictionary<string, Func<CDP4Common.DTO.MappingToReferenceScale, object>>
        {
            { "Actor", thing => thing.Actor },
            { "ClassKind", thing => thing.ClassKind },
            { "DependentScaleValue", thing => thing.DependentScaleValue },
            { "ExcludedDomain", thing => thing.ExcludedDomain },
            { "ExcludedPerson", thing => thing.ExcludedPerson },
            { "Iid", thing => thing.Iid },
            { "ModifiedOn", thing => thing.ModifiedOn },
            { "ReferenceScaleValue", thing => thing.ReferenceScaleValue },
        ...
        /// </summary>
        private readonly Dictionary<string, Action<CDP4Common.DTO.MappingToReferenceScale, object>> propertyValueAssignmentMap = new Dictionary<string, Action<CDP4Common.DTO.MappingToReferenceScale, object>>
        {
            { "Actor", (mappingToReferenceScale, value) => mappingToReferenceScale.Actor = value == null ? (Guid?)null : (Guid)value },
            { "DependentScaleValue", (mappingToReferenceScale, value) => mappingToReferenceScale.DependentScaleValue = (Guid)value },
            { "Iid", (mappingToReferenceScale, value) => mappingToReferenceScale.Iid = (Guid)value },
            { "ModifiedOn", (mappingToReferenceScale, value) => mappingToReferenceScale.ModifiedOn = (DateTime)value },
            { "ReferenceScaleValue", (mappingToReferenceScale, value) => mappingToReferenceScale.ReferenceScaleValue = (Guid)value },
            { "ThingPreference", (mappingToReferenceScale, value) => mappingToReferenceScale.ThingPreference = value == null ? (string)null : value.ToString() },
        };
        ...
        /// <summary>
        /// Returns the <see cref="CDP4Common.DTO.MappingToReferenceScale"/> containment property type from the supplied property name.
        /// </summary>
        /// <param name="propertyName">
        ...
        /// <summary>
        /// Returns the <see cref="CDP4Common.DTO.MappingToReferenceScale"/> property type from the supplied property name.
        /// </summary>
        /// <param name="propertyName">
        /// The property name.
        /// </param>
        ...
        /// <summary>
        /// Returns the container property for the supplied type name is a possible container for <see cref="CDP4Common.DTO.MappingToReferenceScale"/>.
        /// </summary>
        /// <param name="typeName">
        /// Name of the type for which to check if it is a container of <see cref="CDP4Common.DTO.MappingToReferenceScale"/>.
        /// </param>
        /// <param name="containerProperty">
        /// Supplied container property info instance that will be set if the supplied type name is a container of <see cref="CDP4Common.DTO.MappingToReferenceScale"/>.
        /// </param>
        /// <returns>
        /// True if the supplied typeName is a container for <see cref="CDP4Common.DTO.MappingToReferenceScale"/> and sets the container property name.
        /// </returns>
        ...
        /// <summary>
        /// Check if the supplied property name for <see cref="CDP4Common.DTO.MappingToReferenceScale"/> is scalar.
        /// </summary>
        /// <param name="propertyName">
        /// Name of the property for which to check if it is scalar.
        /// </param>
        ...
        public bool ApplyPropertyUpdate(CDP4Common.DTO.Thing updatableThing, string propertyName, object value)
        {
            ...
            this.propertyValueAssignmentMap[propertyName]((CDP4Common.DTO.MappingToReferenceScale)updatableThing, value);
        ...
        public object DeserializeCollectionValue(string propertyName, object value)
        {
            ...
            {
                throw new ArgumentException($"'{propertyName}' is not a valid collection property of 'MappingToReferenceScale'");
            }
        ...
        public object GetValue(string propertyName, CDP4Common.DTO.Thing thing)
        {
            ...
            return this.propertyValueMap[propertyName]((CDP4Common.DTO.MappingToReferenceScale)thing);
        }
        ...
        /// <summary>
        /// Instantiates a <see cref="CDP4Common.DTO.MappingToReferenceScale"/>
        /// </summary>
        /// <returns>
        ...
        {
            return new CDP4Common.DTO.MappingToReferenceScale(guid, revisionNumber);
        }
    }
}
