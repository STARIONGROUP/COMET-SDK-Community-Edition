...
namespace CDP4Common.MetaInfo
{
    ...
    public partial class MappingToReferenceScaleMetaInfo : IMappingToReferenceScaleMetaInfo
    {
        ...
        public IEnumerable<Guid> GetContainmentIds(CDP4Common.DTO.Thing mappingToReferenceScale, string propertyName)
        {
            ...
            {
                throw new ArgumentException(string.Format("'{0}' is not a valid containment property of 'MappingToReferenceScale'", propertyName));
            }
        ...
        public object DeserializeCollectionValue(string propertyName, object value)
        {
            ...
            {
                throw new ArgumentException(string.Format("'{0}' is not a valid collection property of 'MappingToReferenceScale'", propertyName));
            }
