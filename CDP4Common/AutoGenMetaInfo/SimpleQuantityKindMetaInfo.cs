...
namespace CDP4Common.MetaInfo
{
    ...
    public partial class SimpleQuantityKindMetaInfo : ISimpleQuantityKindMetaInfo
    {
        ...
        public IEnumerable<Guid> GetContainmentIds(CDP4Common.DTO.Thing simpleQuantityKind, string propertyName)
        {
            ...
            {
                throw new ArgumentException(string.Format("'{0}' is not a valid containment property of 'SimpleQuantityKind'", propertyName));
            }
        ...
        public object DeserializeCollectionValue(string propertyName, object value)
        {
            ...
            {
                throw new ArgumentException(string.Format("'{0}' is not a valid collection property of 'SimpleQuantityKind'", propertyName));
            }
