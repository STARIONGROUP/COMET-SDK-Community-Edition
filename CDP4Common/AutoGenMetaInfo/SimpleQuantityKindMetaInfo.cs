// --------------------------------------------------------------------------------------------------------------------
// <copyright file="SimpleQuantityKindMetaInfo.cs" company="RHEA System S.A.">
...
namespace CDP4Common.MetaInfo
{
    ...
    /// </summary>
    public partial class SimpleQuantityKindMetaInfo : ISimpleQuantityKindMetaInfo
    {
        /// <summary>
        /// The containment property value map.
        /// </summary>
        private readonly Dictionary<string, Func<CDP4Common.DTO.SimpleQuantityKind, IEnumerable<Guid>>> containmentPropertyValueMap = new Dictionary<string, Func<CDP4Common.DTO.SimpleQuantityKind, IEnumerable<Guid>>>
        {
            { "Alias", simpleQuantityKind => simpleQuantityKind.Alias },
            { "Attachment", simpleQuantityKind => simpleQuantityKind.Attachment },
            { "Definition", simpleQuantityKind => simpleQuantityKind.Definition },
            { "HyperLink", simpleQuantityKind => simpleQuantityKind.HyperLink },
        };

        /// <summary>
        /// The ordered containment property value map.
        /// </summary>
        private readonly Dictionary<string, Func<CDP4Common.DTO.SimpleQuantityKind, IEnumerable<OrderedItem>>> orderedContainmentPropertyValueMap = new Dictionary<string, Func<CDP4Common.DTO.SimpleQuantityKind, IEnumerable<OrderedItem>>>();

        /// <summary>
        /// The validation rules that should pass for an instance of <see cref="CDP4Common.DTO.SimpleQuantityKind"/>.
        /// </summary>
        private readonly Dictionary<string, DtoValidationHelper<CDP4Common.DTO.SimpleQuantityKind>> validationRules = new Dictionary<string, DtoValidationHelper<CDP4Common.DTO.SimpleQuantityKind>>
        {
            { "Alias", new DtoValidationHelper<CDP4Common.DTO.SimpleQuantityKind>(item => item.Alias != null, "The 'Alias' property of a 'SimpleQuantityKind' is mandatory and cannot be null.") },
            { "Attachment", new DtoValidationHelper<CDP4Common.DTO.SimpleQuantityKind>(item => item.Attachment != null, "The 'Attachment' property of a 'SimpleQuantityKind' is mandatory and cannot be null.") },
            { "Category", new DtoValidationHelper<CDP4Common.DTO.SimpleQuantityKind>(item => item.Category != null, "The 'Category' property of a 'SimpleQuantityKind' is mandatory and cannot be null.") },
            { "Definition", new DtoValidationHelper<CDP4Common.DTO.SimpleQuantityKind>(item => item.Definition != null, "The 'Definition' property of a 'SimpleQuantityKind' is mandatory and cannot be null.") },
            { "ExcludedDomain", new DtoValidationHelper<CDP4Common.DTO.SimpleQuantityKind>(item => item.ExcludedDomain != null, "The 'ExcludedDomain' property of a 'SimpleQuantityKind' is mandatory and cannot be null.") },
            { "ExcludedPerson", new DtoValidationHelper<CDP4Common.DTO.SimpleQuantityKind>(item => item.ExcludedPerson != null, "The 'ExcludedPerson' property of a 'SimpleQuantityKind' is mandatory and cannot be null.") },
            { "HyperLink", new DtoValidationHelper<CDP4Common.DTO.SimpleQuantityKind>(item => item.HyperLink != null, "The 'HyperLink' property of a 'SimpleQuantityKind' is mandatory and cannot be null.") },
            { "Name", new DtoValidationHelper<CDP4Common.DTO.SimpleQuantityKind>(item => !string.IsNullOrWhiteSpace(item.Name), "The 'Name' property of a 'SimpleQuantityKind' is mandatory and cannot be empty or null.") },
            { "PossibleScale", new DtoValidationHelper<CDP4Common.DTO.SimpleQuantityKind>(item => item.PossibleScale != null, "The 'PossibleScale' property of a 'SimpleQuantityKind' is mandatory and cannot be null.") },
            { "ShortName", new DtoValidationHelper<CDP4Common.DTO.SimpleQuantityKind>(item => !string.IsNullOrWhiteSpace(item.ShortName), "The 'ShortName' property of a 'SimpleQuantityKind' is mandatory and cannot be empty or null.") },
            { "Symbol", new DtoValidationHelper<CDP4Common.DTO.SimpleQuantityKind>(item => !string.IsNullOrWhiteSpace(item.Symbol), "The 'Symbol' property of a 'SimpleQuantityKind' is mandatory and cannot be empty or null.") },
        };
        ...
        /// </exception>
        public void Validate(CDP4Common.DTO.Thing simpleQuantityKind)
        {
            this.Validate(simpleQuantityKind, x => true);
        }
        ...
        /// If any validation rule failed.
        /// </exception>
        public void Validate(CDP4Common.DTO.Thing simpleQuantityKind, Func<string, bool> validateProperty)
        {
            foreach (var applicableRule in this.validationRules.Where(x => validateProperty(x.Key)))
            {
                applicableRule.Value.Validate((CDP4Common.DTO.SimpleQuantityKind)simpleQuantityKind);
            }
        }
        ...
        /// </returns>
        public bool TryValidate(CDP4Common.DTO.Thing simpleQuantityKind)
        {
            return this.TryValidate(simpleQuantityKind, x => true);
        }
        ...
        /// True if all validation rules have passed or if none are defined.
        /// </returns>
        public bool TryValidate(CDP4Common.DTO.Thing simpleQuantityKind, Func<string, bool> validateProperty)
        {
            var applicableValidationRules = this.validationRules.Where(x => validateProperty(x.Key)).Select(x => x.Value);

            return applicableValidationRules.All(applicableRule => applicableRule.TryValidate((CDP4Common.DTO.SimpleQuantityKind)simpleQuantityKind));
        }

        /// <summary>
        /// Returns the containment property value for the supplied <see cref="CDP4Common.DTO.SimpleQuantityKind"/>.
        /// </summary>
        /// <param name="simpleQuantityKind">
        /// The <see cref="CDP4Common.DTO.SimpleQuantityKind"/> for which to return the containment property value.
        /// </param>
        ...
        /// If the property name is not supported for the <see cref="CDP4Common.DTO.SimpleQuantityKind"/>.
        /// </exception>
        public IEnumerable<Guid> GetContainmentIds(CDP4Common.DTO.Thing simpleQuantityKind, string propertyName)
        {
            if (!this.containmentPropertyValueMap.ContainsKey(propertyName))
            {
                throw new ArgumentException($"'{propertyName}' is not a valid containment property of 'SimpleQuantityKind'");
            }

            return this.containmentPropertyValueMap[propertyName]((CDP4Common.DTO.SimpleQuantityKind)simpleQuantityKind);
        }

        /// <summary>
        /// Returns the ordered containment property value for the supplied <see cref="CDP4Common.DTO.SimpleQuantityKind"/>.
        /// </summary>
        /// <param name="simpleQuantityKind">
        /// The <see cref="CDP4Common.DTO.SimpleQuantityKind"/> for which to return the containment property value.
        /// </param>
        ...
        /// If the property name is not supported for the <see cref="CDP4Common.DTO.SimpleQuantityKind"/>.
        /// </exception>
        public IEnumerable<OrderedItem> GetOrderedContainmentIds(CDP4Common.DTO.Thing simpleQuantityKind, string propertyName)
        {
            ...
            return this.orderedContainmentPropertyValueMap[propertyName]((CDP4Common.DTO.SimpleQuantityKind)simpleQuantityKind);
        }
        ...
        /// <summary>
        /// Gets the <see cref="PropertyMetaInfo"/> for the <see cref="SimpleQuantityKind"/> class
        /// </summary>
        ...
        /// </summary>
        private readonly Dictionary<string, Func<CDP4Common.DTO.SimpleQuantityKind, object>> propertyValueMap = new Dictionary<string, Func<CDP4Common.DTO.SimpleQuantityKind, object>>
        {
        ...
        /// </summary>
        private readonly Dictionary<string, Action<CDP4Common.DTO.SimpleQuantityKind, object>> propertyValueAssignmentMap = new Dictionary<string, Action<CDP4Common.DTO.SimpleQuantityKind, object>>
        {
            { "Actor", (simpleQuantityKind, value) => simpleQuantityKind.Actor = value == null ? (Guid?)null : (Guid)value },
            { "DefaultScale", (simpleQuantityKind, value) => simpleQuantityKind.DefaultScale = (Guid)value },
            { "Iid", (simpleQuantityKind, value) => simpleQuantityKind.Iid = (Guid)value },
            { "IsDeprecated", (simpleQuantityKind, value) => simpleQuantityKind.IsDeprecated = (bool)value },
            { "ModifiedOn", (simpleQuantityKind, value) => simpleQuantityKind.ModifiedOn = (DateTime)value },
            { "Name", (simpleQuantityKind, value) => simpleQuantityKind.Name = value.ToString() },
            { "QuantityDimensionSymbol", (simpleQuantityKind, value) => simpleQuantityKind.QuantityDimensionSymbol = value == null ? (string)null : value.ToString() },
            { "ShortName", (simpleQuantityKind, value) => simpleQuantityKind.ShortName = value.ToString() },
            { "Symbol", (simpleQuantityKind, value) => simpleQuantityKind.Symbol = value.ToString() },
            { "ThingPreference", (simpleQuantityKind, value) => simpleQuantityKind.ThingPreference = value == null ? (string)null : value.ToString() },
        };
        ...
        /// <summary>
        /// Returns the <see cref="CDP4Common.DTO.SimpleQuantityKind"/> containment property type from the supplied property name.
        /// </summary>
        /// <param name="propertyName">
        ...
        /// <summary>
        /// Returns the <see cref="CDP4Common.DTO.SimpleQuantityKind"/> property type from the supplied property name.
        /// </summary>
        /// <param name="propertyName">
        /// The property name.
        /// </param>
        ...
        /// <summary>
        /// Returns the container property for the supplied type name is a possible container for <see cref="CDP4Common.DTO.SimpleQuantityKind"/>.
        /// </summary>
        /// <param name="typeName">
        /// Name of the type for which to check if it is a container of <see cref="CDP4Common.DTO.SimpleQuantityKind"/>.
        /// </param>
        /// <param name="containerProperty">
        /// Supplied container property info instance that will be set if the supplied type name is a container of <see cref="CDP4Common.DTO.SimpleQuantityKind"/>.
        /// </param>
        /// <returns>
        /// True if the supplied typeName is a container for <see cref="CDP4Common.DTO.SimpleQuantityKind"/> and sets the container property name.
        /// </returns>
        ...
        /// <summary>
        /// Check if the supplied property name for <see cref="CDP4Common.DTO.SimpleQuantityKind"/> is scalar.
        /// </summary>
        /// <param name="propertyName">
        /// Name of the property for which to check if it is scalar.
        /// </param>
        ...
        public bool ApplyPropertyUpdate(CDP4Common.DTO.Thing updatableThing, string propertyName, object value)
        {
            ...
            this.propertyValueAssignmentMap[propertyName]((CDP4Common.DTO.SimpleQuantityKind)updatableThing, value);
        ...
        public object DeserializeCollectionValue(string propertyName, object value)
        {
            ...
            {
                throw new ArgumentException($"'{propertyName}' is not a valid collection property of 'SimpleQuantityKind'");
            }
        ...
        public object GetValue(string propertyName, CDP4Common.DTO.Thing thing)
        {
            ...
            return this.propertyValueMap[propertyName]((CDP4Common.DTO.SimpleQuantityKind)thing);
        }
        ...
        /// <summary>
        /// Instantiates a <see cref="CDP4Common.DTO.SimpleQuantityKind"/>
        /// </summary>
        /// <returns>
        ...
        {
            return new CDP4Common.DTO.SimpleQuantityKind(guid, revisionNumber);
        }
    }
}
