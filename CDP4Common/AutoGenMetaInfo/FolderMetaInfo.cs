// --------------------------------------------------------------------------------------------------------------------
// <copyright file="FolderMetaInfo.cs" company="Starion Group S.A.">
...
namespace CDP4Common.MetaInfo
{
    ...
    public partial class FolderMetaInfo : IFolderMetaInfo
    {
        ...
        public IEnumerable<Guid> GetContainmentIds(CDP4Common.DTO.Thing folder, string propertyName)
        {
            ...
            {
                throw new ArgumentException($"'{propertyName}' is not a valid containment property of 'Folder'");
            }
        ...
        {
            { "Actor", (folder, value) => folder.Actor = value == null ? (Guid?)null : (Guid)value },
        ...
        {
            { "CommonFileStore", new PropertyMetaInfo("Folder", "Folder", PropertyKind.List, AggregationKind.Composite, false, false, true, 0, "*", true) },
            { "DomainFileStore", new PropertyMetaInfo("Folder", "Folder", PropertyKind.List, AggregationKind.Composite, false, false, true, 0, "*", true) },
        };
        ...
        public object DeserializeCollectionValue(string propertyName, object value)
        {
            ...
            {
                throw new ArgumentException($"'{propertyName}' is not a valid collection property of 'Folder'");
            }
