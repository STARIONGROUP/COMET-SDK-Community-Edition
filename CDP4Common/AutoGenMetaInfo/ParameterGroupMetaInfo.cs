// --------------------------------------------------------------------------------------------------------------------
// <copyright file="ParameterGroupMetaInfo.cs" company="Starion Group S.A.">
...
namespace CDP4Common.MetaInfo
{
    ...
    /// <summary>
    /// This a class that holds meta info for <see cref="ParameterGroup"/>.
    /// </summary>
    public partial class ParameterGroupMetaInfo : IParameterGroupMetaInfo
    {
        /// <summary>
        /// The containment property value map.
        /// </summary>
        private readonly Dictionary<string, Func<CDP4Common.DTO.ParameterGroup, IEnumerable<Guid>>> containmentPropertyValueMap = new Dictionary<string, Func<CDP4Common.DTO.ParameterGroup, IEnumerable<Guid>>>();

        /// <summary>
        /// The ordered containment property value map.
        /// </summary>
        private readonly Dictionary<string, Func<CDP4Common.DTO.ParameterGroup, IEnumerable<OrderedItem>>> orderedContainmentPropertyValueMap = new Dictionary<string, Func<CDP4Common.DTO.ParameterGroup, IEnumerable<OrderedItem>>>();

        /// <summary>
        /// The validation rules that should pass for an instance of <see cref="CDP4Common.DTO.ParameterGroup"/>.
        /// </summary>
        private readonly Dictionary<string, DtoValidationHelper<CDP4Common.DTO.ParameterGroup>> validationRules = new Dictionary<string, DtoValidationHelper<CDP4Common.DTO.ParameterGroup>>
        {
            { "ExcludedDomain", new DtoValidationHelper<CDP4Common.DTO.ParameterGroup>(item => item.ExcludedDomain != null, "The 'ExcludedDomain' property of a 'ParameterGroup' is mandatory and cannot be null.") },
            { "ExcludedPerson", new DtoValidationHelper<CDP4Common.DTO.ParameterGroup>(item => item.ExcludedPerson != null, "The 'ExcludedPerson' property of a 'ParameterGroup' is mandatory and cannot be null.") },
            { "Name", new DtoValidationHelper<CDP4Common.DTO.ParameterGroup>(item => !string.IsNullOrWhiteSpace(item.Name), "The 'Name' property of a 'ParameterGroup' is mandatory and cannot be empty or null.") },
        };
        ...
        /// </exception>
        public void Validate(CDP4Common.DTO.Thing parameterGroup)
        {
            this.Validate(parameterGroup, x => true);
        }
        ...
        /// If any validation rule failed.
        /// </exception>
        public void Validate(CDP4Common.DTO.Thing parameterGroup, Func<string, bool> validateProperty)
        {
            foreach (var applicableRule in this.validationRules.Where(x => validateProperty(x.Key)))
            {
                applicableRule.Value.Validate((CDP4Common.DTO.ParameterGroup)parameterGroup);
            }
        }
        ...
        /// </returns>
        public bool TryValidate(CDP4Common.DTO.Thing parameterGroup)
        {
            return this.TryValidate(parameterGroup, x => true);
        }
        ...
        /// True if all validation rules have passed or if none are defined.
        /// </returns>
        public bool TryValidate(CDP4Common.DTO.Thing parameterGroup, Func<string, bool> validateProperty)
        {
            var applicableValidationRules = this.validationRules.Where(x => validateProperty(x.Key)).Select(x => x.Value);

            return applicableValidationRules.All(applicableRule => applicableRule.TryValidate((CDP4Common.DTO.ParameterGroup)parameterGroup));
        }

        /// <summary>
        /// Returns the containment property value for the supplied <see cref="CDP4Common.DTO.ParameterGroup"/>.
        /// </summary>
        /// <param name="parameterGroup">
        /// The <see cref="CDP4Common.DTO.ParameterGroup"/> for which to return the containment property value.
        /// </param>
        ...
        /// If the property name is not supported for the <see cref="CDP4Common.DTO.ParameterGroup"/>.
        /// </exception>
        public IEnumerable<Guid> GetContainmentIds(CDP4Common.DTO.Thing parameterGroup, string propertyName)
        {
            if (!this.containmentPropertyValueMap.ContainsKey(propertyName))
            {
                throw new ArgumentException($"'{propertyName}' is not a valid containment property of 'ParameterGroup'");
            }

            return this.containmentPropertyValueMap[propertyName]((CDP4Common.DTO.ParameterGroup)parameterGroup);
        }

        /// <summary>
        /// Returns the ordered containment property value for the supplied <see cref="CDP4Common.DTO.ParameterGroup"/>.
        /// </summary>
        /// <param name="parameterGroup">
        /// The <see cref="CDP4Common.DTO.ParameterGroup"/> for which to return the containment property value.
        /// </param>
        ...
        /// If the property name is not supported for the <see cref="CDP4Common.DTO.ParameterGroup"/>.
        /// </exception>
        public IEnumerable<OrderedItem> GetOrderedContainmentIds(CDP4Common.DTO.Thing parameterGroup, string propertyName)
        {
            ...
            return this.orderedContainmentPropertyValueMap[propertyName]((CDP4Common.DTO.ParameterGroup)parameterGroup);
        }
        ...
        /// <summary>
        /// Gets the <see cref="PropertyMetaInfo"/> for the <see cref="ParameterGroup"/> class
        /// </summary>
        ...
        /// </summary>
        private readonly Dictionary<string, Func<CDP4Common.DTO.ParameterGroup, object>> propertyValueMap = new Dictionary<string, Func<CDP4Common.DTO.ParameterGroup, object>>
        {
            { "Actor", thing => thing.Actor },
            { "ClassKind", thing => thing.ClassKind },
            { "ContainingGroup", thing => thing.ContainingGroup },
        ...
        private readonly Dictionary<string, PropertyMetaInfo> propertyTypeMap = new Dictionary<string, PropertyMetaInfo>
        {
            ...
            { "ContainingGroup", new PropertyMetaInfo("ContainingGroup", "ParameterGroup", PropertyKind.Scalar, AggregationKind.None, false, false, true, 0, "1", true) },
        ...
        /// </summary>
        private readonly Dictionary<string, Action<CDP4Common.DTO.ParameterGroup, object>> propertyValueAssignmentMap = new Dictionary<string, Action<CDP4Common.DTO.ParameterGroup, object>>
        {
            { "Actor", (parameterGroup, value) => parameterGroup.Actor = value == null ? (Guid?)null : (Guid)value },
            { "ContainingGroup", (parameterGroup, value) => parameterGroup.ContainingGroup = value == null ? (Guid?)null : (Guid)value },
            { "Iid", (parameterGroup, value) => parameterGroup.Iid = (Guid)value },
            { "ModifiedOn", (parameterGroup, value) => parameterGroup.ModifiedOn = (DateTime)value },
            { "Name", (parameterGroup, value) => parameterGroup.Name = value.ToString() },
            { "ThingPreference", (parameterGroup, value) => parameterGroup.ThingPreference = value == null ? (string)null : value.ToString() },
        };
        ...
        {
            { "ElementDefinition", new PropertyMetaInfo("ParameterGroup", "ParameterGroup", PropertyKind.List, AggregationKind.Composite, false, false, true, 0, "*", true) },
        };
        ...
        /// <summary>
        /// Returns the <see cref="CDP4Common.DTO.ParameterGroup"/> containment property type from the supplied property name.
        /// </summary>
        /// <param name="propertyName">
        ...
        /// <summary>
        /// Returns the <see cref="CDP4Common.DTO.ParameterGroup"/> property type from the supplied property name.
        /// </summary>
        /// <param name="propertyName">
        /// The property name.
        /// </param>
        ...
        /// <summary>
        /// Returns the container property for the supplied type name is a possible container for <see cref="CDP4Common.DTO.ParameterGroup"/>.
        /// </summary>
        /// <param name="typeName">
        /// Name of the type for which to check if it is a container of <see cref="CDP4Common.DTO.ParameterGroup"/>.
        /// </param>
        /// <param name="containerProperty">
        /// Supplied container property info instance that will be set if the supplied type name is a container of <see cref="CDP4Common.DTO.ParameterGroup"/>.
        /// </param>
        /// <returns>
        /// True if the supplied typeName is a container for <see cref="CDP4Common.DTO.ParameterGroup"/> and sets the container property name.
        /// </returns>
        ...
        /// <summary>
        /// Check if the supplied property name for <see cref="CDP4Common.DTO.ParameterGroup"/> is scalar.
        /// </summary>
        /// <param name="propertyName">
        /// Name of the property for which to check if it is scalar.
        /// </param>
        ...
        public bool ApplyPropertyUpdate(CDP4Common.DTO.Thing updatableThing, string propertyName, object value)
        {
            ...
            this.propertyValueAssignmentMap[propertyName]((CDP4Common.DTO.ParameterGroup)updatableThing, value);
        ...
        public object DeserializeCollectionValue(string propertyName, object value)
        {
            ...
            {
                throw new ArgumentException($"'{propertyName}' is not a valid collection property of 'ParameterGroup'");
            }
        ...
        public object GetValue(string propertyName, CDP4Common.DTO.Thing thing)
        {
            ...
            return this.propertyValueMap[propertyName]((CDP4Common.DTO.ParameterGroup)thing);
        }
        ...
        /// <summary>
        /// Instantiates a <see cref="CDP4Common.DTO.ParameterGroup"/>
        /// </summary>
        /// <returns>
        ...
        {
            return new CDP4Common.DTO.ParameterGroup(guid, revisionNumber);
        }
    }
}
