// --------------------------------------------------------------------------------------------------------------------
// <copyright file="OrganizationalParticipantMetaInfo.cs" company="Starion Group S.A.">
...
namespace CDP4Common.MetaInfo
{
    ...
    public partial class OrganizationalParticipantMetaInfo : IOrganizationalParticipantMetaInfo
    {
        ...
        public IEnumerable<Guid> GetContainmentIds(CDP4Common.DTO.Thing organizationalParticipant, string propertyName)
        {
            ...
            {
                throw new ArgumentException($"'{propertyName}' is not a valid containment property of 'OrganizationalParticipant'");
            }
        ...
        {
            { "Actor", (organizationalParticipant, value) => organizationalParticipant.Actor = value == null ? (Guid?)null : (Guid)value },
        ...
        public object DeserializeCollectionValue(string propertyName, object value)
        {
            ...
            {
                throw new ArgumentException($"'{propertyName}' is not a valid collection property of 'OrganizationalParticipant'");
            }
