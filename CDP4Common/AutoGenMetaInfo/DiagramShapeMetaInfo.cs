// --------------------------------------------------------------------------------------------------------------------
// <copyright file="DiagramShapeMetaInfo.cs" company="Starion Group S.A.">
...
namespace CDP4Common.MetaInfo
{
    ...
    /// <summary>
    /// This a class that holds meta info for <see cref="DiagramShape"/>.
    /// </summary>
    public partial class DiagramShapeMetaInfo : IDiagramShapeMetaInfo
    {
        /// <summary>
        /// The containment property value map.
        /// </summary>
        private readonly Dictionary<string, Func<CDP4Common.DTO.DiagramShape, IEnumerable<Guid>>> containmentPropertyValueMap = new Dictionary<string, Func<CDP4Common.DTO.DiagramShape, IEnumerable<Guid>>>
        {
            { "Bounds", diagramShape => diagramShape.Bounds },
            { "DiagramElement", diagramShape => diagramShape.DiagramElement },
            { "LocalStyle", diagramShape => diagramShape.LocalStyle },
        };

        /// <summary>
        /// The ordered containment property value map.
        /// </summary>
        private readonly Dictionary<string, Func<CDP4Common.DTO.DiagramShape, IEnumerable<OrderedItem>>> orderedContainmentPropertyValueMap = new Dictionary<string, Func<CDP4Common.DTO.DiagramShape, IEnumerable<OrderedItem>>>();

        /// <summary>
        /// The validation rules that should pass for an instance of <see cref="CDP4Common.DTO.DiagramShape"/>.
        /// </summary>
        private readonly Dictionary<string, DtoValidationHelper<CDP4Common.DTO.DiagramShape>> validationRules = new Dictionary<string, DtoValidationHelper<CDP4Common.DTO.DiagramShape>>
        {
            { "Bounds", new DtoValidationHelper<CDP4Common.DTO.DiagramShape>(item => item.Bounds != null, "The 'Bounds' property of a 'DiagramShape' is mandatory and cannot be null.") },
            { "DiagramElement", new DtoValidationHelper<CDP4Common.DTO.DiagramShape>(item => item.DiagramElement != null, "The 'DiagramElement' property of a 'DiagramShape' is mandatory and cannot be null.") },
            { "ExcludedDomain", new DtoValidationHelper<CDP4Common.DTO.DiagramShape>(item => item.ExcludedDomain != null, "The 'ExcludedDomain' property of a 'DiagramShape' is mandatory and cannot be null.") },
            { "ExcludedPerson", new DtoValidationHelper<CDP4Common.DTO.DiagramShape>(item => item.ExcludedPerson != null, "The 'ExcludedPerson' property of a 'DiagramShape' is mandatory and cannot be null.") },
            { "LocalStyle", new DtoValidationHelper<CDP4Common.DTO.DiagramShape>(item => item.LocalStyle != null, "The 'LocalStyle' property of a 'DiagramShape' is mandatory and cannot be null.") },
            { "Name", new DtoValidationHelper<CDP4Common.DTO.DiagramShape>(item => !string.IsNullOrWhiteSpace(item.Name), "The 'Name' property of a 'DiagramShape' is mandatory and cannot be empty or null.") },
        };
        ...
        /// </exception>
        public void Validate(CDP4Common.DTO.Thing diagramShape)
        {
            this.Validate(diagramShape, x => true);
        }
        ...
        /// If any validation rule failed.
        /// </exception>
        public void Validate(CDP4Common.DTO.Thing diagramShape, Func<string, bool> validateProperty)
        {
            foreach (var applicableRule in this.validationRules.Where(x => validateProperty(x.Key)))
            {
                applicableRule.Value.Validate((CDP4Common.DTO.DiagramShape)diagramShape);
            }
        }
        ...
        /// </returns>
        public bool TryValidate(CDP4Common.DTO.Thing diagramShape)
        {
            return this.TryValidate(diagramShape, x => true);
        }
        ...
        /// True if all validation rules have passed or if none are defined.
        /// </returns>
        public bool TryValidate(CDP4Common.DTO.Thing diagramShape, Func<string, bool> validateProperty)
        {
            var applicableValidationRules = this.validationRules.Where(x => validateProperty(x.Key)).Select(x => x.Value);

            return applicableValidationRules.All(applicableRule => applicableRule.TryValidate((CDP4Common.DTO.DiagramShape)diagramShape));
        }

        /// <summary>
        /// Returns the containment property value for the supplied <see cref="CDP4Common.DTO.DiagramShape"/>.
        /// </summary>
        /// <param name="diagramShape">
        /// The <see cref="CDP4Common.DTO.DiagramShape"/> for which to return the containment property value.
        /// </param>
        ...
        /// If the property name is not supported for the <see cref="CDP4Common.DTO.DiagramShape"/>.
        /// </exception>
        public IEnumerable<Guid> GetContainmentIds(CDP4Common.DTO.Thing diagramShape, string propertyName)
        {
            if (!this.containmentPropertyValueMap.ContainsKey(propertyName))
            {
                throw new ArgumentException($"'{propertyName}' is not a valid containment property of 'DiagramShape'");
            }

            return this.containmentPropertyValueMap[propertyName]((CDP4Common.DTO.DiagramShape)diagramShape);
        }

        /// <summary>
        /// Returns the ordered containment property value for the supplied <see cref="CDP4Common.DTO.DiagramShape"/>.
        /// </summary>
        /// <param name="diagramShape">
        /// The <see cref="CDP4Common.DTO.DiagramShape"/> for which to return the containment property value.
        /// </param>
        ...
        /// If the property name is not supported for the <see cref="CDP4Common.DTO.DiagramShape"/>.
        /// </exception>
        public IEnumerable<OrderedItem> GetOrderedContainmentIds(CDP4Common.DTO.Thing diagramShape, string propertyName)
        {
            ...
            return this.orderedContainmentPropertyValueMap[propertyName]((CDP4Common.DTO.DiagramShape)diagramShape);
        }
        ...
        /// <summary>
        /// Gets the <see cref="PropertyMetaInfo"/> for the <see cref="DiagramShape"/> class
        /// </summary>
        ...
        /// </summary>
        private readonly Dictionary<string, Func<CDP4Common.DTO.DiagramShape, object>> propertyValueMap = new Dictionary<string, Func<CDP4Common.DTO.DiagramShape, object>>
        {
        ...
        /// </summary>
        private readonly Dictionary<string, Action<CDP4Common.DTO.DiagramShape, object>> propertyValueAssignmentMap = new Dictionary<string, Action<CDP4Common.DTO.DiagramShape, object>>
        {
            { "Actor", (diagramShape, value) => diagramShape.Actor = value == null ? (Guid?)null : (Guid)value },
            { "DepictedThing", (diagramShape, value) => diagramShape.DepictedThing = value == null ? (Guid?)null : (Guid)value },
            { "Iid", (diagramShape, value) => diagramShape.Iid = (Guid)value },
            { "ModifiedOn", (diagramShape, value) => diagramShape.ModifiedOn = (DateTime)value },
            { "Name", (diagramShape, value) => diagramShape.Name = value.ToString() },
            { "SharedStyle", (diagramShape, value) => diagramShape.SharedStyle = value == null ? (Guid?)null : (Guid)value },
            { "ThingPreference", (diagramShape, value) => diagramShape.ThingPreference = value == null ? (string)null : value.ToString() },
        };
        ...
        /// <summary>
        /// Returns the <see cref="CDP4Common.DTO.DiagramShape"/> containment property type from the supplied property name.
        /// </summary>
        /// <param name="propertyName">
        ...
        /// <summary>
        /// Returns the <see cref="CDP4Common.DTO.DiagramShape"/> property type from the supplied property name.
        /// </summary>
        /// <param name="propertyName">
        /// The property name.
        /// </param>
        ...
        /// <summary>
        /// Returns the container property for the supplied type name is a possible container for <see cref="CDP4Common.DTO.DiagramShape"/>.
        /// </summary>
        /// <param name="typeName">
        /// Name of the type for which to check if it is a container of <see cref="CDP4Common.DTO.DiagramShape"/>.
        /// </param>
        /// <param name="containerProperty">
        /// Supplied container property info instance that will be set if the supplied type name is a container of <see cref="CDP4Common.DTO.DiagramShape"/>.
        /// </param>
        /// <returns>
        /// True if the supplied typeName is a container for <see cref="CDP4Common.DTO.DiagramShape"/> and sets the container property name.
        /// </returns>
        ...
        /// <summary>
        /// Check if the supplied property name for <see cref="CDP4Common.DTO.DiagramShape"/> is scalar.
        /// </summary>
        /// <param name="propertyName">
        /// Name of the property for which to check if it is scalar.
        /// </param>
        ...
        public bool ApplyPropertyUpdate(CDP4Common.DTO.Thing updatableThing, string propertyName, object value)
        {
            ...
            this.propertyValueAssignmentMap[propertyName]((CDP4Common.DTO.DiagramShape)updatableThing, value);
        ...
        public object DeserializeCollectionValue(string propertyName, object value)
        {
            ...
            {
                throw new ArgumentException($"'{propertyName}' is not a valid collection property of 'DiagramShape'");
            }
        ...
        public object GetValue(string propertyName, CDP4Common.DTO.Thing thing)
        {
            ...
            return this.propertyValueMap[propertyName]((CDP4Common.DTO.DiagramShape)thing);
        }
        ...
        /// <summary>
        /// Instantiates a <see cref="CDP4Common.DTO.DiagramShape"/>
        /// </summary>
        /// <returns>
