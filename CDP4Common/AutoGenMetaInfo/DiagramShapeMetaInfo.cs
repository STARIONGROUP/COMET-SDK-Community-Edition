...
namespace CDP4Common.MetaInfo
{
    ...
    public partial class DiagramShapeMetaInfo : IDiagramShapeMetaInfo
    {
        ...
        public IEnumerable<Guid> GetContainmentIds(CDP4Common.DTO.Thing diagramShape, string propertyName)
        {
            ...
            {
                throw new ArgumentException(string.Format("'{0}' is not a valid containment property of 'DiagramShape'", propertyName));
            }
        ...
        public object DeserializeCollectionValue(string propertyName, object value)
        {
            ...
            {
                throw new ArgumentException(string.Format("'{0}' is not a valid collection property of 'DiagramShape'", propertyName));
            }
