...
namespace CDP4Common.MetaInfo
{
    ...
    public partial class StakeHolderValueMapMetaInfo : IStakeHolderValueMapMetaInfo
    {
        ...
        public IEnumerable<Guid> GetContainmentIds(CDP4Common.DTO.Thing stakeHolderValueMap, string propertyName)
        {
            ...
            {
                throw new ArgumentException(string.Format("'{0}' is not a valid containment property of 'StakeHolderValueMap'", propertyName));
            }
        ...
        private readonly Dictionary<string, PropertyMetaInfo> containmentTypeMap = new Dictionary<string, PropertyMetaInfo>
        {
            ...
            { "Settings", new PropertyMetaInfo("Settings", "Guid", PropertyKind.List, AggregationKind.Composite, false, false, true, 1, "1", true) },
        };
        ...
        private readonly Dictionary<string, PropertyMetaInfo> propertyTypeMap = new Dictionary<string, PropertyMetaInfo>
        {
            ...
            { "Goal", new PropertyMetaInfo("Goal", "Guid", PropertyKind.List, AggregationKind.None, false, false, true, 0, "*", true) },
            ...
            { "Requirement", new PropertyMetaInfo("Requirement", "Guid", PropertyKind.List, AggregationKind.None, false, false, true, 0, "*", true) },
            ...
            { "ValueGroup", new PropertyMetaInfo("ValueGroup", "Guid", PropertyKind.List, AggregationKind.None, false, false, true, 0, "*", true) },
        };
        ...
        {
            { "Iteration", new PropertyMetaInfo("StakeholderValueMap", "Guid", PropertyKind.List, AggregationKind.Composite, false, false, true, 0, "*", true) },
        };
        ...
        public object DeserializeCollectionValue(string propertyName, object value)
        {
            ...
            {
                throw new ArgumentException(string.Format("'{0}' is not a valid collection property of 'StakeHolderValueMap'", propertyName));
            }
