// --------------------------------------------------------------------------------------------------------------------
// <copyright file="UnitPrefixMetaInfo.cs" company="RHEA System S.A.">
...
namespace CDP4Common.MetaInfo
{
    ...
    /// <summary>
    /// This a class that holds meta info for <see cref="UnitPrefix"/>.
    /// </summary>
    public partial class UnitPrefixMetaInfo : IUnitPrefixMetaInfo
    {
        /// <summary>
        /// The containment property value map.
        /// </summary>
        private readonly Dictionary<string, Func<CDP4Common.DTO.UnitPrefix, IEnumerable<Guid>>> containmentPropertyValueMap = new Dictionary<string, Func<CDP4Common.DTO.UnitPrefix, IEnumerable<Guid>>>
        {
            { "Alias", unitPrefix => unitPrefix.Alias },
            { "Attachment", unitPrefix => unitPrefix.Attachment },
            { "Definition", unitPrefix => unitPrefix.Definition },
            { "HyperLink", unitPrefix => unitPrefix.HyperLink },
        };

        /// <summary>
        /// The ordered containment property value map.
        /// </summary>
        private readonly Dictionary<string, Func<CDP4Common.DTO.UnitPrefix, IEnumerable<OrderedItem>>> orderedContainmentPropertyValueMap = new Dictionary<string, Func<CDP4Common.DTO.UnitPrefix, IEnumerable<OrderedItem>>>();

        /// <summary>
        /// The validation rules that should pass for an instance of <see cref="CDP4Common.DTO.UnitPrefix"/>.
        /// </summary>
        private readonly Dictionary<string, DtoValidationHelper<CDP4Common.DTO.UnitPrefix>> validationRules = new Dictionary<string, DtoValidationHelper<CDP4Common.DTO.UnitPrefix>>
        {
            { "Alias", new DtoValidationHelper<CDP4Common.DTO.UnitPrefix>(item => item.Alias != null, "The 'Alias' property of a 'UnitPrefix' is mandatory and cannot be null.") },
            { "Attachment", new DtoValidationHelper<CDP4Common.DTO.UnitPrefix>(item => item.Attachment != null, "The 'Attachment' property of a 'UnitPrefix' is mandatory and cannot be null.") },
            { "ConversionFactor", new DtoValidationHelper<CDP4Common.DTO.UnitPrefix>(item => !string.IsNullOrWhiteSpace(item.ConversionFactor), "The 'ConversionFactor' property of a 'UnitPrefix' is mandatory and cannot be empty or null.") },
            { "Definition", new DtoValidationHelper<CDP4Common.DTO.UnitPrefix>(item => item.Definition != null, "The 'Definition' property of a 'UnitPrefix' is mandatory and cannot be null.") },
            { "ExcludedDomain", new DtoValidationHelper<CDP4Common.DTO.UnitPrefix>(item => item.ExcludedDomain != null, "The 'ExcludedDomain' property of a 'UnitPrefix' is mandatory and cannot be null.") },
            { "ExcludedPerson", new DtoValidationHelper<CDP4Common.DTO.UnitPrefix>(item => item.ExcludedPerson != null, "The 'ExcludedPerson' property of a 'UnitPrefix' is mandatory and cannot be null.") },
            { "HyperLink", new DtoValidationHelper<CDP4Common.DTO.UnitPrefix>(item => item.HyperLink != null, "The 'HyperLink' property of a 'UnitPrefix' is mandatory and cannot be null.") },
            { "Name", new DtoValidationHelper<CDP4Common.DTO.UnitPrefix>(item => !string.IsNullOrWhiteSpace(item.Name), "The 'Name' property of a 'UnitPrefix' is mandatory and cannot be empty or null.") },
            { "ShortName", new DtoValidationHelper<CDP4Common.DTO.UnitPrefix>(item => !string.IsNullOrWhiteSpace(item.ShortName), "The 'ShortName' property of a 'UnitPrefix' is mandatory and cannot be empty or null.") },
        };
        ...
        /// </exception>
        public void Validate(CDP4Common.DTO.Thing unitPrefix)
        {
            this.Validate(unitPrefix, x => true);
        }
        ...
        /// If any validation rule failed.
        /// </exception>
        public void Validate(CDP4Common.DTO.Thing unitPrefix, Func<string, bool> validateProperty)
        {
            foreach (var applicableRule in this.validationRules.Where(x => validateProperty(x.Key)))
            {
                applicableRule.Value.Validate((CDP4Common.DTO.UnitPrefix)unitPrefix);
            }
        }
        ...
        /// </returns>
        public bool TryValidate(CDP4Common.DTO.Thing unitPrefix)
        {
            return this.TryValidate(unitPrefix, x => true);
        }
        ...
        /// True if all validation rules have passed or if none are defined.
        /// </returns>
        public bool TryValidate(CDP4Common.DTO.Thing unitPrefix, Func<string, bool> validateProperty)
        {
            var applicableValidationRules = this.validationRules.Where(x => validateProperty(x.Key)).Select(x => x.Value);

            return applicableValidationRules.All(applicableRule => applicableRule.TryValidate((CDP4Common.DTO.UnitPrefix)unitPrefix));
        }

        /// <summary>
        /// Returns the containment property value for the supplied <see cref="CDP4Common.DTO.UnitPrefix"/>.
        /// </summary>
        /// <param name="unitPrefix">
        /// The <see cref="CDP4Common.DTO.UnitPrefix"/> for which to return the containment property value.
        /// </param>
        ...
        /// If the property name is not supported for the <see cref="CDP4Common.DTO.UnitPrefix"/>.
        /// </exception>
        public IEnumerable<Guid> GetContainmentIds(CDP4Common.DTO.Thing unitPrefix, string propertyName)
        {
            if (!this.containmentPropertyValueMap.ContainsKey(propertyName))
            {
                throw new ArgumentException(string.Format("'{0}' is not a valid containment property of 'UnitPrefix'", propertyName));
            }

            return this.containmentPropertyValueMap[propertyName]((CDP4Common.DTO.UnitPrefix)unitPrefix);
        }

        /// <summary>
        /// Returns the ordered containment property value for the supplied <see cref="CDP4Common.DTO.UnitPrefix"/>.
        /// </summary>
        /// <param name="unitPrefix">
        /// The <see cref="CDP4Common.DTO.UnitPrefix"/> for which to return the containment property value.
        /// </param>
        ...
        /// If the property name is not supported for the <see cref="CDP4Common.DTO.UnitPrefix"/>.
        /// </exception>
        public IEnumerable<OrderedItem> GetOrderedContainmentIds(CDP4Common.DTO.Thing unitPrefix, string propertyName)
        {
            ...
            return this.orderedContainmentPropertyValueMap[propertyName]((CDP4Common.DTO.UnitPrefix)unitPrefix);
        }
        ...
        /// <summary>
        /// Gets the <see cref="PropertyMetaInfo"/> for the <see cref="UnitPrefix"/> class
        /// </summary>
        ...
        private readonly Dictionary<string, Action<CDP4Common.DTO.UnitPrefix, object>> propertyValueAssignmentMap = new Dictionary<string, Action<CDP4Common.DTO.UnitPrefix, object>>
        {
            ...
            { "ModifiedOn", (unitPrefix, value) => unitPrefix.ModifiedOn = (DateTime)value },
            { "Name", (unitPrefix, value) => unitPrefix.Name = value.ToString() },
            { "ShortName", (unitPrefix, value) => unitPrefix.ShortName = value.ToString() },
            { "ThingPreference", (unitPrefix, value) => unitPrefix.ThingPreference = value == null ? (string)null : value.ToString() },
        };
        ...
        {
            { "ModelReferenceDataLibrary", new PropertyMetaInfo("UnitPrefix", "UnitPrefix", PropertyKind.List, AggregationKind.Composite, false, false, true, 0, "*", true) },
            { "SiteReferenceDataLibrary", new PropertyMetaInfo("UnitPrefix", "UnitPrefix", PropertyKind.List, AggregationKind.Composite, false, false, true, 0, "*", true) },
        };
        ...
        /// <summary>
        /// Returns the <see cref="CDP4Common.DTO.UnitPrefix"/> containment property type from the supplied property name.
        /// </summary>
        /// <param name="propertyName">
        ...
        /// <summary>
        /// Returns the <see cref="CDP4Common.DTO.UnitPrefix"/> property type from the supplied property name.
        /// </summary>
        /// <param name="propertyName">
        /// The property name.
        /// </param>
        ...
        /// <summary>
        /// Returns the container property for the supplied type name is a possible container for <see cref="CDP4Common.DTO.UnitPrefix"/>.
        /// </summary>
        /// <param name="typeName">
        /// Name of the type for which to check if it is a container of <see cref="CDP4Common.DTO.UnitPrefix"/>.
        /// </param>
        /// <param name="containerProperty">
        /// Supplied container property info instance that will be set if the supplied type name is a container of <see cref="CDP4Common.DTO.UnitPrefix"/>.
        /// </param>
        /// <returns>
        /// True if the supplied typeName is a container for <see cref="CDP4Common.DTO.UnitPrefix"/> and sets the container property name.
        /// </returns>
        ...
        /// <summary>
        /// Check if the supplied property name for <see cref="CDP4Common.DTO.UnitPrefix"/> is scalar.
        /// </summary>
        /// <param name="propertyName">
        /// Name of the property for which to check if it is scalar.
        /// </param>
        ...
        public bool ApplyPropertyUpdate(CDP4Common.DTO.Thing updatableThing, string propertyName, object value)
        {
            ...
            this.propertyValueAssignmentMap[propertyName]((CDP4Common.DTO.UnitPrefix)updatableThing, value);
        ...
        public object DeserializeCollectionValue(string propertyName, object value)
        {
            ...
            {
                throw new ArgumentException(string.Format("'{0}' is not a valid collection property of 'UnitPrefix'", propertyName));
            }
        ...
        public object GetValue(string propertyName, CDP4Common.DTO.Thing thing)
        {
            ...
            return this.propertyValueMap[propertyName]((CDP4Common.DTO.UnitPrefix)thing);
        }
        ...
        /// <summary>
        /// Instantiates a <see cref="CDP4Common.DTO.UnitPrefix"/>
        /// </summary>
        /// <returns>
        ...
        {
            return new CDP4Common.DTO.UnitPrefix(guid, revisionNumber);
        }
    }
}
