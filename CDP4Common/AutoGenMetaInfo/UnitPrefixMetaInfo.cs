...
namespace CDP4Common.MetaInfo
{
    ...
    public partial class UnitPrefixMetaInfo : IUnitPrefixMetaInfo
    {
        ...
        {
            { "ModelReferenceDataLibrary", new PropertyMetaInfo("UnitPrefix", "Guid", PropertyKind.List, AggregationKind.Composite, false, false, true, 0, "*", true) },
            { "SiteReferenceDataLibrary", new PropertyMetaInfo("UnitPrefix", "Guid", PropertyKind.List, AggregationKind.Composite, false, false, true, 0, "*", true) },
        };
