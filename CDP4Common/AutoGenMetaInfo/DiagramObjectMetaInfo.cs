// --------------------------------------------------------------------------------------------------------------------
// <copyright file="DiagramObjectMetaInfo.cs" company="Starion Group S.A.">
...
namespace CDP4Common.MetaInfo
{
    ...
    public partial class DiagramObjectMetaInfo : IDiagramObjectMetaInfo
    {
        ...
        public IEnumerable<Guid> GetContainmentIds(CDP4Common.DTO.Thing diagramObject, string propertyName)
        {
            ...
            {
                throw new ArgumentException($"'{propertyName}' is not a valid containment property of 'DiagramObject'");
            }
        ...
        {
            { "Actor", (diagramObject, value) => diagramObject.Actor = value == null ? (Guid?)null : (Guid)value },
        ...
        public object DeserializeCollectionValue(string propertyName, object value)
        {
            ...
            {
                throw new ArgumentException($"'{propertyName}' is not a valid collection property of 'DiagramObject'");
            }
