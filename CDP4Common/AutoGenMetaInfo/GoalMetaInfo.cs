// --------------------------------------------------------------------------------------------------------------------
// <copyright file="GoalMetaInfo.cs" company="Starion Group S.A.">
...
namespace CDP4Common.MetaInfo
{
    ...
    /// <summary>
    /// This a class that holds meta info for <see cref="Goal"/>.
    /// </summary>
    public partial class GoalMetaInfo : IGoalMetaInfo
    {
        /// <summary>
        ...
        /// </summary>
        private readonly Dictionary<string, Func<CDP4Common.DTO.Goal, IEnumerable<OrderedItem>>> orderedContainmentPropertyValueMap = new Dictionary<string, Func<CDP4Common.DTO.Goal, IEnumerable<OrderedItem>>>();

        /// <summary>
        /// The validation rules that should pass for an instance of <see cref="CDP4Common.DTO.Goal"/>.
        /// </summary>
        private readonly Dictionary<string, DtoValidationHelper<CDP4Common.DTO.Goal>> validationRules = new Dictionary<string, DtoValidationHelper<CDP4Common.DTO.Goal>>
        {
            ...
            { "ExcludedPerson", new DtoValidationHelper<CDP4Common.DTO.Goal>(item => item.ExcludedPerson != null, "The 'ExcludedPerson' property of a 'Goal' is mandatory and cannot be null.") },
            { "HyperLink", new DtoValidationHelper<CDP4Common.DTO.Goal>(item => item.HyperLink != null, "The 'HyperLink' property of a 'Goal' is mandatory and cannot be null.") },
            { "Name", new DtoValidationHelper<CDP4Common.DTO.Goal>(item => !string.IsNullOrWhiteSpace(item.Name), "The 'Name' property of a 'Goal' is mandatory and cannot be empty or null.") },
            { "ShortName", new DtoValidationHelper<CDP4Common.DTO.Goal>(item => !string.IsNullOrWhiteSpace(item.ShortName), "The 'ShortName' property of a 'Goal' is mandatory and cannot be empty or null.") },
        };
        ...
        /// If any validation rule failed.
        /// </exception>
        public void Validate(CDP4Common.DTO.Thing goal, Func<string, bool> validateProperty)
        {
            foreach (var applicableRule in this.validationRules.Where(x => validateProperty(x.Key)))
            {
                applicableRule.Value.Validate((CDP4Common.DTO.Goal)goal);
            }
        }
        ...
        /// True if all validation rules have passed or if none are defined.
        /// </returns>
        public bool TryValidate(CDP4Common.DTO.Thing goal, Func<string, bool> validateProperty)
        {
            var applicableValidationRules = this.validationRules.Where(x => validateProperty(x.Key)).Select(x => x.Value);

            return applicableValidationRules.All(applicableRule => applicableRule.TryValidate((CDP4Common.DTO.Goal)goal));
        }

        /// <summary>
        /// Returns the containment property value for the supplied <see cref="CDP4Common.DTO.Goal"/>.
        /// </summary>
        /// <param name="goal">
        /// The <see cref="CDP4Common.DTO.Goal"/> for which to return the containment property value.
        /// </param>
        ...
        /// If the property name is not supported for the <see cref="CDP4Common.DTO.Goal"/>.
        /// </exception>
        public IEnumerable<Guid> GetContainmentIds(CDP4Common.DTO.Thing goal, string propertyName)
        {
            if (!this.containmentPropertyValueMap.ContainsKey(propertyName))
            {
                throw new ArgumentException($"'{propertyName}' is not a valid containment property of 'Goal'");
            }

            return this.containmentPropertyValueMap[propertyName]((CDP4Common.DTO.Goal)goal);
        }

        /// <summary>
        /// Returns the ordered containment property value for the supplied <see cref="CDP4Common.DTO.Goal"/>.
        /// </summary>
        /// <param name="goal">
        /// The <see cref="CDP4Common.DTO.Goal"/> for which to return the containment property value.
        /// </param>
        ...
        /// If the property name is not supported for the <see cref="CDP4Common.DTO.Goal"/>.
        /// </exception>
        public IEnumerable<OrderedItem> GetOrderedContainmentIds(CDP4Common.DTO.Thing goal, string propertyName)
        {
            ...
            return this.orderedContainmentPropertyValueMap[propertyName]((CDP4Common.DTO.Goal)goal);
        }
        ...
        /// <summary>
        /// Gets the <see cref="PropertyMetaInfo"/> for the <see cref="Goal"/> class
        /// </summary>
        ...
        /// </summary>
        private readonly Dictionary<string, Func<CDP4Common.DTO.Goal, object>> propertyValueMap = new Dictionary<string, Func<CDP4Common.DTO.Goal, object>>
        {
        ...
        /// </summary>
        private readonly Dictionary<string, Action<CDP4Common.DTO.Goal, object>> propertyValueAssignmentMap = new Dictionary<string, Action<CDP4Common.DTO.Goal, object>>
        {
            { "Actor", (goal, value) => goal.Actor = value == null ? (Guid?)null : (Guid)value },
            { "Iid", (goal, value) => goal.Iid = (Guid)value },
            { "ModifiedOn", (goal, value) => goal.ModifiedOn = (DateTime)value },
            { "Name", (goal, value) => goal.Name = value.ToString() },
            { "ShortName", (goal, value) => goal.ShortName = value.ToString() },
            { "ThingPreference", (goal, value) => goal.ThingPreference = value == null ? (string)null : value.ToString() },
        };
        ...
        {
            { "Iteration", new PropertyMetaInfo("Goal", "Goal", PropertyKind.List, AggregationKind.Composite, false, false, true, 0, "*", true) },
        };
        ...
        /// <summary>
        /// Returns the <see cref="CDP4Common.DTO.Goal"/> containment property type from the supplied property name.
        /// </summary>
        /// <param name="propertyName">
        ...
        /// <summary>
        /// Returns the <see cref="CDP4Common.DTO.Goal"/> property type from the supplied property name.
        /// </summary>
        /// <param name="propertyName">
        /// The property name.
        /// </param>
        ...
        /// <summary>
        /// Returns the container property for the supplied type name is a possible container for <see cref="CDP4Common.DTO.Goal"/>.
        /// </summary>
        /// <param name="typeName">
        /// Name of the type for which to check if it is a container of <see cref="CDP4Common.DTO.Goal"/>.
        /// </param>
        /// <param name="containerProperty">
        /// Supplied container property info instance that will be set if the supplied type name is a container of <see cref="CDP4Common.DTO.Goal"/>.
        /// </param>
        /// <returns>
        /// True if the supplied typeName is a container for <see cref="CDP4Common.DTO.Goal"/> and sets the container property name.
        /// </returns>
        ...
        /// <summary>
        /// Check if the supplied property name for <see cref="CDP4Common.DTO.Goal"/> is scalar.
        /// </summary>
        /// <param name="propertyName">
        /// Name of the property for which to check if it is scalar.
        /// </param>
        ...
        public bool ApplyPropertyUpdate(CDP4Common.DTO.Thing updatableThing, string propertyName, object value)
        {
            ...
            this.propertyValueAssignmentMap[propertyName]((CDP4Common.DTO.Goal)updatableThing, value);
        ...
        public object DeserializeCollectionValue(string propertyName, object value)
        {
            ...
            {
                throw new ArgumentException($"'{propertyName}' is not a valid collection property of 'Goal'");
            }
        ...
        public object GetValue(string propertyName, CDP4Common.DTO.Thing thing)
        {
            ...
            return this.propertyValueMap[propertyName]((CDP4Common.DTO.Goal)thing);
        }
        ...
        /// <summary>
        /// Instantiates a <see cref="CDP4Common.DTO.Goal"/>
        /// </summary>
        /// <returns>
        ...
        {
            return new CDP4Common.DTO.Goal(guid, revisionNumber);
        }
    }
}
