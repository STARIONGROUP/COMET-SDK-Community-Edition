// --------------------------------------------------------------------------------------------------------------------
// <copyright file="EngineeringModelDataDiscussionItemMetaInfo.cs" company="Starion Group S.A.">
...
namespace CDP4Common.MetaInfo
{
    ...
    /// </summary>
    public partial class EngineeringModelDataDiscussionItemMetaInfo : IEngineeringModelDataDiscussionItemMetaInfo
    {
        /// <summary>
        /// The containment property value map.
        /// </summary>
        private readonly Dictionary<string, Func<CDP4Common.DTO.EngineeringModelDataDiscussionItem, IEnumerable<Guid>>> containmentPropertyValueMap = new Dictionary<string, Func<CDP4Common.DTO.EngineeringModelDataDiscussionItem, IEnumerable<Guid>>>();

        /// <summary>
        /// The ordered containment property value map.
        /// </summary>
        private readonly Dictionary<string, Func<CDP4Common.DTO.EngineeringModelDataDiscussionItem, IEnumerable<OrderedItem>>> orderedContainmentPropertyValueMap = new Dictionary<string, Func<CDP4Common.DTO.EngineeringModelDataDiscussionItem, IEnumerable<OrderedItem>>>();

        /// <summary>
        /// The validation rules that should pass for an instance of <see cref="CDP4Common.DTO.EngineeringModelDataDiscussionItem"/>.
        /// </summary>
        private readonly Dictionary<string, DtoValidationHelper<CDP4Common.DTO.EngineeringModelDataDiscussionItem>> validationRules = new Dictionary<string, DtoValidationHelper<CDP4Common.DTO.EngineeringModelDataDiscussionItem>>
        {
            { "Content", new DtoValidationHelper<CDP4Common.DTO.EngineeringModelDataDiscussionItem>(item => !string.IsNullOrWhiteSpace(item.Content), "The 'Content' property of a 'EngineeringModelDataDiscussionItem' is mandatory and cannot be empty or null.") },
            { "ExcludedDomain", new DtoValidationHelper<CDP4Common.DTO.EngineeringModelDataDiscussionItem>(item => item.ExcludedDomain != null, "The 'ExcludedDomain' property of a 'EngineeringModelDataDiscussionItem' is mandatory and cannot be null.") },
            { "ExcludedPerson", new DtoValidationHelper<CDP4Common.DTO.EngineeringModelDataDiscussionItem>(item => item.ExcludedPerson != null, "The 'ExcludedPerson' property of a 'EngineeringModelDataDiscussionItem' is mandatory and cannot be null.") },
            { "LanguageCode", new DtoValidationHelper<CDP4Common.DTO.EngineeringModelDataDiscussionItem>(item => !string.IsNullOrWhiteSpace(item.LanguageCode), "The 'LanguageCode' property of a 'EngineeringModelDataDiscussionItem' is mandatory and cannot be empty or null.") },
        };
        ...
        /// </exception>
        public void Validate(CDP4Common.DTO.Thing engineeringModelDataDiscussionItem)
        {
            this.Validate(engineeringModelDataDiscussionItem, x => true);
        }
        ...
        /// If any validation rule failed.
        /// </exception>
        public void Validate(CDP4Common.DTO.Thing engineeringModelDataDiscussionItem, Func<string, bool> validateProperty)
        {
            foreach (var applicableRule in this.validationRules.Where(x => validateProperty(x.Key)))
            {
                applicableRule.Value.Validate((CDP4Common.DTO.EngineeringModelDataDiscussionItem)engineeringModelDataDiscussionItem);
            }
        }
        ...
        /// </returns>
        public bool TryValidate(CDP4Common.DTO.Thing engineeringModelDataDiscussionItem)
        {
            return this.TryValidate(engineeringModelDataDiscussionItem, x => true);
        }
        ...
        /// True if all validation rules have passed or if none are defined.
        /// </returns>
        public bool TryValidate(CDP4Common.DTO.Thing engineeringModelDataDiscussionItem, Func<string, bool> validateProperty)
        {
            var applicableValidationRules = this.validationRules.Where(x => validateProperty(x.Key)).Select(x => x.Value);

            return applicableValidationRules.All(applicableRule => applicableRule.TryValidate((CDP4Common.DTO.EngineeringModelDataDiscussionItem)engineeringModelDataDiscussionItem));
        }

        /// <summary>
        /// Returns the containment property value for the supplied <see cref="CDP4Common.DTO.EngineeringModelDataDiscussionItem"/>.
        /// </summary>
        /// <param name="engineeringModelDataDiscussionItem">
        /// The <see cref="CDP4Common.DTO.EngineeringModelDataDiscussionItem"/> for which to return the containment property value.
        /// </param>
        ...
        /// If the property name is not supported for the <see cref="CDP4Common.DTO.EngineeringModelDataDiscussionItem"/>.
        /// </exception>
        public IEnumerable<Guid> GetContainmentIds(CDP4Common.DTO.Thing engineeringModelDataDiscussionItem, string propertyName)
        {
            if (!this.containmentPropertyValueMap.ContainsKey(propertyName))
            {
                throw new ArgumentException($"'{propertyName}' is not a valid containment property of 'EngineeringModelDataDiscussionItem'");
            }

            return this.containmentPropertyValueMap[propertyName]((CDP4Common.DTO.EngineeringModelDataDiscussionItem)engineeringModelDataDiscussionItem);
        }

        /// <summary>
        /// Returns the ordered containment property value for the supplied <see cref="CDP4Common.DTO.EngineeringModelDataDiscussionItem"/>.
        /// </summary>
        /// <param name="engineeringModelDataDiscussionItem">
        /// The <see cref="CDP4Common.DTO.EngineeringModelDataDiscussionItem"/> for which to return the containment property value.
        /// </param>
        ...
        /// If the property name is not supported for the <see cref="CDP4Common.DTO.EngineeringModelDataDiscussionItem"/>.
        /// </exception>
        public IEnumerable<OrderedItem> GetOrderedContainmentIds(CDP4Common.DTO.Thing engineeringModelDataDiscussionItem, string propertyName)
        {
            ...
            return this.orderedContainmentPropertyValueMap[propertyName]((CDP4Common.DTO.EngineeringModelDataDiscussionItem)engineeringModelDataDiscussionItem);
        }
        ...
        /// <summary>
        /// Gets the <see cref="PropertyMetaInfo"/> for the <see cref="EngineeringModelDataDiscussionItem"/> class
        /// </summary>
        ...
        /// </summary>
        private readonly Dictionary<string, Func<CDP4Common.DTO.EngineeringModelDataDiscussionItem, object>> propertyValueMap = new Dictionary<string, Func<CDP4Common.DTO.EngineeringModelDataDiscussionItem, object>>
        {
        ...
        /// </summary>
        private readonly Dictionary<string, Action<CDP4Common.DTO.EngineeringModelDataDiscussionItem, object>> propertyValueAssignmentMap = new Dictionary<string, Action<CDP4Common.DTO.EngineeringModelDataDiscussionItem, object>>
        {
            { "Actor", (engineeringModelDataDiscussionItem, value) => engineeringModelDataDiscussionItem.Actor = value == null ? (Guid?)null : (Guid)value },
            { "Author", (engineeringModelDataDiscussionItem, value) => engineeringModelDataDiscussionItem.Author = (Guid)value },
            { "Content", (engineeringModelDataDiscussionItem, value) => engineeringModelDataDiscussionItem.Content = value.ToString() },
            { "CreatedOn", (engineeringModelDataDiscussionItem, value) => engineeringModelDataDiscussionItem.CreatedOn = (DateTime)value },
            { "Iid", (engineeringModelDataDiscussionItem, value) => engineeringModelDataDiscussionItem.Iid = (Guid)value },
        ...
        /// <summary>
        /// Returns the <see cref="CDP4Common.DTO.EngineeringModelDataDiscussionItem"/> containment property type from the supplied property name.
        /// </summary>
        /// <param name="propertyName">
        ...
        /// <summary>
        /// Returns the <see cref="CDP4Common.DTO.EngineeringModelDataDiscussionItem"/> property type from the supplied property name.
        /// </summary>
        /// <param name="propertyName">
        /// The property name.
        /// </param>
        ...
        /// <summary>
        /// Returns the container property for the supplied type name is a possible container for <see cref="CDP4Common.DTO.EngineeringModelDataDiscussionItem"/>.
        /// </summary>
        /// <param name="typeName">
        /// Name of the type for which to check if it is a container of <see cref="CDP4Common.DTO.EngineeringModelDataDiscussionItem"/>.
        /// </param>
        /// <param name="containerProperty">
        /// Supplied container property info instance that will be set if the supplied type name is a container of <see cref="CDP4Common.DTO.EngineeringModelDataDiscussionItem"/>.
        /// </param>
        /// <returns>
        /// True if the supplied typeName is a container for <see cref="CDP4Common.DTO.EngineeringModelDataDiscussionItem"/> and sets the container property name.
        /// </returns>
        ...
        /// <summary>
        /// Check if the supplied property name for <see cref="CDP4Common.DTO.EngineeringModelDataDiscussionItem"/> is scalar.
        /// </summary>
        /// <param name="propertyName">
        /// Name of the property for which to check if it is scalar.
        /// </param>
        ...
        public bool ApplyPropertyUpdate(CDP4Common.DTO.Thing updatableThing, string propertyName, object value)
        {
            ...
            this.propertyValueAssignmentMap[propertyName]((CDP4Common.DTO.EngineeringModelDataDiscussionItem)updatableThing, value);
        ...
        public object DeserializeCollectionValue(string propertyName, object value)
        {
            ...
            {
                throw new ArgumentException($"'{propertyName}' is not a valid collection property of 'EngineeringModelDataDiscussionItem'");
            }
        ...
        public object GetValue(string propertyName, CDP4Common.DTO.Thing thing)
        {
            ...
            return this.propertyValueMap[propertyName]((CDP4Common.DTO.EngineeringModelDataDiscussionItem)thing);
        }
        ...
        /// <summary>
        /// Instantiates a <see cref="CDP4Common.DTO.EngineeringModelDataDiscussionItem"/>
        /// </summary>
        /// <returns>
        ...
        {
            return new CDP4Common.DTO.EngineeringModelDataDiscussionItem(guid, revisionNumber);
        }
    }
}
