...
namespace CDP4Common.MetaInfo
{
    ...
    public partial class EngineeringModelDataDiscussionItemMetaInfo : IEngineeringModelDataDiscussionItemMetaInfo
    {
        ...
        public IEnumerable<Guid> GetContainmentIds(CDP4Common.DTO.Thing engineeringModelDataDiscussionItem, string propertyName)
        {
            ...
            {
                throw new ArgumentException(string.Format("'{0}' is not a valid containment property of 'EngineeringModelDataDiscussionItem'", propertyName));
            }
        ...
        public object DeserializeCollectionValue(string propertyName, object value)
        {
            ...
            {
                throw new ArgumentException(string.Format("'{0}' is not a valid collection property of 'EngineeringModelDataDiscussionItem'", propertyName));
            }
