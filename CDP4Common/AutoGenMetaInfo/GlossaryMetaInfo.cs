...
namespace CDP4Common.MetaInfo
{
    ...
    public partial class GlossaryMetaInfo : IGlossaryMetaInfo
    {
        ...
        private readonly Dictionary<string, PropertyMetaInfo> containmentTypeMap = new Dictionary<string, PropertyMetaInfo>
        {
            ...
            { "Term", new PropertyMetaInfo("Term", "Guid", PropertyKind.List, AggregationKind.Composite, false, false, true, 0, "*", true) },
        };
        ...
        {
            { "ModelReferenceDataLibrary", new PropertyMetaInfo("Glossary", "Guid", PropertyKind.List, AggregationKind.Composite, false, false, true, 0, "*", true) },
            { "SiteReferenceDataLibrary", new PropertyMetaInfo("Glossary", "Guid", PropertyKind.List, AggregationKind.Composite, false, false, true, 0, "*", true) },
        };
