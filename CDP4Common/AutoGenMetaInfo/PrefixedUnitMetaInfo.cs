// --------------------------------------------------------------------------------------------------------------------
// <copyright file="PrefixedUnitMetaInfo.cs" company="Starion Group S.A.">
...
namespace CDP4Common.MetaInfo
{
    ...
    /// <summary>
    /// This a class that holds meta info for <see cref="PrefixedUnit"/>.
    /// </summary>
    public partial class PrefixedUnitMetaInfo : IPrefixedUnitMetaInfo
    {
        /// <summary>
        ...
        /// </summary>
        private readonly Dictionary<string, Func<CDP4Common.DTO.PrefixedUnit, IEnumerable<OrderedItem>>> orderedContainmentPropertyValueMap = new Dictionary<string, Func<CDP4Common.DTO.PrefixedUnit, IEnumerable<OrderedItem>>>();

        /// <summary>
        /// The validation rules that should pass for an instance of <see cref="CDP4Common.DTO.PrefixedUnit"/>.
        /// </summary>
        private readonly Dictionary<string, DtoValidationHelper<CDP4Common.DTO.PrefixedUnit>> validationRules = new Dictionary<string, DtoValidationHelper<CDP4Common.DTO.PrefixedUnit>>
        {
            ...
            { "HyperLink", new DtoValidationHelper<CDP4Common.DTO.PrefixedUnit>(item => item.HyperLink != null, "The 'HyperLink' property of a 'PrefixedUnit' is mandatory and cannot be null.") },
        };
        ...
        /// </exception>
        public void Validate(CDP4Common.DTO.Thing prefixedUnit)
        {
            this.Validate(prefixedUnit, x => true);
        }
        ...
        /// If any validation rule failed.
        /// </exception>
        public void Validate(CDP4Common.DTO.Thing prefixedUnit, Func<string, bool> validateProperty)
        {
            foreach (var applicableRule in this.validationRules.Where(x => validateProperty(x.Key)))
            {
                applicableRule.Value.Validate((CDP4Common.DTO.PrefixedUnit)prefixedUnit);
            }
        }
        ...
        /// </returns>
        public bool TryValidate(CDP4Common.DTO.Thing prefixedUnit)
        {
            return this.TryValidate(prefixedUnit, x => true);
        }
        ...
        /// True if all validation rules have passed or if none are defined.
        /// </returns>
        public bool TryValidate(CDP4Common.DTO.Thing prefixedUnit, Func<string, bool> validateProperty)
        {
            var applicableValidationRules = this.validationRules.Where(x => validateProperty(x.Key)).Select(x => x.Value);

            return applicableValidationRules.All(applicableRule => applicableRule.TryValidate((CDP4Common.DTO.PrefixedUnit)prefixedUnit));
        }

        /// <summary>
        /// Returns the containment property value for the supplied <see cref="CDP4Common.DTO.PrefixedUnit"/>.
        /// </summary>
        /// <param name="prefixedUnit">
        /// The <see cref="CDP4Common.DTO.PrefixedUnit"/> for which to return the containment property value.
        /// </param>
        ...
        /// If the property name is not supported for the <see cref="CDP4Common.DTO.PrefixedUnit"/>.
        /// </exception>
        public IEnumerable<Guid> GetContainmentIds(CDP4Common.DTO.Thing prefixedUnit, string propertyName)
        {
        ...
        /// <summary>
        /// Returns the ordered containment property value for the supplied <see cref="CDP4Common.DTO.PrefixedUnit"/>.
        /// </summary>
        /// <param name="prefixedUnit">
        /// The <see cref="CDP4Common.DTO.PrefixedUnit"/> for which to return the containment property value.
        /// </param>
        ...
        /// If the property name is not supported for the <see cref="CDP4Common.DTO.PrefixedUnit"/>.
        /// </exception>
        public IEnumerable<OrderedItem> GetOrderedContainmentIds(CDP4Common.DTO.Thing prefixedUnit, string propertyName)
        {
        ...
        /// <summary>
        /// Gets the <see cref="PropertyMetaInfo"/> for the <see cref="PrefixedUnit"/> class
        /// </summary>
        ...
        private readonly Dictionary<string, PropertyMetaInfo> propertyTypeMap = new Dictionary<string, PropertyMetaInfo>
        {
            ...
            { "ConversionFactor", new PropertyMetaInfo("ConversionFactor", "string", PropertyKind.Scalar, AggregationKind.None, true, false, true, 1, "1", false) },
            ...
            { "Prefix", new PropertyMetaInfo("Prefix", "UnitPrefix", PropertyKind.Scalar, AggregationKind.None, false, false, true, 1, "1", true) },
        ...
        /// </summary>
        private readonly Dictionary<string, Action<CDP4Common.DTO.PrefixedUnit, object>> propertyValueAssignmentMap = new Dictionary<string, Action<CDP4Common.DTO.PrefixedUnit, object>>
        {
            { "Actor", (prefixedUnit, value) => prefixedUnit.Actor = value == null ? (Guid?)null : (Guid)value },
            { "Iid", (prefixedUnit, value) => prefixedUnit.Iid = (Guid)value },
            { "IsDeprecated", (prefixedUnit, value) => prefixedUnit.IsDeprecated = (bool)value },
        ...
        /// <summary>
        /// Returns the <see cref="CDP4Common.DTO.PrefixedUnit"/> containment property type from the supplied property name.
        /// </summary>
        /// <param name="propertyName">
        ...
        /// <summary>
        /// Returns the <see cref="CDP4Common.DTO.PrefixedUnit"/> property type from the supplied property name.
        /// </summary>
        /// <param name="propertyName">
        /// The property name.
        /// </param>
        ...
        /// <summary>
        /// Returns the container property for the supplied type name is a possible container for <see cref="CDP4Common.DTO.PrefixedUnit"/>.
        /// </summary>
        /// <param name="typeName">
        /// Name of the type for which to check if it is a container of <see cref="CDP4Common.DTO.PrefixedUnit"/>.
        /// </param>
        /// <param name="containerProperty">
        /// Supplied container property info instance that will be set if the supplied type name is a container of <see cref="CDP4Common.DTO.PrefixedUnit"/>.
        /// </param>
        /// <returns>
        /// True if the supplied typeName is a container for <see cref="CDP4Common.DTO.PrefixedUnit"/> and sets the container property name.
        /// </returns>
        ...
        /// <summary>
        /// Check if the supplied property name for <see cref="CDP4Common.DTO.PrefixedUnit"/> is scalar.
        /// </summary>
        /// <param name="propertyName">
        /// Name of the property for which to check if it is scalar.
        /// </param>
        ...
        public bool ApplyPropertyUpdate(CDP4Common.DTO.Thing updatableThing, string propertyName, object value)
        {
            ...
            this.propertyValueAssignmentMap[propertyName]((CDP4Common.DTO.PrefixedUnit)updatableThing, value);
        ...
        /// <summary>
        /// Instantiates a <see cref="CDP4Common.DTO.PrefixedUnit"/>
        /// </summary>
        /// <returns>
        ...
        {
            return new CDP4Common.DTO.PrefixedUnit(guid, revisionNumber);
        }
    }
}
