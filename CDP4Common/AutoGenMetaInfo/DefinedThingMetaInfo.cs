// --------------------------------------------------------------------------------------------------------------------
// <copyright file="DefinedThingMetaInfo.cs" company="RHEA System S.A.">
...
namespace CDP4Common.MetaInfo
{
    ...
    /// <summary>
    /// This a class that holds meta info for <see cref="DefinedThing"/>.
    /// </summary>
    public partial class DefinedThingMetaInfo : IDefinedThingMetaInfo
    {
        /// <summary>
        /// The containment property value map.
        /// </summary>
        private readonly Dictionary<string, Func<CDP4Common.DTO.DefinedThing, IEnumerable<Guid>>> containmentPropertyValueMap = new Dictionary<string, Func<CDP4Common.DTO.DefinedThing, IEnumerable<Guid>>>
        {
            { "Alias", definedThing => definedThing.Alias },
            { "Attachment", definedThing => definedThing.Attachment },
            { "Definition", definedThing => definedThing.Definition },
            { "HyperLink", definedThing => definedThing.HyperLink },
        };

        /// <summary>
        /// The ordered containment property value map.
        /// </summary>
        private readonly Dictionary<string, Func<CDP4Common.DTO.DefinedThing, IEnumerable<OrderedItem>>> orderedContainmentPropertyValueMap = new Dictionary<string, Func<CDP4Common.DTO.DefinedThing, IEnumerable<OrderedItem>>>();

        /// <summary>
        /// The validation rules that should pass for an instance of <see cref="CDP4Common.DTO.DefinedThing"/>.
        /// </summary>
        private readonly Dictionary<string, DtoValidationHelper<CDP4Common.DTO.DefinedThing>> validationRules = new Dictionary<string, DtoValidationHelper<CDP4Common.DTO.DefinedThing>>
        {
            { "Alias", new DtoValidationHelper<CDP4Common.DTO.DefinedThing>(item => item.Alias != null, "The 'Alias' property of a 'DefinedThing' is mandatory and cannot be null.") },
            { "Attachment", new DtoValidationHelper<CDP4Common.DTO.DefinedThing>(item => item.Attachment != null, "The 'Attachment' property of a 'DefinedThing' is mandatory and cannot be null.") },
            { "Definition", new DtoValidationHelper<CDP4Common.DTO.DefinedThing>(item => item.Definition != null, "The 'Definition' property of a 'DefinedThing' is mandatory and cannot be null.") },
            { "ExcludedDomain", new DtoValidationHelper<CDP4Common.DTO.DefinedThing>(item => item.ExcludedDomain != null, "The 'ExcludedDomain' property of a 'DefinedThing' is mandatory and cannot be null.") },
            { "ExcludedPerson", new DtoValidationHelper<CDP4Common.DTO.DefinedThing>(item => item.ExcludedPerson != null, "The 'ExcludedPerson' property of a 'DefinedThing' is mandatory and cannot be null.") },
            { "HyperLink", new DtoValidationHelper<CDP4Common.DTO.DefinedThing>(item => item.HyperLink != null, "The 'HyperLink' property of a 'DefinedThing' is mandatory and cannot be null.") },
            { "Name", new DtoValidationHelper<CDP4Common.DTO.DefinedThing>(item => !string.IsNullOrWhiteSpace(item.Name), "The 'Name' property of a 'DefinedThing' is mandatory and cannot be empty or null.") },
            { "ShortName", new DtoValidationHelper<CDP4Common.DTO.DefinedThing>(item => !string.IsNullOrWhiteSpace(item.ShortName), "The 'ShortName' property of a 'DefinedThing' is mandatory and cannot be empty or null.") },
        };
        ...
        /// </exception>
        public void Validate(CDP4Common.DTO.Thing definedThing)
        {
            this.Validate(definedThing, x => true);
        }
        ...
        /// If any validation rule failed.
        /// </exception>
        public void Validate(CDP4Common.DTO.Thing definedThing, Func<string, bool> validateProperty)
        {
            foreach (var applicableRule in this.validationRules.Where(x => validateProperty(x.Key)))
            {
                applicableRule.Value.Validate((CDP4Common.DTO.DefinedThing)definedThing);
            }
        }
        ...
        /// </returns>
        public bool TryValidate(CDP4Common.DTO.Thing definedThing)
        {
            return this.TryValidate(definedThing, x => true);
        }
        ...
        /// True if all validation rules have passed or if none are defined.
        /// </returns>
        public bool TryValidate(CDP4Common.DTO.Thing definedThing, Func<string, bool> validateProperty)
        {
            var applicableValidationRules = this.validationRules.Where(x => validateProperty(x.Key)).Select(x => x.Value);

            return applicableValidationRules.All(applicableRule => applicableRule.TryValidate((CDP4Common.DTO.DefinedThing)definedThing));
        }

        /// <summary>
        /// Returns the containment property value for the supplied <see cref="CDP4Common.DTO.DefinedThing"/>.
        /// </summary>
        /// <param name="definedThing">
        /// The <see cref="CDP4Common.DTO.DefinedThing"/> for which to return the containment property value.
        /// </param>
        ...
        /// If the property name is not supported for the <see cref="CDP4Common.DTO.DefinedThing"/>.
        /// </exception>
        public IEnumerable<Guid> GetContainmentIds(CDP4Common.DTO.Thing definedThing, string propertyName)
        {
            if (!this.containmentPropertyValueMap.ContainsKey(propertyName))
            {
                throw new ArgumentException($"'{propertyName}' is not a valid containment property of 'DefinedThing'");
            }

            return this.containmentPropertyValueMap[propertyName]((CDP4Common.DTO.DefinedThing)definedThing);
        }

        /// <summary>
        /// Returns the ordered containment property value for the supplied <see cref="CDP4Common.DTO.DefinedThing"/>.
        /// </summary>
        /// <param name="definedThing">
        /// The <see cref="CDP4Common.DTO.DefinedThing"/> for which to return the containment property value.
        /// </param>
        ...
        /// If the property name is not supported for the <see cref="CDP4Common.DTO.DefinedThing"/>.
        /// </exception>
        public IEnumerable<OrderedItem> GetOrderedContainmentIds(CDP4Common.DTO.Thing definedThing, string propertyName)
        {
            ...
            return this.orderedContainmentPropertyValueMap[propertyName]((CDP4Common.DTO.DefinedThing)definedThing);
        }
        ...
        /// <summary>
        /// Gets the <see cref="PropertyMetaInfo"/> for the <see cref="DefinedThing"/> class
        /// </summary>
        ...
        /// </summary>
        private readonly Dictionary<string, Func<CDP4Common.DTO.DefinedThing, object>> propertyValueMap = new Dictionary<string, Func<CDP4Common.DTO.DefinedThing, object>>
        {
        ...
        /// </summary>
        private readonly Dictionary<string, Action<CDP4Common.DTO.DefinedThing, object>> propertyValueAssignmentMap = new Dictionary<string, Action<CDP4Common.DTO.DefinedThing, object>>
        {
            { "Actor", (definedThing, value) => definedThing.Actor = value == null ? (Guid?)null : (Guid)value },
            { "Iid", (definedThing, value) => definedThing.Iid = (Guid)value },
            { "ModifiedOn", (definedThing, value) => definedThing.ModifiedOn = (DateTime)value },
            { "Name", (definedThing, value) => definedThing.Name = value.ToString() },
            { "ShortName", (definedThing, value) => definedThing.ShortName = value.ToString() },
            { "ThingPreference", (definedThing, value) => definedThing.ThingPreference = value == null ? (string)null : value.ToString() },
        };
        ...
        /// <summary>
        /// Returns the <see cref="CDP4Common.DTO.DefinedThing"/> containment property type from the supplied property name.
        /// </summary>
        /// <param name="propertyName">
        ...
        /// <summary>
        /// Returns the <see cref="CDP4Common.DTO.DefinedThing"/> property type from the supplied property name.
        /// </summary>
        /// <param name="propertyName">
        /// The property name.
        /// </param>
        ...
        /// <summary>
        /// Returns the container property for the supplied type name is a possible container for <see cref="CDP4Common.DTO.DefinedThing"/>.
        /// </summary>
        /// <param name="typeName">
        /// Name of the type for which to check if it is a container of <see cref="CDP4Common.DTO.DefinedThing"/>.
        /// </param>
        /// <param name="containerProperty">
        /// Supplied container property info instance that will be set if the supplied type name is a container of <see cref="CDP4Common.DTO.DefinedThing"/>.
        /// </param>
        /// <returns>
        /// True if the supplied typeName is a container for <see cref="CDP4Common.DTO.DefinedThing"/> and sets the container property name.
        /// </returns>
        ...
        /// <summary>
        /// Check if the supplied property name for <see cref="CDP4Common.DTO.DefinedThing"/> is scalar.
        /// </summary>
        /// <param name="propertyName">
        /// Name of the property for which to check if it is scalar.
        /// </param>
        ...
        public bool ApplyPropertyUpdate(CDP4Common.DTO.Thing updatableThing, string propertyName, object value)
        {
            ...
            this.propertyValueAssignmentMap[propertyName]((CDP4Common.DTO.DefinedThing)updatableThing, value);
        ...
        public object DeserializeCollectionValue(string propertyName, object value)
        {
            ...
            {
                throw new ArgumentException($"'{propertyName}' is not a valid collection property of 'DefinedThing'");
            }
        ...
        public object GetValue(string propertyName, CDP4Common.DTO.Thing thing)
        {
            ...
            return this.propertyValueMap[propertyName]((CDP4Common.DTO.DefinedThing)thing);
        }
        ...
        /// <summary>
        /// Instantiates a <see cref="CDP4Common.DTO.DefinedThing"/>
        /// </summary>
        /// <returns>
