// --------------------------------------------------------------------------------------------------------------------
// <copyright file="NotExpressionMetaInfo.cs" company="Starion Group S.A.">
...
namespace CDP4Common.MetaInfo
{
    ...
    /// <summary>
    /// This a class that holds meta info for <see cref="NotExpression"/>.
    /// </summary>
    public partial class NotExpressionMetaInfo : INotExpressionMetaInfo
    {
        /// <summary>
        /// The containment property value map.
        /// </summary>
        private readonly Dictionary<string, Func<CDP4Common.DTO.NotExpression, IEnumerable<Guid>>> containmentPropertyValueMap = new Dictionary<string, Func<CDP4Common.DTO.NotExpression, IEnumerable<Guid>>>();

        /// <summary>
        /// The ordered containment property value map.
        /// </summary>
        private readonly Dictionary<string, Func<CDP4Common.DTO.NotExpression, IEnumerable<OrderedItem>>> orderedContainmentPropertyValueMap = new Dictionary<string, Func<CDP4Common.DTO.NotExpression, IEnumerable<OrderedItem>>>();

        /// <summary>
        /// The validation rules that should pass for an instance of <see cref="CDP4Common.DTO.NotExpression"/>.
        /// </summary>
        private readonly Dictionary<string, DtoValidationHelper<CDP4Common.DTO.NotExpression>> validationRules = new Dictionary<string, DtoValidationHelper<CDP4Common.DTO.NotExpression>>
        {
            { "ExcludedDomain", new DtoValidationHelper<CDP4Common.DTO.NotExpression>(item => item.ExcludedDomain != null, "The 'ExcludedDomain' property of a 'NotExpression' is mandatory and cannot be null.") },
            { "ExcludedPerson", new DtoValidationHelper<CDP4Common.DTO.NotExpression>(item => item.ExcludedPerson != null, "The 'ExcludedPerson' property of a 'NotExpression' is mandatory and cannot be null.") },
        };
        ...
        /// </exception>
        public void Validate(CDP4Common.DTO.Thing notExpression)
        {
            this.Validate(notExpression, x => true);
        }
        ...
        /// If any validation rule failed.
        /// </exception>
        public void Validate(CDP4Common.DTO.Thing notExpression, Func<string, bool> validateProperty)
        {
            foreach (var applicableRule in this.validationRules.Where(x => validateProperty(x.Key)))
            {
                applicableRule.Value.Validate((CDP4Common.DTO.NotExpression)notExpression);
            }
        }
        ...
        /// </returns>
        public bool TryValidate(CDP4Common.DTO.Thing notExpression)
        {
            return this.TryValidate(notExpression, x => true);
        }
        ...
        /// True if all validation rules have passed or if none are defined.
        /// </returns>
        public bool TryValidate(CDP4Common.DTO.Thing notExpression, Func<string, bool> validateProperty)
        {
            var applicableValidationRules = this.validationRules.Where(x => validateProperty(x.Key)).Select(x => x.Value);

            return applicableValidationRules.All(applicableRule => applicableRule.TryValidate((CDP4Common.DTO.NotExpression)notExpression));
        }

        /// <summary>
        /// Returns the containment property value for the supplied <see cref="CDP4Common.DTO.NotExpression"/>.
        /// </summary>
        /// <param name="notExpression">
        /// The <see cref="CDP4Common.DTO.NotExpression"/> for which to return the containment property value.
        /// </param>
        ...
        /// If the property name is not supported for the <see cref="CDP4Common.DTO.NotExpression"/>.
        /// </exception>
        public IEnumerable<Guid> GetContainmentIds(CDP4Common.DTO.Thing notExpression, string propertyName)
        {
            if (!this.containmentPropertyValueMap.ContainsKey(propertyName))
            {
                throw new ArgumentException($"'{propertyName}' is not a valid containment property of 'NotExpression'");
            }

            return this.containmentPropertyValueMap[propertyName]((CDP4Common.DTO.NotExpression)notExpression);
        }

        /// <summary>
        /// Returns the ordered containment property value for the supplied <see cref="CDP4Common.DTO.NotExpression"/>.
        /// </summary>
        /// <param name="notExpression">
        /// The <see cref="CDP4Common.DTO.NotExpression"/> for which to return the containment property value.
        /// </param>
        ...
        /// If the property name is not supported for the <see cref="CDP4Common.DTO.NotExpression"/>.
        /// </exception>
        public IEnumerable<OrderedItem> GetOrderedContainmentIds(CDP4Common.DTO.Thing notExpression, string propertyName)
        {
            ...
            return this.orderedContainmentPropertyValueMap[propertyName]((CDP4Common.DTO.NotExpression)notExpression);
        }
        ...
        /// <summary>
        /// Gets the <see cref="PropertyMetaInfo"/> for the <see cref="NotExpression"/> class
        /// </summary>
        ...
        /// </summary>
        private readonly Dictionary<string, Func<CDP4Common.DTO.NotExpression, object>> propertyValueMap = new Dictionary<string, Func<CDP4Common.DTO.NotExpression, object>>
        {
        ...
        private readonly Dictionary<string, PropertyMetaInfo> propertyTypeMap = new Dictionary<string, PropertyMetaInfo>
        {
            ...
            { "Term", new PropertyMetaInfo("Term", "BooleanExpression", PropertyKind.Scalar, AggregationKind.None, false, false, true, 1, "1", true) },
        ...
        /// </summary>
        private readonly Dictionary<string, Action<CDP4Common.DTO.NotExpression, object>> propertyValueAssignmentMap = new Dictionary<string, Action<CDP4Common.DTO.NotExpression, object>>
        {
            { "Actor", (notExpression, value) => notExpression.Actor = value == null ? (Guid?)null : (Guid)value },
            { "Iid", (notExpression, value) => notExpression.Iid = (Guid)value },
            { "ModifiedOn", (notExpression, value) => notExpression.ModifiedOn = (DateTime)value },
            { "Term", (notExpression, value) => notExpression.Term = (Guid)value },
            { "ThingPreference", (notExpression, value) => notExpression.ThingPreference = value == null ? (string)null : value.ToString() },
        };
        ...
        /// <summary>
        /// Returns the <see cref="CDP4Common.DTO.NotExpression"/> containment property type from the supplied property name.
        /// </summary>
        /// <param name="propertyName">
        ...
        /// <summary>
        /// Returns the <see cref="CDP4Common.DTO.NotExpression"/> property type from the supplied property name.
        /// </summary>
        /// <param name="propertyName">
        /// The property name.
        /// </param>
        ...
        /// <summary>
        /// Returns the container property for the supplied type name is a possible container for <see cref="CDP4Common.DTO.NotExpression"/>.
        /// </summary>
        /// <param name="typeName">
        /// Name of the type for which to check if it is a container of <see cref="CDP4Common.DTO.NotExpression"/>.
        /// </param>
        /// <param name="containerProperty">
        /// Supplied container property info instance that will be set if the supplied type name is a container of <see cref="CDP4Common.DTO.NotExpression"/>.
        /// </param>
        /// <returns>
        /// True if the supplied typeName is a container for <see cref="CDP4Common.DTO.NotExpression"/> and sets the container property name.
        /// </returns>
        ...
        /// <summary>
        /// Check if the supplied property name for <see cref="CDP4Common.DTO.NotExpression"/> is scalar.
        /// </summary>
        /// <param name="propertyName">
        /// Name of the property for which to check if it is scalar.
        /// </param>
        ...
        public bool ApplyPropertyUpdate(CDP4Common.DTO.Thing updatableThing, string propertyName, object value)
        {
            ...
            this.propertyValueAssignmentMap[propertyName]((CDP4Common.DTO.NotExpression)updatableThing, value);
        ...
        public object DeserializeCollectionValue(string propertyName, object value)
        {
            ...
            {
                throw new ArgumentException($"'{propertyName}' is not a valid collection property of 'NotExpression'");
            }
        ...
        public object GetValue(string propertyName, CDP4Common.DTO.Thing thing)
        {
            ...
            return this.propertyValueMap[propertyName]((CDP4Common.DTO.NotExpression)thing);
        }
        ...
        /// <summary>
        /// Instantiates a <see cref="CDP4Common.DTO.NotExpression"/>
        /// </summary>
        /// <returns>
        ...
        {
            return new CDP4Common.DTO.NotExpression(guid, revisionNumber);
        }
    }
}
