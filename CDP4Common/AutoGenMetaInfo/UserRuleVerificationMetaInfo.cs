// --------------------------------------------------------------------------------------------------------------------
// <copyright file="UserRuleVerificationMetaInfo.cs" company="Starion Group S.A.">
...
namespace CDP4Common.MetaInfo
{
    ...
    public partial class UserRuleVerificationMetaInfo : IUserRuleVerificationMetaInfo
    {
        ...
        public IEnumerable<Guid> GetContainmentIds(CDP4Common.DTO.Thing userRuleVerification, string propertyName)
        {
            ...
            {
                throw new ArgumentException($"'{propertyName}' is not a valid containment property of 'UserRuleVerification'");
            }
        ...
        {
            { "Actor", (userRuleVerification, value) => userRuleVerification.Actor = value == null ? (Guid?)null : (Guid)value },
        ...
        public object DeserializeCollectionValue(string propertyName, object value)
        {
            ...
            {
                throw new ArgumentException($"'{propertyName}' is not a valid collection property of 'UserRuleVerification'");
            }
