...
namespace CDP4Common.MetaInfo
{
    ...
    /// <summary>
    /// This a class that holds meta info for <see cref="EnumerationParameterType"/>.
    /// </summary>
    public partial class EnumerationParameterTypeMetaInfo : IEnumerationParameterTypeMetaInfo
    {
        /// <summary>
        /// The containment property value map.
        /// </summary>
        private readonly Dictionary<string, Func<CDP4Common.DTO.EnumerationParameterType, IEnumerable<Guid>>> containmentPropertyValueMap = new Dictionary<string, Func<CDP4Common.DTO.EnumerationParameterType, IEnumerable<Guid>>>
        {
            { "Alias", enumerationParameterType => enumerationParameterType.Alias },
            { "Attachment", enumerationParameterType => enumerationParameterType.Attachment },
            { "Definition", enumerationParameterType => enumerationParameterType.Definition },
            { "HyperLink", enumerationParameterType => enumerationParameterType.HyperLink },
            { "ValueDefinition", enumerationParameterType => enumerationParameterType.ValueDefinition.ToIdList() },
        };

        /// <summary>
        /// The ordered containment property value map.
        /// </summary>
        private readonly Dictionary<string, Func<CDP4Common.DTO.EnumerationParameterType, IEnumerable<OrderedItem>>> orderedContainmentPropertyValueMap = new Dictionary<string, Func<CDP4Common.DTO.EnumerationParameterType, IEnumerable<OrderedItem>>>
        {
            { "ValueDefinition", enumerationParameterType => enumerationParameterType.ValueDefinition },
        };

        /// <summary>
        /// The validation rules that should pass for an instance of <see cref="CDP4Common.DTO.EnumerationParameterType"/>.
        /// </summary>
        private readonly Dictionary<string, DtoValidationHelper<CDP4Common.DTO.EnumerationParameterType>> validationRules = new Dictionary<string, DtoValidationHelper<CDP4Common.DTO.EnumerationParameterType>>
        {
            { "Alias", new DtoValidationHelper<CDP4Common.DTO.EnumerationParameterType>(item => item.Alias != null, "The 'Alias' property of a 'EnumerationParameterType' is mandatory and cannot be null.") },
            { "Attachment", new DtoValidationHelper<CDP4Common.DTO.EnumerationParameterType>(item => item.Attachment != null, "The 'Attachment' property of a 'EnumerationParameterType' is mandatory and cannot be null.") },
            { "Category", new DtoValidationHelper<CDP4Common.DTO.EnumerationParameterType>(item => item.Category != null, "The 'Category' property of a 'EnumerationParameterType' is mandatory and cannot be null.") },
            { "Definition", new DtoValidationHelper<CDP4Common.DTO.EnumerationParameterType>(item => item.Definition != null, "The 'Definition' property of a 'EnumerationParameterType' is mandatory and cannot be null.") },
            { "ExcludedDomain", new DtoValidationHelper<CDP4Common.DTO.EnumerationParameterType>(item => item.ExcludedDomain != null, "The 'ExcludedDomain' property of a 'EnumerationParameterType' is mandatory and cannot be null.") },
            { "ExcludedPerson", new DtoValidationHelper<CDP4Common.DTO.EnumerationParameterType>(item => item.ExcludedPerson != null, "The 'ExcludedPerson' property of a 'EnumerationParameterType' is mandatory and cannot be null.") },
            { "HyperLink", new DtoValidationHelper<CDP4Common.DTO.EnumerationParameterType>(item => item.HyperLink != null, "The 'HyperLink' property of a 'EnumerationParameterType' is mandatory and cannot be null.") },
            { "Name", new DtoValidationHelper<CDP4Common.DTO.EnumerationParameterType>(item => !string.IsNullOrWhiteSpace(item.Name), "The 'Name' property of a 'EnumerationParameterType' is mandatory and cannot be empty or null.") },
            { "ShortName", new DtoValidationHelper<CDP4Common.DTO.EnumerationParameterType>(item => !string.IsNullOrWhiteSpace(item.ShortName), "The 'ShortName' property of a 'EnumerationParameterType' is mandatory and cannot be empty or null.") },
            { "Symbol", new DtoValidationHelper<CDP4Common.DTO.EnumerationParameterType>(item => !string.IsNullOrWhiteSpace(item.Symbol), "The 'Symbol' property of a 'EnumerationParameterType' is mandatory and cannot be empty or null.") },
            { "ValueDefinition", new DtoValidationHelper<CDP4Common.DTO.EnumerationParameterType>(item => item.ValueDefinition != null && item.ValueDefinition.Any(), "The 'ValueDefinition' property of a 'EnumerationParameterType' is mandatory and must have at least one entry.") },
        };
        ...
        /// </exception>
        public void Validate(CDP4Common.DTO.Thing enumerationParameterType)
        {
            this.Validate(enumerationParameterType, x => true);
        }
        ...
        /// If any validation rule failed.
        /// </exception>
        public void Validate(CDP4Common.DTO.Thing enumerationParameterType, Func<string, bool> validateProperty)
        {
            foreach (var applicableRule in this.validationRules.Where(x => validateProperty(x.Key)))
            {
                applicableRule.Value.Validate((CDP4Common.DTO.EnumerationParameterType)enumerationParameterType);
            }
        }
        ...
        /// </returns>
        public bool TryValidate(CDP4Common.DTO.Thing enumerationParameterType)
        {
            return this.TryValidate(enumerationParameterType, x => true);
        }
        ...
        /// True if all validation rules have passed or if none are defined.
        /// </returns>
        public bool TryValidate(CDP4Common.DTO.Thing enumerationParameterType, Func<string, bool> validateProperty)
        {
            var applicableValidationRules = this.validationRules.Where(x => validateProperty(x.Key)).Select(x => x.Value);

            return applicableValidationRules.All(applicableRule => applicableRule.TryValidate((CDP4Common.DTO.EnumerationParameterType)enumerationParameterType));
        }

        /// <summary>
        /// Returns the containment property value for the supplied <see cref="CDP4Common.DTO.EnumerationParameterType"/>.
        /// </summary>
        /// <param name="enumerationParameterType">
        /// The <see cref="CDP4Common.DTO.EnumerationParameterType"/> for which to return the containment property value.
        /// </param>
        ...
        /// If the property name is not supported for the <see cref="CDP4Common.DTO.EnumerationParameterType"/>.
        /// </exception>
        public IEnumerable<Guid> GetContainmentIds(CDP4Common.DTO.Thing enumerationParameterType, string propertyName)
        {
        ...
        /// <summary>
        /// Returns the ordered containment property value for the supplied <see cref="CDP4Common.DTO.EnumerationParameterType"/>.
        /// </summary>
        /// <param name="enumerationParameterType">
        /// The <see cref="CDP4Common.DTO.EnumerationParameterType"/> for which to return the containment property value.
        /// </param>
        ...
        /// If the property name is not supported for the <see cref="CDP4Common.DTO.EnumerationParameterType"/>.
        /// </exception>
        public IEnumerable<OrderedItem> GetOrderedContainmentIds(CDP4Common.DTO.Thing enumerationParameterType, string propertyName)
        {
        ...
        private readonly Dictionary<string, PropertyMetaInfo> containmentTypeMap = new Dictionary<string, PropertyMetaInfo>
        {
            ...
            { "ValueDefinition", new PropertyMetaInfo("ValueDefinition", "EnumerationValueDefinition", PropertyKind.OrderedList, AggregationKind.Composite, false, true, true, 1, "*", true) },
        };

        /// <summary>
        /// Gets the <see cref="PropertyMetaInfo"/> for the <see cref="EnumerationParameterType"/> class
        /// </summary>
        ...
        private readonly Dictionary<string, Action<CDP4Common.DTO.EnumerationParameterType, object>> propertyValueAssignmentMap = new Dictionary<string, Action<CDP4Common.DTO.EnumerationParameterType, object>>
        {
            ...
            { "ModifiedOn", (enumerationParameterType, value) => enumerationParameterType.ModifiedOn = (DateTime)value },
            { "Name", (enumerationParameterType, value) => enumerationParameterType.Name = value.ToString() },
            { "ShortName", (enumerationParameterType, value) => enumerationParameterType.ShortName = value.ToString() },
            { "Symbol", (enumerationParameterType, value) => enumerationParameterType.Symbol = value.ToString() },
            { "ThingPreference", (enumerationParameterType, value) => enumerationParameterType.ThingPreference = value == null ? (string)null : value.ToString() },
        };
        ...
        /// <summary>
        /// Returns the <see cref="CDP4Common.DTO.EnumerationParameterType"/> containment property type from the supplied property name.
        /// </summary>
        /// <param name="propertyName">
        ...
        /// <summary>
        /// Returns the <see cref="CDP4Common.DTO.EnumerationParameterType"/> property type from the supplied property name.
        /// </summary>
        /// <param name="propertyName">
        /// The property name.
        /// </param>
        ...
        /// <summary>
        /// Returns the container property for the supplied type name is a possible container for <see cref="CDP4Common.DTO.EnumerationParameterType"/>.
        /// </summary>
        /// <param name="typeName">
        /// Name of the type for which to check if it is a container of <see cref="CDP4Common.DTO.EnumerationParameterType"/>.
        /// </param>
        /// <param name="containerProperty">
        /// Supplied container property info instance that will be set if the supplied type name is a container of <see cref="CDP4Common.DTO.EnumerationParameterType"/>.
        /// </param>
        /// <returns>
        /// True if the supplied typeName is a container for <see cref="CDP4Common.DTO.EnumerationParameterType"/> and sets the container property name.
        /// </returns>
        ...
        /// <summary>
        /// Check if the supplied property name for <see cref="CDP4Common.DTO.EnumerationParameterType"/> is scalar.
        /// </summary>
        /// <param name="propertyName">
        /// Name of the property for which to check if it is scalar.
        /// </param>
        ...
        public bool ApplyPropertyUpdate(CDP4Common.DTO.Thing updatableThing, string propertyName, object value)
        {
            ...
            this.propertyValueAssignmentMap[propertyName]((CDP4Common.DTO.EnumerationParameterType)updatableThing, value);
        ...
        /// <summary>
        /// Instantiates a <see cref="CDP4Common.DTO.EnumerationParameterType"/>
        /// </summary>
        /// <returns>
        ...
        {
            return new CDP4Common.DTO.EnumerationParameterType(guid, revisionNumber);
        }
    }
}
