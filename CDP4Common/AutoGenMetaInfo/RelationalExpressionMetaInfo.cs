// --------------------------------------------------------------------------------------------------------------------
// <copyright file="RelationalExpressionMetaInfo.cs" company="Starion Group S.A.">
...
namespace CDP4Common.MetaInfo
{
    ...
    public partial class RelationalExpressionMetaInfo : IRelationalExpressionMetaInfo
    {
        ...
        {
            { "Actor", (relationalExpression, value) => relationalExpression.Actor = value == null ? (Guid?)null : (Guid)value },
