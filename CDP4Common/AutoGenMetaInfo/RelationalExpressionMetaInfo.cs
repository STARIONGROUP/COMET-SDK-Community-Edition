...
namespace CDP4Common.MetaInfo
{
    ...
    /// <summary>
    /// This a class that holds meta info for <see cref="RelationalExpression"/>.
    /// </summary>
    public partial class RelationalExpressionMetaInfo : IRelationalExpressionMetaInfo
    {
        /// <summary>
        /// The containment property value map.
        /// </summary>
        private readonly Dictionary<string, Func<CDP4Common.DTO.RelationalExpression, IEnumerable<Guid>>> containmentPropertyValueMap = new Dictionary<string, Func<CDP4Common.DTO.RelationalExpression, IEnumerable<Guid>>>();

        /// <summary>
        /// The ordered containment property value map.
        /// </summary>
        private readonly Dictionary<string, Func<CDP4Common.DTO.RelationalExpression, IEnumerable<OrderedItem>>> orderedContainmentPropertyValueMap = new Dictionary<string, Func<CDP4Common.DTO.RelationalExpression, IEnumerable<OrderedItem>>>();

        /// <summary>
        /// The validation rules that should pass for an instance of <see cref="CDP4Common.DTO.RelationalExpression"/>.
        /// </summary>
        private readonly Dictionary<string, DtoValidationHelper<CDP4Common.DTO.RelationalExpression>> validationRules = new Dictionary<string, DtoValidationHelper<CDP4Common.DTO.RelationalExpression>>
        {
            { "ExcludedDomain", new DtoValidationHelper<CDP4Common.DTO.RelationalExpression>(item => item.ExcludedDomain != null, "The 'ExcludedDomain' property of a 'RelationalExpression' is mandatory and cannot be null.") },
            { "ExcludedPerson", new DtoValidationHelper<CDP4Common.DTO.RelationalExpression>(item => item.ExcludedPerson != null, "The 'ExcludedPerson' property of a 'RelationalExpression' is mandatory and cannot be null.") },
            { "Value", new DtoValidationHelper<CDP4Common.DTO.RelationalExpression>(item => item.Value != null && item.Value.Any(), "The 'Value' property of a 'RelationalExpression' is mandatory and must have at least one entry.") },
        };
        ...
        /// </exception>
        public void Validate(CDP4Common.DTO.Thing relationalExpression)
        {
            this.Validate(relationalExpression, x => true);
        }
        ...
        /// If any validation rule failed.
        /// </exception>
        public void Validate(CDP4Common.DTO.Thing relationalExpression, Func<string, bool> validateProperty)
        {
            foreach (var applicableRule in this.validationRules.Where(x => validateProperty(x.Key)))
            {
                applicableRule.Value.Validate((CDP4Common.DTO.RelationalExpression)relationalExpression);
            }
        }
        ...
        /// </returns>
        public bool TryValidate(CDP4Common.DTO.Thing relationalExpression)
        {
            return this.TryValidate(relationalExpression, x => true);
        }
        ...
        /// True if all validation rules have passed or if none are defined.
        /// </returns>
        public bool TryValidate(CDP4Common.DTO.Thing relationalExpression, Func<string, bool> validateProperty)
        {
            var applicableValidationRules = this.validationRules.Where(x => validateProperty(x.Key)).Select(x => x.Value);

            return applicableValidationRules.All(applicableRule => applicableRule.TryValidate((CDP4Common.DTO.RelationalExpression)relationalExpression));
        }

        /// <summary>
        /// Returns the containment property value for the supplied <see cref="CDP4Common.DTO.RelationalExpression"/>.
        /// </summary>
        /// <param name="relationalExpression">
        /// The <see cref="CDP4Common.DTO.RelationalExpression"/> for which to return the containment property value.
        /// </param>
        ...
        /// If the property name is not supported for the <see cref="CDP4Common.DTO.RelationalExpression"/>.
        /// </exception>
        public IEnumerable<Guid> GetContainmentIds(CDP4Common.DTO.Thing relationalExpression, string propertyName)
        {
        ...
        /// <summary>
        /// Returns the ordered containment property value for the supplied <see cref="CDP4Common.DTO.RelationalExpression"/>.
        /// </summary>
        /// <param name="relationalExpression">
        /// The <see cref="CDP4Common.DTO.RelationalExpression"/> for which to return the containment property value.
        /// </param>
        ...
        /// If the property name is not supported for the <see cref="CDP4Common.DTO.RelationalExpression"/>.
        /// </exception>
        public IEnumerable<OrderedItem> GetOrderedContainmentIds(CDP4Common.DTO.Thing relationalExpression, string propertyName)
        {
        ...
        /// <summary>
        /// Gets the <see cref="PropertyMetaInfo"/> for the <see cref="RelationalExpression"/> class
        /// </summary>
        ...
        /// </summary>
        private readonly Dictionary<string, Func<CDP4Common.DTO.RelationalExpression, object>> propertyValueMap = new Dictionary<string, Func<CDP4Common.DTO.RelationalExpression, object>>
        {
        ...
        /// </summary>
        private readonly Dictionary<string, Action<CDP4Common.DTO.RelationalExpression, object>> propertyValueAssignmentMap = new Dictionary<string, Action<CDP4Common.DTO.RelationalExpression, object>>
        {
            { "Iid", (relationalExpression, value) => relationalExpression.Iid = (Guid)value },
            { "ModifiedOn", (relationalExpression, value) => relationalExpression.ModifiedOn = (DateTime)value },
        ...
        /// <summary>
        /// Returns the <see cref="CDP4Common.DTO.RelationalExpression"/> containment property type from the supplied property name.
        /// </summary>
        /// <param name="propertyName">
        ...
        /// <summary>
        /// Returns the <see cref="CDP4Common.DTO.RelationalExpression"/> property type from the supplied property name.
        /// </summary>
        /// <param name="propertyName">
        /// The property name.
        /// </param>
        ...
        /// <summary>
        /// Returns the container property for the supplied type name is a possible container for <see cref="CDP4Common.DTO.RelationalExpression"/>.
        /// </summary>
        /// <param name="typeName">
        /// Name of the type for which to check if it is a container of <see cref="CDP4Common.DTO.RelationalExpression"/>.
        /// </param>
        /// <param name="containerProperty">
        /// Supplied container property info instance that will be set if the supplied type name is a container of <see cref="CDP4Common.DTO.RelationalExpression"/>.
        /// </param>
        /// <returns>
        /// True if the supplied typeName is a container for <see cref="CDP4Common.DTO.RelationalExpression"/> and sets the container property name.
        /// </returns>
        ...
        /// <summary>
        /// Check if the supplied property name for <see cref="CDP4Common.DTO.RelationalExpression"/> is scalar.
        /// </summary>
        /// <param name="propertyName">
        /// Name of the property for which to check if it is scalar.
        /// </param>
        ...
        public bool ApplyPropertyUpdate(CDP4Common.DTO.Thing updatableThing, string propertyName, object value)
        {
            ...
            this.propertyValueAssignmentMap[propertyName]((CDP4Common.DTO.RelationalExpression)updatableThing, value);
        ...
        /// <summary>
        /// Instantiates a <see cref="CDP4Common.DTO.RelationalExpression"/>
        /// </summary>
        /// <returns>
        ...
        {
            return new CDP4Common.DTO.RelationalExpression(guid, revisionNumber);
        }
    }
}
