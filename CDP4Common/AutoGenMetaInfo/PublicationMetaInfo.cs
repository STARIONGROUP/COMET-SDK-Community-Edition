...
namespace CDP4Common.MetaInfo
{
    ...
    public partial class PublicationMetaInfo : IPublicationMetaInfo
    {
        ...
        private readonly Dictionary<string, PropertyMetaInfo> propertyTypeMap = new Dictionary<string, PropertyMetaInfo>
        {
            ...
            { "PublishedParameter", new PropertyMetaInfo("PublishedParameter", "Guid", PropertyKind.List, AggregationKind.None, false, false, true, 0, "*", true) },
        ...
        {
            { "Iteration", new PropertyMetaInfo("Publication", "Guid", PropertyKind.List, AggregationKind.Composite, false, false, true, 0, "*", true) },
        };
