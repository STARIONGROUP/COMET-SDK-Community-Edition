...
namespace CDP4Common.MetaInfo
{
    ...
    public partial class PublicationMetaInfo : IPublicationMetaInfo
    {
        ...
        public IEnumerable<Guid> GetContainmentIds(CDP4Common.DTO.Thing publication, string propertyName)
        {
            ...
            {
                throw new ArgumentException(string.Format("'{0}' is not a valid containment property of 'Publication'", propertyName));
            }
        ...
        public object DeserializeCollectionValue(string propertyName, object value)
        {
            ...
            {
                throw new ArgumentException(string.Format("'{0}' is not a valid collection property of 'Publication'", propertyName));
            }
