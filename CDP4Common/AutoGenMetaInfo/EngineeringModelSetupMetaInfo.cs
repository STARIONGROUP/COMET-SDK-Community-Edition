// --------------------------------------------------------------------------------------------------------------------
// <copyright file="EngineeringModelSetupMetaInfo.cs" company="Starion Group S.A.">
...
namespace CDP4Common.MetaInfo
{
    ...
    public partial class EngineeringModelSetupMetaInfo : IEngineeringModelSetupMetaInfo
    {
        ...
        public IEnumerable<Guid> GetContainmentIds(CDP4Common.DTO.Thing engineeringModelSetup, string propertyName)
        {
            ...
            {
                throw new ArgumentException($"'{propertyName}' is not a valid containment property of 'EngineeringModelSetup'");
            }
        ...
        public object DeserializeCollectionValue(string propertyName, object value)
        {
            ...
            {
                throw new ArgumentException($"'{propertyName}' is not a valid collection property of 'EngineeringModelSetup'");
            }
