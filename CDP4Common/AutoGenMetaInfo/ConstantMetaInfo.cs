// --------------------------------------------------------------------------------------------------------------------
// <copyright file="ConstantMetaInfo.cs" company="RHEA System S.A.">
...
namespace CDP4Common.MetaInfo
{
    ...
    /// <summary>
    /// This a class that holds meta info for <see cref="Constant"/>.
    /// </summary>
    public partial class ConstantMetaInfo : IConstantMetaInfo
    {
        /// <summary>
        /// The containment property value map.
        /// </summary>
        private readonly Dictionary<string, Func<CDP4Common.DTO.Constant, IEnumerable<Guid>>> containmentPropertyValueMap = new Dictionary<string, Func<CDP4Common.DTO.Constant, IEnumerable<Guid>>>
        {
            { "Alias", constant => constant.Alias },
            { "Attachment", constant => constant.Attachment },
            { "Definition", constant => constant.Definition },
            { "HyperLink", constant => constant.HyperLink },
        };

        /// <summary>
        /// The ordered containment property value map.
        /// </summary>
        private readonly Dictionary<string, Func<CDP4Common.DTO.Constant, IEnumerable<OrderedItem>>> orderedContainmentPropertyValueMap = new Dictionary<string, Func<CDP4Common.DTO.Constant, IEnumerable<OrderedItem>>>();

        /// <summary>
        /// The validation rules that should pass for an instance of <see cref="CDP4Common.DTO.Constant"/>.
        /// </summary>
        private readonly Dictionary<string, DtoValidationHelper<CDP4Common.DTO.Constant>> validationRules = new Dictionary<string, DtoValidationHelper<CDP4Common.DTO.Constant>>
        {
            { "Alias", new DtoValidationHelper<CDP4Common.DTO.Constant>(item => item.Alias != null, "The 'Alias' property of a 'Constant' is mandatory and cannot be null.") },
            { "Attachment", new DtoValidationHelper<CDP4Common.DTO.Constant>(item => item.Attachment != null, "The 'Attachment' property of a 'Constant' is mandatory and cannot be null.") },
            { "Category", new DtoValidationHelper<CDP4Common.DTO.Constant>(item => item.Category != null, "The 'Category' property of a 'Constant' is mandatory and cannot be null.") },
            { "Definition", new DtoValidationHelper<CDP4Common.DTO.Constant>(item => item.Definition != null, "The 'Definition' property of a 'Constant' is mandatory and cannot be null.") },
            { "ExcludedDomain", new DtoValidationHelper<CDP4Common.DTO.Constant>(item => item.ExcludedDomain != null, "The 'ExcludedDomain' property of a 'Constant' is mandatory and cannot be null.") },
            { "ExcludedPerson", new DtoValidationHelper<CDP4Common.DTO.Constant>(item => item.ExcludedPerson != null, "The 'ExcludedPerson' property of a 'Constant' is mandatory and cannot be null.") },
            { "HyperLink", new DtoValidationHelper<CDP4Common.DTO.Constant>(item => item.HyperLink != null, "The 'HyperLink' property of a 'Constant' is mandatory and cannot be null.") },
            { "Name", new DtoValidationHelper<CDP4Common.DTO.Constant>(item => !string.IsNullOrWhiteSpace(item.Name), "The 'Name' property of a 'Constant' is mandatory and cannot be empty or null.") },
            { "ShortName", new DtoValidationHelper<CDP4Common.DTO.Constant>(item => !string.IsNullOrWhiteSpace(item.ShortName), "The 'ShortName' property of a 'Constant' is mandatory and cannot be empty or null.") },
            { "Value", new DtoValidationHelper<CDP4Common.DTO.Constant>(item => item.Value != null && item.Value.Any(), "The 'Value' property of a 'Constant' is mandatory and must have at least one entry.") },
        };
        ...
        /// </exception>
        public void Validate(CDP4Common.DTO.Thing constant)
        {
            this.Validate(constant, x => true);
        }
        ...
        /// If any validation rule failed.
        /// </exception>
        public void Validate(CDP4Common.DTO.Thing constant, Func<string, bool> validateProperty)
        {
            foreach (var applicableRule in this.validationRules.Where(x => validateProperty(x.Key)))
            {
                applicableRule.Value.Validate((CDP4Common.DTO.Constant)constant);
            }
        }
        ...
        /// </returns>
        public bool TryValidate(CDP4Common.DTO.Thing constant)
        {
            return this.TryValidate(constant, x => true);
        }
        ...
        /// True if all validation rules have passed or if none are defined.
        /// </returns>
        public bool TryValidate(CDP4Common.DTO.Thing constant, Func<string, bool> validateProperty)
        {
            var applicableValidationRules = this.validationRules.Where(x => validateProperty(x.Key)).Select(x => x.Value);

            return applicableValidationRules.All(applicableRule => applicableRule.TryValidate((CDP4Common.DTO.Constant)constant));
        }

        /// <summary>
        /// Returns the containment property value for the supplied <see cref="CDP4Common.DTO.Constant"/>.
        /// </summary>
        /// <param name="constant">
        /// The <see cref="CDP4Common.DTO.Constant"/> for which to return the containment property value.
        /// </param>
        ...
        /// If the property name is not supported for the <see cref="CDP4Common.DTO.Constant"/>.
        /// </exception>
        public IEnumerable<Guid> GetContainmentIds(CDP4Common.DTO.Thing constant, string propertyName)
        {
            if (!this.containmentPropertyValueMap.ContainsKey(propertyName))
            {
                throw new ArgumentException($"'{propertyName}' is not a valid containment property of 'Constant'");
            }

            return this.containmentPropertyValueMap[propertyName]((CDP4Common.DTO.Constant)constant);
        }

        /// <summary>
        /// Returns the ordered containment property value for the supplied <see cref="CDP4Common.DTO.Constant"/>.
        /// </summary>
        /// <param name="constant">
        /// The <see cref="CDP4Common.DTO.Constant"/> for which to return the containment property value.
        /// </param>
        ...
        /// If the property name is not supported for the <see cref="CDP4Common.DTO.Constant"/>.
        /// </exception>
        public IEnumerable<OrderedItem> GetOrderedContainmentIds(CDP4Common.DTO.Thing constant, string propertyName)
        {
            ...
            return this.orderedContainmentPropertyValueMap[propertyName]((CDP4Common.DTO.Constant)constant);
        }
        ...
        /// <summary>
        /// Gets the <see cref="PropertyMetaInfo"/> for the <see cref="Constant"/> class
        /// </summary>
        ...
        /// </summary>
        private readonly Dictionary<string, Func<CDP4Common.DTO.Constant, object>> propertyValueMap = new Dictionary<string, Func<CDP4Common.DTO.Constant, object>>
        {
        ...
        /// </summary>
        private readonly Dictionary<string, Action<CDP4Common.DTO.Constant, object>> propertyValueAssignmentMap = new Dictionary<string, Action<CDP4Common.DTO.Constant, object>>
        {
            { "Actor", (constant, value) => constant.Actor = value == null ? (Guid?)null : (Guid)value },
            { "Iid", (constant, value) => constant.Iid = (Guid)value },
            { "IsDeprecated", (constant, value) => constant.IsDeprecated = (bool)value },
            { "ModifiedOn", (constant, value) => constant.ModifiedOn = (DateTime)value },
            { "Name", (constant, value) => constant.Name = value.ToString() },
            { "ParameterType", (constant, value) => constant.ParameterType = (Guid)value },
            { "Scale", (constant, value) => constant.Scale = value == null ? (Guid?)null : (Guid)value },
            { "ShortName", (constant, value) => constant.ShortName = value.ToString() },
            { "ThingPreference", (constant, value) => constant.ThingPreference = value == null ? (string)null : value.ToString() },
            { "Value", (constant, value) => constant.Value = (ValueArray<string>)value },
        };
        ...
        {
            { "ModelReferenceDataLibrary", new PropertyMetaInfo("Constant", "Constant", PropertyKind.List, AggregationKind.Composite, false, false, true, 0, "*", true) },
            { "SiteReferenceDataLibrary", new PropertyMetaInfo("Constant", "Constant", PropertyKind.List, AggregationKind.Composite, false, false, true, 0, "*", true) },
        };
        ...
        /// <summary>
        /// Returns the <see cref="CDP4Common.DTO.Constant"/> containment property type from the supplied property name.
        /// </summary>
        /// <param name="propertyName">
        ...
        /// <summary>
        /// Returns the <see cref="CDP4Common.DTO.Constant"/> property type from the supplied property name.
        /// </summary>
        /// <param name="propertyName">
        /// The property name.
        /// </param>
        ...
        /// <summary>
        /// Returns the container property for the supplied type name is a possible container for <see cref="CDP4Common.DTO.Constant"/>.
        /// </summary>
        /// <param name="typeName">
        /// Name of the type for which to check if it is a container of <see cref="CDP4Common.DTO.Constant"/>.
        /// </param>
        /// <param name="containerProperty">
        /// Supplied container property info instance that will be set if the supplied type name is a container of <see cref="CDP4Common.DTO.Constant"/>.
        /// </param>
        /// <returns>
        /// True if the supplied typeName is a container for <see cref="CDP4Common.DTO.Constant"/> and sets the container property name.
        /// </returns>
        ...
        /// <summary>
        /// Check if the supplied property name for <see cref="CDP4Common.DTO.Constant"/> is scalar.
        /// </summary>
        /// <param name="propertyName">
        /// Name of the property for which to check if it is scalar.
        /// </param>
        ...
        public bool ApplyPropertyUpdate(CDP4Common.DTO.Thing updatableThing, string propertyName, object value)
        {
            ...
            this.propertyValueAssignmentMap[propertyName]((CDP4Common.DTO.Constant)updatableThing, value);
        ...
        public object DeserializeCollectionValue(string propertyName, object value)
        {
            ...
            {
                throw new ArgumentException($"'{propertyName}' is not a valid collection property of 'Constant'");
            }
        ...
        public object GetValue(string propertyName, CDP4Common.DTO.Thing thing)
        {
            ...
            return this.propertyValueMap[propertyName]((CDP4Common.DTO.Constant)thing);
        }
        ...
        /// <summary>
        /// Instantiates a <see cref="CDP4Common.DTO.Constant"/>
        /// </summary>
        /// <returns>
        ...
        {
            return new CDP4Common.DTO.Constant(guid, revisionNumber);
        }
    }
}
