...
namespace CDP4Common.MetaInfo
{
    ...
    public partial class ConstantMetaInfo : IConstantMetaInfo
    {
        ...
        {
            { "ModelReferenceDataLibrary", new PropertyMetaInfo("Constant", "Guid", PropertyKind.List, AggregationKind.Composite, false, false, true, 0, "*", true) },
            { "SiteReferenceDataLibrary", new PropertyMetaInfo("Constant", "Guid", PropertyKind.List, AggregationKind.Composite, false, false, true, 0, "*", true) },
        };
