// --------------------------------------------------------------------------------------------------------------------
// <copyright file="DateParameterTypeMetaInfo.cs" company="RHEA System S.A.">
...
namespace CDP4Common.MetaInfo
{
    ...
    /// <summary>
    /// This a class that holds meta info for <see cref="DateParameterType"/>.
    /// </summary>
    public partial class DateParameterTypeMetaInfo : IDateParameterTypeMetaInfo
    {
        ...
        /// </summary>
        private readonly Dictionary<string, Func<CDP4Common.DTO.DateParameterType, IEnumerable<Guid>>> containmentPropertyValueMap = new Dictionary<string, Func<CDP4Common.DTO.DateParameterType, IEnumerable<Guid>>>
        {
            { "Alias", dateParameterType => dateParameterType.Alias },
            { "Attachment", dateParameterType => dateParameterType.Attachment },
            { "Definition", dateParameterType => dateParameterType.Definition },
            { "HyperLink", dateParameterType => dateParameterType.HyperLink },
        };

        /// <summary>
        /// The ordered containment property value map.
        /// </summary>
        private readonly Dictionary<string, Func<CDP4Common.DTO.DateParameterType, IEnumerable<OrderedItem>>> orderedContainmentPropertyValueMap = new Dictionary<string, Func<CDP4Common.DTO.DateParameterType, IEnumerable<OrderedItem>>>();

        /// <summary>
        /// The validation rules that should pass for an instance of <see cref="CDP4Common.DTO.DateParameterType"/>.
        /// </summary>
        private readonly Dictionary<string, DtoValidationHelper<CDP4Common.DTO.DateParameterType>> validationRules = new Dictionary<string, DtoValidationHelper<CDP4Common.DTO.DateParameterType>>
        {
            { "Alias", new DtoValidationHelper<CDP4Common.DTO.DateParameterType>(item => item.Alias != null, "The 'Alias' property of a 'DateParameterType' is mandatory and cannot be null.") },
            { "Attachment", new DtoValidationHelper<CDP4Common.DTO.DateParameterType>(item => item.Attachment != null, "The 'Attachment' property of a 'DateParameterType' is mandatory and cannot be null.") },
            { "Category", new DtoValidationHelper<CDP4Common.DTO.DateParameterType>(item => item.Category != null, "The 'Category' property of a 'DateParameterType' is mandatory and cannot be null.") },
            { "Definition", new DtoValidationHelper<CDP4Common.DTO.DateParameterType>(item => item.Definition != null, "The 'Definition' property of a 'DateParameterType' is mandatory and cannot be null.") },
            { "ExcludedDomain", new DtoValidationHelper<CDP4Common.DTO.DateParameterType>(item => item.ExcludedDomain != null, "The 'ExcludedDomain' property of a 'DateParameterType' is mandatory and cannot be null.") },
            { "ExcludedPerson", new DtoValidationHelper<CDP4Common.DTO.DateParameterType>(item => item.ExcludedPerson != null, "The 'ExcludedPerson' property of a 'DateParameterType' is mandatory and cannot be null.") },
            { "HyperLink", new DtoValidationHelper<CDP4Common.DTO.DateParameterType>(item => item.HyperLink != null, "The 'HyperLink' property of a 'DateParameterType' is mandatory and cannot be null.") },
            { "Name", new DtoValidationHelper<CDP4Common.DTO.DateParameterType>(item => !string.IsNullOrWhiteSpace(item.Name), "The 'Name' property of a 'DateParameterType' is mandatory and cannot be empty or null.") },
            { "ShortName", new DtoValidationHelper<CDP4Common.DTO.DateParameterType>(item => !string.IsNullOrWhiteSpace(item.ShortName), "The 'ShortName' property of a 'DateParameterType' is mandatory and cannot be empty or null.") },
            { "Symbol", new DtoValidationHelper<CDP4Common.DTO.DateParameterType>(item => !string.IsNullOrWhiteSpace(item.Symbol), "The 'Symbol' property of a 'DateParameterType' is mandatory and cannot be empty or null.") },
        };
        ...
        /// </exception>
        public void Validate(CDP4Common.DTO.Thing dateParameterType)
        {
            this.Validate(dateParameterType, x => true);
        }
        ...
        /// If any validation rule failed.
        /// </exception>
        public void Validate(CDP4Common.DTO.Thing dateParameterType, Func<string, bool> validateProperty)
        {
            foreach (var applicableRule in this.validationRules.Where(x => validateProperty(x.Key)))
            {
                applicableRule.Value.Validate((CDP4Common.DTO.DateParameterType)dateParameterType);
            }
        }
        ...
        /// </returns>
        public bool TryValidate(CDP4Common.DTO.Thing dateParameterType)
        {
            return this.TryValidate(dateParameterType, x => true);
        }
        ...
        /// True if all validation rules have passed or if none are defined.
        /// </returns>
        public bool TryValidate(CDP4Common.DTO.Thing dateParameterType, Func<string, bool> validateProperty)
        {
            var applicableValidationRules = this.validationRules.Where(x => validateProperty(x.Key)).Select(x => x.Value);

            return applicableValidationRules.All(applicableRule => applicableRule.TryValidate((CDP4Common.DTO.DateParameterType)dateParameterType));
        }

        /// <summary>
        /// Returns the containment property value for the supplied <see cref="CDP4Common.DTO.DateParameterType"/>.
        /// </summary>
        /// <param name="dateParameterType">
        /// The <see cref="CDP4Common.DTO.DateParameterType"/> for which to return the containment property value.
        /// </param>
        ...
        /// If the property name is not supported for the <see cref="CDP4Common.DTO.DateParameterType"/>.
        /// </exception>
        public IEnumerable<Guid> GetContainmentIds(CDP4Common.DTO.Thing dateParameterType, string propertyName)
        {
            if (!this.containmentPropertyValueMap.ContainsKey(propertyName))
            {
                throw new ArgumentException($"'{propertyName}' is not a valid containment property of 'DateParameterType'");
            }

            return this.containmentPropertyValueMap[propertyName]((CDP4Common.DTO.DateParameterType)dateParameterType);
        }

        /// <summary>
        /// Returns the ordered containment property value for the supplied <see cref="CDP4Common.DTO.DateParameterType"/>.
        /// </summary>
        /// <param name="dateParameterType">
        /// The <see cref="CDP4Common.DTO.DateParameterType"/> for which to return the containment property value.
        /// </param>
        ...
        /// If the property name is not supported for the <see cref="CDP4Common.DTO.DateParameterType"/>.
        /// </exception>
        public IEnumerable<OrderedItem> GetOrderedContainmentIds(CDP4Common.DTO.Thing dateParameterType, string propertyName)
        {
            ...
            return this.orderedContainmentPropertyValueMap[propertyName]((CDP4Common.DTO.DateParameterType)dateParameterType);
        }
        ...
        /// <summary>
        /// Gets the <see cref="PropertyMetaInfo"/> for the <see cref="DateParameterType"/> class
        /// </summary>
        ...
        /// </summary>
        private readonly Dictionary<string, Func<CDP4Common.DTO.DateParameterType, object>> propertyValueMap = new Dictionary<string, Func<CDP4Common.DTO.DateParameterType, object>>
        {
        ...
        /// </summary>
        private readonly Dictionary<string, Action<CDP4Common.DTO.DateParameterType, object>> propertyValueAssignmentMap = new Dictionary<string, Action<CDP4Common.DTO.DateParameterType, object>>
        {
            { "Actor", (dateParameterType, value) => dateParameterType.Actor = value == null ? (Guid?)null : (Guid)value },
            { "Iid", (dateParameterType, value) => dateParameterType.Iid = (Guid)value },
            { "IsDeprecated", (dateParameterType, value) => dateParameterType.IsDeprecated = (bool)value },
            { "ModifiedOn", (dateParameterType, value) => dateParameterType.ModifiedOn = (DateTime)value },
            { "Name", (dateParameterType, value) => dateParameterType.Name = value.ToString() },
            { "ShortName", (dateParameterType, value) => dateParameterType.ShortName = value.ToString() },
            { "Symbol", (dateParameterType, value) => dateParameterType.Symbol = value.ToString() },
            { "ThingPreference", (dateParameterType, value) => dateParameterType.ThingPreference = value == null ? (string)null : value.ToString() },
        };
        ...
        /// <summary>
        /// Returns the <see cref="CDP4Common.DTO.DateParameterType"/> containment property type from the supplied property name.
        /// </summary>
        /// <param name="propertyName">
        ...
        /// <summary>
        /// Returns the <see cref="CDP4Common.DTO.DateParameterType"/> property type from the supplied property name.
        /// </summary>
        /// <param name="propertyName">
        /// The property name.
        /// </param>
        ...
        /// <summary>
        /// Returns the container property for the supplied type name is a possible container for <see cref="CDP4Common.DTO.DateParameterType"/>.
        /// </summary>
        /// <param name="typeName">
        /// Name of the type for which to check if it is a container of <see cref="CDP4Common.DTO.DateParameterType"/>.
        /// </param>
        /// <param name="containerProperty">
        /// Supplied container property info instance that will be set if the supplied type name is a container of <see cref="CDP4Common.DTO.DateParameterType"/>.
        /// </param>
        /// <returns>
        /// True if the supplied typeName is a container for <see cref="CDP4Common.DTO.DateParameterType"/> and sets the container property name.
        /// </returns>
        ...
        /// <summary>
        /// Check if the supplied property name for <see cref="CDP4Common.DTO.DateParameterType"/> is scalar.
        /// </summary>
        /// <param name="propertyName">
        /// Name of the property for which to check if it is scalar.
        /// </param>
        ...
        public bool ApplyPropertyUpdate(CDP4Common.DTO.Thing updatableThing, string propertyName, object value)
        {
            ...
            this.propertyValueAssignmentMap[propertyName]((CDP4Common.DTO.DateParameterType)updatableThing, value);
        ...
        public object DeserializeCollectionValue(string propertyName, object value)
        {
            ...
            {
                throw new ArgumentException($"'{propertyName}' is not a valid collection property of 'DateParameterType'");
            }
        ...
        public object GetValue(string propertyName, CDP4Common.DTO.Thing thing)
        {
            ...
            return this.propertyValueMap[propertyName]((CDP4Common.DTO.DateParameterType)thing);
        }
        ...
        /// <summary>
        /// Instantiates a <see cref="CDP4Common.DTO.DateParameterType"/>
        /// </summary>
        /// <returns>
        ...
        {
            return new CDP4Common.DTO.DateParameterType(guid, revisionNumber);
        }
    }
}
