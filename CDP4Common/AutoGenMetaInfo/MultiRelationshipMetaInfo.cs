// --------------------------------------------------------------------------------------------------------------------
// <copyright file="MultiRelationshipMetaInfo.cs" company="Starion Group S.A.">
...
namespace CDP4Common.MetaInfo
{
    ...
    public partial class MultiRelationshipMetaInfo : IMultiRelationshipMetaInfo
    {
        ...
        public IEnumerable<Guid> GetContainmentIds(CDP4Common.DTO.Thing multiRelationship, string propertyName)
        {
            ...
            {
                throw new ArgumentException($"'{propertyName}' is not a valid containment property of 'MultiRelationship'");
            }
        ...
        {
            { "ParameterValue", new PropertyMetaInfo("ParameterValue", "RelationshipParameterValue", PropertyKind.List, AggregationKind.Composite, false, false, true, 0, "*", true) },
        };
        ...
        {
            { "Actor", (multiRelationship, value) => multiRelationship.Actor = value == null ? (Guid?)null : (Guid)value },
        ...
        {
            { "Iteration", new PropertyMetaInfo("Relationship", "Relationship", PropertyKind.List, AggregationKind.Composite, false, false, true, 0, "*", true) },
        };
        ...
        public object DeserializeCollectionValue(string propertyName, object value)
        {
            ...
            {
                throw new ArgumentException($"'{propertyName}' is not a valid collection property of 'MultiRelationship'");
            }
