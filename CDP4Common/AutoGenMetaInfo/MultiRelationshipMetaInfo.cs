// --------------------------------------------------------------------------------------------------------------------
// <copyright file="MultiRelationshipMetaInfo.cs" company="RHEA System S.A.">
...
namespace CDP4Common.MetaInfo
{
    ...
    /// <summary>
    /// This a class that holds meta info for <see cref="MultiRelationship"/>.
    /// </summary>
    public partial class MultiRelationshipMetaInfo : IMultiRelationshipMetaInfo
    {
        /// <summary>
        /// The containment property value map.
        /// </summary>
        private readonly Dictionary<string, Func<CDP4Common.DTO.MultiRelationship, IEnumerable<Guid>>> containmentPropertyValueMap = new Dictionary<string, Func<CDP4Common.DTO.MultiRelationship, IEnumerable<Guid>>>
        {
            { "ParameterValue", multiRelationship => multiRelationship.ParameterValue },
        };

        /// <summary>
        /// The ordered containment property value map.
        /// </summary>
        private readonly Dictionary<string, Func<CDP4Common.DTO.MultiRelationship, IEnumerable<OrderedItem>>> orderedContainmentPropertyValueMap = new Dictionary<string, Func<CDP4Common.DTO.MultiRelationship, IEnumerable<OrderedItem>>>();

        /// <summary>
        /// The validation rules that should pass for an instance of <see cref="CDP4Common.DTO.MultiRelationship"/>.
        /// </summary>
        private readonly Dictionary<string, DtoValidationHelper<CDP4Common.DTO.MultiRelationship>> validationRules = new Dictionary<string, DtoValidationHelper<CDP4Common.DTO.MultiRelationship>>
        {
            { "Category", new DtoValidationHelper<CDP4Common.DTO.MultiRelationship>(item => item.Category != null, "The 'Category' property of a 'MultiRelationship' is mandatory and cannot be null.") },
            { "ExcludedDomain", new DtoValidationHelper<CDP4Common.DTO.MultiRelationship>(item => item.ExcludedDomain != null, "The 'ExcludedDomain' property of a 'MultiRelationship' is mandatory and cannot be null.") },
            { "ExcludedPerson", new DtoValidationHelper<CDP4Common.DTO.MultiRelationship>(item => item.ExcludedPerson != null, "The 'ExcludedPerson' property of a 'MultiRelationship' is mandatory and cannot be null.") },
            { "ParameterValue", new DtoValidationHelper<CDP4Common.DTO.MultiRelationship>(item => item.ParameterValue != null, "The 'ParameterValue' property of a 'MultiRelationship' is mandatory and cannot be null.") },
            { "RelatedThing", new DtoValidationHelper<CDP4Common.DTO.MultiRelationship>(item => item.RelatedThing != null, "The 'RelatedThing' property of a 'MultiRelationship' is mandatory and cannot be null.") },
        };
        ...
        /// </exception>
        public void Validate(CDP4Common.DTO.Thing multiRelationship)
        {
            this.Validate(multiRelationship, x => true);
        }
        ...
        /// If any validation rule failed.
        /// </exception>
        public void Validate(CDP4Common.DTO.Thing multiRelationship, Func<string, bool> validateProperty)
        {
            foreach (var applicableRule in this.validationRules.Where(x => validateProperty(x.Key)))
            {
                applicableRule.Value.Validate((CDP4Common.DTO.MultiRelationship)multiRelationship);
            }
        }
        ...
        /// </returns>
        public bool TryValidate(CDP4Common.DTO.Thing multiRelationship)
        {
            return this.TryValidate(multiRelationship, x => true);
        }
        ...
        /// True if all validation rules have passed or if none are defined.
        /// </returns>
        public bool TryValidate(CDP4Common.DTO.Thing multiRelationship, Func<string, bool> validateProperty)
        {
            var applicableValidationRules = this.validationRules.Where(x => validateProperty(x.Key)).Select(x => x.Value);

            return applicableValidationRules.All(applicableRule => applicableRule.TryValidate((CDP4Common.DTO.MultiRelationship)multiRelationship));
        }

        /// <summary>
        /// Returns the containment property value for the supplied <see cref="CDP4Common.DTO.MultiRelationship"/>.
        /// </summary>
        /// <param name="multiRelationship">
        /// The <see cref="CDP4Common.DTO.MultiRelationship"/> for which to return the containment property value.
        /// </param>
        ...
        /// If the property name is not supported for the <see cref="CDP4Common.DTO.MultiRelationship"/>.
        /// </exception>
        public IEnumerable<Guid> GetContainmentIds(CDP4Common.DTO.Thing multiRelationship, string propertyName)
        {
            if (!this.containmentPropertyValueMap.ContainsKey(propertyName))
            {
                throw new ArgumentException(string.Format("'{0}' is not a valid containment property of 'MultiRelationship'", propertyName));
            }

            return this.containmentPropertyValueMap[propertyName]((CDP4Common.DTO.MultiRelationship)multiRelationship);
        }

        /// <summary>
        /// Returns the ordered containment property value for the supplied <see cref="CDP4Common.DTO.MultiRelationship"/>.
        /// </summary>
        /// <param name="multiRelationship">
        /// The <see cref="CDP4Common.DTO.MultiRelationship"/> for which to return the containment property value.
        /// </param>
        ...
        /// If the property name is not supported for the <see cref="CDP4Common.DTO.MultiRelationship"/>.
        /// </exception>
        public IEnumerable<OrderedItem> GetOrderedContainmentIds(CDP4Common.DTO.Thing multiRelationship, string propertyName)
        {
            ...
            return this.orderedContainmentPropertyValueMap[propertyName]((CDP4Common.DTO.MultiRelationship)multiRelationship);
        }
        ...
        /// <summary>
        /// Gets the <see cref="PropertyMetaInfo"/> for the <see cref="MultiRelationship"/> class
        /// </summary>
        ...
        /// </summary>
        private readonly Dictionary<string, Func<CDP4Common.DTO.MultiRelationship, object>> propertyValueMap = new Dictionary<string, Func<CDP4Common.DTO.MultiRelationship, object>>
        {
        ...
        private readonly Dictionary<string, PropertyMetaInfo> propertyTypeMap = new Dictionary<string, PropertyMetaInfo>
        {
            ...
            { "RelatedThing", new PropertyMetaInfo("RelatedThing", "Guid", PropertyKind.List, AggregationKind.None, false, false, true, 0, "*", true) },
        ...
        /// </summary>
        private readonly Dictionary<string, Action<CDP4Common.DTO.MultiRelationship, object>> propertyValueAssignmentMap = new Dictionary<string, Action<CDP4Common.DTO.MultiRelationship, object>>
        {
        ...
        {
            { "Iteration", new PropertyMetaInfo("Relationship", "Guid", PropertyKind.List, AggregationKind.Composite, false, false, true, 0, "*", true) },
        };
        ...
        /// <summary>
        /// Returns the <see cref="CDP4Common.DTO.MultiRelationship"/> containment property type from the supplied property name.
        /// </summary>
        /// <param name="propertyName">
        ...
        /// <summary>
        /// Returns the <see cref="CDP4Common.DTO.MultiRelationship"/> property type from the supplied property name.
        /// </summary>
        /// <param name="propertyName">
        /// The property name.
        /// </param>
        ...
        /// <summary>
        /// Returns the container property for the supplied type name is a possible container for <see cref="CDP4Common.DTO.MultiRelationship"/>.
        /// </summary>
        /// <param name="typeName">
        /// Name of the type for which to check if it is a container of <see cref="CDP4Common.DTO.MultiRelationship"/>.
        /// </param>
        /// <param name="containerProperty">
        /// Supplied container property info instance that will be set if the supplied type name is a container of <see cref="CDP4Common.DTO.MultiRelationship"/>.
        /// </param>
        /// <returns>
        /// True if the supplied typeName is a container for <see cref="CDP4Common.DTO.MultiRelationship"/> and sets the container property name.
        /// </returns>
        ...
        /// <summary>
        /// Check if the supplied property name for <see cref="CDP4Common.DTO.MultiRelationship"/> is scalar.
        /// </summary>
        /// <param name="propertyName">
        /// Name of the property for which to check if it is scalar.
        /// </param>
        ...
        public bool ApplyPropertyUpdate(CDP4Common.DTO.Thing updatableThing, string propertyName, object value)
        {
            ...
            this.propertyValueAssignmentMap[propertyName]((CDP4Common.DTO.MultiRelationship)updatableThing, value);
        ...
        public object DeserializeCollectionValue(string propertyName, object value)
        {
            ...
            {
                throw new ArgumentException(string.Format("'{0}' is not a valid collection property of 'MultiRelationship'", propertyName));
            }
        ...
        public object GetValue(string propertyName, CDP4Common.DTO.Thing thing)
        {
            ...
            return this.propertyValueMap[propertyName]((CDP4Common.DTO.MultiRelationship)thing);
        }
        ...
        /// <summary>
        /// Instantiates a <see cref="CDP4Common.DTO.MultiRelationship"/>
        /// </summary>
        /// <returns>
        ...
        {
            return new CDP4Common.DTO.MultiRelationship(guid, revisionNumber);
        }
    }
}
