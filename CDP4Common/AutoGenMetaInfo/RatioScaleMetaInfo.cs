// --------------------------------------------------------------------------------------------------------------------
// <copyright file="RatioScaleMetaInfo.cs" company="RHEA System S.A.">
...
namespace CDP4Common.MetaInfo
{
    ...
    /// <summary>
    /// This a class that holds meta info for <see cref="RatioScale"/>.
    /// </summary>
    public partial class RatioScaleMetaInfo : IRatioScaleMetaInfo
    {
        /// <summary>
        ...
        private readonly Dictionary<string, Func<CDP4Common.DTO.RatioScale, IEnumerable<Guid>>> containmentPropertyValueMap = new Dictionary<string, Func<CDP4Common.DTO.RatioScale, IEnumerable<Guid>>>
        {
            ...
            { "ValueDefinition", ratioScale => ratioScale.ValueDefinition },
        };

        /// <summary>
        /// The ordered containment property value map.
        /// </summary>
        private readonly Dictionary<string, Func<CDP4Common.DTO.RatioScale, IEnumerable<OrderedItem>>> orderedContainmentPropertyValueMap = new Dictionary<string, Func<CDP4Common.DTO.RatioScale, IEnumerable<OrderedItem>>>();

        /// <summary>
        /// The validation rules that should pass for an instance of <see cref="CDP4Common.DTO.RatioScale"/>.
        /// </summary>
        private readonly Dictionary<string, DtoValidationHelper<CDP4Common.DTO.RatioScale>> validationRules = new Dictionary<string, DtoValidationHelper<CDP4Common.DTO.RatioScale>>
        {
            ...
            { "HyperLink", new DtoValidationHelper<CDP4Common.DTO.RatioScale>(item => item.HyperLink != null, "The 'HyperLink' property of a 'RatioScale' is mandatory and cannot be null.") },
            { "MappingToReferenceScale", new DtoValidationHelper<CDP4Common.DTO.RatioScale>(item => item.MappingToReferenceScale != null, "The 'MappingToReferenceScale' property of a 'RatioScale' is mandatory and cannot be null.") },
            { "Name", new DtoValidationHelper<CDP4Common.DTO.RatioScale>(item => !string.IsNullOrWhiteSpace(item.Name), "The 'Name' property of a 'RatioScale' is mandatory and cannot be empty or null.") },
            { "ShortName", new DtoValidationHelper<CDP4Common.DTO.RatioScale>(item => !string.IsNullOrWhiteSpace(item.ShortName), "The 'ShortName' property of a 'RatioScale' is mandatory and cannot be empty or null.") },
            { "ValueDefinition", new DtoValidationHelper<CDP4Common.DTO.RatioScale>(item => item.ValueDefinition != null, "The 'ValueDefinition' property of a 'RatioScale' is mandatory and cannot be null.") },
        };
        ...
        /// </exception>
        public void Validate(CDP4Common.DTO.Thing ratioScale)
        {
            this.Validate(ratioScale, x => true);
        }
        ...
        /// If any validation rule failed.
        /// </exception>
        public void Validate(CDP4Common.DTO.Thing ratioScale, Func<string, bool> validateProperty)
        {
            foreach (var applicableRule in this.validationRules.Where(x => validateProperty(x.Key)))
            {
                applicableRule.Value.Validate((CDP4Common.DTO.RatioScale)ratioScale);
            }
        }
        ...
        /// </returns>
        public bool TryValidate(CDP4Common.DTO.Thing ratioScale)
        {
            return this.TryValidate(ratioScale, x => true);
        }
        ...
        /// True if all validation rules have passed or if none are defined.
        /// </returns>
        public bool TryValidate(CDP4Common.DTO.Thing ratioScale, Func<string, bool> validateProperty)
        {
            var applicableValidationRules = this.validationRules.Where(x => validateProperty(x.Key)).Select(x => x.Value);

            return applicableValidationRules.All(applicableRule => applicableRule.TryValidate((CDP4Common.DTO.RatioScale)ratioScale));
        }

        /// <summary>
        /// Returns the containment property value for the supplied <see cref="CDP4Common.DTO.RatioScale"/>.
        /// </summary>
        /// <param name="ratioScale">
        /// The <see cref="CDP4Common.DTO.RatioScale"/> for which to return the containment property value.
        /// </param>
        ...
        /// If the property name is not supported for the <see cref="CDP4Common.DTO.RatioScale"/>.
        /// </exception>
        public IEnumerable<Guid> GetContainmentIds(CDP4Common.DTO.Thing ratioScale, string propertyName)
        {
            if (!this.containmentPropertyValueMap.ContainsKey(propertyName))
            {
                throw new ArgumentException(string.Format("'{0}' is not a valid containment property of 'RatioScale'", propertyName));
            }

            return this.containmentPropertyValueMap[propertyName]((CDP4Common.DTO.RatioScale)ratioScale);
        }

        /// <summary>
        /// Returns the ordered containment property value for the supplied <see cref="CDP4Common.DTO.RatioScale"/>.
        /// </summary>
        /// <param name="ratioScale">
        /// The <see cref="CDP4Common.DTO.RatioScale"/> for which to return the containment property value.
        /// </param>
        ...
        /// If the property name is not supported for the <see cref="CDP4Common.DTO.RatioScale"/>.
        /// </exception>
        public IEnumerable<OrderedItem> GetOrderedContainmentIds(CDP4Common.DTO.Thing ratioScale, string propertyName)
        {
            ...
            return this.orderedContainmentPropertyValueMap[propertyName]((CDP4Common.DTO.RatioScale)ratioScale);
        }
        ...
        /// <summary>
        /// Gets the <see cref="PropertyMetaInfo"/> for the <see cref="RatioScale"/> class
        /// </summary>
        ...
        private readonly Dictionary<string, Action<CDP4Common.DTO.RatioScale, object>> propertyValueAssignmentMap = new Dictionary<string, Action<CDP4Common.DTO.RatioScale, object>>
        {
            ...
            { "IsMinimumInclusive", (ratioScale, value) => ratioScale.IsMinimumInclusive = (bool)value },
            { "MaximumPermissibleValue", (ratioScale, value) => ratioScale.MaximumPermissibleValue = value == null ? (string)null : value.ToString() },
            { "MinimumPermissibleValue", (ratioScale, value) => ratioScale.MinimumPermissibleValue = value == null ? (string)null : value.ToString() },
            { "ModifiedOn", (ratioScale, value) => ratioScale.ModifiedOn = (DateTime)value },
            { "Name", (ratioScale, value) => ratioScale.Name = value.ToString() },
            { "NegativeValueConnotation", (ratioScale, value) => ratioScale.NegativeValueConnotation = value == null ? (string)null : value.ToString() },
            { "NumberSet", (ratioScale, value) => ratioScale.NumberSet = (NumberSetKind)value },
            { "PositiveValueConnotation", (ratioScale, value) => ratioScale.PositiveValueConnotation = value == null ? (string)null : value.ToString() },
            { "ShortName", (ratioScale, value) => ratioScale.ShortName = value.ToString() },
            { "ThingPreference", (ratioScale, value) => ratioScale.ThingPreference = value == null ? (string)null : value.ToString() },
            { "Unit", (ratioScale, value) => ratioScale.Unit = (Guid)value },
        };
        ...
        /// <summary>
        /// Returns the <see cref="CDP4Common.DTO.RatioScale"/> containment property type from the supplied property name.
        /// </summary>
        /// <param name="propertyName">
        ...
        /// <summary>
        /// Returns the <see cref="CDP4Common.DTO.RatioScale"/> property type from the supplied property name.
        /// </summary>
        /// <param name="propertyName">
        /// The property name.
        /// </param>
        ...
        /// <summary>
        /// Returns the container property for the supplied type name is a possible container for <see cref="CDP4Common.DTO.RatioScale"/>.
        /// </summary>
        /// <param name="typeName">
        /// Name of the type for which to check if it is a container of <see cref="CDP4Common.DTO.RatioScale"/>.
        /// </param>
        /// <param name="containerProperty">
        /// Supplied container property info instance that will be set if the supplied type name is a container of <see cref="CDP4Common.DTO.RatioScale"/>.
        /// </param>
        /// <returns>
        /// True if the supplied typeName is a container for <see cref="CDP4Common.DTO.RatioScale"/> and sets the container property name.
        /// </returns>
        ...
        /// <summary>
        /// Check if the supplied property name for <see cref="CDP4Common.DTO.RatioScale"/> is scalar.
        /// </summary>
        /// <param name="propertyName">
        /// Name of the property for which to check if it is scalar.
        /// </param>
        ...
        public bool ApplyPropertyUpdate(CDP4Common.DTO.Thing updatableThing, string propertyName, object value)
        {
            ...
            this.propertyValueAssignmentMap[propertyName]((CDP4Common.DTO.RatioScale)updatableThing, value);
        ...
        public object DeserializeCollectionValue(string propertyName, object value)
        {
            ...
            {
                throw new ArgumentException(string.Format("'{0}' is not a valid collection property of 'RatioScale'", propertyName));
            }
        ...
        public object GetValue(string propertyName, CDP4Common.DTO.Thing thing)
        {
            ...
            return this.propertyValueMap[propertyName]((CDP4Common.DTO.RatioScale)thing);
        }
        ...
        /// <summary>
        /// Instantiates a <see cref="CDP4Common.DTO.RatioScale"/>
        /// </summary>
        /// <returns>
        ...
        {
            return new CDP4Common.DTO.RatioScale(guid, revisionNumber);
        }
    }
}
