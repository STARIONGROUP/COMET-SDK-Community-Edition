// --------------------------------------------------------------------------------------------------------------------
// <copyright file="FileMetaInfo.cs" company="Starion Group S.A.">
...
namespace CDP4Common.MetaInfo
{
    ...
    public partial class FileMetaInfo : IFileMetaInfo
    {
        ...
        public IEnumerable<Guid> GetContainmentIds(CDP4Common.DTO.Thing file, string propertyName)
        {
            ...
            {
                throw new ArgumentException($"'{propertyName}' is not a valid containment property of 'File'");
            }
        ...
        {
            { "Actor", (file, value) => file.Actor = value == null ? (Guid?)null : (Guid)value },
            ...
            { "ThingPreference", (file, value) => file.ThingPreference = value == null ? (string)null : value.ToString() },
        };
        ...
        public object DeserializeCollectionValue(string propertyName, object value)
        {
            ...
            {
                throw new ArgumentException($"'{propertyName}' is not a valid collection property of 'File'");
            }
