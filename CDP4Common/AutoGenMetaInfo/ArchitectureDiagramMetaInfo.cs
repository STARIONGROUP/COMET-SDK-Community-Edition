// --------------------------------------------------------------------------------------------------------------------
// <copyright file="ArchitectureDiagramMetaInfo.cs" company="RHEA System S.A.">
...
namespace CDP4Common.MetaInfo
{
    ...
    /// <summary>
    /// This a class that holds meta info for <see cref="ArchitectureDiagram"/>.
    /// </summary>
    public partial class ArchitectureDiagramMetaInfo : IArchitectureDiagramMetaInfo
    {
        ...
        /// </summary>
        private readonly Dictionary<string, Func<CDP4Common.DTO.ArchitectureDiagram, IEnumerable<Guid>>> containmentPropertyValueMap = new Dictionary<string, Func<CDP4Common.DTO.ArchitectureDiagram, IEnumerable<Guid>>>
        {
        ...
        /// </summary>
        private readonly Dictionary<string, Func<CDP4Common.DTO.ArchitectureDiagram, IEnumerable<OrderedItem>>> orderedContainmentPropertyValueMap = new Dictionary<string, Func<CDP4Common.DTO.ArchitectureDiagram, IEnumerable<OrderedItem>>>();

        /// <summary>
        /// The validation rules that should pass for an instance of <see cref="CDP4Common.DTO.ArchitectureDiagram"/>.
        /// </summary>
        private readonly Dictionary<string, DtoValidationHelper<CDP4Common.DTO.ArchitectureDiagram>> validationRules = new Dictionary<string, DtoValidationHelper<CDP4Common.DTO.ArchitectureDiagram>>
        {
            { "Bounds", new DtoValidationHelper<CDP4Common.DTO.ArchitectureDiagram>(item => item.Bounds != null, "The 'Bounds' property of a 'ArchitectureDiagram' is mandatory and cannot be null.") },
            { "Description", new DtoValidationHelper<CDP4Common.DTO.ArchitectureDiagram>(item => !string.IsNullOrWhiteSpace(item.Description), "The 'Description' property of a 'ArchitectureDiagram' is mandatory and cannot be empty or null.") },
            { "DiagramElement", new DtoValidationHelper<CDP4Common.DTO.ArchitectureDiagram>(item => item.DiagramElement != null, "The 'DiagramElement' property of a 'ArchitectureDiagram' is mandatory and cannot be null.") },
            { "ExcludedDomain", new DtoValidationHelper<CDP4Common.DTO.ArchitectureDiagram>(item => item.ExcludedDomain != null, "The 'ExcludedDomain' property of a 'ArchitectureDiagram' is mandatory and cannot be null.") },
            { "ExcludedPerson", new DtoValidationHelper<CDP4Common.DTO.ArchitectureDiagram>(item => item.ExcludedPerson != null, "The 'ExcludedPerson' property of a 'ArchitectureDiagram' is mandatory and cannot be null.") },
            { "Name", new DtoValidationHelper<CDP4Common.DTO.ArchitectureDiagram>(item => !string.IsNullOrWhiteSpace(item.Name), "The 'Name' property of a 'ArchitectureDiagram' is mandatory and cannot be empty or null.") },
        };
        ...
        /// If any validation rule failed.
        /// </exception>
        public void Validate(CDP4Common.DTO.Thing architectureDiagram, Func<string, bool> validateProperty)
        {
        ...
        /// True if all validation rules have passed or if none are defined.
        /// </returns>
        public bool TryValidate(CDP4Common.DTO.Thing architectureDiagram, Func<string, bool> validateProperty)
        {
        ...
        /// <summary>
        /// Returns the containment property value for the supplied <see cref="CDP4Common.DTO.ArchitectureDiagram"/>.
        /// </summary>
        /// <param name="architectureDiagram">
        /// The <see cref="CDP4Common.DTO.ArchitectureDiagram"/> for which to return the containment property value.
        /// </param>
        ...
        /// If the property name is not supported for the <see cref="CDP4Common.DTO.ArchitectureDiagram"/>.
        /// </exception>
        public IEnumerable<Guid> GetContainmentIds(CDP4Common.DTO.Thing architectureDiagram, string propertyName)
        {
            if (!this.containmentPropertyValueMap.ContainsKey(propertyName))
            {
                throw new ArgumentException($"'{propertyName}' is not a valid containment property of 'ArchitectureDiagram'");
            }
        ...
        /// <summary>
        /// Returns the ordered containment property value for the supplied <see cref="CDP4Common.DTO.ArchitectureDiagram"/>.
        /// </summary>
        /// <param name="architectureDiagram">
        /// The <see cref="CDP4Common.DTO.ArchitectureDiagram"/> for which to return the containment property value.
        /// </param>
        ...
        /// If the property name is not supported for the <see cref="CDP4Common.DTO.ArchitectureDiagram"/>.
        /// </exception>
        public IEnumerable<OrderedItem> GetOrderedContainmentIds(CDP4Common.DTO.Thing architectureDiagram, string propertyName)
        {
        ...
        /// <summary>
        /// Gets the <see cref="PropertyMetaInfo"/> for the <see cref="ArchitectureDiagram"/> class
        /// </summary>
        ...
        /// </summary>
        private readonly Dictionary<string, Func<CDP4Common.DTO.ArchitectureDiagram, object>> propertyValueMap = new Dictionary<string, Func<CDP4Common.DTO.ArchitectureDiagram, object>>
        {
        ...
        /// </summary>
        private readonly Dictionary<string, Action<CDP4Common.DTO.ArchitectureDiagram, object>> propertyValueAssignmentMap = new Dictionary<string, Action<CDP4Common.DTO.ArchitectureDiagram, object>>
        {
            { "Actor", (architectureDiagram, value) => architectureDiagram.Actor = value == null ? (Guid?)null : (Guid)value },
        ...
        /// <summary>
        /// Returns the <see cref="CDP4Common.DTO.ArchitectureDiagram"/> containment property type from the supplied property name.
        /// </summary>
        /// <param name="propertyName">
        ...
        /// <summary>
        /// Returns the <see cref="CDP4Common.DTO.ArchitectureDiagram"/> property type from the supplied property name.
        /// </summary>
        /// <param name="propertyName">
        /// The property name.
        /// </param>
        ...
        /// <summary>
        /// Returns the container property for the supplied type name is a possible container for <see cref="CDP4Common.DTO.ArchitectureDiagram"/>.
        /// </summary>
        /// <param name="typeName">
        /// Name of the type for which to check if it is a container of <see cref="CDP4Common.DTO.ArchitectureDiagram"/>.
        /// </param>
        /// <param name="containerProperty">
        /// Supplied container property info instance that will be set if the supplied type name is a container of <see cref="CDP4Common.DTO.ArchitectureDiagram"/>.
        /// </param>
        /// <returns>
        /// True if the supplied typeName is a container for <see cref="CDP4Common.DTO.ArchitectureDiagram"/> and sets the container property name.
        /// </returns>
        ...
        /// <summary>
        /// Check if the supplied property name for <see cref="CDP4Common.DTO.ArchitectureDiagram"/> is scalar.
        /// </summary>
        /// <param name="propertyName">
        /// Name of the property for which to check if it is scalar.
        /// </param>
        ...
        public object DeserializeCollectionValue(string propertyName, object value)
        {
            ...
            {
                throw new ArgumentException($"'{propertyName}' is not a valid collection property of 'ArchitectureDiagram'");
            }
        ...
        /// <summary>
        /// Instantiates a <see cref="CDP4Common.DTO.ArchitectureDiagram"/>
        /// </summary>
        /// <returns>
