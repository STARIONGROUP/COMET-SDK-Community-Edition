// --------------------------------------------------------------------------------------------------------------------
// <copyright file="StakeholderMetaInfo.cs" company="RHEA System S.A.">
...
namespace CDP4Common.MetaInfo
{
    ...
    /// <summary>
    /// This a class that holds meta info for <see cref="Stakeholder"/>.
    /// </summary>
    public partial class StakeholderMetaInfo : IStakeholderMetaInfo
    {
        /// <summary>
        /// The containment property value map.
        /// </summary>
        private readonly Dictionary<string, Func<CDP4Common.DTO.Stakeholder, IEnumerable<Guid>>> containmentPropertyValueMap = new Dictionary<string, Func<CDP4Common.DTO.Stakeholder, IEnumerable<Guid>>>
        {
            { "Alias", stakeholder => stakeholder.Alias },
            { "Attachment", stakeholder => stakeholder.Attachment },
            { "Definition", stakeholder => stakeholder.Definition },
            { "HyperLink", stakeholder => stakeholder.HyperLink },
        };

        /// <summary>
        /// The ordered containment property value map.
        /// </summary>
        private readonly Dictionary<string, Func<CDP4Common.DTO.Stakeholder, IEnumerable<OrderedItem>>> orderedContainmentPropertyValueMap = new Dictionary<string, Func<CDP4Common.DTO.Stakeholder, IEnumerable<OrderedItem>>>();

        /// <summary>
        /// The validation rules that should pass for an instance of <see cref="CDP4Common.DTO.Stakeholder"/>.
        /// </summary>
        private readonly Dictionary<string, DtoValidationHelper<CDP4Common.DTO.Stakeholder>> validationRules = new Dictionary<string, DtoValidationHelper<CDP4Common.DTO.Stakeholder>>
        {
            { "Alias", new DtoValidationHelper<CDP4Common.DTO.Stakeholder>(item => item.Alias != null, "The 'Alias' property of a 'Stakeholder' is mandatory and cannot be null.") },
            { "Attachment", new DtoValidationHelper<CDP4Common.DTO.Stakeholder>(item => item.Attachment != null, "The 'Attachment' property of a 'Stakeholder' is mandatory and cannot be null.") },
            { "Category", new DtoValidationHelper<CDP4Common.DTO.Stakeholder>(item => item.Category != null, "The 'Category' property of a 'Stakeholder' is mandatory and cannot be null.") },
            { "Definition", new DtoValidationHelper<CDP4Common.DTO.Stakeholder>(item => item.Definition != null, "The 'Definition' property of a 'Stakeholder' is mandatory and cannot be null.") },
            { "ExcludedDomain", new DtoValidationHelper<CDP4Common.DTO.Stakeholder>(item => item.ExcludedDomain != null, "The 'ExcludedDomain' property of a 'Stakeholder' is mandatory and cannot be null.") },
            { "ExcludedPerson", new DtoValidationHelper<CDP4Common.DTO.Stakeholder>(item => item.ExcludedPerson != null, "The 'ExcludedPerson' property of a 'Stakeholder' is mandatory and cannot be null.") },
            { "HyperLink", new DtoValidationHelper<CDP4Common.DTO.Stakeholder>(item => item.HyperLink != null, "The 'HyperLink' property of a 'Stakeholder' is mandatory and cannot be null.") },
            { "Name", new DtoValidationHelper<CDP4Common.DTO.Stakeholder>(item => !string.IsNullOrWhiteSpace(item.Name), "The 'Name' property of a 'Stakeholder' is mandatory and cannot be empty or null.") },
            { "ShortName", new DtoValidationHelper<CDP4Common.DTO.Stakeholder>(item => !string.IsNullOrWhiteSpace(item.ShortName), "The 'ShortName' property of a 'Stakeholder' is mandatory and cannot be empty or null.") },
            { "StakeholderValue", new DtoValidationHelper<CDP4Common.DTO.Stakeholder>(item => item.StakeholderValue != null, "The 'StakeholderValue' property of a 'Stakeholder' is mandatory and cannot be null.") },
        };
        ...
        /// </exception>
        public void Validate(CDP4Common.DTO.Thing stakeholder)
        {
            this.Validate(stakeholder, x => true);
        }
        ...
        /// If any validation rule failed.
        /// </exception>
        public void Validate(CDP4Common.DTO.Thing stakeholder, Func<string, bool> validateProperty)
        {
            foreach (var applicableRule in this.validationRules.Where(x => validateProperty(x.Key)))
            {
                applicableRule.Value.Validate((CDP4Common.DTO.Stakeholder)stakeholder);
            }
        }
        ...
        /// </returns>
        public bool TryValidate(CDP4Common.DTO.Thing stakeholder)
        {
            return this.TryValidate(stakeholder, x => true);
        }
        ...
        /// True if all validation rules have passed or if none are defined.
        /// </returns>
        public bool TryValidate(CDP4Common.DTO.Thing stakeholder, Func<string, bool> validateProperty)
        {
            var applicableValidationRules = this.validationRules.Where(x => validateProperty(x.Key)).Select(x => x.Value);

            return applicableValidationRules.All(applicableRule => applicableRule.TryValidate((CDP4Common.DTO.Stakeholder)stakeholder));
        }

        /// <summary>
        /// Returns the containment property value for the supplied <see cref="CDP4Common.DTO.Stakeholder"/>.
        /// </summary>
        /// <param name="stakeholder">
        /// The <see cref="CDP4Common.DTO.Stakeholder"/> for which to return the containment property value.
        /// </param>
        ...
        /// If the property name is not supported for the <see cref="CDP4Common.DTO.Stakeholder"/>.
        /// </exception>
        public IEnumerable<Guid> GetContainmentIds(CDP4Common.DTO.Thing stakeholder, string propertyName)
        {
            if (!this.containmentPropertyValueMap.ContainsKey(propertyName))
            {
                throw new ArgumentException($"'{propertyName}' is not a valid containment property of 'Stakeholder'");
            }

            return this.containmentPropertyValueMap[propertyName]((CDP4Common.DTO.Stakeholder)stakeholder);
        }

        /// <summary>
        /// Returns the ordered containment property value for the supplied <see cref="CDP4Common.DTO.Stakeholder"/>.
        /// </summary>
        /// <param name="stakeholder">
        /// The <see cref="CDP4Common.DTO.Stakeholder"/> for which to return the containment property value.
        /// </param>
        ...
        /// If the property name is not supported for the <see cref="CDP4Common.DTO.Stakeholder"/>.
        /// </exception>
        public IEnumerable<OrderedItem> GetOrderedContainmentIds(CDP4Common.DTO.Thing stakeholder, string propertyName)
        {
            ...
            return this.orderedContainmentPropertyValueMap[propertyName]((CDP4Common.DTO.Stakeholder)stakeholder);
        }
        ...
        /// <summary>
        /// Gets the <see cref="PropertyMetaInfo"/> for the <see cref="Stakeholder"/> class
        /// </summary>
        ...
        /// </summary>
        private readonly Dictionary<string, Func<CDP4Common.DTO.Stakeholder, object>> propertyValueMap = new Dictionary<string, Func<CDP4Common.DTO.Stakeholder, object>>
        {
        ...
        /// </summary>
        private readonly Dictionary<string, Action<CDP4Common.DTO.Stakeholder, object>> propertyValueAssignmentMap = new Dictionary<string, Action<CDP4Common.DTO.Stakeholder, object>>
        {
            { "Actor", (stakeholder, value) => stakeholder.Actor = value == null ? (Guid?)null : (Guid)value },
            { "Iid", (stakeholder, value) => stakeholder.Iid = (Guid)value },
            { "ModifiedOn", (stakeholder, value) => stakeholder.ModifiedOn = (DateTime)value },
            { "Name", (stakeholder, value) => stakeholder.Name = value.ToString() },
            { "ShortName", (stakeholder, value) => stakeholder.ShortName = value.ToString() },
            { "ThingPreference", (stakeholder, value) => stakeholder.ThingPreference = value == null ? (string)null : value.ToString() },
        };
        ...
        {
            { "Iteration", new PropertyMetaInfo("Stakeholder", "Stakeholder", PropertyKind.List, AggregationKind.Composite, false, false, true, 0, "*", true) },
        };
        ...
        /// <summary>
        /// Returns the <see cref="CDP4Common.DTO.Stakeholder"/> containment property type from the supplied property name.
        /// </summary>
        /// <param name="propertyName">
        ...
        /// <summary>
        /// Returns the <see cref="CDP4Common.DTO.Stakeholder"/> property type from the supplied property name.
        /// </summary>
        /// <param name="propertyName">
        /// The property name.
        /// </param>
        ...
        /// <summary>
        /// Returns the container property for the supplied type name is a possible container for <see cref="CDP4Common.DTO.Stakeholder"/>.
        /// </summary>
        /// <param name="typeName">
        /// Name of the type for which to check if it is a container of <see cref="CDP4Common.DTO.Stakeholder"/>.
        /// </param>
        /// <param name="containerProperty">
        /// Supplied container property info instance that will be set if the supplied type name is a container of <see cref="CDP4Common.DTO.Stakeholder"/>.
        /// </param>
        /// <returns>
        /// True if the supplied typeName is a container for <see cref="CDP4Common.DTO.Stakeholder"/> and sets the container property name.
        /// </returns>
        ...
        /// <summary>
        /// Check if the supplied property name for <see cref="CDP4Common.DTO.Stakeholder"/> is scalar.
        /// </summary>
        /// <param name="propertyName">
        /// Name of the property for which to check if it is scalar.
        /// </param>
        ...
        public bool ApplyPropertyUpdate(CDP4Common.DTO.Thing updatableThing, string propertyName, object value)
        {
            ...
            this.propertyValueAssignmentMap[propertyName]((CDP4Common.DTO.Stakeholder)updatableThing, value);
        ...
        public object DeserializeCollectionValue(string propertyName, object value)
        {
            ...
            {
                throw new ArgumentException($"'{propertyName}' is not a valid collection property of 'Stakeholder'");
            }
        ...
        public object GetValue(string propertyName, CDP4Common.DTO.Thing thing)
        {
            ...
            return this.propertyValueMap[propertyName]((CDP4Common.DTO.Stakeholder)thing);
        }
        ...
        /// <summary>
        /// Instantiates a <see cref="CDP4Common.DTO.Stakeholder"/>
        /// </summary>
        /// <returns>
        ...
        {
            return new CDP4Common.DTO.Stakeholder(guid, revisionNumber);
        }
    }
}
