...
namespace CDP4Common.MetaInfo
{
    ...
    public partial class StakeholderMetaInfo : IStakeholderMetaInfo
    {
        ...
        private readonly Dictionary<string, PropertyMetaInfo> propertyTypeMap = new Dictionary<string, PropertyMetaInfo>
        {
            ...
            { "StakeholderValue", new PropertyMetaInfo("StakeholderValue", "Guid", PropertyKind.List, AggregationKind.None, false, false, true, 0, "*", true) },
        };
        ...
        {
            { "Iteration", new PropertyMetaInfo("Stakeholder", "Guid", PropertyKind.List, AggregationKind.Composite, false, false, true, 0, "*", true) },
        };
