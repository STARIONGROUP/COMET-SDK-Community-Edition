// --------------------------------------------------------------------------------------------------------------------
// <copyright file="ParameterOrOverrideBaseMetaInfo.cs" company="Starion Group S.A.">
...
namespace CDP4Common.MetaInfo
{
    ...
    public partial class ParameterOrOverrideBaseMetaInfo : IParameterOrOverrideBaseMetaInfo
    {
        ...
        public IEnumerable<Guid> GetContainmentIds(CDP4Common.DTO.Thing parameterOrOverrideBase, string propertyName)
        {
            ...
            {
                throw new ArgumentException($"'{propertyName}' is not a valid containment property of 'ParameterOrOverrideBase'");
            }
        ...
        {
            { "Actor", (parameterOrOverrideBase, value) => parameterOrOverrideBase.Actor = value == null ? (Guid?)null : (Guid)value },
        ...
        public object DeserializeCollectionValue(string propertyName, object value)
        {
            ...
            {
                throw new ArgumentException($"'{propertyName}' is not a valid collection property of 'ParameterOrOverrideBase'");
            }
