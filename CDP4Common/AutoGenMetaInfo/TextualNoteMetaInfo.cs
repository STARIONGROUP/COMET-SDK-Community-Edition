// --------------------------------------------------------------------------------------------------------------------
// <copyright file="TextualNoteMetaInfo.cs" company="Starion Group S.A.">
...
namespace CDP4Common.MetaInfo
{
    ...
    /// <summary>
    /// This a class that holds meta info for <see cref="TextualNote"/>.
    /// </summary>
    public partial class TextualNoteMetaInfo : ITextualNoteMetaInfo
    {
        /// <summary>
        /// The containment property value map.
        /// </summary>
        private readonly Dictionary<string, Func<CDP4Common.DTO.TextualNote, IEnumerable<Guid>>> containmentPropertyValueMap = new Dictionary<string, Func<CDP4Common.DTO.TextualNote, IEnumerable<Guid>>>();

        /// <summary>
        /// The ordered containment property value map.
        /// </summary>
        private readonly Dictionary<string, Func<CDP4Common.DTO.TextualNote, IEnumerable<OrderedItem>>> orderedContainmentPropertyValueMap = new Dictionary<string, Func<CDP4Common.DTO.TextualNote, IEnumerable<OrderedItem>>>();

        /// <summary>
        /// The validation rules that should pass for an instance of <see cref="CDP4Common.DTO.TextualNote"/>.
        /// </summary>
        private readonly Dictionary<string, DtoValidationHelper<CDP4Common.DTO.TextualNote>> validationRules = new Dictionary<string, DtoValidationHelper<CDP4Common.DTO.TextualNote>>
        {
            { "Category", new DtoValidationHelper<CDP4Common.DTO.TextualNote>(item => item.Category != null, "The 'Category' property of a 'TextualNote' is mandatory and cannot be null.") },
            { "Content", new DtoValidationHelper<CDP4Common.DTO.TextualNote>(item => !string.IsNullOrWhiteSpace(item.Content), "The 'Content' property of a 'TextualNote' is mandatory and cannot be empty or null.") },
            { "ExcludedDomain", new DtoValidationHelper<CDP4Common.DTO.TextualNote>(item => item.ExcludedDomain != null, "The 'ExcludedDomain' property of a 'TextualNote' is mandatory and cannot be null.") },
            { "ExcludedPerson", new DtoValidationHelper<CDP4Common.DTO.TextualNote>(item => item.ExcludedPerson != null, "The 'ExcludedPerson' property of a 'TextualNote' is mandatory and cannot be null.") },
            { "LanguageCode", new DtoValidationHelper<CDP4Common.DTO.TextualNote>(item => !string.IsNullOrWhiteSpace(item.LanguageCode), "The 'LanguageCode' property of a 'TextualNote' is mandatory and cannot be empty or null.") },
            { "Name", new DtoValidationHelper<CDP4Common.DTO.TextualNote>(item => !string.IsNullOrWhiteSpace(item.Name), "The 'Name' property of a 'TextualNote' is mandatory and cannot be empty or null.") },
            { "ShortName", new DtoValidationHelper<CDP4Common.DTO.TextualNote>(item => !string.IsNullOrWhiteSpace(item.ShortName), "The 'ShortName' property of a 'TextualNote' is mandatory and cannot be empty or null.") },
        };
        ...
        /// </exception>
        public void Validate(CDP4Common.DTO.Thing textualNote)
        {
            this.Validate(textualNote, x => true);
        }
        ...
        /// If any validation rule failed.
        /// </exception>
        public void Validate(CDP4Common.DTO.Thing textualNote, Func<string, bool> validateProperty)
        {
            foreach (var applicableRule in this.validationRules.Where(x => validateProperty(x.Key)))
            {
                applicableRule.Value.Validate((CDP4Common.DTO.TextualNote)textualNote);
            }
        }
        ...
        /// </returns>
        public bool TryValidate(CDP4Common.DTO.Thing textualNote)
        {
            return this.TryValidate(textualNote, x => true);
        }
        ...
        /// True if all validation rules have passed or if none are defined.
        /// </returns>
        public bool TryValidate(CDP4Common.DTO.Thing textualNote, Func<string, bool> validateProperty)
        {
            var applicableValidationRules = this.validationRules.Where(x => validateProperty(x.Key)).Select(x => x.Value);

            return applicableValidationRules.All(applicableRule => applicableRule.TryValidate((CDP4Common.DTO.TextualNote)textualNote));
        }

        /// <summary>
        /// Returns the containment property value for the supplied <see cref="CDP4Common.DTO.TextualNote"/>.
        /// </summary>
        /// <param name="textualNote">
        /// The <see cref="CDP4Common.DTO.TextualNote"/> for which to return the containment property value.
        /// </param>
        ...
        /// If the property name is not supported for the <see cref="CDP4Common.DTO.TextualNote"/>.
        /// </exception>
        public IEnumerable<Guid> GetContainmentIds(CDP4Common.DTO.Thing textualNote, string propertyName)
        {
            if (!this.containmentPropertyValueMap.ContainsKey(propertyName))
            {
                throw new ArgumentException($"'{propertyName}' is not a valid containment property of 'TextualNote'");
            }

            return this.containmentPropertyValueMap[propertyName]((CDP4Common.DTO.TextualNote)textualNote);
        }

        /// <summary>
        /// Returns the ordered containment property value for the supplied <see cref="CDP4Common.DTO.TextualNote"/>.
        /// </summary>
        /// <param name="textualNote">
        /// The <see cref="CDP4Common.DTO.TextualNote"/> for which to return the containment property value.
        /// </param>
        ...
        /// If the property name is not supported for the <see cref="CDP4Common.DTO.TextualNote"/>.
        /// </exception>
        public IEnumerable<OrderedItem> GetOrderedContainmentIds(CDP4Common.DTO.Thing textualNote, string propertyName)
        {
            ...
            return this.orderedContainmentPropertyValueMap[propertyName]((CDP4Common.DTO.TextualNote)textualNote);
        }
        ...
        /// <summary>
        /// Gets the <see cref="PropertyMetaInfo"/> for the <see cref="TextualNote"/> class
        /// </summary>
        ...
        /// </summary>
        private readonly Dictionary<string, Func<CDP4Common.DTO.TextualNote, object>> propertyValueMap = new Dictionary<string, Func<CDP4Common.DTO.TextualNote, object>>
        {
        ...
        /// </summary>
        private readonly Dictionary<string, Action<CDP4Common.DTO.TextualNote, object>> propertyValueAssignmentMap = new Dictionary<string, Action<CDP4Common.DTO.TextualNote, object>>
        {
            { "Actor", (textualNote, value) => textualNote.Actor = value == null ? (Guid?)null : (Guid)value },
            { "Content", (textualNote, value) => textualNote.Content = value.ToString() },
            { "CreatedOn", (textualNote, value) => textualNote.CreatedOn = (DateTime)value },
            { "Iid", (textualNote, value) => textualNote.Iid = (Guid)value },
            { "LanguageCode", (textualNote, value) => textualNote.LanguageCode = value.ToString() },
            { "ModifiedOn", (textualNote, value) => textualNote.ModifiedOn = (DateTime)value },
            { "Name", (textualNote, value) => textualNote.Name = value.ToString() },
            { "Owner", (textualNote, value) => textualNote.Owner = (Guid)value },
            { "ShortName", (textualNote, value) => textualNote.ShortName = value.ToString() },
            { "ThingPreference", (textualNote, value) => textualNote.ThingPreference = value == null ? (string)null : value.ToString() },
        };
        ...
        {
            { "Page", new PropertyMetaInfo("Note", "Note", PropertyKind.OrderedList, AggregationKind.Composite, false, true, true, 0, "*", true) },
        };
        ...
        /// <summary>
        /// Returns the <see cref="CDP4Common.DTO.TextualNote"/> containment property type from the supplied property name.
        /// </summary>
        /// <param name="propertyName">
        ...
        /// <summary>
        /// Returns the <see cref="CDP4Common.DTO.TextualNote"/> property type from the supplied property name.
        /// </summary>
        /// <param name="propertyName">
        /// The property name.
        /// </param>
        ...
        /// <summary>
        /// Returns the container property for the supplied type name is a possible container for <see cref="CDP4Common.DTO.TextualNote"/>.
        /// </summary>
        /// <param name="typeName">
        /// Name of the type for which to check if it is a container of <see cref="CDP4Common.DTO.TextualNote"/>.
        /// </param>
        /// <param name="containerProperty">
        /// Supplied container property info instance that will be set if the supplied type name is a container of <see cref="CDP4Common.DTO.TextualNote"/>.
        /// </param>
        /// <returns>
        /// True if the supplied typeName is a container for <see cref="CDP4Common.DTO.TextualNote"/> and sets the container property name.
        /// </returns>
        ...
        /// <summary>
        /// Check if the supplied property name for <see cref="CDP4Common.DTO.TextualNote"/> is scalar.
        /// </summary>
        /// <param name="propertyName">
        /// Name of the property for which to check if it is scalar.
        /// </param>
        ...
        public bool ApplyPropertyUpdate(CDP4Common.DTO.Thing updatableThing, string propertyName, object value)
        {
            ...
            this.propertyValueAssignmentMap[propertyName]((CDP4Common.DTO.TextualNote)updatableThing, value);
        ...
        public object DeserializeCollectionValue(string propertyName, object value)
        {
            ...
            {
                throw new ArgumentException($"'{propertyName}' is not a valid collection property of 'TextualNote'");
            }
        ...
        public object GetValue(string propertyName, CDP4Common.DTO.Thing thing)
        {
            ...
            return this.propertyValueMap[propertyName]((CDP4Common.DTO.TextualNote)thing);
        }
        ...
        /// <summary>
        /// Instantiates a <see cref="CDP4Common.DTO.TextualNote"/>
        /// </summary>
        /// <returns>
        ...
        {
            return new CDP4Common.DTO.TextualNote(guid, revisionNumber);
        }
    }
}
