// --------------------------------------------------------------------------------------------------------------------
// <copyright file="ParameterTypeMetaInfo.cs" company="RHEA System S.A.">
...
namespace CDP4Common.MetaInfo
{
    ...
    /// <summary>
    /// This a class that holds meta info for <see cref="ParameterType"/>.
    /// </summary>
    public partial class ParameterTypeMetaInfo : IParameterTypeMetaInfo
    {
        ...
        /// </summary>
        private readonly Dictionary<string, Func<CDP4Common.DTO.ParameterType, IEnumerable<Guid>>> containmentPropertyValueMap = new Dictionary<string, Func<CDP4Common.DTO.ParameterType, IEnumerable<Guid>>>
        {
            { "Alias", parameterType => parameterType.Alias },
            { "Attachment", parameterType => parameterType.Attachment },
            { "Definition", parameterType => parameterType.Definition },
            { "HyperLink", parameterType => parameterType.HyperLink },
        };

        /// <summary>
        /// The ordered containment property value map.
        /// </summary>
        private readonly Dictionary<string, Func<CDP4Common.DTO.ParameterType, IEnumerable<OrderedItem>>> orderedContainmentPropertyValueMap = new Dictionary<string, Func<CDP4Common.DTO.ParameterType, IEnumerable<OrderedItem>>>();

        /// <summary>
        /// The validation rules that should pass for an instance of <see cref="CDP4Common.DTO.ParameterType"/>.
        /// </summary>
        private readonly Dictionary<string, DtoValidationHelper<CDP4Common.DTO.ParameterType>> validationRules = new Dictionary<string, DtoValidationHelper<CDP4Common.DTO.ParameterType>>
        {
            { "Alias", new DtoValidationHelper<CDP4Common.DTO.ParameterType>(item => item.Alias != null, "The 'Alias' property of a 'ParameterType' is mandatory and cannot be null.") },
            { "Attachment", new DtoValidationHelper<CDP4Common.DTO.ParameterType>(item => item.Attachment != null, "The 'Attachment' property of a 'ParameterType' is mandatory and cannot be null.") },
            { "Category", new DtoValidationHelper<CDP4Common.DTO.ParameterType>(item => item.Category != null, "The 'Category' property of a 'ParameterType' is mandatory and cannot be null.") },
            { "Definition", new DtoValidationHelper<CDP4Common.DTO.ParameterType>(item => item.Definition != null, "The 'Definition' property of a 'ParameterType' is mandatory and cannot be null.") },
            { "ExcludedDomain", new DtoValidationHelper<CDP4Common.DTO.ParameterType>(item => item.ExcludedDomain != null, "The 'ExcludedDomain' property of a 'ParameterType' is mandatory and cannot be null.") },
            { "ExcludedPerson", new DtoValidationHelper<CDP4Common.DTO.ParameterType>(item => item.ExcludedPerson != null, "The 'ExcludedPerson' property of a 'ParameterType' is mandatory and cannot be null.") },
            { "HyperLink", new DtoValidationHelper<CDP4Common.DTO.ParameterType>(item => item.HyperLink != null, "The 'HyperLink' property of a 'ParameterType' is mandatory and cannot be null.") },
            { "Name", new DtoValidationHelper<CDP4Common.DTO.ParameterType>(item => !string.IsNullOrWhiteSpace(item.Name), "The 'Name' property of a 'ParameterType' is mandatory and cannot be empty or null.") },
            { "ShortName", new DtoValidationHelper<CDP4Common.DTO.ParameterType>(item => !string.IsNullOrWhiteSpace(item.ShortName), "The 'ShortName' property of a 'ParameterType' is mandatory and cannot be empty or null.") },
            { "Symbol", new DtoValidationHelper<CDP4Common.DTO.ParameterType>(item => !string.IsNullOrWhiteSpace(item.Symbol), "The 'Symbol' property of a 'ParameterType' is mandatory and cannot be empty or null.") },
        };
        ...
        /// </exception>
        public void Validate(CDP4Common.DTO.Thing parameterType)
        {
            this.Validate(parameterType, x => true);
        }
        ...
        /// If any validation rule failed.
        /// </exception>
        public void Validate(CDP4Common.DTO.Thing parameterType, Func<string, bool> validateProperty)
        {
            foreach (var applicableRule in this.validationRules.Where(x => validateProperty(x.Key)))
            {
                applicableRule.Value.Validate((CDP4Common.DTO.ParameterType)parameterType);
            }
        }
        ...
        /// </returns>
        public bool TryValidate(CDP4Common.DTO.Thing parameterType)
        {
            return this.TryValidate(parameterType, x => true);
        }
        ...
        /// True if all validation rules have passed or if none are defined.
        /// </returns>
        public bool TryValidate(CDP4Common.DTO.Thing parameterType, Func<string, bool> validateProperty)
        {
            var applicableValidationRules = this.validationRules.Where(x => validateProperty(x.Key)).Select(x => x.Value);

            return applicableValidationRules.All(applicableRule => applicableRule.TryValidate((CDP4Common.DTO.ParameterType)parameterType));
        }

        /// <summary>
        /// Returns the containment property value for the supplied <see cref="CDP4Common.DTO.ParameterType"/>.
        /// </summary>
        /// <param name="parameterType">
        /// The <see cref="CDP4Common.DTO.ParameterType"/> for which to return the containment property value.
        /// </param>
        ...
        /// If the property name is not supported for the <see cref="CDP4Common.DTO.ParameterType"/>.
        /// </exception>
        public IEnumerable<Guid> GetContainmentIds(CDP4Common.DTO.Thing parameterType, string propertyName)
        {
            if (!this.containmentPropertyValueMap.ContainsKey(propertyName))
            {
                throw new ArgumentException($"'{propertyName}' is not a valid containment property of 'ParameterType'");
            }

            return this.containmentPropertyValueMap[propertyName]((CDP4Common.DTO.ParameterType)parameterType);
        }

        /// <summary>
        /// Returns the ordered containment property value for the supplied <see cref="CDP4Common.DTO.ParameterType"/>.
        /// </summary>
        /// <param name="parameterType">
        /// The <see cref="CDP4Common.DTO.ParameterType"/> for which to return the containment property value.
        /// </param>
        ...
        /// If the property name is not supported for the <see cref="CDP4Common.DTO.ParameterType"/>.
        /// </exception>
        public IEnumerable<OrderedItem> GetOrderedContainmentIds(CDP4Common.DTO.Thing parameterType, string propertyName)
        {
            ...
            return this.orderedContainmentPropertyValueMap[propertyName]((CDP4Common.DTO.ParameterType)parameterType);
        }
        ...
        /// <summary>
        /// Gets the <see cref="PropertyMetaInfo"/> for the <see cref="ParameterType"/> class
        /// </summary>
        ...
        /// </summary>
        private readonly Dictionary<string, Func<CDP4Common.DTO.ParameterType, object>> propertyValueMap = new Dictionary<string, Func<CDP4Common.DTO.ParameterType, object>>
        {
        ...
        /// </summary>
        private readonly Dictionary<string, Action<CDP4Common.DTO.ParameterType, object>> propertyValueAssignmentMap = new Dictionary<string, Action<CDP4Common.DTO.ParameterType, object>>
        {
            { "Actor", (parameterType, value) => parameterType.Actor = value == null ? (Guid?)null : (Guid)value },
            { "Iid", (parameterType, value) => parameterType.Iid = (Guid)value },
            { "IsDeprecated", (parameterType, value) => parameterType.IsDeprecated = (bool)value },
            { "ModifiedOn", (parameterType, value) => parameterType.ModifiedOn = (DateTime)value },
            { "Name", (parameterType, value) => parameterType.Name = value.ToString() },
            { "ShortName", (parameterType, value) => parameterType.ShortName = value.ToString() },
            { "Symbol", (parameterType, value) => parameterType.Symbol = value.ToString() },
            { "ThingPreference", (parameterType, value) => parameterType.ThingPreference = value == null ? (string)null : value.ToString() },
        };
        ...
        /// <summary>
        /// Returns the <see cref="CDP4Common.DTO.ParameterType"/> containment property type from the supplied property name.
        /// </summary>
        /// <param name="propertyName">
        ...
        /// <summary>
        /// Returns the <see cref="CDP4Common.DTO.ParameterType"/> property type from the supplied property name.
        /// </summary>
        /// <param name="propertyName">
        /// The property name.
        /// </param>
        ...
        /// <summary>
        /// Returns the container property for the supplied type name is a possible container for <see cref="CDP4Common.DTO.ParameterType"/>.
        /// </summary>
        /// <param name="typeName">
        /// Name of the type for which to check if it is a container of <see cref="CDP4Common.DTO.ParameterType"/>.
        /// </param>
        /// <param name="containerProperty">
        /// Supplied container property info instance that will be set if the supplied type name is a container of <see cref="CDP4Common.DTO.ParameterType"/>.
        /// </param>
        /// <returns>
        /// True if the supplied typeName is a container for <see cref="CDP4Common.DTO.ParameterType"/> and sets the container property name.
        /// </returns>
        ...
        /// <summary>
        /// Check if the supplied property name for <see cref="CDP4Common.DTO.ParameterType"/> is scalar.
        /// </summary>
        /// <param name="propertyName">
        /// Name of the property for which to check if it is scalar.
        /// </param>
        ...
        public bool ApplyPropertyUpdate(CDP4Common.DTO.Thing updatableThing, string propertyName, object value)
        {
            ...
            this.propertyValueAssignmentMap[propertyName]((CDP4Common.DTO.ParameterType)updatableThing, value);
        ...
        public object DeserializeCollectionValue(string propertyName, object value)
        {
            ...
            {
                throw new ArgumentException($"'{propertyName}' is not a valid collection property of 'ParameterType'");
            }
        ...
        public object GetValue(string propertyName, CDP4Common.DTO.Thing thing)
        {
            ...
            return this.propertyValueMap[propertyName]((CDP4Common.DTO.ParameterType)thing);
        }
        ...
        /// <summary>
        /// Instantiates a <see cref="CDP4Common.DTO.ParameterType"/>
        /// </summary>
        /// <returns>
