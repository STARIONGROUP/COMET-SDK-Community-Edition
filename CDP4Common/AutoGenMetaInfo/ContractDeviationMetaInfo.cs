...
namespace CDP4Common.MetaInfo
{
    ...
    public partial class ContractDeviationMetaInfo : IContractDeviationMetaInfo
    {
        ...
        public IEnumerable<Guid> GetContainmentIds(CDP4Common.DTO.Thing contractDeviation, string propertyName)
        {
            ...
            {
                throw new ArgumentException(string.Format("'{0}' is not a valid containment property of 'ContractDeviation'", propertyName));
            }
        ...
        public object DeserializeCollectionValue(string propertyName, object value)
        {
            ...
            {
                throw new ArgumentException(string.Format("'{0}' is not a valid collection property of 'ContractDeviation'", propertyName));
            }
