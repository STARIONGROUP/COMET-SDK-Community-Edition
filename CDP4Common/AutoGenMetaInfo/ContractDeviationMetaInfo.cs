// --------------------------------------------------------------------------------------------------------------------
// <copyright file="ContractDeviationMetaInfo.cs" company="Starion Group S.A.">
...
namespace CDP4Common.MetaInfo
{
    ...
    /// <summary>
    /// This a class that holds meta info for <see cref="ContractDeviation"/>.
    /// </summary>
    public partial class ContractDeviationMetaInfo : IContractDeviationMetaInfo
    {
        /// <summary>
        /// The containment property value map.
        /// </summary>
        private readonly Dictionary<string, Func<CDP4Common.DTO.ContractDeviation, IEnumerable<Guid>>> containmentPropertyValueMap = new Dictionary<string, Func<CDP4Common.DTO.ContractDeviation, IEnumerable<Guid>>>
        {
            { "ApprovedBy", contractDeviation => contractDeviation.ApprovedBy },
            { "Discussion", contractDeviation => contractDeviation.Discussion },
            { "RelatedThing", contractDeviation => contractDeviation.RelatedThing },
        };

        /// <summary>
        /// The ordered containment property value map.
        /// </summary>
        private readonly Dictionary<string, Func<CDP4Common.DTO.ContractDeviation, IEnumerable<OrderedItem>>> orderedContainmentPropertyValueMap = new Dictionary<string, Func<CDP4Common.DTO.ContractDeviation, IEnumerable<OrderedItem>>>();

        /// <summary>
        /// The validation rules that should pass for an instance of <see cref="CDP4Common.DTO.ContractDeviation"/>.
        /// </summary>
        private readonly Dictionary<string, DtoValidationHelper<CDP4Common.DTO.ContractDeviation>> validationRules = new Dictionary<string, DtoValidationHelper<CDP4Common.DTO.ContractDeviation>>
        {
            { "ApprovedBy", new DtoValidationHelper<CDP4Common.DTO.ContractDeviation>(item => item.ApprovedBy != null, "The 'ApprovedBy' property of a 'ContractDeviation' is mandatory and cannot be null.") },
            { "Category", new DtoValidationHelper<CDP4Common.DTO.ContractDeviation>(item => item.Category != null, "The 'Category' property of a 'ContractDeviation' is mandatory and cannot be null.") },
            { "Content", new DtoValidationHelper<CDP4Common.DTO.ContractDeviation>(item => !string.IsNullOrWhiteSpace(item.Content), "The 'Content' property of a 'ContractDeviation' is mandatory and cannot be empty or null.") },
            { "Discussion", new DtoValidationHelper<CDP4Common.DTO.ContractDeviation>(item => item.Discussion != null, "The 'Discussion' property of a 'ContractDeviation' is mandatory and cannot be null.") },
            { "ExcludedDomain", new DtoValidationHelper<CDP4Common.DTO.ContractDeviation>(item => item.ExcludedDomain != null, "The 'ExcludedDomain' property of a 'ContractDeviation' is mandatory and cannot be null.") },
            { "ExcludedPerson", new DtoValidationHelper<CDP4Common.DTO.ContractDeviation>(item => item.ExcludedPerson != null, "The 'ExcludedPerson' property of a 'ContractDeviation' is mandatory and cannot be null.") },
            { "LanguageCode", new DtoValidationHelper<CDP4Common.DTO.ContractDeviation>(item => !string.IsNullOrWhiteSpace(item.LanguageCode), "The 'LanguageCode' property of a 'ContractDeviation' is mandatory and cannot be empty or null.") },
            { "RelatedThing", new DtoValidationHelper<CDP4Common.DTO.ContractDeviation>(item => item.RelatedThing != null, "The 'RelatedThing' property of a 'ContractDeviation' is mandatory and cannot be null.") },
            { "ShortName", new DtoValidationHelper<CDP4Common.DTO.ContractDeviation>(item => !string.IsNullOrWhiteSpace(item.ShortName), "The 'ShortName' property of a 'ContractDeviation' is mandatory and cannot be empty or null.") },
            { "SourceAnnotation", new DtoValidationHelper<CDP4Common.DTO.ContractDeviation>(item => item.SourceAnnotation != null, "The 'SourceAnnotation' property of a 'ContractDeviation' is mandatory and cannot be null.") },
            { "Title", new DtoValidationHelper<CDP4Common.DTO.ContractDeviation>(item => !string.IsNullOrWhiteSpace(item.Title), "The 'Title' property of a 'ContractDeviation' is mandatory and cannot be empty or null.") },
        };
        ...
        /// </exception>
        public void Validate(CDP4Common.DTO.Thing contractDeviation)
        {
            this.Validate(contractDeviation, x => true);
        }
        ...
        /// If any validation rule failed.
        /// </exception>
        public void Validate(CDP4Common.DTO.Thing contractDeviation, Func<string, bool> validateProperty)
        {
            foreach (var applicableRule in this.validationRules.Where(x => validateProperty(x.Key)))
            {
                applicableRule.Value.Validate((CDP4Common.DTO.ContractDeviation)contractDeviation);
            }
        }
        ...
        /// </returns>
        public bool TryValidate(CDP4Common.DTO.Thing contractDeviation)
        {
            return this.TryValidate(contractDeviation, x => true);
        }
        ...
        /// True if all validation rules have passed or if none are defined.
        /// </returns>
        public bool TryValidate(CDP4Common.DTO.Thing contractDeviation, Func<string, bool> validateProperty)
        {
            var applicableValidationRules = this.validationRules.Where(x => validateProperty(x.Key)).Select(x => x.Value);

            return applicableValidationRules.All(applicableRule => applicableRule.TryValidate((CDP4Common.DTO.ContractDeviation)contractDeviation));
        }

        /// <summary>
        /// Returns the containment property value for the supplied <see cref="CDP4Common.DTO.ContractDeviation"/>.
        /// </summary>
        /// <param name="contractDeviation">
        /// The <see cref="CDP4Common.DTO.ContractDeviation"/> for which to return the containment property value.
        /// </param>
        ...
        /// If the property name is not supported for the <see cref="CDP4Common.DTO.ContractDeviation"/>.
        /// </exception>
        public IEnumerable<Guid> GetContainmentIds(CDP4Common.DTO.Thing contractDeviation, string propertyName)
        {
            if (!this.containmentPropertyValueMap.ContainsKey(propertyName))
            {
                throw new ArgumentException($"'{propertyName}' is not a valid containment property of 'ContractDeviation'");
            }

            return this.containmentPropertyValueMap[propertyName]((CDP4Common.DTO.ContractDeviation)contractDeviation);
        }

        /// <summary>
        /// Returns the ordered containment property value for the supplied <see cref="CDP4Common.DTO.ContractDeviation"/>.
        /// </summary>
        /// <param name="contractDeviation">
        /// The <see cref="CDP4Common.DTO.ContractDeviation"/> for which to return the containment property value.
        /// </param>
        ...
        /// If the property name is not supported for the <see cref="CDP4Common.DTO.ContractDeviation"/>.
        /// </exception>
        public IEnumerable<OrderedItem> GetOrderedContainmentIds(CDP4Common.DTO.Thing contractDeviation, string propertyName)
        {
            ...
            return this.orderedContainmentPropertyValueMap[propertyName]((CDP4Common.DTO.ContractDeviation)contractDeviation);
        }
        ...
        /// <summary>
        /// Gets the <see cref="PropertyMetaInfo"/> for the <see cref="ContractDeviation"/> class
        /// </summary>
        ...
        /// </summary>
        private readonly Dictionary<string, Func<CDP4Common.DTO.ContractDeviation, object>> propertyValueMap = new Dictionary<string, Func<CDP4Common.DTO.ContractDeviation, object>>
        {
        ...
        /// </summary>
        private readonly Dictionary<string, Action<CDP4Common.DTO.ContractDeviation, object>> propertyValueAssignmentMap = new Dictionary<string, Action<CDP4Common.DTO.ContractDeviation, object>>
        {
            { "Actor", (contractDeviation, value) => contractDeviation.Actor = value == null ? (Guid?)null : (Guid)value },
            { "Author", (contractDeviation, value) => contractDeviation.Author = (Guid)value },
            { "Classification", (contractDeviation, value) => contractDeviation.Classification = (AnnotationClassificationKind)value },
            { "Content", (contractDeviation, value) => contractDeviation.Content = value.ToString() },
            { "CreatedOn", (contractDeviation, value) => contractDeviation.CreatedOn = (DateTime)value },
            { "Iid", (contractDeviation, value) => contractDeviation.Iid = (Guid)value },
            { "LanguageCode", (contractDeviation, value) => contractDeviation.LanguageCode = value.ToString() },
            { "ModifiedOn", (contractDeviation, value) => contractDeviation.ModifiedOn = (DateTime)value },
            { "Owner", (contractDeviation, value) => contractDeviation.Owner = (Guid)value },
            { "PrimaryAnnotatedThing", (contractDeviation, value) => contractDeviation.PrimaryAnnotatedThing = value == null ? (Guid?)null : (Guid)value },
            { "ShortName", (contractDeviation, value) => contractDeviation.ShortName = value.ToString() },
            { "Status", (contractDeviation, value) => contractDeviation.Status = (AnnotationStatusKind)value },
            { "ThingPreference", (contractDeviation, value) => contractDeviation.ThingPreference = value == null ? (string)null : value.ToString() },
            { "Title", (contractDeviation, value) => contractDeviation.Title = value.ToString() },
        };
        ...
        /// <summary>
        /// Returns the <see cref="CDP4Common.DTO.ContractDeviation"/> containment property type from the supplied property name.
        /// </summary>
        /// <param name="propertyName">
        ...
        /// <summary>
        /// Returns the <see cref="CDP4Common.DTO.ContractDeviation"/> property type from the supplied property name.
        /// </summary>
        /// <param name="propertyName">
        /// The property name.
        /// </param>
        ...
        /// <summary>
        /// Returns the container property for the supplied type name is a possible container for <see cref="CDP4Common.DTO.ContractDeviation"/>.
        /// </summary>
        /// <param name="typeName">
        /// Name of the type for which to check if it is a container of <see cref="CDP4Common.DTO.ContractDeviation"/>.
        /// </param>
        /// <param name="containerProperty">
        /// Supplied container property info instance that will be set if the supplied type name is a container of <see cref="CDP4Common.DTO.ContractDeviation"/>.
        /// </param>
        /// <returns>
        /// True if the supplied typeName is a container for <see cref="CDP4Common.DTO.ContractDeviation"/> and sets the container property name.
        /// </returns>
        ...
        /// <summary>
        /// Check if the supplied property name for <see cref="CDP4Common.DTO.ContractDeviation"/> is scalar.
        /// </summary>
        /// <param name="propertyName">
        /// Name of the property for which to check if it is scalar.
        /// </param>
        ...
        public bool ApplyPropertyUpdate(CDP4Common.DTO.Thing updatableThing, string propertyName, object value)
        {
            ...
            this.propertyValueAssignmentMap[propertyName]((CDP4Common.DTO.ContractDeviation)updatableThing, value);
        ...
        public object DeserializeCollectionValue(string propertyName, object value)
        {
            ...
            {
                throw new ArgumentException($"'{propertyName}' is not a valid collection property of 'ContractDeviation'");
            }
        ...
        public object GetValue(string propertyName, CDP4Common.DTO.Thing thing)
        {
            ...
            return this.propertyValueMap[propertyName]((CDP4Common.DTO.ContractDeviation)thing);
        }
        ...
        /// <summary>
        /// Instantiates a <see cref="CDP4Common.DTO.ContractDeviation"/>
        /// </summary>
        /// <returns>
