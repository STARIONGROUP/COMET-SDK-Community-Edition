// --------------------------------------------------------------------------------------------------------------------
// <copyright file="ConversionBasedUnitMetaInfo.cs" company="Starion Group S.A.">
...
namespace CDP4Common.MetaInfo
{
    ...
    /// <summary>
    /// This a class that holds meta info for <see cref="ConversionBasedUnit"/>.
    /// </summary>
    public partial class ConversionBasedUnitMetaInfo : IConversionBasedUnitMetaInfo
    {
        /// <summary>
        ...
        /// </summary>
        private readonly Dictionary<string, Func<CDP4Common.DTO.ConversionBasedUnit, IEnumerable<OrderedItem>>> orderedContainmentPropertyValueMap = new Dictionary<string, Func<CDP4Common.DTO.ConversionBasedUnit, IEnumerable<OrderedItem>>>();

        /// <summary>
        /// The validation rules that should pass for an instance of <see cref="CDP4Common.DTO.ConversionBasedUnit"/>.
        /// </summary>
        private readonly Dictionary<string, DtoValidationHelper<CDP4Common.DTO.ConversionBasedUnit>> validationRules = new Dictionary<string, DtoValidationHelper<CDP4Common.DTO.ConversionBasedUnit>>
        {
            ...
            { "ExcludedPerson", new DtoValidationHelper<CDP4Common.DTO.ConversionBasedUnit>(item => item.ExcludedPerson != null, "The 'ExcludedPerson' property of a 'ConversionBasedUnit' is mandatory and cannot be null.") },
            { "HyperLink", new DtoValidationHelper<CDP4Common.DTO.ConversionBasedUnit>(item => item.HyperLink != null, "The 'HyperLink' property of a 'ConversionBasedUnit' is mandatory and cannot be null.") },
            { "Name", new DtoValidationHelper<CDP4Common.DTO.ConversionBasedUnit>(item => !string.IsNullOrWhiteSpace(item.Name), "The 'Name' property of a 'ConversionBasedUnit' is mandatory and cannot be empty or null.") },
            { "ShortName", new DtoValidationHelper<CDP4Common.DTO.ConversionBasedUnit>(item => !string.IsNullOrWhiteSpace(item.ShortName), "The 'ShortName' property of a 'ConversionBasedUnit' is mandatory and cannot be empty or null.") },
        };
        ...
        /// </exception>
        public void Validate(CDP4Common.DTO.Thing conversionBasedUnit)
        {
            this.Validate(conversionBasedUnit, x => true);
        }
        ...
        /// If any validation rule failed.
        /// </exception>
        public void Validate(CDP4Common.DTO.Thing conversionBasedUnit, Func<string, bool> validateProperty)
        {
            foreach (var applicableRule in this.validationRules.Where(x => validateProperty(x.Key)))
            {
                applicableRule.Value.Validate((CDP4Common.DTO.ConversionBasedUnit)conversionBasedUnit);
            }
        }
        ...
        /// </returns>
        public bool TryValidate(CDP4Common.DTO.Thing conversionBasedUnit)
        {
            return this.TryValidate(conversionBasedUnit, x => true);
        }
        ...
        /// True if all validation rules have passed or if none are defined.
        /// </returns>
        public bool TryValidate(CDP4Common.DTO.Thing conversionBasedUnit, Func<string, bool> validateProperty)
        {
            var applicableValidationRules = this.validationRules.Where(x => validateProperty(x.Key)).Select(x => x.Value);

            return applicableValidationRules.All(applicableRule => applicableRule.TryValidate((CDP4Common.DTO.ConversionBasedUnit)conversionBasedUnit));
        }

        /// <summary>
        /// Returns the containment property value for the supplied <see cref="CDP4Common.DTO.ConversionBasedUnit"/>.
        /// </summary>
        /// <param name="conversionBasedUnit">
        /// The <see cref="CDP4Common.DTO.ConversionBasedUnit"/> for which to return the containment property value.
        /// </param>
        ...
        /// If the property name is not supported for the <see cref="CDP4Common.DTO.ConversionBasedUnit"/>.
        /// </exception>
        public IEnumerable<Guid> GetContainmentIds(CDP4Common.DTO.Thing conversionBasedUnit, string propertyName)
        {
            if (!this.containmentPropertyValueMap.ContainsKey(propertyName))
            {
                throw new ArgumentException($"'{propertyName}' is not a valid containment property of 'ConversionBasedUnit'");
            }

            return this.containmentPropertyValueMap[propertyName]((CDP4Common.DTO.ConversionBasedUnit)conversionBasedUnit);
        }

        /// <summary>
        /// Returns the ordered containment property value for the supplied <see cref="CDP4Common.DTO.ConversionBasedUnit"/>.
        /// </summary>
        /// <param name="conversionBasedUnit">
        /// The <see cref="CDP4Common.DTO.ConversionBasedUnit"/> for which to return the containment property value.
        /// </param>
        ...
        /// If the property name is not supported for the <see cref="CDP4Common.DTO.ConversionBasedUnit"/>.
        /// </exception>
        public IEnumerable<OrderedItem> GetOrderedContainmentIds(CDP4Common.DTO.Thing conversionBasedUnit, string propertyName)
        {
            ...
            return this.orderedContainmentPropertyValueMap[propertyName]((CDP4Common.DTO.ConversionBasedUnit)conversionBasedUnit);
        }
        ...
        /// <summary>
        /// Gets the <see cref="PropertyMetaInfo"/> for the <see cref="ConversionBasedUnit"/> class
        /// </summary>
        ...
        /// </summary>
        private readonly Dictionary<string, Action<CDP4Common.DTO.ConversionBasedUnit, object>> propertyValueAssignmentMap = new Dictionary<string, Action<CDP4Common.DTO.ConversionBasedUnit, object>>
        {
            { "Actor", (conversionBasedUnit, value) => conversionBasedUnit.Actor = value == null ? (Guid?)null : (Guid)value },
            { "ConversionFactor", (conversionBasedUnit, value) => conversionBasedUnit.ConversionFactor = value.ToString() },
            { "Iid", (conversionBasedUnit, value) => conversionBasedUnit.Iid = (Guid)value },
            { "IsDeprecated", (conversionBasedUnit, value) => conversionBasedUnit.IsDeprecated = (bool)value },
            { "ModifiedOn", (conversionBasedUnit, value) => conversionBasedUnit.ModifiedOn = (DateTime)value },
            { "Name", (conversionBasedUnit, value) => conversionBasedUnit.Name = value.ToString() },
            { "ReferenceUnit", (conversionBasedUnit, value) => conversionBasedUnit.ReferenceUnit = (Guid)value },
            { "ShortName", (conversionBasedUnit, value) => conversionBasedUnit.ShortName = value.ToString() },
            { "ThingPreference", (conversionBasedUnit, value) => conversionBasedUnit.ThingPreference = value == null ? (string)null : value.ToString() },
        };
        ...
        /// <summary>
        /// Returns the <see cref="CDP4Common.DTO.ConversionBasedUnit"/> containment property type from the supplied property name.
        /// </summary>
        /// <param name="propertyName">
        ...
        /// <summary>
        /// Returns the <see cref="CDP4Common.DTO.ConversionBasedUnit"/> property type from the supplied property name.
        /// </summary>
        /// <param name="propertyName">
        /// The property name.
        /// </param>
        ...
        /// <summary>
        /// Returns the container property for the supplied type name is a possible container for <see cref="CDP4Common.DTO.ConversionBasedUnit"/>.
        /// </summary>
        /// <param name="typeName">
        /// Name of the type for which to check if it is a container of <see cref="CDP4Common.DTO.ConversionBasedUnit"/>.
        /// </param>
        /// <param name="containerProperty">
        /// Supplied container property info instance that will be set if the supplied type name is a container of <see cref="CDP4Common.DTO.ConversionBasedUnit"/>.
        /// </param>
        /// <returns>
        /// True if the supplied typeName is a container for <see cref="CDP4Common.DTO.ConversionBasedUnit"/> and sets the container property name.
        /// </returns>
        ...
        /// <summary>
        /// Check if the supplied property name for <see cref="CDP4Common.DTO.ConversionBasedUnit"/> is scalar.
        /// </summary>
        /// <param name="propertyName">
        /// Name of the property for which to check if it is scalar.
        /// </param>
        ...
        public bool ApplyPropertyUpdate(CDP4Common.DTO.Thing updatableThing, string propertyName, object value)
        {
            ...
            this.propertyValueAssignmentMap[propertyName]((CDP4Common.DTO.ConversionBasedUnit)updatableThing, value);
        ...
        public object DeserializeCollectionValue(string propertyName, object value)
        {
            ...
            {
                throw new ArgumentException($"'{propertyName}' is not a valid collection property of 'ConversionBasedUnit'");
            }
        ...
        public object GetValue(string propertyName, CDP4Common.DTO.Thing thing)
        {
            ...
            return this.propertyValueMap[propertyName]((CDP4Common.DTO.ConversionBasedUnit)thing);
        }
        ...
        /// <summary>
        /// Instantiates a <see cref="CDP4Common.DTO.ConversionBasedUnit"/>
        /// </summary>
        /// <returns>
