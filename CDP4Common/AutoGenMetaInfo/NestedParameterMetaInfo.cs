// --------------------------------------------------------------------------------------------------------------------
// <copyright file="NestedParameterMetaInfo.cs" company="Starion Group S.A.">
...
namespace CDP4Common.MetaInfo
{
    ...
    public partial class NestedParameterMetaInfo : INestedParameterMetaInfo
    {
        ...
        public IEnumerable<Guid> GetContainmentIds(CDP4Common.DTO.Thing nestedParameter, string propertyName)
        {
            ...
            {
                throw new ArgumentException($"'{propertyName}' is not a valid containment property of 'NestedParameter'");
            }
        ...
        {
            { "Actor", (nestedParameter, value) => nestedParameter.Actor = value == null ? (Guid?)null : (Guid)value },
        ...
        public object DeserializeCollectionValue(string propertyName, object value)
        {
            ...
            {
                throw new ArgumentException($"'{propertyName}' is not a valid collection property of 'NestedParameter'");
            }
