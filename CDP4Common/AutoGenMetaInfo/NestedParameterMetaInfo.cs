...
namespace CDP4Common.MetaInfo
{
    ...
    public partial class NestedParameterMetaInfo : INestedParameterMetaInfo
    {
        ...
        private readonly Dictionary<string, PropertyMetaInfo> propertyTypeMap = new Dictionary<string, PropertyMetaInfo>
        {
            ...
            { "AssociatedParameter", new PropertyMetaInfo("AssociatedParameter", "Guid", PropertyKind.Scalar, AggregationKind.None, false, false, true, 1, "1", true) },
        ...
        {
            { "NestedElement", new PropertyMetaInfo("NestedParameter", "Guid", PropertyKind.List, AggregationKind.Composite, false, false, true, 0, "*", true) },
        };
