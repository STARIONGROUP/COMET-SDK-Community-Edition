// --------------------------------------------------------------------------------------------------------------------
// <copyright file="OrdinalScaleMetaInfo.cs" company="RHEA System S.A.">
...
namespace CDP4Common.MetaInfo
{
    ...
    /// </summary>
    public partial class OrdinalScaleMetaInfo : IOrdinalScaleMetaInfo
    {
        /// <summary>
        /// The containment property value map.
        /// </summary>
        private readonly Dictionary<string, Func<CDP4Common.DTO.OrdinalScale, IEnumerable<Guid>>> containmentPropertyValueMap = new Dictionary<string, Func<CDP4Common.DTO.OrdinalScale, IEnumerable<Guid>>>
        {
            { "Alias", ordinalScale => ordinalScale.Alias },
            { "Attachment", ordinalScale => ordinalScale.Attachment },
            { "Definition", ordinalScale => ordinalScale.Definition },
            { "HyperLink", ordinalScale => ordinalScale.HyperLink },
            { "MappingToReferenceScale", ordinalScale => ordinalScale.MappingToReferenceScale },
            { "ValueDefinition", ordinalScale => ordinalScale.ValueDefinition },
        };

        /// <summary>
        /// The ordered containment property value map.
        /// </summary>
        private readonly Dictionary<string, Func<CDP4Common.DTO.OrdinalScale, IEnumerable<OrderedItem>>> orderedContainmentPropertyValueMap = new Dictionary<string, Func<CDP4Common.DTO.OrdinalScale, IEnumerable<OrderedItem>>>();

        /// <summary>
        /// The validation rules that should pass for an instance of <see cref="CDP4Common.DTO.OrdinalScale"/>.
        /// </summary>
        private readonly Dictionary<string, DtoValidationHelper<CDP4Common.DTO.OrdinalScale>> validationRules = new Dictionary<string, DtoValidationHelper<CDP4Common.DTO.OrdinalScale>>
        {
            { "Alias", new DtoValidationHelper<CDP4Common.DTO.OrdinalScale>(item => item.Alias != null, "The 'Alias' property of a 'OrdinalScale' is mandatory and cannot be null.") },
            { "Attachment", new DtoValidationHelper<CDP4Common.DTO.OrdinalScale>(item => item.Attachment != null, "The 'Attachment' property of a 'OrdinalScale' is mandatory and cannot be null.") },
            { "Definition", new DtoValidationHelper<CDP4Common.DTO.OrdinalScale>(item => item.Definition != null, "The 'Definition' property of a 'OrdinalScale' is mandatory and cannot be null.") },
            { "ExcludedDomain", new DtoValidationHelper<CDP4Common.DTO.OrdinalScale>(item => item.ExcludedDomain != null, "The 'ExcludedDomain' property of a 'OrdinalScale' is mandatory and cannot be null.") },
            { "ExcludedPerson", new DtoValidationHelper<CDP4Common.DTO.OrdinalScale>(item => item.ExcludedPerson != null, "The 'ExcludedPerson' property of a 'OrdinalScale' is mandatory and cannot be null.") },
            { "HyperLink", new DtoValidationHelper<CDP4Common.DTO.OrdinalScale>(item => item.HyperLink != null, "The 'HyperLink' property of a 'OrdinalScale' is mandatory and cannot be null.") },
            { "MappingToReferenceScale", new DtoValidationHelper<CDP4Common.DTO.OrdinalScale>(item => item.MappingToReferenceScale != null, "The 'MappingToReferenceScale' property of a 'OrdinalScale' is mandatory and cannot be null.") },
            { "Name", new DtoValidationHelper<CDP4Common.DTO.OrdinalScale>(item => !string.IsNullOrWhiteSpace(item.Name), "The 'Name' property of a 'OrdinalScale' is mandatory and cannot be empty or null.") },
            { "ShortName", new DtoValidationHelper<CDP4Common.DTO.OrdinalScale>(item => !string.IsNullOrWhiteSpace(item.ShortName), "The 'ShortName' property of a 'OrdinalScale' is mandatory and cannot be empty or null.") },
            { "ValueDefinition", new DtoValidationHelper<CDP4Common.DTO.OrdinalScale>(item => item.ValueDefinition != null, "The 'ValueDefinition' property of a 'OrdinalScale' is mandatory and cannot be null.") },
        };
        ...
        /// </exception>
        public void Validate(CDP4Common.DTO.Thing ordinalScale)
        {
            this.Validate(ordinalScale, x => true);
        }
        ...
        /// If any validation rule failed.
        /// </exception>
        public void Validate(CDP4Common.DTO.Thing ordinalScale, Func<string, bool> validateProperty)
        {
            foreach (var applicableRule in this.validationRules.Where(x => validateProperty(x.Key)))
            {
                applicableRule.Value.Validate((CDP4Common.DTO.OrdinalScale)ordinalScale);
            }
        }
        ...
        /// </returns>
        public bool TryValidate(CDP4Common.DTO.Thing ordinalScale)
        {
            return this.TryValidate(ordinalScale, x => true);
        }
        ...
        /// True if all validation rules have passed or if none are defined.
        /// </returns>
        public bool TryValidate(CDP4Common.DTO.Thing ordinalScale, Func<string, bool> validateProperty)
        {
            var applicableValidationRules = this.validationRules.Where(x => validateProperty(x.Key)).Select(x => x.Value);

            return applicableValidationRules.All(applicableRule => applicableRule.TryValidate((CDP4Common.DTO.OrdinalScale)ordinalScale));
        }

        /// <summary>
        /// Returns the containment property value for the supplied <see cref="CDP4Common.DTO.OrdinalScale"/>.
        /// </summary>
        /// <param name="ordinalScale">
        /// The <see cref="CDP4Common.DTO.OrdinalScale"/> for which to return the containment property value.
        /// </param>
        ...
        /// If the property name is not supported for the <see cref="CDP4Common.DTO.OrdinalScale"/>.
        /// </exception>
        public IEnumerable<Guid> GetContainmentIds(CDP4Common.DTO.Thing ordinalScale, string propertyName)
        {
            if (!this.containmentPropertyValueMap.ContainsKey(propertyName))
            {
                throw new ArgumentException($"'{propertyName}' is not a valid containment property of 'OrdinalScale'");
            }

            return this.containmentPropertyValueMap[propertyName]((CDP4Common.DTO.OrdinalScale)ordinalScale);
        }

        /// <summary>
        /// Returns the ordered containment property value for the supplied <see cref="CDP4Common.DTO.OrdinalScale"/>.
        /// </summary>
        /// <param name="ordinalScale">
        /// The <see cref="CDP4Common.DTO.OrdinalScale"/> for which to return the containment property value.
        /// </param>
        ...
        /// If the property name is not supported for the <see cref="CDP4Common.DTO.OrdinalScale"/>.
        /// </exception>
        public IEnumerable<OrderedItem> GetOrderedContainmentIds(CDP4Common.DTO.Thing ordinalScale, string propertyName)
        {
            ...
            return this.orderedContainmentPropertyValueMap[propertyName]((CDP4Common.DTO.OrdinalScale)ordinalScale);
        }
        ...
        /// <summary>
        /// Gets the <see cref="PropertyMetaInfo"/> for the <see cref="OrdinalScale"/> class
        /// </summary>
        ...
        /// </summary>
        private readonly Dictionary<string, Func<CDP4Common.DTO.OrdinalScale, object>> propertyValueMap = new Dictionary<string, Func<CDP4Common.DTO.OrdinalScale, object>>
        {
            ...
            { "UseShortNameValues", thing => thing.UseShortNameValues },
        ...
        /// </summary>
        private readonly Dictionary<string, Action<CDP4Common.DTO.OrdinalScale, object>> propertyValueAssignmentMap = new Dictionary<string, Action<CDP4Common.DTO.OrdinalScale, object>>
        {
            { "Actor", (ordinalScale, value) => ordinalScale.Actor = value == null ? (Guid?)null : (Guid)value },
            { "Iid", (ordinalScale, value) => ordinalScale.Iid = (Guid)value },
            { "IsDeprecated", (ordinalScale, value) => ordinalScale.IsDeprecated = (bool)value },
            { "IsMaximumInclusive", (ordinalScale, value) => ordinalScale.IsMaximumInclusive = (bool)value },
            { "IsMinimumInclusive", (ordinalScale, value) => ordinalScale.IsMinimumInclusive = (bool)value },
            { "MaximumPermissibleValue", (ordinalScale, value) => ordinalScale.MaximumPermissibleValue = value == null ? (string)null : value.ToString() },
            { "MinimumPermissibleValue", (ordinalScale, value) => ordinalScale.MinimumPermissibleValue = value == null ? (string)null : value.ToString() },
            { "ModifiedOn", (ordinalScale, value) => ordinalScale.ModifiedOn = (DateTime)value },
            { "Name", (ordinalScale, value) => ordinalScale.Name = value.ToString() },
            { "NegativeValueConnotation", (ordinalScale, value) => ordinalScale.NegativeValueConnotation = value == null ? (string)null : value.ToString() },
            { "NumberSet", (ordinalScale, value) => ordinalScale.NumberSet = (NumberSetKind)value },
            { "PositiveValueConnotation", (ordinalScale, value) => ordinalScale.PositiveValueConnotation = value == null ? (string)null : value.ToString() },
            { "ShortName", (ordinalScale, value) => ordinalScale.ShortName = value.ToString() },
            { "ThingPreference", (ordinalScale, value) => ordinalScale.ThingPreference = value == null ? (string)null : value.ToString() },
            { "Unit", (ordinalScale, value) => ordinalScale.Unit = (Guid)value },
            { "UseShortNameValues", (ordinalScale, value) => ordinalScale.UseShortNameValues = (bool)value },
        };
        ...
        /// <summary>
        /// Returns the <see cref="CDP4Common.DTO.OrdinalScale"/> containment property type from the supplied property name.
        /// </summary>
        /// <param name="propertyName">
        ...
        /// <summary>
        /// Returns the <see cref="CDP4Common.DTO.OrdinalScale"/> property type from the supplied property name.
        /// </summary>
        /// <param name="propertyName">
        /// The property name.
        /// </param>
        ...
        /// <summary>
        /// Returns the container property for the supplied type name is a possible container for <see cref="CDP4Common.DTO.OrdinalScale"/>.
        /// </summary>
        /// <param name="typeName">
        /// Name of the type for which to check if it is a container of <see cref="CDP4Common.DTO.OrdinalScale"/>.
        /// </param>
        /// <param name="containerProperty">
        /// Supplied container property info instance that will be set if the supplied type name is a container of <see cref="CDP4Common.DTO.OrdinalScale"/>.
        /// </param>
        /// <returns>
        /// True if the supplied typeName is a container for <see cref="CDP4Common.DTO.OrdinalScale"/> and sets the container property name.
        /// </returns>
        ...
        /// <summary>
        /// Check if the supplied property name for <see cref="CDP4Common.DTO.OrdinalScale"/> is scalar.
        /// </summary>
        /// <param name="propertyName">
        /// Name of the property for which to check if it is scalar.
        /// </param>
        ...
        public bool ApplyPropertyUpdate(CDP4Common.DTO.Thing updatableThing, string propertyName, object value)
        {
            ...
            this.propertyValueAssignmentMap[propertyName]((CDP4Common.DTO.OrdinalScale)updatableThing, value);
        ...
        public object DeserializeCollectionValue(string propertyName, object value)
        {
            ...
            {
                throw new ArgumentException($"'{propertyName}' is not a valid collection property of 'OrdinalScale'");
            }
        ...
        public object GetValue(string propertyName, CDP4Common.DTO.Thing thing)
        {
            ...
            return this.propertyValueMap[propertyName]((CDP4Common.DTO.OrdinalScale)thing);
        }
        ...
        /// <summary>
        /// Instantiates a <see cref="CDP4Common.DTO.OrdinalScale"/>
        /// </summary>
        /// <returns>
        ...
        {
            return new CDP4Common.DTO.OrdinalScale(guid, revisionNumber);
        }
    }
}
