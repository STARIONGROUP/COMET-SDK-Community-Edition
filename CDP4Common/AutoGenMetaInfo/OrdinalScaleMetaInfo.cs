...
namespace CDP4Common.MetaInfo
{
    ...
    public partial class OrdinalScaleMetaInfo : IOrdinalScaleMetaInfo
    {
        ...
        public IEnumerable<Guid> GetContainmentIds(CDP4Common.DTO.Thing ordinalScale, string propertyName)
        {
            ...
            {
                throw new ArgumentException(string.Format("'{0}' is not a valid containment property of 'OrdinalScale'", propertyName));
            }
        ...
        public object DeserializeCollectionValue(string propertyName, object value)
        {
            ...
            {
                throw new ArgumentException(string.Format("'{0}' is not a valid collection property of 'OrdinalScale'", propertyName));
            }
