// --------------------------------------------------------------------------------------------------------------------
// <copyright file="ParameterOverrideValueSetMetaInfo.cs" company="Starion Group S.A.">
...
namespace CDP4Common.MetaInfo
{
    ...
    public partial class ParameterOverrideValueSetMetaInfo : IParameterOverrideValueSetMetaInfo
    {
        ...
        public IEnumerable<Guid> GetContainmentIds(CDP4Common.DTO.Thing parameterOverrideValueSet, string propertyName)
        {
            ...
            {
                throw new ArgumentException($"'{propertyName}' is not a valid containment property of 'ParameterOverrideValueSet'");
            }
        ...
        public object DeserializeCollectionValue(string propertyName, object value)
        {
            ...
            {
                throw new ArgumentException($"'{propertyName}' is not a valid collection property of 'ParameterOverrideValueSet'");
            }
