// --------------------------------------------------------------------------------------------------------------------
// <copyright file="ParameterOverrideValueSetMetaInfo.cs" company="RHEA System S.A.">
...
namespace CDP4Common.MetaInfo
{
    ...
    /// <summary>
    /// This a class that holds meta info for <see cref="ParameterOverrideValueSet"/>.
    /// </summary>
    public partial class ParameterOverrideValueSetMetaInfo : IParameterOverrideValueSetMetaInfo
    {
        /// <summary>
        /// The containment property value map.
        /// </summary>
        private readonly Dictionary<string, Func<CDP4Common.DTO.ParameterOverrideValueSet, IEnumerable<Guid>>> containmentPropertyValueMap = new Dictionary<string, Func<CDP4Common.DTO.ParameterOverrideValueSet, IEnumerable<Guid>>>();

        /// <summary>
        /// The ordered containment property value map.
        /// </summary>
        private readonly Dictionary<string, Func<CDP4Common.DTO.ParameterOverrideValueSet, IEnumerable<OrderedItem>>> orderedContainmentPropertyValueMap = new Dictionary<string, Func<CDP4Common.DTO.ParameterOverrideValueSet, IEnumerable<OrderedItem>>>();

        /// <summary>
        /// The validation rules that should pass for an instance of <see cref="CDP4Common.DTO.ParameterOverrideValueSet"/>.
        /// </summary>
        private readonly Dictionary<string, DtoValidationHelper<CDP4Common.DTO.ParameterOverrideValueSet>> validationRules = new Dictionary<string, DtoValidationHelper<CDP4Common.DTO.ParameterOverrideValueSet>>
        {
            { "Computed", new DtoValidationHelper<CDP4Common.DTO.ParameterOverrideValueSet>(item => item.Computed != null && item.Computed.Any(), "The 'Computed' property of a 'ParameterOverrideValueSet' is mandatory and must have at least one entry.") },
            { "ExcludedDomain", new DtoValidationHelper<CDP4Common.DTO.ParameterOverrideValueSet>(item => item.ExcludedDomain != null, "The 'ExcludedDomain' property of a 'ParameterOverrideValueSet' is mandatory and cannot be null.") },
            { "ExcludedPerson", new DtoValidationHelper<CDP4Common.DTO.ParameterOverrideValueSet>(item => item.ExcludedPerson != null, "The 'ExcludedPerson' property of a 'ParameterOverrideValueSet' is mandatory and cannot be null.") },
            { "Formula", new DtoValidationHelper<CDP4Common.DTO.ParameterOverrideValueSet>(item => item.Formula != null && item.Formula.Any(), "The 'Formula' property of a 'ParameterOverrideValueSet' is mandatory and must have at least one entry.") },
            { "Manual", new DtoValidationHelper<CDP4Common.DTO.ParameterOverrideValueSet>(item => item.Manual != null && item.Manual.Any(), "The 'Manual' property of a 'ParameterOverrideValueSet' is mandatory and must have at least one entry.") },
            { "Published", new DtoValidationHelper<CDP4Common.DTO.ParameterOverrideValueSet>(item => item.Published != null && item.Published.Any(), "The 'Published' property of a 'ParameterOverrideValueSet' is mandatory and must have at least one entry.") },
            { "Reference", new DtoValidationHelper<CDP4Common.DTO.ParameterOverrideValueSet>(item => item.Reference != null && item.Reference.Any(), "The 'Reference' property of a 'ParameterOverrideValueSet' is mandatory and must have at least one entry.") },
        };
        ...
        /// </exception>
        public void Validate(CDP4Common.DTO.Thing parameterOverrideValueSet)
        {
            this.Validate(parameterOverrideValueSet, x => true);
        }
        ...
        /// If any validation rule failed.
        /// </exception>
        public void Validate(CDP4Common.DTO.Thing parameterOverrideValueSet, Func<string, bool> validateProperty)
        {
            foreach (var applicableRule in this.validationRules.Where(x => validateProperty(x.Key)))
            {
                applicableRule.Value.Validate((CDP4Common.DTO.ParameterOverrideValueSet)parameterOverrideValueSet);
            }
        }
        ...
        /// </returns>
        public bool TryValidate(CDP4Common.DTO.Thing parameterOverrideValueSet)
        {
            return this.TryValidate(parameterOverrideValueSet, x => true);
        }
        ...
        /// True if all validation rules have passed or if none are defined.
        /// </returns>
        public bool TryValidate(CDP4Common.DTO.Thing parameterOverrideValueSet, Func<string, bool> validateProperty)
        {
            var applicableValidationRules = this.validationRules.Where(x => validateProperty(x.Key)).Select(x => x.Value);

            return applicableValidationRules.All(applicableRule => applicableRule.TryValidate((CDP4Common.DTO.ParameterOverrideValueSet)parameterOverrideValueSet));
        }

        /// <summary>
        /// Returns the containment property value for the supplied <see cref="CDP4Common.DTO.ParameterOverrideValueSet"/>.
        /// </summary>
        /// <param name="parameterOverrideValueSet">
        /// The <see cref="CDP4Common.DTO.ParameterOverrideValueSet"/> for which to return the containment property value.
        /// </param>
        ...
        /// If the property name is not supported for the <see cref="CDP4Common.DTO.ParameterOverrideValueSet"/>.
        /// </exception>
        public IEnumerable<Guid> GetContainmentIds(CDP4Common.DTO.Thing parameterOverrideValueSet, string propertyName)
        {
            if (!this.containmentPropertyValueMap.ContainsKey(propertyName))
            {
                throw new ArgumentException(string.Format("'{0}' is not a valid containment property of 'ParameterOverrideValueSet'", propertyName));
            }

            return this.containmentPropertyValueMap[propertyName]((CDP4Common.DTO.ParameterOverrideValueSet)parameterOverrideValueSet);
        }

        /// <summary>
        /// Returns the ordered containment property value for the supplied <see cref="CDP4Common.DTO.ParameterOverrideValueSet"/>.
        /// </summary>
        /// <param name="parameterOverrideValueSet">
        /// The <see cref="CDP4Common.DTO.ParameterOverrideValueSet"/> for which to return the containment property value.
        /// </param>
        ...
        /// If the property name is not supported for the <see cref="CDP4Common.DTO.ParameterOverrideValueSet"/>.
        /// </exception>
        public IEnumerable<OrderedItem> GetOrderedContainmentIds(CDP4Common.DTO.Thing parameterOverrideValueSet, string propertyName)
        {
            ...
            return this.orderedContainmentPropertyValueMap[propertyName]((CDP4Common.DTO.ParameterOverrideValueSet)parameterOverrideValueSet);
        }
        ...
        /// <summary>
        /// Gets the <see cref="PropertyMetaInfo"/> for the <see cref="ParameterOverrideValueSet"/> class
        /// </summary>
        ...
        private readonly Dictionary<string, Func<CDP4Common.DTO.ParameterOverrideValueSet, object>> propertyValueMap = new Dictionary<string, Func<CDP4Common.DTO.ParameterOverrideValueSet, object>>
        {
            ...
            { "ParameterValueSet", thing => thing.ParameterValueSet },
        ...
        {
            { "ActualOption", new PropertyMetaInfo("ActualOption", "Guid", PropertyKind.Scalar, AggregationKind.None, true, false, true, 0, "1", false) },
            { "ActualState", new PropertyMetaInfo("ActualState", "Guid", PropertyKind.Scalar, AggregationKind.None, true, false, true, 0, "1", false) },
            ...
            { "ParameterValueSet", new PropertyMetaInfo("ParameterValueSet", "Guid", PropertyKind.Scalar, AggregationKind.None, false, false, true, 1, "1", true) },
        ...
        private readonly Dictionary<string, Action<CDP4Common.DTO.ParameterOverrideValueSet, object>> propertyValueAssignmentMap = new Dictionary<string, Action<CDP4Common.DTO.ParameterOverrideValueSet, object>>
        {
            ...
            { "Manual", (parameterOverrideValueSet, value) => parameterOverrideValueSet.Manual = (ValueArray<string>)value },
            { "ModifiedOn", (parameterOverrideValueSet, value) => parameterOverrideValueSet.ModifiedOn = (DateTime)value },
        ...
        {
            { "ParameterOverride", new PropertyMetaInfo("ValueSet", "Guid", PropertyKind.List, AggregationKind.Composite, false, false, true, 1, "*", true) },
        };
        ...
        /// <summary>
        /// Returns the <see cref="CDP4Common.DTO.ParameterOverrideValueSet"/> containment property type from the supplied property name.
        /// </summary>
        /// <param name="propertyName">
        ...
        /// <summary>
        /// Returns the <see cref="CDP4Common.DTO.ParameterOverrideValueSet"/> property type from the supplied property name.
        /// </summary>
        /// <param name="propertyName">
        /// The property name.
        /// </param>
        ...
        /// <summary>
        /// Returns the container property for the supplied type name is a possible container for <see cref="CDP4Common.DTO.ParameterOverrideValueSet"/>.
        /// </summary>
        /// <param name="typeName">
        /// Name of the type for which to check if it is a container of <see cref="CDP4Common.DTO.ParameterOverrideValueSet"/>.
        /// </param>
        /// <param name="containerProperty">
        /// Supplied container property info instance that will be set if the supplied type name is a container of <see cref="CDP4Common.DTO.ParameterOverrideValueSet"/>.
        /// </param>
        /// <returns>
        /// True if the supplied typeName is a container for <see cref="CDP4Common.DTO.ParameterOverrideValueSet"/> and sets the container property name.
        /// </returns>
        ...
        /// <summary>
        /// Check if the supplied property name for <see cref="CDP4Common.DTO.ParameterOverrideValueSet"/> is scalar.
        /// </summary>
        /// <param name="propertyName">
        /// Name of the property for which to check if it is scalar.
        /// </param>
        ...
        public bool ApplyPropertyUpdate(CDP4Common.DTO.Thing updatableThing, string propertyName, object value)
        {
            ...
            this.propertyValueAssignmentMap[propertyName]((CDP4Common.DTO.ParameterOverrideValueSet)updatableThing, value);
        ...
        public object DeserializeCollectionValue(string propertyName, object value)
        {
            ...
            {
                throw new ArgumentException(string.Format("'{0}' is not a valid collection property of 'ParameterOverrideValueSet'", propertyName));
            }
        ...
        public object GetValue(string propertyName, CDP4Common.DTO.Thing thing)
        {
            ...
            return this.propertyValueMap[propertyName]((CDP4Common.DTO.ParameterOverrideValueSet)thing);
        }
        ...
        /// <summary>
        /// Instantiates a <see cref="CDP4Common.DTO.ParameterOverrideValueSet"/>
        /// </summary>
        /// <returns>
        ...
        {
            return new CDP4Common.DTO.ParameterOverrideValueSet(guid, revisionNumber);
        }
    }
}
