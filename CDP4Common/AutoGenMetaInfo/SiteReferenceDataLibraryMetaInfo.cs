// --------------------------------------------------------------------------------------------------------------------
// <copyright file="SiteReferenceDataLibraryMetaInfo.cs" company="Starion Group S.A.">
...
namespace CDP4Common.MetaInfo
{
    ...
    public partial class SiteReferenceDataLibraryMetaInfo : ISiteReferenceDataLibraryMetaInfo
    {
        ...
        public IEnumerable<Guid> GetContainmentIds(CDP4Common.DTO.Thing siteReferenceDataLibrary, string propertyName)
        {
            ...
            {
                throw new ArgumentException($"'{propertyName}' is not a valid containment property of 'SiteReferenceDataLibrary'");
            }
        ...
        {
            { "Actor", (siteReferenceDataLibrary, value) => siteReferenceDataLibrary.Actor = value == null ? (Guid?)null : (Guid)value },
            ...
            { "ThingPreference", (siteReferenceDataLibrary, value) => siteReferenceDataLibrary.ThingPreference = value == null ? (string)null : value.ToString() },
        };
        ...
        public object DeserializeCollectionValue(string propertyName, object value)
        {
            ...
            {
                throw new ArgumentException($"'{propertyName}' is not a valid collection property of 'SiteReferenceDataLibrary'");
            }
