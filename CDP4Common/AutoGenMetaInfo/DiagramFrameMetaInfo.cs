// --------------------------------------------------------------------------------------------------------------------
// <copyright file="DiagramFrameMetaInfo.cs" company="RHEA System S.A.">
...
namespace CDP4Common.MetaInfo
{
    ...
    /// <summary>
    /// This a class that holds meta info for <see cref="DiagramFrame"/>.
    /// </summary>
    public partial class DiagramFrameMetaInfo : IDiagramFrameMetaInfo
    {
        /// <summary>
        /// The containment property value map.
        /// </summary>
        private readonly Dictionary<string, Func<CDP4Common.DTO.DiagramFrame, IEnumerable<Guid>>> containmentPropertyValueMap = new Dictionary<string, Func<CDP4Common.DTO.DiagramFrame, IEnumerable<Guid>>>
        {
            { "Bounds", diagramFrame => diagramFrame.Bounds },
            { "DiagramElement", diagramFrame => diagramFrame.DiagramElement },
            { "LocalStyle", diagramFrame => diagramFrame.LocalStyle },
        };

        /// <summary>
        /// The ordered containment property value map.
        /// </summary>
        private readonly Dictionary<string, Func<CDP4Common.DTO.DiagramFrame, IEnumerable<OrderedItem>>> orderedContainmentPropertyValueMap = new Dictionary<string, Func<CDP4Common.DTO.DiagramFrame, IEnumerable<OrderedItem>>>();

        /// <summary>
        /// The validation rules that should pass for an instance of <see cref="CDP4Common.DTO.DiagramFrame"/>.
        /// </summary>
        private readonly Dictionary<string, DtoValidationHelper<CDP4Common.DTO.DiagramFrame>> validationRules = new Dictionary<string, DtoValidationHelper<CDP4Common.DTO.DiagramFrame>>
        {
            { "Bounds", new DtoValidationHelper<CDP4Common.DTO.DiagramFrame>(item => item.Bounds != null, "The 'Bounds' property of a 'DiagramFrame' is mandatory and cannot be null.") },
            { "DiagramElement", new DtoValidationHelper<CDP4Common.DTO.DiagramFrame>(item => item.DiagramElement != null, "The 'DiagramElement' property of a 'DiagramFrame' is mandatory and cannot be null.") },
            { "ExcludedDomain", new DtoValidationHelper<CDP4Common.DTO.DiagramFrame>(item => item.ExcludedDomain != null, "The 'ExcludedDomain' property of a 'DiagramFrame' is mandatory and cannot be null.") },
            { "ExcludedPerson", new DtoValidationHelper<CDP4Common.DTO.DiagramFrame>(item => item.ExcludedPerson != null, "The 'ExcludedPerson' property of a 'DiagramFrame' is mandatory and cannot be null.") },
            { "LocalStyle", new DtoValidationHelper<CDP4Common.DTO.DiagramFrame>(item => item.LocalStyle != null, "The 'LocalStyle' property of a 'DiagramFrame' is mandatory and cannot be null.") },
            { "Name", new DtoValidationHelper<CDP4Common.DTO.DiagramFrame>(item => !string.IsNullOrWhiteSpace(item.Name), "The 'Name' property of a 'DiagramFrame' is mandatory and cannot be empty or null.") },
        };
        ...
        /// </exception>
        public void Validate(CDP4Common.DTO.Thing diagramFrame)
        {
            this.Validate(diagramFrame, x => true);
        }
        ...
        /// If any validation rule failed.
        /// </exception>
        public void Validate(CDP4Common.DTO.Thing diagramFrame, Func<string, bool> validateProperty)
        {
            foreach (var applicableRule in this.validationRules.Where(x => validateProperty(x.Key)))
            {
                applicableRule.Value.Validate((CDP4Common.DTO.DiagramFrame)diagramFrame);
            }
        }
        ...
        /// </returns>
        public bool TryValidate(CDP4Common.DTO.Thing diagramFrame)
        {
            return this.TryValidate(diagramFrame, x => true);
        }
        ...
        /// True if all validation rules have passed or if none are defined.
        /// </returns>
        public bool TryValidate(CDP4Common.DTO.Thing diagramFrame, Func<string, bool> validateProperty)
        {
            var applicableValidationRules = this.validationRules.Where(x => validateProperty(x.Key)).Select(x => x.Value);

            return applicableValidationRules.All(applicableRule => applicableRule.TryValidate((CDP4Common.DTO.DiagramFrame)diagramFrame));
        }

        /// <summary>
        /// Returns the containment property value for the supplied <see cref="CDP4Common.DTO.DiagramFrame"/>.
        /// </summary>
        /// <param name="diagramFrame">
        /// The <see cref="CDP4Common.DTO.DiagramFrame"/> for which to return the containment property value.
        /// </param>
        ...
        /// If the property name is not supported for the <see cref="CDP4Common.DTO.DiagramFrame"/>.
        /// </exception>
        public IEnumerable<Guid> GetContainmentIds(CDP4Common.DTO.Thing diagramFrame, string propertyName)
        {
            if (!this.containmentPropertyValueMap.ContainsKey(propertyName))
            {
                throw new ArgumentException($"'{propertyName}' is not a valid containment property of 'DiagramFrame'");
            }

            return this.containmentPropertyValueMap[propertyName]((CDP4Common.DTO.DiagramFrame)diagramFrame);
        }

        /// <summary>
        /// Returns the ordered containment property value for the supplied <see cref="CDP4Common.DTO.DiagramFrame"/>.
        /// </summary>
        /// <param name="diagramFrame">
        /// The <see cref="CDP4Common.DTO.DiagramFrame"/> for which to return the containment property value.
        /// </param>
        ...
        /// If the property name is not supported for the <see cref="CDP4Common.DTO.DiagramFrame"/>.
        /// </exception>
        public IEnumerable<OrderedItem> GetOrderedContainmentIds(CDP4Common.DTO.Thing diagramFrame, string propertyName)
        {
            ...
            return this.orderedContainmentPropertyValueMap[propertyName]((CDP4Common.DTO.DiagramFrame)diagramFrame);
        }
        ...
        /// <summary>
        /// Gets the <see cref="PropertyMetaInfo"/> for the <see cref="DiagramFrame"/> class
        /// </summary>
        ...
        /// </summary>
        private readonly Dictionary<string, Func<CDP4Common.DTO.DiagramFrame, object>> propertyValueMap = new Dictionary<string, Func<CDP4Common.DTO.DiagramFrame, object>>
        {
        ...
        /// </summary>
        private readonly Dictionary<string, Action<CDP4Common.DTO.DiagramFrame, object>> propertyValueAssignmentMap = new Dictionary<string, Action<CDP4Common.DTO.DiagramFrame, object>>
        {
            { "Actor", (diagramFrame, value) => diagramFrame.Actor = value == null ? (Guid?)null : (Guid)value },
            { "DepictedThing", (diagramFrame, value) => diagramFrame.DepictedThing = value == null ? (Guid?)null : (Guid)value },
            { "Iid", (diagramFrame, value) => diagramFrame.Iid = (Guid)value },
            { "ModifiedOn", (diagramFrame, value) => diagramFrame.ModifiedOn = (DateTime)value },
            { "Name", (diagramFrame, value) => diagramFrame.Name = value.ToString() },
            { "SharedStyle", (diagramFrame, value) => diagramFrame.SharedStyle = value == null ? (Guid?)null : (Guid)value },
            { "ThingPreference", (diagramFrame, value) => diagramFrame.ThingPreference = value == null ? (string)null : value.ToString() },
        };
        ...
        /// <summary>
        /// Returns the <see cref="CDP4Common.DTO.DiagramFrame"/> containment property type from the supplied property name.
        /// </summary>
        /// <param name="propertyName">
        ...
        /// <summary>
        /// Returns the <see cref="CDP4Common.DTO.DiagramFrame"/> property type from the supplied property name.
        /// </summary>
        /// <param name="propertyName">
        /// The property name.
        /// </param>
        ...
        /// <summary>
        /// Returns the container property for the supplied type name is a possible container for <see cref="CDP4Common.DTO.DiagramFrame"/>.
        /// </summary>
        /// <param name="typeName">
        /// Name of the type for which to check if it is a container of <see cref="CDP4Common.DTO.DiagramFrame"/>.
        /// </param>
        /// <param name="containerProperty">
        /// Supplied container property info instance that will be set if the supplied type name is a container of <see cref="CDP4Common.DTO.DiagramFrame"/>.
        /// </param>
        /// <returns>
        /// True if the supplied typeName is a container for <see cref="CDP4Common.DTO.DiagramFrame"/> and sets the container property name.
        /// </returns>
        ...
        /// <summary>
        /// Check if the supplied property name for <see cref="CDP4Common.DTO.DiagramFrame"/> is scalar.
        /// </summary>
        /// <param name="propertyName">
        /// Name of the property for which to check if it is scalar.
        /// </param>
        ...
        public bool ApplyPropertyUpdate(CDP4Common.DTO.Thing updatableThing, string propertyName, object value)
        {
            ...
            this.propertyValueAssignmentMap[propertyName]((CDP4Common.DTO.DiagramFrame)updatableThing, value);
        ...
        public object DeserializeCollectionValue(string propertyName, object value)
        {
            ...
            {
                throw new ArgumentException($"'{propertyName}' is not a valid collection property of 'DiagramFrame'");
            }
        ...
        public object GetValue(string propertyName, CDP4Common.DTO.Thing thing)
        {
            ...
            return this.propertyValueMap[propertyName]((CDP4Common.DTO.DiagramFrame)thing);
        }
        ...
        /// <summary>
        /// Instantiates a <see cref="CDP4Common.DTO.DiagramFrame"/>
        /// </summary>
        /// <returns>
        ...
        {
            return new CDP4Common.DTO.DiagramFrame(guid, revisionNumber);
        }
    }
}
