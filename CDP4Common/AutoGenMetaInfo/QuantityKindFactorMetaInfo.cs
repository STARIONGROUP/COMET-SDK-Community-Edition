// --------------------------------------------------------------------------------------------------------------------
// <copyright file="QuantityKindFactorMetaInfo.cs" company="Starion Group S.A.">
...
namespace CDP4Common.MetaInfo
{
    ...
    public partial class QuantityKindFactorMetaInfo : IQuantityKindFactorMetaInfo
    {
        ...
        public IEnumerable<Guid> GetContainmentIds(CDP4Common.DTO.Thing quantityKindFactor, string propertyName)
        {
            ...
            {
                throw new ArgumentException($"'{propertyName}' is not a valid containment property of 'QuantityKindFactor'");
            }
        ...
        {
            { "Actor", (quantityKindFactor, value) => quantityKindFactor.Actor = value == null ? (Guid?)null : (Guid)value },
        ...
        {
            { "DerivedQuantityKind", new PropertyMetaInfo("QuantityKindFactor", "QuantityKindFactor", PropertyKind.OrderedList, AggregationKind.Composite, false, true, true, 1, "*", true) },
        };
        ...
        public object DeserializeCollectionValue(string propertyName, object value)
        {
            ...
            {
                throw new ArgumentException($"'{propertyName}' is not a valid collection property of 'QuantityKindFactor'");
            }
