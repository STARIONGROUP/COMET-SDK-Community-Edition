// --------------------------------------------------------------------------------------------------------------------
// <copyright file="QuantityKindFactorMetaInfo.cs" company="RHEA System S.A.">
...
namespace CDP4Common.MetaInfo
{
    ...
    /// <summary>
    /// This a class that holds meta info for <see cref="QuantityKindFactor"/>.
    /// </summary>
    public partial class QuantityKindFactorMetaInfo : IQuantityKindFactorMetaInfo
    {
        /// <summary>
        /// The containment property value map.
        /// </summary>
        private readonly Dictionary<string, Func<CDP4Common.DTO.QuantityKindFactor, IEnumerable<Guid>>> containmentPropertyValueMap = new Dictionary<string, Func<CDP4Common.DTO.QuantityKindFactor, IEnumerable<Guid>>>();

        /// <summary>
        /// The ordered containment property value map.
        /// </summary>
        private readonly Dictionary<string, Func<CDP4Common.DTO.QuantityKindFactor, IEnumerable<OrderedItem>>> orderedContainmentPropertyValueMap = new Dictionary<string, Func<CDP4Common.DTO.QuantityKindFactor, IEnumerable<OrderedItem>>>();

        /// <summary>
        /// The validation rules that should pass for an instance of <see cref="CDP4Common.DTO.QuantityKindFactor"/>.
        /// </summary>
        private readonly Dictionary<string, DtoValidationHelper<CDP4Common.DTO.QuantityKindFactor>> validationRules = new Dictionary<string, DtoValidationHelper<CDP4Common.DTO.QuantityKindFactor>>
        {
            { "ExcludedDomain", new DtoValidationHelper<CDP4Common.DTO.QuantityKindFactor>(item => item.ExcludedDomain != null, "The 'ExcludedDomain' property of a 'QuantityKindFactor' is mandatory and cannot be null.") },
            { "ExcludedPerson", new DtoValidationHelper<CDP4Common.DTO.QuantityKindFactor>(item => item.ExcludedPerson != null, "The 'ExcludedPerson' property of a 'QuantityKindFactor' is mandatory and cannot be null.") },
            { "Exponent", new DtoValidationHelper<CDP4Common.DTO.QuantityKindFactor>(item => !string.IsNullOrWhiteSpace(item.Exponent), "The 'Exponent' property of a 'QuantityKindFactor' is mandatory and cannot be empty or null.") },
        };
        ...
        /// </exception>
        public void Validate(CDP4Common.DTO.Thing quantityKindFactor)
        {
            this.Validate(quantityKindFactor, x => true);
        }
        ...
        /// If any validation rule failed.
        /// </exception>
        public void Validate(CDP4Common.DTO.Thing quantityKindFactor, Func<string, bool> validateProperty)
        {
            foreach (var applicableRule in this.validationRules.Where(x => validateProperty(x.Key)))
            {
                applicableRule.Value.Validate((CDP4Common.DTO.QuantityKindFactor)quantityKindFactor);
            }
        }
        ...
        /// </returns>
        public bool TryValidate(CDP4Common.DTO.Thing quantityKindFactor)
        {
            return this.TryValidate(quantityKindFactor, x => true);
        }
        ...
        /// True if all validation rules have passed or if none are defined.
        /// </returns>
        public bool TryValidate(CDP4Common.DTO.Thing quantityKindFactor, Func<string, bool> validateProperty)
        {
            var applicableValidationRules = this.validationRules.Where(x => validateProperty(x.Key)).Select(x => x.Value);

            return applicableValidationRules.All(applicableRule => applicableRule.TryValidate((CDP4Common.DTO.QuantityKindFactor)quantityKindFactor));
        }

        /// <summary>
        /// Returns the containment property value for the supplied <see cref="CDP4Common.DTO.QuantityKindFactor"/>.
        /// </summary>
        /// <param name="quantityKindFactor">
        /// The <see cref="CDP4Common.DTO.QuantityKindFactor"/> for which to return the containment property value.
        /// </param>
        ...
        /// If the property name is not supported for the <see cref="CDP4Common.DTO.QuantityKindFactor"/>.
        /// </exception>
        public IEnumerable<Guid> GetContainmentIds(CDP4Common.DTO.Thing quantityKindFactor, string propertyName)
        {
            if (!this.containmentPropertyValueMap.ContainsKey(propertyName))
            {
                throw new ArgumentException(string.Format("'{0}' is not a valid containment property of 'QuantityKindFactor'", propertyName));
            }

            return this.containmentPropertyValueMap[propertyName]((CDP4Common.DTO.QuantityKindFactor)quantityKindFactor);
        }

        /// <summary>
        /// Returns the ordered containment property value for the supplied <see cref="CDP4Common.DTO.QuantityKindFactor"/>.
        /// </summary>
        /// <param name="quantityKindFactor">
        /// The <see cref="CDP4Common.DTO.QuantityKindFactor"/> for which to return the containment property value.
        /// </param>
        ...
        /// If the property name is not supported for the <see cref="CDP4Common.DTO.QuantityKindFactor"/>.
        /// </exception>
        public IEnumerable<OrderedItem> GetOrderedContainmentIds(CDP4Common.DTO.Thing quantityKindFactor, string propertyName)
        {
            ...
            return this.orderedContainmentPropertyValueMap[propertyName]((CDP4Common.DTO.QuantityKindFactor)quantityKindFactor);
        }
        ...
        /// <summary>
        /// Gets the <see cref="PropertyMetaInfo"/> for the <see cref="QuantityKindFactor"/> class
        /// </summary>
        ...
        /// </summary>
        private readonly Dictionary<string, Func<CDP4Common.DTO.QuantityKindFactor, object>> propertyValueMap = new Dictionary<string, Func<CDP4Common.DTO.QuantityKindFactor, object>>
        {
        ...
        private readonly Dictionary<string, PropertyMetaInfo> propertyTypeMap = new Dictionary<string, PropertyMetaInfo>
        {
            ...
            { "QuantityKind", new PropertyMetaInfo("QuantityKind", "Guid", PropertyKind.Scalar, AggregationKind.None, false, false, true, 1, "1", true) },
        ...
        /// </summary>
        private readonly Dictionary<string, Action<CDP4Common.DTO.QuantityKindFactor, object>> propertyValueAssignmentMap = new Dictionary<string, Action<CDP4Common.DTO.QuantityKindFactor, object>>
        {
            { "Exponent", (quantityKindFactor, value) => quantityKindFactor.Exponent = value.ToString() },
        ...
        {
            { "DerivedQuantityKind", new PropertyMetaInfo("QuantityKindFactor", "Guid", PropertyKind.OrderedList, AggregationKind.Composite, false, true, true, 1, "*", true) },
        };
        ...
        /// <summary>
        /// Returns the <see cref="CDP4Common.DTO.QuantityKindFactor"/> containment property type from the supplied property name.
        /// </summary>
        /// <param name="propertyName">
        ...
        /// <summary>
        /// Returns the <see cref="CDP4Common.DTO.QuantityKindFactor"/> property type from the supplied property name.
        /// </summary>
        /// <param name="propertyName">
        /// The property name.
        /// </param>
        ...
        /// <summary>
        /// Returns the container property for the supplied type name is a possible container for <see cref="CDP4Common.DTO.QuantityKindFactor"/>.
        /// </summary>
        /// <param name="typeName">
        /// Name of the type for which to check if it is a container of <see cref="CDP4Common.DTO.QuantityKindFactor"/>.
        /// </param>
        /// <param name="containerProperty">
        /// Supplied container property info instance that will be set if the supplied type name is a container of <see cref="CDP4Common.DTO.QuantityKindFactor"/>.
        /// </param>
        /// <returns>
        /// True if the supplied typeName is a container for <see cref="CDP4Common.DTO.QuantityKindFactor"/> and sets the container property name.
        /// </returns>
        ...
        /// <summary>
        /// Check if the supplied property name for <see cref="CDP4Common.DTO.QuantityKindFactor"/> is scalar.
        /// </summary>
        /// <param name="propertyName">
        /// Name of the property for which to check if it is scalar.
        /// </param>
        ...
        public bool ApplyPropertyUpdate(CDP4Common.DTO.Thing updatableThing, string propertyName, object value)
        {
            ...
            this.propertyValueAssignmentMap[propertyName]((CDP4Common.DTO.QuantityKindFactor)updatableThing, value);
        ...
        public object DeserializeCollectionValue(string propertyName, object value)
        {
            ...
            {
                throw new ArgumentException(string.Format("'{0}' is not a valid collection property of 'QuantityKindFactor'", propertyName));
            }
        ...
        public object GetValue(string propertyName, CDP4Common.DTO.Thing thing)
        {
            ...
            return this.propertyValueMap[propertyName]((CDP4Common.DTO.QuantityKindFactor)thing);
        }
        ...
        /// <summary>
        /// Instantiates a <see cref="CDP4Common.DTO.QuantityKindFactor"/>
        /// </summary>
        /// <returns>
        ...
        {
            return new CDP4Common.DTO.QuantityKindFactor(guid, revisionNumber);
        }
    }
}
