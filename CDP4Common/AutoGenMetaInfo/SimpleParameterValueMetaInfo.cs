// --------------------------------------------------------------------------------------------------------------------
// <copyright file="SimpleParameterValueMetaInfo.cs" company="RHEA System S.A.">
...
namespace CDP4Common.MetaInfo
{
    ...
    /// <summary>
    /// This a class that holds meta info for <see cref="SimpleParameterValue"/>.
    /// </summary>
    public partial class SimpleParameterValueMetaInfo : ISimpleParameterValueMetaInfo
    {
        /// <summary>
        /// The containment property value map.
        /// </summary>
        private readonly Dictionary<string, Func<CDP4Common.DTO.SimpleParameterValue, IEnumerable<Guid>>> containmentPropertyValueMap = new Dictionary<string, Func<CDP4Common.DTO.SimpleParameterValue, IEnumerable<Guid>>>();

        /// <summary>
        /// The ordered containment property value map.
        /// </summary>
        private readonly Dictionary<string, Func<CDP4Common.DTO.SimpleParameterValue, IEnumerable<OrderedItem>>> orderedContainmentPropertyValueMap = new Dictionary<string, Func<CDP4Common.DTO.SimpleParameterValue, IEnumerable<OrderedItem>>>();

        /// <summary>
        /// The validation rules that should pass for an instance of <see cref="CDP4Common.DTO.SimpleParameterValue"/>.
        /// </summary>
        private readonly Dictionary<string, DtoValidationHelper<CDP4Common.DTO.SimpleParameterValue>> validationRules = new Dictionary<string, DtoValidationHelper<CDP4Common.DTO.SimpleParameterValue>>
        {
            { "ExcludedDomain", new DtoValidationHelper<CDP4Common.DTO.SimpleParameterValue>(item => item.ExcludedDomain != null, "The 'ExcludedDomain' property of a 'SimpleParameterValue' is mandatory and cannot be null.") },
            { "ExcludedPerson", new DtoValidationHelper<CDP4Common.DTO.SimpleParameterValue>(item => item.ExcludedPerson != null, "The 'ExcludedPerson' property of a 'SimpleParameterValue' is mandatory and cannot be null.") },
            { "Value", new DtoValidationHelper<CDP4Common.DTO.SimpleParameterValue>(item => item.Value != null && item.Value.Any(), "The 'Value' property of a 'SimpleParameterValue' is mandatory and must have at least one entry.") },
        };
        ...
        /// </exception>
        public void Validate(CDP4Common.DTO.Thing simpleParameterValue)
        {
            this.Validate(simpleParameterValue, x => true);
        }
        ...
        /// If any validation rule failed.
        /// </exception>
        public void Validate(CDP4Common.DTO.Thing simpleParameterValue, Func<string, bool> validateProperty)
        {
            foreach (var applicableRule in this.validationRules.Where(x => validateProperty(x.Key)))
            {
                applicableRule.Value.Validate((CDP4Common.DTO.SimpleParameterValue)simpleParameterValue);
            }
        }
        ...
        /// </returns>
        public bool TryValidate(CDP4Common.DTO.Thing simpleParameterValue)
        {
            return this.TryValidate(simpleParameterValue, x => true);
        }
        ...
        /// True if all validation rules have passed or if none are defined.
        /// </returns>
        public bool TryValidate(CDP4Common.DTO.Thing simpleParameterValue, Func<string, bool> validateProperty)
        {
            var applicableValidationRules = this.validationRules.Where(x => validateProperty(x.Key)).Select(x => x.Value);

            return applicableValidationRules.All(applicableRule => applicableRule.TryValidate((CDP4Common.DTO.SimpleParameterValue)simpleParameterValue));
        }

        /// <summary>
        /// Returns the containment property value for the supplied <see cref="CDP4Common.DTO.SimpleParameterValue"/>.
        /// </summary>
        /// <param name="simpleParameterValue">
        /// The <see cref="CDP4Common.DTO.SimpleParameterValue"/> for which to return the containment property value.
        /// </param>
        ...
        /// If the property name is not supported for the <see cref="CDP4Common.DTO.SimpleParameterValue"/>.
        /// </exception>
        public IEnumerable<Guid> GetContainmentIds(CDP4Common.DTO.Thing simpleParameterValue, string propertyName)
        {
            if (!this.containmentPropertyValueMap.ContainsKey(propertyName))
            {
                throw new ArgumentException(string.Format("'{0}' is not a valid containment property of 'SimpleParameterValue'", propertyName));
            }

            return this.containmentPropertyValueMap[propertyName]((CDP4Common.DTO.SimpleParameterValue)simpleParameterValue);
        }

        /// <summary>
        /// Returns the ordered containment property value for the supplied <see cref="CDP4Common.DTO.SimpleParameterValue"/>.
        /// </summary>
        /// <param name="simpleParameterValue">
        /// The <see cref="CDP4Common.DTO.SimpleParameterValue"/> for which to return the containment property value.
        /// </param>
        ...
        /// If the property name is not supported for the <see cref="CDP4Common.DTO.SimpleParameterValue"/>.
        /// </exception>
        public IEnumerable<OrderedItem> GetOrderedContainmentIds(CDP4Common.DTO.Thing simpleParameterValue, string propertyName)
        {
            ...
            return this.orderedContainmentPropertyValueMap[propertyName]((CDP4Common.DTO.SimpleParameterValue)simpleParameterValue);
        }
        ...
        /// <summary>
        /// Gets the <see cref="PropertyMetaInfo"/> for the <see cref="SimpleParameterValue"/> class
        /// </summary>
        ...
        /// </summary>
        private readonly Dictionary<string, Func<CDP4Common.DTO.SimpleParameterValue, object>> propertyValueMap = new Dictionary<string, Func<CDP4Common.DTO.SimpleParameterValue, object>>
        {
        ...
        /// </summary>
        private readonly Dictionary<string, Action<CDP4Common.DTO.SimpleParameterValue, object>> propertyValueAssignmentMap = new Dictionary<string, Action<CDP4Common.DTO.SimpleParameterValue, object>>
        {
            { "Iid", (simpleParameterValue, value) => simpleParameterValue.Iid = (Guid)value },
            { "ModifiedOn", (simpleParameterValue, value) => simpleParameterValue.ModifiedOn = (DateTime)value },
            { "ParameterType", (simpleParameterValue, value) => simpleParameterValue.ParameterType = (Guid)value },
            { "Scale", (simpleParameterValue, value) => simpleParameterValue.Scale = value == null ? (Guid?)null : (Guid)value },
            { "Value", (simpleParameterValue, value) => simpleParameterValue.Value = (ValueArray<string>)value },
        };
        ...
        {
            { "Requirement", new PropertyMetaInfo("ParameterValue", "Guid", PropertyKind.List, AggregationKind.Composite, false, false, true, 0, "*", true) },
        };
        ...
        /// <summary>
        /// Returns the <see cref="CDP4Common.DTO.SimpleParameterValue"/> containment property type from the supplied property name.
        /// </summary>
        /// <param name="propertyName">
        ...
        /// <summary>
        /// Returns the <see cref="CDP4Common.DTO.SimpleParameterValue"/> property type from the supplied property name.
        /// </summary>
        /// <param name="propertyName">
        /// The property name.
        /// </param>
        ...
        /// <summary>
        /// Returns the container property for the supplied type name is a possible container for <see cref="CDP4Common.DTO.SimpleParameterValue"/>.
        /// </summary>
        /// <param name="typeName">
        /// Name of the type for which to check if it is a container of <see cref="CDP4Common.DTO.SimpleParameterValue"/>.
        /// </param>
        /// <param name="containerProperty">
        /// Supplied container property info instance that will be set if the supplied type name is a container of <see cref="CDP4Common.DTO.SimpleParameterValue"/>.
        /// </param>
        /// <returns>
        /// True if the supplied typeName is a container for <see cref="CDP4Common.DTO.SimpleParameterValue"/> and sets the container property name.
        /// </returns>
        ...
        /// <summary>
        /// Check if the supplied property name for <see cref="CDP4Common.DTO.SimpleParameterValue"/> is scalar.
        /// </summary>
        /// <param name="propertyName">
        /// Name of the property for which to check if it is scalar.
        /// </param>
        ...
        public bool ApplyPropertyUpdate(CDP4Common.DTO.Thing updatableThing, string propertyName, object value)
        {
            ...
            this.propertyValueAssignmentMap[propertyName]((CDP4Common.DTO.SimpleParameterValue)updatableThing, value);
        ...
        public object DeserializeCollectionValue(string propertyName, object value)
        {
            ...
            {
                throw new ArgumentException(string.Format("'{0}' is not a valid collection property of 'SimpleParameterValue'", propertyName));
            }
        ...
        public object GetValue(string propertyName, CDP4Common.DTO.Thing thing)
        {
            ...
            return this.propertyValueMap[propertyName]((CDP4Common.DTO.SimpleParameterValue)thing);
        }
        ...
        /// <summary>
        /// Instantiates a <see cref="CDP4Common.DTO.SimpleParameterValue"/>
        /// </summary>
        /// <returns>
        ...
        {
            return new CDP4Common.DTO.SimpleParameterValue(guid, revisionNumber);
        }
    }
}
