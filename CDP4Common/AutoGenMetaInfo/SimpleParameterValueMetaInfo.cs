// --------------------------------------------------------------------------------------------------------------------
// <copyright file="SimpleParameterValueMetaInfo.cs" company="Starion Group S.A.">
...
namespace CDP4Common.MetaInfo
{
    ...
    public partial class SimpleParameterValueMetaInfo : ISimpleParameterValueMetaInfo
    {
        ...
        public IEnumerable<Guid> GetContainmentIds(CDP4Common.DTO.Thing simpleParameterValue, string propertyName)
        {
            ...
            {
                throw new ArgumentException($"'{propertyName}' is not a valid containment property of 'SimpleParameterValue'");
            }
        ...
        {
            { "Actor", (simpleParameterValue, value) => simpleParameterValue.Actor = value == null ? (Guid?)null : (Guid)value },
            ...
            { "ThingPreference", (simpleParameterValue, value) => simpleParameterValue.ThingPreference = value == null ? (string)null : value.ToString() },
        ...
        {
            { "Requirement", new PropertyMetaInfo("ParameterValue", "SimpleParameterValue", PropertyKind.List, AggregationKind.Composite, false, false, true, 0, "*", true) },
        };
        ...
        public object DeserializeCollectionValue(string propertyName, object value)
        {
            ...
            {
                throw new ArgumentException($"'{propertyName}' is not a valid collection property of 'SimpleParameterValue'");
            }
