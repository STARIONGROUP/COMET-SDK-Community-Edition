// --------------------------------------------------------------------------------------------------------------------
// <copyright file="LogEntryChangelogItemMetaInfo.cs" company="RHEA System S.A.">
...
namespace CDP4Common.MetaInfo
{
    ...
    /// <summary>
    /// This a class that holds meta info for <see cref="LogEntryChangelogItem"/>.
    /// </summary>
    public partial class LogEntryChangelogItemMetaInfo : ILogEntryChangelogItemMetaInfo
    {
        /// <summary>
        /// The containment property value map.
        /// </summary>
        private readonly Dictionary<string, Func<CDP4Common.DTO.LogEntryChangelogItem, IEnumerable<Guid>>> containmentPropertyValueMap = new Dictionary<string, Func<CDP4Common.DTO.LogEntryChangelogItem, IEnumerable<Guid>>>();

        /// <summary>
        /// The ordered containment property value map.
        /// </summary>
        private readonly Dictionary<string, Func<CDP4Common.DTO.LogEntryChangelogItem, IEnumerable<OrderedItem>>> orderedContainmentPropertyValueMap = new Dictionary<string, Func<CDP4Common.DTO.LogEntryChangelogItem, IEnumerable<OrderedItem>>>();

        /// <summary>
        /// The validation rules that should pass for an instance of <see cref="CDP4Common.DTO.LogEntryChangelogItem"/>.
        /// </summary>
        private readonly Dictionary<string, DtoValidationHelper<CDP4Common.DTO.LogEntryChangelogItem>> validationRules = new Dictionary<string, DtoValidationHelper<CDP4Common.DTO.LogEntryChangelogItem>>
        {
            { "AffectedReferenceIid", new DtoValidationHelper<CDP4Common.DTO.LogEntryChangelogItem>(item => item.AffectedReferenceIid != null, "The 'AffectedReferenceIid' property of a 'LogEntryChangelogItem' is mandatory and cannot be null.") },
            { "ExcludedDomain", new DtoValidationHelper<CDP4Common.DTO.LogEntryChangelogItem>(item => item.ExcludedDomain != null, "The 'ExcludedDomain' property of a 'LogEntryChangelogItem' is mandatory and cannot be null.") },
            { "ExcludedPerson", new DtoValidationHelper<CDP4Common.DTO.LogEntryChangelogItem>(item => item.ExcludedPerson != null, "The 'ExcludedPerson' property of a 'LogEntryChangelogItem' is mandatory and cannot be null.") },
        };
        ...
        /// </exception>
        public void Validate(CDP4Common.DTO.Thing logEntryChangelogItem)
        {
            this.Validate(logEntryChangelogItem, x => true);
        }
        ...
        /// If any validation rule failed.
        /// </exception>
        public void Validate(CDP4Common.DTO.Thing logEntryChangelogItem, Func<string, bool> validateProperty)
        {
            foreach (var applicableRule in this.validationRules.Where(x => validateProperty(x.Key)))
            {
                applicableRule.Value.Validate((CDP4Common.DTO.LogEntryChangelogItem)logEntryChangelogItem);
            }
        }
        ...
        /// </returns>
        public bool TryValidate(CDP4Common.DTO.Thing logEntryChangelogItem)
        {
            return this.TryValidate(logEntryChangelogItem, x => true);
        }
        ...
        /// True if all validation rules have passed or if none are defined.
        /// </returns>
        public bool TryValidate(CDP4Common.DTO.Thing logEntryChangelogItem, Func<string, bool> validateProperty)
        {
            var applicableValidationRules = this.validationRules.Where(x => validateProperty(x.Key)).Select(x => x.Value);

            return applicableValidationRules.All(applicableRule => applicableRule.TryValidate((CDP4Common.DTO.LogEntryChangelogItem)logEntryChangelogItem));
        }

        /// <summary>
        /// Returns the containment property value for the supplied <see cref="CDP4Common.DTO.LogEntryChangelogItem"/>.
        /// </summary>
        /// <param name="logEntryChangelogItem">
        /// The <see cref="CDP4Common.DTO.LogEntryChangelogItem"/> for which to return the containment property value.
        /// </param>
        ...
        /// If the property name is not supported for the <see cref="CDP4Common.DTO.LogEntryChangelogItem"/>.
        /// </exception>
        public IEnumerable<Guid> GetContainmentIds(CDP4Common.DTO.Thing logEntryChangelogItem, string propertyName)
        {
            if (!this.containmentPropertyValueMap.ContainsKey(propertyName))
            {
                throw new ArgumentException(string.Format("'{0}' is not a valid containment property of 'LogEntryChangelogItem'", propertyName));
            }

            return this.containmentPropertyValueMap[propertyName]((CDP4Common.DTO.LogEntryChangelogItem)logEntryChangelogItem);
        }

        /// <summary>
        /// Returns the ordered containment property value for the supplied <see cref="CDP4Common.DTO.LogEntryChangelogItem"/>.
        /// </summary>
        /// <param name="logEntryChangelogItem">
        /// The <see cref="CDP4Common.DTO.LogEntryChangelogItem"/> for which to return the containment property value.
        /// </param>
        ...
        /// If the property name is not supported for the <see cref="CDP4Common.DTO.LogEntryChangelogItem"/>.
        /// </exception>
        public IEnumerable<OrderedItem> GetOrderedContainmentIds(CDP4Common.DTO.Thing logEntryChangelogItem, string propertyName)
        {
            ...
            return this.orderedContainmentPropertyValueMap[propertyName]((CDP4Common.DTO.LogEntryChangelogItem)logEntryChangelogItem);
        }
        ...
        /// <summary>
        /// Gets the <see cref="PropertyMetaInfo"/> for the <see cref="LogEntryChangelogItem"/> class
        /// </summary>
        ...
        private readonly Dictionary<string, Func<CDP4Common.DTO.LogEntryChangelogItem, object>> propertyValueMap = new Dictionary<string, Func<CDP4Common.DTO.LogEntryChangelogItem, object>>
        {
            ...
            { "ChangelogKind", thing => thing.ChangelogKind },
        ...
        private readonly Dictionary<string, PropertyMetaInfo> propertyTypeMap = new Dictionary<string, PropertyMetaInfo>
        {
            ...
            { "ChangelogKind", new PropertyMetaInfo("ChangelogKind", "CDP4Common.CommonData.LogEntryChangelogItemKind", PropertyKind.Scalar, AggregationKind.None, false, false, true, 1, "1", true) },
        ...
        {
            { "AffectedReferenceIid", (value) => (Guid)value },
        ...
        private readonly Dictionary<string, Action<CDP4Common.DTO.LogEntryChangelogItem, object>> propertyValueAssignmentMap = new Dictionary<string, Action<CDP4Common.DTO.LogEntryChangelogItem, object>>
        {
            ...
            { "Iid", (logEntryChangelogItem, value) => logEntryChangelogItem.Iid = (Guid)value },
            { "ModifiedOn", (logEntryChangelogItem, value) => logEntryChangelogItem.ModifiedOn = (DateTime)value },
            { "ThingPreference", (logEntryChangelogItem, value) => logEntryChangelogItem.ThingPreference = value == null ? (string)null : value.ToString() },
        };
        ...
        {
            { "ModelLogEntry", new PropertyMetaInfo("LogEntryChangelogItem", "LogEntryChangelogItem", PropertyKind.List, AggregationKind.Composite, false, false, true, 0, "*", true) },
            { "SiteLogEntry", new PropertyMetaInfo("LogEntryChangelogItem", "LogEntryChangelogItem", PropertyKind.List, AggregationKind.Composite, false, false, true, 0, "*", true) },
        };
        ...
        /// <summary>
        /// Returns the <see cref="CDP4Common.DTO.LogEntryChangelogItem"/> containment property type from the supplied property name.
        /// </summary>
        /// <param name="propertyName">
        ...
        /// <summary>
        /// Returns the <see cref="CDP4Common.DTO.LogEntryChangelogItem"/> property type from the supplied property name.
        /// </summary>
        /// <param name="propertyName">
        /// The property name.
        /// </param>
        ...
        /// <summary>
        /// Returns the container property for the supplied type name is a possible container for <see cref="CDP4Common.DTO.LogEntryChangelogItem"/>.
        /// </summary>
        /// <param name="typeName">
        /// Name of the type for which to check if it is a container of <see cref="CDP4Common.DTO.LogEntryChangelogItem"/>.
        /// </param>
        /// <param name="containerProperty">
        /// Supplied container property info instance that will be set if the supplied type name is a container of <see cref="CDP4Common.DTO.LogEntryChangelogItem"/>.
        /// </param>
        /// <returns>
        /// True if the supplied typeName is a container for <see cref="CDP4Common.DTO.LogEntryChangelogItem"/> and sets the container property name.
        /// </returns>
        ...
        /// <summary>
        /// Check if the supplied property name for <see cref="CDP4Common.DTO.LogEntryChangelogItem"/> is scalar.
        /// </summary>
        /// <param name="propertyName">
        /// Name of the property for which to check if it is scalar.
        /// </param>
        ...
        public object DeserializeCollectionValue(string propertyName, object value)
        {
            ...
            {
                throw new ArgumentException(string.Format("'{0}' is not a valid collection property of 'LogEntryChangelogItem'", propertyName));
            }
        ...
        public object GetValue(string propertyName, CDP4Common.DTO.Thing thing)
        {
            ...
            return this.propertyValueMap[propertyName]((CDP4Common.DTO.LogEntryChangelogItem)thing);
        }
        ...
        /// <summary>
        /// Instantiates a <see cref="CDP4Common.DTO.LogEntryChangelogItem"/>
        /// </summary>
        /// <returns>
        ...
        {
            return new CDP4Common.DTO.LogEntryChangelogItem(guid, revisionNumber);
        }
    }
}
