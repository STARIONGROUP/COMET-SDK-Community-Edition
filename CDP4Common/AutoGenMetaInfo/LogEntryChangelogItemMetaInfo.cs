// --------------------------------------------------------------------------------------------------------------------
// <copyright file="LogEntryChangelogItemMetaInfo.cs" company="Starion Group S.A.">
...
namespace CDP4Common.MetaInfo
{
    ...
    public partial class LogEntryChangelogItemMetaInfo : ILogEntryChangelogItemMetaInfo
    {
        ...
        public IEnumerable<Guid> GetContainmentIds(CDP4Common.DTO.Thing logEntryChangelogItem, string propertyName)
        {
            ...
            {
                throw new ArgumentException($"'{propertyName}' is not a valid containment property of 'LogEntryChangelogItem'");
            }
        ...
        public object DeserializeCollectionValue(string propertyName, object value)
        {
            ...
            {
                throw new ArgumentException($"'{propertyName}' is not a valid collection property of 'LogEntryChangelogItem'");
            }
