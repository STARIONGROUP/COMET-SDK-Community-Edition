// --------------------------------------------------------------------------------------------------------------------
// <copyright file="ParameterValueSetMetaInfo.cs" company="RHEA System S.A.">
...
namespace CDP4Common.MetaInfo
{
    ...
    public partial class ParameterValueSetMetaInfo : IParameterValueSetMetaInfo
    {
        ...
        public IEnumerable<Guid> GetContainmentIds(CDP4Common.DTO.Thing parameterValueSet, string propertyName)
        {
            ...
            {
                throw new ArgumentException(string.Format("'{0}' is not a valid containment property of 'ParameterValueSet'", propertyName));
            }
        ...
        {
            { "Parameter", new PropertyMetaInfo("ValueSet", "Guid", PropertyKind.List, AggregationKind.Composite, false, false, true, 1, "*", true) },
        };
        ...
        public object DeserializeCollectionValue(string propertyName, object value)
        {
            ...
            {
                throw new ArgumentException(string.Format("'{0}' is not a valid collection property of 'ParameterValueSet'", propertyName));
            }
