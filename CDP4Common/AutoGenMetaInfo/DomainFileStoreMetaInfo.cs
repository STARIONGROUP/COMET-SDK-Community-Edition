// --------------------------------------------------------------------------------------------------------------------
// <copyright file="DomainFileStoreMetaInfo.cs" company="Starion Group S.A.">
...
namespace CDP4Common.MetaInfo
{
    ...
    /// <summary>
    /// This a class that holds meta info for <see cref="DomainFileStore"/>.
    /// </summary>
    public partial class DomainFileStoreMetaInfo : IDomainFileStoreMetaInfo
    {
        /// <summary>
        /// The containment property value map.
        /// </summary>
        private readonly Dictionary<string, Func<CDP4Common.DTO.DomainFileStore, IEnumerable<Guid>>> containmentPropertyValueMap = new Dictionary<string, Func<CDP4Common.DTO.DomainFileStore, IEnumerable<Guid>>>
        {
            { "File", domainFileStore => domainFileStore.File },
            { "Folder", domainFileStore => domainFileStore.Folder },
        };

        /// <summary>
        /// The ordered containment property value map.
        /// </summary>
        private readonly Dictionary<string, Func<CDP4Common.DTO.DomainFileStore, IEnumerable<OrderedItem>>> orderedContainmentPropertyValueMap = new Dictionary<string, Func<CDP4Common.DTO.DomainFileStore, IEnumerable<OrderedItem>>>();

        /// <summary>
        /// The validation rules that should pass for an instance of <see cref="CDP4Common.DTO.DomainFileStore"/>.
        /// </summary>
        private readonly Dictionary<string, DtoValidationHelper<CDP4Common.DTO.DomainFileStore>> validationRules = new Dictionary<string, DtoValidationHelper<CDP4Common.DTO.DomainFileStore>>
        {
            { "ExcludedDomain", new DtoValidationHelper<CDP4Common.DTO.DomainFileStore>(item => item.ExcludedDomain != null, "The 'ExcludedDomain' property of a 'DomainFileStore' is mandatory and cannot be null.") },
            { "ExcludedPerson", new DtoValidationHelper<CDP4Common.DTO.DomainFileStore>(item => item.ExcludedPerson != null, "The 'ExcludedPerson' property of a 'DomainFileStore' is mandatory and cannot be null.") },
            { "File", new DtoValidationHelper<CDP4Common.DTO.DomainFileStore>(item => item.File != null, "The 'File' property of a 'DomainFileStore' is mandatory and cannot be null.") },
            { "Folder", new DtoValidationHelper<CDP4Common.DTO.DomainFileStore>(item => item.Folder != null, "The 'Folder' property of a 'DomainFileStore' is mandatory and cannot be null.") },
            { "Name", new DtoValidationHelper<CDP4Common.DTO.DomainFileStore>(item => !string.IsNullOrWhiteSpace(item.Name), "The 'Name' property of a 'DomainFileStore' is mandatory and cannot be empty or null.") },
        };
        ...
        /// </exception>
        public void Validate(CDP4Common.DTO.Thing domainFileStore)
        {
            this.Validate(domainFileStore, x => true);
        }
        ...
        /// If any validation rule failed.
        /// </exception>
        public void Validate(CDP4Common.DTO.Thing domainFileStore, Func<string, bool> validateProperty)
        {
            foreach (var applicableRule in this.validationRules.Where(x => validateProperty(x.Key)))
            {
                applicableRule.Value.Validate((CDP4Common.DTO.DomainFileStore)domainFileStore);
            }
        }
        ...
        /// </returns>
        public bool TryValidate(CDP4Common.DTO.Thing domainFileStore)
        {
            return this.TryValidate(domainFileStore, x => true);
        }
        ...
        /// True if all validation rules have passed or if none are defined.
        /// </returns>
        public bool TryValidate(CDP4Common.DTO.Thing domainFileStore, Func<string, bool> validateProperty)
        {
            var applicableValidationRules = this.validationRules.Where(x => validateProperty(x.Key)).Select(x => x.Value);

            return applicableValidationRules.All(applicableRule => applicableRule.TryValidate((CDP4Common.DTO.DomainFileStore)domainFileStore));
        }

        /// <summary>
        /// Returns the containment property value for the supplied <see cref="CDP4Common.DTO.DomainFileStore"/>.
        /// </summary>
        /// <param name="domainFileStore">
        /// The <see cref="CDP4Common.DTO.DomainFileStore"/> for which to return the containment property value.
        /// </param>
        ...
        /// If the property name is not supported for the <see cref="CDP4Common.DTO.DomainFileStore"/>.
        /// </exception>
        public IEnumerable<Guid> GetContainmentIds(CDP4Common.DTO.Thing domainFileStore, string propertyName)
        {
        ...
        /// <summary>
        /// Returns the ordered containment property value for the supplied <see cref="CDP4Common.DTO.DomainFileStore"/>.
        /// </summary>
        /// <param name="domainFileStore">
        /// The <see cref="CDP4Common.DTO.DomainFileStore"/> for which to return the containment property value.
        /// </param>
        ...
        /// If the property name is not supported for the <see cref="CDP4Common.DTO.DomainFileStore"/>.
        /// </exception>
        public IEnumerable<OrderedItem> GetOrderedContainmentIds(CDP4Common.DTO.Thing domainFileStore, string propertyName)
        {
        ...
        /// <summary>
        /// Gets the <see cref="PropertyMetaInfo"/> for the <see cref="DomainFileStore"/> class
        /// </summary>
        ...
        /// </summary>
        private readonly Dictionary<string, Func<CDP4Common.DTO.DomainFileStore, object>> propertyValueMap = new Dictionary<string, Func<CDP4Common.DTO.DomainFileStore, object>>
        {
        ...
        /// </summary>
        private readonly Dictionary<string, Action<CDP4Common.DTO.DomainFileStore, object>> propertyValueAssignmentMap = new Dictionary<string, Action<CDP4Common.DTO.DomainFileStore, object>>
        {
            { "Actor", (domainFileStore, value) => domainFileStore.Actor = value == null ? (Guid?)null : (Guid)value },
            { "CreatedOn", (domainFileStore, value) => domainFileStore.CreatedOn = (DateTime)value },
            { "Iid", (domainFileStore, value) => domainFileStore.Iid = (Guid)value },
            { "IsHidden", (domainFileStore, value) => domainFileStore.IsHidden = (bool)value },
            { "ModifiedOn", (domainFileStore, value) => domainFileStore.ModifiedOn = (DateTime)value },
            { "Name", (domainFileStore, value) => domainFileStore.Name = value.ToString() },
            { "Owner", (domainFileStore, value) => domainFileStore.Owner = (Guid)value },
            { "ThingPreference", (domainFileStore, value) => domainFileStore.ThingPreference = value == null ? (string)null : value.ToString() },
        };
        ...
        {
            { "Iteration", new PropertyMetaInfo("DomainFileStore", "DomainFileStore", PropertyKind.List, AggregationKind.Composite, false, false, true, 0, "*", true) },
        };
        ...
        /// <summary>
        /// Returns the <see cref="CDP4Common.DTO.DomainFileStore"/> containment property type from the supplied property name.
        /// </summary>
        /// <param name="propertyName">
        ...
        /// <summary>
        /// Returns the <see cref="CDP4Common.DTO.DomainFileStore"/> property type from the supplied property name.
        /// </summary>
        /// <param name="propertyName">
        /// The property name.
        /// </param>
        ...
        /// <summary>
        /// Returns the container property for the supplied type name is a possible container for <see cref="CDP4Common.DTO.DomainFileStore"/>.
        /// </summary>
        /// <param name="typeName">
        /// Name of the type for which to check if it is a container of <see cref="CDP4Common.DTO.DomainFileStore"/>.
        /// </param>
        /// <param name="containerProperty">
        /// Supplied container property info instance that will be set if the supplied type name is a container of <see cref="CDP4Common.DTO.DomainFileStore"/>.
        /// </param>
        /// <returns>
        /// True if the supplied typeName is a container for <see cref="CDP4Common.DTO.DomainFileStore"/> and sets the container property name.
        /// </returns>
        ...
        /// <summary>
        /// Check if the supplied property name for <see cref="CDP4Common.DTO.DomainFileStore"/> is scalar.
        /// </summary>
        /// <param name="propertyName">
        /// Name of the property for which to check if it is scalar.
        /// </param>
        ...
        public bool ApplyPropertyUpdate(CDP4Common.DTO.Thing updatableThing, string propertyName, object value)
        {
            ...
            this.propertyValueAssignmentMap[propertyName]((CDP4Common.DTO.DomainFileStore)updatableThing, value);
        ...
        /// <summary>
        /// Instantiates a <see cref="CDP4Common.DTO.DomainFileStore"/>
        /// </summary>
        /// <returns>
        ...
        {
            return new CDP4Common.DTO.DomainFileStore(guid, revisionNumber);
        }
    }
}
