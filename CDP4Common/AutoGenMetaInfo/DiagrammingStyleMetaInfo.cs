// --------------------------------------------------------------------------------------------------------------------
// <copyright file="DiagrammingStyleMetaInfo.cs" company="Starion Group S.A.">
...
namespace CDP4Common.MetaInfo
{
    ...
    /// <summary>
    /// This a class that holds meta info for <see cref="DiagrammingStyle"/>.
    /// </summary>
    public partial class DiagrammingStyleMetaInfo : IDiagrammingStyleMetaInfo
    {
        /// <summary>
        /// The containment property value map.
        /// </summary>
        private readonly Dictionary<string, Func<CDP4Common.DTO.DiagrammingStyle, IEnumerable<Guid>>> containmentPropertyValueMap = new Dictionary<string, Func<CDP4Common.DTO.DiagrammingStyle, IEnumerable<Guid>>>
        {
            { "UsedColor", diagrammingStyle => diagrammingStyle.UsedColor },
        };

        /// <summary>
        /// The ordered containment property value map.
        /// </summary>
        private readonly Dictionary<string, Func<CDP4Common.DTO.DiagrammingStyle, IEnumerable<OrderedItem>>> orderedContainmentPropertyValueMap = new Dictionary<string, Func<CDP4Common.DTO.DiagrammingStyle, IEnumerable<OrderedItem>>>();

        /// <summary>
        /// The validation rules that should pass for an instance of <see cref="CDP4Common.DTO.DiagrammingStyle"/>.
        /// </summary>
        private readonly Dictionary<string, DtoValidationHelper<CDP4Common.DTO.DiagrammingStyle>> validationRules = new Dictionary<string, DtoValidationHelper<CDP4Common.DTO.DiagrammingStyle>>
        {
            { "ExcludedDomain", new DtoValidationHelper<CDP4Common.DTO.DiagrammingStyle>(item => item.ExcludedDomain != null, "The 'ExcludedDomain' property of a 'DiagrammingStyle' is mandatory and cannot be null.") },
            { "ExcludedPerson", new DtoValidationHelper<CDP4Common.DTO.DiagrammingStyle>(item => item.ExcludedPerson != null, "The 'ExcludedPerson' property of a 'DiagrammingStyle' is mandatory and cannot be null.") },
            { "Name", new DtoValidationHelper<CDP4Common.DTO.DiagrammingStyle>(item => !string.IsNullOrWhiteSpace(item.Name), "The 'Name' property of a 'DiagrammingStyle' is mandatory and cannot be empty or null.") },
            { "UsedColor", new DtoValidationHelper<CDP4Common.DTO.DiagrammingStyle>(item => item.UsedColor != null, "The 'UsedColor' property of a 'DiagrammingStyle' is mandatory and cannot be null.") },
        };
        ...
        /// </exception>
        public void Validate(CDP4Common.DTO.Thing diagrammingStyle)
        {
            this.Validate(diagrammingStyle, x => true);
        }
        ...
        /// If any validation rule failed.
        /// </exception>
        public void Validate(CDP4Common.DTO.Thing diagrammingStyle, Func<string, bool> validateProperty)
        {
            foreach (var applicableRule in this.validationRules.Where(x => validateProperty(x.Key)))
            {
                applicableRule.Value.Validate((CDP4Common.DTO.DiagrammingStyle)diagrammingStyle);
            }
        }
        ...
        /// </returns>
        public bool TryValidate(CDP4Common.DTO.Thing diagrammingStyle)
        {
            return this.TryValidate(diagrammingStyle, x => true);
        }
        ...
        /// True if all validation rules have passed or if none are defined.
        /// </returns>
        public bool TryValidate(CDP4Common.DTO.Thing diagrammingStyle, Func<string, bool> validateProperty)
        {
            var applicableValidationRules = this.validationRules.Where(x => validateProperty(x.Key)).Select(x => x.Value);

            return applicableValidationRules.All(applicableRule => applicableRule.TryValidate((CDP4Common.DTO.DiagrammingStyle)diagrammingStyle));
        }

        /// <summary>
        /// Returns the containment property value for the supplied <see cref="CDP4Common.DTO.DiagrammingStyle"/>.
        /// </summary>
        /// <param name="diagrammingStyle">
        /// The <see cref="CDP4Common.DTO.DiagrammingStyle"/> for which to return the containment property value.
        /// </param>
        ...
        /// If the property name is not supported for the <see cref="CDP4Common.DTO.DiagrammingStyle"/>.
        /// </exception>
        public IEnumerable<Guid> GetContainmentIds(CDP4Common.DTO.Thing diagrammingStyle, string propertyName)
        {
            if (!this.containmentPropertyValueMap.ContainsKey(propertyName))
            {
                throw new ArgumentException($"'{propertyName}' is not a valid containment property of 'DiagrammingStyle'");
            }

            return this.containmentPropertyValueMap[propertyName]((CDP4Common.DTO.DiagrammingStyle)diagrammingStyle);
        }

        /// <summary>
        /// Returns the ordered containment property value for the supplied <see cref="CDP4Common.DTO.DiagrammingStyle"/>.
        /// </summary>
        /// <param name="diagrammingStyle">
        /// The <see cref="CDP4Common.DTO.DiagrammingStyle"/> for which to return the containment property value.
        /// </param>
        ...
        /// If the property name is not supported for the <see cref="CDP4Common.DTO.DiagrammingStyle"/>.
        /// </exception>
        public IEnumerable<OrderedItem> GetOrderedContainmentIds(CDP4Common.DTO.Thing diagrammingStyle, string propertyName)
        {
            ...
            return this.orderedContainmentPropertyValueMap[propertyName]((CDP4Common.DTO.DiagrammingStyle)diagrammingStyle);
        }
        ...
        /// <summary>
        /// Gets the <see cref="PropertyMetaInfo"/> for the <see cref="DiagrammingStyle"/> class
        /// </summary>
        ...
        /// </summary>
        private readonly Dictionary<string, Func<CDP4Common.DTO.DiagrammingStyle, object>> propertyValueMap = new Dictionary<string, Func<CDP4Common.DTO.DiagrammingStyle, object>>
        {
        ...
        /// </summary>
        private readonly Dictionary<string, Action<CDP4Common.DTO.DiagrammingStyle, object>> propertyValueAssignmentMap = new Dictionary<string, Action<CDP4Common.DTO.DiagrammingStyle, object>>
        {
            { "Actor", (diagrammingStyle, value) => diagrammingStyle.Actor = value == null ? (Guid?)null : (Guid)value },
            { "FillColor", (diagrammingStyle, value) => diagrammingStyle.FillColor = value == null ? (Guid?)null : (Guid)value },
            { "FillOpacity", (diagrammingStyle, value) => diagrammingStyle.FillOpacity = value == null ? (float?)null : (float)value },
            { "FontBold", (diagrammingStyle, value) => diagrammingStyle.FontBold = value == null ? (bool?)null : (bool)value },
            { "FontColor", (diagrammingStyle, value) => diagrammingStyle.FontColor = value == null ? (Guid?)null : (Guid)value },
            { "FontItalic", (diagrammingStyle, value) => diagrammingStyle.FontItalic = value == null ? (bool?)null : (bool)value },
            { "FontName", (diagrammingStyle, value) => diagrammingStyle.FontName = value == null ? (string)null : value.ToString() },
            { "FontSize", (diagrammingStyle, value) => diagrammingStyle.FontSize = value == null ? (float?)null : (float)value },
            { "FontStrokeThrough", (diagrammingStyle, value) => diagrammingStyle.FontStrokeThrough = value == null ? (bool?)null : (bool)value },
            { "FontUnderline", (diagrammingStyle, value) => diagrammingStyle.FontUnderline = value == null ? (bool?)null : (bool)value },
            { "Iid", (diagrammingStyle, value) => diagrammingStyle.Iid = (Guid)value },
            { "ModifiedOn", (diagrammingStyle, value) => diagrammingStyle.ModifiedOn = (DateTime)value },
            { "Name", (diagrammingStyle, value) => diagrammingStyle.Name = value.ToString() },
        ...
        /// <summary>
        /// Returns the <see cref="CDP4Common.DTO.DiagrammingStyle"/> containment property type from the supplied property name.
        /// </summary>
        /// <param name="propertyName">
        ...
        /// <summary>
        /// Returns the <see cref="CDP4Common.DTO.DiagrammingStyle"/> property type from the supplied property name.
        /// </summary>
        /// <param name="propertyName">
        /// The property name.
        /// </param>
        ...
        /// <summary>
        /// Returns the container property for the supplied type name is a possible container for <see cref="CDP4Common.DTO.DiagrammingStyle"/>.
        /// </summary>
        /// <param name="typeName">
        /// Name of the type for which to check if it is a container of <see cref="CDP4Common.DTO.DiagrammingStyle"/>.
        /// </param>
        /// <param name="containerProperty">
        /// Supplied container property info instance that will be set if the supplied type name is a container of <see cref="CDP4Common.DTO.DiagrammingStyle"/>.
        /// </param>
        /// <returns>
        /// True if the supplied typeName is a container for <see cref="CDP4Common.DTO.DiagrammingStyle"/> and sets the container property name.
        /// </returns>
        ...
        /// <summary>
        /// Check if the supplied property name for <see cref="CDP4Common.DTO.DiagrammingStyle"/> is scalar.
        /// </summary>
        /// <param name="propertyName">
        /// Name of the property for which to check if it is scalar.
        /// </param>
        ...
        public bool ApplyPropertyUpdate(CDP4Common.DTO.Thing updatableThing, string propertyName, object value)
        {
            ...
            this.propertyValueAssignmentMap[propertyName]((CDP4Common.DTO.DiagrammingStyle)updatableThing, value);
        ...
        public object DeserializeCollectionValue(string propertyName, object value)
        {
            ...
            {
                throw new ArgumentException($"'{propertyName}' is not a valid collection property of 'DiagrammingStyle'");
            }
        ...
        public object GetValue(string propertyName, CDP4Common.DTO.Thing thing)
        {
            ...
            return this.propertyValueMap[propertyName]((CDP4Common.DTO.DiagrammingStyle)thing);
        }
        ...
        /// <summary>
        /// Instantiates a <see cref="CDP4Common.DTO.DiagrammingStyle"/>
        /// </summary>
        /// <returns>
