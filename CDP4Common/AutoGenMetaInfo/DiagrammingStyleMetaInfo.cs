...
namespace CDP4Common.MetaInfo
{
    ...
    public partial class DiagrammingStyleMetaInfo : IDiagrammingStyleMetaInfo
    {
        ...
        public IEnumerable<Guid> GetContainmentIds(CDP4Common.DTO.Thing diagrammingStyle, string propertyName)
        {
            ...
            {
                throw new ArgumentException(string.Format("'{0}' is not a valid containment property of 'DiagrammingStyle'", propertyName));
            }
        ...
        public object DeserializeCollectionValue(string propertyName, object value)
        {
            ...
            {
                throw new ArgumentException(string.Format("'{0}' is not a valid collection property of 'DiagrammingStyle'", propertyName));
            }
