// --------------------------------------------------------------------------------------------------------------------
// <copyright file="CategoryMetaInfo.cs" company="RHEA System S.A.">
...
namespace CDP4Common.MetaInfo
{
    ...
    public partial class CategoryMetaInfo : ICategoryMetaInfo
    {
        ...
        public IEnumerable<Guid> GetContainmentIds(CDP4Common.DTO.Thing category, string propertyName)
        {
            ...
            {
                throw new ArgumentException(string.Format("'{0}' is not a valid containment property of 'Category'", propertyName));
            }
        ...
        private readonly Dictionary<string, PropertyMetaInfo> propertyTypeMap = new Dictionary<string, PropertyMetaInfo>
        {
            ...
            { "SuperCategory", new PropertyMetaInfo("SuperCategory", "Guid", PropertyKind.List, AggregationKind.None, false, false, true, 0, "*", true) },
        };
        ...
        {
            { "ModelReferenceDataLibrary", new PropertyMetaInfo("DefinedCategory", "Guid", PropertyKind.List, AggregationKind.Composite, false, false, true, 0, "*", true) },
            { "SiteReferenceDataLibrary", new PropertyMetaInfo("DefinedCategory", "Guid", PropertyKind.List, AggregationKind.Composite, false, false, true, 0, "*", true) },
        };
        ...
        public object DeserializeCollectionValue(string propertyName, object value)
        {
            ...
            {
                throw new ArgumentException(string.Format("'{0}' is not a valid collection property of 'Category'", propertyName));
            }
