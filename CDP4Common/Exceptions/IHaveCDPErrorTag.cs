// -------------------------------------------------------------------------------------------------------------------------------
// <copyright file="IHaveCDPErrorTag.cs" company="Starion Group S.A.">
...
{
    /// <summary>
    /// Defines the properties and methods of classes that implement the <see cref="IHaveCDPErrorTag"/> interface
    /// </summary>
    public interface IHaveCDPErrorTag
    {
        /// <summary>
