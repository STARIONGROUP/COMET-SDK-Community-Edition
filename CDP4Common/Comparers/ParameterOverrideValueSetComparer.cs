// --------------------------------------------------------------------------------------------------------------------
// <copyright file="ParameterOverrideValueSetComparer.cs" company="Starion Group S.A.">
...
namespace CDP4Common.Comparers
{
    ...
    /// <summary>
    /// A comparer class for <see cref="ParameterOverrideValueSet"/> where the order of a <see cref="ParameterOverrideValueSet"/>
    /// is determined by the referenced option and actual finite state and their order
    /// </summary>
    public class ParameterOverrideValueSetComparer : IComparer<ParameterOverrideValueSet>
    {
        /// <summary>
