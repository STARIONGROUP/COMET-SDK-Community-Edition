...
namespace CDP4Common.SiteDirectoryData
{
    ...
    public partial class CompoundParameterType : ParameterType
    {
        ...
        /// </param>
        public CompoundParameterType(Guid iid, ConcurrentDictionary<Tuple<Guid, Guid?>, Lazy<Thing>> cache, Uri iDalUri) : base(iid, cache, iDalUri)
        {
            this.Component = new OrderedItemList<ParameterTypeComponent>(this, true);
        }
        ...
        protected override Thing GenericClone(bool cloneContainedThings)
        {
            ...
            if (cloneContainedThings)
            {
                ...
                clone.Component.AddRange(this.Component.Select(x => x.Clone(true)));
        ...
        internal override void ResolveProperties(DTO.Thing dtoThing)
        {
            ...
            if (dto == null)
            {
                throw new InvalidOperationException(string.Format("The DTO type {0} does not match the type of the current CompoundParameterType POCO.", dtoThing.GetType()));
            }
