...
namespace CDP4Common.SiteDirectoryData
{
    ...
    public partial class EnumerationParameterType : ScalarParameterType
    {
        ...
        protected override Thing GenericClone(bool cloneContainedThings)
        {
            ...
            clone.ValueDefinition = cloneContainedThings ? null : new OrderedItemList<EnumerationValueDefinition>(this.ValueDefinition, clone);
        ...
        internal override void ResolveProperties(DTO.Thing dtoThing)
        {
            ...
            if (dto == null)
            {
                throw new InvalidOperationException($"The DTO type {dtoThing.GetType()} does not match the type of the current EnumerationParameterType POCO.");
            }
