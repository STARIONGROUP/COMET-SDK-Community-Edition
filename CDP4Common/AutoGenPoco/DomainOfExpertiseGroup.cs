// --------------------------------------------------------------------------------------------------------------------
// <copyright file="DomainOfExpertiseGroup.cs" company="Starion Group S.A.">
...
namespace CDP4Common.SiteDirectoryData
{
    ...
    public partial class DomainOfExpertiseGroup : DefinedThing, IDeprecatableThing
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="DomainOfExpertiseGroup"/> class.
        /// </summary>
        ...
        /// </param>
        public DomainOfExpertiseGroup(Guid iid, ConcurrentDictionary<CacheKey, Lazy<CommonData.Thing>> cache, Uri iDalUri) : base(iid, cache, iDalUri)
        {
            this.Domain = new List<DomainOfExpertise>();
        }
        ...
        /// <returns>
        /// A cloned instance of <see cref="DomainOfExpertiseGroup"/>.
        /// </returns>
        protected override Thing GenericClone(bool cloneContainedThings)
        {
            var clone = (DomainOfExpertiseGroup)this.MemberwiseClone();
        ...
        /// A cloned instance of <see cref="DomainOfExpertiseGroup"/>.
        /// </returns>
        public new DomainOfExpertiseGroup Clone(bool cloneContainedThings)
        {
        ...
        /// <summary>
        /// Validates the cardinalities of the properties of this <see cref="DomainOfExpertiseGroup"/>.
        /// </summary>
        /// <returns>
        ...
        /// <summary>
        /// Resolve the properties of the current <see cref="DomainOfExpertiseGroup"/> from its <see cref="DTO.Thing"/> counter-part
        /// </summary>
        ...
        /// <summary>
        /// Generates a <see cref="DTO.Thing"/> from the current <see cref="DomainOfExpertiseGroup"/>
        /// </summary>
        public override DTO.Thing ToDto()
        {
            var dto = new DTO.DomainOfExpertiseGroup(this.Iid, this.RevisionNumber);
