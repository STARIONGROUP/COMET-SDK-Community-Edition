...
namespace CDP4Common.ReportingData
{
    ...
    public sealed partial class Section : Thing, ICategorizableThing, INamedThing, IOwnedThing, IShortNamedThing, ITimeStampedThing
    {
        ...
        /// </param>
        public Section(Guid iid, ConcurrentDictionary<CacheKey, Lazy<CommonData.Thing>> cache, Uri iDalUri) : base(iid, cache, iDalUri)
        {
            this.Category = new List<Category>();
            this.Page = new OrderedItemList<Page>(this, true);
        }
        ...
        /// <summary>
        /// Gets or sets a list of ordered contained Page.
        /// </summary>
        /// <remarks>
        /// collection of Pages in this Section
        /// </remarks>
        [UmlInformation(aggregation: AggregationKind.Composite, isDerived: false, isOrdered: true, isNullable: false, isPersistent: true)]
        public OrderedItemList<Page> Page { get; protected set; }
        ...
        /// <summary>
        /// Gets an <see cref="IEnumerable{IEnumerable}"/> that references the composite properties of the current <see cref="Section"/>.
        /// </summary>
        ...
        /// <summary>
        /// Creates and returns a copy of this <see cref="Section"/> for edit purpose.
        /// </summary>
        /// <param name="cloneContainedThings">A value that indicates whether the contained <see cref="Thing"/>s should be cloned or not.</param>
        /// <returns>
        /// A cloned instance of <see cref="Section"/>.
        /// </returns>
        protected override Thing GenericClone(bool cloneContainedThings)
        {
            ...
            {
                clone.Page.AddRange(this.Page.Select(x => x.Clone(true)));
            }
        ...
        /// A cloned instance of <see cref="Section"/>.
        /// </returns>
        public new Section Clone(bool cloneContainedThings)
        {
        ...
        /// <summary>
        /// Validates the cardinalities of the properties of this <see cref="Section"/>.
        /// </summary>
        /// <returns>
        ...
        /// <summary>
        /// Resolve the properties of the current <see cref="Section"/> from its <see cref="DTO.Thing"/> counter-part
        /// </summary>
        ...
        internal override void ResolveProperties(DTO.Thing dtoThing)
        {
            ...
            var dto = dtoThing as DTO.Section;
            if (dto == null)
            {
                throw new InvalidOperationException(string.Format("The DTO type {0} does not match the type of the current Section POCO.", dtoThing.GetType()));
            }
            ...
            this.Page.ResolveList(dto.Page, dto.IterationContainerId, this.Cache);
        ...
        /// <summary>
        /// Generates a <see cref="DTO.Thing"/> from the current <see cref="Section"/>
        /// </summary>
        public override DTO.Thing ToDto()
        {
            ...
            dto.Page.AddRange(this.Page.ToDtoOrderedItemList());
