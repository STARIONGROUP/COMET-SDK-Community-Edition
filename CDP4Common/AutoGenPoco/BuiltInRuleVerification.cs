// --------------------------------------------------------------------------------------------------------------------
// <copyright file="BuiltInRuleVerification.cs" company="Starion Group S.A.">
...
namespace CDP4Common.EngineeringModelData
{
    ...
    public partial class BuiltInRuleVerification : RuleVerification
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="BuiltInRuleVerification"/> class.
        /// </summary>
        ...
        /// </param>
        public BuiltInRuleVerification(Guid iid, ConcurrentDictionary<CacheKey, Lazy<CommonData.Thing>> cache, Uri iDalUri) : base(iid, cache, iDalUri)
        {
        }

        /// <summary>
        /// Creates and returns a copy of this <see cref="BuiltInRuleVerification"/> for edit purpose.
        /// </summary>
        /// <param name="cloneContainedThings">A value that indicates whether the contained <see cref="Thing"/>s should be cloned or not.</param>
        /// <returns>
        /// A cloned instance of <see cref="BuiltInRuleVerification"/>.
        /// </returns>
        protected override Thing GenericClone(bool cloneContainedThings)
        {
            var clone = (BuiltInRuleVerification)this.MemberwiseClone();
        ...
        /// A cloned instance of <see cref="BuiltInRuleVerification"/>.
        /// </returns>
        public new BuiltInRuleVerification Clone(bool cloneContainedThings)
        {
        ...
        /// <summary>
        /// Validates the cardinalities of the properties of this <see cref="BuiltInRuleVerification"/>.
        /// </summary>
        /// <returns>
        ...
        /// <summary>
        /// Generates a <see cref="DTO.Thing"/> from the current <see cref="BuiltInRuleVerification"/>
        /// </summary>
        public override DTO.Thing ToDto()
        {
            var dto = new DTO.BuiltInRuleVerification(this.Iid, this.RevisionNumber);
