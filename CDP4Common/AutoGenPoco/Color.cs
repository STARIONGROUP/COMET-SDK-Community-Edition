...
namespace CDP4Common.DiagramData
{
    ...
    public sealed partial class Color : DiagramThingBase
    {
        ...
        /// </param>
        public Color(Guid iid, ConcurrentDictionary<CacheKey, Lazy<CommonData.Thing>> cache, Uri iDalUri) : base(iid, cache, iDalUri)
        {
        }
        ...
        /// <summary>
        /// Creates and returns a copy of this <see cref="Color"/> for edit purpose.
        /// </summary>
        /// <param name="cloneContainedThings">A value that indicates whether the contained <see cref="Thing"/>s should be cloned or not.</param>
        /// <returns>
        /// A cloned instance of <see cref="Color"/>.
        /// </returns>
        protected override Thing GenericClone(bool cloneContainedThings)
        {
            var clone = (Color)this.MemberwiseClone();
        ...
        /// A cloned instance of <see cref="Color"/>.
        /// </returns>
        public new Color Clone(bool cloneContainedThings)
        {
        ...
        /// <summary>
        /// Validates the cardinalities of the properties of this <see cref="Color"/>.
        /// </summary>
        /// <returns>
        ...
        /// <summary>
        /// Resolve the properties of the current <see cref="Color"/> from its <see cref="DTO.Thing"/> counter-part
        /// </summary>
        ...
        /// <summary>
        /// Generates a <see cref="DTO.Thing"/> from the current <see cref="Color"/>
        /// </summary>
        public override DTO.Thing ToDto()
        {
            var dto = new DTO.Color(this.Iid, this.RevisionNumber);
