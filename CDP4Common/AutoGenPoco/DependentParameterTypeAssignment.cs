// --------------------------------------------------------------------------------------------------------------------
// <copyright file="DependentParameterTypeAssignment.cs" company="Starion Group S.A.">
...
namespace CDP4Common.SiteDirectoryData
{
    ...
    public partial class DependentParameterTypeAssignment : Thing, IParameterTypeAssignment
    {
        ...
        /// </param>
        public DependentParameterTypeAssignment(Guid iid, ConcurrentDictionary<CacheKey, Lazy<CommonData.Thing>> cache, Uri iDalUri) : base(iid, cache, iDalUri)
        {
        }
        ...
        /// <summary>
        /// Queries the referenced <see cref="Thing"/>s of the current <see cref="DependentParameterTypeAssignment"/>
        /// </summary>
        /// <remarks>
        ...
        /// <summary>
        /// Creates and returns a copy of this <see cref="DependentParameterTypeAssignment"/> for edit purpose.
        /// </summary>
        /// <param name="cloneContainedThings">A value that indicates whether the contained <see cref="Thing"/>s should be cloned or not.</param>
        /// <returns>
        /// A cloned instance of <see cref="DependentParameterTypeAssignment"/>.
        /// </returns>
        protected override Thing GenericClone(bool cloneContainedThings)
        {
            var clone = (DependentParameterTypeAssignment)this.MemberwiseClone();
        ...
        /// A cloned instance of <see cref="DependentParameterTypeAssignment"/>.
        /// </returns>
        public new DependentParameterTypeAssignment Clone(bool cloneContainedThings)
        {
        ...
        /// <summary>
        /// Validates the cardinalities of the properties of this <see cref="DependentParameterTypeAssignment"/>.
        /// </summary>
        /// <returns>
        ...
        /// <summary>
        /// Resolve the properties of the current <see cref="DependentParameterTypeAssignment"/> from its <see cref="DTO.Thing"/> counter-part
        /// </summary>
        ...
        /// <summary>
        /// Generates a <see cref="DTO.Thing"/> from the current <see cref="DependentParameterTypeAssignment"/>
        /// </summary>
        public override DTO.Thing ToDto()
        {
            var dto = new DTO.DependentParameterTypeAssignment(this.Iid, this.RevisionNumber);
