// --------------------------------------------------------------------------------------------------------------------
// <copyright file="DateTimeParameterType.cs" company="Starion Group S.A.">
...
namespace CDP4Common.SiteDirectoryData
{
    ...
    public partial class DateTimeParameterType : ScalarParameterType
    {
        /// <summary>
        ...
        /// </param>
        public DateTimeParameterType(Guid iid, ConcurrentDictionary<CacheKey, Lazy<CommonData.Thing>> cache, Uri iDalUri) : base(iid, cache, iDalUri)
        {
        }

        /// <summary>
        /// Creates and returns a copy of this <see cref="DateTimeParameterType"/> for edit purpose.
        /// </summary>
        /// <param name="cloneContainedThings">A value that indicates whether the contained <see cref="Thing"/>s should be cloned or not.</param>
        /// <returns>
        /// A cloned instance of <see cref="DateTimeParameterType"/>.
        /// </returns>
        protected override Thing GenericClone(bool cloneContainedThings)
        {
            var clone = (DateTimeParameterType)this.MemberwiseClone();
        ...
        /// A cloned instance of <see cref="DateTimeParameterType"/>.
        /// </returns>
        public new DateTimeParameterType Clone(bool cloneContainedThings)
        {
        ...
        /// <summary>
        /// Validates the cardinalities of the properties of this <see cref="DateTimeParameterType"/>.
        /// </summary>
        /// <returns>
        ...
        /// <summary>
        /// Resolve the properties of the current <see cref="DateTimeParameterType"/> from its <see cref="DTO.Thing"/> counter-part
        /// </summary>
        ...
        internal override void ResolveProperties(DTO.Thing dtoThing)
        {
            ...
            var dto = dtoThing as DTO.DateTimeParameterType;
            if (dto == null)
            {
                throw new InvalidOperationException($"The DTO type {dtoThing.GetType()} does not match the type of the current DateTimeParameterType POCO.");
            }
        ...
        /// <summary>
        /// Generates a <see cref="DTO.Thing"/> from the current <see cref="DateTimeParameterType"/>
        /// </summary>
        public override DTO.Thing ToDto()
        {
            var dto = new DTO.DateTimeParameterType(this.Iid, this.RevisionNumber);
