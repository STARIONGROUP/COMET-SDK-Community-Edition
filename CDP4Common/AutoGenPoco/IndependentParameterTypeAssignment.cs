...
namespace CDP4Common.SiteDirectoryData
{
    ...
    public sealed partial class IndependentParameterTypeAssignment : Thing, IParameterTypeAssignment
    {
        /// <summary>
        ...
        internal override void ResolveProperties(DTO.Thing dtoThing)
        {
            ...
            if (dto == null)
            {
                throw new InvalidOperationException(string.Format("The DTO type {0} does not match the type of the current IndependentParameterTypeAssignment POCO.", dtoThing.GetType()));
            }
