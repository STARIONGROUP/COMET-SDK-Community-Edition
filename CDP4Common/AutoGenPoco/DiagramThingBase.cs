// --------------------------------------------------------------------------------------------------------------------
// <copyright file="DiagramThingBase.cs" company="Starion Group S.A.">
...
namespace CDP4Common.DiagramData
{
    ...
    public abstract partial class DiagramThingBase : Thing, INamedThing
    {
        ...
        /// </param>
        protected DiagramThingBase(Guid iid, ConcurrentDictionary<CacheKey, Lazy<CommonData.Thing>> cache, Uri iDalUri) : base(iid, cache, iDalUri)
        {
        }
