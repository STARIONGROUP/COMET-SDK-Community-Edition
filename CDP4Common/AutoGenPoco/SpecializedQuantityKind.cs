...
namespace CDP4Common.SiteDirectoryData
{
    ...
    public partial class SpecializedQuantityKind : QuantityKind
    {
        ...
        /// </param>
        public SpecializedQuantityKind(Guid iid, ConcurrentDictionary<CacheKey, Lazy<CommonData.Thing>> cache, Uri iDalUri) : base(iid, cache, iDalUri)
        {
        }
        ...
        public override IDictionary<string, IEnumerable<Guid>> GetReferenceProperties()
        {
            ...
            {
                dictionary.Add("General", new [] { Guid.Empty });
            }
            else
            {
                dictionary.Add("General", new [] { this.General.Iid });
            }
        ...
        internal override void ResolveProperties(DTO.Thing dtoThing)
        {
            ...
            if (dto == null)
            {
                throw new InvalidOperationException($"The DTO type {dtoThing.GetType()} does not match the type of the current SpecializedQuantityKind POCO.");
            }
