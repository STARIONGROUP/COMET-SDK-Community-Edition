...
namespace CDP4Common.ReportingData
{
    ...
    public sealed partial class ContractChangeNotice : ModellingAnnotationItem
    {
        ...
        /// </param>
        public ContractChangeNotice(Guid iid, ConcurrentDictionary<Tuple<Guid, Guid?>, Lazy<Thing>> cache, Uri iDalUri) : base(iid, cache, iDalUri)
        {
        }
        ...
        internal override void ResolveProperties(DTO.Thing dtoThing)
        {
            ...
            if (dto == null)
            {
                throw new InvalidOperationException(string.Format("The DTO type {0} does not match the type of the current ContractChangeNotice POCO.", dtoThing.GetType()));
            }
