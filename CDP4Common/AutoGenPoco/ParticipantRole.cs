...
namespace CDP4Common.SiteDirectoryData
{
    ...
    public partial class ParticipantRole : DefinedThing, IDeprecatableThing
    {
        ...
        /// </param>
        public ParticipantRole(Guid iid, ConcurrentDictionary<CacheKey, Lazy<CommonData.Thing>> cache, Uri iDalUri) : base(iid, cache, iDalUri)
        {
            this.ParticipantPermission = new ContainerList<ParticipantPermission>(this);
            this.PopulateParticipantPermissions();
        }
        ...
        /// <summary>
        /// Gets or sets a list of contained ParticipantPermission.
        /// </summary>
        /// <remarks>
        /// references to the ParticipantPermissions assigned to this ParticipantRole
        /// </remarks>
        [UmlInformation(aggregation: AggregationKind.Composite, isDerived: false, isOrdered: false, isNullable: false, isPersistent: true)]
        public ContainerList<ParticipantPermission> ParticipantPermission { get; protected set; }
        ...
        public override IDictionary<string, IEnumerable<Guid>> GetReferenceProperties()
        {
            ...
            dictionary.Add("ParticipantPermission", this.ParticipantPermission.Select(x => x.Iid));
        ...
        /// <summary>
        /// Creates and returns a copy of this <see cref="ParticipantRole"/> for edit purpose.
        /// </summary>
        /// <param name="cloneContainedThings">A value that indicates whether the contained <see cref="Thing"/>s should be cloned or not.</param>
        /// <returns>
        /// A cloned instance of <see cref="ParticipantRole"/>.
        /// </returns>
        protected override Thing GenericClone(bool cloneContainedThings)
        {
            var clone = (ParticipantRole)this.MemberwiseClone();
            ...
            clone.ParticipantPermission = cloneContainedThings ? new ContainerList<ParticipantPermission>(clone) : new ContainerList<ParticipantPermission>(this.ParticipantPermission, clone);
            ...
            if (cloneContainedThings)
            {
                ...
                clone.ParticipantPermission.AddRange(this.ParticipantPermission.Select(x => x.Clone(true)));
            }
        ...
        /// A cloned instance of <see cref="ParticipantRole"/>.
        /// </returns>
        public new ParticipantRole Clone(bool cloneContainedThings)
        {
        ...
        /// <summary>
        /// Validates the cardinalities of the properties of this <see cref="ParticipantRole"/>.
        /// </summary>
        /// <returns>
        ...
        /// <summary>
        /// Resolve the properties of the current <see cref="ParticipantRole"/> from its <see cref="DTO.Thing"/> counter-part
        /// </summary>
        ...
        /// <summary>
        /// Generates a <see cref="DTO.Thing"/> from the current <see cref="ParticipantRole"/>
        /// </summary>
        public override DTO.Thing ToDto()
        {
            var dto = new DTO.ParticipantRole(this.Iid, this.RevisionNumber);
