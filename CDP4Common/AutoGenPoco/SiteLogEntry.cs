...
namespace CDP4Common.SiteDirectoryData
{
    ...
    public partial class SiteLogEntry : Thing, IAnnotation, ICategorizableThing, ILogEntry, ITimeStampedThing
    {
        ...
        /// </param>
        public SiteLogEntry(Guid iid, ConcurrentDictionary<CacheKey, Lazy<CommonData.Thing>> cache, Uri iDalUri) : base(iid, cache, iDalUri)
        {
            this.AffectedDomainIid = new List<Guid>();
            this.AffectedItemIid = new List<Guid>();
            this.Category = new List<Category>();
        ...
        /// <summary>
        /// Gets an <see cref="IEnumerable{IEnumerable}"/> that references the composite properties of the current <see cref="SiteLogEntry"/>.
        /// </summary>
