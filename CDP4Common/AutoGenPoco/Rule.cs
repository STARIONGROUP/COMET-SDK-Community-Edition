...
namespace CDP4Common.SiteDirectoryData
{
    ...
    public abstract partial class Rule : DefinedThing, IDeprecatableThing
    {
        /// <summary>
        ...
        /// </param>
        protected Rule(Guid iid, ConcurrentDictionary<CacheKey, Lazy<CommonData.Thing>> cache, Uri iDalUri) : base(iid, cache, iDalUri)
        {
        }
        ...
        /// <summary>
        /// Creates and returns a copy of this <see cref="Rule"/> for edit purpose.
        /// </summary>
        /// <param name="cloneContainedThings">A value that indicates whether the contained <see cref="Thing"/>s should be cloned or not.</param>
        /// <returns>
        /// A cloned instance of <see cref="Rule"/>.
        /// </returns>
        public new Rule Clone(bool cloneContainedThings)
        {
        ...
        /// <summary>
        /// Validates the cardinalities of the properties of this <see cref="Rule"/>.
        /// </summary>
        /// <returns>
