// --------------------------------------------------------------------------------------------------------------------
// <copyright file="Stakeholder.cs" company="Starion Group S.A.">
...
namespace CDP4Common.EngineeringModelData
{
    ...
    public partial class Stakeholder : DefinedThing, ICategorizableThing
    {
        ...
        /// </param>
        public Stakeholder(Guid iid, ConcurrentDictionary<CacheKey, Lazy<CommonData.Thing>> cache, Uri iDalUri) : base(iid, cache, iDalUri)
        {
            this.Category = new List<Category>();
            this.StakeholderValue = new List<StakeholderValue>();
        }
        ...
        /// <returns>
        /// A cloned instance of <see cref="Stakeholder"/>.
        /// </returns>
        protected override Thing GenericClone(bool cloneContainedThings)
        {
            var clone = (Stakeholder)this.MemberwiseClone();
        ...
        /// A cloned instance of <see cref="Stakeholder"/>.
        /// </returns>
        public new Stakeholder Clone(bool cloneContainedThings)
        {
        ...
        /// <summary>
        /// Validates the cardinalities of the properties of this <see cref="Stakeholder"/>.
        /// </summary>
        /// <returns>
        ...
        /// <summary>
        /// Resolve the properties of the current <see cref="Stakeholder"/> from its <see cref="DTO.Thing"/> counter-part
        /// </summary>
        ...
        /// <summary>
        /// Generates a <see cref="DTO.Thing"/> from the current <see cref="Stakeholder"/>
        /// </summary>
        public override DTO.Thing ToDto()
        {
            var dto = new DTO.Stakeholder(this.Iid, this.RevisionNumber);
