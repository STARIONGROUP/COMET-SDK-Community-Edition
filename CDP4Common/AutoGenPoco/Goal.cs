...
namespace CDP4Common.EngineeringModelData
{
    ...
    public sealed partial class Goal : DefinedThing, ICategorizableThing
    {
        /// <summary>
        ...
        internal override void ResolveProperties(DTO.Thing dtoThing)
        {
            ...
            if (dto == null)
            {
                throw new InvalidOperationException(string.Format("The DTO type {0} does not match the type of the current Goal POCO.", dtoThing.GetType()));
            }
