...
namespace CDP4Common.SiteDirectoryData
{
    ...
    public sealed partial class TimeOfDayParameterType : ScalarParameterType
    {
        /// <summary>
        ...
        internal override void ResolveProperties(DTO.Thing dtoThing)
        {
            ...
            if (dto == null)
            {
                throw new InvalidOperationException(string.Format("The DTO type {0} does not match the type of the current TimeOfDayParameterType POCO.", dtoThing.GetType()));
            }
