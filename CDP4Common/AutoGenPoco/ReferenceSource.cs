...
namespace CDP4Common.SiteDirectoryData
{
    ...
    public partial class ReferenceSource : DefinedThing, ICategorizableThing, IDeprecatableThing
    {
        ...
        /// </param>
        public ReferenceSource(Guid iid, ConcurrentDictionary<CacheKey, Lazy<CommonData.Thing>> cache, Uri iDalUri) : base(iid, cache, iDalUri)
        {
            this.Category = new List<Category>();
        }
        ...
        public override IDictionary<string, IEnumerable<Guid>> GetReferenceProperties()
        {
            ...
            {
                dictionary.Add("PublishedIn", new [] { Guid.Empty });
            }
            else
            {
                dictionary.Add("PublishedIn", new [] { this.PublishedIn.Iid });
            }

            if (this.Publisher == null)
            {
                dictionary.Add("Publisher", new [] { Guid.Empty });
            }
            else
            {
                dictionary.Add("Publisher", new [] { this.Publisher.Iid });
            }
