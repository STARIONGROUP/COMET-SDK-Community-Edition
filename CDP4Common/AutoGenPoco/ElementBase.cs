// --------------------------------------------------------------------------------------------------------------------
// <copyright file="ElementBase.cs" company="Starion Group S.A.">
...
namespace CDP4Common.EngineeringModelData
{
    ...
    /// </summary>
    public abstract partial class ElementBase : DefinedThing, ICategorizableThing, IOwnedThing
    {
        /// <summary>
        ...
        /// </param>
        protected ElementBase(Guid iid, ConcurrentDictionary<CacheKey, Lazy<CommonData.Thing>> cache, Uri iDalUri) : base(iid, cache, iDalUri)
        {
            this.Category = new List<Category>();
        }
        ...
        /// <returns>
        /// A cloned instance of <see cref="ElementBase"/>.
        /// </returns>
        public new ElementBase Clone(bool cloneContainedThings)
        {
        ...
        /// <summary>
        /// Validates the cardinalities of the properties of this <see cref="ElementBase"/>.
        /// </summary>
        /// <returns>
