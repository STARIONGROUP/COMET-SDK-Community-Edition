...
namespace CDP4Common.EngineeringModelData
{
    ...
    public sealed partial class PossibleFiniteStateList : DefinedThing, ICategorizableThing, IOwnedThing
    {
        ...
        /// </param>
        public PossibleFiniteStateList(Guid iid, ConcurrentDictionary<Tuple<Guid, Guid?>, Lazy<Thing>> cache, Uri iDalUri) : base(iid, cache, iDalUri)
        {
            this.Category = new List<Category>();
            this.PossibleState = new OrderedItemList<PossibleFiniteState>(this, true);
        }
        ...
        protected override Thing GenericClone(bool cloneContainedThings)
        {
            ...
            clone.PossibleState = cloneContainedThings ? new OrderedItemList<PossibleFiniteState>(clone, true) : new OrderedItemList<PossibleFiniteState>(this.PossibleState, clone);
