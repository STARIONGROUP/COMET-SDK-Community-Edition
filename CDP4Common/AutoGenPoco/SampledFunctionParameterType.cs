...
namespace CDP4Common.SiteDirectoryData
{
    ...
    public partial class SampledFunctionParameterType : ParameterType
    {
        /// <summary>
        ...
        public override IDictionary<string, IEnumerable<Guid>> GetReferenceProperties()
        {
            ...
            dictionary.Add("DependentParameterType", this.DependentParameterType.Select(x => x.Iid));
            dictionary.Add("ExcludedDomain", this.ExcludedDomain.Select(x => x.Iid));
            dictionary.Add("ExcludedPerson", this.ExcludedPerson.Select(x => x.Iid));
            dictionary.Add("HyperLink", this.HyperLink.Select(x => x.Iid));
            dictionary.Add("IndependentParameterType", this.IndependentParameterType.Select(x => x.Iid));
        ...
        internal override void ResolveProperties(DTO.Thing dtoThing)
        {
            ...
            if (dto == null)
            {
                throw new InvalidOperationException($"The DTO type {dtoThing.GetType()} does not match the type of the current SampledFunctionParameterType POCO.");
            }
