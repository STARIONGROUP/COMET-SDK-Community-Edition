...
namespace CDP4Common.SiteDirectoryData
{
    ...
    public partial class DerivedUnit : MeasurementUnit
    {
        ...
        /// </param>
        public DerivedUnit(Guid iid, ConcurrentDictionary<CacheKey, Lazy<CommonData.Thing>> cache, Uri iDalUri) : base(iid, cache, iDalUri)
        {
            this.UnitFactor = new OrderedItemList<UnitFactor>(this, true);
        }
        ...
        public override IDictionary<string, IEnumerable<Guid>> GetReferenceProperties()
        {
            ...
            dictionary.Add("UnitFactor", this.UnitFactor.Select(x => x.Iid));
        ...
        protected override Thing GenericClone(bool cloneContainedThings)
        {
            ...
            clone.UnitFactor = cloneContainedThings ? null : new OrderedItemList<UnitFactor>(this.UnitFactor, clone);
            ...
            if (cloneContainedThings)
            {
                ...
                clone.UnitFactor = this.UnitFactor.Clone(clone);
            }
