...
namespace CDP4Common.SiteDirectoryData
{
    ...
    public partial class RatioScale : MeasurementScale
    {
        ...
        /// </param>
        public RatioScale(Guid iid, ConcurrentDictionary<Tuple<Guid, Guid?>, Lazy<Thing>> cache, Uri iDalUri) : base(iid, cache, iDalUri)
        {
        }
        ...
        internal override void ResolveProperties(DTO.Thing dtoThing)
        {
            ...
            if (dto == null)
            {
                throw new InvalidOperationException(string.Format("The DTO type {0} does not match the type of the current RatioScale POCO.", dtoThing.GetType()));
            }
