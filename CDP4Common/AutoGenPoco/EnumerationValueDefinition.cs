// --------------------------------------------------------------------------------------------------------------------
// <copyright file="EnumerationValueDefinition.cs" company="Starion Group S.A.">
...
namespace CDP4Common.SiteDirectoryData
{
    ...
    public partial class EnumerationValueDefinition : DefinedThing
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="EnumerationValueDefinition"/> class.
        /// </summary>
        ...
        /// </param>
        public EnumerationValueDefinition(Guid iid, ConcurrentDictionary<CacheKey, Lazy<CommonData.Thing>> cache, Uri iDalUri) : base(iid, cache, iDalUri)
        {
        }

        /// <summary>
        /// Creates and returns a copy of this <see cref="EnumerationValueDefinition"/> for edit purpose.
        /// </summary>
        /// <param name="cloneContainedThings">A value that indicates whether the contained <see cref="Thing"/>s should be cloned or not.</param>
        /// <returns>
        /// A cloned instance of <see cref="EnumerationValueDefinition"/>.
        /// </returns>
        protected override Thing GenericClone(bool cloneContainedThings)
        {
            var clone = (EnumerationValueDefinition)this.MemberwiseClone();
        ...
        /// A cloned instance of <see cref="EnumerationValueDefinition"/>.
        /// </returns>
        public new EnumerationValueDefinition Clone(bool cloneContainedThings)
        {
        ...
        /// <summary>
        /// Validates the cardinalities of the properties of this <see cref="EnumerationValueDefinition"/>.
        /// </summary>
        /// <returns>
        ...
        /// <summary>
        /// Resolve the properties of the current <see cref="EnumerationValueDefinition"/> from its <see cref="DTO.Thing"/> counter-part
        /// </summary>
        ...
        /// <summary>
        /// Generates a <see cref="DTO.Thing"/> from the current <see cref="EnumerationValueDefinition"/>
        /// </summary>
        public override DTO.Thing ToDto()
        {
            var dto = new DTO.EnumerationValueDefinition(this.Iid, this.RevisionNumber);
