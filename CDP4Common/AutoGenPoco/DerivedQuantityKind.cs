...
namespace CDP4Common.SiteDirectoryData
{
    ...
    public sealed partial class DerivedQuantityKind : QuantityKind
    {
        ...
        /// </param>
        public DerivedQuantityKind(Guid iid, ConcurrentDictionary<Tuple<Guid, Guid?>, Lazy<Thing>> cache, Uri iDalUri) : base(iid, cache, iDalUri)
        {
            this.QuantityKindFactor = new OrderedItemList<QuantityKindFactor>(this, true);
        }
        ...
        protected override Thing GenericClone(bool cloneContainedThings)
        {
            ...
            clone.QuantityKindFactor = cloneContainedThings ? new OrderedItemList<QuantityKindFactor>(clone, true) : new OrderedItemList<QuantityKindFactor>(this.QuantityKindFactor, clone);
            ...
            if (cloneContainedThings)
            {
                ...
                clone.QuantityKindFactor.AddRange(this.QuantityKindFactor.Select(x => x.Clone(true)));
            }
