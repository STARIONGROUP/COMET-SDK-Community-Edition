...
namespace CDP4Common.EngineeringModelData
{
    ...
    public sealed partial class RuleVerificationList : DefinedThing, IOwnedThing
    {
        ...
        /// </param>
        public RuleVerificationList(Guid iid, ConcurrentDictionary<CacheKey, Lazy<CommonData.Thing>> cache, Uri iDalUri) : base(iid, cache, iDalUri)
        {
            this.RuleVerification = new OrderedItemList<RuleVerification>(this, true);
        }
        ...
        /// <summary>
        /// Gets or sets a list of ordered contained RuleVerification.
        /// </summary>
        /// <remarks>
        /// set of RuleVerifications in this RuleVerificationList, in desired execution order
        /// </remarks>
        [UmlInformation(aggregation: AggregationKind.Composite, isDerived: false, isOrdered: true, isNullable: false, isPersistent: true)]
        public OrderedItemList<RuleVerification> RuleVerification { get; protected set; }
        ...
        /// <summary>
        /// Creates and returns a copy of this <see cref="RuleVerificationList"/> for edit purpose.
        /// </summary>
        /// <param name="cloneContainedThings">A value that indicates whether the contained <see cref="Thing"/>s should be cloned or not.</param>
        /// <returns>
        /// A cloned instance of <see cref="RuleVerificationList"/>.
        /// </returns>
        protected override Thing GenericClone(bool cloneContainedThings)
        {
            var clone = (RuleVerificationList)this.MemberwiseClone();
            ...
            if (cloneContainedThings)
            {
                ...
                clone.RuleVerification.AddRange(this.RuleVerification.Select(x => x.Clone(true)));
            }
        ...
        /// A cloned instance of <see cref="RuleVerificationList"/>.
        /// </returns>
        public new RuleVerificationList Clone(bool cloneContainedThings)
        {
        ...
        /// <summary>
        /// Validates the cardinalities of the properties of this <see cref="RuleVerificationList"/>.
        /// </summary>
        /// <returns>
        ...
        /// <summary>
        /// Resolve the properties of the current <see cref="RuleVerificationList"/> from its <see cref="DTO.Thing"/> counter-part
        /// </summary>
        ...
        /// <summary>
        /// Generates a <see cref="DTO.Thing"/> from the current <see cref="RuleVerificationList"/>
        /// </summary>
        public override DTO.Thing ToDto()
        {
            var dto = new DTO.RuleVerificationList(this.Iid, this.RevisionNumber);
