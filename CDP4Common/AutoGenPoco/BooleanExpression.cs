...
namespace CDP4Common.EngineeringModelData
{
    ...
    public abstract partial class BooleanExpression : Thing
    {
        ...
        /// </param>
        protected BooleanExpression(Guid iid, ConcurrentDictionary<CacheKey, Lazy<CommonData.Thing>> cache, Uri iDalUri) : base(iid, cache, iDalUri)
        {
        }
        ...
        /// <summary>
        /// Creates and returns a copy of this <see cref="BooleanExpression"/> for edit purpose.
        /// </summary>
        /// <param name="cloneContainedThings">A value that indicates whether the contained <see cref="Thing"/>s should be cloned or not.</param>
        /// <returns>
        /// A cloned instance of <see cref="BooleanExpression"/>.
        /// </returns>
        public new BooleanExpression Clone(bool cloneContainedThings)
        {
        ...
        /// <summary>
        /// Validates the cardinalities of the properties of this <see cref="BooleanExpression"/>.
        /// </summary>
        /// <returns>
