...
namespace CDP4Common.SiteDirectoryData
{
    ...
    public partial class ParameterizedCategoryRule : Rule
    {
        ...
        /// </param>
        public ParameterizedCategoryRule(Guid iid, ConcurrentDictionary<CacheKey, Lazy<CommonData.Thing>> cache, Uri iDalUri) : base(iid, cache, iDalUri)
        {
            this.ParameterType = new List<ParameterType>();
        }
        ...
        /// <summary>
        /// Gets or sets a list of ParameterType.
        /// </summary>
        /// <remarks>
        ...
        public override IDictionary<string, IEnumerable<Guid>> GetReferenceProperties()
        {
            ...
            {
                dictionary.Add("Category", new [] { Guid.Empty });
            }
            else
            {
                dictionary.Add("Category", new [] { this.Category.Iid });
            }
        ...
        /// <returns>
        /// A cloned instance of <see cref="ParameterizedCategoryRule"/>.
        /// </returns>
        protected override Thing GenericClone(bool cloneContainedThings)
        {
            var clone = (ParameterizedCategoryRule)this.MemberwiseClone();
            ...
            clone.ParameterType = new List<ParameterType>(this.ParameterType);
        ...
        /// A cloned instance of <see cref="ParameterizedCategoryRule"/>.
        /// </returns>
        public new ParameterizedCategoryRule Clone(bool cloneContainedThings)
        {
        ...
        /// <summary>
        /// Validates the cardinalities of the properties of this <see cref="ParameterizedCategoryRule"/>.
        /// </summary>
        /// <returns>
        ...
        protected override IEnumerable<string> ValidatePocoCardinality()
        {
            ...
            if (this.Category == null || this.Category.Iid == Guid.Empty)
            {
            ...
            var parameterTypeCount = this.ParameterType.Count();
        ...
        /// <summary>
        /// Resolve the properties of the current <see cref="ParameterizedCategoryRule"/> from its <see cref="DTO.Thing"/> counter-part
        /// </summary>
        ...
        internal override void ResolveProperties(DTO.Thing dtoThing)
        {
            ...
            this.Category = this.Cache.Get<Category>(dto.Category, dto.IterationContainerId) ?? SentinelThingProvider.GetSentinel<Category>();
        ...
        /// <summary>
        /// Generates a <see cref="DTO.Thing"/> from the current <see cref="ParameterizedCategoryRule"/>
        /// </summary>
        public override DTO.Thing ToDto()
        {
            var dto = new DTO.ParameterizedCategoryRule(this.Iid, this.RevisionNumber);

            dto.Actor = this.Actor != null ? (Guid?)this.Actor.Iid : null;
            dto.Alias.AddRange(this.Alias.Select(x => x.Iid));
            dto.Category = this.Category != null ? this.Category.Iid : Guid.Empty;
