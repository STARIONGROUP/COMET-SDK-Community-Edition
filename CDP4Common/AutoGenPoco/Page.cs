...
namespace CDP4Common.ReportingData
{
    ...
    public sealed partial class Page : Thing, ICategorizableThing, INamedThing, IOwnedThing, IShortNamedThing, ITimeStampedThing
    {
        ...
        /// </param>
        public Page(Guid iid, ConcurrentDictionary<CacheKey, Lazy<CommonData.Thing>> cache, Uri iDalUri) : base(iid, cache, iDalUri)
        {
            this.Category = new List<Category>();
            this.Note = new OrderedItemList<Note>(this, true);
        }
        ...
        /// <summary>
        /// Gets or sets a list of ordered contained Note.
        /// </summary>
        /// <remarks>
        /// collection of Notes in this Page
        /// </remarks>
        [UmlInformation(aggregation: AggregationKind.Composite, isDerived: false, isOrdered: true, isNullable: false, isPersistent: true)]
        public OrderedItemList<Note> Note { get; protected set; }
        ...
        /// <summary>
        /// Gets an <see cref="IEnumerable{IEnumerable}"/> that references the composite properties of the current <see cref="Page"/>.
        /// </summary>
        ...
        /// <summary>
        /// Creates and returns a copy of this <see cref="Page"/> for edit purpose.
        /// </summary>
        /// <param name="cloneContainedThings">A value that indicates whether the contained <see cref="Thing"/>s should be cloned or not.</param>
        /// <returns>
        /// A cloned instance of <see cref="Page"/>.
        /// </returns>
        protected override Thing GenericClone(bool cloneContainedThings)
        {
            var clone = (Page)this.MemberwiseClone();
            clone.Category = new List<Category>(this.Category);
            clone.ExcludedDomain = new List<DomainOfExpertise>(this.ExcludedDomain);
            clone.ExcludedPerson = new List<Person>(this.ExcludedPerson);
            clone.Note = cloneContainedThings ? new OrderedItemList<Note>(clone, true) : new OrderedItemList<Note>(this.Note, clone);

            if (cloneContainedThings)
            {
                clone.Note.AddRange(this.Note.Select(x => x.Clone(true)));
            }
        ...
        /// A cloned instance of <see cref="Page"/>.
        /// </returns>
        public new Page Clone(bool cloneContainedThings)
        {
        ...
        /// <summary>
        /// Validates the cardinalities of the properties of this <see cref="Page"/>.
        /// </summary>
        /// <returns>
        ...
        /// <summary>
        /// Resolve the properties of the current <see cref="Page"/> from its <see cref="DTO.Thing"/> counter-part
        /// </summary>
        ...
        internal override void ResolveProperties(DTO.Thing dtoThing)
        {
            ...
            this.Name = dto.Name;
            this.Note.ResolveList(dto.Note, dto.IterationContainerId, this.Cache);
        ...
        /// <summary>
        /// Generates a <see cref="DTO.Thing"/> from the current <see cref="Page"/>
        /// </summary>
        public override DTO.Thing ToDto()
        {
            var dto = new DTO.Page(this.Iid, this.RevisionNumber);
