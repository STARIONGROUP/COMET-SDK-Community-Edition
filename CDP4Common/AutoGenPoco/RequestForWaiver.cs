...
namespace CDP4Common.ReportingData
{
    ...
    public partial class RequestForWaiver : ContractDeviation
    {
        ...
        /// </param>
        public RequestForWaiver(Guid iid, ConcurrentDictionary<CacheKey, Lazy<CommonData.Thing>> cache, Uri iDalUri) : base(iid, cache, iDalUri)
        {
        }

        /// <summary>
        /// Creates and returns a copy of this <see cref="RequestForWaiver"/> for edit purpose.
        /// </summary>
        /// <param name="cloneContainedThings">A value that indicates whether the contained <see cref="Thing"/>s should be cloned or not.</param>
        /// <returns>
        /// A cloned instance of <see cref="RequestForWaiver"/>.
        /// </returns>
        protected override Thing GenericClone(bool cloneContainedThings)
        {
            var clone = (RequestForWaiver)this.MemberwiseClone();
        ...
        /// A cloned instance of <see cref="RequestForWaiver"/>.
        /// </returns>
        public new RequestForWaiver Clone(bool cloneContainedThings)
        {
        ...
        /// <summary>
        /// Validates the cardinalities of the properties of this <see cref="RequestForWaiver"/>.
        /// </summary>
        /// <returns>
        ...
        /// <summary>
        /// Resolve the properties of the current <see cref="RequestForWaiver"/> from its <see cref="DTO.Thing"/> counter-part
        /// </summary>
        ...
        internal override void ResolveProperties(DTO.Thing dtoThing)
        {
            ...
            var dto = dtoThing as DTO.RequestForWaiver;
            if (dto == null)
            {
                throw new InvalidOperationException($"The DTO type {dtoThing.GetType()} does not match the type of the current RequestForWaiver POCO.");
            }
        ...
        /// <summary>
        /// Generates a <see cref="DTO.Thing"/> from the current <see cref="RequestForWaiver"/>
        /// </summary>
        public override DTO.Thing ToDto()
        {
            var dto = new DTO.RequestForWaiver(this.Iid, this.RevisionNumber);
