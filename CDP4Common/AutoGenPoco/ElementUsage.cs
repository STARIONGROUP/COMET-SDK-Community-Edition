...
namespace CDP4Common.EngineeringModelData
{
    ...
    public partial class ElementUsage : ElementBase, IOptionDependentThing
    {
        ...
        public override IDictionary<string, IEnumerable<Guid>> GetReferenceProperties()
        {
            ...
            {
                dictionary.Add("ElementDefinition", new [] { Guid.Empty });
            }
            else
            {
                dictionary.Add("ElementDefinition", new [] { this.ElementDefinition.Iid });
            }
            ...
            dictionary.Add("ExcludeOption", this.ExcludeOption.Select(x => x.Iid));
            ...
            dictionary.Add("ParameterOverride", this.ParameterOverride.Select(x => x.Iid));
