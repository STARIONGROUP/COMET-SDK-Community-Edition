...
namespace CDP4Common.EngineeringModelData
{
    ...
    public partial class ElementDefinition : ElementBase
    {
        ...
        public override IDictionary<string, IEnumerable<Guid>> GetReferenceProperties()
        {
            ...
            dictionary.Add("ContainedElement", this.ContainedElement.Select(x => x.Iid));
            ...
            dictionary.Add("Parameter", this.Parameter.Select(x => x.Iid));
            dictionary.Add("ParameterGroup", this.ParameterGroup.Select(x => x.Iid));
            dictionary.Add("ReferencedElement", this.ReferencedElement.Select(x => x.Iid));
