...
namespace CDP4Common.EngineeringModelData
{
    ...
    public sealed partial class EngineeringModel : TopContainer
    {
        ...
        /// </param>
        public EngineeringModel(Guid iid, ConcurrentDictionary<Tuple<Guid, Guid?>, Lazy<Thing>> cache, Uri iDalUri) : base(iid, cache, iDalUri)
        {
            this.Book = new OrderedItemList<Book>(this, true);
            this.CommonFileStore = new ContainerList<CommonFileStore>(this);
            this.GenericNote = new ContainerList<EngineeringModelDataNote>(this);
        ...
        protected override Thing GenericClone(bool cloneContainedThings)
        {
            ...
            {
                clone.Book.AddRange(this.Book.Select(x => x.Clone(true)));
