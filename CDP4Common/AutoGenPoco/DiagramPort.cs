...
namespace CDP4Common.DiagramData
{
    ...
    public partial class DiagramPort : DiagramShape
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="DiagramPort"/> class.
        /// </summary>
        public DiagramPort()
        {
        }
        ...
        /// </param>
        public DiagramPort(Guid iid, ConcurrentDictionary<CacheKey, Lazy<CommonData.Thing>> cache, Uri iDalUri) : base(iid, cache, iDalUri)
        {
        }

        /// <summary>
        /// Creates and returns a copy of this <see cref="DiagramPort"/> for edit purpose.
        /// </summary>
        /// <param name="cloneContainedThings">A value that indicates whether the contained <see cref="Thing"/>s should be cloned or not.</param>
        /// <returns>
        /// A cloned instance of <see cref="DiagramPort"/>.
        /// </returns>
        protected override Thing GenericClone(bool cloneContainedThings)
        {
            var clone = (DiagramPort)this.MemberwiseClone();
        ...
        /// A cloned instance of <see cref="DiagramPort"/>.
        /// </returns>
        public new DiagramPort Clone(bool cloneContainedThings)
        {
            this.ChangeKind = ChangeKind.Update;
            return (DiagramPort)this.GenericClone(cloneContainedThings);
        }

        /// <summary>
        /// Validates the cardinalities of the properties of this <see cref="DiagramPort"/>.
        /// </summary>
        /// <returns>
        ...
        /// <summary>
        /// Resolve the properties of the current <see cref="DiagramPort"/> from its <see cref="DTO.Thing"/> counter-part
        /// </summary>
        ...
        internal override void ResolveProperties(DTO.Thing dtoThing)
        {
            ...
            var dto = dtoThing as DTO.DiagramPort;
            if (dto == null)
            {
                throw new InvalidOperationException($"The DTO type {dtoThing.GetType()} does not match the type of the current DiagramPort POCO.");
            }
        ...
        /// <summary>
        /// Generates a <see cref="DTO.Thing"/> from the current <see cref="DiagramPort"/>
        /// </summary>
        public override DTO.Thing ToDto()
        {
            var dto = new DTO.DiagramPort(this.Iid, this.RevisionNumber);
