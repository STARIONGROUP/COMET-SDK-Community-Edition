...
namespace CDP4Common.ReportingData
{
    ...
    public abstract partial class ContractDeviation : ModellingAnnotationItem
    {
        ...
        /// </param>
        protected ContractDeviation(Guid iid, ConcurrentDictionary<CacheKey, Lazy<CommonData.Thing>> cache, Uri iDalUri) : base(iid, cache, iDalUri)
        {
        }

        /// <summary>
        /// Creates and returns a copy of this <see cref="ContractDeviation"/> for edit purpose.
        /// </summary>
        /// <param name="cloneContainedThings">A value that indicates whether the contained <see cref="Thing"/>s should be cloned or not.</param>
        /// <returns>
        /// A cloned instance of <see cref="ContractDeviation"/>.
        /// </returns>
        public new ContractDeviation Clone(bool cloneContainedThings)
        {
        ...
        /// <summary>
        /// Validates the cardinalities of the properties of this <see cref="ContractDeviation"/>.
        /// </summary>
        /// <returns>
