// --------------------------------------------------------------------------------------------------------------------
// <copyright file="BooleanParameterType.cs" company="Starion Group S.A.">
...
namespace CDP4Common.SiteDirectoryData
{
    ...
    public partial class BooleanParameterType : ScalarParameterType
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="BooleanParameterType"/> class.
        /// </summary>
        ...
        /// </param>
        public BooleanParameterType(Guid iid, ConcurrentDictionary<CacheKey, Lazy<CommonData.Thing>> cache, Uri iDalUri) : base(iid, cache, iDalUri)
        {
        }

        /// <summary>
        /// Creates and returns a copy of this <see cref="BooleanParameterType"/> for edit purpose.
        /// </summary>
        /// <param name="cloneContainedThings">A value that indicates whether the contained <see cref="Thing"/>s should be cloned or not.</param>
        /// <returns>
        /// A cloned instance of <see cref="BooleanParameterType"/>.
        /// </returns>
        protected override Thing GenericClone(bool cloneContainedThings)
        {
            var clone = (BooleanParameterType)this.MemberwiseClone();
        ...
        /// A cloned instance of <see cref="BooleanParameterType"/>.
        /// </returns>
        public new BooleanParameterType Clone(bool cloneContainedThings)
        {
        ...
        /// <summary>
        /// Validates the cardinalities of the properties of this <see cref="BooleanParameterType"/>.
        /// </summary>
        /// <returns>
        ...
        /// <summary>
        /// Resolve the properties of the current <see cref="BooleanParameterType"/> from its <see cref="DTO.Thing"/> counter-part
        /// </summary>
        ...
        /// <summary>
        /// Generates a <see cref="DTO.Thing"/> from the current <see cref="BooleanParameterType"/>
        /// </summary>
        public override DTO.Thing ToDto()
        {
            var dto = new DTO.BooleanParameterType(this.Iid, this.RevisionNumber);
