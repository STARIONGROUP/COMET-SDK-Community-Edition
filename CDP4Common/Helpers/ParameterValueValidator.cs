...
namespace CDP4Common.Helpers
{
    ...
    public static class ParameterValueValidator
    {
        ...
        public static string Validate(object newValue, ParameterType parameterType, MeasurementScale scale = null, ILoggerFactory loggerFactory = null)
        {
            ...
            var result = parameterType.Validate(stringValue, scale, null, loggerFactory);
