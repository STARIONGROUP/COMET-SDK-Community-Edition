// ------------------------------------------------------------------------------------------------
// <copyright file="ParameterOverridePropertyAccessor.cs" company="Starion Group S.A.">
        ...
        public override void SetValue(string path, object value)
        {
            ...
            switch (propertyName)
            {
                ...
                case "parameter":
                    ...
                    if(!(value is Parameter parameterValue))
                    {
                        throw new ArgumentException($"The provided value is a {value.GetType().Name}, expected a Parameter" , nameof(value));
                    }
                ...
                case "valueset":
                    ...
                    switch(value)
                    {
                        case ParameterOverrideValueSet valueSetValue:
                            this.ValueSet.Clear();
