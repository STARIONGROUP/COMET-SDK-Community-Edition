// ------------------------------------------------------------------------------------------------
// <copyright file="EngineeringModelDataAnnotationPropertyAccessor.cs" company="Starion Group S.A.">
        ...
        public override void SetValue(string path, object value)
        {
            ...
            switch (propertyName)
            {
                ...
                case "author":
                    ...
                    if(!(value is Participant authorValue))
                    {
                ...
                case "discussion":
                    ...
                    switch(value)
                    {
                        case EngineeringModelDataDiscussionItem discussionValue:
                            this.Discussion.Clear();
                ...
                case "primaryannotatedthing":
                    ...
                    if(!(value is ModellingThingReference primaryAnnotatedThingValue))
                    {
                        throw new ArgumentException($"The provided value is a {value.GetType().Name}, expected a ModellingThingReference" , nameof(value));
                    }

                    this.PrimaryAnnotatedThing = primaryAnnotatedThingValue;
                    return;
                case "relatedthing":
                    pd.VerifyPropertyDescriptorForEnumerableReferenceProperty();
                    ...
                    switch(value)
                    {
                        case ModellingThingReference relatedThingValue:
                            this.RelatedThing.Clear();
