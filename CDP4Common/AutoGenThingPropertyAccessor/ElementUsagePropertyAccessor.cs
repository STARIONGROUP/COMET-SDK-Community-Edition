// ------------------------------------------------------------------------------------------------
// <copyright file="ElementUsagePropertyAccessor.cs" company="Starion Group S.A.">
        ...
        public override void SetValue(string path, object value)
        {
            ...
            switch (propertyName)
            {
                ...
                case "interfaceend":
                    ...
                    if(!(value is InterfaceEndKind interfaceEndValue || (value is string interfaceEndString) && InterfaceEndKind.TryParse(interfaceEndString, out interfaceEndValue)))
                    {
                        throw new ArgumentException($"The provided value is a {value.GetType().Name}, expected a InterfaceEndKind" , nameof(value));
                    }

                    this.InterfaceEnd = interfaceEndValue;
                    return;
                case "name":
                    base.SetValue(pd.Input, value);
                    return;
                ...
                case "parameteroverride":
                    ...
                    switch(value)
                    {
                        case ParameterOverride parameterOverrideValue:
                            this.ParameterOverride.Clear();
