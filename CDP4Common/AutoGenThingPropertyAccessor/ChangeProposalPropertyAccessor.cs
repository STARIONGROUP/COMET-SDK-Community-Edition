// ------------------------------------------------------------------------------------------------
// <copyright file="ChangeProposalPropertyAccessor.cs" company="Starion Group S.A.">
        ...
        public override void SetValue(string path, object value)
        {
            ...
            switch (propertyName)
            {
                ...
                case "changerequest":
                    ...
                    if(!(value is ChangeRequest changeRequestValue))
                    {
                        throw new ArgumentException($"The provided value is a {value.GetType().Name}, expected a ChangeRequest" , nameof(value));
                    }

                    this.ChangeRequest = changeRequestValue;
                    return;
                case "classification":
                    base.SetValue(pd.Input, value);
                    return;
