// ------------------------------------------------------------------------------------------------
// <copyright file="IdCorrespondencePropertyAccessor.cs" company="Starion Group S.A.">
        ...
        public override void SetValue(string path, object value)
        {
            ...
            switch (propertyName)
            {
                ...
                case "externalid":
                    ...
                    if(!(value is string externalIdValue))
                    {
                ...
                case "internalthing":
                    ...
                    if(!(value is Guid internalThingValue || (value is string internalThingString) && Guid.TryParse(internalThingString, out internalThingValue)))
                    {
                        throw new ArgumentException($"The provided value is a {value.GetType().Name}, expected a Guid" , nameof(value));
                    }

                    this.InternalThing = internalThingValue;
                    return;
                case "owner":
                    pd.VerifyPropertyDescriptorForReferenceProperty();
