// ------------------------------------------------------------------------------------------------
// <copyright file="ReferencerRulePropertyAccessor.cs" company="Starion Group S.A.">
        ...
        public override void SetValue(string path, object value)
        {
            ...
            switch (propertyName)
            {
                ...
                case "maxreferenced":
                    ...
                    if(!(value is int maxReferencedValue || (value is string maxReferencedString) && int.TryParse(maxReferencedString, out maxReferencedValue)))
                    {
                        throw new ArgumentException($"The provided value is a {value.GetType().Name}, expected a int" , nameof(value));
                    }

                    this.MaxReferenced = maxReferencedValue;
                    return;
                case "minreferenced":
                    pd.VerifyPropertyDescriptorForValueProperty();
                    ...
                    if(!(value is int minReferencedValue || (value is string minReferencedString) && int.TryParse(minReferencedString, out minReferencedValue)))
                    {
                        throw new ArgumentException($"The provided value is a {value.GetType().Name}, expected a int" , nameof(value));
                    }

                    this.MinReferenced = minReferencedValue;
                    return;
                case "name":
                    base.SetValue(pd.Input, value);
                    return;
                case "referencedcategory":
                    ...
                    switch(value)
                    {
                        case Category referencedCategoryValue:
                            this.ReferencedCategory.Clear();
                            this.ReferencedCategory.Add(referencedCategoryValue);
                            return;
                        case IEnumerable<Thing> thingValues:
                            this.ReferencedCategory.Clear();
                            this.ReferencedCategory.AddRange(thingValues.OfType<Category>());
                            return;
                        default: 
