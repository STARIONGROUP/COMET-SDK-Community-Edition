// ------------------------------------------------------------------------------------------------
// <copyright file="RequirementPropertyAccessor.cs" company="Starion Group S.A.">
        ...
        public override void SetValue(string path, object value)
        {
            ...
            switch (propertyName)
            {
                ...
                case "group":
                    ...
                    if(!(value is RequirementsGroup groupValue))
                    {
                        throw new ArgumentException($"The provided value is a {value.GetType().Name}, expected a RequirementsGroup" , nameof(value));
                    }
                ...
                case "parametricconstraint":
                    ...
                    switch(value)
                    {
                        case ParametricConstraint parametricConstraintValue:
                            this.ParametricConstraint.Clear();
