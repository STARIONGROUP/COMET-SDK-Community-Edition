// ------------------------------------------------------------------------------------------------
// <copyright file="DefinitionPropertyAccessor.cs" company="Starion Group S.A.">
        ...
        public override void SetValue(string path, object value)
        {
            ...
            switch (propertyName)
            {
                ...
                case "example":
                    ...
                    switch(value)
                    {
                        case string exampleValue:
                            this.Example.Clear();
                            this.Example.Add(exampleValue);
                            return;
                        case IEnumerable<string> exampleValues:
                            this.Example.Clear();
                            this.Example.AddRange(exampleValues);
                            return;
                        default: 
                ...
                case "note":
                    ...
                    switch(value)
                    {
                        case string noteValue:
                            this.Note.Clear();
                            this.Note.Add(noteValue);
                            return;
                        case IEnumerable<string> noteValues:
                            this.Note.Clear();
                            this.Note.AddRange(noteValues);
                            return;
                        default: 
                            throw new ArgumentException($"The provided value is a {value.GetType().Name}, expected a string or a collection of string" , nameof(value));
                    }
