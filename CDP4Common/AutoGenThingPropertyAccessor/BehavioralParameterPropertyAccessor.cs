// ------------------------------------------------------------------------------------------------
// <copyright file="BehavioralParameterPropertyAccessor.cs" company="RHEA System S.A.">
    ...
    public partial class BehavioralParameter
    {
        ...
        public override object QueryValue(string path)
        {
            ...
            switch (propertyName)
            {
                ...
                case "actor":
                    return base.QueryThingValues(pd.Input);
                case "behavioralparameterkind":
                    pd.VerifyPropertyDescriptorForValueProperty();
                    return this.BehavioralParameterKind;
                case "parameter":
        ...
        internal object QuerySentinelValue(string path, bool isCallerEmunerable)
        {
            ...
            switch (propertyName)
            {
                ...
                case "behavioralparameterkind":
                    pd.VerifyPropertyDescriptorForValueProperty();
                    return isCallerEmunerable ? (object) new List<BehavioralParameterKind>() : null;
                case "parameter":
                    pd.VerifyPropertyDescriptorForReferenceProperty();
