// ------------------------------------------------------------------------------------------------
// <copyright file="AliasPropertyAccessor.cs" company="Starion Group S.A.">
        ...
        public override void SetValue(string path, object value)
        {
            ...
            switch (propertyName)
            {
                ...
                case "issynonym":
                    ...
                    if(!(value is bool isSynonymValue || (value is string isSynonymString) && bool.TryParse(isSynonymString, out isSynonymValue)))
                    {
                        throw new ArgumentException($"The provided value is a {value.GetType().Name}, expected a bool" , nameof(value));
                    }

                    this.IsSynonym = isSynonymValue;
                    return;
                case "languagecode":
                    pd.VerifyPropertyDescriptorForValueProperty();
