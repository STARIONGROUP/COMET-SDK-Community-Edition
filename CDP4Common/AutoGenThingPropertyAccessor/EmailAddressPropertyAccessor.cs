// ------------------------------------------------------------------------------------------------
// <copyright file="EmailAddressPropertyAccessor.cs" company="Starion Group S.A.">
        ...
        public override void SetValue(string path, object value)
        {
            ...
            switch (propertyName)
            {
                ...
                case "vcardtype":
                    ...
                    if(!(value is VcardEmailAddressKind vcardTypeValue || (value is string vcardTypeString) && VcardEmailAddressKind.TryParse(vcardTypeString, out vcardTypeValue)))
                    {
                        throw new ArgumentException($"The provided value is a {value.GetType().Name}, expected a VcardEmailAddressKind" , nameof(value));
                    }

                    this.VcardType = vcardTypeValue;
                    return;
                default:
                    throw new ArgumentException($"The path:{path} does not exist on {this.ClassKind}");
            }
