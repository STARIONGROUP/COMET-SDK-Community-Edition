// ------------------------------------------------------------------------------------------------
// <copyright file="PersonPermissionPropertyAccessor.cs" company="Starion Group S.A.">
        ...
        public override void SetValue(string path, object value)
        {
            ...
            switch (propertyName)
            {
                ...
                case "accessright":
                    ...
                    if(!(value is PersonAccessRightKind accessRightValue || (value is string accessRightString) && PersonAccessRightKind.TryParse(accessRightString, out accessRightValue)))
                    {
                        throw new ArgumentException($"The provided value is a {value.GetType().Name}, expected a PersonAccessRightKind" , nameof(value));
                    }
