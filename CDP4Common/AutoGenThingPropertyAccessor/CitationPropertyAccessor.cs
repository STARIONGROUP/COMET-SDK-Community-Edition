// ------------------------------------------------------------------------------------------------
// <copyright file="CitationPropertyAccessor.cs" company="Starion Group S.A.">
        ...
        public override void SetValue(string path, object value)
        {
            ...
            switch (propertyName)
            {
                ...
                case "isadaptation":
                    ...
                    if(!(value is bool isAdaptationValue || (value is string isAdaptationString) && bool.TryParse(isAdaptationString, out isAdaptationValue)))
                    {
                        throw new ArgumentException($"The provided value is a {value.GetType().Name}, expected a bool" , nameof(value));
                    }

                    this.IsAdaptation = isAdaptationValue;
                    return;
                case "location":
                    pd.VerifyPropertyDescriptorForValueProperty();
                    ...
                    if(!(value is string locationValue))
                    {
                ...
                case "remark":
                    ...
                    if(!(value is string remarkValue))
                    {
                        throw new ArgumentException($"The provided value is a {value.GetType().Name}, expected a string" , nameof(value));
                    }
                ...
                case "source":
                    ...
                    if(!(value is ReferenceSource sourceValue))
                    {
