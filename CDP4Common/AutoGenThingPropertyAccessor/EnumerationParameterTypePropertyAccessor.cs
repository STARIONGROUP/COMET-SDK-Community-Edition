// ------------------------------------------------------------------------------------------------
// <copyright file="EnumerationParameterTypePropertyAccessor.cs" company="Starion Group S.A.">
        ...
        public override void SetValue(string path, object value)
        {
            ...
            switch (propertyName)
            {
                ...
                case "allowmultiselect":
                    ...
                    if(!(value is bool allowMultiSelectValue || (value is string allowMultiSelectString) && bool.TryParse(allowMultiSelectString, out allowMultiSelectValue)))
                    {
                        throw new ArgumentException($"The provided value is a {value.GetType().Name}, expected a bool" , nameof(value));
                    }

                    this.AllowMultiSelect = allowMultiSelectValue;
                    return;
                case "category":
                    base.SetValue(pd.Input, value);
                    return;
                ...
                case "valuedefinition":
                    ...
                    switch(value)
                    {
                        case EnumerationValueDefinition valueDefinitionValue:
                            this.ValueDefinition.Clear();
