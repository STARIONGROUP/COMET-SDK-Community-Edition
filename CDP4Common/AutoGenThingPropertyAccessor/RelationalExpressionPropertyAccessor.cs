// ------------------------------------------------------------------------------------------------
// <copyright file="RelationalExpressionPropertyAccessor.cs" company="Starion Group S.A.">
        ...
        public override void SetValue(string path, object value)
        {
            ...
            switch (propertyName)
            {
                ...
                case "relationaloperator":
                    ...
                    if(!(value is RelationalOperatorKind relationalOperatorValue || (value is string relationalOperatorString) && RelationalOperatorKind.TryParse(relationalOperatorString, out relationalOperatorValue)))
                    {
                        throw new ArgumentException($"The provided value is a {value.GetType().Name}, expected a RelationalOperatorKind" , nameof(value));
                    }

                    this.RelationalOperator = relationalOperatorValue;
                    return;
                case "scale":
                    pd.VerifyPropertyDescriptorForReferenceProperty();
                ...
                case "value":
                    ...
                    switch(value)
                    {
                        case string valueValue:
                            this.Value = new ValueArray<string>(new List<string>{ valueValue });
                            return;
                        case IEnumerable<string> valueValues:
                            this.Value = new ValueArray<string>(valueValues);
                            return;
                        default: 
