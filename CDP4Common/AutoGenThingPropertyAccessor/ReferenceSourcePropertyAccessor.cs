// ------------------------------------------------------------------------------------------------
// <copyright file="ReferenceSourcePropertyAccessor.cs" company="Starion Group S.A.">
        ...
        public override void SetValue(string path, object value)
        {
            ...
            switch (propertyName)
            {
                ...
                case "author":
                    ...
                    if(!(value is string authorValue))
                    {
                ...
                case "language":
                    ...
                    if(!(value is string languageValue))
                    {
                        throw new ArgumentException($"The provided value is a {value.GetType().Name}, expected a string" , nameof(value));
                    }
                ...
                case "publicationyear":
                    ...
                    if(!(value is int publicationYearValue || (value is string publicationYearString) && int.TryParse(publicationYearString, out publicationYearValue)))
                    {
                        throw new ArgumentException($"The provided value is a {value.GetType().Name}, expected a int" , nameof(value));
                    }

                    this.PublicationYear = publicationYearValue;
                    return;
                case "publishedin":
                    pd.VerifyPropertyDescriptorForReferenceProperty();
                ...
                case "publisher":
                    ...
                    if(!(value is Organization publisherValue))
                    {
                ...
                case "versiondate":
                    ...
                    if(!(value is DateTime versionDateValue || (value is string versionDateString) && DateTime.TryParse(versionDateString, out versionDateValue)))
                    {
                        throw new ArgumentException($"The provided value is a {value.GetType().Name}, expected a DateTime" , nameof(value));
                    }

                    this.VersionDate = versionDateValue;
                    return;
                case "versionidentifier":
                    pd.VerifyPropertyDescriptorForValueProperty();
                    ...
                    if(!(value is string versionIdentifierValue))
                    {
                        throw new ArgumentException($"The provided value is a {value.GetType().Name}, expected a string" , nameof(value));
                    }

                    this.VersionIdentifier = versionIdentifierValue;
                    return;
                default:
                    throw new ArgumentException($"The path:{path} does not exist on {this.ClassKind}");
            }
