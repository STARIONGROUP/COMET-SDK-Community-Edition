// ------------------------------------------------------------------------------------------------
// <copyright file="ContractChangeNoticePropertyAccessor.cs" company="Starion Group S.A.">
        ...
        public override void SetValue(string path, object value)
        {
            ...
            switch (propertyName)
            {
                ...
                case "changeproposal":
                    ...
                    if(!(value is ChangeProposal changeProposalValue))
                    {
                        throw new ArgumentException($"The provided value is a {value.GetType().Name}, expected a ChangeProposal" , nameof(value));
                    }

                    this.ChangeProposal = changeProposalValue;
                    return;
                case "classification":
                    base.SetValue(pd.Input, value);
                    return;
