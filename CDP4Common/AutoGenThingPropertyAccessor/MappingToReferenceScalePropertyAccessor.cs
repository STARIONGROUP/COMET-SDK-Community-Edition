// ------------------------------------------------------------------------------------------------
// <copyright file="MappingToReferenceScalePropertyAccessor.cs" company="Starion Group S.A.">
        ...
        public override void SetValue(string path, object value)
        {
            ...
            switch (propertyName)
            {
                ...
                case "dependentscalevalue":
                    ...
                    if(!(value is ScaleValueDefinition dependentScaleValueValue))
                    {
                        throw new ArgumentException($"The provided value is a {value.GetType().Name}, expected a ScaleValueDefinition" , nameof(value));
                    }

                    this.DependentScaleValue = dependentScaleValueValue;
                    return;
                case "referencescalevalue":
                    pd.VerifyPropertyDescriptorForReferenceProperty();
                    ...
                    if(!(value is ScaleValueDefinition referenceScaleValueValue))
                    {
                        throw new ArgumentException($"The provided value is a {value.GetType().Name}, expected a ScaleValueDefinition" , nameof(value));
                    }

                    this.ReferenceScaleValue = referenceScaleValueValue;
                    return;
                default:
                    throw new ArgumentException($"The path:{path} does not exist on {this.ClassKind}");
            }
