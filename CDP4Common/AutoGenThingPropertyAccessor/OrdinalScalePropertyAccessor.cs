// ------------------------------------------------------------------------------------------------
// <copyright file="OrdinalScalePropertyAccessor.cs" company="Starion Group S.A.">
        ...
        public override void SetValue(string path, object value)
        {
            ...
            switch (propertyName)
            {
                ...
                case "useshortnamevalues":
                    ...
                    if(!(value is bool useShortNameValuesValue || (value is string useShortNameValuesString) && bool.TryParse(useShortNameValuesString, out useShortNameValuesValue)))
                    {
                        throw new ArgumentException($"The provided value is a {value.GetType().Name}, expected a bool" , nameof(value));
                    }

                    this.UseShortNameValues = useShortNameValuesValue;
                    return;
                case "valuedefinition":
                    base.SetValue(pd.Input, value);
                    return;
