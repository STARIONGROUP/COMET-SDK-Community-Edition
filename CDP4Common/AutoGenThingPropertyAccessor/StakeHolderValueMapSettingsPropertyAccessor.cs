// ------------------------------------------------------------------------------------------------
// <copyright file="StakeHolderValueMapSettingsPropertyAccessor.cs" company="Starion Group S.A.">
        ...
        public override void SetValue(string path, object value)
        {
            ...
            switch (propertyName)
            {
                ...
                case "goaltovaluegrouprelationship":
                    ...
                    if(!(value is BinaryRelationshipRule goalToValueGroupRelationshipValue))
                    {
                        throw new ArgumentException($"The provided value is a {value.GetType().Name}, expected a BinaryRelationshipRule" , nameof(value));
                    }

                    this.GoalToValueGroupRelationship = goalToValueGroupRelationshipValue;
                    return;
                case "stakeholdervaluetorequirementrelationship":
                    pd.VerifyPropertyDescriptorForReferenceProperty();
                    ...
                    if(!(value is BinaryRelationshipRule stakeholderValueToRequirementRelationshipValue))
                    {
                        throw new ArgumentException($"The provided value is a {value.GetType().Name}, expected a BinaryRelationshipRule" , nameof(value));
                    }

                    this.StakeholderValueToRequirementRelationship = stakeholderValueToRequirementRelationshipValue;
                    return;
                case "valuegrouptostakeholdervaluerelationship":
                    pd.VerifyPropertyDescriptorForReferenceProperty();
                    ...
                    if(!(value is BinaryRelationshipRule valueGroupToStakeholderValueRelationshipValue))
                    {
                        throw new ArgumentException($"The provided value is a {value.GetType().Name}, expected a BinaryRelationshipRule" , nameof(value));
                    }

                    this.ValueGroupToStakeholderValueRelationship = valueGroupToStakeholderValueRelationshipValue;
                    return;
                default:
                    throw new ArgumentException($"The path:{path} does not exist on {this.ClassKind}");
            }
