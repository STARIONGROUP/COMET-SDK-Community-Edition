// ------------------------------------------------------------------------------------------------
// <copyright file="ParticipantPermissionPropertyAccessor.cs" company="Starion Group S.A.">
        ...
        public override void SetValue(string path, object value)
        {
            ...
            switch (propertyName)
            {
                ...
                case "accessright":
                    ...
                    if(!(value is ParticipantAccessRightKind accessRightValue || (value is string accessRightString) && ParticipantAccessRightKind.TryParse(accessRightString, out accessRightValue)))
                    {
                        throw new ArgumentException($"The provided value is a {value.GetType().Name}, expected a ParticipantAccessRightKind" , nameof(value));
                    }

                    this.AccessRight = accessRightValue;
                    return;
                case "isdeprecated":
                    pd.VerifyPropertyDescriptorForValueProperty();
                ...
                case "objectclass":
                    ...
                    if(!(value is ClassKind objectClassValue || (value is string objectClassString) && ClassKind.TryParse(objectClassString, out objectClassValue)))
                    {
                        throw new ArgumentException($"The provided value is a {value.GetType().Name}, expected a ClassKind" , nameof(value));
                    }
