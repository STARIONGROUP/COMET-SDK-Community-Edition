// ------------------------------------------------------------------------------------------------
// <copyright file="ParametricConstraintPropertyAccessor.cs" company="Starion Group S.A.">
        ...
        public override void SetValue(string path, object value)
        {
            ...
            switch (propertyName)
            {
                ...
                case "expression":
                    ...
                    switch(value)
                    {
                        case BooleanExpression expressionValue:
                            this.Expression.Clear();
                ...
                case "topexpression":
                    ...
                    if(!(value is BooleanExpression topExpressionValue))
                    {
                        throw new ArgumentException($"The provided value is a {value.GetType().Name}, expected a BooleanExpression" , nameof(value));
                    }

                    this.TopExpression = topExpressionValue;
                    return;
                default:
                    throw new ArgumentException($"The path:{path} does not exist on {this.ClassKind}");
            }
