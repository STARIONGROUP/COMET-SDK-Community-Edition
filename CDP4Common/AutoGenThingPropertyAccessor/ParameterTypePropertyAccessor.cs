// ------------------------------------------------------------------------------------------------
// <copyright file="ParameterTypePropertyAccessor.cs" company="Starion Group S.A.">
        ...
        public override void SetValue(string path, object value)
        {
            ...
            switch (propertyName)
            {
                ...
                case "numberofvalues":
                    ...
                    if(!(value is int numberOfValuesValue || (value is string numberOfValuesString) && int.TryParse(numberOfValuesString, out numberOfValuesValue)))
                    {
                        throw new ArgumentException($"The provided value is a {value.GetType().Name}, expected a int" , nameof(value));
                    }

                    this.NumberOfValues = numberOfValuesValue;
                    return;
                case "shortname":
                    base.SetValue(pd.Input, value);
                    return;
                case "symbol":
                    ...
                    if(!(value is string symbolValue))
                    {
