// ------------------------------------------------------------------------------------------------
// <copyright file="PossibleFiniteStateListPropertyAccessor.cs" company="Starion Group S.A.">
        ...
        public override void SetValue(string path, object value)
        {
            ...
            switch (propertyName)
            {
                ...
                case "defaultstate":
                    ...
                    if(!(value is PossibleFiniteState defaultStateValue))
                    {
                        throw new ArgumentException($"The provided value is a {value.GetType().Name}, expected a PossibleFiniteState" , nameof(value));
                    }

                    this.DefaultState = defaultStateValue;
                    return;
                case "definition":
                    base.SetValue(pd.Input, value);
                    return;
