// ------------------------------------------------------------------------------------------------
// <copyright file="ThingReferencePropertyAccessor.cs" company="Starion Group S.A.">
        ...
        public override void SetValue(string path, object value)
        {
            ...
            switch (propertyName)
            {
                ...
                case "referencedrevisionnumber":
                    ...
                    if(!(value is int referencedRevisionNumberValue || (value is string referencedRevisionNumberString) && int.TryParse(referencedRevisionNumberString, out referencedRevisionNumberValue)))
                    {
                        throw new ArgumentException($"The provided value is a {value.GetType().Name}, expected a int" , nameof(value));
                    }

                    this.ReferencedRevisionNumber = referencedRevisionNumberValue;
                    return;
                case "referencedthing":
                    pd.VerifyPropertyDescriptorForReferenceProperty();
