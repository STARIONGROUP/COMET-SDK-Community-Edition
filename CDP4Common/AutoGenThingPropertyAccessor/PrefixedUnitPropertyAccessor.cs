// ------------------------------------------------------------------------------------------------
// <copyright file="PrefixedUnitPropertyAccessor.cs" company="Starion Group S.A.">
        ...
        public override void SetValue(string path, object value)
        {
            ...
            switch (propertyName)
            {
                ...
                case "prefix":
                    ...
                    if(!(value is UnitPrefix prefixValue))
                    {
                        throw new ArgumentException($"The provided value is a {value.GetType().Name}, expected a UnitPrefix" , nameof(value));
                    }
