// ------------------------------------------------------------------------------------------------
// <copyright file="ArchitectureDiagramPropertyAccessor.cs" company="RHEA System S.A.">
        ...
        public override object QueryValue(string path)
        {
            ...
            switch (propertyName)
            {
                ...
                case "toparchitectureelement":
                    ...
                    if (pd.Next == null)
                    {
                        return this.TopArchitectureElement;
                    }

                    if (this.TopArchitectureElement != null)
                    {
                        return this.TopArchitectureElement.QueryValue(pd.Next.Input);
                    }

                    var sentineltoparchitectureelement = new ArchitectureElement(Guid.Empty, null, null);
                    return sentineltoparchitectureelement.QuerySentinelValue(pd.Next.Input, false);
                default:
        ...
        internal object QuerySentinelValue(string path, bool isCallerEmunerable)
        {
            ...
            switch (propertyName)
            {
                ...
                case "toparchitectureelement":
                    ...
                    if (pd.Next != null)
                    {
                        return new ArchitectureElement(Guid.Empty, null, null).QuerySentinelValue(pd.Next.Input, true);
                    }

                    return isCallerEmunerable ? (object) new List<ArchitectureElement>() : default(ArchitectureElement);
                default:
                    throw new ArgumentException($"The path:{path} does not exist on {this.ClassKind}");
            }
        }
