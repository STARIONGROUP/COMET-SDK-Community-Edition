// ------------------------------------------------------------------------------------------------
// <copyright file="CompoundParameterTypePropertyAccessor.cs" company="Starion Group S.A.">
        ...
        public override void SetValue(string path, object value)
        {
            ...
            switch (propertyName)
            {
                ...
                case "component":
                    ...
                    switch(value)
                    {
                        case ParameterTypeComponent componentValue:
                            this.Component.Clear();
                ...
                case "isfinalized":
                    ...
                    if(!(value is bool isFinalizedValue || (value is string isFinalizedString) && bool.TryParse(isFinalizedString, out isFinalizedValue)))
                    {
                        throw new ArgumentException($"The provided value is a {value.GetType().Name}, expected a bool" , nameof(value));
                    }

                    this.IsFinalized = isFinalizedValue;
                    return;
                case "name":
                    base.SetValue(pd.Input, value);
                    return;
