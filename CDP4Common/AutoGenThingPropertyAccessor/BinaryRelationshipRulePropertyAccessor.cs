// ------------------------------------------------------------------------------------------------
// <copyright file="BinaryRelationshipRulePropertyAccessor.cs" company="Starion Group S.A.">
        ...
        public override void SetValue(string path, object value)
        {
            ...
            switch (propertyName)
            {
                ...
                case "forwardrelationshipname":
                    ...
                    if(value == null)
                    {
                        this.ForwardRelationshipName = null;
                        return;
                    }

                    if(!(value is string forwardRelationshipNameValue))
                    {
                        throw new ArgumentException($"The provided value is a {value.GetType().Name}, expected a string" , nameof(value));
                    }

                    this.ForwardRelationshipName = forwardRelationshipNameValue;
                    return;
                case "hyperlink":
                    base.SetValue(pd.Input, value);
                    return;
                case "inverserelationshipname":
                    ...
                    if(!(value is string inverseRelationshipNameValue))
                    {
                        throw new ArgumentException($"The provided value is a {value.GetType().Name}, expected a string" , nameof(value));
                    }

                    this.InverseRelationshipName = inverseRelationshipNameValue;
                    return;
                case "isdeprecated":
                    base.SetValue(pd.Input, value);
                    return;
                ...
                case "sourcecategory":
                    ...
                    if(!(value is Category sourceCategoryValue))
                    {
                        throw new ArgumentException($"The provided value is a {value.GetType().Name}, expected a Category" , nameof(value));
                    }

                    this.SourceCategory = sourceCategoryValue;
                    return;
                case "targetcategory":
                    pd.VerifyPropertyDescriptorForReferenceProperty();
                    ...
                    if(!(value is Category targetCategoryValue))
                    {
                        throw new ArgumentException($"The provided value is a {value.GetType().Name}, expected a Category" , nameof(value));
                    }

                    this.TargetCategory = targetCategoryValue;
                    return;
                default:
                    throw new ArgumentException($"The path:{path} does not exist on {this.ClassKind}");
            }
