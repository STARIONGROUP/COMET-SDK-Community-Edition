// ------------------------------------------------------------------------------------------------
// <copyright file="ApprovalPropertyAccessor.cs" company="Starion Group S.A.">
        ...
        public override void SetValue(string path, object value)
        {
            ...
            switch (propertyName)
            {
                ...
                case "classification":
                    ...
                    if(!(value is AnnotationApprovalKind classificationValue || (value is string classificationString) && AnnotationApprovalKind.TryParse(classificationString, out classificationValue)))
                    {
                        throw new ArgumentException($"The provided value is a {value.GetType().Name}, expected a AnnotationApprovalKind" , nameof(value));
                    }
