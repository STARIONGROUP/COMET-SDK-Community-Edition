// ------------------------------------------------------------------------------------------------
// <copyright file="BehaviorEquatable.cs" company="RHEA System S.A.">
...
namespace CDP4Common.DTO.Equatable
{
    ...
    /// <summary>
    /// An extension class for the <see cref="Behavior"/> to support the computation
    /// of property based equality
    /// </summary>
    public static class BehaviorEquatable
    {
        /// <summary>
        /// Determines whether 2 <see cref="Behavior"/> objects are the same
        /// by comparing all the properties
        /// </summary>
        /// <param name="me">
        /// The current <see cref="Behavior"/>
        /// </param>
        /// <param name="other">
        /// The <see cref="Behavior"/> that the <paramref name="me"/> is
        /// compared to
        /// </param>
        /// <returns>
        /// returns true when all the properties of the <see cref="Behavior"/> objects
        /// have the same value
        /// </returns>
        public static bool ArePropertiesEqual(this Behavior me, Behavior other)
        {
            ...
            if (!me.BehavioralModelKind.Equals(other.BehavioralModelKind)) return false;

            if (!me.BehavioralParameter.OrderBy(x => x).SequenceEqual(other.BehavioralParameter.OrderBy(x => x))) return false;
            ...
            if (me.Script == null && other.Script != null) return false;
            if (me.Script != null && !me.Script.Equals(other.Script)) return false;
