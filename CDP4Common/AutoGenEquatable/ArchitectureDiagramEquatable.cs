// ------------------------------------------------------------------------------------------------
// <copyright file="ArchitectureDiagramEquatable.cs" company="RHEA System S.A.">
...
namespace CDP4Common.DTO.Equatable
{
    ...
    /// <summary>
    /// An extension class for the <see cref="ArchitectureDiagram"/> to support the computation
    /// of property based equality
    /// </summary>
    public static class ArchitectureDiagramEquatable
    {
        /// <summary>
        /// Determines whether 2 <see cref="ArchitectureDiagram"/> objects are the same
        /// by comparing all the properties
        /// </summary>
        /// <param name="me">
        /// The current <see cref="ArchitectureDiagram"/>
        /// </param>
        /// <param name="other">
        /// The <see cref="ArchitectureDiagram"/> that the <paramref name="me"/> is
        /// compared to
        /// </param>
        /// <returns>
        /// returns true when all the properties of the <see cref="ArchitectureDiagram"/> objects
        /// have the same value
        /// </returns>
        public static bool ArePropertiesEqual(this ArchitectureDiagram me, ArchitectureDiagram other)
        {
