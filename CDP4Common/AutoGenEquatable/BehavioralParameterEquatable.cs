// ------------------------------------------------------------------------------------------------
// <copyright file="BehavioralParameterEquatable.cs" company="RHEA System S.A.">
...
namespace CDP4Common.DTO.Equatable
{
    ...
    /// <summary>
    /// An extension class for the <see cref="BehavioralParameter"/> to support the computation
    /// of property based equality
    /// </summary>
    public static class BehavioralParameterEquatable
    {
        /// <summary>
        /// Determines whether 2 <see cref="BehavioralParameter"/> objects are the same
        /// by comparing all the properties
        /// </summary>
        /// <param name="me">
        /// The current <see cref="BehavioralParameter"/>
        /// </param>
        /// <param name="other">
        /// The <see cref="BehavioralParameter"/> that the <paramref name="me"/> is
        /// compared to
        /// </param>
        /// <returns>
        /// returns true when all the properties of the <see cref="BehavioralParameter"/> objects
        /// have the same value
        /// </returns>
        public static bool ArePropertiesEqual(this BehavioralParameter me, BehavioralParameter other)
        {
            ...
            if (!me.BehavioralParameterKind.Equals(other.BehavioralParameterKind)) return false;

            if (!me.Parameter.Equals(other.Parameter)) return false;

            if (me.VariableName == null && other.VariableName != null) return false;
            if (me.VariableName != null && !me.VariableName.Equals(other.VariableName)) return false;
