// ------------------------------------------------------------------------------------------------
// <copyright file="DiagramFrameEquatable.cs" company="RHEA System S.A.">
...
namespace CDP4Common.DTO.Equatable
{
    ...
    /// <summary>
    /// An extension class for the <see cref="DiagramFrame"/> to support the computation
    /// of property based equality
    /// </summary>
    public static class DiagramFrameEquatable
    {
        /// <summary>
        /// Determines whether 2 <see cref="DiagramFrame"/> objects are the same
        /// by comparing all the properties
        /// </summary>
        /// <param name="me">
        /// The current <see cref="DiagramFrame"/>
        /// </param>
        /// <param name="other">
        /// The <see cref="DiagramFrame"/> that the <paramref name="me"/> is
        /// compared to
        /// </param>
        /// <returns>
        /// returns true when all the properties of the <see cref="DiagramFrame"/> objects
        /// have the same value
        /// </returns>
        public static bool ArePropertiesEqual(this DiagramFrame me, DiagramFrame other)
        {
