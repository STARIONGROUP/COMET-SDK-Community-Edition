// ------------------------------------------------------------------------------------------------
// <copyright file="ArchitectureElementEquatable.cs" company="RHEA System S.A.">
...
namespace CDP4Common.DTO.Equatable
{
    ...
    /// <summary>
    /// An extension class for the <see cref="ArchitectureElement"/> to support the computation
    /// of property based equality
    /// </summary>
    public static class ArchitectureElementEquatable
    {
        /// <summary>
        /// Determines whether 2 <see cref="ArchitectureElement"/> objects are the same
        /// by comparing all the properties
        /// </summary>
        /// <param name="me">
        /// The current <see cref="ArchitectureElement"/>
        /// </param>
        /// <param name="other">
        /// The <see cref="ArchitectureElement"/> that the <paramref name="me"/> is
        /// compared to
        /// </param>
        /// <returns>
        /// returns true when all the properties of the <see cref="ArchitectureElement"/> objects
        /// have the same value
        /// </returns>
        public static bool ArePropertiesEqual(this ArchitectureElement me, ArchitectureElement other)
        {
