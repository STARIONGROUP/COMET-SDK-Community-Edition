// ------------------------------------------------------------------------------------------------
// <copyright file="AttachmentEquatable.cs" company="RHEA System S.A.">
...
namespace CDP4Common.DTO.Equatable
{
    ...
    /// <summary>
    /// An extension class for the <see cref="Attachment"/> to support the computation
    /// of property based equality
    /// </summary>
    public static class AttachmentEquatable
    {
        /// <summary>
        /// Determines whether 2 <see cref="Attachment"/> objects are the same
        /// by comparing all the properties
        /// </summary>
        /// <param name="me">
        /// The current <see cref="Attachment"/>
        /// </param>
        /// <param name="other">
        /// The <see cref="Attachment"/> that the <paramref name="me"/> is
        /// compared to
        /// </param>
        /// <returns>
        /// returns true when all the properties of the <see cref="Attachment"/> objects
        /// have the same value
        /// </returns>
        public static bool ArePropertiesEqual(this Attachment me, Attachment other)
        {
            ...
            if (me.FileName == null && other.FileName != null) return false;
            if (me.FileName != null && !me.FileName.Equals(other.FileName)) return false;
