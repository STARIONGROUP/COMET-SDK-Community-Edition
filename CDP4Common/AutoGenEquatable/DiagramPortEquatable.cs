// ------------------------------------------------------------------------------------------------
// <copyright file="DiagramPortEquatable.cs" company="RHEA System S.A.">
...
namespace CDP4Common.DTO.Equatable
{
    ...
    /// <summary>
    /// An extension class for the <see cref="DiagramPort"/> to support the computation
    /// of property based equality
    /// </summary>
    public static class DiagramPortEquatable
    {
        /// <summary>
        /// Determines whether 2 <see cref="DiagramPort"/> objects are the same
        /// by comparing all the properties
        /// </summary>
        /// <param name="me">
        /// The current <see cref="DiagramPort"/>
        /// </param>
        /// <param name="other">
        /// The <see cref="DiagramPort"/> that the <paramref name="me"/> is
        /// compared to
        /// </param>
        /// <returns>
        /// returns true when all the properties of the <see cref="DiagramPort"/> objects
        /// have the same value
        /// </returns>
        public static bool ArePropertiesEqual(this DiagramPort me, DiagramPort other)
        {
