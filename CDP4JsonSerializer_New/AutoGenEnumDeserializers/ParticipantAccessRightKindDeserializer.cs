// --------------------------------------------------------------------------------------------------------------------
// <copyright file="ParticipantAccessRightKindDeserializer.cs" company="RHEA System S.A.">
...
namespace CDP4JsonSerializer_SystemTextJson
{
    ...
    internal static class ParticipantAccessRightKindDeserializer
    {
        ...
        internal static ParticipantAccessRightKind Deserialize(JsonElement jsonElement)
        {
            ...
            if(Enum.TryParse(value, out ParticipantAccessRightKind result))
            {
                return result;
            }
            throw new ArgumentException($"{value} is not a valid ParticipantAccessRightKind", nameof(value));
        }        
    }
}
