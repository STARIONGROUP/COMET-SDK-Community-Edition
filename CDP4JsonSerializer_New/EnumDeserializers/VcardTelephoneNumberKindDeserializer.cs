// --------------------------------------------------------------------------------------------------------------------
// <copyright file="VcardTelephoneNumberKindDeserializer.cs" company="RHEA System S.A.">
...
namespace CDP4JsonSerializer_SystemTextJson.EnumDeserializers
{
    ...
    internal static class VcardTelephoneNumberKindDeserializer
    {
        ...
        internal static VcardTelephoneNumberKind Deserialize(JsonElement jsonElement)
        {
            ...
            if(Enum.TryParse(value, out VcardTelephoneNumberKind result))
            {
                return result;
            }
            throw new ArgumentException($"{value} is not a valid VcardTelephoneNumberKind", nameof(value));
        }        
    }
}
