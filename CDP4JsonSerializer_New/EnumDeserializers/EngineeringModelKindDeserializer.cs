// --------------------------------------------------------------------------------------------------------------------
// <copyright file="EngineeringModelKindDeserializer.cs" company="RHEA System S.A.">
...
namespace CDP4JsonSerializer_SystemTextJson.EnumDeserializers
{
    ...
    internal static class EngineeringModelKindDeserializer
    {
        ...
        internal static EngineeringModelKind Deserialize(JsonElement jsonElement)
        {
            ...
            if(Enum.TryParse(value, out EngineeringModelKind result))
            {
                return result;
            }
            throw new ArgumentException($"{value} is not a valid EngineeringModelKind", nameof(value));
        }        
    }
}
