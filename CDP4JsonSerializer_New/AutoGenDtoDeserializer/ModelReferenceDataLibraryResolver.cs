...
namespace CDP4JsonSerializer_SystemTextJson
{
    ...
    public static class ModelReferenceDataLibraryResolver
    {
        ...
        public static CDP4Common.DTO.ModelReferenceDataLibrary FromJsonObject(JsonElement jsonElement)
        {
            ...
            {
                throw new DeSerializationException("the mandatory revisionNumber property is not available, the ModelReferenceDataLibraryResolver cannot be used to deserialize this JsonElement");
            }
