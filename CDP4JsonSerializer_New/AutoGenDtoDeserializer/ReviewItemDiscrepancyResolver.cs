...
namespace CDP4JsonSerializer_SystemTextJson
{
    ...
    public static class ReviewItemDiscrepancyResolver
    {
        ...
        public static CDP4Common.DTO.ReviewItemDiscrepancy FromJsonObject(JsonElement jsonElement)
        {
            ...
            {
                throw new DeSerializationException("the mandatory revisionNumber property is not available, the ReviewItemDiscrepancyResolver cannot be used to deserialize this JsonElement");
            }
