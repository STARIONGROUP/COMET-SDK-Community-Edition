...
namespace CDP4JsonSerializer_SystemTextJson
{
    ...
    public static class EmailAddressResolver
    {
        ...
        public static CDP4Common.DTO.EmailAddress FromJsonObject(JsonElement jsonElement)
        {
            ...
            {
                throw new DeSerializationException("the mandatory revisionNumber property is not available, the EmailAddressResolver cannot be used to deserialize this JsonElement");
            }
