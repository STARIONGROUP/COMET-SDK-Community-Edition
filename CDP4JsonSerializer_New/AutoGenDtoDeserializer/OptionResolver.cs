...
namespace CDP4JsonSerializer_SystemTextJson
{
    ...
    public static class OptionResolver
    {
        ...
        public static CDP4Common.DTO.Option FromJsonObject(JsonElement jsonElement)
        {
            ...
            {
                throw new DeSerializationException("the mandatory revisionNumber property is not available, the OptionResolver cannot be used to deserialize this JsonElement");
            }
            ...
            if (jsonElement.TryGetProperty("nestedElement"u8, out var nestedElementProperty))
            {
