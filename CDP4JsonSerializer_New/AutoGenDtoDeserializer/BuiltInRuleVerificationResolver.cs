...
namespace CDP4JsonSerializer_SystemTextJson
{
    ...
    {
        /// <summary>
        /// Instantiate and deserialize the properties of a <see cref="BuiltInRuleVerification"/>
        /// </summary>
        /// <param name="jObject">The <see cref="JsonElement"/> containing the data</param>
        /// <returns>The <see cref="BuiltInRuleVerification"/> to instantiate</returns>
        public static CDP4Common.DTO.BuiltInRuleVerification FromJsonObject(JsonElement jObject)
        {
