...
namespace CDP4JsonSerializer_SystemTextJson
{
    ...
    public static class StakeholderResolver
    {
        ...
        public static CDP4Common.DTO.Stakeholder FromJsonObject(JsonElement jsonElement)
        {
            ...
            {
                throw new DeSerializationException("the mandatory revisionNumber property is not available, the StakeholderResolver cannot be used to deserialize this JsonElement");
            }
