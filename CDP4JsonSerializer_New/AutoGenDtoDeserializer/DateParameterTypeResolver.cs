...
namespace CDP4JsonSerializer_SystemTextJson
{
    ...
    public static class DateParameterTypeResolver
    {
        ...
        public static CDP4Common.DTO.DateParameterType FromJsonObject(JsonElement jsonElement)
        {
            ...
            {
                throw new DeSerializationException("the mandatory revisionNumber property is not available, the DateParameterTypeResolver cannot be used to deserialize this JsonElement");
            }

            var dateParameterType = new CDP4Common.DTO.DateParameterType(iid.GetGuid(), revisionNumber.GetInt32());
            ...
            if (jsonElement.TryGetProperty("isDeprecated"u8, out var isDeprecatedProperty))
            {
                ...
                {
                    Logger.Debug("The non-nullabale isDeprecated property of the dateParameterType {id} is null", dateParameterType.Iid);
                }
                else
                {
            ...
            if (jsonElement.TryGetProperty("modifiedOn"u8, out var modifiedOnProperty))
            {
                ...
                {
                    Logger.Debug("The non-nullabale modifiedOn property of the dateParameterType {id} is null", dateParameterType.Iid);
                }
                else
                {
            ...
            if (jsonElement.TryGetProperty("name"u8, out var nameProperty))
            {
                ...
                {
                    Logger.Debug("The non-nullabale name property of the dateParameterType {id} is null", dateParameterType.Iid);
                }
                else
                {
            ...
            if (jsonElement.TryGetProperty("shortName"u8, out var shortNameProperty))
            {
                ...
                {
                    Logger.Debug("The non-nullabale shortName property of the dateParameterType {id} is null", dateParameterType.Iid);
                }
                else
                {
            ...
            if (jsonElement.TryGetProperty("symbol"u8, out var symbolProperty))
            {
                ...
                {
                    Logger.Debug("The non-nullabale symbol property of the dateParameterType {id} is null", dateParameterType.Iid);
                }
                else
                {
            ...
            if (jsonElement.TryGetProperty("thingPreference"u8, out var thingPreferenceProperty))
            {
                ...
                {
                    Logger.Debug("The non-nullabale thingPreference property of the dateParameterType {id} is null", dateParameterType.Iid);
                }
                else
                {
