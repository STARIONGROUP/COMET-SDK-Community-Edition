...
namespace CDP4JsonSerializer_SystemTextJson
{
    ...
    public static class DiagramCanvasResolver
    {
        ...
        public static CDP4Common.DTO.DiagramCanvas FromJsonObject(JsonElement jsonElement)
        {
            ...
            {
                throw new DeSerializationException("the mandatory revisionNumber property is not available, the DiagramCanvasResolver cannot be used to deserialize this JsonElement");
            }
