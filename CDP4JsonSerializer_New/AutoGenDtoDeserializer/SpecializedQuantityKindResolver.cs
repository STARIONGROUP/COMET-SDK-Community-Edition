...
namespace CDP4JsonSerializer_SystemTextJson
{
    ...
    public static class SpecializedQuantityKindResolver
    {
        ...
        public static CDP4Common.DTO.SpecializedQuantityKind FromJsonObject(JsonElement jsonElement)
        {
            ...
            {
                throw new DeSerializationException("the mandatory revisionNumber property is not available, the SpecializedQuantityKindResolver cannot be used to deserialize this JsonElement");
            }
