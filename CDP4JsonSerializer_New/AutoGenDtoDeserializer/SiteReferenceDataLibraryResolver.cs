...
namespace CDP4JsonSerializer_SystemTextJson
{
    ...
    public static class SiteReferenceDataLibraryResolver
    {
        ...
        public static CDP4Common.DTO.SiteReferenceDataLibrary FromJsonObject(JsonElement jsonElement)
        {
            ...
            {
                throw new DeSerializationException("the mandatory revisionNumber property is not available, the SiteReferenceDataLibraryResolver cannot be used to deserialize this JsonElement");
            }
