...
namespace CDP4JsonSerializer_SystemTextJson
{
    ...
    public static class RuleVerificationListResolver
    {
        ...
        public static CDP4Common.DTO.RuleVerificationList FromJsonObject(JsonElement jsonElement)
        {
            ...
            {
                throw new DeSerializationException("the mandatory revisionNumber property is not available, the RuleVerificationListResolver cannot be used to deserialize this JsonElement");
            }
