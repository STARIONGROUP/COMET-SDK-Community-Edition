...
namespace CDP4JsonSerializer_SystemTextJson
{
    ...
    public static class TextParameterTypeResolver
    {
        ...
        public static CDP4Common.DTO.TextParameterType FromJsonObject(JsonElement jsonElement)
        {
            ...
            {
                throw new DeSerializationException("the mandatory revisionNumber property is not available, the TextParameterTypeResolver cannot be used to deserialize this JsonElement");
            }
