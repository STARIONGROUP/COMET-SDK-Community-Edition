...
namespace CDP4JsonSerializer_SystemTextJson
{
    ...
    public static class FileResolver
    {
        ...
        public static CDP4Common.DTO.File FromJsonObject(JsonElement jsonElement)
        {
            ...
            {
                throw new DeSerializationException("the mandatory revisionNumber property is not available, the FileResolver cannot be used to deserialize this JsonElement");
            }
            ...
            if (jsonElement.TryGetProperty("fileRevision"u8, out var fileRevisionProperty))
            {
