...
namespace CDP4JsonSerializer_SystemTextJson
{
    ...
    public static class ArrayParameterTypeResolver
    {
        ...
        public static CDP4Common.DTO.ArrayParameterType FromJsonObject(JsonElement jsonElement)
        {
            ...
            {
                throw new DeSerializationException("the mandatory revisionNumber property is not available, the ArrayParameterTypeResolver cannot be used to deserialize this JsonElement");
            }
