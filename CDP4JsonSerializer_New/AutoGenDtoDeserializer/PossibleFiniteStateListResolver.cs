...
namespace CDP4JsonSerializer_SystemTextJson
{
    ...
    public static class PossibleFiniteStateListResolver
    {
        ...
        public static CDP4Common.DTO.PossibleFiniteStateList FromJsonObject(JsonElement jsonElement)
        {
            ...
            {
                throw new DeSerializationException("the mandatory revisionNumber property is not available, the PossibleFiniteStateListResolver cannot be used to deserialize this JsonElement");
            }
