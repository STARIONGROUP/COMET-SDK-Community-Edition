...
namespace CDP4JsonSerializer_SystemTextJson
{
    ...
    public static class OrExpressionResolver
    {
        ...
        public static CDP4Common.DTO.OrExpression FromJsonObject(JsonElement jsonElement)
        {
            ...
            {
                throw new DeSerializationException("the mandatory revisionNumber property is not available, the OrExpressionResolver cannot be used to deserialize this JsonElement");
            }
