...
namespace CDP4JsonSerializer_SystemTextJson
{
    ...
    public static class ActualFiniteStateListResolver
    {
        ...
        public static CDP4Common.DTO.ActualFiniteStateList FromJsonObject(JsonElement jsonElement)
        {
            ...
            {
                throw new DeSerializationException("the mandatory revisionNumber property is not available, the ActualFiniteStateListResolver cannot be used to deserialize this JsonElement");
            }
