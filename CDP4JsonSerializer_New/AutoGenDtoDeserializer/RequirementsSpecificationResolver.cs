...
namespace CDP4JsonSerializer_SystemTextJson
{
    ...
    public static class RequirementsSpecificationResolver
    {
        ...
        public static CDP4Common.DTO.RequirementsSpecification FromJsonObject(JsonElement jsonElement)
        {
            ...
            {
                throw new DeSerializationException("the mandatory revisionNumber property is not available, the RequirementsSpecificationResolver cannot be used to deserialize this JsonElement");
            }
