...
namespace CDP4JsonSerializer
{
    ...
    public static class ScaleValueDefinitionResolver
    {
        ...
        public static CDP4Common.DTO.ScaleValueDefinition FromJsonObject(JsonElement jsonElement)
        {
            ...
            {
                throw new DeSerializationException("the mandatory revisionNumber property is not available, the ScaleValueDefinitionResolver cannot be used to deserialize this JsonElement");
            }
