// --------------------------------------------------------------------------------------------------------------------
// <copyright file="DateParameterTypeResolver.cs" company="Starion Group S.A.">
...
namespace CDP4JsonSerializer
{
    ...
    public static class DateParameterTypeResolver
    {
        ...
        public static CDP4Common.DTO.DateParameterType FromJsonObject(JObject jObject)
        {
            ...
            {
                dateParameterType.Actor = jObject["actor"].ToObject<Guid?>();
            }
            ...
            {
                dateParameterType.ThingPreference = jObject["thingPreference"].ToObject<string>();
            }
