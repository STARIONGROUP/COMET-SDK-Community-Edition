...
namespace CDP4JsonSerializer
{
    ...
    public static class SiteDirectoryDataAnnotationResolver
    {
        ...
        public static CDP4Common.DTO.SiteDirectoryDataAnnotation FromJsonObject(JsonElement jsonElement)
        {
            ...
            {
                throw new DeSerializationException("the mandatory revisionNumber property is not available, the SiteDirectoryDataAnnotationResolver cannot be used to deserialize this JsonElement");
            }
