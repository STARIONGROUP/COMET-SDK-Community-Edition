...
namespace CDP4JsonSerializer
{
    ...
    public static class EngineeringModelDataDiscussionItemResolver
    {
        ...
        public static CDP4Common.DTO.EngineeringModelDataDiscussionItem FromJsonObject(JsonElement jsonElement)
        {
            ...
            {
                throw new DeSerializationException("the mandatory revisionNumber property is not available, the EngineeringModelDataDiscussionItemResolver cannot be used to deserialize this JsonElement");
            }
