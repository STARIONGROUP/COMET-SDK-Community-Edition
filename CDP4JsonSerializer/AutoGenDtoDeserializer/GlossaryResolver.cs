// --------------------------------------------------------------------------------------------------------------------
// <copyright file="GlossaryResolver.cs" company="Starion Group S.A.">
...
namespace CDP4JsonSerializer
{
    ...
    public static class GlossaryResolver
    {
        ...
        public static CDP4Common.DTO.Glossary FromJsonObject(JObject jObject)
        {
            ...
            {
                glossary.Actor = jObject["actor"].ToObject<Guid?>();
            }
            ...
            {
                glossary.ThingPreference = jObject["thingPreference"].ToObject<string>();
            }
