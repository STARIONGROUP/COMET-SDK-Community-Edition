...
namespace CDP4JsonSerializer
{
    ...
    public static class TextualNoteResolver
    {
        ...
        public static CDP4Common.DTO.TextualNote FromJsonObject(JsonElement jsonElement)
        {
            ...
            {
                throw new DeSerializationException("the mandatory revisionNumber property is not available, the TextualNoteResolver cannot be used to deserialize this JsonElement");
            }
