...
namespace CDP4JsonSerializer
{
    ...
    public static class ParameterSubscriptionValueSetResolver
    {
        ...
        public static CDP4Common.DTO.ParameterSubscriptionValueSet FromJsonObject(JsonElement jsonElement)
        {
            ...
            {
                throw new DeSerializationException("the mandatory revisionNumber property is not available, the ParameterSubscriptionValueSetResolver cannot be used to deserialize this JsonElement");
            }
