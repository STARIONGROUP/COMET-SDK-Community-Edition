...
namespace CDP4JsonSerializer
{
    ...
    public static class EnumerationParameterTypeResolver
    {
        ...
        public static CDP4Common.DTO.EnumerationParameterType FromJsonObject(JsonElement jsonElement)
        {
            ...
            {
                throw new DeSerializationException("the mandatory revisionNumber property is not available, the EnumerationParameterTypeResolver cannot be used to deserialize this JsonElement");
            }
