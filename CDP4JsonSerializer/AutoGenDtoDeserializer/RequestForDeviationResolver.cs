...
namespace CDP4JsonSerializer
{
    ...
    public static class RequestForDeviationResolver
    {
        ...
        public static CDP4Common.DTO.RequestForDeviation FromJsonObject(JsonElement jsonElement)
        {
            ...
            {
                throw new DeSerializationException("the mandatory revisionNumber property is not available, the RequestForDeviationResolver cannot be used to deserialize this JsonElement");
            }
