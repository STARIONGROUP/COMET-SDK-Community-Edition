...
namespace CDP4JsonSerializer
{
    ...
    public static class DomainOfExpertiseGroupResolver
    {
        ...
        public static CDP4Common.DTO.DomainOfExpertiseGroup FromJsonObject(JsonElement jsonElement)
        {
            ...
            {
                throw new DeSerializationException("the mandatory revisionNumber property is not available, the DomainOfExpertiseGroupResolver cannot be used to deserialize this JsonElement");
            }
