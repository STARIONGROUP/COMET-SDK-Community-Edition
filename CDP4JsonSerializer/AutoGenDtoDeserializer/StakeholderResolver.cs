...
namespace CDP4JsonSerializer
{
    ...
    public static class StakeholderResolver
    {
        ...
        public static CDP4Common.DTO.Stakeholder FromJsonObject(JObject jObject)
        {
            ...
            {
                stakeholder.Actor = jObject["actor"].ToObject<Guid?>();
            }
            ...
            {
                stakeholder.Attachment.AddRange(jObject["attachment"].ToObject<IEnumerable<Guid>>());
            }
            ...
            {
                stakeholder.ThingPreference = jObject["thingPreference"].ToObject<string>();
            }
