...
namespace CDP4JsonSerializer
{
    ...
    public static class UnitFactorResolver
    {
        ...
        public static CDP4Common.DTO.UnitFactor FromJsonObject(JsonElement jsonElement)
        {
            ...
            {
                throw new DeSerializationException("the mandatory revisionNumber property is not available, the UnitFactorResolver cannot be used to deserialize this JsonElement");
            }
