...
namespace CDP4JsonSerializer
{
    ...
    public static class ParameterTypeComponentResolver
    {
        ...
        public static CDP4Common.DTO.ParameterTypeComponent FromJsonObject(JsonElement jsonElement)
        {
            ...
            {
                throw new DeSerializationException("the mandatory revisionNumber property is not available, the ParameterTypeComponentResolver cannot be used to deserialize this JsonElement");
            }
