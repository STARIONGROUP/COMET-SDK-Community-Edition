...
namespace CDP4JsonSerializer
{
    ...
    public static class FileRevisionResolver
    {
        ...
        public static CDP4Common.DTO.FileRevision FromJsonObject(JsonElement jsonElement)
        {
            ...
            {
                throw new DeSerializationException("the mandatory revisionNumber property is not available, the FileRevisionResolver cannot be used to deserialize this JsonElement");
            }
