...
namespace CDP4JsonSerializer
{
    ...
    public static class IterationSetupResolver
    {
        ...
        public static CDP4Common.DTO.IterationSetup FromJsonObject(JsonElement jsonElement)
        {
            ...
            {
                throw new DeSerializationException("the mandatory revisionNumber property is not available, the IterationSetupResolver cannot be used to deserialize this JsonElement");
            }
