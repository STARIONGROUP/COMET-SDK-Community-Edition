...
namespace CDP4JsonSerializer
{
    ...
    public static class EnumerationValueDefinitionResolver
    {
        ...
        public static CDP4Common.DTO.EnumerationValueDefinition FromJsonObject(JObject jObject)
        {
            ...
            {
                enumerationValueDefinition.Actor = jObject["actor"].ToObject<Guid?>();
            }
            ...
            {
                enumerationValueDefinition.Attachment.AddRange(jObject["attachment"].ToObject<IEnumerable<Guid>>());
            }
            ...
            {
                enumerationValueDefinition.ThingPreference = jObject["thingPreference"].ToObject<string>();
            }
