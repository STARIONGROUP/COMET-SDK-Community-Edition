...
namespace CDP4JsonSerializer
{
    ...
    public static class ScaleReferenceQuantityValueResolver
    {
        ...
        public static CDP4Common.DTO.ScaleReferenceQuantityValue FromJsonObject(JsonElement jsonElement)
        {
            ...
            {
                throw new DeSerializationException("the mandatory revisionNumber property is not available, the ScaleReferenceQuantityValueResolver cannot be used to deserialize this JsonElement");
            }
