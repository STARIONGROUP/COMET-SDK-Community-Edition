...
namespace CDP4JsonSerializer
{
    ...
    public static class ParametricConstraintResolver
    {
        ...
        public static CDP4Common.DTO.ParametricConstraint FromJsonObject(JsonElement jsonElement)
        {
            ...
            {
                throw new DeSerializationException("the mandatory revisionNumber property is not available, the ParametricConstraintResolver cannot be used to deserialize this JsonElement");
            }
