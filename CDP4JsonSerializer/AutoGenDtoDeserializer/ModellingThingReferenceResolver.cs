// --------------------------------------------------------------------------------------------------------------------
// <copyright file="ModellingThingReferenceResolver.cs" company="Starion Group S.A.">
...
namespace CDP4JsonSerializer
{
    ...
    public static class ModellingThingReferenceResolver
    {
        ...
        public static CDP4Common.DTO.ModellingThingReference FromJsonObject(JObject jObject)
        {
            ...
            {
                modellingThingReference.Actor = jObject["actor"].ToObject<Guid?>();
            }
            ...
            {
                modellingThingReference.ThingPreference = jObject["thingPreference"].ToObject<string>();
            }
