// --------------------------------------------------------------------------------------------------------------------
// <copyright file="SolutionResolver.cs" company="Starion Group S.A.">
...
namespace CDP4JsonSerializer
{
    ...
    public static class SolutionResolver
    {
        ...
        public static CDP4Common.DTO.Solution FromJsonObject(JObject jObject)
        {
            ...
            {
                solution.Actor = jObject["actor"].ToObject<Guid?>();
            }
            ...
            {
                solution.ThingPreference = jObject["thingPreference"].ToObject<string>();
            }
