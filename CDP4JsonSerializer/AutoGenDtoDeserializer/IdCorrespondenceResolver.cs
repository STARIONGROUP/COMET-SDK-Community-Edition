...
namespace CDP4JsonSerializer
{
    ...
    public static class IdCorrespondenceResolver
    {
        ...
        public static CDP4Common.DTO.IdCorrespondence FromJsonObject(JsonElement jsonElement)
        {
            ...
            {
                throw new DeSerializationException("the mandatory revisionNumber property is not available, the IdCorrespondenceResolver cannot be used to deserialize this JsonElement");
            }
