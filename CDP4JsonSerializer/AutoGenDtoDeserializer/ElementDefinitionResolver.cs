...
namespace CDP4JsonSerializer
{
    ...
    public static class ElementDefinitionResolver
    {
        ...
        public static CDP4Common.DTO.ElementDefinition FromJsonObject(JsonElement jsonElement)
        {
            ...
            {
                throw new DeSerializationException("the mandatory revisionNumber property is not available, the ElementDefinitionResolver cannot be used to deserialize this JsonElement");
            }
