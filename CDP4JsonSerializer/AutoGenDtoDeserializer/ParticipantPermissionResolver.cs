// --------------------------------------------------------------------------------------------------------------------
// <copyright file="ParticipantPermissionResolver.cs" company="Starion Group S.A.">
...
namespace CDP4JsonSerializer
{
    ...
    public static class ParticipantPermissionResolver
    {
        ...
        public static CDP4Common.DTO.ParticipantPermission FromJsonObject(JObject jObject)
        {
            ...
            {
                participantPermission.Actor = jObject["actor"].ToObject<Guid?>();
            }
            ...
            {
                participantPermission.ThingPreference = jObject["thingPreference"].ToObject<string>();
            }
