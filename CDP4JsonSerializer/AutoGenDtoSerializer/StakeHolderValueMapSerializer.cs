...
namespace CDP4JsonSerializer
{
    ...
    public class StakeHolderValueMapSerializer : BaseThingSerializer, IThingSerializer
    {
        ...
        public void SerializeProperty(string propertyName, object value, Utf8JsonWriter writer, Version requestedDataModelVersion)
        {
            ...
            switch(propertyName.ToLower())
            {
                ...
                case "revisionnumber":
                    ...
                    break;
                case "settings":
                    var allowedVersionsForSettings = new List<string>
                    {
                        "1.1.0",
                        "1.2.0",
                        "1.3.0",
                    ...
                    if(!allowedVersionsForSettings.Contains(requestedVersion))
                    {
                        return;
                    }
        ...
        public void Serialize(Thing thing, Utf8JsonWriter writer, Version requestedDataModelVersion)
        {
            ...
            {
                case "1.1.0":
                    Logger.Log(LogLevel.Debug, "Serializing StakeHolderValueMap for Version 1.1.0");
                    writer.WriteStartArray("alias"u8);
                    ...
                    break;
                case "1.2.0":
                    Logger.Log(LogLevel.Debug, "Serializing StakeHolderValueMap for Version 1.2.0");
                    writer.WriteStartArray("alias"u8);
                    ...
                    break;
                case "1.3.0":
                    Logger.Log(LogLevel.Debug, "Serializing StakeHolderValueMap for Version 1.3.0");
                    writer.WritePropertyName("actor"u8);
