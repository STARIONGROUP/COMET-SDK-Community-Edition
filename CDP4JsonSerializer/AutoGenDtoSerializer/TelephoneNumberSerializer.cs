...
namespace CDP4JsonSerializer
{
    ...
    public class TelephoneNumberSerializer : BaseThingSerializer, IThingSerializer
    {
        ...
        public void SerializeProperty(string propertyName, object value, Utf8JsonWriter writer, Version requestedDataModelVersion)
        {
            ...
            switch(propertyName.ToLower())
            {
                ...
                case "value":
                    ...
                    break;
                case "vcardtype":
                    var allowedVersionsForVcardType = new List<string>
                    {
                        "1.0.0",
                        "1.1.0",
                        "1.2.0",
                    ...
                    if(!allowedVersionsForVcardType.Contains(requestedVersion))
                    {
                        return;
                    }
        ...
        public void Serialize(Thing thing, Utf8JsonWriter writer, Version requestedDataModelVersion)
        {
            ...
            {
                case "1.0.0":
                    Logger.Log(LogLevel.Debug, "Serializing TelephoneNumber for Version 1.0.0");
                    writer.WritePropertyName("classKind"u8);
                    ...
                    break;
                case "1.1.0":
                    Logger.Log(LogLevel.Debug, "Serializing TelephoneNumber for Version 1.1.0");
                    writer.WritePropertyName("classKind"u8);
                    writer.WriteStringValue(telephoneNumber.ClassKind.ToString());
                    writer.WriteStartArray("excludedDomain"u8);
                    ...
                    break;
                case "1.2.0":
                    Logger.Log(LogLevel.Debug, "Serializing TelephoneNumber for Version 1.2.0");
                    writer.WritePropertyName("classKind"u8);
                    writer.WriteStringValue(telephoneNumber.ClassKind.ToString());
                    writer.WriteStartArray("excludedDomain"u8);
                    ...
                    break;
                case "1.3.0":
                    Logger.Log(LogLevel.Debug, "Serializing TelephoneNumber for Version 1.3.0");
                    writer.WritePropertyName("actor"u8);
