...
namespace CDP4JsonSerializer
{
    ...
    public class BinaryNoteSerializer : BaseThingSerializer, IThingSerializer
    {
        ...
        public void SerializeProperty(string propertyName, object value, Utf8JsonWriter writer, Version requestedDataModelVersion)
        {
            ...
            switch(propertyName.ToLower())
            {
                case "actor":
                    ...
                    break;
                case "caption":
                    var allowedVersionsForCaption = new List<string>
                    {
                        "1.1.0",
                        "1.2.0",
                        "1.3.0",
                    ...
                    if(!allowedVersionsForCaption.Contains(requestedVersion))
                    {
                        return;
                    }
        ...
        public void Serialize(Thing thing, Utf8JsonWriter writer, Version requestedDataModelVersion)
        {
            ...
            {
                case "1.1.0":
                    Logger.Log(LogLevel.Debug, "Serializing BinaryNote for Version 1.1.0");
                    writer.WritePropertyName("caption"u8);
                    ...
                    break;
                case "1.2.0":
                    Logger.Log(LogLevel.Debug, "Serializing BinaryNote for Version 1.2.0");
                    writer.WritePropertyName("caption"u8);
                    writer.WriteStringValue(binaryNote.Caption);
                    writer.WriteStartArray("category"u8);
                    ...
                    break;
                case "1.3.0":
                    Logger.Log(LogLevel.Debug, "Serializing BinaryNote for Version 1.3.0");
                    writer.WritePropertyName("actor"u8);
