...
namespace CDP4JsonSerializer
{
    ...
    public class BoundsSerializer : BaseThingSerializer, IThingSerializer
    {
        ...
        public void SerializeProperty(string propertyName, object value, Utf8JsonWriter writer, Version requestedDataModelVersion)
        {
            ...
            switch(propertyName.ToLower())
            {
                ...
                case "excludedperson":
                    ...
                    break;
                case "height":
                    var allowedVersionsForHeight = new List<string>
                    {
                        "1.1.0",
                        "1.2.0",
                        "1.3.0",
                    ...
                    if(!allowedVersionsForHeight.Contains(requestedVersion))
                    {
                        return;
                    }
                ...
                case "thingpreference":
                    ...
                    break;
                case "width":
                    var allowedVersionsForWidth = new List<string>
                    {
                        "1.1.0",
                        "1.2.0",
                        "1.3.0",
                    ...
                    if(!allowedVersionsForWidth.Contains(requestedVersion))
                    {
                        return;
                    }
                    ...
                    break;
                case "x":
                    var allowedVersionsForX = new List<string>
                    {
                        "1.1.0",
                        "1.2.0",
                        "1.3.0",
                    ...
                    if(!allowedVersionsForX.Contains(requestedVersion))
                    {
                        return;
                    }
                    ...
                    break;
                case "y":
                    var allowedVersionsForY = new List<string>
                    {
                        "1.1.0",
                        "1.2.0",
                        "1.3.0",
                    ...
                    if(!allowedVersionsForY.Contains(requestedVersion))
                    {
                        return;
                    }
        ...
        public void Serialize(Thing thing, Utf8JsonWriter writer, Version requestedDataModelVersion)
        {
            ...
            {
                case "1.1.0":
                    Logger.Log(LogLevel.Debug, "Serializing Bounds for Version 1.1.0");
                    writer.WritePropertyName("classKind"u8);
                    ...
                    break;
                case "1.2.0":
                    Logger.Log(LogLevel.Debug, "Serializing Bounds for Version 1.2.0");
                    writer.WritePropertyName("classKind"u8);
                    writer.WriteStringValue(bounds.ClassKind.ToString());
                    writer.WriteStartArray("excludedDomain"u8);
                    ...
                    break;
                case "1.3.0":
                    Logger.Log(LogLevel.Debug, "Serializing Bounds for Version 1.3.0");
                    writer.WritePropertyName("actor"u8);
