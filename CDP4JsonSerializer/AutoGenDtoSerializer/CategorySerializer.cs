...
namespace CDP4JsonSerializer
{
    ...
    public class CategorySerializer : BaseThingSerializer, IThingSerializer
    {
        ...
        public void SerializeProperty(string propertyName, object value, Utf8JsonWriter writer, Version requestedDataModelVersion)
        {
            ...
            switch(propertyName.ToLower())
            {
                ...
                case "iid":
                    ...
                    break;
                case "isabstract":
                    var allowedVersionsForIsAbstract = new List<string>
                    {
                        "1.0.0",
                        "1.1.0",
                        "1.2.0",
                    ...
                    if(!allowedVersionsForIsAbstract.Contains(requestedVersion))
                    {
                        return;
                    }
                ...
                case "permissibleclass":
                    var allowedVersionsForPermissibleClass = new List<string>
                    {
                        "1.0.0",
                        "1.1.0",
                        "1.2.0",
                    ...
                    if(!allowedVersionsForPermissibleClass.Contains(requestedVersion))
                    {
                        return;
                    }
                ...
                case "shortname":
                    ...
                    break;
                case "supercategory":
                    var allowedVersionsForSuperCategory = new List<string>
                    {
                        "1.0.0",
                        "1.1.0",
                        "1.2.0",
                    ...
                    if(!allowedVersionsForSuperCategory.Contains(requestedVersion))
                    {
                        return;
                    }
        ...
        public void Serialize(Thing thing, Utf8JsonWriter writer, Version requestedDataModelVersion)
        {
            ...
            {
                case "1.0.0":
                    Logger.Log(LogLevel.Debug, "Serializing Category for Version 1.0.0");
                    writer.WriteStartArray("alias"u8);
                    ...
                    break;
                case "1.1.0":
                    Logger.Log(LogLevel.Debug, "Serializing Category for Version 1.1.0");
                    writer.WriteStartArray("alias"u8);
                    ...
                    break;
                case "1.2.0":
                    Logger.Log(LogLevel.Debug, "Serializing Category for Version 1.2.0");
                    writer.WriteStartArray("alias"u8);
                    ...
                    break;
                case "1.3.0":
                    Logger.Log(LogLevel.Debug, "Serializing Category for Version 1.3.0");
                    writer.WritePropertyName("actor"u8);
