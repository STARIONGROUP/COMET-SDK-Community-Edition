...
namespace CDP4JsonSerializer
{
    ...
    public class SimpleParameterValueSerializer : BaseThingSerializer, IThingSerializer
    {
        ...
        public void Serialize(Thing thing, Utf8JsonWriter writer, Version requestedDataModelVersion)
        {
            ...
            {
                case "1.0.0":
                    Logger.Log(LogLevel.Debug, "Serializing SimpleParameterValue for Version 1.0.0");
                    writer.WritePropertyName("classKind"u8);
                    ...
                    break;
                case "1.1.0":
                    Logger.Log(LogLevel.Debug, "Serializing SimpleParameterValue for Version 1.1.0");
                    writer.WritePropertyName("classKind"u8);
                    writer.WriteStringValue(simpleParameterValue.ClassKind.ToString());
                    writer.WriteStartArray("excludedDomain"u8);
                    ...
                    break;
                case "1.2.0":
                    Logger.Log(LogLevel.Debug, "Serializing SimpleParameterValue for Version 1.2.0");
                    writer.WritePropertyName("classKind"u8);
                    writer.WriteStringValue(simpleParameterValue.ClassKind.ToString());
                    writer.WriteStartArray("excludedDomain"u8);
                    ...
                    break;
                case "1.3.0":
                    Logger.Log(LogLevel.Debug, "Serializing SimpleParameterValue for Version 1.3.0");
                    writer.WritePropertyName("actor"u8);
