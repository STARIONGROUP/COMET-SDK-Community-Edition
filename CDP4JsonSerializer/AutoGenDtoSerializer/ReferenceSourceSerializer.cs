...
namespace CDP4JsonSerializer
{
    ...
    public class ReferenceSourceSerializer : BaseThingSerializer, IThingSerializer
    {
        ...
        public void SerializeProperty(string propertyName, object value, Utf8JsonWriter writer, Version requestedDataModelVersion)
        {
            ...
            switch(propertyName.ToLower())
            {
                ...
                case "isdeprecated":
                    ...
                    break;
                case "language":
                    var allowedVersionsForLanguage = new List<string>
                    {
                        "1.0.0",
                        "1.1.0",
                        "1.2.0",
                    ...
                    if(!allowedVersionsForLanguage.Contains(requestedVersion))
                    {
                        return;
                    }
                ...
                case "publicationyear":
                    var allowedVersionsForPublicationYear = new List<string>
                    {
                        "1.0.0",
                        "1.1.0",
                        "1.2.0",
                    ...
                    if(!allowedVersionsForPublicationYear.Contains(requestedVersion))
                    {
                        return;
                    }
                    ...
                    break;
                case "publishedin":
                    var allowedVersionsForPublishedIn = new List<string>
                    {
                        "1.0.0",
                        "1.1.0",
                        "1.2.0",
                    ...
                    if(!allowedVersionsForPublishedIn.Contains(requestedVersion))
                    {
                        return;
                    }
                    ...
                    break;
                case "publisher":
                    var allowedVersionsForPublisher = new List<string>
                    {
                        "1.0.0",
                        "1.1.0",
                        "1.2.0",
                    ...
                    if(!allowedVersionsForPublisher.Contains(requestedVersion))
                    {
                        return;
                    }
                ...
                case "thingpreference":
                    ...
                    break;
                case "versiondate":
                    var allowedVersionsForVersionDate = new List<string>
                    {
                        "1.0.0",
                        "1.1.0",
                        "1.2.0",
                    ...
                    if(!allowedVersionsForVersionDate.Contains(requestedVersion))
                    {
                        return;
                    }
                ...
                case "versionidentifier":
                    var allowedVersionsForVersionIdentifier = new List<string>
                    {
                        "1.0.0",
                        "1.1.0",
                        "1.2.0",
                    ...
                    if(!allowedVersionsForVersionIdentifier.Contains(requestedVersion))
                    {
                        return;
                    }
        ...
        public void Serialize(Thing thing, Utf8JsonWriter writer, Version requestedDataModelVersion)
        {
            ...
            {
                case "1.0.0":
                    Logger.Log(LogLevel.Debug, "Serializing ReferenceSource for Version 1.0.0");
                    writer.WriteStartArray("alias"u8);
                    ...
                    break;
                case "1.1.0":
                    Logger.Log(LogLevel.Debug, "Serializing ReferenceSource for Version 1.1.0");
                    writer.WriteStartArray("alias"u8);
                    ...
                    break;
                case "1.2.0":
                    Logger.Log(LogLevel.Debug, "Serializing ReferenceSource for Version 1.2.0");
                    writer.WriteStartArray("alias"u8);
                    ...
                    break;
                case "1.3.0":
                    Logger.Log(LogLevel.Debug, "Serializing ReferenceSource for Version 1.3.0");
                    writer.WritePropertyName("actor"u8);
