...
namespace CDP4JsonSerializer
{
    ...
    public class NestedParameterSerializer : BaseThingSerializer, IThingSerializer
    {
        ...
        public void SerializeProperty(string propertyName, object value, Utf8JsonWriter writer, Version requestedDataModelVersion)
        {
            ...
            switch(propertyName.ToLower())
            {
                ...
                case "actualstate":
                    ...
                    break;
                case "actualvalue":
                    var allowedVersionsForActualValue = new List<string>
                    {
                        "1.0.0",
                        "1.1.0",
                        "1.2.0",
                    ...
                    if(!allowedVersionsForActualValue.Contains(requestedVersion))
                    {
                        return;
                    }
                ...
                case "associatedparameter":
                    var allowedVersionsForAssociatedParameter = new List<string>
                    {
                        "1.0.0",
                        "1.1.0",
                        "1.2.0",
                    ...
                    if(!allowedVersionsForAssociatedParameter.Contains(requestedVersion))
                    {
                        return;
                    }
        ...
        public void Serialize(Thing thing, Utf8JsonWriter writer, Version requestedDataModelVersion)
        {
            ...
            {
                case "1.0.0":
                    Logger.Log(LogLevel.Debug, "Serializing NestedParameter for Version 1.0.0");
                    writer.WritePropertyName("actualState"u8);
                    ...
                    break;
                case "1.1.0":
                    Logger.Log(LogLevel.Debug, "Serializing NestedParameter for Version 1.1.0");
                    writer.WritePropertyName("actualState"u8);
                    ...
                    break;
                case "1.2.0":
                    Logger.Log(LogLevel.Debug, "Serializing NestedParameter for Version 1.2.0");
                    writer.WritePropertyName("actualState"u8);
                    ...
                    break;
                case "1.3.0":
                    Logger.Log(LogLevel.Debug, "Serializing NestedParameter for Version 1.3.0");
                    writer.WritePropertyName("actor"u8);
