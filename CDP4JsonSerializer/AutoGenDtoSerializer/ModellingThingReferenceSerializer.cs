...
namespace CDP4JsonSerializer
{
    ...
    /// </summary>
    public class ModellingThingReferenceSerializer : IThingSerializer
    {
        /// <summary>
        ...
        private JObject Serialize(ModellingThingReference modellingThingReference)
        {
            ...
            jsonObject.Add("excludedDomain", this.PropertySerializerMap["excludedDomain"](modellingThingReference.ExcludedDomain));
            jsonObject.Add("excludedPerson", this.PropertySerializerMap["excludedPerson"](modellingThingReference.ExcludedPerson));
