...
namespace CDP4JsonSerializer
{
    ...
    public class ColorSerializer : BaseThingSerializer, IThingSerializer
    {
        ...
        public void SerializeProperty(string propertyName, object value, Utf8JsonWriter writer, Version requestedDataModelVersion)
        {
            ...
            switch(propertyName.ToLower())
            {
                case "actor":
                    ...
                    break;
                case "blue":
                    var allowedVersionsForBlue = new List<string>
                    {
                        "1.0.0",
                        "1.1.0",
                        "1.2.0",
                    ...
                    if(!allowedVersionsForBlue.Contains(requestedVersion))
                    {
                        return;
                    }
                ...
                case "excludedperson":
                    ...
                    break;
                case "green":
                    var allowedVersionsForGreen = new List<string>
                    {
                        "1.0.0",
                        "1.1.0",
                        "1.2.0",
                    ...
                    if(!allowedVersionsForGreen.Contains(requestedVersion))
                    {
                        return;
                    }
                ...
                case "name":
                    ...
                    break;
                case "red":
                    var allowedVersionsForRed = new List<string>
                    {
                        "1.0.0",
                        "1.1.0",
                        "1.2.0",
                    ...
                    if(!allowedVersionsForRed.Contains(requestedVersion))
                    {
                        return;
                    }
        ...
        public void Serialize(Thing thing, Utf8JsonWriter writer, Version requestedDataModelVersion)
        {
            ...
            {
                case "1.0.0":
                    Logger.Log(LogLevel.Debug, "Serializing Color for Version 1.0.0");
                    writer.WritePropertyName("blue"u8);
                    ...
                    break;
                case "1.1.0":
                    Logger.Log(LogLevel.Debug, "Serializing Color for Version 1.1.0");
                    writer.WritePropertyName("blue"u8);
                    writer.WriteNumberValue(color.Blue);
                    writer.WritePropertyName("classKind"u8);
                    writer.WriteStringValue(color.ClassKind.ToString());
                    ...
                    break;
                case "1.2.0":
                    Logger.Log(LogLevel.Debug, "Serializing Color for Version 1.2.0");
                    writer.WritePropertyName("blue"u8);
                    writer.WriteNumberValue(color.Blue);
                    writer.WritePropertyName("classKind"u8);
                    writer.WriteStringValue(color.ClassKind.ToString());
                    ...
                    break;
                case "1.3.0":
                    Logger.Log(LogLevel.Debug, "Serializing Color for Version 1.3.0");
                    writer.WritePropertyName("actor"u8);
