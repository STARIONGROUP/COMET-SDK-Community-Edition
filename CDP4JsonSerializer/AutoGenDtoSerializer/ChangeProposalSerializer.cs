...
namespace CDP4JsonSerializer
{
    ...
    public class ChangeProposalSerializer : BaseThingSerializer, IThingSerializer
    {
        ...
        public void SerializeProperty(string propertyName, object value, Utf8JsonWriter writer, Version requestedDataModelVersion)
        {
            ...
            switch(propertyName.ToLower())
            {
                ...
                case "category":
                    ...
                    break;
                case "changerequest":
                    var allowedVersionsForChangeRequest = new List<string>
                    {
                        "1.1.0",
                        "1.2.0",
                        "1.3.0",
                    ...
                    if(!allowedVersionsForChangeRequest.Contains(requestedVersion))
                    {
                        return;
                    }
        ...
        public void Serialize(Thing thing, Utf8JsonWriter writer, Version requestedDataModelVersion)
        {
            ...
            {
                case "1.1.0":
                    Logger.Log(LogLevel.Debug, "Serializing ChangeProposal for Version 1.1.0");
                    writer.WriteStartArray("approvedBy"u8);
                    ...
                    break;
                case "1.2.0":
                    Logger.Log(LogLevel.Debug, "Serializing ChangeProposal for Version 1.2.0");
                    writer.WriteStartArray("approvedBy"u8);
                    ...
                    break;
                case "1.3.0":
                    Logger.Log(LogLevel.Debug, "Serializing ChangeProposal for Version 1.3.0");
                    writer.WritePropertyName("actor"u8);
