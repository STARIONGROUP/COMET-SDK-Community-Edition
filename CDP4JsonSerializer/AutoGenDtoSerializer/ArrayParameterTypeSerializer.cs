...
namespace CDP4JsonSerializer
{
    ...
    public class ArrayParameterTypeSerializer : BaseThingSerializer, IThingSerializer
    {
        ...
        public void SerializeProperty(string propertyName, object value, Utf8JsonWriter writer, Version requestedDataModelVersion)
        {
            ...
            switch(propertyName.ToLower())
            {
                ...
                case "classkind":
                    ...
                    break;
                case "component":
                    var allowedVersionsForComponent = new List<string>
                    {
                        "1.0.0",
                        "1.1.0",
                        "1.2.0",
                    ...
                    if(!allowedVersionsForComponent.Contains(requestedVersion))
                    {
                        return;
                    }
                    ...
                    if(value is IEnumerable<object> objectListComponent)
                    {
                ...
                case "definition":
                    ...
                    break;
                case "dimension":
                    var allowedVersionsForDimension = new List<string>
                    {
                        "1.0.0",
                        "1.1.0",
                        "1.2.0",
                    ...
                    if(!allowedVersionsForDimension.Contains(requestedVersion))
                    {
                        return;
                    }
                    ...
                    if(value is IEnumerable<object> objectListDimension)
                    {
                ...
                case "isdeprecated":
                    ...
                    break;
                case "isfinalized":
                    var allowedVersionsForIsFinalized = new List<string>
                    {
                        "1.0.0",
                        "1.1.0",
                        "1.2.0",
                    ...
                    if(!allowedVersionsForIsFinalized.Contains(requestedVersion))
                    {
                        return;
                    }
                    ...
                    break;
                case "istensor":
                    var allowedVersionsForIsTensor = new List<string>
                    {
                        "1.0.0",
                        "1.1.0",
                        "1.2.0",
                    ...
                    if(!allowedVersionsForIsTensor.Contains(requestedVersion))
                    {
                        return;
                    }
        ...
        public void Serialize(Thing thing, Utf8JsonWriter writer, Version requestedDataModelVersion)
        {
            ...
            {
                case "1.0.0":
                    Logger.Log(LogLevel.Debug, "Serializing ArrayParameterType for Version 1.0.0");
                    writer.WriteStartArray("alias"u8);
                    ...
                    break;
                case "1.1.0":
                    Logger.Log(LogLevel.Debug, "Serializing ArrayParameterType for Version 1.1.0");
                    writer.WriteStartArray("alias"u8);
                    ...
                    break;
                case "1.2.0":
                    Logger.Log(LogLevel.Debug, "Serializing ArrayParameterType for Version 1.2.0");
                    writer.WriteStartArray("alias"u8);
                    ...
                    break;
                case "1.3.0":
                    Logger.Log(LogLevel.Debug, "Serializing ArrayParameterType for Version 1.3.0");
                    writer.WritePropertyName("actor"u8);
