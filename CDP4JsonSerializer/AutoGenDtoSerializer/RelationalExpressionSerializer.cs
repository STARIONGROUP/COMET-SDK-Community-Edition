...
namespace CDP4JsonSerializer
{
    ...
    public class RelationalExpressionSerializer : BaseThingSerializer, IThingSerializer
    {
        ...
        public void SerializeProperty(string propertyName, object value, Utf8JsonWriter writer, Version requestedDataModelVersion)
        {
            ...
            switch(propertyName.ToLower())
            {
                ...
                case "relationaloperator":
                    var allowedVersionsForRelationalOperator = new List<string>
                    {
                        "1.0.0",
                        "1.1.0",
                        "1.2.0",
                    ...
                    if(!allowedVersionsForRelationalOperator.Contains(requestedVersion))
                    {
                        return;
                    }
        ...
        public void Serialize(Thing thing, Utf8JsonWriter writer, Version requestedDataModelVersion)
        {
            ...
            {
                case "1.0.0":
                    Logger.Log(LogLevel.Debug, "Serializing RelationalExpression for Version 1.0.0");
                    writer.WritePropertyName("classKind"u8);
                    ...
                    break;
                case "1.1.0":
                    Logger.Log(LogLevel.Debug, "Serializing RelationalExpression for Version 1.1.0");
                    writer.WritePropertyName("classKind"u8);
                    writer.WriteStringValue(relationalExpression.ClassKind.ToString());
                    writer.WriteStartArray("excludedDomain"u8);
                    ...
                    break;
                case "1.2.0":
                    Logger.Log(LogLevel.Debug, "Serializing RelationalExpression for Version 1.2.0");
                    writer.WritePropertyName("classKind"u8);
                    writer.WriteStringValue(relationalExpression.ClassKind.ToString());
                    writer.WriteStartArray("excludedDomain"u8);
                    ...
                    break;
                case "1.3.0":
                    Logger.Log(LogLevel.Debug, "Serializing RelationalExpression for Version 1.3.0");
                    writer.WritePropertyName("actor"u8);
