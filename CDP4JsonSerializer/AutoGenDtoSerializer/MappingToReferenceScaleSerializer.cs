...
namespace CDP4JsonSerializer
{
    ...
    public class MappingToReferenceScaleSerializer : BaseThingSerializer, IThingSerializer
    {
        ...
        public void SerializeProperty(string propertyName, object value, Utf8JsonWriter writer, Version requestedDataModelVersion)
        {
            ...
            switch(propertyName.ToLower())
            {
                ...
                case "dependentscalevalue":
                    var allowedVersionsForDependentScaleValue = new List<string>
                    {
                        "1.0.0",
                        "1.1.0",
                        "1.2.0",
                    ...
                    if(!allowedVersionsForDependentScaleValue.Contains(requestedVersion))
                    {
                        return;
                    }
                ...
                case "referencescalevalue":
                    var allowedVersionsForReferenceScaleValue = new List<string>
                    {
                        "1.0.0",
                        "1.1.0",
                        "1.2.0",
                    ...
                    if(!allowedVersionsForReferenceScaleValue.Contains(requestedVersion))
                    {
                        return;
                    }
        ...
        public void Serialize(Thing thing, Utf8JsonWriter writer, Version requestedDataModelVersion)
        {
            ...
            {
                case "1.0.0":
                    Logger.Log(LogLevel.Debug, "Serializing MappingToReferenceScale for Version 1.0.0");
                    writer.WritePropertyName("classKind"u8);
                    ...
                    break;
                case "1.1.0":
                    Logger.Log(LogLevel.Debug, "Serializing MappingToReferenceScale for Version 1.1.0");
                    writer.WritePropertyName("classKind"u8);
                    writer.WriteStringValue(mappingToReferenceScale.ClassKind.ToString());
                    writer.WritePropertyName("dependentScaleValue"u8);
                    writer.WriteStringValue(mappingToReferenceScale.DependentScaleValue);
                    ...
                    break;
                case "1.2.0":
                    Logger.Log(LogLevel.Debug, "Serializing MappingToReferenceScale for Version 1.2.0");
                    writer.WritePropertyName("classKind"u8);
                    writer.WriteStringValue(mappingToReferenceScale.ClassKind.ToString());
                    writer.WritePropertyName("dependentScaleValue"u8);
                    writer.WriteStringValue(mappingToReferenceScale.DependentScaleValue);
                    ...
                    break;
                case "1.3.0":
                    Logger.Log(LogLevel.Debug, "Serializing MappingToReferenceScale for Version 1.3.0");
                    writer.WritePropertyName("actor"u8);
