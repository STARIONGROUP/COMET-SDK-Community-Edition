...
namespace CDP4JsonSerializer
{
    ...
    public class DefinitionSerializer : BaseThingSerializer, IThingSerializer
    {
        ...
        public void SerializeProperty(string propertyName, object value, Utf8JsonWriter writer, Version requestedDataModelVersion)
        {
            ...
            switch(propertyName.ToLower())
            {
                case "actor":
                    ...
                    break;
                case "citation":
                    var allowedVersionsForCitation = new List<string>
                    {
                        "1.0.0",
                        "1.1.0",
                        "1.2.0",
                    ...
                    if(!allowedVersionsForCitation.Contains(requestedVersion))
                    {
                        return;
                    }
                    ...
                    if(value is IEnumerable<object> objectListCitation)
                    {
                ...
                case "content":
                    ...
                    break;
                case "example":
                    var allowedVersionsForExample = new List<string>
                    {
                        "1.0.0",
                        "1.1.0",
                        "1.2.0",
                    ...
                    if(!allowedVersionsForExample.Contains(requestedVersion))
                    {
                        return;
                    }
                    ...
                    if(value is IEnumerable<object> objectListExample)
                    {
                ...
                case "modifiedon":
                    ...
                    break;
                case "note":
                    var allowedVersionsForNote = new List<string>
                    {
                        "1.0.0",
                        "1.1.0",
                        "1.2.0",
                    ...
                    if(!allowedVersionsForNote.Contains(requestedVersion))
                    {
                        return;
                    }
                    ...
                    if(value is IEnumerable<object> objectListNote)
                    {
        ...
        public void Serialize(Thing thing, Utf8JsonWriter writer, Version requestedDataModelVersion)
        {
            ...
            {
                case "1.0.0":
                    Logger.Log(LogLevel.Debug, "Serializing Definition for Version 1.0.0");
                    writer.WriteStartArray("citation"u8);
                    ...
                    break;
                case "1.1.0":
                    Logger.Log(LogLevel.Debug, "Serializing Definition for Version 1.1.0");
                    writer.WriteStartArray("citation"u8);
                    ...
                    break;
                case "1.2.0":
                    Logger.Log(LogLevel.Debug, "Serializing Definition for Version 1.2.0");
                    writer.WriteStartArray("citation"u8);
                    ...
                    break;
                case "1.3.0":
                    Logger.Log(LogLevel.Debug, "Serializing Definition for Version 1.3.0");
                    writer.WritePropertyName("actor"u8);
