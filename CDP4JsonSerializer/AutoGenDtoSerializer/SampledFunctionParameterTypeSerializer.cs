...
namespace CDP4JsonSerializer
{
    ...
    public class SampledFunctionParameterTypeSerializer : BaseThingSerializer, IThingSerializer
    {
        ...
        public void SerializeProperty(string propertyName, object value, Utf8JsonWriter writer, Version requestedDataModelVersion)
        {
            ...
            switch(propertyName.ToLower())
            {
                ...
                case "degreeofinterpolation":
                    var allowedVersionsForDegreeOfInterpolation = new List<string>
                    {
                        "1.2.0",
                        "1.3.0",
                    };

                    if(!allowedVersionsForDegreeOfInterpolation.Contains(requestedVersion))
                    {
                        return;
                    }
                ...
                case "dependentparametertype":
                    var allowedVersionsForDependentParameterType = new List<string>
                    {
                        "1.2.0",
                        "1.3.0",
                    };

                    if(!allowedVersionsForDependentParameterType.Contains(requestedVersion))
                    {
                        return;
                    }
                    ...
                    if(value is IEnumerable<object> objectListDependentParameterType)
                    {
                ...
                case "independentparametertype":
                    var allowedVersionsForIndependentParameterType = new List<string>
                    {
                        "1.2.0",
                        "1.3.0",
                    };

                    if(!allowedVersionsForIndependentParameterType.Contains(requestedVersion))
                    {
                        return;
                    }
                    ...
                    if(value is IEnumerable<object> objectListIndependentParameterType)
                    {
                ...
                case "interpolationperiod":
                    var allowedVersionsForInterpolationPeriod = new List<string>
                    {
                        "1.2.0",
                        "1.3.0",
                    };

                    if(!allowedVersionsForInterpolationPeriod.Contains(requestedVersion))
                    {
                        return;
                    }
        ...
        public void Serialize(Thing thing, Utf8JsonWriter writer, Version requestedDataModelVersion)
        {
            ...
            {
                case "1.2.0":
                    Logger.Log(LogLevel.Debug, "Serializing SampledFunctionParameterType for Version 1.2.0");
                    writer.WriteStartArray("alias"u8);
                    ...
                    break;
                case "1.3.0":
                    Logger.Log(LogLevel.Debug, "Serializing SampledFunctionParameterType for Version 1.3.0");
                    writer.WritePropertyName("actor"u8);
