...
namespace CDP4JsonSerializer
{
    ...
    public class BinaryRelationshipRuleSerializer : BaseThingSerializer, IThingSerializer
    {
        ...
        public void SerializeProperty(string propertyName, object value, Utf8JsonWriter writer, Version requestedDataModelVersion)
        {
            ...
            switch(propertyName.ToLower())
            {
                ...
                case "forwardrelationshipname":
                    var allowedVersionsForForwardRelationshipName = new List<string>
                    {
                        "1.0.0",
                        "1.1.0",
                        "1.2.0",
                    ...
                    if(!allowedVersionsForForwardRelationshipName.Contains(requestedVersion))
                    {
                        return;
                    }
                ...
                case "inverserelationshipname":
                    var allowedVersionsForInverseRelationshipName = new List<string>
                    {
                        "1.0.0",
                        "1.1.0",
                        "1.2.0",
                    ...
                    if(!allowedVersionsForInverseRelationshipName.Contains(requestedVersion))
                    {
                        return;
                    }
                ...
                case "shortname":
                    ...
                    break;
                case "sourcecategory":
                    var allowedVersionsForSourceCategory = new List<string>
                    {
                        "1.0.0",
                        "1.1.0",
                        "1.2.0",
                    ...
                    if(!allowedVersionsForSourceCategory.Contains(requestedVersion))
                    {
                        return;
                    }
                    ...
                    break;
                case "targetcategory":
                    var allowedVersionsForTargetCategory = new List<string>
                    {
                        "1.0.0",
                        "1.1.0",
                        "1.2.0",
                    ...
                    if(!allowedVersionsForTargetCategory.Contains(requestedVersion))
                    {
                        return;
                    }
        ...
        public void Serialize(Thing thing, Utf8JsonWriter writer, Version requestedDataModelVersion)
        {
            ...
            {
                case "1.0.0":
                    Logger.Log(LogLevel.Debug, "Serializing BinaryRelationshipRule for Version 1.0.0");
                    writer.WriteStartArray("alias"u8);
                    ...
                    break;
                case "1.1.0":
                    Logger.Log(LogLevel.Debug, "Serializing BinaryRelationshipRule for Version 1.1.0");
                    writer.WriteStartArray("alias"u8);
                    ...
                    break;
                case "1.2.0":
                    Logger.Log(LogLevel.Debug, "Serializing BinaryRelationshipRule for Version 1.2.0");
                    writer.WriteStartArray("alias"u8);
                    ...
                    break;
                case "1.3.0":
                    Logger.Log(LogLevel.Debug, "Serializing BinaryRelationshipRule for Version 1.3.0");
                    writer.WritePropertyName("actor"u8);
