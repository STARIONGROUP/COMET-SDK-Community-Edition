...
namespace CDP4JsonSerializer
{
    ...
    public class DerivedQuantityKindSerializer : BaseThingSerializer, IThingSerializer
    {
        ...
        public void SerializeProperty(string propertyName, object value, Utf8JsonWriter writer, Version requestedDataModelVersion)
        {
            ...
            switch(propertyName.ToLower())
            {
                ...
                case "quantitykindfactor":
                    var allowedVersionsForQuantityKindFactor = new List<string>
                    {
                        "1.0.0",
                        "1.1.0",
                        "1.2.0",
                    ...
                    if(!allowedVersionsForQuantityKindFactor.Contains(requestedVersion))
                    {
                        return;
                    }
                    ...
                    if(value is IEnumerable<object> objectListQuantityKindFactor)
                    {
        ...
        public void Serialize(Thing thing, Utf8JsonWriter writer, Version requestedDataModelVersion)
        {
            ...
            {
                case "1.0.0":
                    Logger.Log(LogLevel.Debug, "Serializing DerivedQuantityKind for Version 1.0.0");
                    writer.WriteStartArray("alias"u8);
                    ...
                    break;
                case "1.1.0":
                    Logger.Log(LogLevel.Debug, "Serializing DerivedQuantityKind for Version 1.1.0");
                    writer.WriteStartArray("alias"u8);
                    ...
                    break;
                case "1.2.0":
                    Logger.Log(LogLevel.Debug, "Serializing DerivedQuantityKind for Version 1.2.0");
                    writer.WriteStartArray("alias"u8);
                    ...
                    break;
                case "1.3.0":
                    Logger.Log(LogLevel.Debug, "Serializing DerivedQuantityKind for Version 1.3.0");
                    writer.WritePropertyName("actor"u8);
