// -------------------------------------------------------------------------------------------------------------------------------
// <copyright file="NumberSetKindDeserializer.cs" company="Starion Group S.A.">
...
namespace CDP4JsonSerializer
{
    ...
    internal static class NumberSetKindDeserializer
    {
        ...
        internal static NumberSetKind Deserialize(JsonElement jsonElement)
        {
            ...
            return value switch
            {
                "NATURAL_NUMBER_SET" => NumberSetKind.NATURAL_NUMBER_SET,
                "INTEGER_NUMBER_SET" => NumberSetKind.INTEGER_NUMBER_SET,
                "RATIONAL_NUMBER_SET" => NumberSetKind.RATIONAL_NUMBER_SET,
                "REAL_NUMBER_SET" => NumberSetKind.REAL_NUMBER_SET,
                _ => throw new InvalidDataException($"{value} is not a valid for NumberSetKind")
            };
        }        
    }
}
