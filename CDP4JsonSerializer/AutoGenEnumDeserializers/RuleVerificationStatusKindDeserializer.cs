// -------------------------------------------------------------------------------------------------------------------------------
// <copyright file="RuleVerificationStatusKindDeserializer.cs" company="Starion Group S.A.">
...
namespace CDP4JsonSerializer
{
    ...
    internal static class RuleVerificationStatusKindDeserializer
    {
        ...
        internal static RuleVerificationStatusKind Deserialize(JsonElement jsonElement)
        {
            ...
            return value switch
            {
                "NONE" => RuleVerificationStatusKind.NONE,
                "PASSED" => RuleVerificationStatusKind.PASSED,
                "FAILED" => RuleVerificationStatusKind.FAILED,
                "INCONCLUSIVE" => RuleVerificationStatusKind.INCONCLUSIVE,
                _ => throw new InvalidDataException($"{value} is not a valid for RuleVerificationStatusKind")
            };
        }        
    }
}
