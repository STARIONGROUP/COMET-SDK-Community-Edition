// -------------------------------------------------------------------------------------------------------------------------------
// <copyright file="AnnotationStatusKindDeserializer.cs" company="Starion Group S.A.">
...
namespace CDP4JsonSerializer
{
    ...
    internal static class AnnotationStatusKindDeserializer
    {
        ...
        internal static AnnotationStatusKind Deserialize(JsonElement jsonElement)
        {
            ...
            return value switch
            {
                "OPEN" => AnnotationStatusKind.OPEN,
                "DONE" => AnnotationStatusKind.DONE,
                "CLOSED" => AnnotationStatusKind.CLOSED,
                "INVALID" => AnnotationStatusKind.INVALID,
                "WONTFIX" => AnnotationStatusKind.WONTFIX,
                "NOT_APPLICABLE" => AnnotationStatusKind.NOT_APPLICABLE,
                _ => throw new InvalidDataException($"{value} is not a valid for AnnotationStatusKind")
            };
        }        
    }
}
